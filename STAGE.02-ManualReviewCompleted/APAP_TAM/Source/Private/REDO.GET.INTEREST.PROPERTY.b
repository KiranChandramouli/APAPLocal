* @ValidationCode : MjotODIwMjE1NDg4OkNwMTI1MjoxNjg0NDkxMDM0OTM4OklUU1M6LTE6LTE6LTUxOjE6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
...
*APAP.TAM.REDO.GET.PROPERTY.NAME(IN.AA.ID,IN.PROPERTY.CLASS,R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR) ;*MANUAL R22 CODE CONVERSION
    APAP.TAM.redoGetPropertyName(IN.AA.ID,IN.PROPERTY.CLASS,R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR) ;*MANUAL R22 CODE CONVERSION
...
* Here Payment schedule is read for that particular arrangement
    ...
    ERR.MSG = ''
    R.PAY.SCH.COND = ''
*APAP.AA.REDO.CRR.GET.CONDITIONS(IN.AA.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PAY.SCH.COND,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    APAP.AA.redoCrrGetConditions(IN.AA.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PAY.SCH.COND,ERR.MSG) ;*MANUAL R22 CODE CONVERSION

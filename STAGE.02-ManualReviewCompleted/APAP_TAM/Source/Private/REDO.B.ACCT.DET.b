* @ValidationCode : Mjo3MDg4MTgyODQ6Q3AxMjUyOjE2ODU2MjI3NDM0ODk6SVRTUzotMTotMTo2MzI6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 01 Jun 2023 18:02:23
...
*30/05/2023      CONVERSION TOOL            AUTO R22 CODE CONVERSION      TAM.BP REMOVED IN INSERT FILE, SM to @SM, VM to @VM
*30/05/2023      HARISH VIKRAM              MANUAL R22 CODE CONVERSION    CATEG.LIST,YL.CATEG,L.TIP.CLI.POSN,L.CU.LOCAL.POS,LCOMP.LOCALIDAD.POS,CUR.LIST,YL.CURR,Y.LNK.TYP.NAME,CATEGINT.LIST  added in insert file "I_REDO.B.ACCT.DET.COMMON"
...
*----------------------------------------------------------------------------------------
    ...
    $INSERT I_DAS.COMMON ;*AUTO R22 CODE CONVERSION
    $INSERT I_DAS.BASIC.INTEREST ;*AUTO R22 CODE CONVERSION
    $INSERT I_F.REDO.AZACC.DESC ;*AUTO R22 CODE CONVERSION - START
    $INSERT I_F.REDO.H.REPORTS.PARAM
    $INSERT I_REDO.B.ACCT.DET.COMMON
    $INSERT I_REDO.GENERIC.FIELD.POS.COMMON ;*AUTO R22 CODE CONVERSION - END
    $USING APAP.LAPAP
...
*-------------------
    ...
    INT.RATE = ''
    APAP.LAPAP.drRepAcIntCalc(ACCOUNT.ID,R.ACCOUNT,INT.RATE);* R22 Manual conversion

...
*14-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     INSERT FILE MODIFIED,FM TO @FM,++ TO +=1
...
*************
    ...
    T.TOT.STMT.CNT=DCOUNT(Y.ID.LIST,@FM) ;*R22 AUTO CONVERSION
    Y.CUR.STMT.NO=1
    LOOP
    WHILE Y.CUR.STMT.NO LE T.TOT.STMT.CNT
        Y.STMT.ID=FIELD(Y.ID.LIST<Y.CUR.STMT.NO>,'*',2)
        GOSUB PROCESS.STMT
        Y.CUR.STMT.NO += 1 ;*R22 AUTO CONVERSION
    REPEAT
RETURN
******************
PROCESS.DATA.COB:

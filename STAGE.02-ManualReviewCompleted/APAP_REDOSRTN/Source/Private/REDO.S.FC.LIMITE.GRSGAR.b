...
*28/08/2023	 VIGNESHWARI        MANUAL R22 CODE CONVERSION	      DYN.TO.OFS Change to OFS.BUILD.RECORD,CALL RTN MODIFIED,CALL RTN MODIFIED
*-----------------------------------------------------------------------------------------------------------------------
*-----------------------------------------------------------------------------------
...
*=========
    ...
    Y.ID.NAME.LIM = 'INDIVIDUAL.EMPLOYEES'

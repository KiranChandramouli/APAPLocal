* @ValidationCode : MjotNTA5MDU0NjQwOkNwMTI1MjoxNjg4NTU2NjM3MjQxOklUU1M6LTE6LTE6ODM3NToxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jul 2023 17:00:37
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 8375
...
*-----------------------------------------------------------------------------
SUBROUTINE RGP.LCS.BY.RSKPTY
REM "RGP.LCS.BY.RSKPTY",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.LCS.BY.RSKPTY"
    EXECUTE "HUSH ON"
...
*------------------------------------------------------------------------
    ...
    LOOP WHILE YKEYFD = "" DO
        ...
        GOSUB 1000000
*
        IF YKEY.OLD[1,38] <> YKEY[1,38] THEN
            YTOTAL.STATUS = 2

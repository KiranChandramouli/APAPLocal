* @ValidationCode : MjoyMDYyMjgwMzg1OkNwMTI1MjoxNzAyOTg4MzM4ODEyOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
OPEN.FILES:
    ...
    Y.SYS.ID = "SYSTEM" ;*R22 Manual Code Conversion_Utility Check
    CALL CACHE.READ(FN.DR.REG.213IF01.PARAM, Y.SYS.ID, R.DR.REG.213IF01.PARAM, DR.REG.213IF01.PARAM.ERR) ;*R22 Manual Code Conversion_Utility Check
    ...
    Y.AML.ID = 'AML.PROCESS' ;*R22 Manual Code Conversion_Utility Check
    CALL F.READ(FN.REDO.CLEARING.PROCESS, Y.AML.ID, R.REDO.CLEARING.PROCESS, F.REDO.CLEARING.PROCESS, READ.ERR) ;*R22 Manual Code Conversion_Utility Check
...
PROCESS:
    ...
    Y.SYS.ID = "SYSTEM" ;*R22 Manual Code Conversion_Utility Check
    CALL F.WRITE(FN.DR.REG.213IF01.PARAM, Y.SYS.ID,R.DR.REG.213IF01.PARAM) ;*R22 Manual Code Conversion_Utility Check

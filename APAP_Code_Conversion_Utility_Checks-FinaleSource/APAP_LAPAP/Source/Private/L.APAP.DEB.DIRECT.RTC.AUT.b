* @ValidationCode : MjotNDE1ODUyNzAxOkNwMTI1MjoxNzAyOTg4MzUwODQzOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Dec 2023 17:49:10
...
* 13-07-2023     Conversion tool    R22 Auto conversion       FM TO @FM, VM to @VM, SM to @SM, BP Removed in INSERTFILE
...
*       CALL OFS.CALL.BULK.MANAGER(options,OFS.RECORD,RESP, Y.txnCommitted)
        EB.Interface.OfsCallBulkManager(options,OFS.RECORD,RESP, Y.txnCommitted) ;*R22 Manual Code Conversion_Utility Check

* @ValidationCode : MjotMTQyMjYyMzQxMjpDcDEyNTI6MTcwMjk4ODM0MjA5NjpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
...
*   $INSERT I_F.AA.ARRANGEMENT;* PACS00305219
    ...
    $INSERT I_F.REDO.CUST.PRD.LIST ;*R22 Manual Code Conversion_Utility Check
    $USING AA.Framework
...
*-----------*
    OUT.ARR = ''
*APAP.LAPAP.DR.REG.GET.CUST.TYPE(R.CUSTOMER,OUT.ARR)
...
****************
    ...
    CALL CACHE.READ(FN.DR.REG.IF02.EXTRACT,Y.SYS.ID,R.DR.REG.IF02.EXTRACT,DR.REG.IF02.EXTRACT.ERR)
...
*       YACCT.REC = R.REDO.CUST.PRD.LIST<1>
        YACCT.REC = R.REDO.CUST.PRD.LIST<PRD.PRODUCT.ID> ;*R22 Manual Code Conversion_Utility Check
...
*       YAC.STATUS = R.REDO.CUST.PRD.LIST<2,YCUST.CNT>
        ...
        YACC.ID = R.REDO.CUST.PRD.LIST<PRD.PRODUCT.ID,YCUST.CNT>
        YAC.TYPE = R.REDO.CUST.PRD.LIST<PRD.TYPE.OF.CUST,YCUST.CNT>
        YAC.STATUS = R.REDO.CUST.PRD.LIST<PRD.PRD.STATUS,YCUST.CNT>
...
*       CALL F.READ(FN.AA.SCHEDULED.ACTIVITY,ARR.ID,R.AA.SCHEDULED.ACTIVITY,F.AA.SCHEDULED.ACTIVITY,AA.SCHEDULED.ACTIVITY.ERR)
        R.AA.SCHEDULED.ACTIVITY = AA.Framework.ScheduledActivity.Read(ARR.ID, AA.SCHEDULED.ACTIVITY.ERR) ;*R22 Manual Code Conversion_Utility Check
*       CUT.DATE = R.AA.SCHEDULED.ACTIVITY<AA.SCH.NEXT.RUN.DATE>
        CUT.DATE = R.AA.SCHEDULED.ACTIVITY<AA.Framework.ScheduledActivity.SchNextRunDate>  ;*R22 Manual Code Conversion_Utility Check
*PACS00305219
...
*   PROD.GROUP.ID = R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP>
    STAR.DATE.VAL = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrStartDate> ;*R22 Manual Code Conversion_Utility Check
    PROD.GROUP.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup> ;*R22 Manual Code Conversion_Utility Check
...
*       CALL AA.GET.PERIOD.BALANCES(ACCOUNT.VAL,BALANCE.TO.CHECK,REQUEST.TYPE,START.DATE,END.DATE,'',BAL.DETAILS, ERROR.MESSAGE)
        AA.Framework.GetPeriodBalances(ACCOUNT.VAL,BALANCE.TO.CHECK,REQUEST.TYPE,START.DATE,END.DATE,'',BAL.DETAILS, ERROR.MESSAGE) ;*R22 Manual Code Conversion_Utility Check

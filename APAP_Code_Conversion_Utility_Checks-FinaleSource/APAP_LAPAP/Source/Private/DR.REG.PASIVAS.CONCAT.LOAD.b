* @ValidationCode : MjotNjUxNzg0MjQ5OkNwMTI1MjoxNzAyOTg4MzQyMTU4OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*************
    ...
    CALL CACHE.READ(FN.DR.REG.PASIVAS.PARAM,Y.SYS.ID,R.DR.REG.PASIVAS.PARAM,DR.REG.PASIVAS.PARAM.ERR)

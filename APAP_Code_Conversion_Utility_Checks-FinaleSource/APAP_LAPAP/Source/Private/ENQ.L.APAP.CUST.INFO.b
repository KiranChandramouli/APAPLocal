* @ValidationCode : MjotMTMxNDg2MDM2NTpDcDEyNTI6MTcwMjk4ODM0NDEwNTpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
...
*   CALL GET.LOC.REF("CUSTOMER", "L.CU.TIPO.CL", L.CU.TIPO.CL.POS)
    EB.LocalReferences.GetLocRef("CUSTOMER", "L.CU.TIPO.CL", L.CU.TIPO.CL.POS) ;*R22 Manual Code Conversion_Utility Check
...
*R22 Manual Code Conversion_Utility Check-Start
    ...
    END ELSE
        IF (Y.L.CU.RNC NE '') THEN  ;* Latest Routine- Changes START
...
*R22 Manual Code Conversion_Utility Check-Start
    ...
    END ELSE
        IF  Y.CUSTOMER.TYPE EQ "PERSONA JURIDICA" THEN  ;* Latest Routine- Changes

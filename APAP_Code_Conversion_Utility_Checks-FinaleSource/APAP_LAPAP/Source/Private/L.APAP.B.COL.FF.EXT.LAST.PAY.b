* @ValidationCode : MjotMTYwOTA5NjUwOkNwMTI1MjoxNzAyOTg4MzQ1NTcyOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*13-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     TAM.BP is Removed,SM,FM,VM to @SM,@FM,@VM
...
*----------------------------------------------------------------------------------------
SUBROUTINE L.APAP.B.COL.FF.EXT.LAST.PAY(Y.AA.ID,Y.TOTAL.CUOTAS,Y.LASTPAY.AMT, Y.LASTPAY.DAT,Y.NEXT.PAY.AMT,Y.NEXT.PAY.DATE,Y.AL.PAID.BILLS.CNT)
...
* CALL REDO.GET.PROPERTY.NAME(Y.AA.ID,'ACCOUNT',R.OUT.AA.RECORD,ACCOUNT.PROPERTY,OUT.ERR)
    Y.APPL.ID = 'ACCOUNT' ;*R22 Manual Code Conversion_Utility Check
    APAP.TAM.redoGetPropertyName(Y.AA.ID,Y.APPL.ID,R.OUT.AA.RECORD,ACCOUNT.PROPERTY,OUT.ERR);*R22 MANUAL CODE CONVERSION

* @ValidationCode : MjoxOTY2OTA3MTExOlVURi04OjE3MDI5OTA5ODc3MDk6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 Dec 2023 18:33:07
...
*18-12-2023      Narmadha V        Manual R22 Conversion              AA.ARR.CUSTOMER to AA.PRD.DES.CUSTOMER
*-------------------------------------------------------------------------------
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*FN.AA.ARR.CUSTOMER     = 'F.AA.ARR.CUSTOMER'
    FN.AA.ARR.CUSTOMER     = 'F.AA.PRD.DES.CUSTOMER' ;*Manual R22 Conversion
    F.AA.ARR.CUSTOMER      = ''

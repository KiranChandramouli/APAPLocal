...
*13-07-2023    VICTORIA S          R22 MANUAL CONVERSION   FIELD NAME MODIFIED
*----------------------------------------------------------------------------------------
...
*
    ...
    CALL CACHE.READ(FN.ACCOUNT.CLASS, "SAVINGS", R.ACCOUNT.CLASS, AC.CLASS.ERR) ;*R22 AUTO CONVERSION
    Y.SAVE.CAT = R.ACCOUNT.CLASS<AC.CLS.CATEGORY>
    CHANGE @VM TO @FM IN Y.SAVE.CAT ;*R22 AUTO CONVERSION
...
*Y.CUR.CAT = R.REDO.H.TELLER.TXN.CODES<TT.TXN.CURR.ACC.CATEG>
    Y.CUR.CAT = R.REDO.H.TELLER.TXN.CODES<TT.TXN.CASH.ACC.CATEG> ;*R22 MANUAL CONVERSION
    CHANGE @VM TO @FM IN Y.CUR.CAT ;*R22 AUTO CONVERSION

    Y.TOTAL.CAT = Y.SAVE.CAT:@FM:Y.CUR.CAT ;*R22 AUTO CONVERSION
*
RETURN
*--------------------------------------------------------------------------------------------------------
END

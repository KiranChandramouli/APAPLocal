* @ValidationCode : MjoxMTI3NTM4MTg4OkNwMTI1MjoxNjg0MTI3NDE0NTkyOklUU1M6LTE6LTE6ODI4OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 May 2023 10:40:14
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 828
...
*14-12-2023      Victoria S          R22 Manual code conversion   Add call routine prefix, CACHE READ modified
...
*To Check if the range falls under Specified category
    ...
    VAL.SYSTEM="SYSTEM" ;* R22 Manual conversion
    CALL CACHE.READ(FN.CHARGE.PARAM,VAL.SYSTEM,R.CHARGE.PARAM,CHG.ERR)

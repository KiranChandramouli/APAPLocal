* @ValidationCode : Mjo5NTc5MTIyMTQ6Q3AxMjUyOjE3MDI5OTEzNzAwNDI6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 Dec 2023 18:39:30
...
*26/10/2023         Ajithkumar             R22 Manual Conversion       USPLATFORM.BP file is Removed, FM ,Vm TO @FM, @VM, CALL GET.LOC.REF Changed
*15/12/2023         HARISHVIKRAM             R22 Manual Conversion     F.READ changed
...
*    CALL F.READ(FN.TT,TXN.CODE,R.TT,F.TT,TT.ERR)
    EB.DataAccess.FRead(FN.TT,TXN.CODE,R.TT,F.TT,TT.ERR)                ;*R22 Manual Conversion
*    CALL GET.LOC.REF('TFS.TRANSACTION','TFS.CCY.MKT',CCY.POS)
    EB.LocalReferences.GetLocRef('TFS.TRANSACTION','TFS.CCY.MKT',CCY.POS)   ; *R22 Manual code conversion
    LOCAL.CCY.MKT = R.TT<TFS.TXN.LOCAL.REF,CCY.POS>
*    CALL DBR("CURRENCY.MARKET":@FM:EB.CMA.DESCRIPTION,LOCAL.CCY.MKT,DESCRIPTION)
    EB.DataAccess.Dbr("CURRENCY.MARKET":@FM:EB.CMA.DESCRIPTION,LOCAL.CCY.MKT,DESCRIPTION)  ; *R22 Manual code conversion
...
*            CALL DBR('TELLER.DENOMINATION':@FM:TT.DEN.DENOM.TYPE,DENOM.ID,DENOM.TYPE)
            EB.DataAccess.Dbr('TELLER.DENOMINATION':@FM:TT.DEN.DENOM.TYPE,DENOM.ID,DENOM.TYPE)  ; *R22 Manual code conversion
...
OPEN.FILES:
    ...
    F.TD = ''
*    CALL OPF(FN.TD,F.TD)
    EB.DataAccess.Opf(FN.TD,F.TD)    ;*R22 Manual Conversion

    FN.TT = 'F.TFS.TRANSACTION'
    F.TT = ''
*   CALL OPF(FN.TT,F.TT)
    EB.DataAccess.Opf(FN.TT,F.TT)  ;*R22 Manual Conversion

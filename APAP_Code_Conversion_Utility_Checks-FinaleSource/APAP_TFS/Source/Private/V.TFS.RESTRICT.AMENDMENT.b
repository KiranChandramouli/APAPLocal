* @ValidationCode : MjoxNTM3NjA2NTkyOkNwMTI1MjoxNjk4NzUwNjc0NzYwOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*26/10/2023         Suresh             R22 Manual Conversion           GLOBUS.BP File Removed, USPLATFORM.BP File Removed, VM TO @VM
*-----------------------------------------------------------------------------------
...
*
    ...
    WHILE LOOP.CNT LE MAX.LOOPS AND PROCESS.GOAHEAD DO
        ...
        BEGIN CASE
            ...
            CASE LOOP.CNT EQ 2
                IF NOT(V$FUNCTION MATCHES 'I' :@VM: 'C') THEN PROCESS.GOAHEAD = 0 ;*R22 Manual Conversion

* @ValidationCode : Mjo0NDE5Nzg4MTU6Q3AxMjUyOjE3MDI5ODgyNTA4NDg6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
*---------------------------------------------------------------------------------------------------
    ...
    F.ATM.REVERSAL=''
    CALL OPF (FN.ATM.REVERSAL,F.ATM.REVERSAL) ;*R22 MANUAL CODE OCNVERSION

*CALL REDO.TC.IN.FRAME.ARR(STLMT.LINES) ;*R22 MANUAL CODE CONVERSION
    APAP.TAM.redoTcInFrameArr(STLMT.LINES) ;*R22 MANUAL CODE CONVERSION
...
*CALL LOAD.COMPANY(Y.ID.COMPANY)
    ST.CompanyCreation.LoadCompany(Y.ID.COMPANY);*r22 manual code conversion
...
*CALL REDO.VISA.SETTLE.WRITE(Y.STL.ID,R.REDO.STLMT.LINE) ;*R22 MANUAL CODE CONVERSION
    APAP.TAM.redoVisaSettleWrite(Y.STL.ID,R.REDO.STLMT.LINE) ;*R22 MANUAL CODE CONVERSION

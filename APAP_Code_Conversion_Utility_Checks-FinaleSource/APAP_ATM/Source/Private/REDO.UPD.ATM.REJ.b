* @ValidationCode : MjotNDE5NDU1OTgzOkNwMTI1MjoxNzAyOTg4MjUxMTE1OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*R22 MANUAL CONVERSION
        APAP.TAM.redoTxnAuthCode(CARD.NUMM,RET.VAL)
...
*R22 MANUAL CONVERSION
*APAP.ATM.vFtUpdAtmKeyId()
        APAP.ATM.vFtUpdEnqAtmKeyId()
        RETURN
    END
...
*changing end code to accomadate multivalue of CARD.TYPE in REDO.CARD.BIN for issue PACS00033279
    ...
    CALL CACHE.READ(FN.REDO.IST.RESP.CODE,ID.VAR,R.REDO.IST.RESP.CODE,ERR)

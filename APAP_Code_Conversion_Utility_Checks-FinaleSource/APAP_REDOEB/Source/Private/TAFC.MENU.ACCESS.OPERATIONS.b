* @ValidationCode : MjotMzc3MTY0NzU0OlVURi04OjE3MDI5OTA2MzMwODI6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 Dec 2023 18:27:13
...
*14-12-2023      Narmadha V                    Manual R22 Conversion                 Initalise FN variable,Change hardcoded value to FN variable, = to EQ
*-----------------------------------------------------------------------------
...
* PHNO=1 ; CALL OVERLAY.EX ; CALL S.INITIALISE.COMMON
    ...
    FN.TAFC.AUDIT.LOG = "F.TAFC.AUDIT.LOG" ;*Manual R22 Conversion -  Initalise FN variable
    F.TAFC.AUDIT.LOG = ""
*OPEN F.TAFC.AUDIT.LOG TO F.TAFC.AUDIT.LOG ELSE
    OPEN FN.TAFC.AUDIT.LOG TO F.TAFC.AUDIT.LOG ELSE ;*Manual R22 Conversion - Change hardcoded value to FN variable.
...
*IF Tty[1] = "$" THEN
    IF Tty[1] EQ "$" THEN ;*Manual R22 Conversion = to EQ

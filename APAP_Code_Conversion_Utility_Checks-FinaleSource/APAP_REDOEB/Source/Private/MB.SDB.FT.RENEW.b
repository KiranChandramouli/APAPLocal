* @ValidationCode : MjotNDk1MDUxNTE4OlVURi04OjE3MDI5OTA2MjgwMzg6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
* 15-12-2023      Narmadha V        Manual R22 Conversion      Change F.READ to CACHE.READ
*-----------------------------------------------------------------------------
    $INSERT I_EQUATE
    $INSERT I_COMMON
    $INSERT I_F.DATES
...
*CALL F.READ(FN.MB.SDB.PARAM,MB.SDB.PARAM.ID,R.MB.SDB.PARAM,F.MB.SDB.PARAM,PARAM.YERR)
    CALL CACHE.READ(FN.MB.SDB.PARAM,MB.SDB.PARAM.ID,R.MB.SDB.PARAM,PARAM.YERR);*Manual R22 Conversion - Change F.READ to CACHE.READ

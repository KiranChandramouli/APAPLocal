* @ValidationCode : MjoxODc5MDQ5OTY2OkNwMTI1MjoxNjkwMTc2MDQ1Njg1OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*13/07/2023	               CONVERSION TOOL       AUTO R22 CODE CONVERSION		         ../T24_BP,TAM.BP is removed in insertfile, CONVERT changed to CHANGE,
*                                                                                         VM changed to @VM,FM changed to @FM , SM is changed to @SM
...
*   R.LAYERING = R.ENQUIRY
    ...
    *CALL F.READ(FN.APAP.PARAM.DB.CR.MASK,RECID,R.MASK.PARAM,F.APAP.PARAM.DB.CR.MASK,ERR.MASK.PARAM)
    CALL F.CACHE.READ(FN.APAP.PARAM.DB.CR.MASK,RECID,R.MASK.PARAM,ERR.MASK.PARAM)
    IF R.MASK.PARAM THEN
        ...
        CHANGE @VM TO @FM IN Y.PARAM.ENQ.COL.LST ;*AUTO R22 CODE CONVERSION
        CHANGE @VM TO @FM IN Y.ENQ.COL.LST ;*AUTO R22 CODE CONVERSION

* @ValidationCode : MjotOTk4NTU5MDI2OkNwMTI1MjoxNjg0NDkxMDI2MzIyOklUU1M6LTE6LTE6ODkwOjE6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
...
* PACS00309203
    ...
    R.DR.REG.RIEN5.PARAM = ''; DR.REG.RIEN5.PARAM.ERR = ''; PROD.GRP = '' ;GET.ID = 'SYSTEM'
    CALL CACHE.READ(FN.DR.REG.RIEN5.PARAM,GET.ID,R.DR.REG.RIEN5.PARAM,DR.REG.RIEN5.PARAM.ERR)

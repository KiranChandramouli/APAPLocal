* @ValidationCode : MjotMTAxNzA5ODY5MzpDcDEyNTI6MTY4NDQ5MTAyNTk0MjpJVFNTOi0xOi0xOjEwODY6MTpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
...
INIT.PARA:
**********
    R.DR.REG.RIEN11.PARAM = ''; DR.REG.RIEN11.PARAM.ERR = '' ; GET.ID = 'SYSTEM'
    CALL CACHE.READ(FN.DR.REG.RIEN11.PARAM, GET.ID, R.DR.REG.RIEN11.PARAM, DR.REG.RIEN11.PARAM.ERR)

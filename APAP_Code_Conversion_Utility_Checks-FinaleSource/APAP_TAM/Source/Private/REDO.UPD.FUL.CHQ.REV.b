* @ValidationCode : MjotMTUwMzY5MDYxMDpDcDEyNTI6MTY4OTkyNTI0NjY3OTpJVFNTOi0xOi0xOjU2NDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 21 Jul 2023 13:10:46
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 564
...
*13/07/2023	        CONVERSION TOOL                    AUTO R22 CODE CONVERSION-VM TO @VM,SM TO @SM, T.NO TO C$T24.SESSION.NO
...
*Y.CHQ = R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.CHEQUE.NO>
    Y.CHQ = R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.CHEQUE.REF> ;*MANUAL R22 CODE CONVERSION
    ...
    WHILE Y.CNT GT 0 DO
        ...
        *Y.CHQ.STATUS = R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.CHEQUE.STATUS,FLG>
        Y.CHQ.STATUS = R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.STATUS,FLG> ;*MANUAL R22 CODE CONVERSION
        IF Y.CHQ.STATUS EQ 'RETURN' THEN
            * Y.RES.AMT = Y.RES.AMT + R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.REQ.TXN.AMT,FLG>
            Y.RES.AMT = Y.RES.AMT + R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.TRANS.AMOUNT,FLG> ;*MANUAL R22 CODE CONVERSION
            *R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.CHEQUE.STATUS,FLG> = 'PROCESSED'
            R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.STATUS,FLG> = 'PROCESSED' ;*MANUAL R22 CODE CONVERSION
        END ELSE
...
UPDATE.LOC.TABLE:
    ...
    IF Y.PROCESS NE 'SET' THEN
        ...
        *R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.NEW.TXN.ID> = ID.NEW
        R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.FT.TRANSACTION.ID> = ID.NEW ;*MANUAL R22 CODE CONVERSION
        ...
        R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.AUTHORISER> = C$T24.SESSION.NO:'_':OPERATOR;*AUTO R22 CODE CONVERSION
        R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.INPUTTER> = C$T24.SESSION.NO:'_':OPERATOR;*AUTO R22 CODE CONVERSION

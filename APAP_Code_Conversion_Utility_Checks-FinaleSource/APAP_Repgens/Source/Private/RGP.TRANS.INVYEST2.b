* @ValidationCode : Mjo2MTQ3MTg5MzY6Q3AxMjUyOjE2ODY4MjE3MjMxOTM6SGFyaXNodmlrcmFtQzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:05:23
...
*----------------------------------------------------------------------------------------
SUBROUTINE RGP.TRANS.INVYEST2
REM "RGP.TRANS.INVYEST2",230614-4
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.TRANS.INVYEST2"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "INVESTIGATION LISTING OF YESTERDAYS ENTRIES"
    IF YPRINTING THEN
        YHDR = "RGP.TRANS.INVYEST2 ":YHDR
    ...
    YHDR1 = "TRANS.REFERENCE ACCT/CATEG/CRF L        CY AMOUNT EXCH.RATE CCY FCY A           MOUNT VAL.DATE T/C DEPT A/O. PRODUCT C  USTOMER"
    YHDR2 = "=============== ============== =        ========= ========= === =====           ===== ======== === ==== ==== ======= =  ======="
    YHDR3 = ""
    YHDR4 = ""
...
*
    GOSUB 9200000
    FOR LL = L1ST TO 19
        X = YT.PAGE<P,LL>; IF X <> "" THEN PRINT @(0,LL):X:        ;*Manual R22 conversion GOTO Changed to GOSUB

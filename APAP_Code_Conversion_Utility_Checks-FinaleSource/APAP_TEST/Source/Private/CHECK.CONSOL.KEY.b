* @ValidationCode : MjotODM2OTYyMjkwOlVURi04OjE3MDI5OTEzNTQ5Njk6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 Dec 2023 18:39:14
...
*14-12-2023          Narmadha V            Manual R22 Conversion   intialise variable, Hardcoded value to FN variable.
*-------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.ACCOUNT
    ...
    FN.BP = "&SAVEDLISTS&" ;*Manual R22 Conversion - intialise variable
    F.BP = ""
*OPEN "&SAVEDLISTS&" TO F.BP ELSE PRINT 'Unable to open SAVEDLIST'
    OPEN FN.BP TO F.BP ELSE PRINT 'Unable to open SAVEDLIST' ;*Manual R22 conversion - FN varible modified.

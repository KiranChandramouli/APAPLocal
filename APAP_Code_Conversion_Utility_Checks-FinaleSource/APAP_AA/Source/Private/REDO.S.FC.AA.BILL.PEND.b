* @ValidationCode : MjotOTYyNzcyMDUzOkNwMTI1MjoxNzAyOTkyNDY1ODEwOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6REVWXzIwMjIwMi4wOi0xOi0x
...
*CALL AA.SCHEDULE.PROJECTOR(Y.ARRG.ID, SIM.REF, "",CYCLE.DATE, TOT.PAYMENT, DUE.DATES, DUE.DEFER.DATES, DUE.TYPES, DUE.METHODS, DUE.TYPE.AMTS, DUE.PROPS, DUE.PROP.AMTS, DUE.OUTS)        ;* Routine to Project complete schedules
    AA.PaymentSchedule.ScheduleProjector(Y.ARRG.ID, SIM.REF, "",CYCLE.DATE, TOT.PAYMENT, DUE.DATES, DUE.DEFER.DATES, DUE.TYPES, DUE.METHODS, DUE.TYPE.AMTS, DUE.PROPS, DUE.PROP.AMTS, DUE.OUTS)        ;*   MANUAL R22 CODE CONVERSION

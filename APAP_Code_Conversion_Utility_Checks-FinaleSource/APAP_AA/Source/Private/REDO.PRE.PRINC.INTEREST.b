* @ValidationCode : MjoxOTAyNjQxNjkwOkNwMTI1MjoxNzAyOTkyNDY1MzAyOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6REVWXzIwMjIwMi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Dec 2023 18:57:45
...
*CALL F.READ(FN.AA.ACCOUNT.DETAILS,Y.AA.ID,R.ACC.DET,F.AA.ACCOUNT.DETAILS,ACC.DET.ERR)
    R.ACC.DET = AA.PaymentSchedule.AccountDetails.Read(Y.AA.ID, ACC.DET.ERR)
	
*  END.DATE = R.PAY.SCHED<1,AA.PS.PAYMENT.END.DATE>
    END.DATE   = R.ACC.DET<AA.PaymentSchedule.AccountDetails.AdPaymentEndDate>
*TUS END
    !

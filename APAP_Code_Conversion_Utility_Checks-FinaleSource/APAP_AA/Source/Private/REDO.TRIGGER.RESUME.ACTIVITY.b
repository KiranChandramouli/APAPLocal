* @ValidationCode : MjotMTA5ODE5NDY3MTpDcDEyNTI6MTcwMjk5MjQ2NzcyMzpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOkRFVl8yMDIyMDIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 19 Dec 2023 18:57:47
...
*19/12/2023         Arun               R22 Manual Conversion            Added EB.Interface.OfsCallBulkManager
*--------------------------------------------------------------------------------------------------------
...
*CALL OFS.CALL.BULK.MANAGER(OFS.SOURCE.ID, OFS.MESSAGE, OFS.RESPONSE, TXN.COMMIT)        ;*Process the Activity :)
    EB.Interface.OfsCallBulkManager(OFS.SOURCE.ID, OFS.MESSAGE, OFS.RESPONSE, TXN.COMMIT)        ;*MANUAL R22 CODE CONVERSION

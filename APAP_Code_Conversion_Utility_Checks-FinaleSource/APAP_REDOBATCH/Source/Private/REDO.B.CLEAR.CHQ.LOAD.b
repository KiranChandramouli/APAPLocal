...
**********
    ...
    LREF.APP='ACCOUNT':@FM:'T24.FUND.SERVICES':@FM:'AZ.ACCOUNT' ;*R22 AUTO CONVERSION
    LREF.FIELD='L.AC.TRAN.AVAIL':@FM:'L.TT.PROCESS':@FM:'L.AZ.IN.TRANSIT' ;*R22 AUTO CONVERSION
    LREF.POS = ''

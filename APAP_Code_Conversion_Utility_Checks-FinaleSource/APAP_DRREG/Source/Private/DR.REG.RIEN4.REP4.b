* @ValidationCode : Mjo4MDc4NjEyOTE6Q3AxMjUyOjE3MDI5NjM5ODk3Nzc6MzMzc3U6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
SUBROUTINE DR.REG.RIEN4.REP4
*----------------------------------------------------------------------------
* Company Name   : APAP
* Developed By   : gangadhar@temenos.com
* Program Name   : DR.REG.RIEN4.REP4
* Date           : 27-May-2013
*----------------------------------------------------------------------------
* Description:
*------------
...
*
    OPEN.ERR = ''
    Y.DATE = TODAY
    EXTRACT.FILE.ID = R.DR.REG.RIEN4.PARAM<RIEN4.PARAM.FILE.NAME>:'_':R.DR.REG.RIEN4.PARAM<RIEN4.PARAM.REP.NAME,4>:'_':Y.DATE:'.csv'
...
*
    ...
    REP.NAME = R.DR.REG.RIEN4.PARAM<RIEN4.PARAM.REP.NAME,4>
...
*
    ...
    ID.CNT1 = ''
    ERR.SEL1 = ''
**    SEL.CMD1 = "SELECT ":FN.DR.REG.RIEN4.AZ.REP.OUT4:" BY RATE"
    SEL.CMD1 = "SELECT ":FN.DR.REG.RIEN4.AZ.REP.OUT4:" BY @ID"
...
*
    ...
    RANGE11 = ''
*
    CALL F.READ(FN.DR.REG.RIEN4.AZ.REP.OUT4,REC.ID,R.DR.REG.RIEN4.AZ.REP.OUT4,F.DR.REG.RIEN4.AZ.REP.OUT4,DR.REG.RIEN4.AZ.REP.OUT4.ERR)
    IF R.DR.REG.RIEN4.AZ.REP.OUT4 THEN
        RANGE1 = R.DR.REG.RIEN4.AZ.REP.OUT4<DR.RIEN4.OUT4.RANGE.0.15>
        IF RANGE1 THEN
            RANGE1 = RANGE1
            TOT.RANGE1 += RANGE1
        END ELSE
            RANGE1 = '0.00'
        END
        RANGE2 = R.DR.REG.RIEN4.AZ.REP.OUT4<DR.RIEN4.OUT4.RANGE.16.30>
        IF RANGE2 THEN
            RANGE2 = RANGE2
            TOT.RANGE2 += RANGE2
        END ELSE
            RANGE2 = '0.00'
        END
        RANGE3 = R.DR.REG.RIEN4.AZ.REP.OUT4<DR.RIEN4.OUT4.RANGE.31.60>
        IF RANGE3 THEN
            RANGE3 = RANGE3
            TOT.RANGE3 += RANGE3
        END ELSE
            RANGE3 = '0.00'
        END
        RANGE4 = R.DR.REG.RIEN4.AZ.REP.OUT4<DR.RIEN4.OUT4.RANGE.61.90>
        IF RANGE4 THEN
            RANGE4 = RANGE4
            TOT.RANGE4 += RANGE4
        END ELSE
            RANGE4 = '0.00'
        END
        RANGE5 = R.DR.REG.RIEN4.AZ.REP.OUT4<DR.RIEN4.OUT4.RANGE.91.180>
        IF RANGE5 THEN
            RANGE5 = RANGE5
            TOT.RANGE5 += RANGE5
        END ELSE
            RANGE5 = '0.00'
        END
        RANGE6 = R.DR.REG.RIEN4.AZ.REP.OUT4<DR.RIEN4.OUT4.RANGE.181.360>
        IF RANGE6 THEN
            RANGE6 = RANGE6
            TOT.RANGE6 += RANGE6
        END ELSE
            RANGE6 = '0.00'
        END
        RANGE7 = R.DR.REG.RIEN4.AZ.REP.OUT4<DR.RIEN4.OUT4.RANGE.361.720>
        IF RANGE7 THEN
            RANGE7 = RANGE7
            TOT.RANGE7 += RANGE7
        END ELSE
            RANGE7 = '0.00'
        END
        RANGE8 = R.DR.REG.RIEN4.AZ.REP.OUT4<DR.RIEN4.OUT4.RANGE.721.1080>
        IF RANGE8 THEN
            RANGE8 = RANGE8
            TOT.RANGE8 += RANGE8
        END ELSE
            RANGE8 = '0.00'
        END
        RANGE9 = R.DR.REG.RIEN4.AZ.REP.OUT4<DR.RIEN4.OUT4.RANGE.1081.1440>
        IF RANGE9 THEN
            RANGE9 = RANGE9
            TOT.RANGE9 += RANGE9
        END ELSE
            RANGE9 = '0.00'
        END
        RANGE10 = R.DR.REG.RIEN4.AZ.REP.OUT4<DR.RIEN4.OUT4.RANGE.1441.1800>
        IF RANGE10 THEN
            RANGE10 = RANGE10
            TOT.RANGE10 += RANGE10
        END ELSE
            RANGE10 = '0.00'
        END
        RANGE11 = R.DR.REG.RIEN4.AZ.REP.OUT4<DR.RIEN4.OUT4.RANGE.1881>
        IF RANGE11 THEN
            RANGE11 = RANGE11
            TOT.RANGE11 += RANGE11
        END ELSE

* @ValidationCode : MjoyMDk0OTQ5MDk4OkNwMTI1MjoxNjgzNzI4ODY1MjEwOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*CALL REDO.VERIFY.TRANSACTION ;*MANUAL R22 CODE CONVERSION
        CALL APAP.TAM.redoVerifyTransaction()    ;*MANUAL R22 CODE CONVERSION
    END
*CALL APAP.TAM.REDO.STLMT.STATUS.UPDATE
...
*------------------------------------------------------------------------------------
    ...
    Y.OUT.ID=Y.ID
*CALL REDO.VISA.OUTGOING.WRITE(Y.ID,R.VISA.OUTGOING)

* @ValidationCode : MjotMTM0MTI2MDYwMzpDcDEyNTI6MTY4ODM4ODY4MjIzMTpJVFNTMTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 Jul 2023 18:21:22
    ...
    IF APPLICATION NE 'REDO.CREATE.ARRANGEMENT' THEN
        IF Y.CUS.DC THEN
            LOCATE Y.CUS.DC IN Y.EMP.REL.CUS<1,1> SETTING EMP.POS THEN
                ...
                CURR.NO = DCOUNT(OVERRIDE.FIELD.VALUE,@VM) + 1 ;*R22 MANUAL CONVERSION
...
*--------------------------------------------------------------
    ...
    CHANGE @VM TO @FM IN Y.EMP.REL.CUS ;*R22 MANUAL CONVERSION
    CHANGE @VM TO @FM IN Y.EMP.ACCOUNT ;*R22 MANUAL CONVERSION
...
CHECK.JOINT.HOLDER:
*--------------------------------------------------------------
    Y.JOINT.CNT  = DCOUNT(Y.JOINT.HOLDERS,@VM) ;*R22 MANUAL CONVERSION
    Y.VAR2 = 1
    LOOP
...
*------------------------------------------------
    ...
    Y.JOINT.CNT = DCOUNT(Y.CUS.VAL,@VM) ;*R22 MANUAL CONVERSION
    Y.VAR=1
    LOOP
...
*-------------------------------
    ...
    Y.EMP.ACCOUNT = ''
    Y.REL.CUS.CNT = DCOUNT(Y.EMP.REL.CUS,@VM) ;*R22 MANUAL CONVERSION
    Y.VAR1 = 1
    LOOP

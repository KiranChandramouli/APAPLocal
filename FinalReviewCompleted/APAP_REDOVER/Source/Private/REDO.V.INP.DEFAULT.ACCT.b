* @ValidationCode : MjotNjk1MDgzNjc6Q3AxMjUyOjE2ODU2ODkxMzY1NTU6SVRTUzotMTotMTo1NzE6MTpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 02 Jun 2023 12:28:56
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 571
...
*CALL REDO.UPD.VAL.ITEM.VALUE
    APAP.TAM.redoUpdValItemValue() ;*R22 MANAUAL CODE CONVERSION
*
RETURN
*
* ===================

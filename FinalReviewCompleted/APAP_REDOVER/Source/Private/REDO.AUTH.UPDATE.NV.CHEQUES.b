* @ValidationCode : Mjo5ODQyNDk5NDk6Q3AxMjUyOjE2ODMwMTA3MjMzNzU6SVRTUzotMTotMTo3NDY6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 02 May 2023 12:28:43
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 746
...
*-------------------------------------------------------------
    ...
    APAP.TAM.redoGetNvVersionTypes(Y.TRANS.ID,Y.VERSION.NAMES,Y.VERSION.TYPES,Y.PROC.TYPE,Y.RECEP.METHOD) ;*R22 MANUAL CODE CONVERSION

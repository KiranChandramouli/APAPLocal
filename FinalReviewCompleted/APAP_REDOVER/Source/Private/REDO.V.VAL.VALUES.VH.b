* @ValidationCode : MjoxMzA0ODQzMzE2OkNwMTI1MjoxNjg1Njg5MTM4NTE2OklUU1M6LTE6LTE6LTQxOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
SUBROUTINE REDO.V.VAL.VALUES.VH
*
* Subroutine Type : ROUTINE
* Attached to     : REDO.V.VAL.VALUES.VH
* Attached as     : ROUTINE
...
*04-04-2023            Samaran T                Manual R22 Code Conversion    CALL RTN FORMAT MODIFIED
*----------------------------------------------------------------------------------------------------------
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
**CALC THE DISPONIBLE VALUE
*CALL REDO.V.VAL.DISPO.COLL

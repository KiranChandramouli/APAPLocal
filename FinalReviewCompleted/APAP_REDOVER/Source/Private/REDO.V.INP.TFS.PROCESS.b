* @ValidationCode : MjoxMjc1NzkwODIyOkNwMTI1MjoxNjg0ODQ1NjIzMTIyOklUU1M6LTE6LTE6MTQ2OjE6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 23 May 2023 18:10:23
...
SUBROUTINE REDO.V.INP.TFS.PROCESS
***********************************************************************
...
*----------------------------------------------------------------------
    ...
    WHILE VAR1 LE Y.COUNT
        ...
        END ELSE
            ...
            R.REDO.TFS.PROCESS<TFS.PRO.AMOUNT,VAR1> = INDEX.AMOUNT
            Y.AMT +=INDEX.AMOUNT
        END
        VAR1 += 1
    REPEAT

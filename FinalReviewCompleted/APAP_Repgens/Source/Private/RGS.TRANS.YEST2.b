* @ValidationCode : MjozODMwNjkwMzY6Q3AxMjUyOjE2ODY5MTg5MTEyOTE6SVRTUzotMTotMToyOTQwNjoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 Jun 2023 18:05:11
...
*************************************************************************
    ...
    DIM YR.REC(18)
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.TRANS.YEST2"
    YOLDFILE = 1
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.TRANS.YEST2")
    END
*
    YCOM = ID.COMPANY
*

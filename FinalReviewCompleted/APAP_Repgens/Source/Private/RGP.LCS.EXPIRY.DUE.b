* @ValidationCode : MjotMzMzNjU3NjA2OkNwMTI1MjoxNjg4NTU2NjM3NzgwOklUU1M6LTE6LTE6NTk2NjoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
*-----------------------------------------------------------------------------
SUBROUTINE RGP.LCS.EXPIRY.DUE
REM "RGP.LCS.EXPIRY.DUE",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.LCS.EXPIRY.DUE"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "LETTER OF CREDIT EXPIRY DUE"
    IF YPRINTING THEN
        YHDR = "RGP.LCS.EXPIRY.DUE ":YHDR

* @ValidationCode : MjozNjQ2MTg3MTE6Q3AxMjUyOjE2ODg1NDU3NTMxNDc6SVRTUzotMTotMTozNDg5OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
*-----------------------------------------------------------------------------------------------
SUBROUTINE RGS.LCS.BY.EXPIRY
REM "RGS.LCS.BY.EXPIRY",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.LCS.BY.EXPIRY")
    END
*
    YCOM = ID.COMPANY
*

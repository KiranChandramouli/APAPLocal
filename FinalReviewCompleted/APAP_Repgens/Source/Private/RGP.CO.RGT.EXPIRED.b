...
SUBROUTINE RGP.CO.RGT.EXPIRED
REM "RGP.CO.RGT.EXPIRED",230614-4
...
* T.REMTEXT(23) = "PAGE"
    ...
    END
    YKEY = ""; YTOTFD = ""
    DIM YR.REC(15); MAT YR.REC = ""
    DIM YR.REC.OLD(13); MAT YR.REC.OLD = "_"
    GOSUB 1000000
    YHDR = "COLLATERAL RIGHT EXPIRED"
    IF YPRINTING THEN
        YHDR = "RGP.CO.RGT.EXPIRED ":YHDR
    ...
    YHDR3 = " DATE CUSTOMER                           COLLATERAL CODE                         NO DATE"
    YHDR4 = "------------------------------------------------------------------------------------------------------------------------------------"
...
*
    ...
    IF YPRINTING THEN
        ...
        C$RPT.CUSTOMER.NO = YR.REC(14)
        C$RPT.ACCOUNT.NO = YR.REC(15)

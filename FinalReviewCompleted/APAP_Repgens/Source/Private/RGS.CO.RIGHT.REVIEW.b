<<<<<<< Updated upstream
* @ValidationCode : MjotNTA1NDk0MzQ0OlVURi04OjE2ODg1MzY4OTQ0MTI6SVRTUzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jul 2023 11:31:34
* @ValidationInfo : Encoding          : UTF-8
* @ValidationInfo : User Name         : ITSS
=======
* @ValidationCode : MjotNTA1NDk0MzQ0OlVURi04OjE2ODY4MzUyNTMzNjQ6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 18:50:53
* @ValidationInfo : Encoding          : UTF-8
...
SUBROUTINE RGS.CO.RIGHT.REVIEW
REM "RGS.CO.RIGHT.REVIEW",230614-4
*************************************************************************
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.CO.RIGHT.REVIEW")
    END
*************************************************************************
...
*************************************************************************
    ...
    DIM YR.REC(15)
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.CO.RIGHT.REVIEW"
    YOLDFILE = 1
...
*************************************************************************
    ...
    CALL FIELD.NUMBERS.TO.NAMES('12',SS.REC,fldName,dataType,errMsg)
    fldName2 = '' ; dataType2 = '' ; errMsg2 = ''
    CALL FIELD.NUMBERS.TO.NAMES('19',SS.REC,fldName2,dataType2,errMsg2)
    CLEARSELECT
    YSEL.A = ""
    ...
    END
    EXECUTE "HUSH ON"
    EXECUTE 'SSELECT ':FULL.FNAME:' WITH ':fldName:' <> "" AND ':fldName2:' <> "LIQ"':YSEL.A ;* Manual R22 Conversion
    EXECUTE "HUSH OFF"
...
*
    ...
    IF YM.DEPT.ACCT.OFFICER <> "" THEN
        YCOMP = "CUSTOMER_11.1_":YM.DEPT.ACCT.OFFICER
        YFORFIL = YF.CUSTOMER
        YPART.S = ""; YFD.LEN = ""; YHANDLE.LNGG = 0; GOSUB 9000000
...
* Year 2000 compliance
    ...
    YKEYFD = FMT(YM.DEPT.ACCT.OFFICER,"12L")
    ...
    YM.REVIEW.FQU = FMT(R.NEW(8),"13L"); YM.REVIEW.FQU = YM.REVIEW.FQU[9,5]
    YR.REC(12) = YM.REVIEW.FQU
    YM.VALIDITY.DATE = R.NEW(12)
    YR.REC(13) = YM.VALIDITY.DATE

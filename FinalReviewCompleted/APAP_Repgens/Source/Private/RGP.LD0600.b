<<<<<<< Updated upstream
<<<<<<< Updated upstream
* @ValidationCode : MjotNzI4MTAyNTQ3OkNwMTI1MjoxNjg4NTM2ODkwNzI3OklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jul 2023 11:31:30
=======
* @ValidationCode : MjotNzI4MTAyNTQ3OkNwMTI1MjoxNjg2ODIyNzM3MTY0OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:22:17
>>>>>>> Stashed changes
=======
* @ValidationCode : MjotNzI4MTAyNTQ3OkNwMTI1MjoxNjg2ODIyNzM3MTY0OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:22:17
...
SUBROUTINE RGP.LD0600
REM "RGP.LD0600",230614-4
*************************************************************************
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "CONTRACT STATUS REPORT"
    IF YPRINTING THEN
        YHDR = "RGP.LD0600 ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "CONTRACT NO. CCY CONTRACT AMOUN         T CUSTOMER NAME VALUE DATE               MAT. DATE CATEGORY LIQ. STATUS          STATUS"
    YHDR2 = "                                                                                 CODE CONTRO                            L"
    YHDR3 = ""
    YHDR4 = ""
...
*------------------------------------------------------------------------
    ...
    LOOP WHILE YKEYFD = "" DO
        ...
        YTOTFD := "  ":YFD
        YFD = YR.REC(6)  ;* YM.MAT.DATE.PRINT
        BEGIN CASE
            CASE YFD MATCHES "8N"
                YFD=YFD[7,2]:" ":FIELD(T.REMTEXT(19)," ",YFD[5,2]):" ":YFD[1,4]
            CASE YFD MATCHES "6N"
        ...
        IF LEN(YFD) > 11 THEN YFD = YFD[1,10]:"|"
        YTOTFD := "  ":YFD
        YFD = YR.REC(7)  ;* YM.CATEGORY
        YFD = FMT(YFD,"10L")
        IF LEN(YFD) > 10 THEN YFD = YFD[1,9]:"|"
        YTOTFD := "  ":YFD
        YFD = YR.REC(8)  ;* YM.LIQ.CD.PRINT
        YFD = FMT(YFD,"2L")
        IF LEN(YFD) > 2 THEN YFD = YFD[1,1]:"|"
        YTOTFD := "  ":YFD
        YFD = YR.REC(9)  ;* YM.STATUS.CONTROL
        YFD = FMT(YFD,"9L")
        IF LEN(YFD) > 9 THEN YFD = YFD[1,8]:"|"
        YTOTFD := "   ":YFD
        YFD = YR.REC(10)  ;* YM.STATUS
        YFD = FMT(YFD,"3L")
        IF LEN(YFD) > 3 THEN YFD = YFD[1,2]:"|"
        YTOTFD := "   ":YFD
        GOSUB 9000000

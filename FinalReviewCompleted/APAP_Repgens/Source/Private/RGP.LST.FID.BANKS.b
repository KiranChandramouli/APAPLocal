<<<<<<< Updated upstream
* @ValidationCode : MjotMzg1NjY0OTY4OkNwMTI1MjoxNjg4NTM2ODkxMzkwOklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jul 2023 11:31:31
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
=======
* @ValidationCode : MjotMzg1NjY0OTY4OkNwMTI1MjoxNjg2ODIxNDIwNDU2OmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:00:20
* @ValidationInfo : Encoding          : Cp1252
...
*----------------------------------------------------------------------------
REM "RGP.LST.FID.BANKS",230614-4
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*------------------------------------------------------------------------
    ...
    LOOP WHILE YKEYFD = "" DO
        ...
        END CASE
        YFD.OLD = YR.REC.OLD(2); YFD = YR.REC(2)  ;* YM.PLAC.BK
        ...
        GOSUB 1000000
*
        IF YKEY.OLD[1,16] <> YKEY[1,16] THEN
            YTOTAL.STATUS = 2

* @ValidationCode : MjotMTQ2OTE2NTkxNzpDcDEyNTI6MTY4ODU1NjYzODI3MDpJVFNTOi0xOi0xOjU1MTM6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jul 2023 17:00:38
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 5513
...
*-----------------------------------------------------------------------------
SUBROUTINE RGP.LIST.COLL
REM "RGP.LIST.COLL",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.LIST.COLL"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "OUTSTANDING COLLECTION REPORT"
    IF YPRINTING THEN
    ...
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "                                        OUTSTANDING COLLECTION REPORT"
    YHDR2 = ""

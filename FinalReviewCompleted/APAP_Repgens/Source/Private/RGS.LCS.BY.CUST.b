* @ValidationCode : MjotNzU5MzEzNDcwOkNwMTI1MjoxNjg4NTQ1NzUzMDEwOklUU1M6LTE6LTE6MzUwNDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jul 2023 13:59:13
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 3504
...
*-----------------------------------------------------------------------------------------------
SUBROUTINE RGS.LCS.BY.CUST
REM "RGS.LCS.BY.CUST",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.LCS.BY.CUST")
    END
*
    YCOM = ID.COMPANY
*
...
* Year 2000 compliance
    ...
    YKEYFD = FMT(YM.CUST.NAME,"37L")


    IF LEN(YKEYFD) > 37 THEN YKEYFD = YKEYFD[1,36]:"|"
    GOSUB 8000000
    YR.REC(1) = YM.CUST.NAME
    YM.LC.NUM = ID.NEW
    YR.REC(2) = YM.LC.NUM
    YM.LC.TYPE = R.NEW(2)
    YKEYFD = YM.LC.TYPE

<<<<<<< Updated upstream
* @ValidationCode : MjotODYyNzkzNTA4OkNwMTI1MjoxNjg4NTM2ODkzOTMyOklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jul 2023 11:31:33
=======
* @ValidationCode : MjotODYyNzkzNTA4OkNwMTI1MjoxNjg2ODIzOTAxNzU5OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:41:41
>>>>>>> Stashed changes
...
SUBROUTINE RGS.BANKS.MNEMONIC
REM "RGS.BANKS.MNEMONIC",230614-4
*************************************************************************
*------------------------------------------------------------------------
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.BANKS.MNEMONIC")
    END
*
    YCOM = ID.COMPANY
*
...
*************************************************************************
    ...
    END
    EXECUTE "HUSH ON"
    EXECUTE 'SSELECT ':FULL.FNAME:' WITH @ID >= "500000" AND @ID <= "699999"':YSEL.A     ;*R22 Manual Conversion - SELECT to SSELECT
    EXECUTE "HUSH OFF"
...
* Year 2000 compliance
    ...
    YKEYFD = FMT(YM.MNEMO,"12L")


    IF LEN(YKEYFD) > 12 THEN YKEYFD = YKEYFD[1,11]:"|"
    GOSUB 8000000
    YR.REC(1) = YM.MNEMO
    YM.SHORTNAME = R.NEW(2)
    YR.REC(2) = YM.SHORTNAME
    YM.ID = ID.NEW
    YR.REC(3) = YM.ID
*
    YKEYNO = YKEYNO + 1

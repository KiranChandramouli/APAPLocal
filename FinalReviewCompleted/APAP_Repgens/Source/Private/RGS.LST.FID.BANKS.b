<<<<<<< Updated upstream
* @ValidationCode : MjoxMDY4MjY2NTg4OkNwMTI1MjoxNjg4NTM2OTAwMTI0OklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jul 2023 11:31:40
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
=======
* @ValidationCode : MjoxMDY4MjY2NTg4OkNwMTI1MjoxNjg2OTE4MjI3NzYwOklUU1MxOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jun 2023 17:53:47
* @ValidationInfo : Encoding          : Cp1252
...
SUBROUTINE RGS.LST.FID.BANKS
REM "RGS.LST.FID.BANKS",230614-4
*************************************************************************
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.LST.FID.BANKS")
    END
*************************************************************************
...
*************************************************************************
    ...
    DIM YR.REC(10)
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.LST.FID.BANKS"
    YOLDFILE = 1
...
*************************************************************************
    ...
    END
    EXECUTE "HUSH ON"
    EXECUTE 'SELECT ':FULL.FNAME:' WITH ':fldName:' >= "500000" AND ':fldName:' <= "699999" AND ':fldName2:' = "21085"':YSEL.A
    EXECUTE "HUSH OFF"
...
* Year 2000 compliance
    ...
    YKEYFD = FMT(YM.PLAC.BANK,"10L")


    IF LEN(YKEYFD) > 10 THEN YKEYFD = YKEYFD[1,9]:"|"
    GOSUB 8000000
    YR.REC(1) = YM.PLAC.BANK
    YM.PLAC.BK = R.NEW(1)
    IF YM.PLAC.BK <> "" THEN
        YCOMP = "CUSTOMER_2_":YM.PLAC.BK
        YFORFIL = YF.CUSTOMER
        YPART.S = ""; YFD.LEN = ""; YHANDLE.LNGG = 0; GOSUB 9000000
        YM.PLAC.BK = YFOR.FD
    END
...
* Year 2000 compliance
    ...
    YDEC = "NO.OF.DECIMALS"; CALL UPD.CCY (YM.CCY, YDEC)
    IF YM.PRINC. <> "" THEN
        YM.PRINC. = TRIM(FMT(YM.PRINC.,"19R":YDEC))
    END
    YR.REC(6) = YM.PRINC.

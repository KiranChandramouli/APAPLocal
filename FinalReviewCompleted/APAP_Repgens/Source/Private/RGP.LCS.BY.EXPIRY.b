* @ValidationCode : MjotMTA5MjYwOTUzNTpDcDEyNTI6MTY4ODU1NjYzNzAwNDpJVFNTOi0xOi0xOjU5NjY6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*-----------------------------------------------------------------------------
SUBROUTINE RGP.LCS.BY.EXPIRY
REM "RGP.LCS.BY.EXPIRY",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.LCS.BY.EXPIRY"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "LETTER OF CREDITS BY EXPIRY."
    IF YPRINTING THEN
        YHDR = "RGP.LCS.BY.EXPIRY ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "                                           LETTER OF CREDIT BY EXPIRY DATE"

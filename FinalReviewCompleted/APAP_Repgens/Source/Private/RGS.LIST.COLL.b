* @ValidationCode : MjotMTIyNzI3NjgzODpDcDEyNTI6MTY4ODU0NTc1Mzk3NzpJVFNTOi0xOi0xOjQwMjc6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jul 2023 13:59:13
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 4027
...
*-----------------------------------------------------------------------------------------------
SUBROUTINE RGS.LIST.COLL
REM "RGS.LIST.COLL",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.LIST.COLL")
    END
*************************************************************************

* @ValidationCode : Mjo4MjE4ODI1Nzg6Q3AxMjUyOjE2ODg1NTY2MzkxNjY6SVRTUzotMTotMTo0NjQzOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jul 2023 17:00:39
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 4643
...
*-----------------------------------------------------------------------------
SUBROUTINE RGP.MG.RATE.CON.EX
REM "RGP.MG.RATE.CON.EX",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    YT.SMS.FILE = "MG.RATE.CONTROL.EX"
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.MG.RATE.CON.EX"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "MORTGAGE RATE CONTROL EXCEPTION REPORT"
    IF YPRINTING THEN
        YHDR = "RGP.MG.RATE.CON.EX ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "INTEREST KEY  MESSAGE                              RATE UPDATED"
    YHDR2 = "------------  -------                              ------------"
    YHDR3 = ""
    YHDR4 = ""

* @ValidationCode : MjotNTY0Mjc0MzE5OkNwMTI1MjoxNjg4NTQ1NzUwMjQxOklUU1M6LTE6LTE6NjY2ODoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jul 2023 13:59:10
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 6668
...
SUBROUTINE RGS.COLLECT.TRACER
    
REM "RGS.COLLECT.TRACER",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    DIM YR.REC(6)
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.COLLECT.TRACER"
    YOLDFILE = 1
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.COLLECT.TRACER")
    END
*
    YCOM = ID.COMPANY
*
...
*
    ...
    YM9.GOSUB = YM.DISPLACEMENT
    YM.RETURN.DATE = ""
    YM10.GOSUB = YM.RETURN.DATE
    YM.ERROR.CODE = ""
    YM11.GOSUB = YM.ERROR.CODE
    YM.RE.DISPLACEMENT = ""
    YM12.GOSUB = YM.RE.DISPLACEMENT
    CALL @RP.NEXT.WORKING.DAY (YM8.GOSUB, YM9.GOSUB, YM10.GOSUB, YM11.GOSUB, YM12.GOSUB)
    YM.COUNTRY.CODE = YM8.GOSUB
    YM.DISPLACEMENT = YM9.GOSUB
    YM.RETURN.DATE = YM10.GOSUB
    YM.ERROR.CODE = YM11.GOSUB
    YM.RE.DISPLACEMENT = YM12.GOSUB
    YM.TRACE.DATE = R.NEW(28)
    YM.NULL = ""
    YM.ACCEPTED.DATE = R.NEW(33)
    YM.YES = "YES"
    YM.TYPE = R.NEW(2)
    ...
    END
    IF YM.TRACE.DATE <= YM.RETURN.DATE AND YM.ACCEPTED.DATE = YM.NULL AND YM.COLL.TYPE = YM.YES THEN
        YTRUE.1 = 1
        YM.TRACER.DATE = R.NEW(28)
    END
    IF NOT(YTRUE.1) THEN YM.TRACER.DATE = ""
    YKEYFD = YM.TRACER.DATE
    YKEYFD = FMT(YM.TRACER.DATE,"11L")
    IF LEN(YKEYFD) > 11 THEN YKEYFD = YKEYFD[1,10]:"|"
    GOSUB 8000000
    YR.REC(1) = YM.TRACER.DATE
    YTRUE.1 = 0
    YM.TRACE.DATE = R.NEW(28)
    YM.NULL = ""
    YM.ACCEPTED.DATE = R.NEW(33)

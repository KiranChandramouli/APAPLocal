* @ValidationCode : MjotMTE5OTc4OTIxNDpDcDEyNTI6MTY4ODU0NTc1MDgzMjpJVFNTOi0xOi0xOjQwMzc6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jul 2023 13:59:10
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 4037
...
*-----------------------------------------------------------------------------------------------
SUBROUTINE RGS.LC.ACCEPTANCES
REM "RGS.LC.ACCEPTANCES",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.LC.ACCEPTANCES")
    END
*************************************************************************

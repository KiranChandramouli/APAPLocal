<<<<<<< Updated upstream
* @ValidationCode : MjotNzM1MjM4NTM1OkNwMTI1MjoxNjg4NTM2OTAwMDU3OklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jul 2023 11:31:40
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
=======
* @ValidationCode : MjotNzM1MjM4NTM1OkNwMTI1MjoxNjg2OTE4MjA0MjgyOklUU1MxOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jun 2023 17:53:24
* @ValidationInfo : Encoding          : Cp1252
...
SUBROUTINE RGS.LST.CLI.BAL
REM "RGS.LST.CLI.BAL",230614-4
*************************************************************************
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.LST.CLI.BAL")
    END
*************************************************************************
...
*************************************************************************
    ...
    END
    EXECUTE "HUSH ON"
    EXECUTE 'SELECT ':FULL.FNAME:' WITH ':fldName:' >= "01000" AND ':fldName:' <= "01900" AND ':fldName2:' <> ""':YSEL.A
    EXECUTE "HUSH OFF"

<<<<<<< Updated upstream
<<<<<<< Updated upstream
* @ValidationCode : MjotMTg0NTA3OTM3NTpDcDEyNTI6MTY4ODUzNjg5MTg0NDpJVFNTOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
=======
>>>>>>> Stashed changes
* @ValidationCode : MjotMTg0NTA3OTM3NTpDcDEyNTI6MTY4NjgyNDc5MDM5MTpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:56:30
* @ValidationInfo : Encoding          : Cp1252
...
SUBROUTINE RGP.MM0005
REM "RGP.MM0005",230614-4
*************************************************************************
*----------------------------------------------------------------------------
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "Fiduciary bank deals"
    IF YPRINTING THEN
        YHDR = "RGP.MM0005 ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "REFERENCE CUSTOMER NAME C               CY PRINCIPAL AMOUNT INTEREST AMOUNT I   NTEREST INTEREST BASE MATURIT           Y DATE"
    YHDR2 = "                                                                                RATE"
    YHDR3 = ""
    YHDR4 = ""
...
*------------------------------------------------------------------------
    ...
    LOOP WHILE YKEYFD = "" DO
        ...
        END CASE
        YFD.OLD = YR.REC.OLD(1); YFD = YR.REC(1)  ;* YM.FID.BANK
        IF YHEADER.DISPLAY OR YFD.OLD <> YFD THEN
            YHEADER.DISPLAY = 1
            YFD = FMT(YFD,"35L")
            IF LEN(YFD) > 35 THEN YFD = YFD[1,34]:"|"
            YFD = "PLACEMENT BANK NAME: ":YFD
            YTOTFD := "                    ":YFD
        END
        ...
        YTOTFD := "   ":YFD
        YFD = YR.REC(8)  ;* YM.INT.BASE
        YFD = FMT(YFD,"15L")
        IF LEN(YFD) > 15 THEN YFD = YFD[1,14]:"|"
        YTOTFD := "     ":YFD
        YFD = YR.REC(9)  ;* YM.MAT.DATE
        BEGIN CASE
            CASE YFD MATCHES "8N"

<<<<<<< Updated upstream
<<<<<<< Updated upstream
* @ValidationCode : Mjo2NjQ5ODUwNzk6Q3AxMjUyOjE2ODg1MzY4OTMyNTQ6SVRTUzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jul 2023 11:31:33
=======
* @ValidationCode : Mjo2NjQ5ODUwNzk6Q3AxMjUyOjE2ODY4MjIyNzY2MjY6SVRTUzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:14:36
>>>>>>> Stashed changes
=======
* @ValidationCode : Mjo2NjQ5ODUwNzk6Q3AxMjUyOjE2ODY4MjIyNzY2MjY6SVRTUzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:14:36
...
SUBROUTINE RGP.TRANS.JOURNAL6
REM "RGP.TRANS.JOURNAL6",230614-4
*************************************************************************
*------------------------------------------------------------------------
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.TRANS.JOURNAL6"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "TRANSACTION JOURNAL (WITH EXPANED CRF INFORMATION)"
    IF YPRINTING THEN
        YHDR = "RGP.TRANS.JOURNAL6 ":YHDR
    ...
    YHDR1 = "TRANS.REFERENCE ACCOUNT/CATEG CODE/CRF  KEY ASSET TYPE LCY AMOUNT EXC           H.RATE CCY FCY AMOUNT VAL.DAT            T/C CUST/MD"
    YHDR2 = "=============== ======================= === ========== ========== ===           ====== === ========== =======            === ======="
    YHDR3 = ""
    YHDR4 = ""
...
*------------------------------------------------------------------------
    ...
    LOOP WHILE YKEYFD = "1" DO
        ...
        IF NUM(YFD) = NUMERIC THEN
            ...
            NEXT YNO
        END
        YFD = YR.REC(11)  ;* YM.RATE
        YFD = FMT(YFD,"11L")
        IF LEN(YFD) > 11 THEN YFD = YFD[1,10]:"|"
        YTOTFD := " ":YFD
        YFD = YR.REC(12)  ;* YM.CCY
        YFD = FMT(YFD,"3L")
        IF LEN(YFD) > 3 THEN YFD = YFD[1,2]:"|"
        YTOTFD := " ":YFD
        YFD = YR.REC(13)  ;* YM.FCYAMOUNT
        IF YFD = "" THEN
            YFD = STR(" ",19)
        END ELSE
            YDEC = INDEX(YFD,".",1)

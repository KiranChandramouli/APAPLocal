* @ValidationCode : MjotMTcxOTY4NjQ0MjpDcDEyNTI6MTY4ODU0NTc1NDI2OTpJVFNTOi0xOi0xOjM4MTc6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jul 2023 13:59:14
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 3817
...
*-----------------------------------------------------------------------------------------------
SUBROUTINE RGS.LIST.PRE.LCS
REM "RGS.LIST.PRE.LCS",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.LIST.PRE.LCS")
    END
*************************************************************************
...
*************************************************************************
    ...
    CLEARSELECT
    EXECUTE "HUSH ON"
    EXECUTE 'SSELECT ':FULL.FNAME:' WITH FLD.':TNO:' = "P"';* R22 Manual conversion - SELECT changed to SSELECT
    EXECUTE "HUSH OFF"
...
* Year 2000 compliance
    ...
    YR.REC(6) = YM.ISSUE.DATE
    YM.EXPIRY.DATE = R.NEW(28)
    YR.REC(7) = YM.EXPIRY.DATE

...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "Unconfirmed Broker deals"
    IF YPRINTING THEN
        YHDR = "RGP.MM0003 ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "BROKER NAME REFE                        RENCE NO CCY PRINCIPAL AMOUNT INT.R     ATE VALUE DATE MAT.DATE TYPE"
    YHDR2 = ""
    YHDR3 = ""
    YHDR4 = ""

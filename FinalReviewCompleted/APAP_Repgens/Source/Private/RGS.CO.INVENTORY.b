* @ValidationCode : MjotNzcyNjExNzc4OkNwMTI1MjoxNjg2ODM1MzgzOTQ2OklUU1M6LTE6LTE6NDU0NzoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 18:53:03
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 4547
...
*************************************************************************
    ...
    END
    EXECUTE "HUSH ON"
    EXECUTE 'SSELECT ':FULL.FNAME:' WITH ':fldName:' <> "LIQ"':YSEL.A;* R22 Manual conversion - SELECT changed to SSELECT
    EXECUTE "HUSH OFF"

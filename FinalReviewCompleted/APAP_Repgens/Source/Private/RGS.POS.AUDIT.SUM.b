...
*----------------------------------------------------------------------------------------
SUBROUTINE RGS.POS.AUDIT.SUM
REM "RGS.POS.AUDIT.SUM",230614-4
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.POS.AUDIT.SUM")
    END
*
    YCOM = ID.COMPANY
*
...
* Year 2000 compliance
            ...
            END
            YR.REC(12) = YM.CCY.ENTRY.TOT
            YM.LCY.ENTRY.TOT = ""
            YR.REC(13) = YM.LCY.ENTRY.TOT
            ...
            END
            YR.REC(14) = YM.CCY.CLOSE.TOT
            YM.LCY.CCY.AMT = R.NEW(1)
            YM36.GOSUB = YM.LCY.CCY.AMT
            YM.LCC.CCY = YM.CURRENCY
            YM37.GOSUB = YM.LCC.CCY
            YM.LCY.MKT = FMT(ID.NEW,"28L"); YM.LCY.MKT = YM.LCY.MKT[10,1]
            YM38.GOSUB = YM.LCY.MKT
            YM.LCY.ANS = ""
            YM39.GOSUB = YM.LCY.ANS
            CALL @MIDDLE.RATE.CONV.CHECK (YM36.GOSUB, YM37.GOSUB, "", YM38.GOSUB, YM39.GOSUB, "", "")
            YM.LCY.CCY.AMT = YM36.GOSUB
            YM.LCC.CCY = YM37.GOSUB
            YM.LCY.MKT = YM38.GOSUB
            YM.LCY.ANS = YM39.GOSUB
            YM.LCY.CLOSE.POS = YM.LCY.ANS
            YM.LCY.CLOSE.TOT = YM.LCY.CLOSE.POS
            YR.REC(15) = YM.LCY.CLOSE.TOT

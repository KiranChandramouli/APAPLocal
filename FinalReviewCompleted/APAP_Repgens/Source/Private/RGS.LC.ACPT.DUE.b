* @ValidationCode : MjotMTcxMDU1ODc2ODpDcDEyNTI6MTY4ODU1NjY0MDQ2MzpJVFNTOi0xOi0xOjYwNTY6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*-----------------------------------------------------------------------------
SUBROUTINE RGS.LC.ACPT.DUE
REM "RGS.LC.ACPT.DUE",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.LC.ACPT.DUE")
    END
*************************************************************************
...
*
    ...
    YM.DIS = "SYSTEM"
    IF YM.DIS <> "" THEN
        YCOMP = "LC.PARAMETERS_16_":YM.DIS
...
* Year 2000 compliance
    ...
    IF YM.MAT <= YM.RETURN.DATE THEN
        ...
        END
        YM.CUSTOMER.NAME = YM.CUST.NAME
    END
    IF NOT(YTRUE.1) THEN YM.CUSTOMER.NAME = ""
    YR.REC(6) = YM.CUSTOMER.NAME
*
    YKEYNO = YKEYNO + 1
    IF YKEYNO > 9999 THEN
        YKEY = YKEY:YKEYNO

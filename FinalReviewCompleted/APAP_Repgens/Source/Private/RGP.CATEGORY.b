* @ValidationCode : MjotMTA3MDI2MjUxMjpDcDEyNTI6MTY4NjkxODkwNTMzODpJVFNTOi0xOi0xOjQzNTY6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jun 2023 18:05:05
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 4356
...
SUBROUTINE RGP.CATEGORY
REM "RGP.CATEGORY",230614-4
*-----------------------------------------------------------------------------------------------------------------------
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "CATEGORIES LIST"
    IF YPRINTING THEN
        YHDR = "RGP.CATEGORY ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "CATEGORY      DESCRIPTION                                  IND"
    YHDR2 = ""
    YHDR3 = ""
    YHDR4 = ""

* @ValidationCode : MjotNzkzNTY4MTM5OkNwMTI1MjoxNjg4NTU2NjM2Nzc5OklUU1M6LTE6LTE6NTk2NjoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jul 2023 17:00:36
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 5966
...
*-----------------------------------------------------------------------------
SUBROUTINE RGP.LCS.BY.CUST
REM "RGP.LCS.BY.CUST",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.LCS.BY.CUST"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "LETTER.OF.CREDIT BY CUST"
    IF YPRINTING THEN
        YHDR = "RGP.LCS.BY.CUST ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "                                        LETTER OF CREDIT LISTING BY CUSTOMER"
    YHDR2 = "    CUSTOMER / ISSUING SHORT NAME         LC NUMBER   TYPE     EXTERNAL REFERENCE CURRENCY   AMOUNT        ISSUE      EXPIRY"
    YHDR3 = "                                                                                                            DATE       DATE"
    YHDR4 = "------------------------------------------------------------------------------------------------------------------------------------"

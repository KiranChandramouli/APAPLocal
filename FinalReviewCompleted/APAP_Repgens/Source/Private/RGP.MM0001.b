<<<<<<< Updated upstream
* @ValidationCode : Mjo3NjQ0MzcyNTM6Q3AxMjUyOjE2ODg1MzY4OTE2NjM6SVRTUzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jul 2023 11:31:31
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
=======
* @ValidationCode : Mjo3NjQ0MzcyNTM6Q3AxMjUyOjE2ODY4MjM1Nzg3ODg6aGFpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:36:18
* @ValidationInfo : Encoding          : Cp1252
...
SUBROUTINE RGP.MM0001
REM "RGP.MM0001",230614-4
*************************************************************************
*----------------------------------------------------------------------------
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "Maturing deals report."
    IF YPRINTING THEN
        YHDR = "RGP.MM0001 ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = " MAT DATE REFERENCE NO CUSTOMER          CCY NET PRINC+INT AMT LIQ ACCOUNT P    RINC LIQ ACCOUNT INT TYPE"
    YHDR2 = ""
    YHDR3 = ""
    YHDR4 = ""
...
*------------------------------------------------------------------------
    ...
    LOOP WHILE YKEYFD = "" DO
        ...
        YTOTFD := " ":YFD
        YFD = YR.REC(6)  ;* YM.LIQ.ACCT.
        YFD = FMT(YFD,"18L")
        IF LEN(YFD) > 18 THEN YFD = YFD[1,17]:"|"
        YTOTFD := " ":YFD
        YFD = YR.REC(7)  ;* YM.INT.LIQ.ACCT
        YFD = FMT(YFD,"20L")
        IF LEN(YFD) > 20 THEN YFD = YFD[1,19]:"|"
        YTOTFD := "  ":YFD
        YFD = YR.REC(8)  ;* YM.CATEGORY
        YFD = FMT(YFD,"15L")

* @ValidationCode : Mjo1MDcyNzIzODc6Q3AxMjUyOjE2ODg1NDU3NTE3Mzg6SVRTUzotMTotMTo5MzQ4OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jul 2023 13:59:11
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 9348
...
*-----------------------------------------------------------------------------------------------
SUBROUTINE RGS.LC.DRAWINGS
REM "RGS.LC.DRAWINGS",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.LC.DRAWINGS")
    END
*
    YCOM = ID.COMPANY
*

* @ValidationCode : MjotMjQ4NDEyMjk2OkNwMTI1MjoxNjg4NTQ1NzU0Mzc0OklUU1M6LTE6LTE6MjA5MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jul 2023 13:59:14
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 2090
...
*-----------------------------------------------------------------------------------------------
SUBROUTINE RGS.MG.RATE.CON.EX
REM "RGS.MG.RATE.CON.EX",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.MG.RATE.CON.EX")
    END
*
    YCOM = ID.COMPANY
*
...
*
*************************************************************************
    YFILE = "MG.RATE.CONTROL.EX"
    FULL.FNAME = "F.MG.RATE.CONTROL.EX"; YF.MG.RATE.CONTROL.EX = ""
    ...
    CALL OPF (FULL.FNAME, YF.MG.RATE.CONTROL.EX)
    CLEARSELECT
    ...
    WHILE ID.NEW:YDELIM
        MATREAD R.NEW FROM YF.MG.RATE.CONTROL.EX, ID.NEW ELSE ID.NEW = "" ; MAT R.NEW = ""
        IF T.PWD THEN
...
*
    YKEY = ""; MAT YR.REC = ""
    YM.INTEREST.KEY = ID.NEW
    YKEYFD = YM.INTEREST.KEY
...
* Year 2000 compliance
    ...
    YKEYFD = FMT(YM.INTEREST.KEY,"4L")


    IF LEN(YKEYFD) > 4 THEN YKEYFD = YKEYFD[1,3]:"|"
    GOSUB 8000000
    YR.REC(1) = YM.INTEREST.KEY
    YM.MESSAGE = R.NEW(1)
    YR.REC(2) = YM.MESSAGE
    YM.RATE.UPDATED = R.NEW(2)
    YR.REC(3) = YM.RATE.UPDATED
*
    YKEYNO = YKEYNO + 1
    IF YKEYNO > 9999 THEN
        YKEY = YKEY:YKEYNO

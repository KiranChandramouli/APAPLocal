...
SUBROUTINE RGS.LI.COLLAT.DET
REM "RGS.LI.COLLAT.DET",230614-4
*---------------------------------------------------------------------------
...
*************************************************************************
    ...
    RG.S.FIELDS = "RG.S.FIELDS"
    RG.S.SUBSTRINGS = "RG.S.SUBSTRINGS"
*************************************************************************
    YF.VOC = ""
    OPEN "", "VOC" TO YF.VOC ELSE
        TEXT = "CANNOT OPEN VOC-FILE"
        CALL FATAL.ERROR ("RGS.LI.COLLAT.DET")
    END
*************************************************************************
...
* Year 2000 compliance
    ...
    END
    YR.REC(9) = YM.SHORT.NAME
    YM.LIMIT.PRODUCT = R.NEW(98)
    ...
    END
    YR.REC(10) = YM.LIMIT.PRODUCT
    YM.LIMIT.CURRENCY = R.NEW(1)
    YR.REC(11) = YM.LIMIT.CURRENCY
    YM.MAXIMUM.TOTAL = R.NEW(26)
    YR.REC(12) = YM.MAXIMUM.TOTAL
    ...
    YR.REC(16) = YM.FIXED.VARIABLE
    YM.TOTAL.OS = R.NEW(36)<1,1>
    YM1.TOTAL.OS = YM.TOTAL.OS
    YM.LIMIT.LINES.ID = ID.NEW
    YM.ARG1F = YM.LIMIT.LINES.ID
    YM22.GOSUB = YM.ARG1F
    YM.ARG2F = ""
    YM23.GOSUB = YM.ARG2F
    CALL @RG.S.LIMIT.ACCOUNT.OS (YM22.GOSUB, YM23.GOSUB)
    YM.ARG1F = YM22.GOSUB
    YM.ARG2F = YM23.GOSUB
    YM.TOTAL.OS = YM.ARG2F
    ...
    YR.REC(18) = YM.AVAIL.AMT
    YM.COLLATERAL.CODE = R.NEW(18)
    YR.REC(19) = YM.COLLATERAL.CODE
    ...
    END
    YR.REC(20) = YM.DESCRIPTION
    YM.MAXIMUM.SECURED = R.NEW(24)
    YR.REC(21) = YM.MAXIMUM.SECURED
    YM.COLLAT.RIGHT = R.NEW(28)
    YR.REC(22) = YM.COLLAT.RIGHT
    YM.SECURED.AMT.DETAIL = R.NEW(29)
    YR.REC(23) = YM.SECURED.AMT.DETAIL
    YM.LIMIT.SUB.PRODUCT = R.NEW(98)
    YR.REC(24) = YM.LIMIT.SUB.PRODUCT
    YM.ARG1A = YM.LIMIT.LINES.ID
    YM32.GOSUB = YM.ARG1A
    YM.ARG2A = "LIMIT.LINES"
    YM33.GOSUB = YM.ARG2A
    YM.ARG3A = ""
    YM34.GOSUB = YM.ARG3A
    CALL @RG.S.CONCAT.IDS (YM32.GOSUB, YM33.GOSUB, YM34.GOSUB)
    YM.ARG1A = YM32.GOSUB
    YM.ARG2A = YM33.GOSUB
    YM.ARG3A = YM34.GOSUB
    YM.ARG1C = YM.ARG3A
    ...
    YM.ARG3C = ""
    YM44.GOSUB = YM.ARG3C
    CALL @RG.S.FIELDS (YM42.GOSUB, YM43.GOSUB, YM44.GOSUB)
    YM.ARG1C = YM42.GOSUB
    YM.ARG2C = YM43.GOSUB
    YM.ARG3C = YM44.GOSUB
    YM.LIMIT.SUB.CUSTOMER = YM.ARG3C
    YR.REC(25) = YM.LIMIT.SUB.CUSTOMER
    YM.SHORT.NAME2 = YM.LIMIT.SUB.CUSTOMER
    YCOUNT.RPL = COUNT(YM.SHORT.NAME2,@VM)+1
    FOR YAV.RPL = 1 TO YCOUNT.RPL
        YCOUNT.AS.RPL = COUNT(YM.SHORT.NAME2<1,YAV.RPL>,@SM)+1
        FOR YAS.RPL = 1 TO YCOUNT.AS.RPL
            IF YM.SHORT.NAME2<1,YAV.RPL,YAS.RPL> <> "" THEN
                YCOMP = "CUSTOMER_2_":YM.SHORT.NAME2<1,YAV.RPL,YAS.RPL>
                YFORFIL = YF.CUSTOMER
                YPART.S = ""; YFD.LEN = ""; YHANDLE.LNGG = 0; GOSUB 9000000
                YM.SHORT.NAME2<1,YAV.RPL,YAS.RPL> = YFOR.FD
            END
        NEXT YAS.RPL
    NEXT YAV.RPL
    YR.REC(26) = YM.SHORT.NAME2
    YM.LIMIT.SUB.ID = YM.ARG3A
    YM.LIMIT.SUB.PRODUCT.ID = YM.LIMIT.SUB.ID
    YCOUNT.RPL = COUNT(YM.LIMIT.SUB.PRODUCT.ID,@VM)+1
    FOR YAV.RPL = 1 TO YCOUNT.RPL
        YCOUNT.AS.RPL = COUNT(YM.LIMIT.SUB.PRODUCT.ID<1,YAV.RPL>,@SM)+1
        FOR YAS.RPL = 1 TO YCOUNT.AS.RPL
            IF YM.LIMIT.SUB.PRODUCT.ID<1,YAV.RPL,YAS.RPL> <> "" THEN
                YCOMP = "LIMIT_98_":YM.LIMIT.SUB.PRODUCT.ID<1,YAV.RPL,YAS.RPL>
                YFORFIL = YF.LIMIT
                YPART.S = ""; YFD.LEN = ""; YHANDLE.LNGG = 0; GOSUB 9000000
                YM.LIMIT.SUB.PRODUCT.ID<1,YAV.RPL,YAS.RPL> = YFOR.FD
            END
        NEXT YAS.RPL
    NEXT YAV.RPL
    YM.DESCRIPTION3 = YM.LIMIT.SUB.PRODUCT.ID
    ...
    FOR YAV.RPL = 1 TO YCOUNT.RPL
        ...
        FOR YAS.RPL = 1 TO YCOUNT.AS.RPL
            IF YM.DESCRIPTION3<1,YAV.RPL,YAS.RPL> <> "" THEN
                YCOMP = "LIMIT.REFERENCE_1_":YM.DESCRIPTION3<1,YAV.RPL,YAS.RPL>
                YFORFIL = YF.LIMIT.REFERENCE
                YPART.S = ""; YFD.LEN = ""; YHANDLE.LNGG = 1; GOSUB 9000000
        ...
        NEXT YAS.RPL
    NEXT YAV.RPL
    YR.REC(27) = YM.DESCRIPTION3
    YM.LIMIT.SUB.CURRENCY = YM.LIMIT.SUB.ID
    YCOUNT.RPL = COUNT(YM.LIMIT.SUB.CURRENCY,@VM)+1
    FOR YAV.RPL = 1 TO YCOUNT.RPL
        YCOUNT.AS.RPL = COUNT(YM.LIMIT.SUB.CURRENCY<1,YAV.RPL>,@SM)+1
        FOR YAS.RPL = 1 TO YCOUNT.AS.RPL
            IF YM.LIMIT.SUB.CURRENCY<1,YAV.RPL,YAS.RPL> <> "" THEN
                YCOMP = "LIMIT_1_":YM.LIMIT.SUB.CURRENCY<1,YAV.RPL,YAS.RPL>
                YFORFIL = YF.LIMIT
                YPART.S = ""; YFD.LEN = ""; YHANDLE.LNGG = 0; GOSUB 9000000
                YM.LIMIT.SUB.CURRENCY<1,YAV.RPL,YAS.RPL> = YFOR.FD
            END
        NEXT YAS.RPL
    NEXT YAV.RPL
    YR.REC(28) = YM.LIMIT.SUB.CURRENCY
    YM.ONLINE.SUB.LIMIT = YM.LIMIT.SUB.ID
    YCOUNT.RPL = COUNT(YM.ONLINE.SUB.LIMIT,@VM)+1
    FOR YAV.RPL = 1 TO YCOUNT.RPL
        YCOUNT.AS.RPL = COUNT(YM.ONLINE.SUB.LIMIT<1,YAV.RPL>,@SM)+1
        FOR YAS.RPL = 1 TO YCOUNT.AS.RPL
            IF YM.ONLINE.SUB.LIMIT<1,YAV.RPL,YAS.RPL> <> "" THEN
                YCOMP = "LIMIT_32.1_":YM.ONLINE.SUB.LIMIT<1,YAV.RPL,YAS.RPL>
                YFORFIL = YF.LIMIT
                YPART.S = ""; YFD.LEN = ""; YHANDLE.LNGG = 0; GOSUB 9000000
                YM.ONLINE.SUB.LIMIT<1,YAV.RPL,YAS.RPL> = YFOR.FD
            END
        NEXT YAS.RPL
    NEXT YAV.RPL
    YR.REC(29) = YM.ONLINE.SUB.LIMIT
    YM.TOTAL.SUB.OS = YM.LIMIT.SUB.ID
    YCOUNT.RPL = COUNT(YM.TOTAL.SUB.OS,@VM)+1
    FOR YAV.RPL = 1 TO YCOUNT.RPL
        YCOUNT.AS.RPL = COUNT(YM.TOTAL.SUB.OS<1,YAV.RPL>,@SM)+1
        FOR YAS.RPL = 1 TO YCOUNT.AS.RPL
            IF YM.TOTAL.SUB.OS<1,YAV.RPL,YAS.RPL> <> "" THEN
                YCOMP = "LIMIT_36.1_":YM.TOTAL.SUB.OS<1,YAV.RPL,YAS.RPL>
                YFORFIL = YF.LIMIT
                YPART.S = ""; YFD.LEN = ""; YHANDLE.LNGG = 0; GOSUB 9000000
                YM.TOTAL.SUB.OS<1,YAV.RPL,YAS.RPL> = YFOR.FD
            END
        NEXT YAS.RPL
    NEXT YAV.RPL
    YM.TOTAL.SUB.OS.AC = YM.TOTAL.SUB.OS
    YM1.TOTAL.SUB.OS.AC = YM.TOTAL.SUB.OS.AC
    YM.ARG1E = YM.LIMIT.SUB.ID
    YM52.GOSUB = YM.ARG1E
    YM.ARG2E = ""
    YM53.GOSUB = YM.ARG2E
    CALL @RG.S.LIMIT.ACCOUNT.OS (YM52.GOSUB, YM53.GOSUB)
    YM.ARG1E = YM52.GOSUB
    YM.ARG2E = YM53.GOSUB
    YM.TOTAL.SUB.OS.AC = YM.ARG2E
    YCOUNT.MOD = COUNT(YM1.TOTAL.SUB.OS.AC,@VM)+1
    YCOUNT.MOD2 = COUNT(YM.TOTAL.SUB.OS.AC,@VM)+1
    IF YCOUNT.MOD2 > YCOUNT.MOD THEN YCOUNT.MOD = YCOUNT.MOD2
    FOR YAV.MOD = 1 TO YCOUNT.MOD
        YCOUNT.AS.MOD = COUNT(YM1.TOTAL.SUB.OS.AC<1,YAV.MOD>,@SM)+1
        YCOUNT.AS.MOD2 = COUNT(YM.TOTAL.SUB.OS.AC<1,YAV.MOD>,@SM)+1
        IF YCOUNT.AS.MOD2 > YCOUNT.AS.MOD THEN YCOUNT.AS.MOD = YCOUNT.AS.MOD2
        FOR YAS.MOD = 1 TO YCOUNT.AS.MOD
            YFD = YM.TOTAL.SUB.OS.AC<1,YAV.MOD,YAS.MOD>
            IF NUM(YM1.TOTAL.SUB.OS.AC<1,YAV.MOD,YAS.MOD>) = NUMERIC THEN IF NUM(YFD) = NUMERIC THEN
                YM1.TOTAL.SUB.OS.AC<1,YAV.MOD,YAS.MOD> = YM1.TOTAL.SUB.OS.AC<1,YAV.MOD,YAS.MOD> + YFD
                IF YM1.TOTAL.SUB.OS.AC<1,YAV.MOD,YAS.MOD> = 0 THEN YM1.TOTAL.SUB.OS.AC<1,YAV.MOD,YAS.MOD> = ""
            END
        NEXT YAS.MOD
    NEXT YAV.MOD
    YM.TOTAL.SUB.OS.AC = YM1.TOTAL.SUB.OS.AC
    YR.REC(30) = YM.TOTAL.SUB.OS.AC
    YM.AVAIL.SUB.AMT = YM.LIMIT.SUB.ID
    YCOUNT.RPL = COUNT(YM.AVAIL.SUB.AMT,@VM)+1
    FOR YAV.RPL = 1 TO YCOUNT.RPL
        YCOUNT.AS.RPL = COUNT(YM.AVAIL.SUB.AMT<1,YAV.RPL>,@SM)+1
        FOR YAS.RPL = 1 TO YCOUNT.AS.RPL
            IF YM.AVAIL.SUB.AMT<1,YAV.RPL,YAS.RPL> <> "" THEN
                YCOMP = "LIMIT_37.1_":YM.AVAIL.SUB.AMT<1,YAV.RPL,YAS.RPL>
                YFORFIL = YF.LIMIT
                YPART.S = ""; YFD.LEN = ""; YHANDLE.LNGG = 0; GOSUB 9000000
                YM.AVAIL.SUB.AMT<1,YAV.RPL,YAS.RPL> = YFOR.FD
            END
        NEXT YAS.RPL
    NEXT YAV.RPL
    YM.AVAIL.SUB.AMT.AC = YM.AVAIL.SUB.AMT
    YM1.AVAIL.SUB.AMT.AC = YM.AVAIL.SUB.AMT.AC
    YM.AVAIL.SUB.AMT.AC = YM.ARG2E
    YCOUNT.MOD = COUNT(YM1.AVAIL.SUB.AMT.AC,@VM)+1
    YCOUNT.MOD2 = COUNT(YM.AVAIL.SUB.AMT.AC,@VM)+1
    IF YCOUNT.MOD2 > YCOUNT.MOD THEN YCOUNT.MOD = YCOUNT.MOD2
    FOR YAV.MOD = 1 TO YCOUNT.MOD
        YCOUNT.AS.MOD = COUNT(YM1.AVAIL.SUB.AMT.AC<1,YAV.MOD>,@SM)+1
        YCOUNT.AS.MOD2 = COUNT(YM.AVAIL.SUB.AMT.AC<1,YAV.MOD>,@SM)+1
        IF YCOUNT.AS.MOD2 > YCOUNT.AS.MOD THEN YCOUNT.AS.MOD = YCOUNT.AS.MOD2
        FOR YAS.MOD = 1 TO YCOUNT.AS.MOD
            YFD = YM.AVAIL.SUB.AMT.AC<1,YAV.MOD,YAS.MOD>
            IF NUM(YM1.AVAIL.SUB.AMT.AC<1,YAV.MOD,YAS.MOD>) = NUMERIC THEN IF NUM(YFD) = NUMERIC THEN
                YM1.AVAIL.SUB.AMT.AC<1,YAV.MOD,YAS.MOD> = YM1.AVAIL.SUB.AMT.AC<1,YAV.MOD,YAS.MOD> + YFD
                IF YM1.AVAIL.SUB.AMT.AC<1,YAV.MOD,YAS.MOD> = 0 THEN YM1.AVAIL.SUB.AMT.AC<1,YAV.MOD,YAS.MOD> = ""
            END
        NEXT YAS.MOD
    NEXT YAV.MOD
    YM.AVAIL.SUB.AMT.AC = YM1.AVAIL.SUB.AMT.AC
    YR.REC(31) = YM.AVAIL.SUB.AMT.AC
*
    YKEYNO = YKEYNO + 1
    IF YKEYNO > 9999 THEN
        YKEY = YKEY:YKEYNO

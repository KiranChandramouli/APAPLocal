...
SUBROUTINE RGP.CO.INVENTORY
REM "RGP.CO.INVENTORY",230614-4
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "COLLATERAL INVENTORY"
    IF YPRINTING THEN
        YHDR = "RGP.CO.INVENTORY ":YHDR
    ...
    END
    YHDR1 = ""
    YHDR2 = "COUNTRY, CURRENCY                                                                NOMINAL EXECUTION 3RD PARTY             EXPIRY DATE"
    YHDR3 = " & COLLATERAL ID APPLICATION ID          DESCRIPTION                             VALUE VALUE VALUE                       & STATUS"
    YHDR4 = "------------------------------------------------------------------------------------------------------------------------------------"
...
*------------------------------------------------------------------------
    ...
    LOOP WHILE YKEYFD = "" DO
        ...
        END
        YFD.OLD = YR.REC.OLD(1); YFD = YR.REC(1)  ;* YM.COLLATERAL.TYPE
        IF YHEADER.DISPLAY OR YFD.OLD <> YFD THEN
            YHEADER.DISPLAY = 1
            YFD = FMT(YFD,"3L")
            IF LEN(YFD) > 3 THEN YFD = YFD[1,2]:"|"
            YFD = "COLLATERAL TYPE: ":YFD
            YTOTFD := YFD
        END ELSE
            ...
            END
        END
        YFD.OLD = YR.REC.OLD(2); YFD = YR.REC(2)  ;* YM.TYPE.DESCRIPTION
        IF YHEADER.DISPLAY OR YFD.OLD <> YFD THEN
            YHEADER.DISPLAY = 1
            YFD = FMT(YFD,"35L")
        ...
        END ELSE
            ...
            END
        END
        YFD.OLD = YR.REC.OLD(3); YFD = YR.REC(3)  ;* YM.APPLICATION
        IF YHEADER.DISPLAY OR YFD.OLD <> YFD THEN
            YHEADER.DISPLAY = 1
            YFD = FMT(YFD,"3L")
            IF LEN(YFD) > 3 THEN YFD = YFD[1,2]:"|"
        ...
        YTOTFD := " ":YFD
        YFD = YR.REC(7)  ;* YM.COLLATERAL.RIGHT.NO
        IF YFD = "" THEN
            YFD = STR(" ",2)
        END ELSE
            YFD = FMT(YFD,"R##")
        ...
        YTOTFD := " ":YFD
        YFD = YR.REC(9)  ;* YM.APPLICATION.ID
        YFD = FMT(YFD,"34L")
        IF LEN(YFD) > 34 THEN YFD = YFD[1,33]:"|"
        YTOTFD := " ":YFD
        YFD = YR.REC(10)  ;* YM.DESCRIPTION
        YFD = FMT(YFD,"15L")
        IF LEN(YFD) > 15 THEN YFD = YFD[1,14]:"|"
        YTOTFD := " ":YFD
        YFD = YR.REC(11)  ;* YM.NOMINAL.VALUE
        IF YFD = "" THEN
            YFD = STR(" ",13)
        END ELSE
            YFD = FMT(YFD,"13R0,")
        ...
        END
        IF LEN(YFD) > 13 THEN YFD = YFD[1,12]:"|"
        YTOTFD := " ":YFD
        YFD = YR.REC(12)  ;* YM.EXECUTION.VALUE
        IF YFD = "" THEN
            YFD = STR(" ",13)
        END ELSE
            YFD = FMT(YFD,"13R0,")
        ...
        IF LEN(YFD) > 13 THEN YFD = YFD[1,12]:"|"
        YTOTFD := " ":YFD
        YFD = YR.REC(13)  ;* YM.THIRD.PARTY.VALUE
        IF YFD = "" THEN
            YFD = STR(" ",13)
        END ELSE
            YFD = FMT(YFD,"13R0,")

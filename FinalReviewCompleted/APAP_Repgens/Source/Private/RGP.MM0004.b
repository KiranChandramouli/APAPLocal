<<<<<<< Updated upstream
<<<<<<< Updated upstream
* @ValidationCode : MjotNDE4NzEwMjI4OkNwMTI1MjoxNjg4NTM2ODkxODAyOklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
=======
>>>>>>> Stashed changes
* @ValidationCode : MjotNDE4NzEwMjI4OkNwMTI1MjoxNjg2ODI0MzMxODMxOmhhaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:48:51
* @ValidationInfo : Encoding          : Cp1252
...
SUBROUTINE RGP.MM0004
REM "RGP.MM0004",230614-4
*************************************************************************
*----------------------------------------------------------------------------
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.MM0004"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "Unconfirmed Counterparty deals"
    IF YPRINTING THEN
        YHDR = "RGP.MM0004 ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "CUSTOMER REFE                           RENCE NO CCY PRINCIPAL AMOUNT INT.R     ATE VALUE DATE MAT.DATE TYPE"
    YHDR2 = ""
    YHDR3 = ""
    YHDR4 = ""
...
*------------------------------------------------------------------------
    ...
    LOOP WHILE YKEYFD = "" DO
        ...
        YFD = YR.REC(1)  ;* YM.CUSTOMER
        YFD = FMT(YFD,"35L")
        IF LEN(YFD) > 35 THEN YFD = YFD[1,34]:"|"
        YTOTFD := YFD
        YFD = YR.REC(2)  ;* YM.REFERENCE.NUMBER
        YFD = FMT(YFD,"14L")
        ...
        YTOTFD := " ":YFD
        YFD = YR.REC(5)  ;* YM.RATE1
        YFD = FMT(YFD,"11L")
        IF LEN(YFD) > 11 THEN YFD = YFD[1,10]:"|"
        YTOTFD := "   ":YFD
        YFD = YR.REC(6)  ;* YM.VALUE.DATE
        IF YFD = "" THEN
            YFD = STR(" ",10)
        END ELSE
            YFD = FMT(YFD,"R####-##-##")

* @ValidationCode : MjoxNTI2NjYzMDU2OkNwMTI1MjoxNjg2ODM1Mzg0NDI5OklUU1M6LTE6LTE6MjEwMDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 18:53:04
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 2100
...
SUBROUTINE RGS.CURRENCY
REM "RGS.CURRENCY",230614-4
*************************************************************************
...
*************************************************************************
    ...
    DIM YR.REC(5)
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.CURRENCY"
    YOLDFILE = 1
...
* Year 2000 compliance
    ...
    GOSUB 8000000
    YR.REC(1) = YM.ID
    YM.DESCR = R.NEW(3)<1,1>
    YR.REC(2) = YM.DESCR
    YM.MIDRATE = R.NEW(14)
    YR.REC(3) = YM.MIDRATE
    YM.BUYRATE = R.NEW(16)
    YR.REC(4) = YM.BUYRATE
    YM.SELLRATE = R.NEW(17)
    YR.REC(5) = YM.SELLRATE
*
    YKEYNO = YKEYNO + 1
    IF YKEYNO > 9999 THEN
        YKEY = YKEY:YKEYNO

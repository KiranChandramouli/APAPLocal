* @ValidationCode : MjoyMDg3MzczOTYzOkNwMTI1MjoxNjg2OTE4OTA2NzAxOklUU1M6LTE6LTE6Mjk0MDY6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jun 2023 18:05:06
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 29406
...
*************************************************************************
    ...
    RG.CATEG.CONSOL.KEY = "RG.CATEG.CONSOL.KEY"
*************************************************************************
...
*************************************************************************
    ...
    DIM YR.REC(18)
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.TRANS.JOURNAL2"
    YOLDFILE = 1
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.TRANS.JOURNAL2")
    END
*
    YCOM = ID.COMPANY
*
...
* Handle Decision Table
                YM.INPUT.ARG = R.NEW(56)
                YM23.GOSUB = YM.INPUT.ARG
                YM.OUTPUT.ARG = "NC"
                YM24.GOSUB = YM.OUTPUT.ARG
                CALL @RG.CATEG.CONSOL.KEY (YM23.GOSUB, YM24.GOSUB)
                YM.INPUT.ARG = YM23.GOSUB
                YM.OUTPUT.ARG = YM24.GOSUB
...
* Handle Decision Table
                ...
                YM.OUTPUT.ARG = ""
                YM24.GOSUB = YM.OUTPUT.ARG
                CALL @RE.AC.CONTINGENT (YM23.GOSUB, YM24.GOSUB)
                YM.INPUT.ARG = YM23.GOSUB
                YM.OUTPUT.ARG = YM24.GOSUB
                IF YM.OUTPUT.ARG = "NC" THEN
                    YGROUP = "1"; GOSUB 2000000
...
* Handle Decision Table
                ...
                YM.OUTPUT.ARG = ""
                YM24.GOSUB = YM.OUTPUT.ARG
                CALL @RG.GET.CONSOL.TYPE (YM23.GOSUB, YM24.GOSUB)
                YM.INPUT.ARG = YM23.GOSUB
                YM.OUTPUT.ARG = YM24.GOSUB
                IF YM.OUTPUT.ARG = "NC" THEN
                    YGROUP = "1"; GOSUB 2000000
                ...
                CASE YGROUP = "1"
                    ...
                    IF INDEX(YM.SYS.ID.CHECK,"IC",1) <> 1 OR (INDEX(YM.SYS.ID.CHECK,"IC",1) = 1 AND YM.TRANS.CODE = "RVL") THEN
                        ...
                        IF NOT(YTRUE.2) THEN
                            YM.TRANS.CODE = R.NEW(4)
                            YM.SYS.ID.CHECK = R.NEW(24)
                            IF (YM.TRANS.CODE = "CRT" OR YM.TRANS.CODE = "MVT") AND YM.SYS.ID.CHECK = "PD" THEN
                                YTRUE.2 = 1
                                YM.SYS.ID = ""
                            END
                        END
...
* Year 2000 compliance
                    ...
                    YR.REC(15) = YM.DEPT
                    YM.ACCT.OFF = R.NEW(9)
                    YR.REC(16) = YM.ACCT.OFF
                    YM.PRODUCT = R.NEW(10)
                    YR.REC(17) = YM.PRODUCT
                    YM.CUSTOMER = R.NEW(8)
                    YR.REC(18) = YM.CUSTOMER
*
                CASE YGROUP = "2"
                    YKEY = "2"; MAT YR.REC = ""
                    YTRUE.1 = 0
            ...
            BEGIN CASE
                CASE YGROUP = "1"
                    ...
                    IF INDEX(YM.SYS.ID.CHECK,"IC",1) <> 1 OR (INDEX(YM.SYS.ID.CHECK,"IC",1) = 1 AND YM.TRANS.CODE = "RVL") THEN
                        ...
                        YM.SYS.ID.CHECK = R.NEW(24)
                        YM.TRANS.REF = R.NEW(17)
                        IF (YM.TRANS.CODE = "CRT" OR YM.TRANS.CODE = "MVT") AND YM.SYS.ID.CHECK = "PD" AND INDEX(YM.TRANS.REF,"PDTF",1) = 1 THEN
                            YTRUE.2 = 1
                            YM.SYS.ID = "LC"
                        END
                        IF NOT(YTRUE.2) THEN
                            ...
                            YM.SYS.ID.CHECK = R.NEW(24)
                            YM.TRANS.REF = R.NEW(17)
                            IF (YM.TRANS.CODE = "CRT" OR YM.TRANS.CODE = "MVT") AND YM.SYS.ID.CHECK = "PD" AND INDEX(YM.TRANS.REF,"PDAZ",1) = 1 THEN
                                YTRUE.2 = 1
                                YM.SYS.ID = "AC"
                            END
                        END
...
* Year 2000 compliance
                    ...
                    IF NOT(YTRUE.1) THEN
                        YM.TRANS.CODE = R.NEW(4)
                        IF YM.TRANS.CODE <> "CRT" AND YM.TRANS.CODE <> "MVT" THEN
                            YTRUE.1 = 1
                            YM.SORT.REF = R.NEW(17)
                        END
                    END

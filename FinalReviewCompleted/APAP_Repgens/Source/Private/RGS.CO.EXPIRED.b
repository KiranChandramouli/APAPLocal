<<<<<<< Updated upstream
* @ValidationCode : Mjo5NzI3Nzg0MTI6Q3AxMjUyOjE2ODg1MzY4OTQxMTI6SVRTUzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jul 2023 11:31:34
=======
* @ValidationCode : Mjo5NzI3Nzg0MTI6Q3AxMjUyOjE2ODY4MjM2NDQ2ODc6SVRTUzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:37:24
>>>>>>> Stashed changes
...
SUBROUTINE RGS.CO.EXPIRED
REM "RGS.CO.EXPIRED",230614-4
*************************************************************************
*------------------------------------------------------------------------
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.CO.EXPIRED")
    END
*************************************************************************
...
*************************************************************************
    ...
    END
    EXECUTE "HUSH ON"
    EXECUTE 'SSELECT ':FULL.FNAME:' WITH ':fldName:' <> "" AND ':fldName2:' = "LIQ"':YSEL.A     ;*R22 Manual Conversion - SELECT to SSELECT
    EXECUTE "HUSH OFF"
...
* Handle Decision Table
            ...
            IF YM.EXPIRY.DATE < YM.REPORT.DATE AND YM.EXPIRY.DATE THEN
                GOSUB 2000000
            END
        END
*
...
* Year 2000 compliance
    ...
    YM.DESCRIPTION1 = R.NEW(2)<1,1>
    YR.REC(17) = YM.DESCRIPTION1
*
    YKEYNO = YKEYNO + 1
    IF YKEYNO > 9999 THEN
        YKEY = YKEY:YKEYNO

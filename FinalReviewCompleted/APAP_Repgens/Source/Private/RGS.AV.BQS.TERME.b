<<<<<<< Updated upstream
* @ValidationCode : MjoxNjU2NDMxMzEzOkNwMTI1MjoxNjg4NTM2ODkzODU1OklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jul 2023 11:31:33
=======
* @ValidationCode : MjoxNjU2NDMxMzEzOkNwMTI1MjoxNjg2ODI0MDI0OTE0OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:43:44
>>>>>>> Stashed changes
...
SUBROUTINE RGS.AV.BQS.TERME
REM "RGS.AV.BQS.TERME",230614-5
*************************************************************************
*------------------------------------------------------------------------
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.AV.BQS.TERME")
    END
*************************************************************************
...
*************************************************************************
    ...
    DIM YR.REC(9)
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.AV.BQS.TERME"
    YOLDFILE = 1
...
*************************************************************************
    ...
    END
    EXECUTE "HUSH ON"
    EXECUTE 'SSELECT ':FULL.FNAME:' WITH ':fldName:' >= "500000" AND ':fldName:' <= "699999" AND ':fldName2:' = "21075"':YSEL.A      ;*R22 Manual Conversion - SELECT to SSELECT
    EXECUTE "HUSH OFF"
...
*
    ...
    IF YM.PLAC.BANK <> "" THEN
        YCOMP = "CUSTOMER_2_":YM.PLAC.BANK
        YFORFIL = YF.CUSTOMER

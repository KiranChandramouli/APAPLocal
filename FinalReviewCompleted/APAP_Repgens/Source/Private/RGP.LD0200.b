<<<<<<< Updated upstream
<<<<<<< Updated upstream
* @ValidationCode : MjotMTMyNTA4MTQxNTpDcDEyNTI6MTY4ODUzNjg5MDI4MTpJVFNTOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jul 2023 11:31:30
=======
* @ValidationCode : MjotMTMyNTA4MTQxNTpDcDEyNTI6MTY4NjgyMTM3MjgxNDpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 Jun 2023 14:59:32
>>>>>>> Stashed changes
=======
* @ValidationCode : MjotMTMyNTA4MTQxNTpDcDEyNTI6MTY4NjgyMTM3MjgxNDpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 Jun 2023 14:59:32
...
SUBROUTINE RGP.LD0200
REM "RGP.LD0200",230614-4
*************************************************************************
...
* T.REMTEXT(23) = "PAGE"
    ...
    END
    YKEY = ""; YTOTFD = ""
    DIM YR.REC(42); MAT YR.REC = ""
    DIM YR.REC.OLD(40); MAT YR.REC.OLD = "_"
    GOSUB 1000000
    YHDR = "CONTRACTS ACCRUALS REPORT"
    IF YPRINTING THEN
        YHDR = "RGP.LD0200 ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "CONTRACT CUSTOMER/NUMBER                 CCY STATUS PRINCIPAL                    INTEREST COMMISSION                     FEE"
    YHDR2 = " NUMBER MAT. DATE :START DATE            AMOUNT                                  AMOUNT AMOUNT                           AMOUNT"
    YHDR3 = ""
    YHDR4 = ""
...
*------------------------------------------------------------------------
    ...
    LOOP WHILE YKEYFD = "" DO
        ...
        END ELSE
            ...
            END
        END
        YFD.OLD = YR.REC.OLD(2); YFD = YR.REC(2)  ;* YM.CATEGORY.PRINT
        IF YHEADER.DISPLAY OR YFD.OLD <> YFD THEN
            YHEADER.DISPLAY = 1
            YFD = FMT(YFD,"35L")
        ...
        IF Y1ST.LIN THEN
            ...
            IF COMI = C.U THEN RETURN  ;* end of pgm
        END
        YFD = YR.REC(3)  ;* YM.CONTRACT.NO.PRINT
        IF YFD = "" THEN
            YFD = STR(" ",14)
        END ELSE
            YFD = FMT(YFD,"R##-#####-#####")
        ...
        YTOTFD := " ":YFD
        YFD = YR.REC(6)  ;* YM.STATUS
        YFD = FMT(YFD,"3L")
        IF LEN(YFD) > 3 THEN YFD = YFD[1,2]:"|"
        YTOTFD := " ":YFD
        YFD = YR.REC(7)  ;* YM.BLANK.LINE
        YFD = FMT(YFD,"1L")
        IF LEN(YFD) > 1 THEN YFD = YFD[1,0]:"|"
        GOSUB 9000000
        IF COMI = C.U THEN RETURN  ;* end of pgm
        YTOTFD := "                        ":YFD
        YFD = YR.REC(8)  ;* YM.CUSTOMER.ID.PRINT
        YFD = FMT(YFD,"10L")
        IF LEN(YFD) > 10 THEN YFD = YFD[1,9]:"|"
        GOSUB 9000000
        IF COMI = C.U THEN RETURN  ;* end of pgm
        YTOTFD := "               ":YFD
        YFD = YR.REC(9)  ;* YM.CURR.LIT
        YFD = FMT(YFD,"7L")
        IF LEN(YFD) > 7 THEN YFD = YFD[1,6]:"|"
        YTOTFD := "                    ":YFD
        YFD = YR.REC(10)  ;* YM.PRINC.AMT.CURR
        IF YFD = "" THEN
            YFD = STR(" ",19)
        END ELSE
            YDEC = INDEX(YFD,".",1)
        ...
        YTOTFD := "    ":YFD
        YFD = YR.REC(11)  ;* YM.INT.AMT.PRINT
        IF YFD = "" THEN
            YFD = STR(" ",19)
        END ELSE
            YDEC = INDEX(YFD,".",1)
        ...
        IF LEN(YFD) > 19 THEN YFD = YFD[1,18]:"|"
        YTOTFD := YFD
        YFD = YR.REC(12)  ;* YM.COMM.AMT.PRINT
        IF YFD = "" THEN
            YFD = STR(" ",19)
        END ELSE
            YDEC = INDEX(YFD,".",1)
        ...
        IF LEN(YFD) > 19 THEN YFD = YFD[1,18]:"|"
        YTOTFD := YFD
        YFD = YR.REC(14)  ;* YM.MAT.DATE.PRINT
        BEGIN CASE
            CASE YFD MATCHES "8N"
        ...
        IF COMI = C.U THEN RETURN  ;* end of pgm
        YTOTFD := "               ":YFD
        YFD = YR.REC(15)  ;* YM.PRINT.COLON
        YFD = FMT(YFD,"1L")
        IF LEN(YFD) > 1 THEN YFD = YFD[1,0]:"|"
        YTOTFD := YFD
        YFD = YR.REC(16)  ;* YM.VAL.DATE
        BEGIN CASE
            CASE YFD MATCHES "8N"
                YFD=YFD[7,2]:" ":FIELD(T.REMTEXT(19)," ",YFD[5,2]):" ":YFD[1,4]
            CASE YFD MATCHES "6N"
        ...
        IF LEN(YFD) > 11 THEN YFD = YFD[1,10]:"|"
        YTOTFD := YFD
        YFD = YR.REC(17)  ;* YM.OVERDUE.LIT
        YFD = FMT(YFD,"7L")
        IF LEN(YFD) > 7 THEN YFD = YFD[1,6]:"|"
        YTOTFD := "       ":YFD
        YFD = YR.REC(18)  ;* YM.PRINC.OVERDUE
        IF YFD = "" THEN
            YFD = STR(" ",19)
        END ELSE
            YDEC = INDEX(YFD,".",1)
        ...
        IF LEN(YFD) > 19 THEN YFD = YFD[1,18]:"|"
        YTOTFD := YFD
        YFD = YR.REC(21)  ;* YM.BLANK.LINE.1
        YFD = FMT(YFD,"1L")
        IF LEN(YFD) > 1 THEN YFD = YFD[1,0]:"|"
        GOSUB 9000000
        IF COMI = C.U THEN RETURN  ;* end of pgm
        YTOTFD := "                                                      ":YFD
        YFD = YR.REC(22)  ;* YM.TAX.LIT
        YFD = FMT(YFD,"3L")
        IF LEN(YFD) > 3 THEN YFD = YFD[1,2]:"|"
        GOSUB 9000000
        IF COMI = C.U THEN RETURN  ;* end of pgm
        YTOTFD := "                                             ":YFD
        YFD = YR.REC(23)  ;* YM.PRINC.TAX
        IF YFD = "" THEN
            YFD = STR(" ",19)
        END ELSE
            YDEC = INDEX(YFD,".",1)
        ...
        IF LEN(YFD) > 19 THEN YFD = YFD[1,18]:"|"
        YTOTFD := YFD
        YFD = YR.REC(26)  ;* YM.BLANK.LINE.2
        YFD = FMT(YFD,"1L")
        IF LEN(YFD) > 1 THEN YFD = YFD[1,0]:"|"
        GOSUB 9000000
        IF COMI = C.U THEN RETURN  ;* end of pgm
        YTOTFD := "                                                                ":YFD
        YFD = YR.REC(27)  ;* YM.START.DATE.LIT
        YFD = FMT(YFD,"10L")
        IF LEN(YFD) > 10 THEN YFD = YFD[1,9]:"|"
        GOSUB 9000000
        IF COMI = C.U THEN RETURN  ;* end of pgm
        YTOTFD := "                                             ":YFD
        YFD = YR.REC(28)  ;* YM.INT.START.DATE
        BEGIN CASE
            CASE YFD MATCHES "8N"
                YFD=YFD[7,2]:" ":FIELD(T.REMTEXT(19)," ",YFD[5,2]):" ":YFD[1,4]
            CASE YFD MATCHES "6N"
        ...
        IF LEN(YFD) > 11 THEN YFD = YFD[1,10]:"|"
        YTOTFD := "                            ":YFD
        YFD = YR.REC(29)  ;* YM.COMM.START.DATE
        BEGIN CASE
            CASE YFD MATCHES "8N"
                YFD=YFD[7,2]:" ":FIELD(T.REMTEXT(19)," ",YFD[5,2]):" ":YFD[1,4]
            CASE YFD MATCHES "6N"
        ...
        IF LEN(YFD) > 11 THEN YFD = YFD[1,10]:"|"
        YTOTFD := "        ":YFD
        YFD = YR.REC(30)  ;* YM.END.DATE.LIT
        YFD = FMT(YFD,"8L")
        IF LEN(YFD) > 8 THEN YFD = YFD[1,7]:"|"
        GOSUB 9000000
        IF COMI = C.U THEN RETURN  ;* end of pgm
        YTOTFD := "                                             ":YFD
        YFD = YR.REC(31)  ;* YM.INT.END.DATE
        BEGIN CASE
            CASE YFD MATCHES "8N"
                YFD=YFD[7,2]:" ":FIELD(T.REMTEXT(19)," ",YFD[5,2]):" ":YFD[1,4]
            CASE YFD MATCHES "6N"
        ...
        IF LEN(YFD) > 11 THEN YFD = YFD[1,10]:"|"
        YTOTFD := "                              ":YFD
        YFD = YR.REC(32)  ;* YM.COMM.END.DATE
        BEGIN CASE
            CASE YFD MATCHES "8N"
                YFD=YFD[7,2]:" ":FIELD(T.REMTEXT(19)," ",YFD[5,2]):" ":YFD[1,4]
            CASE YFD MATCHES "6N"
        ...
        IF LEN(YFD) > 11 THEN YFD = YFD[1,10]:"|"
        YTOTFD := "        ":YFD
        YFD = YR.REC(33)  ;* YM.ACCR.LIT
        YFD = FMT(YFD,"10L")
        IF LEN(YFD) > 10 THEN YFD = YFD[1,9]:"|"
        GOSUB 9000000
        IF COMI = C.U THEN RETURN  ;* end of pgm
        YTOTFD := "                                             ":YFD
        YFD = YR.REC(34)  ;* YM.INT.ACCR.DT.PRT
        BEGIN CASE
            CASE YFD MATCHES "8N"
                YFD=YFD[7,2]:" ":FIELD(T.REMTEXT(19)," ",YFD[5,2]):" ":YFD[1,4]
            CASE YFD MATCHES "6N"
        ...
        IF LEN(YFD) > 11 THEN YFD = YFD[1,10]:"|"
        YTOTFD := "                            ":YFD
        YFD = YR.REC(35)  ;* YM.COMM.ACCR.DATE
        BEGIN CASE
            CASE YFD MATCHES "8N"
                YFD=YFD[7,2]:" ":FIELD(T.REMTEXT(19)," ",YFD[5,2]):" ":YFD[1,4]
            CASE YFD MATCHES "6N"
        ...
        IF LEN(YFD) > 11 THEN YFD = YFD[1,10]:"|"
        YTOTFD := "        ":YFD
        YFD = YR.REC(36)  ;* YM.BLANK.LINE.3
        YFD = FMT(YFD,"1L")
        IF LEN(YFD) > 1 THEN YFD = YFD[1,0]:"|"
        GOSUB 9000000
        IF COMI = C.U THEN RETURN  ;* end of pgm
        YTOTFD := "                        ":YFD
        YFD = YR.REC(37)  ;* YM.END.REC.LIT1
        YFD = FMT(YFD,"33L")
        IF LEN(YFD) > 33 THEN YFD = YFD[1,32]:"|"
        GOSUB 9000000
        IF COMI = C.U THEN RETURN  ;* end of pgm
        YTOTFD := YFD
        YFD = YR.REC(38)  ;* YM.END.REC.LIT2
        YFD = FMT(YFD,"33L")
        IF LEN(YFD) > 33 THEN YFD = YFD[1,32]:"|"
        YTOTFD := YFD
        YFD = YR.REC(39)  ;* YM.END.REC.LIT3
        YFD = FMT(YFD,"33L")
        IF LEN(YFD) > 33 THEN YFD = YFD[1,32]:"|"
        YTOTFD := YFD
        YFD = YR.REC(40)  ;* YM.END.REC.LIT4
        YFD = FMT(YFD,"33L")
        IF LEN(YFD) > 33 THEN YFD = YFD[1,32]:"|"
        YTOTFD := YFD
        GOSUB 9000000
...
*
    ...
    IF YPRINTING THEN
        ...
        C$RPT.CUSTOMER.NO = YR.REC(41)
        C$RPT.ACCOUNT.NO = YR.REC(42)

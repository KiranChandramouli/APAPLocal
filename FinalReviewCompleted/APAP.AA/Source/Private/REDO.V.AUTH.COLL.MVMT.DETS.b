* @ValidationCode : MjotNjAyMzMzODcwOkNwMTI1MjoxNjgzODc4MTc1NDc3OklUU1M6LTE6LTE6MTgyNDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 May 2023 13:26:15
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1824
...
***********************
    ...
    R.AMT.CONDITION = ''
    ERR.AMT.MSG     = ''
    CALL APAP.AA.redoCrrGetConditions(ARR.AMT.ID,EFF.AMT.DATE,PROP.AMT.CLASS,PROPERTY.AMT,R.AMT.CONDITION,ERR.AMT.MSG);* R22 Manual conversion
...
*********************
    ...
    WHILE SEL.AA.ID:Y.AA.POS
        ...
        CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.AA.ARR.ACCOUNT,ERR.MSG);* R22 Manual conversion

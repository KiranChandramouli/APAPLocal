* @ValidationCode : MjotNjk2ODA0MDU1OkNwMTI1MjoxNjgzODc4MDc0NDgzOklUU1M6LTE6LTE6LTM4OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 May 2023 13:24:34
...
*---------------------------------------------------------------
    ...
    CALL APAP.AA.redoEAaFullScheduleProjector(SCHED.ARR);* R22 Manual conversion
...
*----------------------------------------------
    ...
    R.CONDITION= ''
    ERR.MSG    = ''
    CALL APAP.AA.redoCrrGetConditions(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG);* R22 Manual conversion

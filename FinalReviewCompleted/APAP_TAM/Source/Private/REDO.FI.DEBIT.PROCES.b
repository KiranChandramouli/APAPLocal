* @ValidationCode : MjotNjk1NDM2NDkxOkNwMTI1MjoxNjkzMjIxMjk5NzE2OnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Aug 2023 16:44:59
...
*
    ...
    Z = INDEX(Y.VAR,",",1) - 1
    IF Z EQ '-1' THEN ;*R22 AUTO CONVERSION END
        Z = 50
    END

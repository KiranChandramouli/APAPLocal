* @ValidationCode : MjotMTkwOTQzMjY3NDpDcDEyNTI6MTY4NDg0MjE1MzY3NTpJVFNTOi0xOi0xOi03MToxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
        ...
        BEGIN CASE
            CASE LOOP.CNT EQ 1
                IF R.NEW(TT.TE.DR.CR.MARKER) EQ "CREDIT" AND V$FUNCTION NE "R" THEN
                    ...
                    APAP.REDOEB.redoAnaliseInternaAccbal(WINTERAC.ACCT,WTRAN.AMOUNT,WERROR.BAL) ;*MANUAL R22 CODE CONVERSION
                END

* @ValidationCode : MjoxNTExMjE5OTkxOkNwMTI1MjoxNjg0ODQyMTI3NDkxOklUU1M6LTE6LTE6NDY6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 23 May 2023 17:12:07
...
** R22 Manual conversion
    APAP.TAM.redoConvertAccount(IN.ACC.ID,ARR.ID,Y.AA.ACC.ID,ERR.TEXT)

    OUT.PROP.ACC    = ''
    R.OUT.AA.RECORD = ''
*CALL REDO.GET.PROPERTY.NAME(ARR.ID,'ACCOUNT',R.OUT.AA.RECORD,OUT.PROP.ACC,OUT.ERR)
** R22 Manual conversion
    APAP.TAM.redoGetPropertyName(ARR.ID,'ACCOUNT',R.OUT.AA.RECORD,OUT.PROP.ACC,OUT.ERR)
...
** R22 Manual conversion
    APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.TERM,ERR.MSG)

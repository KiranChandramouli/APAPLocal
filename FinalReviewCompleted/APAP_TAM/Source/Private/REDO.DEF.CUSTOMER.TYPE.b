* @ValidationCode : MjotMTA0OTYyODk2OkNwMTI1MjoxNjg0ODQyMDk1NjIzOklUU1M6LTE6LTE6NzU3OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
*CALL APAP.REDOVER.REDO.VAL.CIDENT.CUST(Y.APP.VERSION) ;*MANUAL R22 CODE CONVERSION
            CALL APAP.REDOVER.redoValCidentCust(Y.APP.VERSION)
...
* CALL APAP.TAM.REDO.VAL.PASSPORT.CUST(Y.APP.VERSION) ;*MANUAL R22 CODE CONVERSION
            CALL APAP.TAM.redoValPassportCust(Y.APP.VERSION)
    END CASE
*
...
* CALL APAP.TAM.REDO.RNC.CHECK.DIGIT(RNC.CHK.RESULT) ;*MANUAL R22 CODE CONVERSION
        CALL APAP.TAM.redoRncCheckDigit(RNC.CHK.RESULT)
    END ELSE

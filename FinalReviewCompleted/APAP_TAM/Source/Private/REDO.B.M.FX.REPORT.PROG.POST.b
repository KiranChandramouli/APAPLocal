* @ValidationCode : MjotNzUzMTkyMzY2OkNwMTI1MjoxNjg0NDkxMDI5NTM3OklUU1M6LTE6LTE6NDUxOjE6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
...
$PACKAGE APAP.TAM
SUBROUTINE REDO.B.M.FX.REPORT.PROG.POST
*-------------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------------------------------------------
    MON.TP = "04"
    REC.CON = "RGN20.":Y.ERR.MSG
    DESC = "RGN20.":Y.ERR.MSG
    INT.CODE = 'REP001'
    INT.TYPE = 'ONLINE'
    BAT.NO = ''
    BAT.TOT = ''

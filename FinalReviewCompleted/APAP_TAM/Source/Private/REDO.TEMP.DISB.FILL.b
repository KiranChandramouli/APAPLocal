* @ValidationCode : MjotMTc3Mzg0MDY4MjpDcDEyNTI6MTY4MzcyODg2NTg2OTpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
** R22 Manual conversion
        APAP.REDOVER.redoVValPdisAmt(Y.CRD.AC)
    END
...
** R22 Manual conversion
    APAP.TAM.redoConvertAccount(ACC.ID,Y.ARR.ID,ARR.ID,ERR.TEXT)
*CALL REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG)
** R22 Manual conversion
    APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG)
    LOAN.STATUS = R.Condition<AA.OD.LOCAL.REF,OD.LOAN.STATUS.POS>
...
** R22 Manual conversion
        APAP.TAM.redoConvertAccount(Y.DEBIT.ACCT.NO,'',OUT.ID,ERR.TEXT)
        Y.ARR.ID = OUT.ID
...
** R22 Manual conversion
        APAP.AA.redoCrrGetConditions(Y.ARR.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.Condition,ERR.MSG)

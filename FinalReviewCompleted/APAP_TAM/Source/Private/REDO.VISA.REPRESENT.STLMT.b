* @ValidationCode : Mjo1NTg5NjU2Njg6Q3AxMjUyOjE2ODM4NjcxMjU1OTI6SVRTUzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMl9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 May 2023 10:22:05
...
*-----------------------------------------------------------------------------------------------------
    ...
    CALL APAP.TAM.redoVisaOutgoingWrite(Y.ID,R.REDO.OUTGOING) ;*MANUAL R22 CODE CONVERSION

* @ValidationCode : Mjo5MjM1MTY4NzU6Q3AxMjUyOjE2ODQ4NDIwOTQ2NjI6SVRTUzotMTotMToxMzIxOjE6ZmFsc2U6Ti9BOlIyMl9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 23 May 2023 17:11:34
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1321
...
*APAP.TAM.REDO.GET.ACI.HIS(R.ACCOUNT.CREDIT.INT,Y.ACI.CUR,Y.INT.RATES)
        APAP.TAM.redoGetAciHis(R.ACCOUNT.CREDIT.INT,Y.ACI.CUR,Y.INT.RATES) ;*R22 Manual conversion
    END ELSE
        GOSUB GET.GCI
    END
...
** R22 Manual conversion
*APAP.TAM.REDO.GET.HIGH.GCI(Y.GCI.ID,Y.GCI.CUR,Y.INT.RATES)
    APAP.TAM.redoGetHighGci(Y.GCI.ID,Y.GCI.CUR,Y.INT.RATES) ;*R22 Manual Conversion

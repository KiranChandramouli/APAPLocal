* @ValidationCode : MjotMTQ1NzExMDc2NDpDcDEyNTI6MTY4Mzg2NjY1NDY3NzpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIyX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 12 May 2023 10:14:14
...
*
    ...
    PSO = ''
    CALL MULTI.GET.LOC.REF(Y.APLS,Y.FIELDS,PSO) ;*MANUAL R22 CODE CONVERSION
    Y.TT.NXT = PSO<1,1>
    Y.TT.INIT= PSO<1,2>
    Y.FT.NXT = PSO<2,1>
    Y.FT.INIT = PSO<2,2>
...
GEN.RTE:
    ...
    CALL APAP.REDOVER.redoVAutRteReprint(Y.HID) ;*MANUAL R22 CODE CONVERSION

* @ValidationCode : MjoyMDYzNzQxNzIyOkNwMTI1MjoxNjgzODY4MjA2NjcwOklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjJfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 May 2023 10:40:06
...
* Call to the error message
        CALL APAP.TAM.sRedoGetEbErrorTxt(K.REC.NOT.FOUND, REDO.CUS.TXN.PARAM.ID : @VM: FN.REDO.CUS.TXN.PARAM,P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
...
* Call to the error message
        CALL APAP.TAM.sRedoGetEbErrorTxt(K.PARAMETER.IS.EMPTY, 'APP.ID' : @VM: 'S.REDO.CUS.OFS.TXN.UPDATE',P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
        P.OUT.RESPONSE = '0,': P.OUT.MSG
        RETURN
    END
...
* Call to the error message
        CALL APAP.TAM.sRedoGetEbErrorTxt(K.PARAMETER.IS.EMPTY, 'RECORD.STATUS' : @VM: 'S.REDO.CUS.OFS.TXN.UPDATE',P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
        P.OUT.RESPONSE = '0,': P.OUT.MSG
        RETURN
    END
...
* Call to the error message
        CALL APAP.TAM.sRedoGetEbErrorTxt(K.PARAMETER.IS.EMPTY, 'ID.NEW' : @VM: 'S.REDO.CUS.OFS.TXN.UPDATE',P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
        P.OUT.RESPONSE = '0,': P.OUT.MSG
        RETURN
    END
RETURN

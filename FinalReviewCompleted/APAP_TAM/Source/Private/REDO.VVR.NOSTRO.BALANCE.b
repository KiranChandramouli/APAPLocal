* @ValidationCode : MjotNTI1NjExMjQ5OkNwMTI1MjoxNjg0ODQyMTUzNjk5OklUU1M6LTE6LTE6LTcxOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
$PACKAGE APAP.TAM
SUBROUTINE REDO.VVR.NOSTRO.BALANCE
******************************************************************************
* =============================================================================
*
*=======================================================================
        ...
        BEGIN CASE
            CASE LOOP.CNT EQ 1
                IF R.NEW(TT.TE.DR.CR.MARKER) EQ "CREDIT" AND V$FUNCTION NE "R" THEN
                    WNOSTRO.ACCT = R.NEW(TT.TE.ACCOUNT.1)
                    GOSUB GET.TRAN.AMOUNT1
                    CALL APAP.REDOEB.redoAnaliseNostroBalance(WNOSTRO.ACCT,WTRAN.AMOUNT,WERROR.BAL) ;*MANUAL R22 CODE CONVERSION
                END

            CASE LOOP.CNT EQ 2
                IF R.NEW(TT.TE.DR.CR.MARKER) EQ "DEBIT" AND V$FUNCTION NE "R" THEN
                    WNOSTRO.ACCT = R.NEW(TT.TE.ACCOUNT.2)

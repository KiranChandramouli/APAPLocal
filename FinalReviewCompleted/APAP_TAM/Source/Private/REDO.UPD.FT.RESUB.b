* @ValidationCode : MjotMzQwMTkxMTU5OkNwMTI1MjoxNjg0NDkxMDQxNzU3OklUU1M6LTE6LTE6MTEzNDoxOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 May 2023 15:40:41
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1134
...
*CALL REDO.CONVERT.ACCOUNT(Y.ARR.ACC.ID,Y.ARR.ID,OUT.ID,ERR.TEXT) ;*R22 MANUAL CODE CONVERSION
    CALL APAP.TAM.redoConvertAccount(Y.ARR.ACC.ID,Y.ARR.ID,OUT.ID,ERR.TEXT) ;*R22 MANUAL CODE CONVERSION

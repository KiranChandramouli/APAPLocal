* @ValidationCode : MjotMTIzOTM4NTY2NzpDcDEyNTI6MTY4NDg0MjEzMDEwODpJVFNTOi0xOi0xOjE4NDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
PROCESS:
    ...
    APPLN = 'AZ.ACCOUNT'
    FLD = 'L.AZ.METHOD.PAY'
    CALL MULTI.GET.LOC.REF(APPLN,FLD,POSS) ;*MANUAL R22 CODE CONVERSION
    Y.PAY.POS = POSS<1,1>

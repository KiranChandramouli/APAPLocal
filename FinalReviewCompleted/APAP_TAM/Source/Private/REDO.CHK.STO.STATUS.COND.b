* @ValidationCode : MjotMjMyODUwNDQ4OkNwMTI1MjoxNjg1NTQ1MTk3MTM4OklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 May 2023 20:29:57
...
*DATE                 WHO                  REFERENCE                     DESCRIPTION
*05/04/2023      CONVERSION TOOL     AUTO R22 CODE CONVERSION           = TO EQ, FM TO @FM, VM TO @VM, SM TO @SM
...
*----------------------------------------------------------------------------------------------------------------------------------------
    ...
    ERR.MSG = ''
    EFF.DATE = ''
* APAP.TAM.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*  APAP.TAM.REDO.U.NEW.FT.IN.HOLD(ARR.ID,FT.ID,R.FUNDS.TRANSFER,R.STO) ;*MANUAL R22 CODE CONVERSION

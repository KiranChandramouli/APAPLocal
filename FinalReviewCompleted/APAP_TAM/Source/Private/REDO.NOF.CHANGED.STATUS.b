...
*APAP.REDOENQ.REDO.E.FORM.SEL.STMT(FILE.NAME, '', '',SEL.CMD) ;*MANUAL R22 CODE CONVERSION
    APAP.REDOENQ.redoEFormSelStmt(FILE.NAME, '', '',SEL.CMD) ;*MANUAL R22 CODE CONVERSION
    CLAIM.FLAG = '1'
    GOSUB GET.VALUES
RETURN
************
...
*APAP.TAM.REDO.E.FORM.SEL.STMT(FILE.NAME, '', '',SEL.CMD) ;*MANUAL R22 CODE CONVERSION
    APAP.REDOENQ.redoEFormSelStmt(FILE.NAME, '', '',SEL.CMD) ;*MANUAL R22 CODE CONVERSION
    COMPLAINT.FLAG = '1'
    GOSUB GET.VALUES
RETURN

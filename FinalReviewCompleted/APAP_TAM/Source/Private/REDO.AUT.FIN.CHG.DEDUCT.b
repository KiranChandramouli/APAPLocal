* @ValidationCode : MjoxMjc2OTEyNzA6Q3AxMjUyOjE2ODQ4NDE4NjM5MDQ6SVRTUzotMTotMToxODI5OjE6ZmFsc2U6Ti9BOlIyMl9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 23 May 2023 17:07:43
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1829
...
* APAP.REDOVER.REDO.AUT.MANU.SETTLE.CHARGE
        APAP.REDOVER.redoAutManuSettleCharge()
...
** R22 Manual conversion
* APAP.TAM.REDO.CONVERT.ACCOUNT(Y.LOAN.ACC,IN.ARR.ID,OUT.ID,ERR.TEXT)
    APAP.TAM.redoConvertAccount(Y.LOAN.ACC,IN.ARR.ID,OUT.ID,ERR.TEXT)
...
** R22 Manual conversion
*APAP.TAM.REDO.CONVERT.ACCOUNT(Y.DR.ACCOUNT,'',Y.AA.ID,ERR.TEXT)
    APAP.TAM.redoConvertAccount(Y.DR.ACCOUNT,'',Y.AA.ID,ERR.TEXT)

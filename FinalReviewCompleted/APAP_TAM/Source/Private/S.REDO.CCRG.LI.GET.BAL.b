* @ValidationCode : MjoyMDQxMzExMzcxOkNwMTI1MjoxNjgzODY3NzQxNTg2OklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjJfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 May 2023 10:32:21
...
*Get Direct Balance
    ...
    IF LCCY NE Y.CURR.CONTRACT THEN
        ...
        P.CURR.MARKET = 1
        CALL APAP.TAM.sRedoConvLocalCurr(P.CURRENCY.ID,P.CURR.MARKET,X.RETURN) ;*MANUAL R22 CODE CONVERSION

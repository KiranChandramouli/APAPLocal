...
PROCESS:
***********************
*APAP.TAM.REDO.S.NOTIFY.INTERFACE.ACT('VPL006', 'BATCH', '06', 'EMAIL SINCRONIZACION DE CLIENTES', 'INICIO - SINCRONIZACION DE CLIENTES A LAS ' : TIMEDATE(), '','', '', '', '', OPERATOR, '')     ;*R22 MANUAL CODE CONVERSION
    APAP.REDOSRTN.redoSNotifyInterfaceAct('VPL006', 'BATCH', '06', 'EMAIL SINCRONIZACION DE CLIENTES', 'INICIO - SINCRONIZACION DE CLIENTES A LAS ' : TIMEDATE(), '','', '', '', '', OPERATOR, '')     ;*R22 MANUAL CODE CONVERSION
...
*---------
    ...
    Y.CS.PATH     =CS.PATH
    APAP.TAM.redoVpUtilLog(LOG.FILE.NAME, CS.PATH, LOG.MESSAGE)    ;*R22 MANUAL CODE CONVERSION

    APAP.REDOSRTN.redoSNotifyInterfaceAct('VPL006', 'BATCH', '07', 'EMAIL SINCRONIZACION DE CLIENTES', 'FIN' : Y.ERR.LOG : '- SINCRONIZACION DE CLIENTES A LAS ' : TIMEDATE() : ' - LOG EN ' : CS.PATH : '\' : LOG.FILE.NAME, '', '', '', '', '', OPERATOR, '')     ;*R22 MANUAL CODE CONVERSION

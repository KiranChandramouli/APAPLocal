* @ValidationCode : MjoxOTU1Mjk1MDUyOkNwMTI1MjoxNjg0NDkxMDMyOTM3OklUU1M6LTE6LTE6MTA5MzoxOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 May 2023 15:40:32
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1093
...
*******************
    ...
    WHILE ACC.ID:ACCT.POS
        ...
        IF ARR.ID NE '' THEN
*APAP.TAM.REDO.CONVERT.ACCOUNT(ACC.ID,Y.ARR.ID,ARR.ID,ERR.TEXT) ;*MANUAL R22 CODE CONVERSION
            APAP.TAM.redoConvertAccount(ACC.ID,Y.ARR.ID,ARR.ID,ERR.TEXT) ;*MANUAL R22 CODE CONVERSION
*APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*APAP.TAM.REDO.AA.GET.OUT.BALANCE(ARR.ID,Y.BALANCE) ;*MANUAL R22 CODE CONVERSION
        APAP.TAM.redoAaGetOutBalance(ARR.ID,Y.BALANCE) ;*MANUAL R22 CODE CONVERSION

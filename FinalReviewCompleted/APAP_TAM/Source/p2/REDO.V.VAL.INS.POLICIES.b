* @ValidationCode : MjotNjMzMjY2NTU6Q3AxMjUyOjE2ODQ0OTEwNDY0Mzc6SVRTUzotMTotMToxMDAwOjE6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
* @ValidationInfo : Timestamp         : 19 May 2023 15:40:46
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1000
...
*CALL APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID.TERM.AMOUNT,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.comm,ERR.MSG) ;*R22 MANUAL CODE CONVERSION
    CALL APAP.AA.redoCrrGetConditions(ARR.ID.TERM.AMOUNT,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.comm,ERR.MSG) ;*R22 MANUAL CODE CONVERSION

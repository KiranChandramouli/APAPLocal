* @ValidationCode : MjotMTkyNTE0ODM3NTpDcDEyNTI6MTY4NDQ5MTAzMDgwMDpJVFNTOi0xOi0xOjE0MTc6MTpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 May 2023 15:40:30
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1417
...
*CALL APAP.TAM.REDO.GET.INTEREST.PROPERTY(ARR.INFO,PROP.NAME,OUT.PROP,ERR) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoGetInterestProperty(ARR.INFO,PROP.NAME,OUT.PROP,ERR) ;*MANUAL R22 CODE CONVERSION

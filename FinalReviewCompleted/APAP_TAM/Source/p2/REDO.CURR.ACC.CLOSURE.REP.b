...
*CALL APAP.TAM.REDO.GET.ACI.HIS(R.ACCOUNT.CREDIT.INT,Y.ACI.CUR,Y.INT.RATES) ;*MANUAL R22 CODE CONVERSION
        CALL APAP.TAM.redoGetAciHis(R.ACCOUNT.CREDIT.INT,Y.ACI.CUR,Y.INT.RATES) ;*MANUAL R22 CODE CONVERSION
    END ELSE
        GOSUB GET.GCI
    END
...
*CALL APAP.TAM.REDO.GET.HIGH.GCI(Y.GCI.ID,Y.GCI.CUR,Y.INT.RATES) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoGetHighGci(Y.GCI.ID,Y.GCI.CUR,Y.INT.RATES) ;*MANUAL R22 CODE CONVERSION

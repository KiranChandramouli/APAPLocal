* @ValidationCode : MjoxMzc4ODY0MTQwOlVURi04OjE2ODUxMDYwODM5NDk6SVRTUzotMTotMToxOTQyOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 May 2023 18:31:23
* @ValidationInfo : Encoding          : UTF-8
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1942
...
*CALL APAP.REDOENQ.REDO.NOMINA.ACCT.STATUS.CHECK(Y.ACCOUNT.ID,IN.ACCT.TYPE,OUT.ACCT.STATUS)
            CALL APAP.REDOENQ.redoNominaAcctStatusCheck(Y.ACCOUNT.ID,IN.ACCT.TYPE,OUT.ACCT.STATUS) ;*R22 Manual Conversion

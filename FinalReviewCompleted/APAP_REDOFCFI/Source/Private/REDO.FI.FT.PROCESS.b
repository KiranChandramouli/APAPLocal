...
*APAP.TAM.REDO.FI.DEBIT.PROCES.ORANGE(R.PARAM,OUT.REF, OUT.RESP)
            APAP.TAM.redoFiDebitProcesOrange(R.PARAM,OUT.REF, OUT.RESP);*R22 Manual Conversion

        CASE R.REDO.TEMP.FI.CONTROL<FI.TEMP.INTER.TYPE> EQ 'BACEN'
* APAP.TAM.REDO.FI.DEBIT.PROCES.BACEN(R.PARAM, OUT.REF, OUT.RESP)
            APAP.TAM.redoFiDebitProcesBacen(rParams, outResp, outErr) ;*R22 Manual Conversion
...
*APAP.TAM.REDO.FI.EXT.DEBIT.PROCES(R.PARAM,OUT.REF,OUT.RESP)
            APAP.TAM.redoFiExtDebitProces(R.PARAM,OUT.REF,OUT.RESP);*R22 Manual Conversion
    END CASE

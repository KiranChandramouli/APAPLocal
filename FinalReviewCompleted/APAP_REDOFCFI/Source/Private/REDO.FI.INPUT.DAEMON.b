...
*
    ...
    END
*
    CALL APAP.REDOFCFI.redoFiRecordControl(WERROR.MSG) ;*MANUAL R22 CODE CONVERSION
*
RETURN
*
* ======================
...
*Locate ID.INTERFACE.LIST
            ...
            CASE LOOP.CNT EQ 4
                ...
                WHILE Y.SETPOS : PARAM.ID AND PROCESS.GOAHEAD DO
                    ...
                    CALL APAP.REDOFCFI.redoFiGetDirList(PARAM.ID,W.ERROR) ;* MANUAL R22 CONVERSION
                    IF W.ERROR THEN
                        PROCESS.GOAHEAD = 0
                    END
                REPEAT

...
*-------
    ...
    WHILE Y.REC.CNT LE NO.OF.FI.CON
        ...
        WHILE Y.FI.TMP.CNT LE Y.FI.TMP.TOT
            ...
            CALL APAP.REDOFCFI.redoFiRecordTxnDetails(R.PARAM,OUT.RESP,OUT.REF,OUT.ARRAY) ;*R22 Manual Conversion - Added APAP.REDOFCFI
            GOSUB REPORT.FORMAT
...
*CALL APAP.TAM.REDO.FI.EXT.DEBIT.PROCES(R.PARAM, OUT.RESP, OUT.ERR)
    CALL APAP.TAM.redoFiExtDebitProces(R.PARAM, OUT.RESP, OUT.ERR) ;*R22 Manual Conversion - Added APAP.REDOFCFI
...
* CALL APAP.TAM.REDO.FI.DEBIT.PROCES.ORANGE(R.PARAM, OUT.RESP, OUT.ERR)
        CALL APAP.TAM.redoFiDebitProcesOrange(R.PARAM, OUT.RESP, OUT.ERR);*R22 Manual Conversion
...
*CALL APAP.TAM.redoFiDebitProcesBacen(R.PARAM, OUT.RESP, OUT.ERR)
        CALL APAP.TAM.redoFiDebitProcesBacen(R.PARAM, OUT.RESP, OUT.ERR);*R22 Manual Conversion
        FI.W.REDO.FI.CONTROL<REDO.FI.CON.RET.FT.REF> = OUT.RESP
        Y.COMMISSION.AMT = W.TOT.FT.ERR * (Y.PAY.COM.PERCENT/100)
        CALL EB.ROUND.AMOUNT("DOP",Y.COMMISSION.AMT,"","")
        IF Y.PAY.CATEG.ACCOUNT AND Y.COMMISSION.AMT GT 0 THEN

...
*CALL APAP.REDOCHNLS.REDO.INTERFACE.REC.ACT(FI.INTERFACES,"BATCH",WRECORD.NUMBER,Y.TOT.REC,FI.W.REDO.FI.CONTROL.ID,FI.FILE.ID,"","04",Y.ERR.MSG,Y.OUT.MSG,"","")
        CALL APAP.REDOCHNLS.redoInterfaceRecAct(FI.INTERFACES,"BATCH",WRECORD.NUMBER,Y.TOT.REC,FI.W.REDO.FI.CONTROL.ID,FI.FILE.ID,"","04",Y.ERR.MSG,Y.OUT.MSG,"","") ;*MANUAL R22 CODE CONVERSION
...
*CALL APAP.REDOCHNLS.REDO.INTERFACE.REC.ACT(FI.INTERFACES,"BATCH",WRECORD.NUMBER,Y.TOT.REC,FI.W.REDO.FI.CONTROL.ID,FI.FILE.ID,WRECORD.NUMBER,"01","OK",Y.OUT.MSG,"","")
        CALL APAP.REDOCHNLS.redoInterfaceRecAct(FI.INTERFACES,"BATCH",WRECORD.NUMBER,Y.TOT.REC,FI.W.REDO.FI.CONTROL.ID,FI.FILE.ID,WRECORD.NUMBER,"01","OK",Y.OUT.MSG,"","");*MANUAL R22 CODE CONVERSION
        IF R.PARAM<10> EQ "N" THEN
            W.REC.FT.OK += 1

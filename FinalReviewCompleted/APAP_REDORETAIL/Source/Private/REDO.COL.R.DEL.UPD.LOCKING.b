* @ValidationCode : MjoyMTMxNTQ2MzMyOkNwMTI1MjoxNjg1OTUwMzI5NTgzOklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jun 2023 13:02:09
...
*23-05-2023      MOHANRAJ R        AUTO R22 CODE CONVERSION           I TO I.VAR,FM TPO @FM,VM TO@VM
*23-05-2023      MOHANRAJ R        MANUAL R22 CODE CONVERSION         Inserted I_F.LOCKING
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_REDO.COL.DELIVERY.COMMON
    $INSERT I_F.LOCKING     ;*R22 Manual Conversion - Inserted I_F.LOCKING
*-----------------------------------------------------------------------------
...
*   Tus End
            ...
            FOR I.VAR = NUM.TABLES TO 1 STEP -1 ;*AUTO R22 CODE CONVERSION
*     Tus Start
*     LOCATE R.REDO.COL.MSG.QUEUE<1,I> IN R.LOCKING<1,1> SETTING Y.POS THEN
                LOCATE R.REDO.COL.MSG.QUEUE<1,I.VAR> IN R.LOCKING<EB.LOK.CONTENT,1> SETTING Y.POS THEN ;*AUTO R22 CODE CONVERSION
*     DEL R.LOCKING<1,Y.POS>
                    DEL R.LOCKING<EB.LOK.CONTENT,Y.POS>
*     Tus End
                END

* @ValidationCode : MjoxMjk2Mzk2NTc4OkNwMTI1MjoxNjgyNTk4MDE3OTUwOnNhbWFyOi0xOi0xOjA6MTpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
...
*-----------------------------------------------------------------------------
    ...
    GOSUB INITIALISE
    GOSUB PROCESS
*APAP.TAM.REDO.CALL.COL.FF.EXTRACT.LOAD

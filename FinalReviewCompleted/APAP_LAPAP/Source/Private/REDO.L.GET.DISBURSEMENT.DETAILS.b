* @ValidationCode : MjoxNTAwOTQ2NDYzOkNwMTI1MjoxNjg1NjkwMjMwNDYxOklUU1M6LTE6LTE6NjM0OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 02 Jun 2023 12:47:10
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 634
...
*------------------------------------------------------------------------------------------------
    ...
    REQD.MODE = ''; EFF.DATE = R.AA.ARRANGEMENT<AA.ARR.START.DATE>; R.AA.ACTIVITY.HISTORY = ''
...
* For migrated loans,
    ...
    IF Y.TOTCOMMIT.AMT ELSE   ;* For migrated contracts which are expired in legacy. then we will takeover with amount as 0. then we will do amend history with original contract date.
        ...
        ARR.PROPERTY.ID<AA.IDC.EFF.DATE> = Y.ORIG.DATE

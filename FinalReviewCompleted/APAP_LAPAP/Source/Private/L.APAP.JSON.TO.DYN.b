* @ValidationCode : MjotODQ4NzI2MDg1OkNwMTI1MjoxNjg0MjIyNzkzNDI1OklUU1M6LTE6LTE6LTI4OjE6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
...
PROCESS.DEPTH1:
*APAP.LAPAP.L.APAP.JSON.PARSE(JSON.REQUEST, Y.REQUEST.KV1 , Y.UNROLL.ARRAY, Y.ERROR)
    APAP.LAPAP.lApapJsonParse(JSON.REQUEST, Y.REQUEST.KV1 , Y.UNROLL.ARRAY, Y.ERROR);*R22 Manual Conversion - Added APAP.LAPAP
...
PROCESS.DEPTH2:
*DEBUG
*APAP.LAPAP.L.APAP.JSON.PARSE(Y.REQUEST.KV1<2,CT.I>, Y.REQUEST.KV2, Y.UNROLL.ARRAY, Y.ERROR)
    APAP.LAPAP.lApapJsonParse(Y.REQUEST.KV1<2,CT.I>, Y.REQUEST.KV2, Y.UNROLL.ARRAY, Y.ERROR);*R22 Manual Conversion - Added APAP.LAPAP
...
PROCESS.DEPTH3:
*DEBUG
*APAP.LAPAP.L.APAP.JSON.PARSE(Y.REQUEST.KV2<2,1,CT.J>, Y.REQUEST.KV3, Y.UNROLL.ARRAY, Y.ERROR)
    APAP.LAPAP.lApapJsonParse(Y.REQUEST.KV2<2,1,CT.J>, Y.REQUEST.KV3, Y.UNROLL.ARRAY, Y.ERROR);*R22 Manual Conversion - Added APAP.LAPAP

* @ValidationCode : MjotMTQ1NDE0Njk1ODpDcDEyNTI6MTY4NDg1Njg3NTQ5NDpJVFNTOi0xOi0xOi0xNToxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
SUBROUTINE DR.REG.RIEN4.AZ.REP.OUT2
*-----------------------------------------------------------------------------
*Company   Name    : APAP
...
* </region>
*-----------------------------------------------------------------------------
    Table.name = 'DR.REG.RIEN4.AZ.REP.OUT2'         ;* Full application name including product prefix
    ...
    Table.equatePrefix = 'DR.RIEN4.OUT2'  ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------

* @ValidationCode : MjoxODM3MDk3NTgyOkNwMTI1MjoxNjg0ODU2ODc1NDI5OklUU1M6LTE6LTE6LTE1OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
SUBROUTINE DR.REG.RIEN4.AZ.REP.OUT
*-----------------------------------------------------------------------------
*Company   Name    : APAP
*Developed By      : Temenos Americas
*Program   Name    : DR.REG.RIEN4.AZ.REP.OUT
*-----------------------------------------------------------------------------
...
* </region>
*-----------------------------------------------------------------------------
    Table.name = 'DR.REG.RIEN4.AZ.REP.OUT'          ;* Full application name including product prefix
    ...
    Table.equatePrefix = 'DR.RIEN4.OUT'   ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------

* @ValidationCode : Mjo3NzAxNzM4MDA6Q3AxMjUyOjE2ODQ4NTY4NzU1NjI6SVRTUzotMTotMTotMTU6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
SUBROUTINE DR.REG.RIEN4.AZ.REP.OUT3
*-----------------------------------------------------------------------------
*Company   Name    : APAP
...
* </region>
*-----------------------------------------------------------------------------
    Table.name = 'DR.REG.RIEN4.AZ.REP.OUT3'         ;* Full application name including product prefix
    ...
    Table.equatePrefix = 'DR.RIEN4.OUT3'  ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------

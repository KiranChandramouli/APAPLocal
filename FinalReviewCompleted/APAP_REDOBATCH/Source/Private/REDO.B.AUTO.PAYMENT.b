* @ValidationCode : MjoyMDc3NTk5NTI2OkNwMTI1MjoxNjg0ODU0MzgwNDMyOklUU1M6LTE6LTE6NTIwOjE6ZmFsc2U6Ti9BOlIyMl9BTVIuMDotMTotMQ==
...
*-----------------------------------------------------------------------------
    ...
    R.OVERDUE.CONDITION  = ''
    ERR.MSG              = ''
* CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.CONDITION,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.CONDITION,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    ...
    R.PAYSCH.CONDITION   = ''
    ERR.MSG              = ''
*CALL APAP.TAM.REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.PAYSCH.CONDITION,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.PAYSCH.CONDITION,ERR.MSG) ;*MANUAL R22 CODE CONVERSION

...
* Delete files of the enquieries
    APAP.REDOBATCH.redoCcrgBPopDel(P.IN.CUS.ID)
...
*  Report the error and take an action with the process
    ...
    APAP.REDOBATCH.redoCcrgBTraceError(R.SOURCE.INFO, R.MSG.ERR, @FALSE, P.IN.CUS.ID, @TRUE)
*APAP.REDOBATCH.REDO.CCRG.B.TRACE.ERROR(R.SOURCE.INFO, R.MSG.ERR, @FALSE, P.IN.CUS.ID, @TRUE) ;*R22 MANUAL CONVERSTION ADD PACKAGE
*
RETURN
*-----------------------------------------------------------------------------

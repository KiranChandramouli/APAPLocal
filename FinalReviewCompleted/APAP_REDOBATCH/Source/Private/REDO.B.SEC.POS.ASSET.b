...
* APAP.REDOBATCH.REDO.B.SEC.ASSET(Y.INV.DET) ;*R22 MANUAL CONVERSTION ADDING THE PACKAGE NAME
        APAP.REDOBATCH.redoBSecAsset(Y.INV.DET) ;*R22 MANUAL CONVERSTION ADDING THE PACKAGE NAME
    END
*
RETURN

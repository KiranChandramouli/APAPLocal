* @ValidationCode : Mjo2MTM1OTg2NzQ6Q3AxMjUyOjE2ODM4Nzk2MDQxNjY6SVRTUzotMTotMToxMzEzOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 May 2023 13:50:04
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1313
...
* RUTINA QUE ELIMINA COLLATERAL
    ...
    IF Y.BAND.DELETE THEN
        CALL APAP.TAM.redoDelClBalance(Y.ARR.ID, Y.ID.COLLATERAL);* R22 Manual conversion
    END

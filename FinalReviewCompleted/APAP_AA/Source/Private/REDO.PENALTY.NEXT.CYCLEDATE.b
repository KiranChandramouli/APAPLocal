* @ValidationCode : MjotOTU5MzE4MTY0OkNwMTI1MjoxNjgzODc4MDc1OTQ4OklUU1M6LTE6LTE6NTk4OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 May 2023 13:24:35
...
*TUS AA Changes - 20161019
    ...
    R.AA.ACC  = ''
    ERR.MSG           = ''
    CALL APAP.AA.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.AA.ACC,ERR.MSG);* R22 Manual conversion
...
*----------------------------------------------------------
    ...
    R.CONDITION  = ''
    ERR.MSG      = ''
    CALL APAP.AA.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG);* R22 Manual conversion

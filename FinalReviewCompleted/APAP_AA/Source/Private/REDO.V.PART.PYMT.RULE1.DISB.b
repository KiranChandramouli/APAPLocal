* @ValidationCode : MjoyODQ2OTE1MTk6Q3AxMjUyOjE2ODM4NzgxOTAxNTU6SVRTUzotMTotMToxNTA1OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 May 2023 13:26:30
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1505
...
PROCESS:
    ...
    IF APPLICATION EQ 'TELLER' THEN
        GOSUB TT.PROCESS
        CALL APAP.REDOVER.redoVDefTtLoanStatusCond();* R22 Manual conversion
    END
...
*Teller Process for checking the bills
    ...
    CALL APAP.AA.redoCrrGetConditions(VAR.ACCT.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG);* R22 Manual conversion

* @ValidationCode : MjoxOTM0NDYwMzIwOkNwMTI1MjoxNjgzODc4MTYwNjczOklUU1M6LTE6LTE6MTk5NjoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 May 2023 13:26:00
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1996
...
*** <desc>Here we will get the previous condition record.</desc>
    ...
    R.PROPERTY=''
    RET.ERROR=''
    CALL APAP.TAM.redoGetPropertyName(c_aalocArrId,PROPERTY.CLASS,R.OUT.AA.RECORD,ARR.PROPERTY.ID,OUT.ERR);* R22 Manual conversion
    ID.COMPONENT = ""

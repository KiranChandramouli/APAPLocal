* @ValidationCode : MjotMTM0MDExNDg0NzpDcDEyNTI6MTY4Mzg3ODA4ODcxNzpJVFNTOi0xOi0xOi05MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 May 2023 13:24:48
...
*-------------------------------------------------
    ...
    R.CONDITION.PAYSCH = ''
    ERR.MSG = ''
    CALL APAP.AA.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.PAYSCH,ERR.MSG);* R22 Manual conversion
...
* Here we will trigger the secondary activity.
    ...
    ARR.FIELD.NAME.LIST  = ""
    ARR.FIELD.VALUE.LIST = ""
    CALL APAP.TAM.redoGetPropertyName(Y.AA.ID,'PAYMENT.SCHEDULE',R.OUT.AA.RECORD,Y.PAYSCH.PROP,OUT.ERR);* R22 Manual conversion

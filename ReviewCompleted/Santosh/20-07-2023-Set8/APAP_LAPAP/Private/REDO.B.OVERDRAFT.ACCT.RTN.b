...
*13-07-2023            Conversion Tool             R22 Auto Code conversion                FM TO @FM,== TO +=1, INSERT FILE MODIFIED
...
*--------------------------------------------------------------------------------------------------------------------------------------------
    ...
    $INSERT I_F.LATAM.CARD.CUSTOMER  ;*R22 AUTO CODE CONVERSION.END
...
**********************
    ...
    Y.CUR.ID = Y.ACCT.NO
    Y.ACC.COUNT = DCOUNT(Y.ACCT.DETS,@VM) ;*R22 AUTO CODE CONVERSION
    Y.ACC.START = 1
    LOOP
    WHILE Y.ACC.START LE Y.ACC.COUNT
        ...
        Y.ACC.START += 1
    REPEAT
    CHANGE @FM TO ';' IN Y.CARD.IDS ;*R22 AUTO CODE CONVERSION
RETURN

GET.JOINT.HOLD:
***************
    JOINT.HOLD.VAL = "500":@FM:"501":@FM:"600":@FM:"601" ;*R22 AUTO CODE CONVERSION
    YCNT = 1
    LOOP
    ...
    END
    CHANGE @FM TO ';' IN Y.CLIENT.CODE ;*R22 AUTO CODE CONVERSION
RETURN
END

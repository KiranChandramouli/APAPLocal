* @ValidationCode : MjozNTA1Nzk4OTU6Q3AxMjUyOjE2ODk1ODMxMjUwMTg6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 17 Jul 2023 14:08:45
...
*13/07/2023    CONVERSION TOOL                             AUTO R22 CODE CONVERSION- VM TO @VM,FM TO @FM,F.READ TO CACHE.READ,++ TO +=1
...
* Fix for PACS00371359 [Passbook warning message not getting triggered coz of Nostro accounts]
    ...
    CALL CACHE.READ(FN.ACCOUNT.CLASS, 'NOSTRO', R.ACCT.CLASS, ER.ACC.CLASS)
...
* End of Fix
    ...
    CALL CACHE.READ(FN.ACCOUNT.CLASS, 'SAVINGS', R.ACCT.CLASS, ER.ACC.CLASS)
    SAV.ACCT.CATEG = R.ACCT.CLASS<AC.CLS.CATEGORY>
*
    FIND ACCATEG IN SAV.ACCT.CATEG SETTING SAV.FOUND.POSN1,SAV.FOUND.POSN ELSE S.VAR = ''

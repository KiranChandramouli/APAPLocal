...
*13-07-2023       Conversion Tool        R22 Auto Code conversion          INSERT FILE MODIFIED,J TO J.VAR,END ADDED
...
* The record with negative balance will not be reflected.
    IF (DAT.BALANCES EQ 0 OR DAT.BALANCES EQ '' OR DAT.BALANCES LT 0) THEN
        RETURN  ;*R22 AUTO CODE CONVERSION
    ...
    IF YPOST.REST EQ '75' OR YPOST.REST EQ '90' THEN
        RETURN  ;*R22 AUTO CODE CONVERSION
    END  ;*R22 AUTO CODE CONVERSION
...
*****************
    ...
    WHILE J.VAR LE TOT.DUE.DATE  ;*R22 AUTO CODE CONVERSION
        ...
        J.VAR = TOT.DUE.DATE + 1 ;*R22 AUTO CODE CONVERSION
    REPEAT
RETURN

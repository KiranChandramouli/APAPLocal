...
*----------------------------------------------------------------------------------------
SUBROUTINE RGS.TRANS.INV2
REM "RGS.TRANS.INV2",230614-4
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.TRANS.INV2")
    END
*
    YCOM = ID.COMPANY
*
...
*************************************************************************
    YFILE = "CATEG.ENT.TODAY"
    FULL.FNAME = "F.CATEG.ENT.TODAY"; YF.CATEG.ENT.TODAY = ""
    ...
    CALL OPF (FULL.FNAME, YF.CATEG.ENT.TODAY)
    CLEARSELECT
    ...
    WHILE WR.NEW:YDELIM
        READ YR.KEYS FROM YF.CATEG.ENT.TODAY, WR.NEW ELSE YR.KEYS = ""

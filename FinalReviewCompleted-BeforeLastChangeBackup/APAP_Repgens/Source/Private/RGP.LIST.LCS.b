* @ValidationCode : MjotMTY3MTM0NjA4NjpDcDEyNTI6MTY4ODU1NjYzODQ5NjpJVFNTOi0xOi0xOjU5NjY6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*-----------------------------------------------------------------------------
SUBROUTINE RGP.LIST.LCS
REM "RGP.LIST.LCS",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.LIST.LCS"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "FULL LETTER OF CREDIT REPORT"
    IF YPRINTING THEN
        YHDR = "RGP.LIST.LCS ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "                                        FULL LETTER OF CREDIT LISTING"

* @ValidationCode : MjoyMzQ1Mjg2OTM6Q3AxMjUyOjE2ODQ1MDIzNzgwMjY6YWppdGg6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
* CALL APAP.ATM.ATM.BRANCH.CHECK.FIELDS ;*R22 MANAUL CODE CONVERSION
    CALL APAP.ATM.atmBranchCheckFields();*R22 MANAUL CODE CONVERSION
    IF E THEN
        ETEXT = E
        CALL STORE.END.ERROR
    END ELSE

* @ValidationCode : MjotMTY3MTY2NDcxNDpDcDEyNTI6MTY5ODc1MDY3NDYxNjpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
*26/10/2023         Ajithkumar             R22 Manual Conversion         Call Rtn Format Can be mocdified , SM to @SM, VM TO @VM
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
*
...
*
            BEGIN CASE
                CASE F(AF)[4,2] = 'XX'      ;* Sv
                    NO.OF.AV = DCOUNT(R.NEW(AF), @VM) ;*R22 Manual code conversion
                    IF NO.OF.AV = 0 THEN NO.OF.AV = 1
                    FOR AV = 1 TO NO.OF.AV
                        NO.OF.SV = DCOUNT(R.NEW(AF)<1,AV>, @SM) ;*R22 Manual code conversion

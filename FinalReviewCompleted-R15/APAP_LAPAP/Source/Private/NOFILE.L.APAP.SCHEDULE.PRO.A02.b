...
*13-07-2023       Conversion Tool        R22 Auto Code conversion          INSERT FILE MODIFIED, = TO EQ
...
*------------------------------------------------------------------------------------------
    ...
    $INSERT I_F.USER  ;*R22 AUTO CODE CONVERSION.END
*-----------------------------------------------------------------------------
INIT:
    GOSUB INITILISATION
    GOSUB OPENFILES
...
*INTERNAL
    ...
    FOR Y.VM = 1 TO Y.COUNT.VM
        ...
        FOR Y.SM = 1 TO Y.COUNT.SM
            ...
            IF Y.USR.LANGUAGE EQ 1 OR  Y.PT.DESCRIPTION EQ '' THEN  ;*R22 AUTO CODE CONVERSION
...
*INTERNAL
    ...
    FOR Y.VM = 1 TO Y.COUNT.VM
        ...
        FOR Y.SM = 1 TO Y.COUNT.SM
            ...
            IF Y.USR.LANGUAGE EQ 1 OR  Y.PROP.DESCRIPTION  EQ '' THEN  ;*R22 AUTO CODE CONVERSION

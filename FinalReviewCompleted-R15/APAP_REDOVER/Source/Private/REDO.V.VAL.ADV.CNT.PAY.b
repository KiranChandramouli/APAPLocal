* @ValidationCode : MjoxNDA1ODEwNTM3OkNwMTI1MjoxNzAyOTA0Mzk0MTA4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 18 Dec 2023 18:29:54
...
*CALL F.READ(FN.AA.ACCOUNT.DETAILS.HIST,VAR.AA.ID,R.AA.ACCOUNT.DETAILS.HIST,F.AA.ACCOUNT.DETAILS.HIST,AA.AC.ERR.HIST)
    R.AA.ACCOUNT.DETAILS.HIST = AA.PaymentSchedule.AccountDetails.ReadHis(VAR.AA.ID, AA.AC.ERR.HIST)
    IF R.AA.ACCOUNT.DETAILS.HIST THEN
        
        
* R.AA.ACCOUNT.DETAILS<AA.AD.BILL.ID, -1> = R.AA.ACCOUNT.DETAILS.HIST<AA.AD.BILL.ID>
        R.AA.ACCOUNT.DETAILS<AA.PaymentSchedule.AccountDetails.AdBillId, -1> = R.AA.ACCOUNT.DETAILS.HIST<AA.PaymentSchedule.AccountDetailsHist.AdBillId>
...
* R.AA.ACCOUNT.DETAILS<AA.AD.BILL.TYPE, -1> = R.AA.ACCOUNT.DETAILS.HIST<AA.AD.BILL.TYPE>
        R.AA.ACCOUNT.DETAILS<AA.PaymentSchedule.AccountDetails.AdBillType, -1> = R.AA.ACCOUNT.DETAILS.HIST<AA.PaymentSchedule.AccountDetailsHist.AdBillType>
    END

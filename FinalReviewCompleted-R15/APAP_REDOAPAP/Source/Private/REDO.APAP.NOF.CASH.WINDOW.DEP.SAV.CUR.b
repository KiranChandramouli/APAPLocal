* @ValidationCode : MjotNjEyMzEwNTQ4OkNwMTI1MjoxNjg0ODM2MDQ1NTU5OklUU1M6LTE6LTE6Mjg5NToxOmZhbHNlOk4vQTpSMjJfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 23 May 2023 15:30:45
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 2895
...
*APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.DEP.TERM.INST.OPEN.R32(Y.CCY.LIST,TELLER.ID,R.TELLER,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR)
        APAP.REDOAPAP.redoApapNofCashWindowDepTermInstOpenR32(Y.CCY.LIST,TELLER.ID,R.TELLER,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR)
...
*APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.DEP.LOOP.MTS.R32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR)
    APAP.REDOAPAP.redoApapNofCashWindowDepLoopMtsR32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR)
    TELLER.ID = YTELLER.ID
RETURN
...
* In this para of the code, a CALL to a seperate routine is made to fetch the CREDIT CARD PAYMENT details
    ...
    YTELLER.ID = TELLER.ID
    TELLER.ID = TELLER.ID:"_":Y.CASH.TXN.TYPE:"_":Y.CASH.TXN.CODE:"_":Y.CHQ.TXN.TYPE:"_":Y.CHQ.TXN.CODE:"_":Y.TFR.TXN.TYPE:"_":Y.TFR.TXN.CODE
*APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.DEP.CCARD.PAY.R32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR);*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapNofCashWindowDepCcardPayR32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR)
    TELLER.ID = YTELLER.ID
RETURN
*--------------------------------------------------------------------------------------------------------
*************************
...
* APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.DEP.TPSP.R32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.COMPANY.LIST,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR) ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapNofCashWindowDepTpspR32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.COMPANY.LIST,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR)
RETURN
*--------------------------------------------------------------------------------------------------------
******************
GET.OTHER.INCOMES:
...
*APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.DEP.OTH.INC.R32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.COMPANY.LIST,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR) ;*R22 MANUAL CODE CONVERSION
    APAP.REDOAPAP.redoApapNofCashWindowDepOthIncR32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.COMPANY.LIST,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR)
    TELLER.ID = YTELLER.ID
RETURN
*--------------------------------------------------------------------------------------------------------
*********************
...
* In this para of the code, a CALL to a seperate routine is made to fetch the BUY CURRENCY
    LOCATE TELLER.ID IN Y.TT.LIST<1> SETTING Y.TT.POS THEN
        RETURN
    END
*    APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.DEP.BUY.R32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.COMPANY.LIST,Y.TT.LIST,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR)
    APAP.REDOAPAP.redoApapNofCashWindowDepBuyR32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.COMPANY.LIST,Y.TT.LIST,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR)
RETURN

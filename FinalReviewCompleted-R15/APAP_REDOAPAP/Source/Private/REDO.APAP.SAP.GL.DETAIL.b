...
*****************
    ...
    Y.FT.OUT.LIST=''
    APAP.REDOAPAP.redoApapSapGlDetailRptSplit1(Y.CATEG.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST) ;* MANUAL R22 CODE CONVERSION
    GOSUB WRITE.DATA.TO.SESSION.FILES
...
*-------------------------------------------------Accoiunting CR changes updated------------------------
    ...
    IF R.EB.CONTRACT.BALANCES THEN
        ...
        APAP.REDOAPAP.redoVCheckBalIntEntries(Y.ACT.ACCOUNT,BAL.CR.AMT,BAL.DR.AMT,INT.CR.AMT,INT.DR.AMT,Y.BAL.DET,Y.INT.DET) ;* MANUAL R22 CODE CONVERSION

* @ValidationCode : MjoyMDk1MjI1Nzg1OkNwMTI1MjoxNjg2ODM1Mzg0MzAzOklUU1M6LTE6LTE6MzI0OToxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 18:53:04
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 3249
...
SUBROUTINE RGS.CSH.FLOW.EXCEP
REM "RGS.CSH.FLOW.EXCEP",230614-4
*************************************************************************
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.CSH.FLOW.EXCEP")
    END
*
    YCOM = ID.COMPANY
*
...
*************************************************************************
    YFILE = "CASH.FLOW.EXCEPTION"
    FULL.FNAME = "F.CASH.FLOW.EXCEPTION"; YF.CASH.FLOW.EXCEPTION = ""
    ...
    CALL OPF (FULL.FNAME, YF.CASH.FLOW.EXCEPTION)
    CLEARSELECT
    ...
    WHILE ID.NEW:YDELIM
        MATREAD R.NEW FROM YF.CASH.FLOW.EXCEPTION, ID.NEW ELSE ID.NEW = "" ; MAT R.NEW = ""
        IF T.PWD THEN
...
* Year 2000 compliance
    ...
    YR.REC(1) = YM.ACC.ID
    YM.ACC.TITLE = ID.NEW
    IF YM.ACC.TITLE <> "" THEN
        YCOMP = "ACCOUNT_3_":YM.ACC.TITLE
        YFORFIL = YF.ACCOUNT
        YPART.S = ""; YFD.LEN = ""; YHANDLE.LNGG = 1; GOSUB 9000000
        YM.ACC.TITLE = YFOR.FD
    END
    YR.REC(2) = YM.ACC.TITLE
    YM.DATE = R.NEW(1)
    YR.REC(3) = YM.DATE
    YM.BALANCE = R.NEW(2)
    YR.REC(4) = YM.BALANCE
    YM.LIMIT.OD = R.NEW(3)
    YR.REC(5) = YM.LIMIT.OD
*
    YKEYNO = YKEYNO + 1
    IF YKEYNO > 9999 THEN
        YKEY = YKEY:YKEYNO

* @ValidationCode : MjoxMjMwNzg4MzkzOkNwMTI1MjoxNjg2OTE4OTEyMjI0OklUU1M6LTE6LTE6Mjk0MzoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 Jun 2023 18:05:12
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 2943
...
*************************************************************************
    ...
    END
    EXECUTE "HUSH ON"
    EXECUTE 'SSELECT ':FULL.FNAME:' WITH ':fldName:' <> ""':YSEL.A;* R22 Manual conversion - SELECT changed to SSELECT
    EXECUTE "HUSH OFF"

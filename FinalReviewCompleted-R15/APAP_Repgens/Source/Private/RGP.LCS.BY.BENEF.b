* @ValidationCode : Mjo3MTA1MzM3MDI6Q3AxMjUyOjE2ODg1NTY2MzY1Njc6SVRTUzotMTotMTo1OTY2OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
*-----------------------------------------------------------------------------
SUBROUTINE RGP.LCS.BY.BENEF
REM "RGP.LCS.BY.BENEF",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.LCS.BY.BENEF"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "LETTER OF CREDITS BY BENEFICIARY"
    IF YPRINTING THEN
        YHDR = "RGP.LCS.BY.BENEF ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "                                        LETTER OF CREDITS BY BENEFICIARY"
    YHDR2 = "           BENEFICIARY NAME               LC NUMBER   TYPE     EXTERNAL REFERENCE CURRENCY   AMOUNT        ISSUE      EXPIRY"
    YHDR3 = "                                                                                                            DATE       DATE"
    YHDR4 = "------------------------------------------------------------------------------------------------------------------------------------"

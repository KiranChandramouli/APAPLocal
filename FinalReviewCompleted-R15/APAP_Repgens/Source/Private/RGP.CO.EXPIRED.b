* @ValidationCode : MjoyMTIzNzk0MTUyOkNwMTI1MjoxNjg2OTE4OTA2MTQxOklUU1M6LTE6LTE6MTM1MzQ6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jun 2023 18:05:06
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 13534
...
SUBROUTINE RGP.CO.EXPIRED
REM "RGP.CO.EXPIRED",230614-4
*-----------------------------------------------------------------------------------------------------------------------
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.CO.EXPIRED"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "COLLATERAL EXPIRED"
    IF YPRINTING THEN
        YHDR = "RGP.CO.EXPIRED ":YHDR
    ...
    YHDR3 = " DATE CUSTOMER                           COLLATERAL TYPE & NO CCY                VALUE VALUE VALUE DESCRIP              TION"
    YHDR4 = "------------------------------------------------------------------------------------------------------------------------------------"

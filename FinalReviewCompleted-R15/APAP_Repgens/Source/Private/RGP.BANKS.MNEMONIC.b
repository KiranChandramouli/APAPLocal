* @ValidationCode : MjotMTc2Nzg0NDM4MDpDcDEyNTI6MTY4NjkxODkwNDk2NDpJVFNTOi0xOi0xOjQzNjc6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jun 2023 18:05:04
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 4367
...
SUBROUTINE RGP.BANKS.MNEMONIC
REM "RGP.BANKS.MNEMONIC",230614-4
*-----------------------------------------------------------------------------------------------------------------------
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.BANKS.MNEMONIC"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "MNEMONIC        SHORT-NAME                          ID-NUMBER"
    YHDR2 = ""
    YHDR3 = ""
    YHDR4 = ""
...
*------------------------------------------------------------------------
    ...
    LOOP WHILE YKEYFD = "" DO
        ...
        YFD = YR.REC(1)  ;* YM.MNEMO
        YFD = FMT(YFD,"10L")
        IF LEN(YFD) > 10 THEN YFD = YFD[1,9]:"|"
        YTOTFD := YFD
        YFD = YR.REC(2)  ;* YM.SHORTNAME
        YFD = FMT(YFD,"35L")

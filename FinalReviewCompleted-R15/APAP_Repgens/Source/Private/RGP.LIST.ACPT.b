* @ValidationCode : MjozNzU1ODUwNTE6Q3AxMjUyOjE2ODg1NTY2MzgwMzQ6SVRTUzotMTotMTo1MTM4OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jul 2023 17:00:38
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 5138
...
*-----------------------------------------------------------------------------
SUBROUTINE RGP.LIST.ACPT
REM "RGP.LIST.ACPT",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "ACCEPTANCE / DEFERRED REPORT"
    IF YPRINTING THEN
        YHDR = "RGP.LIST.ACPT ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "                                        FULL ACCEPTANCE / DEFERRED DRAWINGS"
    YHDR2 = ""

...
SUBROUTINE RGP.EXCEPT.LOG.EOD
REM "RGP.EXCEPT.LOG.EOD",230614-4
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "EXCEPTION LOG EOD"
    IF YPRINTING THEN
        YHDR = "RGP.EXCEPT.LOG.EOD ":YHDR
...
9100010:
    ...
    BEGIN CASE
        ...
        CASE 1
            E = ""; L = 22; CALL ERR; GOSUB 9100010 ;*r22 manual code coversion
    END CASE
*
    IF NEXTP < 1 THEN
        NEXTP = 1

* @ValidationCode : MjoxMTM5MDY3MjY5OkNwMTI1MjoxNjg2ODM1MzgzNjM4OklUU1M6LTE6LTE6NzM5MjoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 18:53:03
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 7392
...
SUBROUTINE RGS.CO.EXPIRY
REM "RGS.CO.EXPIRY",230614-4
* MODIFICATION HISTORY:
* DATE          WHO            REFERENCE                  DESCRIPTION
* 15-JUNE-2023 Narmadha V     R22 Manual conversion     SELECT changed to SSELECT
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.CO.EXPIRY")
    END
*************************************************************************
...
*************************************************************************
    ...
    END
    EXECUTE "HUSH ON"
    EXECUTE 'SSELECT ':FULL.FNAME:' WITH ':fldName:' <> "" AND ':fldName2:' <> "LIQ"':YSEL.A;* R22 Manual conversion - SELECT changed to SSELECT
    EXECUTE "HUSH OFF"
...
* Handle Decision Table
            ...
            IF YM.EXPIRY.DATE <= YM.REPORT.DATE THEN
                GOSUB 2000000
            END
        END
*

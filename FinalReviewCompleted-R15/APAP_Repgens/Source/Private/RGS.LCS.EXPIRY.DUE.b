* @ValidationCode : MjotMTE0OTc1ODIzNzpDcDEyNTI6MTY4ODU0NTc1MzY2MDpJVFNTOi0xOi0xOjM0ODk6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jul 2023 13:59:13
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 3489
...
*-----------------------------------------------------------------------------------------------
SUBROUTINE RGS.LCS.EXPIRY.DUE
REM "RGS.LCS.EXPIRY.DUE",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.LCS.EXPIRY.DUE")
    END
*
    YCOM = ID.COMPANY
*

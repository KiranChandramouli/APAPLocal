* @ValidationCode : MjotMTQ1ODQ2OTE5MTpDcDEyNTI6MTY4ODU1NjYzODkxODpJVFNTOi0xOi0xOjU5NjY6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jul 2023 17:00:38
...
*-----------------------------------------------------------------------------
SUBROUTINE RGP.LIST.PRE.LCS
REM "RGP.LIST.PRE.LCS",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.LIST.PRE.LCS"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "LETTER OF CREDITS PRE-ADVISED"
    IF YPRINTING THEN
        YHDR = "RGP.LIST.PRE.LCS ":YHDR
        YTYPE = "HEADER":@FM:YHDR
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "                                        PRE-ADVISED LETTERS OF CREDIT"
    YHDR2 = "  LC NUMBER  TYPE     EXTERNAL REFERENCECURRENCY     LC AMOUNT   ISSUE      EXPIIRY                  CUSTOMER/ISSUING   SHORT NAME"
    YHDR3 = "                                                                  DATE       DATE"
    YHDR4 = "------------------------------------------------------------------------------------------------------------------------"

* @ValidationCode : MjoyMDcxMjkxNzg3OkNwMTI1MjoxNjg0ODUxOTgzNTczOklUU1M6LTE6LTE6MzY2NjoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 23 May 2023 19:56:23
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 3666
...
*If the count is 2 then get the dates in DATE.1 and DATE.2 and call the routine REDO.GET.MTH.DETAILS with parameters
    ...
    Y.REJ.CHQ.CNT = ''
    IF Y.COUNT EQ '2' THEN
        APAP.TAM.redoGetMthDetails(Y.TXN.DATE1,Y.TXN.DATE2,OUT.MONTH,OUT.DATE,OUT.COUNT,OUT.MTH.DATE);*R22 Manual Conversion

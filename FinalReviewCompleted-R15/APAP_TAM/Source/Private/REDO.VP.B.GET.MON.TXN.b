* @ValidationCode : MjotMTczOTI2Mzc0MzpDcDEyNTI6MTY4NDg0MjE1MjY3ODpJVFNTOi0xOi0xOjE0MzU6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 23 May 2023 17:12:32
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1435
...
*19/04/2023         SURESH           MANUAL R22 CODE CONVERSION       CALL routine format modified,R22 interface Unit testing changes
*-----------------------------------------------------------------------------
...
* Log writing: process started
    APAP.REDOSRTN.redoSNotifyInterfaceAct ('VPL001', 'BATCH', '06', 'EMAIL ARCHIVO MONETARIO', 'INICIO - PROCESO MONETARIO A LAS ' : TIMEDATE(), '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION
...
* Each batch might have upto 998 items
    ...
    D.CASH.BACK = FMT(D.CASH.BACK,'R2') ;*R22 interface Unit testing changes

* @ValidationCode : MjozNDkyNzIxOTU6Q3AxMjUyOjE2ODQ0OTEwMzAyOTY6SVRTUzotMTotMTo3NDoxOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
...
*CALL REDO.CONVERT.ACCOUNT(Y.ARR.ID,IN.ARR.ID,OUT.ID,ERR.TEXT)  ;*R22 MANUAL CODE CONVERSION
            APAP.TAM.redoConvertAccount(Y.ARR.ID,IN.ARR.ID,OUT.ID,ERR.TEXT) ;*R22 MANUAL CODE CONVERSION
            Y.ARRAY<-1> = OUT.ID
        REPEAT

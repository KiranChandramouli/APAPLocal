...
* Call to the error message
        APAP.TAM.sRedoGetEbErrorTxt(K.REC.NOT.FOUND, REDO.CUS.TXN.PARAM.ID : @VM: FN.REDO.CUS.TXN.PARAM,P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
...
* Call to the error message
        APAP.TAM.sRedoGetEbErrorTxt(K.PARAMETER.IS.EMPTY, 'APP.ID' : @VM: 'S.REDO.CUS.OFS.TXN.UPDATE',P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
        P.OUT.RESPONSE = '0,': P.OUT.MSG
        RETURN
    END
...
* Call to the error message
        APAP.TAM.sRedoGetEbErrorTxt(K.PARAMETER.IS.EMPTY, 'RECORD.STATUS' : @VM: 'S.REDO.CUS.OFS.TXN.UPDATE',P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
        P.OUT.RESPONSE = '0,': P.OUT.MSG
        RETURN
    END
...
* Call to the error message
        APAP.TAM.sRedoGetEbErrorTxt(K.PARAMETER.IS.EMPTY, 'ID.NEW' : @VM: 'S.REDO.CUS.OFS.TXN.UPDATE',P.OUT.MSG) ;*MANUAL R22 CODE CONVERSION
        P.OUT.RESPONSE = '0,': P.OUT.MSG
        RETURN
    END
RETURN

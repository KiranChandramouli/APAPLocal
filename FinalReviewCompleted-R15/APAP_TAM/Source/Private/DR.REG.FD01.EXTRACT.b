* @ValidationCode : MjotMzkxODU1NDkzOkNwMTI1MjoxNjg1NjIxMzExNDg5OklUU1M6LTE6LTE6MjUwNDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 01 Jun 2023 17:38:31
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 2504
...
*30/05/2023      CONVERSION TOOL         AUTO R22 CODE CONVERSION              BP Removed in insertfile, = to EQ
*30/05/2023      HARISH VIKRAM            MANUAL R22 CODE CONVERSION         CALL routine format modified, L.FTTC.CHANNELS.POS,L.FT.CHANNELS.POS   added in insert file   I_DR.REG.FD01.EXTRACT.COMMON
...
*----------------------------------------------------------------------------------------
    ...
    $INSERT I_F.REDO.ID.CARD.CHECK ;*AUTO R22 CODE CONVERSION

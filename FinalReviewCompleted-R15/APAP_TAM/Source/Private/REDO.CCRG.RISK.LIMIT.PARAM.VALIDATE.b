* @ValidationCode : MjotMTQ4OTI3NDA1MzpDcDEyNTI6MTY4NDg0MTg5NTA5ODpJVFNTOi0xOi0xOi0xMTA6MTpmYWxzZTpOL0E6UjIyX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 23 May 2023 17:08:15
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : -110
...
*APAP.TAM.REDO.CCRG.ALLOWED.APP('VALIDATE', Y.APPLICATION)
        APAP.TAM.redoCcrgAllowedApp('VALIDATE', Y.APPLICATION) ;*R22 Manual Conversion
        IF END.ERROR THEN
            RETURN
        END
...
* APAP.TAM.REDO.R.MULTI.GET.FIELD.NO(Y.APPLICATION,Y.FIELD.NO, R.STANDARD.SELECTION, Y.FIELD.POS)
        APAP.TAM.redoRMultiGetFieldNo(Y.APPLICATION,Y.FIELD.NO, R.STANDARD.SELECTION, Y.FIELD.POS) ;*R22 Manual Conversion
...
* All fields
* APAP.TAM.REDO.CCRG.VALIDATE.CONDITIONS(R.CONDITIONS, R.VALUES) ;* R22 Manual Conversion
        APAP.TAM.redoCcrgValidateConditions(R.CONDITIONS, R.VALUES) ;*R22 Manual Conversion
        IF END.ERROR THEN
            RETURN
        END
    NEXT J.VAR  ;*Fields

* @ValidationCode : MjotOTI1Mjc2ODQ6Q3AxMjUyOjE2ODI1OTgwMTM2NDY6c2FtYXI6LTE6LTE6MDoxOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
...
*APAP.REDORETAIL.REDO.AZ.PENAL.AMT.CALC(Y.VALUE,Y.PREC.DEP.DAYS,PEN.AMT)
        APAP.REDORETAIL.redoAzPenalAmtCalc(Y.VALUE,Y.PREC.DEP.DAYS,PEN.AMT);*MANUAL R22 CODE CONVERSION
...
*APAP.REDORETAIL.REDO.AZ.PENAL.AMT.CALC(Y.PENAL.PER,Y.PREC.DEP.DAYS,PEN.AMT)
    APAP.REDORETAIL.redoAzPenalAmtCalc(Y.PENAL.PER,Y.PREC.DEP.DAYS,PEN.AMT);*MANUAL R22 CODE CONVERSION
    R.NEW(AZ.LOCAL.REF)<1,LOC.L.AZ.PENAL.AMT> = PEN.AMT

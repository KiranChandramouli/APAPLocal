...
*HAS TO BE EMPTY
        ...
        ELSE
            ...
            C.ID.PROC = QUEUE.ID
            C.DESC    = R.QUEUE.REC
*APAP.REDOCHNLS.REDO.INTERFACE.REC.ACT(C.INT.CODE,C.INT.TYPE,C.BAT.NO,C.BAT.TOT,C.INFO.OR,C.INFO.DE,C.ID.PROC,C.MON.TP,C.DESC,C.REC.CON,C.EX.USER,C.EX.PC)

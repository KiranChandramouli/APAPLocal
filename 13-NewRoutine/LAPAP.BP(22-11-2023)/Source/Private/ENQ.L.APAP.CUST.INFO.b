...
**------------------------------
    ...
    L.TIP.CLI.POS = FLD.POS.ARR<1,5> ;*R22 NEW LINE
    L.CU.TEL.AREA.POS = FLD.POS.ARR<1,6> ;*R22 NEW LINE
    L.CU.TEL.NO.POS = FLD.POS.ARR<1,7> ;*R22 NEW LINE
**-----------------------------------------------------
...
**------------------------------------------------------------------------------------------------------------------------------------
    ...
    Y.L.TIP.CLI = R.CUS<EB.CUS.LOCAL.REF, L.TIP.CLI.POS,1> ;*R22 NEW LINE - START
    Y.MARITAL.STATUS = R.CUS<EB.CUS.MARITAL.STATUS>
    Y.CUSTOMER.NO = CUSTOMER.IDE ;*R22 NEW LINE - END
    ...
    Y.L.CU.TEL.NO = R.CUS<EB.CUS.LOCAL.REF, L.CU.TEL.NO.POS> ;*R22 NEW LINE - START
    Y.TEL.1 = R.CUS<EB.CUS.LOCAL.REF, L.CU.TEL.AREA.POS,1> : '-':R.CUS<EB.CUS.LOCAL.REF, L.CU.TEL.NO.POS,1>
    Y.TEL.2 = R.CUS<EB.CUS.LOCAL.REF, L.CU.TEL.AREA.POS,2> : '-':R.CUS<EB.CUS.LOCAL.REF, L.CU.TEL.NO.POS,2> ;*R22 NEW LINE - END
    Y.IDENTIFICACION = ''
    ...
    END ;*R22 NEW LINE
    ELSE ;*R22 NEW LINE
        Y.IDENTIFICACION = Y.CUSTOMER.NO ;*R22 NEW LINE
    END
*DEBUG
**------------------------------------------------------------------------------------------------------------------------------------
**------------------------------------------------------------------------------------------------------------------------------------

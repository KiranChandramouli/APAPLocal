* @ValidationCode : MjotNzg2MjczMjIwOkNwMTI1MjoxNjgzODc4MjMwMjUyOklUU1M6LTE6LTE6MTQzMToxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 May 2023 13:27:10
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1431
...
GET.OUTS.PRIN:
    ...
    Y.ACCOUNT.PROPERTY = ''
    OUT.ERR = ''
    CALL APAP.TAM.redoGetPropertyName(Y.AA.ID,'ACCOUNT',R.OUT.AA.RECORD,Y.ACCOUNT.PROPERTY,OUT.ERR);* R22 Manual conversion

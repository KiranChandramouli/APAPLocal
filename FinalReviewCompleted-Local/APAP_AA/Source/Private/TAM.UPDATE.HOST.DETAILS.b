* @ValidationCode : MjoxNDY2MTc5NTgyOkNwMTI1MjoxNjgzNjk4NDQ1ODgyOklUU1M6LTE6LTE6MzYxOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 10 May 2023 11:30:45
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 361
...
* R.NEW(V-8) is the field RECORD.STATUS, to check for the status of the record to trace.
    ...
    IF (((R.OLD(V-7) NE '' OR V$FUNCTION EQ "D") AND (Y.RECORD.STATUS[1,2] EQ "IN" OR Y.RECORD.STATUS[1,2] EQ "RN" OR V$FUNCTION EQ "D")) OR (R.NEW(V-7) EQ 1 AND Y.RECORD.STATUS[1,2] EQ "IN")) THEN
        CALL APAP.REDOAPAP.redoApplAuditTrack(Y.HOST.NAME,Y.IP.ADDRESS,R.STANDARD.SELECTION) ;*MANUAL R22 CODE CONVERSION
    END

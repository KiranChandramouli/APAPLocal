* @ValidationCode : Mjo5MjY4NTExMTM6Q3AxMjUyOjE2ODM4NzgwMTA5NTk6SVRTUzotMTotMTo4MjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 12 May 2023 13:23:30
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 820
...
*---------------------------------------------------------------------------
    ...
    IN.ACC.ID = ""
    CALL APAP.TAM.redoConvertAccount(IN.ACC.ID,Y.AA.ID,Y.AC.ID,ERR.TEXT);* R22 Manual conversion
...
*---------------------------------------------------------------
    ...
    Y.ACCOUNT.PROPERTY = ""
    CALL APAP.TAM.redoGetPropertyName(Y.AA.ID,IN.PROPERTY.CLASS,R.OUT.AA.RECORD,Y.ACCOUNT.PROPERTY,OUT.ERR);* R22 Manual conversion
    ...
    ERR.MSG     = ''
    R.OVERDUE.COND   = ''
    CALL APAP.AA.redoCrrGetConditions(Y.AA.ID,EFFEC.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.COND,ERR.MSG);* R22 Manual conversion
...
*--------------------------------------------------------
    ...
    IF Y.INTERNAL.ACC THEN
        ...
        CALL APAP.TAM.redoNabCreateIntAcc(Y.LOAN.CO.CODE,Y.INTERNAL.ACC,Y.RET.INT.ACC);* R22 Manual conversion

* @ValidationCode : MjotODkwMzM1ODAyOkNwMTI1MjoxNjgzODgwMTM5Njg1OklUU1M6LTE6LTE6Njc2OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 May 2023 13:58:59
...
*--------------------------------------------------------------
    ...
    LOCATE Y.PENALTY.PROPERTY IN R.NEW(REDO.AA.BD.PROPERTY)<1,1> SETTING PROP.POS THEN
        CALL APAP.TAM.redoGetAdjustedAmount(Y.PENALTY.PROPERTY,Y.BILL.REF,Y.BILL.CHARGE);* R22 Manual conversion

...
* PACS00761324 END
    ...
    IN.ARR.ID = ''
*CALL APAP.TAM.REDO.CONVERT.ACCOUNT(ACC.ID,IN.ARR.ID,OUT.ID,ERR.TEXT) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.TAM.redoConvertAccount(ACC.ID,IN.ARR.ID,OUT.ID,ERR.TEXT) ;*MANUAL R22 CODE CONVERSION
    ARR.ID = OUT.ID
...
*---------------------------------------------------
    ...
    OPTIONS = ''
*CALL APAP.TAM.REDO.AA.BUILD.OFS(ARR.ID,Y.PRIN.RATE.ARRAY.OFS,Y.ACT.PROP,OFS.STRING.PRIN) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.AA.redoAaBuildOfs(ARR.ID,Y.PRIN.RATE.ARRAY.OFS,Y.ACT.PROP,OFS.STRING.PRIN) ;*MANUAL R22 CODE CONVERSION
...
*OFS.STRING.FINAL = ''
* CALL APAP.AA.REDO.AA.BUILD.OFS(ARR.ID,Y.PENAL.RATE.ARRAY.OFS,Y.ACT.PROP,OFS.STRING.PENAL) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.AA.redoAaBuildOfs(ARR.ID,Y.PENAL.RATE.ARRAY.OFS,Y.ACT.PROP,OFS.STRING.PENAL) ;*MANUAL R22 CODE CONVERSION
...
*CALL APAP.AA.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PRINCIPAL.PROPERTY,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.AA.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PRINCIPAL.PROPERTY,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*---------------------------------------------------
    ...
    ERR.MSG = ''
    R.PENALTY.PROPERTY = ''
*CALL APAP.AA.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PENALTY.PROPERTY,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.AA.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PENALTY.PROPERTY,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*CALL APAP.AA.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.TERM.PROPERTY,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.AA.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.TERM.PROPERTY,ERR.MSG) ;*MANUAL R22 CODE CONVERSION

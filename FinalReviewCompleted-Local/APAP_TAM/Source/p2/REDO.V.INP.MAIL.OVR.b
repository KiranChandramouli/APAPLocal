* @ValidationCode : MjotOTUyNzgwNzE6Q3AxMjUyOjE2ODQ0OTEwNDQzOTM6SVRTUzotMTotMToxNDQ1OjE6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
...
*CALL APAP.REDOVER.redoVCallUsdEqv(Y.USD.AMOUNT,Y.REC.STATUS,Y.CURR.NO) ;* R22 Manual conversion - CALL method format changed
    CALL APAP.REDOVER.redoVCallUsdEqv(Y.USD.AMOUNT,Y.REC.STATUS,Y.CURR.NO) ;*R22 MANUAL CODE CONVERSION

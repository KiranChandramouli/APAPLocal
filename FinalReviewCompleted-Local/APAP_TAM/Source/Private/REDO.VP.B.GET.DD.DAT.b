* @ValidationCode : MjoxMTcyNjE2NjkxOkNwMTI1MjoxNjg0ODQyMTUyNjIxOklUU1M6LTE6LTE6MTQ2OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 23 May 2023 17:12:32
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 146
...
* Log writing: process started
    CALL APAP.REDOSRTN.redoSNotifyInterfaceAct ('VPL004', 'BATCH', '06', 'EMAIL ARCHIVO DEBITO DIRECTO', 'INICIO - DEBITO DIRECTO A LAS ' : TIMEDATE(), '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION
...
* Read the input file
    OPENSEQ DD.PATH, DD.FILE TO DD.FILE.POINTER THEN
        ...
        REPEAT
    END ELSE
        CALL APAP.REDOSRTN.redoSNotifyInterfaceAct ('VPL004', 'BATCH', '06', 'EMAIL ARCHIVO DEBITO DIRECTO', 'DEBITO DIRECTO ARCHIVO NO ENCONTRADO EN ' : DD.PATH : '/' : DD.FILE, '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION
        CALL FATAL.ERROR('ERROR: Archivo no encontrado: ' : DD.FILE)
    END

    IF NOT(READ.FILE) THEN
        CALL APAP.REDOSRTN.redoSNotifyInterfaceAct ('VPL004', 'BATCH', '06', 'EMAIL ARCHIVO DEBITO DIRECTO', 'DEBITO DIRECTO ARCHIVO NO SE PUDO LEER EN ' : DD.PATH : '/' : DD.FILE, '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION
        CALL FATAL.ERROR('ERROR: Archivo no encontrado: ' : DD.FILE)
    END

...
** R22 Manual conversion
        CALL APAP.REDOVER.redoVValPdisAmt(Y.CRD.AC)
    END
...
** R22 Manual conversion
    CALL APAP.TAM.redoConvertAccount(ACC.ID,Y.ARR.ID,ARR.ID,ERR.TEXT)
*CALL REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG)
** R22 Manual conversion
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG)
    LOAN.STATUS = R.Condition<AA.OD.LOCAL.REF,OD.LOAN.STATUS.POS>
...
** R22 Manual conversion
        CALL APAP.TAM.redoConvertAccount(Y.DEBIT.ACCT.NO,'',OUT.ID,ERR.TEXT)
        Y.ARR.ID = OUT.ID
...
** R22 Manual conversion
        CALL APAP.AA.redoCrrGetConditions(Y.ARR.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.Condition,ERR.MSG)

* @ValidationCode : Mjo1NDgwNDg0MDI6Q3AxMjUyOjE2ODQ0OTEwMjczMDQ6SVRTUzotMTotMTotNjI6MTpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
...
* Here we gets the overdue status of that particular arrangement
    ...
    R.OVERDUE.CONDITION = ''
    ERR.MSG = ''
*APAP.AA.REDO.CRR.GET.CONDITIONS(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.CONDITION,ERR.MSG)   ;*R22 MANAUAL CODE CONVERSION
    APAP.AA.redoCrrGetConditions(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.CONDITION,ERR.MSG) ;*R22 MANAUAL CODE CONVERSION
...
*CALL REDO.GET.PROPERTY.NAME(Y.ARR.ID,'ACCOUNT',R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)   ;*R22 MANAUAL CODE CONVERSION
    APAP.TAM.redoGetPropertyName(Y.ARR.ID,'ACCOUNT',R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)   ;*R22 MANAUAL CODE CONVERSION
    OUT.ID=''
    IN.ACC.ID=''
*APAP.TAM.REDO.CONVERT.ACCOUNT(IN.ACC.ID,Y.ARR.ID,OUT.ID,ERR.TEXT)   ;*R22 MANAUAL CODE CONVERSION
    APAP.TAM.redoConvertAccount(IN.ACC.ID,Y.ARR.ID,OUT.ID,ERR.TEXT) ;*R22 MANAUAL CODE CONVERSION
...
*CALL AA.GET.ECB.BALANCE.AMOUNT(OUT.ID,BALANCE.TO.CHECK,TODAY,BALANCE.AMOUNT,RET.ERROR) ;*R22 MANAUAL CODE CONVERSION
        APAP.AA.redoAaGetEcbBalanceAmount(OUT.ID,BALANCE.TO.CHECK,TODAY,BALANCE.AMOUNT,RET.ERROR) ;*R22 MANAUAL CODE CONVERSION
...
*CALL REDO.GET.PROPERTY.NAME(Y.ARR.ID,'INTEREST',R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)   ;*R22 MANUAL CODE CONVERSION
    APAP.TAM.redoGetPropertyName(Y.ARR.ID,'INTEREST',R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)  ;*R22 MANUAL CODE CONVERSION
...
*CALL AA.GET.ECB.BALANCE.AMOUNT(OUT.ID,BALANCE.TO.CHECK,TODAY,BALANCE.AMOUNT,RET.ERROR) ;*R22 MANUAL CODE CONVERSION
            APAP.AA.redoAaGetEcbBalanceAmount(OUT.ID,BALANCE.TO.CHECK,TODAY,BALANCE.AMOUNT,RET.ERROR) ;*R22 MANUAL CODE CONVERSION
...
*CALL REDO.GET.PROPERTY.NAME(Y.ARR.ID,'CHARGE',R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)   ;*R22 MANUAL CODE CONVERSION
    APAP.TAM.redoGetPropertyName(Y.ARR.ID,'CHARGE',R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)  ;*R22 MANUAL CODE CONVERSION

* @ValidationCode : MjotMjAwNjk1Njg2NDpDcDEyNTI6MTY4NDg1MTk4MTM0ODpJVFNTOi0xOi0xOjE1MDU6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*************
    ...
    CALL APAP.TAM.redoGetPropertyName(AA.ARRANGEMENT.ID,IN.PROPERTY.CLASS,R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)
...
****************************
    ...
    TOT.DUE = ABS(TOT.DUE)
    Y.DATE = TODAY
    CALL APAP.TAM.redoGetNextPaymentAmount(AA.ARRANGEMENT.ID,Y.DATE,Y.FEE)

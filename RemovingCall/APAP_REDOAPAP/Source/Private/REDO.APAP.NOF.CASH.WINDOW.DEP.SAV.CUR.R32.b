* @ValidationCode : MjoxMDA3NDQ1NTEzOkNwMTI1MjoxNjg0ODM2MDQ1MzY5OklUU1M6LTE6LTE6NDU3MzoxOmZhbHNlOk4vQTpSMjJfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 23 May 2023 15:30:45
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 4573
...
* In this para of the code, a CALL to a seperate routine is made to fetch the CREDIT CARD PAYMENT details
    ...
    YTELLER.ID = TELLER.ID
    TELLER.ID = TELLER.ID:"_":Y.CASH.TXN.TYPE:"_":Y.CASH.TXN.CODE:"_":Y.CHQ.TXN.TYPE:"_":Y.CHQ.TXN.CODE:"_":Y.TFR.TXN.TYPE:"_":Y.TFR.TXN.CODE
    CALL APAP.REDOAPAP.redoApapNofCashWindowDepCcardPayR32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,R.REDO.H.TELLER.TXN.CODES,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR) ;*R22 MANUAL CODE CONVERSION
    TELLER.ID = YTELLER.ID
RETURN
*--------------------------------------------------------------------------------------------------------
*************************
...
* In this para of the code, a CALL to a seperate routine is made to fetch the THIRD PARTY SERVICE PAYMENT details
    ...
    CALL APAP.REDOAPAP.redoApapNofCashWindowDepTpspR32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.COMPANY.LIST,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR) ;*R22 MANUAL CODE CONVERSION
RETURN
*--------------------------------------------------------------------------------------------------------
******************
GET.OTHER.INCOMES:
...
* In this para of the code, a CALL to a seperate routine is made to fetch the OTHER INCOMES details
    ...
    CALL APAP.REDOAPAP.redoApapNofCashWindowDepOthIncR32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.COMPANY.LIST,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR) ;*R22 MANUAL CODE CONVERSION
    TELLER.ID = YTELLER.ID
RETURN
*--------------------------------------------------------------------------------------------------------
*********************
...
*CALL APAP.REDOAPAP.REDO.APAP.NOF.CASH.WINDOW.DEP.CTFT.R32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.COMPANY.LIST,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR,R.REDO.H.TELLER.TXN.CODES) ;*R22 MANUAL CODE CONVERSION
    CALL APAP.REDOAPAP.redoApapNofCashWindowDepCtftR32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.COMPANY.LIST,Y.FINAL.ARRAY,Y.TT.LIST,SET.CUR,Y.DUP.CUR,R.REDO.H.TELLER.TXN.CODES)
    TELLER.ID = YTELLER.ID
RETURN
*--------------------------------------------------------------------------------------------------------
*****************
...
* In this para of the code, a CALL to a seperate routine is made to fetch the BUY CURRENCY
    ...
    YTELLER.ID = TELLER.ID
    TELLER.ID = TELLER.ID:"_":Y.CASH.DEP.FLAG:"_":Y.CHQ.DEP.FLAG:"_":Y.TFR.DEP.FLAG
    CALL APAP.REDOAPAP.redoApapNofCashWindowDepBuyR32(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.COMPANY.LIST,Y.TT.LIST,Y.FINAL.ARRAY,SET.CUR,Y.DUP.CUR) ;*R22 MANUAL CODE CONVERSION
    TELLER.ID = YTELLER.ID
RETURN

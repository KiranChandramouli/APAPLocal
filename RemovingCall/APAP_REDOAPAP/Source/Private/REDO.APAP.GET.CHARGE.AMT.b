* @ValidationCode : MjotNDUzMzcyNTc1OkNwMTI1MjoxNjg0ODM2MDQwODE4OklUU1M6LTE6LTE6LTQ1OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
* This part get the charge properties for that loan
    ...
    CALL APAP.TAM.redoGetPropertyName(ARR.ID,'CHARGE',R.OUT.AA.RECORD,Y.CHARGE.PROPERTY,OUT.ERR);* R22 Manual conversion

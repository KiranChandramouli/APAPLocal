* @ValidationCode : MjotNzM5MjIwMzQ3OkNwMTI1MjoxNjg0MjIyODE3NzA5OklUU1M6LTE6LTE6MTg2MToxOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 May 2023 13:10:17
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1861
...
*21-04-2023            Conversion Tool             R22 Auto Code conversion                FM TO @FM,VM TO @VM,F.READ TO CACHE.READ, INSERT FILE MODIFIED,IF CONDITION ADDED
...
*
    $INSERT I_System
    $INSERT I_REDO.FX.OVR.COMMON    ;*R22 AUTO CODE CONVERSION.END
*
    GOSUB OPEN.FILES
    GOSUB GET.LOCAL.REF
    GOSUB PROCESS

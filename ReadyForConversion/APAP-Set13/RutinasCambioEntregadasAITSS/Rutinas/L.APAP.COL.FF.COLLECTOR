...
*---------------------------------------------------------------------------------------------------
        ...
        CASE R.REDO.COL.QUEUE<1> EQ 'gesgarantias'
            ...
            IF NOT (R.LAPAP.CONCAT.TMP.GESGARANTIAS) THEN
                ...
                CALL OCOMO("Escribiendo el registro: ":Y.ID.COLLECT:" en la tabla ":FN.LAPAP.CONCAT.TMP.GESGARANTIA)
            END
            I++
            CONTINUE;

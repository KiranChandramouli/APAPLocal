...
*--------------------------------------------------------------------------------------------------------
    ...
    $INSERT BP I_F.LAPAP.CARGO.ABONO.EXTRAC
...
*====
    ...
    IF Y.EDIT.CHAR EQ "Ex" THEN
        ...
        TEXT = "LAPAP.EXO.CARGO":FM:" - APROBACION SUPERVISOR"
    ...
    IF Y.MONTO.CARGO GT 0 AND Y.EDIT.CHAR EQ "No" THEN
        ...
        TEXT = "LAPAP.EXTRACAP":FM:" RD$":Y.MONTO.ABONADO:" el cliente debe pagar adicional: RD$":Y.MONTO.CARGO:" del cargo por abono"
        CALL STORE.OVERRIDE(Y.CURR.NO)
    ...
    END ELSE
        IF Y.MONTO.CARGO GT 0 AND Y.EDIT.CHAR EQ "Yes" THEN
            ...
            END ELSE
                ...
                CALL GET.LOC.REF("FUNDS.TRANSFER","L.TOTAL.PAY",Y.TOTAL.PAY.POS)
                R.NEW(FT.LOCAL.REF)<1,Y.TOTAL.PAY.POS> = Y.TOTAL.PAY
                TEXT = "LAPAP.NEW.CHAR":FM:Y.MONTO.CARGO:" - APROBACION SUPERVISOR"
                CALL STORE.OVERRIDE(Y.CURR.NO)
            END
        END
    END
...
*===============
    ...
    CHANGE SM TO FM IN Y.PRODUCT
    CHANGE VM TO FM IN Y.PRODUCT

$PACKAGE EB.Repgen
  SUBROUTINE RGP.CURRENCY
REM "RGP.CURRENCY",230614-4
*************************************************************************
$INSERT I_COMMON
$INSERT I_EQUATE
$INSERT I_RC.COMMON
...
* T.REMTEXT(23) = "PAGE"
  ...
  YHDR = "CURRENCY LIST"
  IF YPRINTING THEN
    YHDR = "RGP.CURRENCY ":YHDR
    YTYPE = "HEADER":@FM:YHDR
    CALL PST ( YTYPE )
  END ELSE
    YTYPE = YHDR
  END
  YHDR1 = "CCY      NAME                            MID RATE       BUY RATE      SELL RATE"
  YHDR2 = ""
  YHDR3 = ""
  YHDR4 = ""

$PACKAGE EB.Repgen
  SUBROUTINE RGS.SECTOR
REM "RGS.SECTOR",230614-4
*************************************************************************
$INSERT I_COMMON
$INSERT I_EQUATE
$INSERT I_RC.COMMON
...
*************************************************************************
 ...
 END
  ...
  WHILE ID.NEW:YDELIM
    MATREAD R.NEW FROM YF.SECTOR, ID.NEW ELSE ID.NEW = "" ; MAT R.NEW = ""
    IF T.PWD THEN

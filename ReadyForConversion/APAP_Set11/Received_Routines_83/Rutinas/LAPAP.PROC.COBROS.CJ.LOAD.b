...
LECTURA.PARAMETROS:
    ...
    LOCATE "TIPO.PAGOS" IN Y.FIELD.NME.ARR<1,1> SETTING TIPOPAGOS.POS THEN
        ...
        Y.TIPO.PAGOS.VAL = CHANGE(Y.TIPO.PAGOS.VAL,SM,VM)
        Y.TIPO.PAGOS.TEXT = CHANGE(Y.TIPO.PAGOS.TEXT,SM,VM)
    END
    ...
    LOCATE "VERSION" IN Y.FIELD.NME.ARR<1,1> SETTING VERSION.POS THEN
        ...
        Y.VERSION.OFS = CHANGE(Y.VERSION.OFS,SM,FM)
        Y.VERSION.OFS = CHANGE(Y.VERSION.OFS,VM,FM)

*-----------------------------------------------------------------------------
* Name: I_L.APAP.COL.CUSTOMER.COMMON
* Allows to define global definition for Extract Process

    COM /L.APAP.COL.EXTRACT.COMMON/F.CUSTOMER,FN.CUSTOMER,  ;* Customer
...
*Local fields position
    ...
    F.REDO.CL.LOAN.CUST,
    L.COL.GUAR.TYPE.POSN,
    L.COL.VAL.DATE.POSN,
    L.COL.TOT.VALUA.POSN,
    L.COL.PROP.DESC.POSN,
    FN.COLLATERAL.CODE,
    F.COLLATERAL.CODE,
    FN.COLLATERAL.TYPE,
    F.COLLATERAL.TYPE,
    ...
    FN.ACCOUNT.HST,
    F.ACCOUNT.HST,
    FN.LAPAP.CONCAT.TMP.CLIENTES,
    FV.LAPAP.CONCAT.TMP.CLIENTES,
    FN.LAPAP.CONCAT.TMP.TIPOGARANTIA,
    FV.LAPAP.CONCAT.TMP.TIPOGARANTIA,
    FN.LAPAP.CONCAT.TMP.GESGARANTIAS,

...
*
    ...
    IF W.FIELD.NAME EQ 'CURRENCY' THEN
        ...
        WHILE Y.CURRENCY.ID:Y.POS
            CALL CACHE.READ(FN.CURRENCY, Y.CURRENCY.ID, R.CURRENCY, Y.ERR.MSG.CURRENCY)
    ...
    IF W.FIELD.NAME EQ 'CHARGE-1' THEN
        ...
        WHILE Y.AA.PROPERTY.ID:Y.POS
            CALL CACHE.READ(FN.AA.PROPERTY, Y.AA.PROPERTY.ID, R.AA.PROPERTY, Y.ERR.MSG.AA.PROPERTY)
    ...
    IF W.FIELD.NAME EQ 'PAYMENT.TYPE-1' THEN
        ...
        WHILE Y.AA.PAYMENT.TYPE.ID:Y.POS
            CALL CACHE.READ(FN.AA.PAYMENT.TYPE, Y.AA.PAYMNET.TYPE.ID, R.AA.PAYMENT.TYPE, Y.ERR.MSG.AA.PAYMENT.TYPE)

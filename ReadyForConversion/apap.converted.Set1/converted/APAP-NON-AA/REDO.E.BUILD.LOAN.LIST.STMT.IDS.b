...
*******************
    ...
    CALL CACHE.READ(FN.AA.ACTIVITY, Y.ACT.ACTIVITY, R.AA.ACTIVITY, AA.ACTIVITY.ERR)
...
*******************
    ...
    CALL CACHE.READ(FN.FT.TXN.TYPE.CONDITION, Y.TRANSACTION.TYPE, R.FT.TXN.TYPE.CONDITION, FTTC.ERR)
    IF NOT(FT.ERR) THEN
        ...
        END
        CALL CACHE.READ(FN.TRANSACTION, Y.FTTC.TXN.CODE, R.TRANSACTION, TRANSACTION.ERR)

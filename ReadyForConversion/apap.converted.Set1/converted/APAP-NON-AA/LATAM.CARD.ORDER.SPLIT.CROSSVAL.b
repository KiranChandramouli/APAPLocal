...
*---------
    ...
    GOSUB INIT.PARA
    GOSUB PROCESS.PARA
    CALL  LATAM.CARD.ORDER.SPLIT.VALIDATE
    CALL LATAM.CARD.ORDER.SPLIT.PROCESS(ACCOUNT.ID,ACCOUNT,CARD.CHARGE,CHARGES,CHARGE.DATE,LCY.AMT)
...
***
    CALL LATAM.CARD.ORDER.SPLIT.CROSSVAL.1
*
...
*
    ...
    IF R.NEW(CARD.IS.CANCELLATION.DATE) AND R.NEW(CARD.IS.CAN.REASON) EQ "" THEN
...
*PACS00072694-S
    ...
    IF GET.CARD.TYPE EQ "PRINCIPAL"  AND  R.NEW(CARD.IS.CARD.STATUS) EQ '90' AND R.NEW(CARD.IS.RENEW.STATUS) NE "AVAILABLE" THEN

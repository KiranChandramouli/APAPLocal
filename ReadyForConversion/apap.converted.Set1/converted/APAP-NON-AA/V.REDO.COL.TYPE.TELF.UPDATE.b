...
***SECOND  CASE DELETE<desc>
    ...
    FOR I.VAR = 1 TO NRO.REL.CODE.TEL.OLD
*
        FIND R.REDO.COL.TRACE.PHONE<REDO.COL.TP.PHONE.TYPE,I.VAR>  IN  R.NEW(EB.CUS.LOCAL.REF)<1,Y.CLI.TELF.TYPE.POS> SETTING FMPOST THEN ;* BY PHONE.TYPE
*
        END ELSE
            DEL R.REDO.COL.TRACE.PHONE<REDO.COL.TP.PHONE.TYPE,I.VAR>
            DEL R.REDO.COL.TRACE.PHONE<REDO.COL.TP.PHONE.NUMBER,I.VAR>
            DEL R.REDO.COL.TRACE.PHONE<REDO.COL.TP.CREATION.DATE,I.VAR>
            DEL R.REDO.COL.TRACE.PHONE<REDO.COL.TP.LAST.UPD.DATE,I.VAR>
            DEL R.REDO.COL.TRACE.PHONE<REDO.COL.TP.LAST.IMPUTTER,I.VAR>
        END
    NEXT I.VAR
*</desc>
...
***FIRST CASE UPDATE AND CREATE <desc>
    ...
    FOR I.VAR = 1 TO NRO.REL.CODE.TEL
        Y.COD.PHONE.NEW = R.NEW(EB.CUS.LOCAL.REF)<1,Y.CLI.TELF.AREA.POS,I.VAR>:R.NEW(EB.CUS.LOCAL.REF)<1,Y.CLI.TELF.NO.POS,I.VAR>
*
        FIND Y.CLI.TELF.TYPE<1,1,I.VAR> IN R.REDO.COL.TRACE.PHONE<REDO.COL.TP.PHONE.TYPE> SETTING FMPOST,VMPOST THEN  ;* BY PHONE.TYPE
...
* inputter
            ...
            END
        END ELSE
            R.REDO.COL.TRACE.PHONE<REDO.COL.TP.PHONE.TYPE,-1> = Y.CLI.TELF.TYPE<1,1,I.VAR>

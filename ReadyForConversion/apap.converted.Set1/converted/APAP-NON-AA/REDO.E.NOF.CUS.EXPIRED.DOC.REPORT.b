...
**************
    ...
    IF  Y.OTHEROFF.ID THEN
        CALL CACHE.READ(FN.DEPT.ACCT.OFFICER, Y.OTHEROFF.ID, R.DEPT.ACCT.OFFICER, F.ERR)
    ...
    IF ACCTOFFICER.ID THEN
        CALL CACHE.READ(FN.DEPT.ACCT.OFFICER, ACCTOFFICER.ID, R.DEPT.ACCT.OFFICER, F.ERR)

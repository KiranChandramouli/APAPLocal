...
*======
    ...
    IF R.EB.CONTRACT.BALANCES THEN
        ...
        FOR I.VAR = NRO.MONTHS TO 1 STEP -1
*---------------------------------
            Y.CUR.CAMPO = "ACTIVITY.MONTHS"
            Y.ACT.MONTH = R.EB.CONTRACT.BALANCES<ECB.ACTIVITY.MONTHS,I.VAR>
...
*---------------------------------
            ...
            IF Y.LST.HRD THEN
                Y.VALUE.FLD = 0
                FOR K.VAR = 1 TO NRO.VAL
                    Y.VALUE.FLD += R.STMT.ACCT.CR<IC.STMCR.CR.INT.AMT,K.VAR>
                NEXT
            END ELSE
                Y.VALUE.FLD = 'NULO'
            END

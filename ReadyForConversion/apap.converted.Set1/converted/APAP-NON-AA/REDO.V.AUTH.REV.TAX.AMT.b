...
*Raise the accounting entries
    ...
    CALL CACHE.READ(FN.CURRENCY, Y.CURR, R.CURR, CURR.ERR)
...
*Y.PL.CATEGORY = R.CERT.CHEQ.PARAM<CERT.CHEQ.PL.CATEGORY,POS>
    ...
    CALL CACHE.READ(FN.FT.COMMISSION.TYPE, Y.TAX.KEY, R.FT.COMMISSION.TYPE, TAX.ERR)
...
*   Y.DR.TXN.CODE=R.FT.COMMISSION.TYPE<FT4.TXN.CODE.DR>
    ...
    CALL CACHE.READ(FN.TAX, Y.TAX.KEY, R.TAX, TAX.ERR)

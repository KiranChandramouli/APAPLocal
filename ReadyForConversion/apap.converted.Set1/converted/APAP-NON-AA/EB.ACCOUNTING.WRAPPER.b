...
*CHECK FOR VALID COMPANY CODE
    CALL CACHE.READ(FN.COMPANY, COMPANY.CODE, COMPANY.RECORD, COMPANY.ERROR)
...
*CHECK FOR VALID CATEGORY
    CALL CACHE.READ(FN.CATEGORY, PRODUCT.CATEGORY.NO, CATEGORY.RECORD, CATEGORY.ERROR)
...
*CHECK FOR VALID TRANSACTION CODE
    CALL CACHE.READ(FN.TRANSACTION, TRANSACTION.NO, TRANSACTION.RECORD, TRANSACTION.ERROR)
...
*CHECK FOR VALID POSITION TYPE
    IF POSITION.TYPE NE '' THEN
        ...
        CALL CACHE.READ(FN.POSITION.TYPE, POSITION.TYPE, POSITION.TYPE.RECORD, POSITION.TYPE.ERROR)
...
*CHECK FOR VALID CURRENCY MARKET
    CALL CACHE.READ(FN.CURRENCY.MARKET, CURRENCY.MARKET, CURRENCY.MARKET.RECORD, CURRENCY.MARKET.ERROR)
...
*CHECK FOR VALID CURRENCY
    CALL CACHE.READ(FN.CURRENCY, CURRENCY, CURRENCY.RECORD, CURRENCY.ERROR)
...
*READING SYSTEM ID
    ...
    CALL CACHE.READ(FN.SYSTEM.ID, EB.SYSTEM.ID, SYSTEM.ID.RECORD, SYSTEM.ID.ERROR)
RETURN
...
*READING DEPARTMENT ACCOUNT OFFICER
    ...
    CALL CACHE.READ(FN.DEPARTMENT.ACCOUNT.OFFICER, DEPARTMENT.ACCOUNT.OFFICER, DEPT.OFFICER.RECORD, DEPARTMENT.OFFICER.ERROR)
RETURN

...
* Update for PACS00139776
            ...
            CASE ret EQ 2
                CALL REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,MSG2,REC.CON,EX.USER,EX.PC)
                Y.MSG = MSG2
* Override Mesages OFAC Case Review - PACS00087206 - Update
* Update for PACS00139776
...
* Y.MSG = YTEXT1
* GOSUB LOG.REG
    CALL REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,YTEXT1,REC.CON,EX.USER,EX.PC)

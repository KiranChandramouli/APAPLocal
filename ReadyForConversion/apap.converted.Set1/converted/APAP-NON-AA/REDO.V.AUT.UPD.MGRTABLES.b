...
* To write the REDO.MANAGER.CHQ.DETAILS using F.WRITE
    ...
    R.REDO.MANAGER.CHQ.DETAILS<MAN.CHQ.DET.INPUTTER>=C$T24.SESSION.NO:'_':OPERATOR
    R.REDO.MANAGER.CHQ.DETAILS<MAN.CHQ.DET.AUTHORISER>=C$T24.SESSION.NO:'_':OPERATOR

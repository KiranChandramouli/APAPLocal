...
******************
    ...
    CALL CACHE.READ(FN.EB.MANDATE, Y.MAND.GROUP.ID, R.EB.MANDATE, EB.MANDATE.ERR)
...
**********************
    CALL CACHE.READ(FN.EB.SIGNATORY.GROUP, Y.SIGN.GRP.ID, R.EB.SIGNATORY.GROUP, ESG.ERR)

SUBROUTINE REDO.INDIVIDUAL.REF.PDF.GEN(Y.ARRAY)
***********************************************************************
* COMPANY NAME: ASOCIACION POPULAR DE AHORROS Y PRESTAMOS
* DEVELOPED BY: H GANESH
* PROGRAM NAME: REDO.INDIVIDUAL.REF.PDF.GEN
...
*24.08.2011  Sudharsanan   PACS00120767/65   Get the id value of REDO.ISSUE.LETTER and get the customer and product values
...
*PACS00120764 - S
    IF APPLICATION EQ 'TELLER' THEN
        Y.LETTER.IND.ISSUE.ID=R.NEW(TT.TE.LOCAL.REF)<1,POS.L.LETTER.ID>
        CALL F.READ(FN.REDO.LETTER.ISSUE,Y.LETTER.IND.ISSUE.ID,R.LETTER.IND.ISSUE,F.REDO.LETTER.ISSUE,LETTER.ERR)
    END ELSE
        Y.LETTER.IND.ISSUE.ID = System.getVariable("CURRENT.IND")
        IF E EQ "EB-UNKNOWN.VARIABLE" THEN
            Y.LETTER.IND.ISSUE.ID = ""
        END
        CALL F.READ(FN.REDO.LETTER.ISSUE,Y.LETTER.IND.ISSUE.ID,R.LETTER.IND.ISSUE,F.REDO.LETTER.ISSUE,ERR.IS)
    END
    Y.RECIPIENT.NAME=R.LETTER.IND.ISSUE<REDO.LET.ISS.RECIPIENT>
    Y.RECIPIENT.CITY=R.LETTER.IND.ISSUE<REDO.LET.ISS.RECIPIENT.CITY>
    Y.CUSTOMER.ID=R.LETTER.IND.ISSUE<REDO.LET.ISS.CUSTOMER.ID>
    CALL F.READ(FN.CUSTOMER,Y.CUSTOMER.ID,R.CUSTOMER,F.CUSTOMER,CUS.ERR)
    Y.CU.NAME=R.LETTER.IND.ISSUE<REDO.LET.ISS.CU.NAME>
    ...
    END ELSE
        ...
        END
    END
    Y.PRODUCT=R.LETTER.IND.ISSUE<REDO.LET.ISS.PRODUCTS>
    ...
    WHILE VAR1 LE Y.PRODUCT.CNT
        ...
        CALL CACHE.READ(FN.CATEGORY, Y.CATEGORY, R.CATEGORY, CAT.ERR)
...
*   Y.BALANCE=R.ACCOUNT<AC.WORKING.BALANCE>;*Tus Start
    ...
    Y.OFFICER.CODE=R.LETTER.IND.ISSUE<REDO.LET.ISS.ISS.OFFICER>
    ...
    Y.DEBIT.ACC=R.LETTER.IND.ISSUE<REDO.LET.ISS.CHARGE.LIQ.ACT>
    Y.CHARGE.AMT=R.LETTER.IND.ISSUE<REDO.LET.ISS.CHARGE.AMT>
    Y.CHARGE.AMT=FMT(Y.CHARGE.AMT,"L2,RD$#25")
    Y.CHARGE.CCY=R.LETTER.IND.ISSUE<REDO.LET.ISS.CHARGE.CCY>
    Y.ARRAY=TODAY[7,2]:'/':TODAY[5,2]:'/':TODAY[1,4]:"#":Y.RECIPIENT.NAME:"#":Y.RECIPIENT.CITY:"#":Y.CU.NAME:"#":Y.CUDELA:"#":Y.RNC.NO:"#":Y.ARRAY1:"#":Y.TOTAL.AMT:"#":Y.OFFICER.NAME:"#":Y.OFFICER.POSITION:"#":Y.OFFICER.DEPT:"#":Y.DEBIT.ACC:"#":Y.CHARGE.AMT:"#":Y.CHARGE.CCY
RETURN
*PACS00120764 - E
*--------------------------------------------------------------------------------------------------------------------
END

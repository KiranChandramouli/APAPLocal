...
* ======
    ...
    WHILE I.VAR LE Y.CONT
        IF R.COMB<INS.CL.POL.FIELD.VALUES,I.VAR> EQ "CAMPO MANDATORIO" THEN
    ...
    WHILE I.VAR LE Y.CONT
        IF R.POLICY<INS.POL.TYP.FIELD.VALUES,I.VAR> EQ "CAMPO MANDATORIO" THEN
            Y.CAMPO = R.POLICY<INS.POL.TYP.FIELD.NAME,I.VAR>
            Y.CAMPO.NOM = R.POLICY<INS.POL.TYP.FIELD.NAME,I.VAR>
            Y.VAR1 = Y.CAMPO['-',1,1]
            Y.VAR2 = Y.CAMPO['-',2,1]

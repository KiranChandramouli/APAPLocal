...
* </region>
*-----------------------------------------------------------------------------
    Table.name = 'REDO.LY.PROGRAM'        ;* Full application name including product prefix
    Table.title = 'REDO.LY.PROGRAM'       ;* Screen title
    ...
    Table.equatePrefix = 'REDO.PROG'      ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------

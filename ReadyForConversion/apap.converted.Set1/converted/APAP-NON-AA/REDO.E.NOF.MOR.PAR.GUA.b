...
*-----------------
    ...
    R.OUT.AA.RECORD = ''
    OUT.ERR = ''
    CALL REDO.GET.PROPERTY.NAME(Y.ARR.ID,'OVERDUE',R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)
...
*------------
    ...
    R.OUT.AA.RECORD = ''
    OUT.ERR = ''
    CALL REDO.GET.PROPERTY.NAME(Y.ARR.ID,'TERM.AMOUNT',R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)

...
**********
    ...
    CALL CACHE.READ(FN.FT.TXN.TYPE.CONDITION, Y.FTTC.ID, R.FT.TXN.TYPE.CONDITION, Y.ERR)
...
*FT5.CURRENCY TO 7,            FT5.FLAT.AMT
            ...
            T.DATAA<2,-1>='CHG'
            CALL CACHE.READ(FN.FT.CHARGE.TYPE, Y.FT.CHRG, R.FT.CHARGE.TYPE, CHG.ERR)
...
*FT5.CURRENCY TO 7,            FT5.FLAT.AMT
            ...
            T.DATAA<2,-1>='COM'
            CALL CACHE.READ(FN.FT.COMMISSION.TYPE, Y.FT.COM, R.FT.COMMISSION.TYPE, COMM.ERR)

...
* Apply behaviour
                    CALL REDO.FC.S.FIELD.VALID.POL(Y.FIELD.FROM, FIELD.BEHAVIOUR, FIELD.VALUE, Y.FIELD.FROM.NAME, I.VAR, J.VAR)
                END
            NEXT J.VAR
        END ELSE
            CALL REDO.FC.S.FIELD.VALID.POL(Y.FIELD.FROM, FIELD.BEHAVIOUR, FIELD.VALUE, Y.FIELD.FROM.NAME, I.VAR, '')
        END

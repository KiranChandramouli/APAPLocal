...
*  CALL F.READ(FN.DR.REG.213IF01.PARAM, "SYSTEM", R.DR.REG.213IF01.PARAM, F.DR.REG.213IF01.PARAM, DR.REG.213IF01.PARAM.ERR)        ;*/ TUS START/END
    ...
    FT.FLDS = "L.RTE.FORM":@VM:"L.LAST.NAME":@VM:"L.2ND.LAST.NAME":@VM:"L.1ST.NAME":@VM:"L.2ND.NAME":@VM:"L.NEW.ID.CARD":@VM:"L.OLD.ID.CARD":@VM:"L.PASSPORT":@VM:"L.ACT.INT":@VM:"L.PEP.INTERM":@VM:"L.TYPE.PEP.INT":@VM:"L.PAIS":@VM:"L.ID.PERS.BENEF":@VM:"L.FT.CLNT.TYPE":@VM:"L.NATIONALITY":@VM:"L.SEX":@VM:"BENEFIC.NAME"
    TT.FLDS = "L.RTE.FORM":@VM:"L.LAST.NAME":@VM:"L.2ND.LAST.NAME":@VM:"L.1ST.NAME":@VM:"L.2ND.NAME":@VM:"L.NEW.ID.CARD":@VM:"L.OLD.ID.CARD":@VM:"L.PASSPORT":@VM:"L.TT.FXSN.NUM":@VM:"L.ACT.INT":@VM:"L.PEP.INTERM":@VM:"L.TYPE.PEP.INT":@VM:"L.PAIS":@VM:"L.ID.PERS.BENEF":@VM:"L.FT.CLNT.TYPE":@VM:"L.NATIONALITY":@VM:"L.SEX":@VM:"BENEFICIARY.NAM"
    CUS.FLDS = "L.CU.TIPO.CL":@VM:"L.CU.RNC":@VM:"L.CU.CIDENT":@VM:"L.CU.PEPS":@VM:"L.CUS.PEP":@VM:"L.APAP.INDUSTRY"
    AC.FLDS = "L.AC.STATUS1":@VM:"L.AC.STATUS2"
    LOC.FLD = FT.FLDS:@FM:TT.FLDS:@FM:CUS.FLDS:@FM:AC.FLDS
    LOC.POS = ""
*

...
*~~~~~~~~~~~~~~~~
    ...
    CALL CACHE.READ(FN.TELLER.TRANSACTION, Y.TELLER.TRANSACTION, R.TELLER.TRANSACTION, ERR.TT)
...
*Calculation of Tax & Charge is done based on the FT.COMMISSION.TYPE
    ...
    CALL CACHE.READ(FN.FT.COMMISSION.TYPE, Y.CHARGE.CODE, R.FT.COMMISSION.TYPE, ERR.FTCT)

SUBROUTINE REDO.ISSUE.COMPLAINTS.FIELDS
*-----------------------------------------------------------------------------
*<doc>
...
*                                                       Used the Reserved Field #19 for OBSERVATIONS
...
* 05-JUL-2012     Karthi KR          PACS00205742       Removed the check file in the CUSTOMER.CODE, changed the field type as null
*-----------------------------------------------------------------------------
*** <region name= Header>
...
*------------------------------------------------------------------------------
    ...
    fieldLength='35'
*   fieldType='CUS' ;* PACS00205742 S/E
    fieldType=''
*   fieldType<9>='HOT.FIELD'
    neighbour=''
    CALL Table.addFieldDefinition(fieldName, fieldLength, fieldType, neighbour)
*   CALL Field.setCheckFile("CUSTOMER") ;* PACS00205742 S/E

...
*------------------------------------------------------------------------------------
    ...
    $INSERT I_F.COUNTRY
    $INSERT I_F.CURRENCY
    $INSERT I_F.REDO.CAPTURE.CREDIT.VOUCHER
...
*READING
    ...
    CALL CACHE.READ(FN.FT.TXN.TYPE.CONDITION, Y.FTTC.ID, R.FT.TXN.TYPE.CONDITION, FT.ERR)
...
*-----------------------------------------------------------------------------------------------------------------------
    ...
    CALL CACHE.READ(FN.FT.CHARGE.TYPE, Y.FT.CHRG, R.FT.CHARGE.TYPE, FT.ERR)

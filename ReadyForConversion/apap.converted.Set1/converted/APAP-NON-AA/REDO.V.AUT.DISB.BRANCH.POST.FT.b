...
*
    ...
    IF R.REDO.AA.DISB.LOAN THEN
        ...
        FOR I.VAR = 1 TO Y.TOT.BRANCH
            Z.BRANCH.ID  = Y.BRANCH.ID<1,I.VAR>
            Z.DISB.TYPE  = Y.DISB.TYPE<1,I.VAR>
            Z.DISB.AMT   = Y.DISB.AMT<1,I.VAR>
            Z.BR.DISB.AC = Y.BR.DISB.AC<1,I.VAR>

            Y.TOT.DISB.TYPE = DCOUNT(Z.DISB.TYPE,@SM)
            Y.BR.DISB.AMT = 0
            FOR J.VAR = 1 TO Y.TOT.DISB.TYPE
                X.DISB.TYPE = Z.DISB.TYPE<1,1,J.VAR>
                Y.BR.DISB.AMT = Z.DISB.AMT<1,1,J.VAR>
        ...
        FOR J.VAR = 1 TO Y.TOT.DISB.TYPE
            X.DISB.TYPE   = Y.MN.DISB.TYPE<1,J.VAR>
            Y.BR.DISB.AMT = Y.MN.DISB.AMT<1,J.VAR>
            IF Y.BR.DISB.AMT GT 0 THEN

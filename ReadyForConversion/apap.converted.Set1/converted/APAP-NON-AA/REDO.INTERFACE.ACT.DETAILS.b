SUBROUTINE REDO.INTERFACE.ACT.DETAILS
*-----------------------------------------------------------------------------
*<doc>
*
...
* </region>
*-----------------------------------------------------------------------------
    Table.name = 'REDO.INTERFACE.ACT.DETAILS'       ;* Full application name including product prefix
    Table.title = 'Detalle Actividad Interfaces'    ;* Screen title
    ...
    Table.equatePrefix = 'REDO.INT.ACT.DET'         ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------

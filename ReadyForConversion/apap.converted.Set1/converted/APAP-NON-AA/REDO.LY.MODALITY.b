...
* </region>
*-----------------------------------------------------------------------------
    Table.name = 'REDO.LY.MODALITY'       ;* Full application name including product prefix
    Table.title = 'Modalidad Modulo Lealtad'        ;* Screen title
    ...
    Table.equatePrefix = 'REDO.MOD'       ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------

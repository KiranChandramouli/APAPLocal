SUBROUTINE LATAM.CARD.REGISTER
*-----------------------------------------------------------------------------
*<doc>
...
* </region>
*-----------------------------------------------------------------------------
    Table.name = 'LATAM.CARD.REGISTER'    ;* Full application name including product prefix
    Table.title = 'Latam Card Register'   ;* Screen title

...
*================
    ...
    FOR ITR = 1 TO NO.OF.BEHA
        ...
        CALL APAP.H.GET.COLL.AMT.RTN(FIELD.VALUE, AMOUNT, R.BEHA.FLDS, FIELD.NAME)
    NEXT
...
*R.NEW(FIELD.NO)=''
                ...
                CALL APAP.H.GET.COLL.AMT.RTN(FIELD.VALUE, POL.EXP.DATE.VALUE,R.BEHA.FLDS, FIELD.NAME)

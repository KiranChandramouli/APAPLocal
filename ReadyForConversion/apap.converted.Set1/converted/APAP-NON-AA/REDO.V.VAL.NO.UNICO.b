...
* Then call REDO.S.CALC.CHECK.DIGIT subroutine.If the returned value is FAIL, then set ETEXT as EB-REDO.INCORRECT.CHECKDIGIT
        ...
        IF Y.L.CU.NOUNICO NE '' THEN
            ...
            END ELSE
                ...
                IF CHECK.NUMERIC EQ 1 THEN
                    CALL REDO.S.CALC.CHECK.DIGIT(Y.L.CU.NOUNICO)
                END ELSE
                    GOSUB CHECK.COUNT
                END
            END

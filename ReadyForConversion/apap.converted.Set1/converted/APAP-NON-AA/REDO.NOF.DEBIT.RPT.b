...
*****************
    ...
    CALL CACHE.READ(FN.AC.ENTRY.PARAM, Y.PARAM.ID, R.AC.ENTRY.PARAM, AC.ENT.PAR)
...
*******************
    ...
    END ELSE
        ...
        IF Y.COMP.CODE NE '' THEN
            CALL CACHE.READ(FN.TELLER.PARAMETER, Y.COMP.CODE, R.TELLER.PARAMETER, PARAMETER.ERR)

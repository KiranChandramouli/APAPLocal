...
* </region>
*-----------------------------------------------------------------------------
    Table.name = 'REDO.LY.MFILE.BKP'      ;* Full application name including product prefix
    Table.title = 'LEALTAD - RESPALDO ARCHIVO MILLAS'         ;* Screen title
    ...
    Table.equatePrefix = 'REDO.MFILE'     ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------

...
*Y.MNEMONIC=R.NEW(REDO.AZ.REINV.MNEMONIC)
    ...
    IF SECOND EQ '-1' THEN
        ...
        I.VAR=2
        LOOP
            Y.CURR.FLD=FIELD(ERR.MSG,',',I.VAR)
        WHILE Y.CURR.FLD
...
*
    ...
    LOOP
        CALL CACHE.READ(FN.PERIODIC.INTEREST, Y.PERIODIC.INT.ID, R.PERIODIC.INTEREST, PI.ERR)
...
*Y.MNEMONIC1='RE-':Y.MNEMONIC
    ...
    IF SECOND1 EQ '-1' THEN
        ...
        I.VAR=2
        LOOP
            Y.CURR.FLD1=FIELD(ERR.MSG1,',',I.VAR)
        WHILE Y.CURR.FLD1
...
*
    BEGIN CASE
        ...
        CASE Y.FLD.NAME EQ "CUSTOMER"
            AF=REDO.AZ.REINV.CUSTOMER
            ETEXT=Y.FLD.NAME:'-':Y.ERR
            CALL STORE.END.ERROR

        CASE Y.FLD.NAME EQ "CATEGORY"
            AF=REDO.AZ.REINV.PRODUCT.CODE
            ETEXT=Y.FLD.NAME:'-':Y.ERR
            CALL STORE.END.ERROR

        CASE Y.FLD.NAME EQ "CURRENCY"
            AF=REDO.AZ.REINV.CURRENCY
            ETEXT=Y.FLD.NAME:'-':Y.ERR
            CALL STORE.END.ERROR

        CASE Y.FLD.NAME EQ "MNEMONIC"
...
*
    BEGIN CASE
        ...
        CASE Y.FLD.NAME1 EQ "CUSTOMER"
            AF=REDO.AZ.REINV.CUSTOMER
            ETEXT=Y.FLD.NAME1:'-':Y.ERR1
            CALL STORE.END.ERROR

        CASE Y.FLD.NAME1 EQ "CATEGORY"
            AF=REDO.AZ.REINV.REINVINT.CATEG
            ETEXT=Y.FLD.NAME1:'-':Y.ERR1
            CALL STORE.END.ERROR

        CASE Y.FLD.NAME1 EQ "CURRENCY"
            AF=REDO.AZ.REINV.CURRENCY
            ETEXT=Y.FLD.NAME1:'-':Y.ERR1
            CALL STORE.END.ERROR

        CASE Y.FLD.NAME1 EQ "MNEMONIC"
            AF=REDO.AZ.REINV.MNEMONIC
            ETEXT=Y.FLD.NAME1:'-':Y.ERR1
            CALL STORE.END.ERROR

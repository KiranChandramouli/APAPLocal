...
*-------------
    FOR I.VAR = 1 TO DENOM.CNT
        ...
        LOCATE U.TEMP IN TT.STK.TEMP.REC.DENOM<1> BY 'AL' SETTING POS ELSE
            ...
            INS TT.STK.REC<TT.SC.QUANTITY,I.VAR> BEFORE TT.STK.TEMP.REC.QTY<POS>
...
*-------------
    FOR I.VAR = 1 TO DENOM.CNT
        ...
        TT.ERR     = ''
        U.TEMP = TT.STK.REC<TT.SC.DENOMINATION,I.VAR>
        CALL CACHE.READ(FN.TT.DENOM, U.TEMP, R.TT.DENOM, TT.ERR)
...
STORE.RETURN.VALUES:
*-------------------
    CHANGE @FM TO @VM IN TT.STK.TEMP.REC.DENOM

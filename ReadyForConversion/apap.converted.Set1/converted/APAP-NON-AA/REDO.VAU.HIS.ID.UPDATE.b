...
*
    ...
    END ELSE
        ...
        CALL CACHE.READ(FN.TXN.TYPE.CONDITION, VAL.TRANS.TYPE, R.TXN.TYPE.CONDITION, CONDITION.ERR)
...
*
    ...
    CALL CACHE.READ(FN.TELLER.TRANSACTION, Y.TRANSACTION.TYPE, R.TELLER.TRANSACTION, TELL.TRANS.ERR)

...
*Fetching the datas from the file record
    ...
    R.REDO.APAP.CLEARING.INWARD<CLEAR.CHQ.AUTHORISER> = C$T24.SESSION.NO:'_':OPERATOR
    R.REDO.APAP.CLEARING.INWARD<CLEAR.CHQ.INPUTTER> = C$T24.SESSION.NO:'_':OPERATOR

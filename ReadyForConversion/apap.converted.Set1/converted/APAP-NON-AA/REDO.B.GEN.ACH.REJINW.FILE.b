...
*R.RECORD<REDO.ACH.PROCESS.FILE.NAME>=Y.FILE.NAME
    ...
    R.RECORD<REDO.ACH.PROCESS.INPUTTER> = C$T24.SESSION.NO:'_':OPERATOR
    R.RECORD<REDO.ACH.PROCESS.AUTHORISER> = C$T24.SESSION.NO:'_':OPERATOR
...
******************
    ...
    WHILE Y.COUNT LE NOR
        ...
        R.REC<REDO.ACH.PROCESS.DET.INPUTTER> = C$T24.SESSION.NO:'_':OPERATOR
        R.REC<REDO.ACH.PROCESS.DET.AUTHORISER> = C$T24.SESSION.NO:'_':OPERATOR
        TEMPTIME = OCONV(TIME(),"MTS")
        TEMPTIME1 = TEMPTIME[1,5]

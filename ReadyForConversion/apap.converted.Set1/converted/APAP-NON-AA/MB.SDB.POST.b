...
READ.SDB.COMPANY:
        ...
        CALL CACHE.READ(FN.COMPANY, COMP.ID, R.COMP, COMP.ERR)
...
READ.SDB.PARAM:
        ...
        CALL CACHE.READ(FN.COMPANY, MB.SDB.PARAM.ID, R.COMPANY.REC, COMPANY.REC.ERR)
...
READ.FT.COMM:
        ...
        CALL CACHE.READ(FN.FT.COMMISSION.TYPE, FT.COMMISSION.TYPE.ID, R.FT.COMMISSION.TYPE, YERR)

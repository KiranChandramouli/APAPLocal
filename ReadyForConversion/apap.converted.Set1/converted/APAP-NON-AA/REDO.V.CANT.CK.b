...
*----------------------------------------------------------------------
    ...
    IF  EB.EXTERNAL$CHANNEL EQ 'INTERNET' THEN
        ...
        IF NOT(STK.ERR) THEN
            ...
            IF NOT(STK.ENT.ERR) THEN
                ...
                CALL CACHE.READ(FN.FT.COMMISSION.TYPE, Y.AI.COSTO.CK, R.FT.COMMISSION.TYPE, FT.COMMI.ERR)
    ...
    WHILE VAR1 LE Y.COSTO.CK.CNT
        ...
        CALL CACHE.READ(FN.FT.COMMISSION.TYPE, Y.COSTO.CK, R.FT.COMMISSION.TYPE, FT.COMMI.ERR)

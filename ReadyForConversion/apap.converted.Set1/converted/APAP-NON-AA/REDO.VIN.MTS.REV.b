...
*
    LOCATE ID.NEW IN R.REDO.TRANSACTION.CHAIN<RTC.TRANS.ID,1> SETTING Y.POS THEN
        R.REDO.TRANSACTION.CHAIN<RTC.TRANS.STATUS,Y.POS> = 'IREV'
        R.REDO.TRANSACTION.CHAIN<RTC.TRANS.AUTH>         = "IR"
        IF R.REDO.TRANSACTION.CHAIN<RTC.TRANS.STATUS> EQ 'IREV' THEN
            R.REDO.TRANSACTION.CHAIN<RTC.TRANS.AUTH>   = "IR"
            NV.AUTOR.PROCESS = ""
            NV.LAST.ID       = ""
        END ELSE

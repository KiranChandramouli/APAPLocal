...
*
    ...
    END
*
    CALL REDO.FI.RECORD.CONTROL(WERROR.MSG)
*
RETURN
*
* ======================
...
*
    ...
    CALL REDO.INTERFACE.REC.ACT(FI.INT.ACT.ID,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,ID.DESC,REC.CON,EX.USER,EX.PC)
*
RETURN
*
* =================
...
*Locate ID.INTERFACE.LIST
            ...
            CASE LOOP.CNT EQ 4
                ...
                WHILE Y.SETPOS : PARAM.ID AND PROCESS.GOAHEAD DO
                    ...
                    CALL REDO.FI.GET.DIR.LIST(PARAM.ID,W.ERROR)
                    IF W.ERROR THEN
                        PROCESS.GOAHEAD = 0
                    END
                REPEAT

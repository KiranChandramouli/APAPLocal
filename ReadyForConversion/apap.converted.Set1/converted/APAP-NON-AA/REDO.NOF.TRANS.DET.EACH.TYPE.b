...
*********************
    ...
    WHILE Y.SEL.ID:FT.POS
        ...
        IF R.FUNDS.TRANSFER NE '' THEN
            ...
            CALL CACHE.READ(FN.TXN.TYPE.CONDITION, Y.TRANS.TYPE, R.TXN.TYPE.CONDITION, CONDITION.ERR)
...
*************
    ...
    WHILE Y.SEL.ID:TT.POS
        ...
        IF R.TELLER NE '' THEN
            ...
            CALL CACHE.READ(FN.TELLER.TRANSACTION, Y.TRANS.CODE, R.TELLER.TRANSACTION, TELL.TRANS.ERR)

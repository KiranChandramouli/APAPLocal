...
*----------------------------------------------------------------------------------
    ...
    CALL CACHE.READ(FN.ACCOUNT.CLASS, Y.FX.CR.ID, R.ACCOUNT.CLASS, ACCOUNT.CLASS.ERR)
    Y.FX.CR.CATEG = R.ACCOUNT.CLASS<AC.CLS.CATEGORY>

    CALL CACHE.READ(FN.ACCOUNT.CLASS, Y.FX.DR.ID, R.ACCOUNT.CLASS, ACCOUNT.CLASS.ERR)

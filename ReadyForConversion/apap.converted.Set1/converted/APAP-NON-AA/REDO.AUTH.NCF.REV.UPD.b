...
*
    IF VAR.DR.CR.MARKER EQ R.NEW(TT.TE.DR.CR.MARKER) EQ 'DEBIT' THEN
...
*
    ...
    VAR.DATE=20:VAR.TXN.DATE[1,6]
    CALL CACHE.READ(FN.TRANSACTION, VAR.TRAN.CODE, R.TRANSACTION, TXN.MSG)
...
*
    ...
    CALL CACHE.READ(FN.ACCOUNT.CLASS, 'NOSTRO', R.ACCOUNT.CLASS, ACCOUNT.CLASS.ERR)

SUBROUTINE REDO.TT.EFECT.REC.BC.ME(V.DR.DENOMINATIO)
*--------------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------
* 04-01-2023    TSR-452565-1     VIJAYALAKSHMI S          Multiple problems present in the alignment of deal slips produced by teller versions
* 20-01-2023    TSR-452565-2     VIJAYALAKSHMI S    Alignment problem for the deal slip generated by the version TELLER,REDO.EFECT.REC.BC.ME
* 09-Feb-2023   TSR-495862       Rjasoundarya S    Deal Slip has alignment problem
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.TELLER
...
*TSR-452565-1
*V.DR.DENOMINATIO=SPACE(2):V.DR.DENOMINATIO:SPACE(10):R.NEW(TT.TE.DR.UNIT)<1,Y.VAR1>:SPACE(3):V.DR.VALUE
*V.DR.DENOMINATIO=V.DR.DENOMINATIO:SPACE(10):R.NEW(TT.TE.DR.UNIT)<1,Y.VAR1>:SPACE(3):V.DR.VALUE
            ...
            V.DR.DENOMINATIO=V.DR.DENOMINATIO:SPACE(5):V.DR.UN:V.DR.VALUE ;*TSR-452565-2
        END

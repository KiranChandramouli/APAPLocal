...
*
    ...
    Y.FIELDS = "L.CU.TIPO.CL":@VM:"L.CU.CIDENT":@VM:"L.CU.RNC":@VM:"L.CU.FOREIGN":@VM:"L.APAP.INDUSTRY":@FM:"L.AA.CAMP.TY"
    Y.FIELD.POS = ""
...
*
    ...
    END
*
    Y.FILE.NAME = Y.FILE.ID:".TEMP.":AGENT.NUMBER:".":SERVER.NAME
*

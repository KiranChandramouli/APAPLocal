...
CHECK.AVAIL:
************
    IF R.NEW(ST.QTY.AVAIL.ORG) GT R.NEW(ST.L.MIN.NCF.ORG) THEN
        R.NEW(ST.NCF.STATUS.ORG)='AVAILABLE'
    END

    IF R.NEW(ST.L.QTY.AVAIL.DR) GT R.NEW(ST.MN.NCF.DR.NOTE) THEN
        R.NEW(ST.NCF.STATUS.DR)='AVAILABLE'
    END

    IF R.NEW(ST.L.QTY.AVAIL.CR) GT R.NEW(ST.MN.NCF.CR.NOTE) THEN

...
FT.TXN.TYPE:
    ...
    CALL CACHE.READ(FN.FT.TXN.TYPE.CONDITION, TRAN.TYPE, R.FT.TXN.TYPE.CONDITION, E.FT.TXN.TYPE.CONDITION)
...
FT.COMM.TYPE:
    ...
    WHILE CNT LE TOT.COMM.TYPE
        ...
        CALL CACHE.READ(FN.FT.COMMISSION.TYPE, FT.COMM.ID, R.FT.COMMISSION.TYPE, E.FT.COMMISSION.TYPE)
        ...
        TAX.ID = SEL.LIST<NOR>
        CALL CACHE.READ(FN.TAX, TAX.ID, R.TAX, E.TAX)

SUBROUTINE REDO.CUS.CHQ.DEP(CHQ.DEP)
*-----------------------------------------------------------------------------
*DESCRIPTION:
*------------
...
********
    ...
    CHQ.DEP = FMT(COUNT1,"L#13"):FMT(COUNT2,"L#20")
    CHQ.DEP := FMT(COUNT3,"L#20"):FMT(COUNT4,"L#20"):FMT(COUNT5,"L#20")
...
*CHECK FT TRANSACTIONS
    ...
    WHILE ACC.ID:POS1
        ...
        SELECT.CMD="SELECT ":FN.FT.HIS:" WITH CREDIT.ACCT.NO EQ ":ACC.ID:" AND CHEQUE.NUMBER NE ''"
        ...
        SELECT.CMD="SELECT ":FN.FUNDS.TRANSFER:" WITH CREDIT.ACCT.NO EQ ":ACC.ID:" AND CHEQUE.NUMBER NE ''"

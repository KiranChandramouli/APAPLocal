...
*-----------------------------------------------------------------------------
    ...
    Y.RATE.REVIEW.DT.TO.VAL=FIELD(Y.RATE.REVIEW.DATE.FR.VAL,@SM,2)
    Y.RATE.REVIEW.DT.FROM.VAL=FIELD(Y.RATE.REVIEW.DATE.FR.VAL,@SM,1)
...
*-----------------------------------------------------------------------------
    ...
    Y.RATE.CHANGE.DT.TO.VAL=FIELD(Y.RATE.CHANGE.DATE.FR.VAL,@SM,2)
    Y.RATE.CHANGE.DT.FROM.VAL=FIELD(Y.RATE.CHANGE.DATE.FR.VAL,@SM,1)
...
GET.LR.FLD.POS:
*-----------------------------------------------------------------------------
    Y.LRF.APPL = "AA.PRD.DES.INTEREST":@FM:'AA.ARR.CUSTOMER'
    Y.LRF.FIELDS = "L.AA.NXT.REV.DT":@VM:"L.AA.FIR.REV.DT":@VM:"L.AA.LST.REV.DT":@FM:'L.AA.CAMP.TY':@VM:'L.AA.AFF.COM'
    FIELD.POS = ''
...
*-----------------------------------------------------------------------------
    ...
    IF R.AA.ACTIVITY.HISTORY THEN
        ...
        Y.EFFECTIVE.DATE.COUNT=DCOUNT(Y.EFFECTIVE.DATE.HIS,@VM)
        Y.COUNT=1
        ...
        WHILE Y.COUNT LE Y.EFFECTIVE.DATE.COUNT
            ...
            Y.ACT.COUNT=DCOUNT(Y.ACTIVITY.HIS,@SM)
            Y.COUNT1 = 1

...
*-----------------------------------------------------------------------------
    ...
    END ELSE
        ...
        WHILE Y.COUNT2 LE Y.STAT.COUNT
            ...
            END ELSE
                Y.LOAN.STATUS:= @VM:Y.OVERDUE.LOAN.STATUS
            END
            Y.COUNT2 += 1
        REPEAT
        RETURN
...
LOAN.ARR.STATUS:
*-----------------------------------------------------------------------------
    Y.AA.STATUS = "GRC":@FM:"NAB":@FM:"DEL":@FM:"CUR"
...
GET.LR.FLD.POS:
*-----------------------------------------------------------------------------
    Y.LRF.APPL = "AA.PRD.DES.CUSTOMER":@FM:"AA.ARR.OVERDUE":@FM:"AA.PRD.DES.INTEREST"
    Y.LRF.FIELDS = "L.AA.CAMP.TY":@VM:"L.AA.AFF.COM":@FM:'L.LOAN.STATUS.1':@FM:"L.AA.NXT.REV.DT"
    FIELD.POS = ''

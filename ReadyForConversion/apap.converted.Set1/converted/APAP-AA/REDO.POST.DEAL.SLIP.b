...
*----------------------------------------------------------------------
    ...
    ERR.MSG     = ''
    Y.PROPERTY  = ''
    CALL REDO.CRR.GET.CONDITIONS(Y.ARR.ID,EFF.DATE,PROP.CLASS,Y.PROPERTY,R.CUST.COND,ERR.MSG)
...
*-----------------------------
    ...
    CALL REDO.AA.BUILD.OFS(c_aalocArrId,R.CONDITION.INTEREST,Y.PROP.ACTIVITY,OFS.MSG)

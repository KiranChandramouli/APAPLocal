SUBROUTINE REDO.BAT.AUTH.OFS.STR.MAN
*-----------------------------------------------------------------------------
*DESCRIPTIONS:
*-------------
* This is a SERVICE routine for B16 development
* Once after running the service REDO.MANUAL.RATE.CHANGE routine
...
*
    ...
    Y.OFS.MESSAGE = 'AA.ARRANGEMENT.ACTIVITY,REDO.MAN/A/PROCESS///,//':Y.COMPANY:'/////,':ACTIVITY.ID
    Y.MSG = Y.OFS.MESSAGE
    Y.MSG.KEY = ""

SUBROUTINE REDO.T.AUTH.AMT.POST.RTN
*------------------------------------------------------------------------------------------------------------------
...
*************
    ...
    INS.AMOUNT = ''
    COLL.ID = ''
    INS.AMT.DATE = R.NEW(AA.AMT.LOCAL.REF)<1,INS.AMOUNT.DATE.POS>
    INS.AMOUNT  = R.NEW(AA.AMT.LOCAL.REF)<1,INS.AMOUNT.POS>
    COLL.ID  = R.NEW(AA.AMT.LOCAL.REF)<1,L.AA.COL.POS>

...
* Here we get the interest property.
    ...
    R.PRIN.COND        = ''
    ERR.MSG            = ''
    CALL REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.PRIN.COND,ERR.MSG)
    ...
    R.PENAL.COND       = ''
    ERR.MSG            = ''
    CALL REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.PENAL.COND,ERR.MSG)

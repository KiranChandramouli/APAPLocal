...
* PACS00260025
    ...
    Y.FIELD.NAME = Y.FIELD:@VM:Y.FIELD.COL.AMOUNT:@VM:Y.FIELD.COL.DESC:@VM:Y.FIELD.COL.VALAMT:@FM:Y.FILED.AV.AMT:@VM:Y.FILED.MX.AMT
* PACS00308600 - E
...
*
    ...
    W.VALCHR = CHARX(251)
    Y.AA.COL.IDS = CHANGE(COL.ID.LINKED, W.VALCHR , @VM )
...
* PACS00308600 - E
    ...
    CHANGE W.VALCHR TO @VM IN Y.AA.COL.AMT         ;* PACS00290578 - S/E
    Y.AA.COL.DESC  = R.AA.ARR.TERM.AMOUNT<AA.AMT.LOCAL.REF,Y.COL.DES.POS>
    CHANGE W.VALCHR TO @VM IN Y.AA.COL.DESC        ;* PACS00290578 - S/E
* PACS00307565 - S
    Y.AA.COL.AVAMT = ''
    Y.AA.COL.AVAMT = R.AA.ARR.TERM.AMOUNT<AA.AMT.LOCAL.REF,Y.COL.AVL.POS>
    CHANGE W.VALCHR TO @VM IN Y.AA.COL.AVAMT
* PACS00307565 - E
...
*================
    ...
    I.COLL.CNT = 1
    Y.COLL.NUM = DCOUNT(Y.AA.COL.IDS,@VM)

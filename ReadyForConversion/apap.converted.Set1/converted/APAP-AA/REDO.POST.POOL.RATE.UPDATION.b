...
*
    LOC.REF.APPL="AA.PRD.DES.INTEREST":@FM:"AA.PRD.DES.PAYMENT.SCHEDULE":@FM:"COLLATERAL"
    LOC.REF.FIELDS="L.AA.POOL.RATE":@VM:"L.AA.RT.RV.FREQ":@VM:'L.AA.LST.REV.DT':@VM:'L.AA.NXT.REV.DT':@VM:'L.AA.REV.FORM':@VM:'L.AA.REV.RT.TY':@FM:'L.MIGRATED.LN':@FM:'L.COL.NUM.INSTR'
    LOC.REF.POS=""

...
** PACS00084115 -S
    LOC.REF.FIELDS='L.AA.PART.ALLOW':@VM:'L.AA.PART.PCNT':@FM:'L.TT.PART.PCNT':@VM:'L.TT.NUM.PYMT':@VM:'L.TT.BIL.NUM':@VM:'L.TT.TAX.TYPE':@VM:'L.LOAN.STATUS.1':@VM:'L.LOAN.COND':@VM:'L.TT.DUE.PRS':@FM:'L.FT.PART.PCNT':@VM:'L.FT.NUM.PYMT':@VM:'L.FT.BILL.NUM':@VM:'L.FT.TAX.TYPE':@VM:'L.LOAN.COND':@VM:'L.LOAN.STATUS.1'
** PACS00084115 - E
    LOC.REF.POS=''
    EFF.DATE=TODAY
...
*****PACS00060191 & PACS00060192 & PACS00060193******* - S
    ...
    CHANGE.BILLS = CHANGE(Y.BILLS,@SM,@VM)
    Y.CNT.BIL = DCOUNT(CHANGE.BILLS,@VM)

...
* L.AA.COL (Collateral) from AA.PRD.DES.TERM.AMOUNT
    ...
    Y.FIELD.NAME = Y.FIELD:@VM:Y.FIELD.COL.AMOUNT
...
* CALL EB.READLIST(SELECT.STATEMENT,REDO.AA.CUSTOMER.LIST,LIST.NAME,NO.OF.REC.CUSTOMER,Y.AA.CUSTOMER.ERR)
    ...
    CHANGE @SM TO @FM IN YFLD.VAL1
    CHANGE @VM TO @FM IN YFLD.VAL1
    CHANGE @SM TO @FM IN YFLD.VAL2
    CHANGE @VM TO @FM IN YFLD.VAL2
...
*        Y.TERM.ID = "AA13121JRMLF-COMMITMENT-20130501.10"
* LOOP

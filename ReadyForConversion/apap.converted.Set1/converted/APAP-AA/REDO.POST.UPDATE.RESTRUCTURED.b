...
*----------------------------------------------------------------------
    ...
    IF c_aalocActivityStatus MATCHES 'UNAUTH':@VM:'UNAUTH-CHG' AND c_aalocArrActivityId EQ c_aalocArrActivityRec<AA.ARR.ACT.MASTER.AAA> THEN
        GOSUB PROCESS
    END
...
*** <desc>Trigger the secondary activity to update the Loan as Normal</desc>
    ...
    ARR.FIELD.NAME.LIST          = "L.LOAN.STATUS.1":@SM:"L.STATUS.CHG.DT"
    ARR.FIELD.VALUE.LIST         = "Normal":@SM:TODAY
    AAA.FIELDS.REC               = ""

...
*--------------------------------------------
    ...
    R.CONDITION.INT = ''
    ERR.MSG = ''
    CALL REDO.CRR.GET.CONDITIONS(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.INT,ERR.MSG)
...
*--------------------------------------------
    ...
    R.CONDITION.CUS = ''
    ERR.MSG = ''
    CALL REDO.CRR.GET.CONDITIONS(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.CUS,ERR.MSG)
...
*-------------------------------------------------
    ...
    R.CONDITION.TERM = ''
    ERR.MSG = ''
    CALL REDO.CRR.GET.CONDITIONS(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.TERM,ERR.MSG)
...
*------------------------------------------------
    ...
    R.CONDITION.OVERDUE = ''
    ERR.MSG = ''
    CALL REDO.CRR.GET.CONDITIONS(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.OVERDUE,ERR.MSG)
...
*------------------------------------------------
    OUT.ARRAY = ''
    CALL REDO.APAP.NOFILE.AA.LOAN.RATES.REVIEW.GET(Y.FINAL.AA.IDS,OUT.ARRAY)
RETURN
*--------------------------------------------
END1:
*--------------------------------------------

...
***************
    ...
    FIELD.NAME = "CLASS.POLICY":@VM:"INS.POLICY.TYPE":@VM:"POLICY.NUMBER":@VM:"SEN.POL.NUMBER":@VM:"MANAGEMENT.TYPE":@VM:"MON.POL.AMT":@VM:"MON.POL.AMT.DAT":@VM:"EXTRA.AMT":@VM:"MON.TOT.PRE.AMT":@VM:"TOT.PREMIUM.AMT":@VM:"L.AA.CALC.TYPE":@VM:"L.AA.CHG.RATE.POS":@VM:"L.AA.CHG.AMOUNT":@VM:"L.FHA.CASE.NO":@FM:"INS.COMPANY":@VM:"POLICY.ORG.DATE":@VM:"POL.START.DATE":@VM:"POL.EXP.DATE":@VM:"POL.ISSUE.DATE":@VM:"REMARKS":@VM:"L.AA.AFF.COM":@VM:"L.AA.CAMP.TY":@VM:"INS.APPLN.DATE":@VM:"INS.REC.DATE":@FM:"INS.AMOUNT":@VM:"INS.AMOUNT.DATE":@VM:"L.AA.COL":@VM:"L.AA.MIN.AMOUNT":@VM:"L.AA.MAX.AMOUNT":@VM:"L.AA.MIN.TIME":@VM:"L.AA.MAX.TIME":@VM:"L.AA.COL.VAL":@VM:"L.AA.AV.COL.BAL":@VM:"L.AA.COL.DESC":@FM:"POLICY.STATUS":@VM:"INS.APPLN.DATE":@VM:"INS.REC.DATE"
    FIELD.POS = ""

...
*  CHANGE VM TO FM IN Y.MOVE.BAL
    ...
    CHANGE @SM TO @FM IN Y.AGING.DAYS
    CHANGE @SM TO @FM IN Y.MOVE.BAL
...
*TUS change END
    ...
    Y.BALANCE.CNT=DCOUNT(Y.BALANCE,@VM)
...
* TUS END
    ...
    END
    SIGN="DEBIT"
    EVENT.LIST = 'CURRENT.MONTH':@VM:'PREVIOUS.MONTH':@VM:'PREVIOUS.YEAR'
    COMMITTED.INT=Y.PENAL.AMT:@FM:'':@FM:''
    EVENT.SPLIT = DCOUNT(EVENT.LIST,@VM)
    VAR1=1
    LOOP

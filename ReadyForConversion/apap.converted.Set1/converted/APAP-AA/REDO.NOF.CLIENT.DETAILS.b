...
PROCESS:
*************************
    APL.ARRAY = 'CUSTOMER':@FM:'ACCOUNT'
    APL.FIELD = 'L.CU.TIPO.CL':@VM:'L.CU.SEGMENTO':@VM:'L.CU.CIDENT':@VM:'L.CU.ACTANAC':@VM:'L.CU.RNC':@VM:'L.CU.NOUNICO':@FM:'L.AC.STATUS':@VM:'L.AC.REINVESTED':@VM:'L.STAT.INT.RATE':@VM:'L.AC.STATUS2'
    FLD.POS = ''
    ...
    IF AGENCY.VAL THEN
        CALL CACHE.READ(FN.DEPT.ACCT.OFFICER, AGENCY.VAL, R.DEPT.ACCT.OFFICER, F.ERR)
    ...
    IF ACCOUNT.OFFICE.VAL THEN
        CALL CACHE.READ(FN.DEPT.ACCT.OFFICER, ACCOUNT.OFFICE.VAL, R.DEPT.ACCT.OFFICER, F.ERR)
...
****************************************
    ...
    Y.TOTAL.CARDS = DCOUNT(Y.CARD.LIST,@VM)
...
*****************
    ...
    CHANGE @FM TO @VM IN SAVINGS.STATUS.VAL

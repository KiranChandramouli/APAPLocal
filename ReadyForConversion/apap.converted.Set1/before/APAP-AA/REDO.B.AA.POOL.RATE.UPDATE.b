...
*-----------------------------------------------------------
    ...
    R.INT.CONDITION    = ''
    ERR.MSG            = ''
    CALL REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.INT.CONDITION,ERR.MSG)
...
*CALL REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.TERM.CONDITION,ERR.MSG)
    CALL REDO.GET.LOAN.TERM(Y.AA.ID,'TODAY',Y.LOAN.TERM)
...
*------------------------------------------------------
    ...
    R.LIMIT.CONDITION = ''
    ERR.MSG     = ''
    CALL REDO.CRR.GET.CONDITIONS(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.LIMIT.CONDITION,ERR.MSG)

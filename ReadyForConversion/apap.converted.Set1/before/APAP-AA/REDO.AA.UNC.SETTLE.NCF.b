...
*-----------------------------------------------------------------------------
    ...
    $INSERT TAM.BP I_F.REDO.L.NCF.STOCK
...
PROCESS:
    ...
    WHILE I LE NOR
        ...
        WHILE K LE Y.TOT.ACT
            ...
            Y.FT.ID = ''
            Y.NCF.AMT = '0'
            Y.VM.ACTIVITY = R.AA.ACTIVITY.BALANCES<AA.ACT.BAL.ACTIVITY,K>
            Y.ACT.REF = R.AA.ACTIVITY.BALANCES<AA.ACT.BAL.ACTIVITY.REF,K>
            Y.ACT.ID = 'LENDING-SETTLE-RP.PAGO.ANTICIPADO'
            IF Y.ACT.ID EQ Y.VM.ACTIVITY THEN
                Y.FT.ID = Y.ACT.REF
                Y.PAY.DATE = R.AA.ACTIVITY.BALANCES<AA.ACT.BAL.ACTIVITY.DATE,K>
                Y.PROPERTY     = R.AA.ACTIVITY.BALANCES<AA.ACT.BAL.PROPERTY,K>
                Y.PROPERTY.BAL.TYPE = FIELDS(Y.PROPERTY,'.',2)
                Y.PROPERTY.AMT = R.AA.ACTIVITY.BALANCES<AA.ACT.BAL.PROPERTY.AMT,K>
                GOSUB CALC.AMT
                GOSUB WRITE.FILE
            END

...
*****************
  ...
  R.Condition.customer=''
  ERR.MSG=''
  CALL REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.customer,ERR.MSG)
  RETURN
...
******************
  ...
  R.Condition.limit=''
  ERR.MSG=''
  CALL REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.limit,ERR.MSG)
...
******************
  ...
  ERR.MSG= ''
  CALL REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition.schedule,ERR.MSG)

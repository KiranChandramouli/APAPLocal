...
READ.ARR.ACCOUNT:
  ...
  END ELSE
    ...
    CALL F.READ(FN.AA.PROPERTY,Y.PRP,R.AA.PROPERTY,F.AA.PROPERTY,PRP.ER)
...
*-----------------------------------------------------------------------------------------------------------
  ...
  ERR.MSG     = ''
  R.OVERDUE.COND   = ''
  CALL REDO.CRR.GET.CONDITIONS(ARR.ID,EFFEC.DATE,PROP.CLASS,PROPERTY,R.OVERDUE.COND,ERR.MSG)
...
*-----------------------------------------------------------------------------------------------------------
  ...
  R.OUT.AA.RECORD   = ''
  Y.ACC.PROPERTY      = ''
  CALL REDO.GET.PROPERTY.NAME(ARR.ID,IN.PROPERTY.CLASS,R.OUT.AA.RECORD,Y.ACC.PROPERTY,OUT.ERR)
...
GET.INTEREST.PROPERTY:
  ...
  ERR.MSG = ''
  R.PAY.SCH.COND = ''
  CALL REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PAY.SCH.COND,ERR.MSG)

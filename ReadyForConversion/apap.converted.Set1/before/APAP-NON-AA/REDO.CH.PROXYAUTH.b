...
* <Rating>-96</Rating>
*-----------------------------------------------------------------------------
  SUBROUTINE REDO.CH.PROXYAUTH
**
* Subroutine Type : VERSION
* Attached to     : AA.ARRANGEMENT.ACTIVITY,REDO.CORP.NEWPROXAUTH
* Attached as     : AUTH.ROUTINE
* Primary Purpose : Create the ISA and external user for corporate authoriser user
*-----------------------------------------------------------------------------
...
*    R.NEW(AA.ARR.ACT.LOCAL.REF)<1,L.CORP.EMAIL.POS> = ''
  ...
  OFS.HEADER = 'AA.ARRANGEMENT.ACTIVITY,REDO.CORP.NEWINTAUTH/I/PROCESS//0/,//DO0010001/////,,'

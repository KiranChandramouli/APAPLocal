...
ACT.TYPE.SEL:
**************
  CONVERT SM TO ' ' IN Y.SEL.ACT.TYPE

  BEGIN CASE

  CASE Y.SEL.ACT.TYPE = 'SEIZURE'
...
*PACS00103352-E
  CASE Y.SEL.ACT.TYPE = 'RELEASE OF SEIZURE'
*PACS00103352-S
...
*********************
  ...
  IF Y.ACT = 'SEIZURE' THEN
    ...
    REPEAT
  END
  IF Y.ACT = 'RELEASE OF SEIZURE' THEN
...
**********************
  ...
  CALL F.READ(FN.CATEGORY,CATEGORY.VAL,R.CATEGORY,F.CATEGORY,CATEGORY.ERR)

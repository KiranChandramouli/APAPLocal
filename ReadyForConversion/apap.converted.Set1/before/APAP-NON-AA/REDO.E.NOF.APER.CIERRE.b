...
*        Y.AGN.EXEC = Y.AGENCIA:'-':Y.DEPT.CODE
        ...
        USER.ERR = ''; R.USER = ''
        CALL F.READ(FN.USER,Y.AUTHORISER,R.USER,F.USER,USER.ERR)
        IF NOT(R.USER) THEN
...
*-----------------
    ...
    CALL F.READ(FN.CATEGORY,Y.INV.CATEG,R.CATEG,F.CATEGORY,CATEG.ERR)
...
*
    ...
    WHILE Y.HOLDER.ID:Y.HOLDER.POS
        ...
        END
        IF R.HOLDER<EB.CUS.LOCAL.REF,Y.CL.TYPE.POS> = "PERSONA JURIDICA" THEN

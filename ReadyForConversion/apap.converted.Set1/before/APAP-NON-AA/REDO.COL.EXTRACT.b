...
* PP, take first position   for NAME.1 & NAME.2
  I = NRO.REL.CODE.PER
  LOOP WHILE I GE 1
    IF Y.CLI.TIPO.PERSONA<1,1,I> EQ 1 THEN        ;*ASIGNACION NOMBRE CLIENTE JURIDICA
      Y.CLI.RAZON.SOCIAL.NOM1 = R.CUSTOMER<EB.CUS.NAME.1, 1>
      Y.CLI.RAZON.SOCIAL.NOM2 = R.CUSTOMER<EB.CUS.NAME.2, 1>
    END  ELSE
      IF Y.CLI.TIPO.PERSONA<1,1,I> EQ 0 THEN      ;*ASIGNACION NOMBRE Y APELLIDO CLIENTE NATURAL

...
*************
  ...
  CALL F.READ(FN.TAX.TYPE.CONDITION,YTAX.KEY,R.TAX.TYPE.CONDITION,F.TAX.TYPE.CONDITION,ERR.TAX.TYPE.CONDITION)
...
************
  ...
  END ELSE
    ...
    CUSTNAME = ''
    BEGIN CASE
    CASE Y.CUSTTYPE = "PERSONA JURIDICA"
      CUSTNAME = R.CUSTOMER<EB.CUS.NAME.1> :" ": R.CUSTOMER<EB.CUS.NAME.2>
    CASE Y.CUSTTYPE = "PERSONA FISICA" OR Y.CUSTTYPE = "CLIENTE MENOR"

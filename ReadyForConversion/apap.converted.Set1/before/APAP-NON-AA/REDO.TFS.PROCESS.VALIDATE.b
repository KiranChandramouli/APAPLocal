...
*-------
  ...
  CALL F.READ(FN.CURRENCY,Y.CURRENCY,R.CURRENCY,F.CURRENCY,ERR)
  ...
  WHILE TRANS.COUNT LE CNT.TRANS
    ...
    CALL F.READ(FN.CURRENCY,VAR.ACC.1,R.CURRENCY,F.CURRENCY,CURR.ERR)
...
*********************************************************
  ...
  CALL F.READ(FN.CURRENCY,VAR.ACCOUNT.ID1,R.CURRENCY,F.CURRENCY,CURR.ERR)

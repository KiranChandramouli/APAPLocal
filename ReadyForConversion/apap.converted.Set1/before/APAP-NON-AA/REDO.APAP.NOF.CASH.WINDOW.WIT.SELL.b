...
* <Rating>-101</Rating>
*-----------------------------------------------------------------------------
  SUBROUTINE REDO.APAP.NOF.CASH.WINDOW.WIT.SELL(Y.CCY.LIST,TELLER.ID,Y.TT.PARAM.REC,Y.FINAL.ARRAY,Y.TT.LIST)
*********************************************************************************************************
*Company   Name    : ASOCIACION POPULAR DE AHORROS Y PRESTAMOS
*Developed By      : Temenos Application Management
*Program   Name    : REDO.APAP.NOF.CASH.WINDOW.WIT.SELL
*--------------------------------------------------------------------------------------------------------
...
* In this para of the code, the CURRENCY.1 is checked if its not LOCAL.CURRENCY and processed further
  ...
  IF R.TRANSACTION<AC.TRA.DEBIT.CREDIT.IND> NE 'CREDIT' THEN
    RETURN
  END
...
* In this para of the code, file TRANSACTION is read
  R.TRANSACTION  = ''
  TRANSACTION.ER = ''
  CALL F.READ(FN.TRANSACTION,TRANSACTION.ID,R.TRANSACTION,F.TRANSACTION,TRANSACTION.ER)

...
!Reading Category Application Using Y.CATEG
  R.CTG = '' ; CTG.ERR = '' ;
  CALL F.READ(FN.CATEGORY,Y.CATEG,R.CTG,F.CATEGORY,CTG.ERR)
...
!Reading the Group Credit Int Application  Using GP.CR.ID
  ...
  CALL F.READ(FN.GROUP.DATE,Y.CDN.GROUP,R.GROUP.DATE,F.GROUP.DATE,Y.DATE.ERR)
  ...
  WHILE GP.CR.ID:GP.CR.POS
    ...
    CALL F.READ(FN.GROUP.CREDIT.INT,Y.GP.CR.ID,R.GROUP.CREDIT.INT,F.GROUP.CREDIT.INT,GP.CR.ERR)
    IF Y.INT.RATE  THEN

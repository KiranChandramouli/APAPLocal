...
*-------
  ...
  CALL F.READ(FN.EB.RULES,Y.RULE,R.EB.RULES,F.EB.RULES,ERR.EB.RULES)

  Y.VERSION = R.EB.RULES<EB.RLE.VERSIONS,1>
  Y.RULE.VERSION = Y.RULE:"*":Y.VERSION

  CALL F.READ(FN.EB.RULES.VERSION,Y.RULE.VERSION,R.EB.RULES.VERSION,F.EB.RULES.VERSION,ERR.RV)

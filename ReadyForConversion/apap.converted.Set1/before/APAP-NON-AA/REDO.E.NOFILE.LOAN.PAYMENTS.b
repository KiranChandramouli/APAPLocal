...
*--------------------------------------------------------------------------------------------------------
  ...
  WHILE Y.SM.START LE Y.SM.COUNT
    ...
    LOCATE Y.ACT IN Y.MAIN.LIST SETTING Y.AA.MAIN.POS THEN
      ...
      CALL REDO.GET.PRE(Y.AA.ARR.ACTIVITY,Y.PRE,Y.CURENT)
...
*--------------------------------------------------------------------------------------------------------
  ...
  CALL F.READ(FN.AA.ACTIVITY,Y.ACT,R.AA.ACTIVITY,F.AA.ACTIVITY,Y.AA.ACT.ER)
...
*--------------------------------------------------------------------------------------------------------
  ...
  IF JS.BILL.STATUS.1 = 'SETTLED' THEN  ;* Shek
...
*--------------------------------------------------------------------------------------------------------
  ...
  CALL REDO.E.NOF.ARRANGMENT.PROCESS(AA.ARRANGEMENT.ID,Y.AGENCY,Y.DISBURSED.AMOUNT)       ;* PACS00313082 - 2015MAY01 - Cristina's email - S/E
...
*--------------------------------------------------------------------------------------------------------
  ...
  ERR.TEXT = ''
  OUT.ID = ''
  CALL REDO.CONVERT.ACCOUNT(IN.ACC.ID,Y.LOAN.NO,OUT.ID,ERR.TEXT)
  Y.LOAN.NO = OUT.ID

...
*------------------------------------------------------------------------------------
    ...
    $INSERT I_F.COUNTRY
    $INSERT I_F.CURRENCY
    $INCLUDE TAM.BP I_F.REDO.CAPTURE.CREDIT.VOUCHER
...
!READING
    ...
    CALL F.READ(FN.FT.TXN.TYPE.CONDITION,Y.FTTC.ID,R.FT.TXN.TYPE.CONDITION,F.FT.TXN.TYPE.CONDITION,FT.ERR)
...
*-----------------------------------------------------------------------------------------------------------------------
    ...
    CALL F.READ(FN.FT.CHARGE.TYPE,Y.FT.CHRG,R.FT.CHARGE.TYPE,F.FT.CHARGE.TYPE,FT.ERR)
...
!SUM THE CHARGE AMOUNT IN LOOP AND ASSIGN BACK TO CHARGE.AMOUNT FIELD

...
* <Rating>-51</Rating>
*-----------------------------------------------------------------------------
  SUBROUTINE REDO.FC.ENQ.NO.COLL.VS(DATA.OUT)
*
* ====================================================================================
*
*
...
* Attached to     :TYPE.OF.SEC.VS DROPDOWN IN REDO.CREATE.ARRANGEMENT
...
* ======
  ...
  LOCATE "TYPE.OF.SEC.VS" IN D.FIELDS<1> SETTING PRO.POS THEN
    Y.TYPE.COLL=D.RANGE.AND.VALUE<PRO.POS>
  END


  SELECT.STATEMENT = "SELECT FBNK.COLLATERAL WITH COLLATERAL.CODE EQ '": Y.TYPE.COLL:"'"

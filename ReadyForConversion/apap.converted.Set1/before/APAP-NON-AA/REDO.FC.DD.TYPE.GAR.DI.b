...
* <Rating>-41</Rating>
*-----------------------------------------------------------------------------
  SUBROUTINE REDO.FC.DD.TYPE.GAR.DI(DATA.OUT)
*
* ====================================================================================
*
*
...
* Attached to     :REDO.FC.SEC.CLASSIFY.DI DROPDOWN IN REDO.CREATE.ARRANGEMENT
...
* ======
  ...
  LOCATE "TYPE.OF.SEC.DI" IN D.FIELDS<1> SETTING PRO.POS THEN

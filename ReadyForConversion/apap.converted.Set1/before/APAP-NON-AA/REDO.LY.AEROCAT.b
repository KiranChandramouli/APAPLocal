...
* </region>
*-----------------------------------------------------------------------------
  Table.name = 'REDO.LY.AEROCAT'        ;* Full application name including product prefix
  Table.title = 'LEALTAD - CATALOGO AEROLINEAS'   ;* Screen title
  ...
  Table.equatePrefix = 'REDO.AERO'      ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------

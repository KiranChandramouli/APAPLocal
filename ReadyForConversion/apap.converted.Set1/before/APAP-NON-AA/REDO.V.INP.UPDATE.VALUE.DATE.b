...
***********
  ...
  CALL F.READ(FN.FT.TXN.COND,Y.TXN.TYPE,R.FT.TXN.COND,F.FT.TXN.COND,FT.TXN.ERR)
...
***********
  ...
  CALL F.READ(FN.TELLER.TXN,Y.TXN.TYPE,R.TELLER.TXN,F.TELLER.TXN,TELLER.TXN.ERR)
  IF Y.APAP EQ 'YES' THEN

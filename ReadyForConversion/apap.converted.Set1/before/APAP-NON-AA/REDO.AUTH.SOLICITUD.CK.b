...
Y.LAST.EVENT.SEQ=Y.LAST.EVENT.SEQ+1
END
...
CALL F.READ(FN.FT.COMMISSION.TYPE,FT.COMM.ID,R.COMM,F.FT.COMMISSION.TYPE,COMM.ERR)
...
CALL F.READ(FN.TAX,TAX.CODE,R.TAX,F.TAX,TAX.ERR)

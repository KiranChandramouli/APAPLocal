...
*------------------------------------------------------------------------------------
    ...
    $INCLUDE TAM.BP I_F.REDO.VISA.STLMT.PARAM
    $INCLUDE TAM.BP I_F.REDO.VISA.STLMT.05TO37
    $INCLUDE TAM.BP I_F.REDO.VISA.STLMT.MAPPING
    $INCLUDE TAM.BP I_F.REDO.VISA.OUTGOING
    $INCLUDE TAM.BP I_REDO.VISA.STLMT.FILE.PROCESS.COMMON

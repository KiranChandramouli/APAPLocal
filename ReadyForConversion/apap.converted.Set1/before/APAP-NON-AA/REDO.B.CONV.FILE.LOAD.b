...
*-------------------------------------------------------------------------------------
  ...
  CALL F.READ(FN.FILE.UP.TYPE,'UPLOAD',R.UP.TYPE,F.FILE.UP.TYPE,UP.TYPE.ERR)
...
*-------------------------------------------------------------------------------------
  ...
  CALL F.READ(FN.FT.TXN.TYPE.CONDITION,Y.PAYROLL.TXN.CODE,R.FT.TXN.TYPE.CONDITION,F.FT.TXN.TYPE.CONDITION,FT.TXN.TYPE.CONDITION.ERR)
...
*-------------------------------------------------------------------------------------
  ...
  CALL F.READ(FN.FT.TXN.TYPE.CONDITION,Y.SUPPLIER.TXN.CODE,R.FT.TXN.TYPE.CONDITION,F.FT.TXN.TYPE.CONDITION,FT.TXN.TYPE.CONDITION.ERR)
  ...
  IF Y.SUPPLIER.COMM.TYPE THEN
    CALL F.READ(FN.FT.COMMISSION.TYPE,Y.SUPPLIER.COMM.TYPE,R.FT.COMMISSION.TYPE,F.FT.COMMISSION.TYPE,FT.COMMISSION.TYPE.ERR)

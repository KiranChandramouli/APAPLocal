...
SORT.BY.DENOM:
*-------------
  FOR I = 1 TO DENOM.CNT
    U.TEMP = TT.STK.REC<TT.SC.DENOMINATION,I>
    LOCATE U.TEMP IN TT.STK.TEMP.REC.DENOM<1> BY 'AL' SETTING POS ELSE
      INS U.TEMP BEFORE TT.STK.TEMP.REC.DENOM<POS>
      INS TT.STK.REC<TT.SC.QUANTITY,I> BEFORE TT.STK.TEMP.REC.QTY<POS>
      INS TT.STK.REC<TT.SC.SERIAL.NO,I> BEFORE TT.STK.TEMP.REC.SER<POS>
    END
  NEXT I
*
  RETURN
...
*-------------
  FOR I = 1 TO DENOM.CNT
    ...
    TT.ERR     = ''
    U.TEMP = TT.STK.REC<TT.SC.DENOMINATION,I>
    CALL F.READ(FN.TT.DENOM,U.TEMP,R.TT.DENOM,FV.TT.DENOM,TT.ERR)

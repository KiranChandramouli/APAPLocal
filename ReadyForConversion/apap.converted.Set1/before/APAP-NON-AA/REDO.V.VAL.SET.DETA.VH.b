...
*
  ...
  WHILE LOOP.CNT LE MAX.LOOPS AND PROCESS.GOAHEAD DO
    ...
    CASE LOOP.CNT EQ 1
*
      IF  Y.O.VAR.MATRICULA EQ VAR.MATRICULA AND Y.O.VAR.PARCELA EQ VAR.PARCELA AND Y.O.VAR.SOLAR EQ VAR.SOLAR       \
      AND Y.O.VAR.MANZANA EQ VAR.MANZANA AND Y.O.VAR.DISTRITO EQ VAR.DISTRITO AND Y.O.VAR.PROVINCIA EQ VAR.PROVINCIA \
      AND Y.O.VAR.CIUDAD EQ VAR.CIUDAD AND Y.O.VAR.TIPO EQ VAR.TIPO AND Y.O.VAR.CONDICION EQ VAR.CONDICION THEN
        PROCESS.GOAHEAD = ""
      END
*
    CASE LOOP.CNT EQ 2

...
CHEK.REV.PEND.DIS:
    ...
    Y.AAA.IDS = R.AA.ACT.HIS<AA.AH.ACTIVITY.ID> ; Y.AAA.IDS = CHANGE(Y.AAA.IDS,VM,SM)
...
GET.CHARGE.VALS:
    ...
    WHILE Y.CHG.CNT GT 0 DO
        ...
        CALL F.READ(FN.AA.PROPERTY,Y.CG,R.AA.PROP,F.AA.PROPERTY,PROP.ERR)
...
HAND.INS:
    ...
    END
    CALL F.READ(FN.COMPANY,Y.COMMON.VAL,R.COMP,F.COMPANY,COM.ERR)

...
*****************
  ...
  CALL F.READ(FN.LOCAL.REF.T,"ACCOUNT",R.LOCAL.REF.T,F.LOCAL.REF.T,LRT.ERR)
  RETURN
...
****************
  ...
  CALL F.READ(FN.LOCAL.TABLE,TABLE.NO,R.LOCAL.TABLE,F.LOCAL.TABLE,ERR.LT)
...
****************
  ...
  CALL F.READ(FN.CATEGORY,Y.AC.CATEG.NEW,R.CATEGORY,F.CATEGORY,CATEG.ERR)

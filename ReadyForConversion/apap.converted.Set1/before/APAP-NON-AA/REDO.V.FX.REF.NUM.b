...
*
        CASE LOOP.CNT EQ 2
            ...
            CALL F.READ(FN.CURRENCY,CURRENCY.ID,R.CURRENCY,F.CURRENCY,CURRENCY.ERR)
*
            IF R.CURRENCY THEN
...
*
    ...
    R.REDO.FOREX.SEQ.NUM<REDO.FXSN.INPUTTER>        = TNO:"_":OPERATOR
    R.REDO.FOREX.SEQ.NUM<REDO.FXSN.DATE.TIME>       = SYS.TIME.NOW
    R.REDO.FOREX.SEQ.NUM<REDO.FXSN.AUTHORISER>      = TNO:"_":OPERATOR
...
*
    ...
    R.REDO.FOREX.SELL.SEQ.NUM<REDO.FXSN.SELL.INPUTTER>        = TNO:"_":OPERATOR
    R.REDO.FOREX.SELL.SEQ.NUM<REDO.FXSN.SELL.DATE.TIME>       = SYS.TIME.NOW
    R.REDO.FOREX.SELL.SEQ.NUM<REDO.FXSN.SELL.AUTHORISER>      = TNO:"_":OPERATOR

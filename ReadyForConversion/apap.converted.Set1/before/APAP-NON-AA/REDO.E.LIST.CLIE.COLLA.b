...
* <Rating>-73</Rating>
*-----------------------------------------------------------------------------
* PACS00574755 - JP Armas fixing 17 Mar 2017
...
*=======================
    ...
    VAR.TIPO = System.getVariable("CURRENT.COL.TP")         ;*R.NEW(COLL.COLLATERAL.TYPE)
	VAR.CURRENCY = System.getVariable("CURRENT.COL.CUR") ; *R.NEW(COLL.CURRENCY)
...
*    IF (VAR.SALDO GT Y.AMT.REQ) AND (Y.STATUS2.FLAG = 0)   THEN
            IF Y.AZ.STATUS1 EQ "ACTIVE" AND Y.STATUS2.FLAG = 0 AND VAR.SALDO GT 0 THEN

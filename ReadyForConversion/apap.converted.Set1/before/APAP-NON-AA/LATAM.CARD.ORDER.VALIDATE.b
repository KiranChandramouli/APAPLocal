...
* CHANGES END  HD1101263
  ...
  CALL LATAM.CARD.ORDER.SPLIT.VALIDATE.3
...
************
  ...
  CALL LATAM.CARD.ORDER.SPLIT.VALIDATE.1
  CALL LATAM.CARD.ORDER.SPLIT.VALIDATE.2
...
*PACS00062260-END OF MODIFICATION------------------------------------------------
  ...
  IF R.NEW(CARD.IS.CARD.STATUS) = 90 AND R.NEW(CARD.IS.RENEW.STATUS) EQ "AVAILABLE" THEN

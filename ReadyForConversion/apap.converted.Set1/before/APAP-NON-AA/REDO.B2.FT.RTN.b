...
PROCESS:
  ...
  LOCATE 'CHARGE-1' IN R.POLICY<INS.POL.TYP.FIELD.NAME,1> SETTING X THEN
    Y.CHARGE = R.POLICY<INS.POL.TYP.FIELD.VALUES,X>
  END
...
PROCESS.BLSS:
  ...
  Y.NUM.BILLS = DCOUNT(Y.RSP.BL.IDS,VM) ; I = ''
  LOOP
  WHILE Y.NUM.BILLS GT 0 DO
    I += 1
    Y.BILL.ID = Y.RSP.BL.IDS<1,I>
    R.BILL = ''
    YERR = ''

...
*To get the values for transaction system id is FT
  ...
  END
  CALL F.READ(FN.FT.TXN.TYPE.CONDITION,VAR.FT.TYPE,R.FT.TYPE,F.FT.TXN.TYPE.CONDITION,FT.TYPE.ERR)
  IF VAR.PAY THEN
...
*To get the description value for teller txn
  ...
  END
  R.TT.TXN = ''
  CALL F.READ(FN.TELLER.TRANSACTION,VAR.TT.TXN,R.TT.TXN,F.TELLER.TRANSACTION,TT.TXN.ERR)

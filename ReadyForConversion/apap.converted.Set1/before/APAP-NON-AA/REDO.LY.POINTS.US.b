...
* </region>
*-----------------------------------------------------------------------------
  Table.name = 'REDO.LY.POINTS.US'      ;* Full application name including product prefix
  Table.title = 'LEALTAD - PUNTOS UTILIZADOS'     ;* Screen title
  ...
  Table.equatePrefix = 'REDO.PT.US'     ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------

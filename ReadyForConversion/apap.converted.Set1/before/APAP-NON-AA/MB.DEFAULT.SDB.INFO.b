    ...
    IF R.NEW(SDB.POST.SDB.NUMBER) AND R.NEW(SDB.POST.SDB.COMPANY) THEN
        ...
        IF INDEX(R.NEW(SDB.POST.SDB.NUMBER),'.',1) THEN
            ...
            IF SDB.STATUS THEN
                ...
                IF R.NEW(SDB.POST.SDB.OPERATE) = 'OPEN' THEN
...
* R.NEW(SDB.POST.CUSTOMER.NO) = ''
                ...
                IF R.NEW(SDB.POST.COLLECT.NEXT.P) = 'YES' THEN
            ...
            IF R.NEW(SDB.POST.SDB.OPERATE) = 'MODIFY' THEN
            ...
            IF SDB.STATUS AND R.NEW(SDB.POST.SDB.OPERATE) = 'CLOSE' THEN

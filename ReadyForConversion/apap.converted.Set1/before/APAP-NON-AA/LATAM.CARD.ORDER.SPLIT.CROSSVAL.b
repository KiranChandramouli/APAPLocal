...
*
  ...
  IF R.NEW(CARD.IS.CANCELLATION.DATE) AND R.NEW(CARD.IS.CAN.REASON) = "" THEN
...
*
      IF R.NEW(CARD.IS.CURRENCY) <> LCCY AND CHARGES THEN
        LCY.AMT = CHARGES
        YFAMT = ""
...
*PACS00072694-S
  ...
  IF GET.CARD.TYPE EQ "PRINCIPAL"  AND  R.NEW(CARD.IS.CARD.STATUS) = '90' AND R.NEW(CARD.IS.RENEW.STATUS) NE "AVAILABLE" THEN

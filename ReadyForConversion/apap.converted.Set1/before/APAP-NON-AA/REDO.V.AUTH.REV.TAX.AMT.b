...
*Raise the accounting entries
  ...
  CALL F.READ(FN.CURRENCY,Y.CURR,R.CURR,F.CURRENCY,CURR.ERR)
...
*Y.PL.CATEGORY = R.CERT.CHEQ.PARAM<CERT.CHEQ.PL.CATEGORY,POS>
  ...
  CALL F.READ(FN.FT.COMMISSION.TYPE,Y.TAX.KEY,R.FT.COMMISSION.TYPE,F.FT.COMMISSION.TYPE,TAX.ERR)

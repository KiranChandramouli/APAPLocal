...
END
IF R.CUSTOMER1<EB.CUS.LOCAL.REF,LOC.L.CU.TIPO.CL.POS> = "PERSONA JURIDICA" THEN
...
CALL F.READ(FN.EB.SYSTEM.ID,Y.SYSTEM.ID,R.EB.SYSTEM.ID,F.EB.SYSTEM.ID,Y.READ.ERR)
...
CALL F.READ(FN.CATEGORY,Y.AC.CATEG,R.CATEGORY,F.CATEGORY,Y.READ.ERR)
IF R.CATEGORY THEN
Y.CATEG.DESC = R.CATEGORY<EB.CAT.DESCRIPTION,1>
CONVERT '*' TO '' IN Y.CATEG.DESC
END

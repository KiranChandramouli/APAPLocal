...
*-----------------
  ...
  LOOP
  WHILE I LE VCOUNT
    LOC.VAR.REASON=R.NEW(AC.ACL.LOCAL.REF)<1,LOC.REF.AZ.REASON,I>
    LOC.VAR.OTHERS=R.NEW(AC.ACL.LOCAL.REF)<1,LOC.REF.AC.OTHER,I>
...
*----------------
  IF APPLN EQ "AZ.ACCOUNT" THEN
    ...
    LOOP
    WHILE I LE VCOUNT
      LOC.VAR.REASON=R.NEW(AZ.LOCAL.REF)<1,LOC.REF.AZ.REASON,I>
      LOC.VAR.OTHERS=R.NEW(AZ.LOCAL.REF)<1,LOC.REF.AZ.OTHER,I>

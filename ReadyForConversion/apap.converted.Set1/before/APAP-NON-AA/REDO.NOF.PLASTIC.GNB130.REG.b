...
FOR I = 1 TO Y.NO.CARD1
Y.CARD1 = FIELD(Y.CARD.TYPE,@VM,I,1)
Y.DUE.DATE.GEN=R.REDO.CARD.GENERATION<REDO.CARD.GEN.EXPIRY,I>
Y.CARD.NUMBER=R.REDO.CARD.GENERATION<REDO.CARD.GEN.CARD.NUMBERS,I>
LOOP
...
Y.PRLC.HIS.CNT++
REPEAT
Y.PR.LOST.CARD.HIS.CNT++
REPEAT
IF NOT(Y.PL.CON.FL) THEN
RETURN
END
Y.PR.CARD.LOST.CUR.NO--
REPEAT
RETURN

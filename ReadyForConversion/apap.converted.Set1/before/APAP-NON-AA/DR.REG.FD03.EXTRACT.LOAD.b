...
*-----------------------------------------------------------------------------
    ...
    $INCLUDE REGREP.BP I_DR.REG.FD03.EXTRACT.COMMON
...
**********
    ...
    CUS.FLD = 'L.CU.CIDENT':VM:'L.CU.RNC':VM:'L.CU.NOUNICO':VM:'L.CU.ACTANAC':VM:'L.CU.TIPO.CL':VM:'L.LOCALIDAD':VM:'L.CU.FOREIGN'
    ...
    L.CU.CIDENT.POS = FLD.POS<3,1>
    L.CU.RNC.POS = FLD.POS<3,2>
    L.CU.NOUNICO.POS = FLD.POS<3,3>
    L.CU.ACTANAC.POS = FLD.POS<3,4>
    L.CU.TIPO.CL.POS = FLD.POS<3,5>
    L.LOCALIDAD.POS = FLD.POS<3,6>
    L.CU.FOREIGN.POS = FLD.POS<3,7>
    RETURN

...
************
  ...
  IF R.NEW(CARD.IS.NEW.REPAY.DATE)[1,8] < R.NEW(CARD.IS.REPAY.DATE)[1,8] THEN
    R.NEW(CARD.IS.LST.REPAY.DATE) = R.NEW(CARD.IS.NEW.REPAY.DATE)[1,8]
    R.NEW(CARD.IS.NEW.REPAY.DATE) = ''
  END

  IF R.NEW(CARD.IS.NEW.BILLING.CLOSE) NE '' AND R.NEW(CARD.IS.NEW.BILLING.CLOSE)[1,8] < R.NEW(CARD.IS.BILLING.CLOSE)[1,8] THEN
...
**************************
  ...
  IF CHARGES THEN
    ...
    IF R.NEW.LAST(CARD.IS.RECORD.STATUS)[2,2] = 'NA' AND R.NEW(CARD.IS.STMT.NO)='VAL' THEN
      VAL.CHG='CHG'
    END ELSE
      VAL.CHG='VAL'
    END

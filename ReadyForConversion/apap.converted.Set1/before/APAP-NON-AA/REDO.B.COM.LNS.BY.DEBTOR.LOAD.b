...
*
    ...
    Y.OUT.FILE.NAME = Y.FILE.NAME:".TEMP.":SESSION.NO:".":SERVER.NAME
*
...
*
    CALL F.READ(FN.AA.PRODUCT.GROUP,'COMERCIAL',R.AA.PRODUCT.GROUP.COM,F.AA.PRODUCT.GROUP,PRDT.ERR)
    ...
    IF Y.PRDT.LNE EQ "LENDING" THEN
        ...
        END
    END
    CALL F.READ(FN.AA.PRODUCT.GROUP,'LINEAS.DE.CREDITO',R.AA.PRODUCT.GROUP.LIN,F.AA.PRODUCT.GROUP,PRDT.ERR)

...
*Pos 10 in Array
     *  YLAMT = YSE.REC<3>
      ...
      E.ARRAY<-1> = "SE:":H:"-":YECONTRACT.ID:YSEP:YSE.KEY:YSEP:YBDATE:YSEP:YACCT:YSEP:YCUST:YSEP:YCOMP:YSEP:YVDATE:YSEP:YCCY:YSEP:YFAMT:YSEP:YLAMT
    END
  NEXT H
  RETURN
*---------------
...
*-------------------------
   ...
   *  YLAMT = YRCSE.REC<3>
      ...
      E.ARRAY<-1> = "RCSE:":I:"-":YECONTRACT.ID:YSEP:YRCSE.KEY:YSEP:YBDATE:YSEP:YACCT:YSEP:YCUST:YSEP:YCOMP:YSEP:YVDATE:YSEP:YCCY:YSEP:YFAMT:YSEP:YLAMT
    END
  NEXT I
  RETURN
*---------------
...
*-------------------------
   ...
   *  YLAMT = YCE.REC<3>
      ...
      E.ARRAY<-1> = "CE:":J:"-":YECONTRACT.ID:YSEP:YCE.KEY:YSEP:YBDATE:YSEP:YACCT:YSEP:YCUST:YSEP:YCOMP:YSEP:YVDATE:YSEP:YCCY:YSEP:YFAMT:YSEP:YLAMT
    END
  NEXT J
  RETURN
*---------

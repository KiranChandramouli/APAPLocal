...
* <Rating>61</Rating>
*-----------------------------------------------------------------------------
  SUBROUTINE REDO.E.NOF.FXSN.SELL(RETURN.ARR)
*----------------------------------------------------------------------------------------------------
*DESCRIPTION : This is a no file enquiry routine for the enquiry REDO.ENQ.FXSN.SELL.DETAILS
*-----------------------------------------------------------------------------------------------------
*-----------------------------------------------------------------------------------------------------
* * Input / Output
* --------------
...
* Program Name : REDO.E.NOF.FXSN.SELL
*-----------------------------------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------------------------------
  ...
  SELECT.COMMAND.1 = "SELECT ":FN.REDO.FOREX.SELL.SEQ.NUM:" WITH @ID NE '' "
...
*-----------------------------------------------------------------------------------------------------
  ...
  IF TEMP.SELECT.COMMAND.1 EQ SELECT.COMMAND.1 THEN
    SELECT.COMMAND.1 = "SELECT ":FN.REDO.FOREX.SELL.SEQ.NUM
  END
...
*-----------------------------------------------------------------------------------------------------
  ...
  WHILE FXSN.ID:FXSN.POS
    ...
    CALL F.READ(FN.REDO.FOREX.SELL.SEQ.NUM,FXSN.ID,R.REDO.FOREX.SEQ.NUM,F.REDO.FOREX.SELL.SEQ.NUM,REDO.FOREX.SEQ.NUM.ERR)

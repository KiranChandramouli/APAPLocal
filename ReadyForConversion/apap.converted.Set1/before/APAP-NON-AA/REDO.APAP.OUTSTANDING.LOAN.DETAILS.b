...
*---------------
  ...
  Y.BALANCE.CHARGE = Y.BALANCE.CHARGE - Y.TOT.BAL.DUE
  RETURN
*-----------------------------------------------------------------------------
CALL.GET.ACC.INT:
*---------------
...
*-----------------------------------------------------------------------------
  ...
  Y.INTEREST.BALANCE = Y.INTEREST.BALANCE+Y.PENALTY.INT     ;* Accrued penalty interest has been added to interest balance as per the issue raised by cristina on 11 Mar 2015.
  RETURN
*-----------------------------------------------------------------------------
ACCT.ACT.BK.BAL:
*---------------

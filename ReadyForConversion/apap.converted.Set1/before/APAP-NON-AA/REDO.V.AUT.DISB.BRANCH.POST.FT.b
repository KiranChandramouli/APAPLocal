...
*
  ...
  IF R.REDO.AA.DISB.LOAN THEN
    ...
    FOR I = 1 TO Y.TOT.BRANCH
      Z.BRANCH.ID  = Y.BRANCH.ID<1,I>
      Z.DISB.TYPE  = Y.DISB.TYPE<1,I>
      Z.DISB.AMT   = Y.DISB.AMT<1,I>
      Z.BR.DISB.AC = Y.BR.DISB.AC<1,I>

      Y.TOT.DISB.TYPE = DCOUNT(Z.DISB.TYPE,SM)
      Y.BR.DISB.AMT = 0
      FOR J = 1 TO Y.TOT.DISB.TYPE
        X.DISB.TYPE = Z.DISB.TYPE<1,1,J>
        Y.BR.DISB.AMT = Z.DISB.AMT<1,1,J>
    ...
    FOR J = 1 TO Y.TOT.DISB.TYPE
      X.DISB.TYPE   = Y.MN.DISB.TYPE<1,J>
      Y.BR.DISB.AMT = Y.MN.DISB.AMT<1,J>
      IF Y.BR.DISB.AMT GT 0 THEN

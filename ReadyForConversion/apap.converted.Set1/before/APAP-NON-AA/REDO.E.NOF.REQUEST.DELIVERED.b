...
* <Rating>59</Rating>
*--------------------------------------------------------------------------------------------------------
  SUBROUTINE REDO.E.NOF.REQUEST.DELIVERED(TX.ARRAY)
*--------------------------------------------------------------------------------------------------------
*Company   Name    : ASOCIACION POPULAR DE AHORROS Y PRESTAMOS
*Developed By      : Temenos Application Management
*Program   Name    : REDO.E.NOF.REQUEST.DELIVERED
*--------------------------------------------------------------------------------------------------------
*Description  : This is a no file enquiry routine for the enquiry REDO.CARD.DELIVERED
*Linked With  : Enquiry REDO.CARD.DELIVERED
*In Parameter : N/A
...
PROCESS.DATA:
***************
  SEL.CMD = 'SELECT ':FN.REDO.CARD.REQUEST:' WITH STATUS EQ 4 AND WITH RENEWAL.FLAG NE "YES" '

  Y.USER.ID = OPERATOR
  CALL F.READ(FN.USER,Y.USER.ID,R.USER.REC,F.USER,Y.ERR.USER)

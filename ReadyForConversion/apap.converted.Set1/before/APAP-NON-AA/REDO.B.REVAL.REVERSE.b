...
* Mod1 S
    ...
    IF R.SPEC.ENTRY<RE.CSE.TRANSACTION.CODE> = 'RVL' AND R.SPEC.ENTRY<RE.CSE.BOOKING.DATE> = TODAY ELSE RETURN
* Mod1 E
...
BRK.CRT:
    ...
    CONVERT SM TO VM IN TEMP.CCY.LIVE.ARRAY

...
SELECT.MB.SDB.STATUS:
    ...
    WHILE SDB.STATUS.ID:POS.STATUS.ID
        ...
        IF BOX.STATUS = 'AVAILABLE' THEN
            BOX.AVAILABLE = BOX.AVAILABLE + 1
        END
        IF BOX.STATUS = 'RESERVED' THEN
            BOX.RESERVED = BOX.RESERVED + 1
        END
        IF BOX.STATUS = 'RENTED' THEN
            TOD.BOX.RENTED = TOD.BOX.RENTED + 1
            IF STAFF.FLAG EQ '1' THEN
                BOX.RENTED.STAFF = BOX.RENTED.STAFF + 1
            END ELSE
                BOX.RENTED.CUSTOMER = BOX.RENTED.CUSTOMER + 1
            END
        END
        IF BOX.STATUS = 'REPAIR' THEN
            BOX.REPAIR = BOX.REPAIR + 1
        END
...
SELECT.MB.SDB.CLOSED:
    ...
    WHILE SDB.CLOSED.ID:POS.CLOSED.ID
        ...
        FOR RENT.AMOUNT.CT = 1 TO RENT.AMOUNT.DC
            ...
            END
        NEXT RENT.AMOUNT.CT
        TOT.RENT.AMOUNT.REFUNDED = TOT.RENT.AMOUNT.REFUNDED + REFUND.AMT
        TOT.VAT.AMOUNT.REFUNDED = TOT.VAT.AMOUNT.REFUNDED + VAT.REFUND.AMT

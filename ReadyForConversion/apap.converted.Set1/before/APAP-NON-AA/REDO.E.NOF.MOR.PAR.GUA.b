...
*-----------------
  ...
  IF R.AZ.CUS.REC<EB.CUS.LOCAL.REF,LOC.L.CU.TIPO.CL.POS> = "PERSONA FISICA" OR R.AZ.CUS.REC<EB.CUS.LOCAL.REF,LOC.L.CU.TIPO.CL.POS> = "CLIENTE MENOR" THEN
    Y.CUS.NAMES = R.AZ.CUS.REC<EB.CUS.GIVEN.NAMES>:" ":R.AZ.CUS.REC<EB.CUS.FAMILY.NAME>
  END
  IF R.AZ.CUS.REC<EB.CUS.LOCAL.REF,LOC.L.CU.TIPO.CL.POS> = "PERSONA JURIDICA" THEN

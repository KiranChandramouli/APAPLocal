...
PROCESS:
********
    CCY.VAL = ''; VAL.DATE = ''; CUS.ID = ''; YCAT.ID = ''; YWORK.BAL = ''; AMT.VAL = ''
    BEGIN CASE
    ...
    CASE CONTROL.LIST<1,1> EQ "GRP.16"
        ...
        IF BANK.EMP.FLAG EQ 'NO' THEN
            ...
            AMT.VAL = R.ACCOUNT<AC.AMNT.LAST.CR.CUST>
            BEGIN CASE
...
*****************
    ...
    CALL F.READ(FN.DR.REG.PASIVAS.GROUP,YPASIV.ID,R.DR.REG.PASIVAS.GROUP,F.DR.REG.PASIVAS.GROUP,DR.REG.PASIVAS.GROUP.ERR)
    RETURN

EVAL.PROD.INT.RATE:
*-----------------*
*
    PROD.INT.RATE = ""        ;* Byron - PACS00305233 S/E
    ...
    R.AZ.PRODUCT.PARAMETER = ''; AZ.PRODUCT.PARAMETER.ERR = ''
...
DATE.30.CHK:
*************
    YACT.MONTH = 0; Y.NO.OF.MONTHS = 0; Y.MNTH = ''

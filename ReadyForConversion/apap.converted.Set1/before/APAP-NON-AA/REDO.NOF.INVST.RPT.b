...
*If the count is 2 then get the dates in DATE.1 and DATE.2 and call the routine REDO.GET.MTH.DETAILS with parameters
  ...
  Y.REJ.CHQ.CNT = ''
  IF Y.COUNT EQ '2' THEN
    CALL REDO.GET.MTH.DETAILS(Y.TXN.DATE1,Y.TXN.DATE2,OUT.MONTH,OUT.DATE,OUT.COUNT,OUT.MTH.DATE)
...
*-------CHECK FOR SAVINGS ACCOUNT --------
  ...
  CALL F.READ(FN.ACCT.CLASS,Y.ACCT.CLASS,R.ACCT.CLASS,F.ACCT.CLASS,CLASS.ERR)

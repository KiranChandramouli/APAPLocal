...
*-----------------------------------------------------------------------------
    ...
    $INCLUDE REGREP.BP I_DR.REG.FD01.EXTRACT.COMMON
...
************
    ...
    SEL.CMD = "SELECT ":FN.POS.MVMT.TDY:" WITH SYSTEM.ID EQ 'TT' 'FT' 'FX' AND BOOKING.DATE EQ ":Y.TODAY.DATE.TIME:" AND CURRENCY NE ":YLCCY

...
*****************
  ...
  CALL F.READ(FN.AC.ENTRY.PARAM,Y.PARAM.ID,R.AC.ENTRY.PARAM,F.AC.ENTRY.PARAM,AC.ENT.PAR)
...
*******************
  ...
  END ELSE
    ...
    IF Y.COMP.CODE NE '' THEN
      CALL F.READ(FN.TELLER.PARAMETER,Y.COMP.CODE,R.TELLER.PARAMETER,F.TELLER.PARAMETER,PARAMETER.ERR)

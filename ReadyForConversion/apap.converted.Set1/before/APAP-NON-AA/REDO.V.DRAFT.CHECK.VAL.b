...
******
  ...
  CALL F.READ(FN.FTTC,Y.FT.TRANSACTION.TYPE,R.FTTC,F.FTTC,FTTC.ERR)
  Y.FT.COMM.TYPES  =  R.FTTC<FT6.COMM.TYPES>
  CALL F.READ(FN.FT.COMMISSION.TYPE,Y.FT.COMM.TYPES,R.FT.COMMISSION.TYPE,F.FT.COMMISSION.TYPE,FT.COMMISSION.TYPE.ERR)

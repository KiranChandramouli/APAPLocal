...
*------------------
  ...
  WHILE Y.FT.ID:Y.FT.POS
    ...
    IF R.FUNDS.TRANSFER.NAU THEN
      ...
      IF CONTINUE.FLAG EQ 1 THEN CONTINUE
...
*-------
  ...
  IF R.STANDING.ORDER THEN
    ...
    CALL F.READ(FN.FT.TXN.TYPE.CONDITION, Y.PAY.MTHD, R.FT.TXN.TYPE.CONDITION, F.FT.TXN.TYPE.CONDITION, Y.ERR.FT.TXN.TYPE.CONDITION)

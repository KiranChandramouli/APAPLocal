...
*-----------
    ...
    Y.FIELDS = "L.CU.TIPO.CL":VM:"L.CU.CIDENT":VM:"L.CU.RNC":VM:"L.CU.DEBTOR":VM:"L.TIP.CLI":VM:"L.CU.FOREIGN":VM:"L.APAP.INDUSTRY":VM:"L.AA.MMD.PYME":FM:"L.AA.CATEG":FM:"L.LOAN.STATUS.1":FM:"L.OD.STATUS"
    Y.FIELD.POS = ""

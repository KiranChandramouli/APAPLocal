...
*
  ...
  WHILE NO.OF.REC NE 1 AND LOOP.CNT LE 10 DO
    ...
    IF NO.OF.REC = 0 THEN SLEEP 3
    LOOP.CNT += 1
  REPEAT
*
  IF NO.OF.REC EQ 1 THEN GOSUB B130.DELETE
*
  ENQ.DATA<3,Y.POS> = "LK"
...
*
  ...
  WHILE LOOP.CNT LE MAX.LOOPS AND PROCESS.GOAHEAD DO
    ...
    CASE LOOP.CNT EQ 2
      ...
      IF YER.BP OR WHEADER.ESTADO = "APLICADO" OR WHEADER.ESTADO = "DESESTIMADO" OR WHEADER.ESTADO = "EN PROCESO" THEN

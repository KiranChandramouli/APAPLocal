...
*-----------------------------------------------------------------------------------------------------------
PROCESS.REMOVE.DATA:
IF R.PAY.SCH<AA.PS.PAYMENT.TYPE,I> EQ  Y.PAYMENT.TYPE THEN
   X6 = DCOUNT(R.PAY.SCH<AA.PS.PROPERTY,I>,SM)         
   FOR J = 1 TO X6
      X7 = R.PAY.SCH<AA.PS.PROPERTY,I,J>
      LOCATE Y.PROPERTY IN R.PAY.SCH<AA.PS.PROPERTY,I,J> SETTING Y.POS THEN
         DEL R.PAY.SCH<AA.PS.PAYMENT.TYPE,I> 
         DEL R.PAY.SCH<AA.PS.PAYMENT.METHOD,I> 
         DEL R.PAY.SCH<AA.PS.PAYMENT.FREQ,I> 
         DEL R.PAY.SCH<AA.PS.BILL.TYPE,I> 
         
         DEL R.PAY.SCH<AA.PS.PROPERTY,I,Y.POS> 
         DEL R.PAY.SCH<AA.PS.DUE.FREQ,I,Y.POS> 
         DEL R.PAY.SCH<AA.PS.START.DATE,I,Y.POS> 
         DEL R.PAY.SCH<AA.PS.END.DATE,I,Y.POS> 
         DEL R.PAY.SCH<AA.PS.ACTUAL.AMT,I,Y.POS>       

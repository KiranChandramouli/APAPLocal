...
FIND.LOCAL.REF.FLDS:
*------------------
    Y.APP = "CUSTOMER":FM:"FUNDS.TRANSFER":FM:"TELLER":FM:"FOREX"
    Y.FIELDS = "L.CU.CIDENT":VM:"L.CU.RNC":VM:"L.CU.FOREIGN":VM:"L.CU.NOUNICO":VM:"L.CU.ACTANAC":FM:"L.TT.TAX.AMT":VM:"L.FT.WV.TAX":VM:"L.FT.LEGAL.ID":FM:"L.TT.TAX.AMT":VM:"L.TT.WV.TAX":VM:"L.TT.LEGAL.ID":VM:"L.TT.DOC.NUM":FM:"L.FX.LEGAL.ID"
    ...
    L.FX.LEGAL.ID.POS = Y.FIELD.POS<4,1>
    RETURN
...
*
    ...
    CALL F.READ(FN.FT.COMMISSION.TYPE,Y.RCL.TXN.TAX,R.FT.COMMISSION.TYPE,F.FT.COMMISSION.TYPE,ERR.COMM.TYPE)

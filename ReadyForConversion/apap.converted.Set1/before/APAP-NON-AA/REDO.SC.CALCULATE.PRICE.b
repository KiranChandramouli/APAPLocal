...
*Calculates the difference between the given dates DATE1 & DATE2
  ...
  BEGIN CASE
  CASE YEAR.DAYS.BASIS[1,1] = 'A' OR YEAR.DAYS.BASIS[1,1] = 'D' OR YEAR.DAYS.BASIS[1,1] = 'F'
...
* gets the number of days in the month
  ...
  BEGIN CASE
  CASE MATURITY.DATE[5,2] MATCHES ODD.MONTH AND MATURITY.DATE[7,2] = '30'
    MAT.DATE = '31'

  CASE MATURITY.DATE[5,2] = '02' AND  MATURITY.DATE[7,2] = '29'
    MAT.DATE = '31'

  CASE MATURITY.DATE[5,2] = '02' AND MATURITY.DATE[7,2] = '28' AND NOT(IS.LEAP.YEAR)
    MAT.DATE = '31'
...
* Alter the Dates according to the requirement for A3 Basis
  IF YEAR.DAYS.BASIS[1,2] = 'A3' THEN
    IF D1 = 31 THEN
      D1 = 30
    END
    IF D2 = 31 THEN

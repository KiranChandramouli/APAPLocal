...
CHANGE.SUB.PROCESS:
*----------------------------------------------------------------------------------------
    CALL F.READ(FN.AA.PROPERTY,Y.AA.PROP.ID,R.AA.PROPERTY,F.AA.PROPERTY,AA.PROP.ERR)
...
*----------------------------------------------------------------------------------------
    ...
    IF Y.FLOATING.INDEX THEN
        ...
        CALL F.READ(FN.BASIC.INTEREST,SEL.LIST,R.BASIC.INTEREST,F.BASIC.INTEREST,Y.BI.ERR)

...
* Obtener la informacion de acuerdo al tipo de COLLATERAL
  ...
  WHILE I LE Y.CL.TYPE.NUM

    Y.CL.TYPE = FIELD(R.REDO.COLLATERAL.PARAMETER<REDO.CL.PR.COLLATERAL.TYPE>,VM,I)

    IF Y.CL.TYPE EQ R.NEW(COLL.COLLATERAL.TYPE) THEN

      Y.CR.CATEGORY.CODE = FIELD(R.REDO.COLLATERAL.PARAMETER<REDO.CL.PR.CR.CATEGORY.CODE>,VM,I)

      Y.DB.CATEGORY.CODE = FIELD(R.REDO.COLLATERAL.PARAMETER<REDO.CL.PR.DB.CATEGORY.CODE>,VM,I)



      Y.CR.TRX = FIELD(R.REDO.COLLATERAL.PARAMETER<REDO.CL.PR.CR.TRX.CODE>,VM,I)

      Y.DB.TRX = FIELD(R.REDO.COLLATERAL.PARAMETER<REDO.CL.PR.DB.TRX.CODE>,VM,I)



      Y.CY.NUM = DCOUNT(R.REDO.COLLATERAL.PARAMETER<REDO.CL.PR.CURRENCY,I>,SM)
...
OBTAIN.ACC.DETAILS2:
  ...
  WHILE J LE Y.CY.NUM
    ...
    Y.CY = FIELD(R.REDO.COLLATERAL.PARAMETER<REDO.CL.PR.CURRENCY,I>,SM,J)

    IF Y.CY EQ R.NEW(COLL.CURRENCY) THEN

      Y.CR.INT.ACCOUNT   = FIELD(R.REDO.COLLATERAL.PARAMETER<REDO.CL.PR.CR.INT.ACCOUNT,I>,SM,J)

      Y.DB.INT.ACCOUNT   = R.REDO.COLLATERAL.PARAMETER<REDO.CL.PR.DB.INT.ACCOUNT,I,J>

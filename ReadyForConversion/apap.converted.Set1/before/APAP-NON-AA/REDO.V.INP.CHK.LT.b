...
*--------*
  ...
  CONVERT SM TO FM IN CUR1.LIST
  LOCATE R.NEW(TT.TE.CURRENCY.1) IN CUR1.LIST SETTING CUR1.POS ELSE CUR1.POS=''
  CUR2.LIST=R.TELLER.REC.2<TT.TID.LOCAL.REF,L.TT.CURRENCY.POS>
  CUR2.SIZE=DCOUNT(CUR2.LIST,SM)
  CONVERT SM TO FM IN CUR2.LIST
  LOCATE R.NEW(TT.TE.CURRENCY.2) IN CUR2.LIST SETTING CUR2.POS ELSE CUR2.POS=''
  IF R.TELLER.REC.1<TT.TID.LOCAL.REF><1,L.TT.MN.VAU.LIM.POS,CUR1.POS> NE "" THEN
    ...
    *Tus Start
    ...
    CUR.POS=CUR1.POS
  END
  ELSE IF R.TELLER.REC.2<TT.TID.LOCAL.REF><1,L.TT.MN.VAU.LIM.POS,CUR2.POS> NE "" THEN
    Y.FLAG="ONE"
...
*--------*
  IF R.TELLER.REC.1<TT.TID.LOCAL.REF><1,L.TT.BRAN.LIM.POS,CUR1.POS> NE "" AND R.NEW(TT.TE.DR.CR.MARKER) EQ "CREDIT" THEN
    ...
    GOSUB BR.CREDIT
  END
  ELSE IF R.TELLER.REC.2<TT.TID.LOCAL.REF><1,L.TT.BRAN.LIM.POS,CUR2.POS> NE "" AND R.NEW(TT.TE.DR.CR.MARKER) EQ "DEBIT" THEN
    GOSUB BR.DEBIT
  END
  ELSE
    GOSUB DE.TILL
...
*--------*
  IF R.TELLER.REC.1<TT.TID.LOCAL.REF><1,L.TT.TILL.LIM.POS,CUR1.POS> EQ R.TELLER.REC.2<TT.TID.LOCAL.REF><1,L.TT.TILL.LIM.POS,CUR2.POS> THEN
    Y.FLAG="THREE"
  END
  ELSE IF R.TELLER.REC.2<TT.TID.LOCAL.REF><1,L.TT.TILL.LIM.POS,CUR2.POS> NE "" THEN
    Y.FLAG="FOUR"
  END
  RETURN
*--------*

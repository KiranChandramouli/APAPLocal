...
* Y.ACCOUNT.ID = R.NEW(TT.TE.LOCAL.REF)<1,LOC.POS>
  ...
  APPL.ARRAY = "CUSTOMER":FM:"TELLER"
  FIELD.ARRAY = "L.CU.TIPO.CL":FM:"L.TT.AZ.ACC.REF"
  FIELD.POS = ''
...
* LOC.L.CU.TIPO.CL.POS = FIELD.POS
  ...
  IF R.CUSTOMER<EB.CUS.LOCAL.REF,LOC.L.CU.TIPO.CL.POS> = "PERSONA JURIDICA" THEN
...
*           END
      ...
      IF R.CUSTOMER<EB.CUS.LOCAL.REF,LOC.L.CU.TIPO.CL.POS> = "PERSONA FISICA" OR R.CUSTOMER<EB.CUS.LOCAL.REF,LOC.L.CU.TIPO.CL.POS> = "CLIENTE  MENOR" THEN

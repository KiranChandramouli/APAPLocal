...
*********************************************************       AVAILABLE.BAL.LIST=AVAILABLE.BAL.LIST:FM:TEMP.AVAILABLE.BAL
    AVAILABLE.BAL=AVAILABLE.BAL+TEMP.AVAILABLE.BAL
    D.ACCOUNT.COUNT=D.ACCOUNT.COUNT+1
...
*        ACCOUNT.ID=FIELD(ACCOUNT.LIST,FM,D.ACCOUNT.COUNT)
    ...
    CALL F.READ(FN.CURRENCY,Y.CURRENCY,R.CURRENCY,F.CURRENCYP,ERR)

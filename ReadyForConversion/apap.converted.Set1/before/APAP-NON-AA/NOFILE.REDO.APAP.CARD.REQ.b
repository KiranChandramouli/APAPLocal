...
CALL F.READ(FN.COMPANY, Y.BRANCH.CODE, R.REC.COMPANY, F.COMPANY, Y.ERR.COMPANY)
...
REPEAT
*
CONVERT FM TO VM IN Y.RET.ARRAY
Y.VAR = Y.RET.ARRAY
Y.FIN.ARRAY = SORT(Y.VAR)
CONVERT VM TO FM IN Y.TEMP.CARD
CONVERT VM TO FM IN Y.TEMP.AMT.CARDS
*

...
*
    ...
    R.REDO.H.BANK.DRAFTS<REDO.BANK.INPUTTER>   = TNO:'_':OPERATOR
    R.REDO.H.BANK.DRAFTS<REDO.BANK.AUTHORISER> = TNO:'_':OPERATOR
...
* To write the REDO.MANAGER.CHQ.DETAILS using F.WRITE
  ...
  R.REDO.MANAGER.CHQ.DETAILS<MAN.CHQ.DET.INPUTTER>=TNO:'_':OPERATOR
  R.REDO.MANAGER.CHQ.DETAILS<MAN.CHQ.DET.AUTHORISER>=TNO:'_':OPERATOR

...
* OFAC
  CALL REDO.FIND.CUST.OFAC(OFAC.TIPO.CL,Y.CUST.NAME,OFAC.GIVEN.NAMES,OFAC.FAMILY.NAME,OFAC.CUS.NAME1,OFAC.CUS.NAME2,OFAC.CUS.TEXT,OFAC.RET)
  Y.DATA<2> = OFAC.RET
  IF OFAC.RET EQ '' THEN
* Log writing: OFAC did not return valid value YES/NO
    CALL REDO.S.NOTIFY.INTERFACE.ACT('VPL007', 'ONLINE', '04', 'OFAC', 'ERROR EN LISTAS RESTRICTIVAS A LAS ' : TIMEDATE(), '', '', '', '', '', '', '')
  END

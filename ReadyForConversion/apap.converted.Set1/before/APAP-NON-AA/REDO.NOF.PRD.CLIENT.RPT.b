...
**********
  ...
  WHILE Y.CUST.ID:CUS.POSD
    ...
    IF Y.PROCESSED.ACCOUNTS THEN
      CALL REDO.NOF.CLIENT.DETAILS(Y.CUST.ID,Y.PROCESSED.ACCOUNTS,Y.RETURN.ARRAY,MAIN.CARD.FLAG,CR.PROFILE.VAL,AGENCY.VAL,SAVING.ACCOUNT.VAL,INVESTMENT.VAL)
    END

...
*******************
  ...
  CALL F.READ(FN.AA.ACTIVITY,Y.ACT.ACTIVITY,R.AA.ACTIVITY,F.AA.ACTIVITY,AA.ACTIVITY.ERR)
...
*******************
  ...
  IF NOT(FT.ERR) THEN
    ...
    END
    CALL F.READ(FN.TRANSACTION,Y.FTTC.TXN.CODE,R.TRANSACTION,F.TRANSACTION,TRANSACTION.ERR)

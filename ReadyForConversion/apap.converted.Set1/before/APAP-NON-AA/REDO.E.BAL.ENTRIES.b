...
STMT.COUNTER:
*-------------------------
  FOR H = 1 TO YSTMT.COUNT
*YSE.KEY = FIELD(YECONT.BAL.REC<ECB.STMT.ENT.IDS,H>,"/",1)
    YSE.KEY = FIELD(Y.ID.LIST<H>,'*',2) ;* IDs Fetched via Core enquiry.
    YSE.REC = "" ; ERR.SE = ""
...
*Pos 10 in Array
  ...
  E.ARRAY<-1> = "SE:":H:"-":YECONTRACT.ID:YSEP:YSE.KEY:YSEP:YBDATE:YSEP:YACCT:YSEP:YCUST:YSEP:YCOMP:YSEP:YVDATE:YSEP:YCCY:YSEP:YFAMT:YSEP:YLAMT:'*':Y.CONSOL.KEY:'*':Y.CRF.TYPE:'*':Y.BALANCE.TYPE:'*':Y.TRANS.CODE:'*':Y.TRANS.REF:'*':Y.TRANS.DESC
  RETURN
*---------------
CONSOL.COUNTER:
*-------------------------
...
*---------------
  ...
  IF YTXNC.KEY THEN
    YTXNC.REC = ""
    ERR.TXNC = ""
    CALL F.READ(FN.TXNC, YTXNC.KEY, YTXNC.REC, F.TXNC, ERR.TXNC)
    IF YTXNC.REC THEN
  ...
  IF Y.TRANS.DESC ELSE
    ...
    END
  END
  E.ARRAY<-1> = "RCSE:":I:"-":YECONTRACT.ID:YSEP:YRCSE.KEY:YSEP:YBDATE:YSEP:YACCT:YSEP:YCUST:YSEP:YCOMP:YSEP:YVDATE:YSEP:YCCY:YSEP:YFAMT:YSEP:YLAMT:'*':Y.CONSOL.KEY:'*':Y.CRF.TYPE:'*':Y.BALANCE.TYPE:'*':Y.TRANS.CODE:'*':Y.TRANS.REF:'*':Y.TRANS.DESC
  RETURN
*---------------
CATEG.COUNTER:
*-------------------------
...
*YCE.KEY = FIELD(YECONT.BAL.REC<ECB.CATEG.ENT.IDS,J>,"/",1)
    ...
    IF YCE.REC THEN
      ...
      IF Y.TRANS.DESC ELSE
        ...
        END
      END
      E.ARRAY<-1> = "CE:":J:"-":YECONTRACT.ID:YSEP:YCE.KEY:YSEP:YBDATE:YSEP:YACCT:YSEP:YCUST:YSEP:YCOMP:YSEP:YVDATE:YSEP:YCCY:YSEP:YFAMT:YSEP:YLAMT:'*':Y.CONSOL.KEY:'*':Y.CRF.TYPE:'*':Y.BALANCE.TYPE:'*':Y.TRANS.CODE:'*':Y.TRANS.REF:'*':Y.TRANS.DESC
    END
  NEXT J
  RETURN
*---------

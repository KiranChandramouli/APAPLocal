...
*======
  ...
  VAR.DATO = COMI
  CALL APAP.H.INSURANCE.BEHAVIOUR.RTN
  COMI = VAR.DATO
...
*Read the firt record
    ...
    IF  COMI EQ "INCLUIR EN CUOTA" THEN POS.I = 1
    IF  COMI EQ "NO INCLUIR EN CUOTA" THEN POS.I = 2

...
***************
  ...
  WHILE Y.INIT.COUNT LE Y.TOT.CARD.TYPES
    ...
    IF V$FUNCTION = "R" OR R.NEW(REDO.CARD.REQ.RECORD.STATUS) EQ "RNAU" OR R.NEW(REDO.CARD.REQ.STATUS) EQ '4' OR  R.NEW(REDO.CARD.REQ.STATUS) EQ '5' THEN

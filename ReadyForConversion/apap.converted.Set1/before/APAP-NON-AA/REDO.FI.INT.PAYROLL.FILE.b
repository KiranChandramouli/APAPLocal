...
*    GOSUB FT.PROCESS
  ...
  Y.TEMP.ID=TODAY:FI.FILE.ID:STR("0",(5-LEN(I))):I
  ...
  R.REDO.TEMP.FI.CONTROL<FI.TEMP.MAIL.MSG>  =IN.TXT.MSG<I>
...
*
  IF Y.ERR.MSG NE "" THEN
    ...
    Y.MAIL.MSG<-1> = IN.TXT.MSG<I+1>:'-':'FAILURE'
  END ELSE
    W.STATUS = "01"
    W.ERROR.MSG = "OK"
    W.TOTAL.TRANSACC += R.PARAM<3>
    Y.MAIL.MSG<-1> = IN.TXT.MSG<I+1>:'-':'SUCCESS'
  END
...
* ==============
  ...
  CALL REDO.FI.RECORD.TXN.DETAILS(R.PARAM,OUT.ERR,OUT.RESP,OUT.ARRAY)

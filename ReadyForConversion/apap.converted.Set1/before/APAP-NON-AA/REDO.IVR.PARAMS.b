...
* </region>
*-----------------------------------------------------------------------------
  Table.name = 'REDO.IVR.PARAMS'        ;* Full application name including product prefix
  Table.title = 'Parametros Oper. IVR'  ;* Screen title
  ...
  Table.equatePrefix = 'REDO.IVR.PAR'   ;* Use to create I_F.EB.LOG.PARAMETER
*-----------------------------------------------------------------------------

...
*
  ...
  R.CATEGORY     = ''
  Y.ERR.CATEGORY = ''
  CALL F.READ(FN.CATEGORY, Y.MM.CATEGORY, R.CATEGORY, F.CATEGORY, Y.ERR.CATEGORY)
  IF R.CATEGORY THEN
...
*
  ...
  CALL F.READ(FN.SUB.ASSET.TYPE,Y.SUB.ASST.TYPE,R.SUB.ASSET.TYPE,F.SUB.ASSET.TYPE,Y.ERR.SUB.ASSET.TYPE)

...
**************
  ...
  IF  Y.OTHEROFF.ID THEN
    CALL F.READ (FN.DEPT.ACCT.OFFICER,Y.OTHEROFF.ID,R.DEPT.ACCT.OFFICER,F.DEPT.ACCT.OFFICER,F.ERR)
  ...
  IF ACCTOFFICER.ID THEN
    CALL F.READ(FN.DEPT.ACCT.OFFICER,ACCTOFFICER.ID,R.DEPT.ACCT.OFFICER,F.DEPT.ACCT.OFFICER,F.ERR)
  ...
  IF Y.DOC.TYPE.DISC THEN
    CALL F.READ(FN.DOCUMENT.TYPE,Y.DOC.TYPE.DISC,R.DOCUMENT.TYPE,F.DOCUMENT.TYPE,F.ERR)

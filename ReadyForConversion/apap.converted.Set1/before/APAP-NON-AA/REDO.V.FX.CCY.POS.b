...
*======================
  ...
  R.BUY.REDO.FX.CCY.POSN<REDO.FX.INPUTTER>              = TNO:'_':OPERATOR
  R.BUY.REDO.FX.CCY.POSN<REDO.FX.AUTHORISER>            = TNO:'_':OPERATOR
...
*=======================
  ...
  R.SELL.REDO.FX.CCY.POSN<REDO.FX.AUTHORISER>             = TNO:'_':OPERATOR
...
*PACS00157021 - S
  IF Y.BUY.AVG.B THEN
    ...
    Y.BUY.TOT.B = Y.BUY.TOT.B + Y.PREV.CLOSE.BAL
  END
  IF Y.SEL.AVG.B THEN
    Y.SEL.AVG.B = Y.SEL.AVG.B + (Y.PREV.CLOSE.BAL * Y.PREV.WGT.SELL.AVG)
    Y.SEL.TOT.B = Y.SEL.TOT.B + Y.PREV.CLOSE.BAL
  END
*PACS00157021 - E
...
*PACS00157021 - S
  IF Y.BUY.AVG.S THEN
    ...
    Y.BUY.TOT.S = Y.BUY.TOT.S + Y.PREV.CLOSE.BAL
  END
  IF Y.SEL.AVG.S THEN
    Y.SEL.AVG.S = Y.SEL.AVG.S + (Y.PREV.CLOSE.BAL * Y.PREV.WGT.SELL.AVG)
    Y.SEL.TOT.S = Y.SEL.TOT.S + Y.PREV.CLOSE.BAL
  END
*PACS00157021 - E

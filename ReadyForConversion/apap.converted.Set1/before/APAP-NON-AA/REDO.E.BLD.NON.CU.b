...
* <Rating>-53</Rating>
*-----------------------------------------------------------------------------
  SUBROUTINE REDO.E.BLD.NON.CU(ENQ.DATA)

*----------------------------------------------------------------------
* Company Name : ASOCIACION POPULAR DE AHORROS Y PRESTAMOS
* Developed By : RAJA SAKTHIVEL K P
* Program Name : REDO.E.BLD.NON.CU
*----------------------------------------------------------
...
PROCESS:
  ...
  IF NOT(CUS.ID) THEN
    OPERAND.VALUE = "EQ"
    SEL.CMD = "SELECT ":FN.CUSTOMER:" WITH RELATION.CODE LE 299"
...
CHECK.CODE:
  ...
  IF REL.CODE GE 1 AND REL.CODE LE 299 THEN

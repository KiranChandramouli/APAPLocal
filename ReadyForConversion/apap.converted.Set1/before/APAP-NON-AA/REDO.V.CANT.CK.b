...
*----------------------------------------------------------------------
  ...
  IF  EB.EXTERNAL$CHANNEL EQ 'INTERNET' THEN
    ...
    IF NOT(STK.ERR) THEN
      ...
      IF NOT(STK.ENT.ERR) THEN
        ...
        CALL F.READ(FN.FT.COMMISSION.TYPE,Y.AI.COSTO.CK,R.FT.COMMISSION.TYPE,F.FT.COMMISSION.TYPE,FT.COMMI.ERR)
  ...
  WHILE VAR1 LE Y.COSTO.CK.CNT
    ...
    CALL F.READ(FN.FT.COMMISSION.TYPE,Y.COSTO.CK,R.FT.COMMISSION.TYPE,F.FT.COMMISSION.TYPE,FT.COMMI.ERR)
    ...
    TOTAL.TAX.AMT=TOTAL.TAX.AMT+TOT.MONTO.CK
    VAR1++
  REPEAT

...
OPENFILES:
  ...
  APPL = 'AA.PRD.DES.OVERDUE':FM:'ACCOUNT':FM:'AA.PRD.DES.ACCOUNT'
  L.FIELDS = 'L.LOAN.STATUS.1':FM:'L.OD.STATUS':FM:'L.LOAN.STATUS'
...
GET.ACCRUED.INTEREST:
  ...
  Y.TOT.ACC.AMT = Y.TOT.ACC.AMT - Y.TOT.ACC.AMT.SP
...
GET.OUTS.PRIN:
  ...
  Y.PRINCIPAL.BAL = Y.PRINCIPAL.BAL - Y.PRINCIPLE.UNC

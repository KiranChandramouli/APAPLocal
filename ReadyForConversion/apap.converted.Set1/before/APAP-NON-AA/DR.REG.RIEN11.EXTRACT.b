...
*-----------------------------------------------------------------------------
    ...
    $INCLUDE REGREP.BP I_F.REDO.AZACC.DESC
    $INCLUDE REGREP.BP I_DR.REG.RIEN11.EXTRACT.COMMON
...
*
    ...
    YT.FLD3 = FLD3
    CALL DR.REG.GET.CUST.TYPE(R.CUSTOMER,YT.FLD3,FLD8,FLD2)
    FLD5 = STMT.ID
    GOSUB GET.FLD6

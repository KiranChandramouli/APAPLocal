...
JUD.ASSIGN:
*----------------------------------------------------------------------------------------
Y.JUD.PRINCIPAL = Y.JUD.PRINCIPAL + Y.PRINCIPAL
Y.JUD.INTEREST = Y.JUD.INTEREST + Y.INTEREST
Y.JUD.MORA = Y.JUD.MORA + Y.MORA
Y.JUD.WRITE.OFF = Y.JUD.WRITE.OFF + Y.WRITE.OFF
...
RESTR.ASSIGN:
*----------------------------------------------------------------------------------------
Y.RES.PRINCIPAL = Y.RES.PRINCIPAL + Y.PRINCIPAL
Y.RES.INTEREST = Y.RES.INTEREST + Y.INTEREST
Y.RES.MORA = Y.RES.MORA + Y.MORA
Y.RES.WRITE.OFF = Y.RES.WRITE.OFF + Y.WRITE.OFF
...
WRITE.ASSIGNE:
*----------------------------------------------------------------------------------------
Y.WR.PRINCIPAL = Y.WR.PRINCIPAL + Y.PRINCIPAL
Y.WR.INTEREST = Y.WR.INTEREST + Y.INTEREST
Y.WR.MORA = Y.WR.MORA + Y.MORA
Y.WR.WRITE.OFF = Y.WR.WRITE.OFF + Y.WRITE.OFF
...
CUR.ASSIGN:
*----------------------------------------------------------------------------------------
Y.CUR.PRINCIPAL = Y.CUR.PRINCIPAL + Y.PRINCIPAL
Y.CUR.INTEREST = Y.CUR.INTEREST + Y.INTEREST
Y.CUR.MORA = Y.CUR.MORA + Y.MORA
Y.CUR.WRITE.OFF = Y.CUR.WRITE.OFF + Y.WRITE.OFF
...
DEL.ASSIGN:
*----------------------------------------------------------------------------------------
Y.DEL.PRINCIPAL = Y.DEL.PRINCIPAL + Y.PRINCIPAL
Y.DEL.INTEREST = Y.DEL.INTEREST + Y.INTEREST
Y.DEL.MORA = Y.DEL.MORA + Y.MORA
Y.DEL.WRITE.OFF = Y.DEL.WRITE.OFF + Y.WRITE.OFF
...
NAB.ASSIGNE:
*----------------------------------------------------------------------------------------
Y.NAB.PRINCIPAL = Y.NAB.PRINCIPAL + Y.PRINCIPAL
Y.NAB.INTEREST = Y.NAB.INTEREST + Y.INTEREST
Y.NAB.MORA = Y.NAB.MORA + Y.MORA
Y.NAB.WRITE.OFF = Y.NAB.WRITE.OFF + Y.WRITE.OFF
...
Y.CUR.VALUE.CNT = Y.CUR.VALUE.CNT + 1
Y.CUR = ''
REPEAT
...
Y.DEL.VALUE.CNT = Y.DEL.VALUE.CNT + 1
REPEAT
...
Y.NAB.VALUE.CNT = Y.NAB.VALUE.CNT + 1
...
Y.WR.VALUE.CNT = Y.WR.VALUE.CNT + 1
REPEAT
...
Y.RES.VALUE.CNT = Y.RES.VALUE.CNT + 1
REPEAT
...
Y.JUD.VALUE.CNT = Y.JUD.VALUE.CNT + 1
REPEAT

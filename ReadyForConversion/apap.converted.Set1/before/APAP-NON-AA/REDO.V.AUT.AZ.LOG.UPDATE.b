...
* <Rating>-30</Rating>
*-----------------------------------------------------------------------------
  SUBROUTINE REDO.V.AUT.AZ.LOG.UPDATE
*-----------------------------------------------------------------------------
*----------------------------------------------------------------------------------------------------
...
* PROGRAM NAME : REDO.V.AUT.AZ.LOG.UPDATE
*-----------------------------------------------------------------------------------------------------
...
********
  ...
  Y.CUST.ID             = R.NEW(AZ.CUSTOMER)
  Y.INPUTTER            = R.NEW(AZ.INPUTTER)
...
***********
  ...
  R.CR.CONTACT.LOG<CR.CONT.LOG.CONTACT.DESC>                   = "CERTIFICATES"
  ...
  R.CR.CONTACT.LOG<CR.CONT.LOG.LOCAL.REF,L.CR.PROD.REQ.POS>    = "CERTIFICATES"

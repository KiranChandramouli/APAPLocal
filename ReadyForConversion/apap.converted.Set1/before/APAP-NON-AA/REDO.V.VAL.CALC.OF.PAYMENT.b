...
FT.TXN.TYPE:
  ...
  CALL F.READ(FN.FT.TXN.TYPE.CONDITION,TRAN.TYPE,R.FT.TXN.TYPE.CONDITION,F.FT.TXN.TYPE.CONDITION,E.FT.TXN.TYPE.CONDITION)
...
FT.COMM.TYPE:
  ...
  WHILE CNT LE TOT.COMM.TYPE
    ...
    CALL F.READ(FN.FT.COMMISSION.TYPE,FT.COMM.ID,R.FT.COMMISSION.TYPE,F.FT.COMMISSION.TYPE,E.FT.COMMISSION.TYPE)
    ...
    TAX.ID = SEL.LIST<NOR>
    CALL F.READ(FN.TAX,TAX.ID,R.TAX,F.TAX,E.TAX)

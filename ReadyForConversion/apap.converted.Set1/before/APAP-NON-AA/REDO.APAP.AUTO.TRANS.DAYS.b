...
************************
  ...
  CALL F.READ(FN.TELLER.TRANSACTION,TELLER.TRANSACTION.ID,R.TELLER.TRANSACTION,F.TELLER.TRANSACTION,TELLER.TRANSACTION.ERR)
...
*****************
  R.TRANSACTION   = ''
  TRANSACTION.ERR = ''
  CALL F.READ(FN.TRANSACTION,TRANSACTION.ID,R.TRANSACTION,F.TRANSACTION,TRANSACTION.ERR)

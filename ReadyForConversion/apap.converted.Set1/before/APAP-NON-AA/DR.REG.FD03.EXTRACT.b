...
************
*
    R.ACCOUNT = ''; ACCOUNT.ERR = ''; R.CUSTOMER = ''; CUSTOMER.ERR = ''
    L.CU.CIDENT.VAL = ''; LEGAL.ID = ''; YNATION = ''; L.CU.RNC.VAL = ''
    L.CU.ACTANAC.VAL = ''; L.CU.NOUNICO.VAL = ''; L.CU.FOREIGN.VAL = ''
    ...
    YNATION = R.CUSTOMER<EB.CUS.NATIONALITY>
    ...
    L.CU.FOREIGN.VAL = R.CUSTOMER<EB.CUS.LOCAL.REF,L.CU.FOREIGN.POS>
    BEGIN CASE
    CASE L.CU.CIDENT.VAL NE ''
        CUST.ID.VAL = L.CU.CIDENT.VAL[1,3]:'-':L.CU.CIDENT.VAL[4,7]:'-':L.CU.CIDENT.VAL[11,1]
    CASE L.CU.RNC.VAL NE ''
        CUST.ID.VAL = L.CU.RNC.VAL[1,1]:'-':L.CU.RNC.VAL[2,2]:'-':L.CU.RNC.VAL[4,5]:'-':L.CU.RNC.VAL[9,1]
    CASE L.CU.FOREIGN.VAL NE ''
        CUST.ID.VAL = YNATION:L.CU.FOREIGN.VAL
    CASE LEGAL.ID NE ''
        CUST.ID.VAL = YNATION:LEGAL.ID
    CASE L.CU.NOUNICO.VAL
        CUST.ID.VAL = L.CU.NOUNICO.VAL
    CASE L.CU.ACTANAC.VAL
        CUST.ID.VAL = L.CU.ACTANAC.VAL
    END CASE
    RETURN

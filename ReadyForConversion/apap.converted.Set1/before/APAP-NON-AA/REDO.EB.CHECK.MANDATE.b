...
******************
  ...
  CALL F.READ(FN.EB.MANDATE,Y.MAND.GROUP.ID,R.EB.MANDATE,F.EB.MANDATE,EB.MANDATE.ERR)
...
**********************
  CALL F.READ(FN.EB.SIGNATORY.GROUP,Y.SIGN.GRP.ID,R.EB.SIGNATORY.GROUP,F.EB.SIGNATORY.GROUP,ESG.ERR)

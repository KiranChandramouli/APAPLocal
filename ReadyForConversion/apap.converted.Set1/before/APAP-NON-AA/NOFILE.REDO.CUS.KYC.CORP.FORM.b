...
******************
  ...
  CALL F.READ(FN.SECTOR,VAR.SECTOR,R.SECTOR,F.SECTOR,SEC.ERR)
...
*       MAIN.ECONOMIC.ACTIVITY   = R.INDUSTRY<EB.IND.DESCRIPTION,1>
  ...
  CALL F.READ(FN.DEPT.ACCT.OFFICER,VAR.EXEC.RESPONSIBLE,R.DEPT.ACCT.OFFICER,F.DEPT.ACCT.OFFICER,DEPT.ERR)
  ...
  CALL F.READ(FN.COUNTRY,VAR.COUNTRY,R.COUNTRY,F.COUNTRY,COUNT.ERR)
  IF R.COUNTRY THEN
...
CATEG.DESC:
*-----------------------------------------------------------------------------------------------------
  CALL F.READ(FN.CATEGORY,PROD.CODE,R.CATEG,F.CATEGORY,CATEG.ERR)

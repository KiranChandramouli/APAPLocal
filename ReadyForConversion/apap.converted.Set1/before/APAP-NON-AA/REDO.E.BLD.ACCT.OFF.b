...
******************
  ...
  CALL F.READ(FN.DEPT.ACCT.OFFICER,Y.ACCT.OFF,R.DEPT.ACCT.OFFICER,F.DEPT.ACCT.OFFICER,DEPT.ERR)
  ...
  IF Y.DEPT.PARENT EQ Y.DEPT.CODE THEN
    ...
    Y.FLAG = 1
  END ELSE
    CALL F.READ(FN.DEPT.ACCT.OFFICER,Y.DEPT.PARENT,R.DEPT.ACCT.OFFICER,F.DEPT.ACCT.OFFICER,DEPT.ERR)

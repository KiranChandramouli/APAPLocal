...
* <Rating>-50</Rating>
*-----------------------------------------------------------------------------
  SUBROUTINE REDO.AUTH.UPD.CR.USER
*-----------------------------------------------------------------------------
*------------------------------------------------------------------------------------------
...
* PROGRAM NAME : REDO.AUTH.UPD.CR.USER
*
*------------------------------------------------------------------------------------------
...
FX.DEFAULT.PARA:
*****************
  R.NEW(FX.LOCAL.REF)<1,Y.FX.CR.USER.POS>    = OPERATOR

  RETURN
*****************
MM.DEFAULT.PARA:
*****************
  R.NEW(MM.LOCAL.REF)<1,Y.MM.CR.USER.POS>    = OPERATOR
  RETURN
...
*****************
  ...
  R.NEW(SC.SBS.LOCAL.REF)<1,Y.SC.CR.USER.POS> = OPERATOR

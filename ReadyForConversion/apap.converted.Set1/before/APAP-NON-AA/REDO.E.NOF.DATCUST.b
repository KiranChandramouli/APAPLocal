...
GET.DATA:
*========
    FOR I = 1 TO COUNT.ENQPARMS
        Y.ENQPARMS.ID = Y.ENQPARMS<1,I>
...
*IF Y.PROD EQ "N3TEST" OR Y.APLICACION NE "AA.ARRANGEMENT" THEN
            ...
            FOR K = 1 TO COUNT.CAMPO
                Y.CUR.CAMPO = Y.CAMPO<1,K>
                Y.CUR.RUTINA = Y.RUTINA<1,K>
                GOSUB APP.PROCESS
            NEXT
        END
    NEXT
...
*==========
    ...
    FOR Y=1 TO NRO.CATEG
        Y.CUR.CATINI = Y.CAT.INI<1,Y>
        Y.CUR.CATFIN = Y.CAT.FIN<1,Y>

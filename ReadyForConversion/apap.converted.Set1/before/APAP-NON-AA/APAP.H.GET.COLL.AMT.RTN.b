...
*===============
  ...
  FOR I=1 TO Y.TOT.TIP.POL
    LOCATE Y.POL.TYPE IN R.COLL.POL<REDO.CPL.TIPO.POLIZA,I> SETTING POS THEN
      Y.SW = 0
      EXIT
    END
  NEXT
  ...
  IF Y.SW EQ 1 THEN
    ...
    FOR I=1 TO Y.TOT.COLL.CODE
      Y.TOT.POL.TYPE = DCOUNT(R.COLL.POL<REDO.CPL.POLICY.TYPE,I>,SM)
      FOR J=1 TO Y.TOT.POL.TYPE
        LOCATE Y.POL.TYPE IN R.COLL.POL<REDO.CPL.POLICY.TYPE,I,J> SETTING POS THEN
          Y.SW = 0
          I = Y.TOT.COLL.CODE
          EXIT
        END
...
* CHANGE MONEY IN AA
  ...
  CALL F.READ(FN.CURR,Y.ID.CURR,R.CURR,F.CURR,Y.APP.ERR)

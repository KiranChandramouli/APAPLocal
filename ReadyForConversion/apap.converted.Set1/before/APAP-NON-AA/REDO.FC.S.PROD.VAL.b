...
CHK.LOOP:
  ...
  I =1
  LOOP
  WHILE I LE NRO.PAYTYPE
    IF NOT(R.NEW(REDO.FC.PAYMENT.TYPE)<1,I>) THEN
      R.NEW(REDO.FC.PAYMENT.TYPE)<1,I> = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.PAYMENT.TYPE,I>
    END
    IF NOT(R.NEW(REDO.FC.PAYMENT.METHOD)<1,I>) THEN
      R.NEW(REDO.FC.PAYMENT.METHOD)<1,I> = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.PAYMENT.METHOD,I>
    END
    IF NOT(R.NEW(REDO.FC.PAYMENT.FREQ)<1,I>) THEN
      R.NEW(REDO.FC.PAYMENT.FREQ)<1,I> = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.PAYMENT.FREQ,I>
    END

    NRO.PROP = DCOUNT(R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.PROPERTY,I>,SM)
...
*===============
  IF R.NEW(REDO.FC.PAYMT.DAY) THEN
    ...
    YFREQ = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.PAYMENT.FREQ,I>
    YDFRQ = "o":YDIA:"D"
    STRYFREQ =  EREPLACE(YFREQ,"e0D",YDFRQ)
    IF R.NEW(REDO.FC.PAYMENT.FREQ)<1,I> EQ R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.PAYMENT.FREQ,I> THEN
      R.NEW(REDO.FC.PAYMENT.FREQ)<1,I> = STRYFREQ
    END ELSE
      YFREQ = R.NEW(REDO.FC.PAYMENT.FREQ)<1,I>
      STRYFREQ =  EREPLACE(YFREQ,"e0D",YDFRQ)
      R.NEW(REDO.FC.PAYMENT.FREQ)<1,I> = STRYFREQ
    END
  END
  ...
  LOOP
  WHILE J LE NRO.PROP
    IF NOT(R.NEW(REDO.FC.PROPERTY)<1,I,J>) THEN
      R.NEW(REDO.FC.PROPERTY)<1,I,J> = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.PROPERTY,I>
    END
*R.NEW(REDO.FC.DUE.FREQ)<1,I,J> = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.DUE.FREQ,I,J> ;*WMEZA FEB 3 12
    IF R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.PERCENTAGE,I> THEN
      R.NEW(REDO.FC.PERCENTAGE)<1,I,J> = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.PERCENTAGE,I>
    END
    IF STRYFREQ THEN
      R.NEW(REDO.FC.DUE.FREQ)<1,I,J> = STRYFREQ   ;*WMEZA FEB 3 12
    END
* Dia de pago
    J+=1
  REPEAT
  NRO.DATES = DCOUNT(R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.START.DATE,I>,SM)
...
* END
    ...
    R.NEW(REDO.FC.START.DATE)<1,I,J> = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.START.DATE,I,J>
    R.NEW(REDO.FC.END.DATE)<1,I,J> = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.END.DATE,I,J>
    R.NEW(REDO.FC.NUM.PAYMENTS)<1,I,J> = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.NUM.PAYMENTS,I,J>
    R.NEW(REDO.FC.CALC.AMOUNT)<1,I,J> = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.CALC.AMOUNT,I,J>
    R.NEW(REDO.FC.ACTUAL.AMT)<1,I,J> = R.AA.PRD.DES.PAYMENT.SCHEDULE<AA.PS.ACTUAL.AMT,I,J>
    J+=1
  REPEAT

...
*---------
    ...
    CALL CACHE.READ(FN.FT.TXN.TYPE.CONDITION, Y.TXN.TYPE, R.REC.FT.TXN.TYPE, FT.TXN.ERR)
...
*-----------
    ...
    CALL CACHE.READ(FN.TELLER.TRANSACTION, Y.TT.TXN.ID, R.TELLER.TRANS, ERR.TT.TRA)
...
GET.TRASACTION.CHECK:
    ...
    CALL CACHE.READ(FN.TRANSACTION, Y.TXN.CODE, R.TRAN, TRNS.ERR)

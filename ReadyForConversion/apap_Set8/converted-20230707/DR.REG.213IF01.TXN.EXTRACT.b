...
*  Change - New RTE 24 hours process.
    ...
    IF R.REDO.RTE.CUST.CASHTXN THEN
        ...
        FOR I.VAR = 1 TO Y.TXN.CNT
            IF R.REDO.RTE.CUST.CASHTXN<RTE.CASH.AMOUNT,I.VAR> NE '' THEN
                Y.RTE.TXN.CNT += 1
...
*                IF TOT.CASH.AMT GE AMT.LCY THEN
                ...
                Y.RTE.TXN.DATE = R.REDO.RTE.CUST.CASHTXN<RTE.TRANS.DATE,I.VAR>
                AMT.TXN  = R.REDO.RTE.CUST.CASHTXN<RTE.CASH.AMOUNT,I.VAR>
                Y.TXN.ID = R.REDO.RTE.CUST.CASHTXN<RTE.TXN.ID,I.VAR>

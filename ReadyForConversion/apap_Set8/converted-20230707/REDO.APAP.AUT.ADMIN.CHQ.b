...
******************************
    ...
    R.REDO.ADMIN.CHQ.DETAILS<ADMIN.CHQ.DET.INPUTTER>        = C$T24.SESSION.NO:'_':OPERATOR
    ...
    R.REDO.ADMIN.CHQ.DETAILS<ADMIN.CHQ.DET.AUTHORISER>      = C$T24.SESSION.NO:'_':OPERATOR

...
*---OFICIAL DE CUENTA
    ...
    CALL CACHE.READ(FN.DEPT.ACCT.OFFICER, Y.CUS.ACCT.OFFICER, R.DEPT.ACCT, ERROR.DEPT.ACCT)
...
*---SUCURSAL DE CARTERIZACION
    ...
    CALL CACHE.READ(FN.DEPT.ACCT.OFFICER, Y.CUS.OTHER.OFFICER, R.DEPT.ACCT.SUC, ERROR.DEPT.ACCT.SUC)

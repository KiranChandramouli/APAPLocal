...
UPDATE.AUDIT.FIELDS:
********************
    R.REDO.H.CLEARING.OUTWARD<REDO.CLR.OUT.INPUTTER>   = C$T24.SESSION.NO:'_':OPERATOR
    ...
    R.REDO.H.CLEARING.OUTWARD<REDO.CLR.OUT.AUTHORISER> = C$T24.SESSION.NO:'_':OPERATOR

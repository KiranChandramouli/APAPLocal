...
***************
    ...
    R.REDO.APAP.H.DEAL.SLIP.QUEUE<REDO.DS.QUEUE.INPUTTER> = C$T24.SESSION.NO:"_":OPERATOR
    R.REDO.APAP.H.DEAL.SLIP.QUEUE<REDO.DS.QUEUE.DATE.TIME> = SYS.TIME.NOW
    R.REDO.APAP.H.DEAL.SLIP.QUEUE<REDO.DS.QUEUE.AUTHORISER> = C$T24.SESSION.NO:"_":OPERATOR

...
*04-MAR-2023      APAP                   MDA-141849           Validar el campo ORDERING.CUST
*                                                             para evitar rechazos por RNC
*---------------------------------------------------------------------------------
...
*--------------------------------------------------------------------------------------------------------
            ...
            IF Y.ORIGINATOR.NAME NE '' THEN
                IF LEN(Y.ORIGINATOR.NAME) LT 15 AND NUM(Y.ORIGINATOR.NAME) EQ 1  THEN
                    Y.ORIGINATOR.NAME = '00':Y.ORIGINATOR.NAME
                END
            END
            R.FT<FT.ORDERING.CUST> = Y.ORIGINATOR.NAME
*--------------------------------------------------------------------------------------------------------
        END ELSE
            R.FT<FT.CREDIT.AMOUNT> = R.REDO.ACH.PROCESS.DET<REDO.ACH.PROCESS.DET.TXN.AMOUNT>

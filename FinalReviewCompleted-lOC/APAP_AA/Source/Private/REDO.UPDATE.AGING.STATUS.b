* @ValidationCode : MjotMTI0NTEwOTQ4MTpDcDEyNTI6MTY4Mzg3ODE2MjA0MjpJVFNTOi0xOi0xOjM3NjoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 May 2023 13:26:02
...
*CALL F.READ(FN.ACCOUNT, R.ACCOUNT.ID, R.ACCOUNT.REC, F.ACCOUNT, ACC.ERR)
    ...
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.ACC,ERR.MSG);* R22 Manual conversion

* @ValidationCode : MjotNTU4NjM0NTQ0OkNwMTI1MjoxNjgzODc3OTY0NzIyOklUU1M6LTE6LTE6MTc5OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 May 2023 13:22:44
...
*-----------------------------------------------------------------------------
    ...
    R.CON.LIMIT = ''
    ERR.MSG     = ''
    CALL APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CON.LIMIT,ERR.MSG);* R22 Manual conversion

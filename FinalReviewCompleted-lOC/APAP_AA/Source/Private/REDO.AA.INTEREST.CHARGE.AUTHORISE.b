* @ValidationCode : MjotMjY0ODEzMDAwOkNwMTI1MjoxNjgzODc3OTcyODkyOklUU1M6LTE6LTE6ODgyOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 May 2023 13:22:52
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 882
...
PROCESS:
    ...
    IF Y.TAX.AMOUNT AND Y.NCF.LIST.CNT EQ 1 AND Y.FT.CHARGE.AMT THEN
        CALL APAP.REDOCHNLS.redoAssignNcf(Y.NCF.ID,Y.FT.CHARGE.AMT);* R22 Manual conversion
        RETURN
    END

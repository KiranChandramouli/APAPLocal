* @ValidationCode : MjotODQ3OTI2NzE5OkNwMTI1MjoxNjgzODc3OTcyNDc0OklUU1M6LTE6LTE6OTMwOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 May 2023 13:22:52
...
*---------------------------------------------------------------------------------------
    ...
    Y.AMT.RET = ""
    CALL APAP.TAM.redoChkIntUncAmtNcf(ACC.ID,TXN.REF,Y.AMT.RET);* R22 Manual conversion
...
* It may return the NCF no. assigned for that user else from the generic NCF stock.
    ...
    Y.REQ.CNT = 1
    Y.NCF.ID  = ""
    CALL APAP.TAM.redoNcfPerfRtn(Y.REQ.CNT,Y.NCF.NUMBER);* R22 Manual conversion

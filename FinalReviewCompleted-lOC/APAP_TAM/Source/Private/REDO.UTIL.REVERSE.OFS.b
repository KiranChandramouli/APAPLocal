* @ValidationCode : MjotMTQ0NDg5NjA4OTpDcDEyNTI6MTY4MzAxODEwMDkzODpJVFNTOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
** R22 Manual conversion
    CALL APAP.REDOCHNLS.redoInterfaceRecAct(Y.INT.CODE, Y.INT.TYPE, '', '', Y.INT.INFO, Y.INT.INFO, Y.FC.REG.ID, Y.INT.MONT, Y.INT.DESC, Y.INT.DATA, Y.INT.USER, Y.INT.TERM)

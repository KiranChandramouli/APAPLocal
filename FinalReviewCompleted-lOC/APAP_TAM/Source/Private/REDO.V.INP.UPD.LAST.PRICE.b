...
*CALL APAP.TAM.REDO.SC.CALCULATE.PRICE(Y.TODAY,Y.MAT.DATE,Y.INT.RATE,Y.YLD,Y.REDEM,Y.FREQ,Y.INT.BASIS,Y.PRICE,Y.ROUNDING,Y.ACCR.ST.DATE,Y.ISSUE.DATE);*R22 MANUAL CODE CONVERSION
                CALL APAP.TAM.redoScCalculatePrice(Y.TODAY,Y.MAT.DATE,Y.INT.RATE,Y.YLD,Y.REDEM,Y.FREQ,Y.INT.BASIS,Y.PRICE,Y.ROUNDING,Y.ACCR.ST.DATE,Y.ISSUE.DATE) ;*R22 MANUAL CODE CONVERSION
...
*CALL APAP.TAM.REDO.SC.CALCULATE.DPRICE(Y.TODAY,Y.MAT.DATE,Y.YLD,Y.INT.BASIS,Y.PRICE,RESERVED.2,RESERVED.1) ;*R22 MANUAL CODE CONVERSION
                CALL APAP.TAM.redoScCalculateDprice(Y.TODAY,Y.MAT.DATE,Y.YLD,Y.INT.BASIS,Y.PRICE,RESERVED.2,RESERVED.1) ;*R22 MANUAL CODE CONVERSION
        END CASE

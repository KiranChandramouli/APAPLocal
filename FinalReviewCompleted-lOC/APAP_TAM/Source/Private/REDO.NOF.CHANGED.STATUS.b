...
*CALL APAP.REDOENQ.REDO.E.FORM.SEL.STMT(FILE.NAME, '', '',SEL.CMD) ;*MANUAL R22 CODE CONVERSION
    CALL APAP.REDOENQ.redoEFormSelStmt(FILE.NAME, '', '',SEL.CMD) ;*MANUAL R22 CODE CONVERSION
    CLAIM.FLAG = '1'
    GOSUB GET.VALUES
RETURN
************

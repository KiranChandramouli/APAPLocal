* @ValidationCode : MjozNzA0MDMyNTpDcDEyNTI6MTY4MzcyODg2OTA4NTpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 10 May 2023 19:57:49
...
*Modification History
*DATE                       WHO                         REFERENCE                                   DESCRIPTION
*19-04-2023            Conversion Tool             R22 Auto Code conversion                 VM TO @VM,SM TO @SM,++ to +=1
...
* CALL REDO.S.CUST.ID.VAL(CUST.ID,CUST.NO,CUS.ERR)
    CALL APAP.REDOSRTN.redoSCustIdVal(CUST.ID,CUST.NO,CUS.ERR)    ;*R22 MANUAL CODE CONVERSION

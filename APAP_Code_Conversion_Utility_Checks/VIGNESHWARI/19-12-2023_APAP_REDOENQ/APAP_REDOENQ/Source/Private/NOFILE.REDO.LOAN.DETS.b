* @ValidationCode : MjoxOTc1NDY0NjIyOkNwMTI1MjoxNzAyOTAyMDM3ODMzOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 18 Dec 2023 17:50:37
...
* 06-06-2023   Conversion Tool R22 Auto Conversion   FM TO @FM AND VM TO @VM AND  I TO I.VAR AND ++ TO + = 1
* 06-06-2023   ANIL KUMAR B    R22 Manual Conversion Adding the Y.BALANCE.TYPE.ARR = R.INT.ARR.COND<AA.INT.ACC.LINKED.SOURCE.CALC.TYPE> AND adding packag APAP.TAM And alias changed for call routine
...
*
    ...
    ERR.MSG = ''
    R.CUS.ARR.COND = ''
    APAP.TAM.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.CUS.ARR.COND,ERR.MSG)  ;*R22 MANUAL CONVERSION
...
*
    ...
    ERR.MSG = ''
    R.TERM.ARR.COND = ''
    APAP.TAM.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.TERM.ARR.COND,ERR.MSG)  ;*R22 MANUAL CONVERSION
...
*
    ...
    APAP.TAM.redoGetInterestProperty(Y.ARRG.ID,PROP.NAME,OUT.PROP,ERR)
    ...
    ERR.MSG = ''
    R.INT.ARR.COND = ''
    APAP.TAM.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.INT.ARR.COND,ERR.MSG) ;*R22 MANUAL CONVERSION
...
* Y.BALANCE.TYPE.ARR   = R.INT.ARR.COND<AA.INT.BALANCE.CALC.TYPE>
            Y.BALANCE.TYPE.ARR   = R.INT.ARR.COND<AA.INT.ACC.LINKED.SOURCE.CALC.TYPE>  ;*R22 MANUAL CONVERSION Adding the Y.BALANCE.TYPE.ARR = R.INT.ARR.COND<AA.INT.ACC.LINKED.SOURCE.CALC.TYPE>

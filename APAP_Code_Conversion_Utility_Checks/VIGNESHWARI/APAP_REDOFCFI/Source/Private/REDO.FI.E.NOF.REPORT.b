* @ValidationCode : MjoxODYwMjQwMjcyOkNwMTI1MjoxNzAyODc0OTg0MzI0OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 18 Dec 2023 10:19:44
...
*17-12-2023          VIGNESHWARI                       MANUAL R22 CODE CONVERSION            VARIABLE IS ASSIGN, CHANGE F.READ TO F.CACHE.READ
*-----------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*CALL F.READ(FN.TSA.SERVICE,"BNK/REDO.FI.INTERFACE",R.TSA.SERVICE,F.TSA.SERVICE,SERVICE.ERR)
    VAR.VAL="BNK/REDO.FI.INTERFACE" ;*MANUAL R22 CODE CONVERSION-VARIABLE IS ASSIGN
    CALL F.READ(FN.TSA.SERVICE,VAR.VAL,R.TSA.SERVICE,F.TSA.SERVICE,SERVICE.ERR)
...
CALL F.CACHE.READ(FN.REDO.INTERFACE.PARAM,Y.FACE.ID,R.REDO.INTERFACE.PARAM,F.REDO.INTERFACE.PARAM,INT.ERR);*MANUAL R22 CODE CONVERSION -CHANGE F.READ TO F.CACHE.READ

* @ValidationCode : Mjo1ODk1NTc0NDY6Q3AxMjUyOjE3MDI4NzczMjk1MDA6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 18 Dec 2023 10:58:49
...
*----
    ...
    ID.VAR='SYSTEM'
    CALL CACHE.READ(FN.REDO.APAP.PARAM.EMAIL,ID.VAR,R.EMAIL,MAIL.ERR);* MANUAL R22 CODE CONVERSION -VARIABLE IS ASSIGN
...
*  CALL F.READ(FN.REDO.ISSUE.MAIL,'SYSTEM',R.REDO.ISSUE.MAIL,F.REDO.ISSUE.MAIL,Y.ISSUE.EMAIL.ERR) ;*Tus Start
    CALL CACHE.READ(FN.REDO.ISSUE.MAIL,'SYSTEM',R.REDO.ISSUE.MAIL,Y.ISSUE.EMAIL.ERR) ; * Tus End;* MANUAL R22 CODE CONVERSION -CHANGE F.READ TO F.CACHE.READ
...
*-------
    ...
    WHILE Y.REC.CNT LE NO.OF.FI.CON
        ...
        WHILE Y.FI.TMP.CNT LE Y.FI.TMP.TOT
            ...
            APAP.REDOFCFI.redoFiRecordTxnDetails(R.PARAM,OUT.RESP,OUT.REF,OUT.ARRAY) ;*R22 Manual Conversion - Added APAP.REDOFCFI
            GOSUB REPORT.FORMAT
 ...
 *               CALL F.READ(FN.REDO.INTERFACE.PARAM,Y.COMP.ID,R.REDO.INTERFACE.PARAM.COMP,F.REDO.INTERFACE.PARAM,Y.COMP.ERR)
  CALL F.CACHE.READ(FN.REDO.INTERFACE.PARAM,Y.COMP.ID,R.REDO.INTERFACE.PARAM.COMP,F.REDO.INTERFACE.PARAM,Y.COMP.ERR);* MANUAL R22 CODE CONVERSION -CHANGE F.READ TO F.CACHE.READ
...
*                CALL F.READ(FN.REDO.INTERFACE.PARAM,Y.COMP.ID,R.REDO.INTERFACE.PARAM.COMP,F.REDO.INTERFACE.PARAM,Y.COMP.ERR)
  CALL F.CACHE.READ(FN.REDO.INTERFACE.PARAM,Y.COMP.ID,R.REDO.INTERFACE.PARAM.COMP,F.REDO.INTERFACE.PARAM,Y.COMP.ERR);* MANUAL R22 CODE CONVERSION -CHANGE F.READ TO F.CACHE.READ
    ...
    APAP.REDOFCFI.redoFiRecordControl(Y.ERR.MSG)  ;*R22 Manual Conversion - Added APAP.REDOFCFI
...
* ---------------
    ...
    R.RECORD1 = ''
    APAP.REDOFCFI.redoFiMailFormatGen(FI.W.REDO.FI.CONTROL.ID,Y.MAIL.DESCRIPTION)    ;*R22 Manual Conversion - Added APAP.REDOFCFI
...
*APAP.TAM.REDO.FI.EXT.DEBIT.PROCES(R.PARAM, OUT.RESP, OUT.ERR)
    APAP.TAM.redoFiExtDebitProces(R.PARAM, OUT.RESP, OUT.ERR) ;*R22 Manual Conversion - Added APAP.REDOFCFI
...
* APAP.TAM.REDO.FI.DEBIT.PROCES.ORANGE(R.PARAM, OUT.RESP, OUT.ERR)
        APAP.TAM.redoFiDebitProcesOrange(R.PARAM, OUT.RESP, OUT.ERR);*R22 Manual Conversion
    ...
    APAP.REDOFCFI.redoFiPreformatMsg(Y.FI.INTERFACE,"D",Y.IN.MSG,OUT.MSG,Y.ERR.MSG)    ;*R22 Manual Conversion - Added APAP.REDOFCFI
...
*APAP.TAM.REDO.FI.DEBIT.PROCES.BACEN(R.PARAM, OUT.RESP, OUT.ERR)
*APAP.TAM.redoFiDebitProcesBacen(R.PARAM, OUT.RESP, OUT.ERR)
        APAP.TAM.redoFiDebitProcesBacen(R.PARAM, OUT.RESP, OUT.ERR);*R22 Manual Conversion
        FI.W.REDO.FI.CONTROL<REDO.FI.CON.RET.FT.REF> = OUT.RESP
        Y.COMMISSION.AMT = W.TOT.FT.ERR * (Y.PAY.COM.PERCENT/100)
        CALL EB.ROUND.AMOUNT("DOP",Y.COMMISSION.AMT,"","")
        IF Y.PAY.CATEG.ACCOUNT AND Y.COMMISSION.AMT GT 0 THEN

* @ValidationCode : MjotNjI1NjE1ODE5OkNwMTI1MjoxNzAyNjQwMzU3MzQzOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 Dec 2023 17:09:17
...
*15-12-2023             VIGNESHWARI                      MANUAL R22 CODE CONVERSION           CHANGE F.READ TO F.CACHE.READ
*-----------------------------------------------------------------------------
...
*            CALL F.READ(FN.INS.COMB, ID.INS.COMB, R.INS.COMB, F.INS.COMB, Y.APP.ERR)
 CALL F.CACHE.READ(FN.INS.COMB, ID.INS.COMB, R.INS.COMB, F.INS.COMB, Y.APP.ERR)
            IF Y.APP.ERR THEN
...
* Apply behaviour
                    APAP.REDOFCFI.redoFcSFieldValidPol(Y.FIELD.FROM, FIELD.BEHAVIOUR, FIELD.VALUE, Y.FIELD.FROM.NAME, I.VAR, J.VAR) ;* MANUAL R22 CODE CONVERSION
                END
            NEXT J.VAR
        END ELSE
            APAP.REDOFCFI.redoFcSFieldValidPol(Y.FIELD.FROM, FIELD.BEHAVIOUR, FIELD.VALUE, Y.FIELD.FROM.NAME, I.VAR, '') ;* MANUAL R22 CODE CONVERSION
        END

* @ValidationCode : MjoxMTM5NzY0MzA3OkNwMTI1MjoxNzAyNjM3NTM1MjYxOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 Dec 2023 16:22:15
...
* 15-12-2023        VIGNESHWARI            R22 Manual Conversion - CHANGE F.READ TO F.CACHE.READ
*------------------------------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_GTS.COMMON
...
*------------------------------------------------------------------------------------------------------------------
    ...
    Y.USR.ID = OPERATOR
 *   CALL F.READ(FN.USR, Y.USR.ID, R.USR, Y.ERR) 
...
*    CALL F.READ(FN.COLL.CODE.PARAMS, Y.COLL.CLASS<1,Y.I>, R.COLL.CODE.PARAMS, F.COLL.CODE.PARAMS, Y.ERR)
 CALL F.CACHE.READ(FN.COLL.CODE.PARAMS, Y.COLL.CLASS<1,Y.I>, R.COLL.CODE.PARAMS, F.COLL.CODE.PARAMS, Y.ERR)

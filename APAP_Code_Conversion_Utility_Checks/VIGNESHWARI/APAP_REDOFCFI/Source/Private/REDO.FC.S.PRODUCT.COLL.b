* @ValidationCode : MjotMTQwNzYwNzczODpDcDEyNTI6MTcwMjY0MjE3NzQwNjp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 Dec 2023 17:39:37
...
* 15-12-2023        VIGNESHWARI               R22 Manual Conversion -OPF IS ADDED 
*------------------------------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
*
...
*------------------------------------------------------------------------------------------------------------------
    ...
    CALL OPF(FN.REDO.FC.PROD.COLL.POLICY,F.REDO.FC.PROD.COLL.POLICY);* R22 Manual Conversion -OPF IS ADDED 

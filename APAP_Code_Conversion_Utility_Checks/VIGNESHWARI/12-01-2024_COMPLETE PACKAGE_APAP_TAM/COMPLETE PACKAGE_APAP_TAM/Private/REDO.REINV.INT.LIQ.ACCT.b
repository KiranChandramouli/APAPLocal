* @ValidationCode : MjotNDE0MTkxNzg2OkNwMTI1MjoxNzA0ODg4MDAxNjk4OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:30:01
...
*    CALL GET.LOC.REF(Y.APPL,Y.FIELD,Y.POS)
    EB.LocalReferences.GetLocRef(Y.APPL,Y.FIELD,Y.POS);* R22 UTILITY AUTO CONVERSION
...
*    CALL GET.LOC.REF(Y.APPL.1,Y.FIELD.1,Y.POS.1)
    EB.LocalReferences.GetLocRef(Y.APPL.1,Y.FIELD.1,Y.POS.1);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxODExODU2MTQ2OlVURi04OjE3MDQ5NTQ2MTQ0Mjg6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 12:00:14
...
*    CALL F.READ(FN.REDO.LY.POINTS,CUSTOMER.ID,R.REDO.LY.POINTS,F.REDO.LY.POINTS,PT.ERR)
    CALL F.READU(FN.REDO.LY.POINTS,CUSTOMER.ID,R.REDO.LY.POINTS,F.REDO.LY.POINTS,PT.ERR,'');* R22 UTILITY AUTO CONVERSION

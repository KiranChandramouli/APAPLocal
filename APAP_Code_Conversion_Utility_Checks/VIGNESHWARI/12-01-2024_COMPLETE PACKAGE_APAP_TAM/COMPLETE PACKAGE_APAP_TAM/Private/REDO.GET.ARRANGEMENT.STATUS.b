* @ValidationCode : MjoxNTg5NjA0Nzk3OkNwMTI1MjoxNzA0OTczNjA5MDgwOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Jan 2024 17:16:49
...
$PACKAGE APAP.TAM ;*MANUAL R22 CODE CONVERSTION
...
*29-03-2023      MOHANRAJ R        MANUAL R22 CODE CONVERSION         Package name added APAP.TAM
*11-01-2024     VIGNESHWARI S       R22 MANUAL CODE CONVERSION          AA.FRAMEWORK IS CHANGED
...
ARRANGEMENT.REC = AA.Framework.Arrangement.Read(ARRANGEMENT.ID, PROCESS.ERR)    ;*R22 MANUAL CODE CONVERSION-F.READ IS MODIFIED
RETURN
*------------------------------------------------------------------------------------------------------------------
...
CHECK.PROCESSING.REQD:
    ...
    BEGIN CASE
        ...
        *CASE ARRANGEMENT.REC<AA.ARR.ARR.STATUS> EQ 'UNAUTH' ;*AUTO R22 CODE CONVERSION
        CASE ARRANGEMENT.REC<AA.Framework.ArrangementSim.ArrArrStatus> EQ 'UNAUTH' ;*AUTO R22 CODE CONVERSION  ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED  
...
AA.Framework.GetArrangementConditions(ARRANGEMENT.ID, 'OVERDUE','','', RET.IDS, OD.COND, RET.ERR);* R22 UTILITY AUTO CONVERSION
...
UPDATE.ACCOUNT.RECORD:
    ...
    *ACC.ID = ARRANGEMENT.REC<AA.ARR.LINKED.APPL.ID>
    ACC.ID = ARRANGEMENT.REC<AA.Framework.ArrangementSim.ArrLinkedApplId> ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED

*    CALL F.READ(FN.ACCOUNT, ACC.ID, R.ACCOUNT, F.ACCOUNT, RET.ERR)
    CALL F.READU(FN.ACCOUNT, ACC.ID, R.ACCOUNT, F.ACCOUNT, RET.ERR,'');* R22 UTILITY AUTO CONVERSION

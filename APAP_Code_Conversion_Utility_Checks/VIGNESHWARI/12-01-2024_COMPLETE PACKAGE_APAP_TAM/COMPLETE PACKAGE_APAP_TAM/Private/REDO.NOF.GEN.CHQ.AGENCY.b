* @ValidationCode : Mjo0NTM0ODYzNjE6VVRGLTg6MTcwNDk1NzU2NDk2ODpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 12:49:24
...
*   CALL CACHE.READ(FN.REDO.TRANS.TYPES.FT.PARAM,'SYSTEM-FT',R.REDO.TRANS.TYPES.FT.PARAM,REDO.FT.PAR.ERR)
    ID.VAR1 = "SYSTEM-FT" ;*Manual R22 Conversion
    CALL CACHE.READ(FN.REDO.TRANS.TYPES.FT.PARAM,ID.VAR1,R.REDO.TRANS.TYPES.FT.PARAM,REDO.FT.PAR.ERR) ;*Manual R22 Conversion
...
*   CALL CACHE.READ(FN.REDO.TRANS.TYPES.TT.PARAM,'SYSTEM-TT',R.REDO.TRANS.TYPES.TT.PARAM,REDO.TT.PAR.ERR)
    ID.VAR2 = "SYSTEM-TT" ;*Manual R22 Conversion
    CALL CACHE.READ(FN.REDO.TRANS.TYPES.TT.PARAM,ID.VAR2,R.REDO.TRANS.TYPES.TT.PARAM,REDO.TT.PAR.ERR) ;*Manual R22 Conversion
...
*-----------------------------------------------------------------------------
    ...
    WHILE Y.MTS.ID:POS.MTS.ID
        CALL OPF(FN.MULTI.TRANSACTION.SERVICE,F.MULTI.TRANSACTION.SERVICE) ;*Manual R22 Conversion
...
*-----------------------------------------------------------------------------
    ...
    CALL OPF(FN.TELLER.TRANSACTION,F.TELLER.TRANSACTION) ;*Manual R22 Conversion
...
* Y.TT.T24.REF = R.TT<TT.TE.LOCAL.REF,Y.POS.TT.REF>
    ...
    IF Y.TT.T24.REF[1,3] EQ 'T24' THEN
        CALL OPF(FN.T24.FUND.SERVICES,F.T24.FUND.SERVICES) ;*Manual R22 Conversion
...
*-----------------------------------------------------------------------------
    ...
    CALL OPF(FN.CUSTOMER,F.CUSTOMER) ;*Manual R22 Conversion
...
*
        R.RELATION = ''
        CALL OPF(FN.RELATION,F.RELATION) ;*Manual R22 Conversion
...
FETCH.CHQ.QNTY.AND.NUM:
    ...
    IF Y.TXN.TYPE.TT.P EQ '96' THEN
        ...
        CALL OPF(FN.FUNDS.TRANSFER,F.FUNDS.TRANSFER) ;*Manual R22 Conversion
        CALL F.READ(FN.FUNDS.TRANSFER,Y.TT.FT.ID,R.FT,F.FUNDS.TRANSFER,FT.ER)
        IF NOT(R.FT) THEN
            CALL OPF(FN.FUNDS.TRANSFER.HIS,F.FUNDS.TRANSFER.HIS) ;*Manual R22 Conversion

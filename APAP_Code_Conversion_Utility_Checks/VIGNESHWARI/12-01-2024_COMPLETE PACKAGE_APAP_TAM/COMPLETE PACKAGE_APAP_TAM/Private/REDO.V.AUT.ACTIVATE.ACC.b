* @ValidationCode : Mjo2MDQwOTM3MTg6VVRGLTg6MTcwNDk3OTM4MzQ4MTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 18:53:03
...
*        CALL F.READ(FN.REDO.ACCT.FROM.INACT.TO.ACT,Y.TODAY,R.REDO.ACCT.FROM.INACT.TO.ACT,F.REDO.ACCT.FROM.INACT.TO.ACT,ERR.ACT)
        CALL F.READU(FN.REDO.ACCT.FROM.INACT.TO.ACT,Y.TODAY,R.REDO.ACCT.FROM.INACT.TO.ACT,F.REDO.ACCT.FROM.INACT.TO.ACT,ERR.ACT,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.INTRANSIT.CHQ,TRANSIT.USAGE.AC,R.REDO.INTRANSIT.CHQ,F.REDO.INTRANSIT.CHQ,TRANSIT.ERR)
    CALL F.READU(FN.REDO.INTRANSIT.CHQ,TRANSIT.USAGE.AC,R.REDO.INTRANSIT.CHQ,F.REDO.INTRANSIT.CHQ,TRANSIT.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.TRANUTIL.INTAMT,TRANSIT.USAGE.AC,R.REDO.TRANUTIL.INTAMT,F.REDO.TRANUTIL.INTAMT,INT.AMT.ERR)
    CALL F.READU(FN.REDO.TRANUTIL.INTAMT,TRANSIT.USAGE.AC,R.REDO.TRANUTIL.INTAMT,F.REDO.TRANUTIL.INTAMT,INT.AMT.ERR,'');* R22 UTILITY AUTO CONVERSION

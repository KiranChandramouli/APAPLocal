* @ValidationCode : MjotMTI3NTM4MTA4OTpDcDEyNTI6MTcwNDk3Mzk2MjA3Mzp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 17:22:42
...
*    CALL REDO.GET.INTEREST.PROPERTY(Y.ARRANGE.ID,PROP.NAME,OUT.PROP,ERR)
    APAP.TAM.redoGetInterestProperty(Y.ARRANGE.ID,PROP.NAME,OUT.PROP,ERR)
...
*----------------   CASE Y.PROP.ID EQ 'APAPB4ARREAR'
   ...
   * Y.PRD.GRP = R.AA.ARR<AA.ARR.PRODUCT.GROUP>
    Y.PRD.GRP = R.AA.ARR<AA.Framework.ArrangementSim.ArrProductGroup>   ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED

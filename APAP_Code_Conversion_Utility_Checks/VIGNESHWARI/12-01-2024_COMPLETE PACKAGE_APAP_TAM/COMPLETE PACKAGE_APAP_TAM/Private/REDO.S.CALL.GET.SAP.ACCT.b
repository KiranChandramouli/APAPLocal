* @ValidationCode : Mjo4ODMyNDA5NDM6Q3AxMjUyOjE3MDUwNDUzMzQ4NjI6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 Jan 2024 13:12:14
...
*--------------------------------------------------------------------------------------------------
    ...
    CALL OPF(FN.EB.CONT.BAL.CA,F.EB.CONT.BAL.CA) ;*R22 Manual Conversion
    ...
    IF R.EB.CONTRACT.BALANCES THEN
        ...
        CALL OPF(FN.RE.STAT.REP.LINE.CA,F.RE.STAT.REP.LINE.CA) ;*R22 Manual Conversion

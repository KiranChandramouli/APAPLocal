* @ValidationCode : MjoxNzc2NDA0NTg6Q3AxMjUyOjE3MDQ5Njc2NzQ3NDE6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 15:37:54
...
*    CALL LOAD.COMPANY(ID.COMPANY)
    ST.CompanyCreation.LoadCompany(ID.COMPANY);* R22 UTILITY AUTO CONVERSION
...
** R22 Manual conversion
    APAP.TAM.redoVisaSettleWrite(Y.ID,R.REDO.STLMT.LINE)

* @ValidationCode : Mjo1MjQ3MzYyNTY6Q3AxMjUyOjE3MDQ4ODkxOTgxMjg6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:49:58
...
PROCESS:
    ...
    CALL MULTI.GET.LOC.REF(LREF.APPLN,LREF.FLDS,LREF.POS) ;*MANUAL R22 CODE CONVERSION
...
*        CALL F.READ(FN.REDO.PAYMENT.STOP.ACCOUNT,Y.PS.ID,R.REDO.PAYMENT.STOP.ACCOUNT,F.REDO.PAYMENT.STOP.ACCOUNT,ERR.PS)
        CALL F.READU(FN.REDO.PAYMENT.STOP.ACCOUNT,Y.PS.ID,R.REDO.PAYMENT.STOP.ACCOUNT,F.REDO.PAYMENT.STOP.ACCOUNT,ERR.PS,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotODE3MTE4NDc4OkNwMTI1MjoxNzA0ODg2NzUzMTgzOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:09:13
...
* 13/07/2023	 CONVERSION TOOL                                 AUTO R22 CODE CONVERSION- FM TO @FM, VM TO @VM, SM TO @SM
* 13/07/2023	 VIGNESHWARI                                     MANUAL R22 CODE CONVERSION-Variable is not found, Hence variable is intialised with null
...
*    CALL F.READ(FN.REDO.WOF.ACCOUNTING, WOF.ID, R.WOF.ACC.REC, F.REDO.WOF.ACCOUNTING, RET.ERR)
    CALL F.READU(FN.REDO.WOF.ACCOUNTING, WOF.ID, R.WOF.ACC.REC, F.REDO.WOF.ACCOUNTING, RET.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.ACCOUNT, CR.ACCOUNT.NUMBER, CR.ACCOUNT, F.ACCOUNT, RET.ERR)
    CALL F.READU(FN.ACCOUNT, CR.ACCOUNT.NUMBER, CR.ACCOUNT, F.ACCOUNT, RET.ERR,'');* R22 UTILITY AUTO CONVERSION

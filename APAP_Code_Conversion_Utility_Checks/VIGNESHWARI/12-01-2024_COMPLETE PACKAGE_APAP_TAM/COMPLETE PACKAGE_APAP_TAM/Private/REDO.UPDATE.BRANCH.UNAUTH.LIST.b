* @ValidationCode : MjotMTU1MTYyMjcwODpVVEYtODoxNzA0OTcwMTA4ODY3OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Jan 2024 16:18:28
...
*        CALL F.READ(FN.BRANCH.UNAUTH.LIST,Y.ID,R.BRANCH.UNAUTH.LIST,F.BRANCH.UNAUTH.LIST,LIST.ERR)
        CALL F.READU(FN.BRANCH.UNAUTH.LIST,Y.ID,R.BRANCH.UNAUTH.LIST,F.BRANCH.UNAUTH.LIST,LIST.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL CACHE.READ(FN.REDO.EXCEP.REC.PARAM,'SYSTEM',R.REDO.EXCEP.REC.PARAM,EXCEP.ERR)
    ...
    CALL CACHE.READ(FN.REDO.EXCEP.REC.PARAM,IDVAR.1,R.REDO.EXCEP.REC.PARAM,EXCEP.ERR);* R22 UTILITY AUTO CONVERSION

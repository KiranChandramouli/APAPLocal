* @ValidationCode : MjotODM0ODIyNDQ3OlVURi04OjE3MDQ5NTQxODQxNTk6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 11:53:04
...
*    CALL F.READ(FN.REDO.LY.POINTS.TOT,Y.POINTS.TOT.ID,R.REDO.LY.POINTS.TOT,F.REDO.LY.POINTS.TOT,TOT.ERR)
    CALL F.READU(FN.REDO.LY.POINTS.TOT,Y.POINTS.TOT.ID,R.REDO.LY.POINTS.TOT,F.REDO.LY.POINTS.TOT,TOT.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL CACHE.READ(FN.REDO.LY.MASTERPRGDR,'SYSTEM',R.REDO.LY.MASTERPRGDR,MAS.ERR) ; * Tus End
    ...
    WHILE Y.SLAVE.CNT LE Y.SLAVES.PRG.CNT
        ...
        END
        Y.SLAVE.CNT += 1 ;* R22 Auto conversion
    REPEAT

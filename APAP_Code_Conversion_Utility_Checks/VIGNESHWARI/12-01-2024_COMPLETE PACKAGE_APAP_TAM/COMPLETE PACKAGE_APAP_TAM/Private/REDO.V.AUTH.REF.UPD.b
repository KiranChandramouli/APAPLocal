* @ValidationCode : MjoxNDUwNTIwMzE5OlVURi04OjE3MDQ5NzYyMTg2MDA6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 18:00:18
...
*    CALL F.READ(FN.AZ.ACCOUNT,Y.VAR.ACCOUNT,R.AZ.ACCOUNT,F.AZ.ACCOUNT,AZ.ERR)
    CALL F.READU(FN.AZ.ACCOUNT,Y.VAR.ACCOUNT,R.AZ.ACCOUNT,F.AZ.ACCOUNT,AZ.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.AZ.ACCOUNT.NAU,Y.VAR.ACCOUNT,R.AZ.ACCOUNT.NAU,F.AZ.ACCOUNT.NAU,AZ.ERR.NAU)
        CALL F.READU(FN.AZ.ACCOUNT.NAU,Y.VAR.ACCOUNT,R.AZ.ACCOUNT.NAU,F.AZ.ACCOUNT.NAU,AZ.ERR.NAU,'');* R22 UTILITY AUTO CONVERSION

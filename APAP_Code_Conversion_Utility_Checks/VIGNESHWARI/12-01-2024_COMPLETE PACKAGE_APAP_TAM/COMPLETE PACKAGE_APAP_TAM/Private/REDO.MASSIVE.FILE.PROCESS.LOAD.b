* @ValidationCode : MjotNTM4MDMwMDA4OlVURi04OjE3MDQ5NTU0NDk2NzM6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 12:14:09
...
*    CALL CACHE.READ(FN.REDO.MASSIVE.FILE.PATH,'SYSTEM',R.FILE.DETAILS,Y.REDO.MASSIVE.FILE.PATH.ERR)
    ...
    CALL CACHE.READ(FN.REDO.MASSIVE.FILE.PATH,IDVAR.1,R.FILE.DETAILS,Y.REDO.MASSIVE.FILE.PATH.ERR);* R22 UTILITY AUTO CONVERSION

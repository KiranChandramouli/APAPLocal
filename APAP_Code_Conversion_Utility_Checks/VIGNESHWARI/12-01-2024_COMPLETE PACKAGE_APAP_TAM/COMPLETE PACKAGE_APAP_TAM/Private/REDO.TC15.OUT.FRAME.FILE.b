* @ValidationCode : MjoyMDI1MDgzNzk0OkNwMTI1MjoxNzA0OTY3NTk3MjMzOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Jan 2024 15:36:37
...
*    CALL F.READ(FN.VISA.OUT.CHGBCK.LINES,Y.FILE.ID,R.FILE.SEQ,F.VISA.OUT.CHGBCK.LINES,SEQ.ERR)
    CALL F.READU(FN.VISA.OUT.CHGBCK.LINES,Y.FILE.ID,R.FILE.SEQ,F.VISA.OUT.CHGBCK.LINES,SEQ.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.VISA.OUT.CHGBCK.LINES,Y.FILE.ID,R.VISA.OUT.CHGBCK.LINES,F.VISA.OUT.CHGBCK.LINES,CHRGBCK.ERR)
    CALL F.READU(FN.VISA.OUT.CHGBCK.LINES,Y.FILE.ID,R.VISA.OUT.CHGBCK.LINES,F.VISA.OUT.CHGBCK.LINES,CHRGBCK.ERR,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotMTYxNTAxNTY5MTpDcDEyNTI6MTcwNDg4OTUwNTc1NjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:55:05
...
************
    ...
    Y.POS = ''
    CALL MULTI.GET.LOC.REF(Y.APPLN,Y.FLD,Y.POS)  ;*MANUAL R22 CODE CONVERSION
...
*    CALL F.READ(FN.AA.ACTIVITY.HISTORY,AA.ARR.ID,R.AA.ACTIVITY.HISTORY,F.AA.ACTIVITY.HISTORY,ERR.AA.ACTIVITY.HISTORY)
    R.AA.ACTIVITY.HISTORY=AA.Framework.ActivityHistory.Read(AA.ARR.ID, ERR.AA.ACTIVITY.HISTORY)  ;*R22 Manual Conversion
    IF R.AA.ACTIVITY.HISTORY THEN
*        YACT.ID.ARR = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY>
        YACT.ID.ARR = R.AA.ACTIVITY.HISTORY <AA.Framework.ActivityHistoryHist.AhActivity> ;*R22 Manual Conversion
*        YACT.IS.STAT = R.AA.ACTIVITY.HISTORY<AA.AH.ACT.STATUS>
        YACT.IS.STAT = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistory.AhActStatus> ;*R22 Manual Conversion
...
*    Y.PROD.GUP = R.AA.ARR<AA.ARR.PRODUCT.GROUP>
    Y.PROD.GUP = R.AA.ARR<AA.Framework.ArrangementSim.ArrProductGroup> ;*R22 Manual Conversion

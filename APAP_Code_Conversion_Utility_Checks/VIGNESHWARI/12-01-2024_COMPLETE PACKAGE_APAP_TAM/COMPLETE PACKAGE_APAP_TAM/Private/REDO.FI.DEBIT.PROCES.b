* @ValidationCode : MjoxOTg2MDMxMzU5OkNwMTI1MjoxNzA0ODg1OTQ2MDkwOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Jan 2024 16:55:46
...
$PACKAGE APAP.TAM
SUBROUTINE REDO.FI.DEBIT.PROCES(R.PARAMS, OUT.RESP,OUT.ERR)
...
*28-08-2023    VICTORIA S          R22 MANUAL CONVERSION   R22 interface Unit testing changes
...
*    $INSERT I_RAPID.APP.DEV.COMMON ;*R22 interface Unit testing changes
*    $INSERT I_RAPID.APP.DEV.EQUATE ;*R22 interface Unit testing changes
* Tus Start
...
*
    ...
    OFS.FUNCTION = 'I'
    OFS.PROCESS  = 'PROCESS'
    OFS.VERSION  = 'FUNDS.TRANSFER,':COMM.VERSION ;*R22 interface Unit testing changes
    Y.GTSMODE    = ''
    NO.OF.AUTH   = ''
    TRANSACTION.ID = ''
    Y.OFS.STR   = ''

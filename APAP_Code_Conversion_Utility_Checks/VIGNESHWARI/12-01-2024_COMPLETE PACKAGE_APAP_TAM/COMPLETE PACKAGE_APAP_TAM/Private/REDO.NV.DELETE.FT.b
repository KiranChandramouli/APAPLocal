* @ValidationCode : MjotMTQ0MDA0MzY2OTpVVEYtODoxNzA0OTU3ODM5MjczOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Jan 2024 12:53:59
...
*
    ...
    CALL OPF(FN.REDO.TRANSACTION.CHAIN,F.REDO.TRANSACTION.CHAIN) ;*Manual R22 Conversion

    FN.TELLER.ID = "F.TELLER.ID"
    F.TELLER.ID  = ""
    CALL OPF(FN.TELLER.ID,F.TELLER.ID) ;*Manual R22 Conversion
...
*                CALL F.READ(FN.TELLER.ID,WTT.ID,R.TELLER.ID,F.TELLER.ID,ERR.MSJ)
                CALL F.READU(FN.TELLER.ID,WTT.ID,R.TELLER.ID,F.TELLER.ID,ERR.MSJ,'');* R22 UTILITY AUTO CONVERSION
...
*                CALL F.READ(FN.REDO.TRANSACTION.CHAIN,WINITIAL.ID,R.REDO.TRANSACTION.CHAIN,F.REDO.TRANSACTION.CHAIN,ERR.MSJ)
                CALL F.READU(FN.REDO.TRANSACTION.CHAIN,WINITIAL.ID,R.REDO.TRANSACTION.CHAIN,F.REDO.TRANSACTION.CHAIN,ERR.MSJ,'');* R22 UTILITY AUTO CONVERSION
                IF ERR.MSJ THEN
                    Y.ERR.MSG = ERR.MSJ
                    AF        = FT.DEBIT.AMOUNT
                    PROCESS.GOAHEAD = ""

* @ValidationCode : MjotMTc2NDU5MzUwOkNwMTI1MjoxNzA0ODg3NzcwNzYwOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:26:10
...
*
    $USING APAP.REDOENQ
    $USING EB.Interface ;*R22 interface Unit testing changes
*************************************************************************
*
...
*
    R.FUNDS.TRANSFER<FT.ORDERING.BANK>="NOMINA"
*R22 interface Unit testing changes
*SJ start
...
;*OFS.SOURCE.ID = "GCS" ;*R22 interface Unit testing changes
    OFS.MSG.ER = ""
*

...
IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.AI.REDO.ARCIB.PARAMETER,IDVAR.1,R.AI.REDO.ARCIB.PARAMETER,RAP.ERR);* R22 UTILITY AUTO CONVERSION
...
*        IF CHK.JOINT.ACC.FLAG EQ 1 THEN ;*Tus Start               ;** R22 Auto conversion - = TO EQ
        IF CHK.JOINT.ACC.FLAG EQ 1 THEN ;*Tus Start               ;** R22 Auto conversion - EQ TO EQ;* R22 UTILITY AUTO CONVERSION
...
*            IF R.AC.REC<AC.CO.CODE> EQ ID.COMPANY THEN                    ;** R22 Auto conversion - = TO EQ
            IF R.AC.REC<AC.CO.CODE> EQ ID.COMPANY THEN                    ;** R22 Auto conversion - EQ TO EQ;* R22 UTILITY AUTO CONVERSION
                GOSUB FILL.THE.REC
            END
        END
    REPEAT

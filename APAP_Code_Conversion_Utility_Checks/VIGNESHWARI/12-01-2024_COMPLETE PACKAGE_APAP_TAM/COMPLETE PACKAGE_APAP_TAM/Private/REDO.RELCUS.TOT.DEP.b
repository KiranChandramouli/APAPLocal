* @ValidationCode : MjotNzE5NjE2NDY5OkNwMTI1MjoxNzA0ODg4Nzk3NDIzOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:43:17
...
*    CALL GET.LOC.REF('ACCOUNT','L.AC.TOT.DEP',TOT.DEP.POS)
    EB.LocalReferences.GetLocRef('ACCOUNT','L.AC.TOT.DEP',TOT.DEP.POS);* R22 UTILITY AUTO CONVERSION
    TOT.DEP = ''
RETURN
*********
PROCESS:

* @ValidationCode : MjotNDUzNjk1NjMyOkNwMTI1MjoxNzA0OTY5NDQyMTg1OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Jan 2024 16:07:22
...
*11-01-2024  VIGNESHWARI S R22 MANUAL CODE CONVERSION-CHANGE F.READ TO F.CACHE.READ
*----------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*----------------------------------------------------------------------
    ...
    *CALL F.READ(FN.REDO.VISA.STLMT.MAPPING,SYSTEM.ID,R.REDO.VISA.STLMT.MAPPING,F.REDO.VISA.STLMT.MAPPING,VISA.STLMT.MAPPING.ERR)
    CALL F.CACHE.READ(FN.REDO.VISA.STLMT.MAPPING,SYSTEM.ID,R.REDO.VISA.STLMT.MAPPING,VISA.STLMT.MAPPING.ERR)    ;*R22 MANUAL CODE CONVERSION-CHANGE F.READ TO F.CACHE.READ
    TRAILER.LINE = ''
...
*LEN.FIELD = END.POS - START.POS + 1
        LEN.FIELD = END.POS
*APAP.TAM.REDO.FMT.OUT.PADDING
        APAP.TAM.redoFmtOutPadding()

* @ValidationCode : MjoxNDA3MTEzNjM3OkNwMTI1MjoxNzA0ODgyNjQ3MDUzOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Jan 2024 16:00:47
...
*    $INSERT I_F.AA.ARRANGEMENT ;*R22 Manual Conversion
...
*    CALL F.READ(FN.AA.ARRANGEMENT,ARR.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,Y.ARR.ERR)
    R.AA.ARRANGEMENT= AA.Framework.Arrangement.Read(ARR.ID, Y.ARR.ERR) ;*R22 Manual Conversion
    PROP.NAME='PRINCIPAL'     ;* Interest Property to obtain
*APAP.TAM.REDO.GET.INTEREST.PROPERTY(ARR.ID,PROP.NAME,OUT.PROP,ERR) ;*MANUAL R22 CODE CONVERSION
    APAP.TAM.redoGetInterestProperty(ARR.ID,PROP.NAME,OUT.PROP,ERR) ;*MANUAL R22 CODE CONVERSION
...
*        Y.ARR.PRODUCT = R.AA.ARRANGEMENT<AA.ARR.PRODUCT>
        Y.ARR.PRODUCT = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct> ;*R22 Manual Conversion
*        Y.ARR.PRODUCT = R.AA.ARRANGEMENT<AA.ARR.PRODUCT>
        Y.ARR.PRODUCT = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct> ;*R22 Manual Conversion
...
*
    ...
    ERR.MSG = ''
    R.INT.ARR.COND = ''
*APAP.AA.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.INT.ARR.COND,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    APAP.AA.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.INT.ARR.COND,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*-----------------------------------------------------------------------------
    ...
    Y.PRODUCT=R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct> ;*R22 Manual Conversion
...
* Here we get the Campaign type of the loan
    ...
    R.CONDITION = ''
    ERR.MSG = ''
*APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.CUSTOMER,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.CUSTOMER,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*APAP.TAM.REDO.GET.MARGIN.ID(Y.CAMP.TYPE,Y.AFF.COMP,R.ARRAY,Y.MARGIN.ID) ;*MANUAL R22 CODE CONVERSION
    APAP.TAM.redoGetMarginId(Y.CAMP.TYPE,Y.AFF.COMP,R.ARRAY,Y.MARGIN.ID) ;*MANUAL R22 CODE CONVERSION
...
* This part gets the Loan amount
    ...
    R.CONDITION = ''
    ERR.MSG = ''
*APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.TERM,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.TERM,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
GET.INTEREST.RATE:
*-----------------------------------------------------------------------------
*APAP.TAM.REDO.GET.INTEREST.RATE(ARR.ID,Y.INTEREST.RATE) ;*MANUAL R22 CODE CONVERSION
    APAP.TAM.redoGetInterestRate(ARR.ID,Y.INTEREST.RATE) ;*MANUAL R22 CODE CONVERSION
...
*-----------------------------------------------------------------------------
    ...
    OUT.PROP.ACC=''
*APAP.TAM.REDO.GET.PROPERTY.NAME(ARR.ID,'ACCOUNT',R.OUT.AA.RECORD,OUT.PROP.ACC,OUT.ERR) ;*MANUAL R22 CODE CONVERSION
    APAP.TAM.redoGetPropertyName(ARR.ID,'ACCOUNT',R.OUT.AA.RECORD,OUT.PROP.ACC,OUT.ERR) ;*MANUAL R22 CODE CONVERSION
    IN.ACC.ID=''
*APAP.TAM.REDO.CONVERT.ACCOUNT(IN.ACC.ID,ARR.ID,OUT.ID,ERR.TEXT) ;*MANUAL R22 CODE CONVERSION
...
*    CALL AA.GET.ECB.BALANCE.AMOUNT(OUT.ID,BALANCE.TO.CHECK,Y.TODAY,BALANCE.AMOUNT,RET.ERROR)
    AA.Framework.GetEcbBalanceAmount(OUT.ID,BALANCE.TO.CHECK,Y.TODAY,BALANCE.AMOUNT,RET.ERROR);* R22 UTILITY AUTO CONVERSION
...
*    Y.LOAN.START.DATE=R.AA.ARRANGEMENT<AA.ARR.START.DATE>
    Y.LOAN.START.DATE=R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrStartDate> ;*R22 Manual Conversion
...
*-----------------------------------------------------------------------------
    ...
    R.CONDITION = ''
    ERR.MSG = ''
*APAP.AA.REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.OVERDUE,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.OVERDUE,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*------------------------------------------------------------------------------
    ...
    OFS.STRING.FINAL = ''
*APAP.AA.REDO.AA.BUILD.OFS(ARR.ID,R.INT.ARR.COND.OFS,Y.ACT.PROP,OFS.STRING.FINAL) ;*MANUAL R22 CODE CONVERSION
    APAP.AA.redoAaBuildOfs(ARR.ID,R.INT.ARR.COND.OFS,Y.ACT.PROP,OFS.STRING.FINAL) ;*MANUAL R22 CODE CONVERSION
...
*    CALL OFS.CALL.BULK.MANAGER(OFS.SRC, OFS.STRING.FINAL, OFS.RESP, TXN.COMMIT)
    EB.Interface.OfsCallBulkManager(OFS.SRC, OFS.STRING.FINAL, OFS.RESP, TXN.COMMIT);* R22 UTILITY AUTO CONVERSION
* PACS00625964 - E
...
*APAP.TAM.REDO.GET.INTEREST.PROPERTY(ARR.ID,PROP.NAME,OUT.PROP,ERR) ;*MANUAL R22 CODE CONVERSION
    ...
    ERR.MSG = ''
    R.PENAL.COND = ''
*APAP.AA.REDO.CRR.GET.CONDITIONS(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PENAL.COND,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    APAP.AA.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PENAL.COND,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
    ...
    OFS.STRING.FINAL = ''
*APAP.AA.REDO.AA.BUILD.OFS(ARR.ID,R.PENAL.COND.OFS,Y.ACT.PROP,OFS.STRING.FINAL) ;*MANUAL R22 CODE CONVERSION
    APAP.AA.redoAaBuildOfs(ARR.ID,R.PENAL.COND.OFS,Y.ACT.PROP,OFS.STRING.FINAL) ;*MANUAL R22 CODE CONVERSION
    OFS.SRC = 'AA.INT.UPDATE'
    OPTIONS = ''
    OFS.STRING.FINAL:="EFFECTIVE.DATE:1:1=":Y.CHECK.DATE
*    CALL OFS.POST.MESSAGE(OFS.STRING.FINAL,OFS.MSG.ID,OFS.SRC,OPTIONS)
    EB.Interface.OfsPostMessage(OFS.STRING.FINAL,OFS.MSG.ID,OFS.SRC,OPTIONS) ;*R22 Manual Conversion
...
*-------------------PACS00165067---------------------
    ...
    Y.DATE = Y.CHECK.DATE
*APAP.TAM.REDO.GET.NEXT.CYCLEDATE(ARR.ID,FREQ,Y.DATE,Y.OUT.DATE) ;*MANUAL R22 CODE CONVERSION
    APAP.TAM.redoGetNextCycledate(ARR.ID,FREQ,Y.DATE,Y.OUT.DATE) ;*MANUAL R22 CODE CONVERSION
*-------------------PACS00165067---------------------

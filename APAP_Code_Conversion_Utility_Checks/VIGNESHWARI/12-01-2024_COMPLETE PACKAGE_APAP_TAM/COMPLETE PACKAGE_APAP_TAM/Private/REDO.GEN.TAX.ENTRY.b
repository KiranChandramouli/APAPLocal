* @ValidationCode : MjotODQ3OTMwMDg5OkNwMTI1MjoxNzA0OTcwNTAyNDMwOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Jan 2024 16:25:02
...
AC.API.EbAccounting('FT','SAO',MULTI.STMT,FWD);* R22 UTILITY AUTO CONVERSION
    END
    IF APPLICATION EQ 'TELLER' THEN
*        CALL EB.ACCOUNTING('TT','SAO',MULTI.STMT,FWD)
AC.API.EbAccounting('TT','SAO',MULTI.STMT,FWD);* R22 UTILITY AUTO CONVERSION
    END
RETURN

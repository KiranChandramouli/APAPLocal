* @ValidationCode : Mjo2ODkxNjMwOlVURi04OjE3MDQ5NzYwMjk3NzE6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 17:57:09
...
*    CALL F.READ(FN.REDO.APAP.H.DEAL.SLIP.QUEUE,Y.CONTRACT.NO,R.REDO,F.REDO.APAP.H.DEAL.SLIP.QUEUE,ERR)
    CALL F.READU(FN.REDO.APAP.H.DEAL.SLIP.QUEUE,Y.CONTRACT.NO,R.REDO,F.REDO.APAP.H.DEAL.SLIP.QUEUE,ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.APAP.H.REPRINT.SEQ,Y.TXN.DSLIP,R.REDO.APAP.H.REPRINT.SEQ,F.REDO.APAP.H.REPRINT.SEQ,Y.RAHRS.ERR)
    CALL F.READU(FN.REDO.APAP.H.REPRINT.SEQ,Y.TXN.DSLIP,R.REDO.APAP.H.REPRINT.SEQ,F.REDO.APAP.H.REPRINT.SEQ,Y.RAHRS.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.LOCKING,LOCKING.ID,R.LOCKING,F.LOCKING,LOCKING.ER)
    CALL F.READU(FN.LOCKING,LOCKING.ID,R.LOCKING,F.LOCKING,LOCKING.ER,'');* R22 UTILITY AUTO CONVERSION
    IF R.LOCKING THEN

* @ValidationCode : MjoxNjYyNDU1NzMxOkNwMTI1MjoxNzA0ODg2MjY4ODUwOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:01:08
...
*    CALL CACHE.READ(FN.SMAIL,'SYSTEM',R.SMAIL,Y.ERR) ; * Tus End
    ...
    CALL CACHE.READ(FN.SMAIL,IDVAR.1,R.SMAIL,Y.ERR) ; * Tus End;* R22 UTILITY AUTO CONVERSION
    IF Y.ERR NE '' THEN
        E = Y.ERR
        RETURN
    END

* @ValidationCode : Mjo4ODUxOTI3MzY6VVRGLTg6MTcwNDk3NTgxNTEzMDpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 17:53:35
...
*13/07/2023	   CONVERSION TOOL                         AUTO R22 CODE CONVERSION- VM TO @VM,FM TO @FM,SM TO @SM,F.READ TO CACHE.READ, TNO TO C$T24.SESSION.NO, = TO EQ
...
PROCESS:
    IF APPLICATION EQ 'TELLER'  AND V$FUNCTION EQ "I"  THEN
...
*        CALL F.READ(FN.REDO.TELLER.PROCESS,VAR.TELLER.PROCESS.ID,R.TELLER.PROCESS,F.REDO.TELLER.PROCESS,ERR)
        CALL F.READU(FN.REDO.TELLER.PROCESS,VAR.TELLER.PROCESS.ID,R.TELLER.PROCESS,F.REDO.TELLER.PROCESS,ERR,'');* R22 UTILITY AUTO CONVERSION
        R.TELLER.PROCESS<TEL.PRO.STATUS>="PROCESSED"
        CALL F.WRITE(FN.REDO.TELLER.PROCESS,VAR.TELLER.PROCESS.ID,R.TELLER.PROCESS)
    END
    IF APPLICATION EQ 'REDO.TELLER.REJECT' AND V$FUNCTION EQ "I" AND PGM.VERSION EQ ",CREATE" THEN
...
*        CALL F.READ(FN.REDO.TELLER.PROCESS,ID.NEW,R.TELLER.PROCESS,F.REDO.TELLER.PROCESS,ERR)
        CALL F.READU(FN.REDO.TELLER.PROCESS,ID.NEW,R.TELLER.PROCESS,F.REDO.TELLER.PROCESS,ERR,'');* R22 UTILITY AUTO CONVERSION
...
*HD1102996-This will remove status rejected from the record of REDO.TELLER.PROCESS
        ...
        CALL F.DELETE(FN.REDO.TELLER.REJECT,ID.NEW)
    END
    IF APPLICATION EQ 'T24.FUND.SERVICES' AND (V$FUNCTION EQ "I" OR V$FUNCTION EQ "A") THEN
...
*        CALL F.READ(FN.REDO.TFS.PROCESS,VAR.TFS.PROCESS.ID,R.TFS.PROCESS,F.REDO.TFS.PROCESS,ERR)
        CALL F.READU(FN.REDO.TFS.PROCESS,VAR.TFS.PROCESS.ID,R.TFS.PROCESS,F.REDO.TFS.PROCESS,ERR,'');* R22 UTILITY AUTO CONVERSION
        R.TFS.PROCESS<TFS.PRO.STATUS>='PROCESSED'
        CALL F.WRITE(FN.REDO.TFS.PROCESS,VAR.TFS.PROCESS.ID,R.TFS.PROCESS)
    END
    IF APPLICATION EQ 'REDO.TFS.REJECT' AND V$FUNCTION EQ "I" AND PGM.VERSION EQ ",CREATE" THEN
...
*        CALL F.READ(FN.REDO.TFS.PROCESS,ID.NEW,R.TFS.PROCESS,F.REDO.TFS.PROCESS,ERR)
        CALL F.READU(FN.REDO.TFS.PROCESS,ID.NEW,R.TFS.PROCESS,F.REDO.TFS.PROCESS,ERR,'');* R22 UTILITY AUTO CONVERSION
...
**HD1102996-This code will remove the status from REDO.TFS.PROCESS application
        ...
        CALL F.DELETE(FN.REDO.TFS.REJECT,ID.NEW)
    END
    IF APPLICATION EQ 'FUNDS.TRANSFER'  AND V$FUNCTION EQ "I"  THEN
...
*        CALL F.READ(FN.REDO.TELLER.PROCESS,VAR.FT.PROCESS.ID,R.TELLER.PROCESS,F.REDO.TELLER.PROCESS,ERR)
        CALL F.READU(FN.REDO.TELLER.PROCESS,VAR.FT.PROCESS.ID,R.TELLER.PROCESS,F.REDO.TELLER.PROCESS,ERR,'');* R22 UTILITY AUTO CONVERSION
        R.TELLER.PROCESS<TEL.PRO.STATUS>="PROCESSED"
    ...
    IF APPLICATION EQ 'REDO.TELLER.PROCESS' AND PGM.VERSION EQ ",PROCESS" THEN
        ...
        CALL CACHE.READ(FN.USER, OPERATOR, R.USE, Y.ERR.US)
...
*-----------------------------------------------------------------
    ...
    INPUTTER = C$T24.SESSION.NO:'_':OPERATOR;*AUTO R22 CODE CONVERSION
    AUTHORISER = C$T24.SESSION.NO:'_':OPERATOR;*AUTO R22 CODE CONVERSION
...
*    CALL F.READ(FN.REDO.PIGGY.STOCK.BY.DATE,Y.ID.PIGGY,R.REDO.PIGGY.STOCK.BY.DATE,F.REDO.PIGGY.STOCK.BY.DATE,Y.ERR.PIGGY)
    CALL F.READU(FN.REDO.PIGGY.STOCK.BY.DATE,Y.ID.PIGGY,R.REDO.PIGGY.STOCK.BY.DATE,F.REDO.PIGGY.STOCK.BY.DATE,Y.ERR.PIGGY,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.ITEM.STOCK,Y.ITEM.STOCK.ID,R.REDO.ITEM.STOCK,F.REDO.ITEM.STOCK,Y.ERR)
    CALL F.READU(FN.REDO.ITEM.STOCK,Y.ITEM.STOCK.ID,R.REDO.ITEM.STOCK,F.REDO.ITEM.STOCK,Y.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.ITEM.STOCK.BY.DATE,Y.ITEM.STOCK.RPT.ID,R.REDO.ITEM.STOCK.BY.DATE,F.REDO.ITEM.STOCK.BY.DATE,Y.ER.RPT)
    CALL F.READU(FN.REDO.ITEM.STOCK.BY.DATE,Y.ITEM.STOCK.RPT.ID,R.REDO.ITEM.STOCK.BY.DATE,F.REDO.ITEM.STOCK.BY.DATE,Y.ER.RPT,'');* R22 UTILITY AUTO CONVERSION
    Y.DATE.RPT = TODAY

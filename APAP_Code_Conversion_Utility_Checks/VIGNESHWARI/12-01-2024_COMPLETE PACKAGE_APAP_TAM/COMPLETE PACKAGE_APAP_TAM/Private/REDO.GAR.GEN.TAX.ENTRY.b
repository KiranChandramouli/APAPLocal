* @ValidationCode : MjotMTI5MzY4MzU4MTpDcDEyNTI6MTcwNDk3MDE2NTQwNjp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 16:19:25
...
AC.API.EbAccounting('FT','SAO',MULTI.STMT,'');* R22 UTILITY AUTO CONVERSION
    END
...
*    CALL F.READ(FN.REDO.GAR.CREDIT.PROCESS,Y.GAR.ID,R.REDO.GAR.CREDIT.PROCESS,F.REDO.GAR.CREDIT.PROCESS,ERR)
    CALL F.READU(FN.REDO.GAR.CREDIT.PROCESS,Y.GAR.ID,R.REDO.GAR.CREDIT.PROCESS,F.REDO.GAR.CREDIT.PROCESS,ERR,'');* R22 UTILITY AUTO CONVERSION

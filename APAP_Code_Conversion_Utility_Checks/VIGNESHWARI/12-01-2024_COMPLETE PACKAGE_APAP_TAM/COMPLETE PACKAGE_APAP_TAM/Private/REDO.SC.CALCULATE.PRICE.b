* @ValidationCode : MjotMzc0OTE0NDM4OlVURi04OjE3MDUwNDQ5NTcxMDQ6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 Jan 2024 13:05:57
...
** 12.01.2024  Narmadha V  Manual R22 Conversion  > to GE
*-------------------------------------------------------------------------------------------------
...
*    WHILE PREV.CPN.DATE > SETTLEMENT
    WHILE PREV.CPN.DATE GE SETTLEMENT ;*Manual R22 Conversion
...
*       NO.OF.DAYS = (Y2 - Y1) * 360 + (M2 - M1) * 30 + (D2 - D1) - (D2 > 30) + (D1 > 30)
        NO.OF.DAYS = (Y2 - Y1) * 360 + (M2 - M1) * 30 + (D2 - D1) - (D2 GE 30) + (D1 GE 30) ;*Manual R22 Conversion
    END
RETURN
END

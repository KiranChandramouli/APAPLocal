* @ValidationCode : MjotOTMyODUxNDgyOkNwMTI1MjoxNjg0ODQyMTUyNTg2OklUU1M6LTE6LTE6NjU3OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
* Log writing: process finished
    APAP.REDOSRTN.redoSNotifyInterfaceAct('VPL004', 'BATCH', '09', 'EMAIL ARCHIVO DEBITO DIRECTO', 'REPORTE - DEBITO DIRECTO A LAS ' : TIMEDATE(), '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION
...
* Open File Directory
    OPEN DD.FILE.PATH ELSE
        ...
        APAP.REDOSRTN.redoSNotifyInterfaceAct('VPL004', 'BATCH', '09', 'EMAIL ARCHIVO DEBITO DIRECTO', 'ERROR REPORTE - DEBITO DIRECTO AL ABRIR DIRECTORIO ' : DD.FILE.PATH, '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION
...
* Open File
    ...
    OPENSEQ DD.FILE.PATH TO DD.FILE THEN
        APAP.REDOSRTN.redoSNotifyInterfaceAct ('VPL004', 'BATCH', '09', 'EMAIL ARCHIVO DEBITO DIRECTO', 'ERROR REPORTE - DEBITO DIRECTO ARCHIVO YA EXISTE EN ' : DD.FILE.PATH, '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION
...
* Write File
    ...
    WHILE DD.LINE:DD.LINE.POS
        WRITESEQ DD.LINE TO DD.FILE ELSE
            APAP.REDOSRTN.redoSNotifyInterfaceAct ('VPL004', 'BATCH', '09', 'EMAIL ARCHIVO DEBITO DIRECTO', 'ERROR REPORTE - DEBITO DIRECTO NO SE PUEDE ESCRIBIR EN ' : DD.FILE.PATH, '', '', '', '', '', OPERATOR, '') ;*MANUAL R22 CODE CONVERSION

* @ValidationCode : MjotODUyNzk0NzE4OlVURi04OjE3MDQ5Nzc1Nzk0NjM6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 18:22:59
...
*    CALL F.READ(FN.REDO.TRANSIT.LOCK,ACCT.ID,R.REDO.TRANSIT.LOCK,F.REDO.TRANSIT.LOCK,ERR)
    CALL F.READU(FN.REDO.TRANSIT.LOCK,ACCT.ID,R.REDO.TRANSIT.LOCK,F.REDO.TRANSIT.LOCK,ERR,'');* R22 UTILITY AUTO CONVERSION
*PACS00055620 -e

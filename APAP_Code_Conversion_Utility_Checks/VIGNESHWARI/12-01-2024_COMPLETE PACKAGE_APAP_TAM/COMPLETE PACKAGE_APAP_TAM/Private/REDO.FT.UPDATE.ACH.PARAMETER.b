* @ValidationCode : MjotMTU4NjczMTUyOkNwMTI1MjoxNzA0OTY5NzYxODQ5OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Jan 2024 16:12:41
...
IDVAR.1 = "SYSTEM" ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.ACH.PARAM,IDVAR.1,R.REDO.ACH.PARAM,ERR.ACH.PARAM);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.ACH.DATE,VAR.TXN.ID,R.REDO.ACH.DATE,F.REDO.ACH.DATE,Y.ERR.ACH.DATE)
    CALL F.READU(FN.REDO.ACH.DATE,VAR.TXN.ID,R.REDO.ACH.DATE,F.REDO.ACH.DATE,Y.ERR.ACH.DATE,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.DUP.ACH.DATE,VAR.TXN.ID,R.REDO.DUP.ACH.DATE,F.REDO.DUP.ACH.DATE,REDO.DUP.ACH.DATE.ERR)
    CALL F.READU(FN.REDO.DUP.ACH.DATE,VAR.TXN.ID,R.REDO.DUP.ACH.DATE,F.REDO.DUP.ACH.DATE,REDO.DUP.ACH.DATE.ERR,'');* R22 UTILITY AUTO CONVERSION

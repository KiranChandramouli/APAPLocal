* @ValidationCode : MjotMTAwODY5NTA0MzpDcDEyNTI6MTcwNDk2OTg0MzE0MjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 16:14:03
...
*    CALL F.READ(FN.REDO.AA.DISBURSE.METHOD,Y.ARRNG.ID,R.REDO.AA.DISBURSE.METHOD,F.REDO.AA.DISBURSE.METHOD,AA.ERR)
    CALL F.READU(FN.REDO.AA.DISBURSE.METHOD,Y.ARRNG.ID,R.REDO.AA.DISBURSE.METHOD,F.REDO.AA.DISBURSE.METHOD,AA.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.REDO.STORE.DSB.DEAL.IDS,Y.ARRNG.ID,R.REDO.STORE.DSB.DEAL.IDS,F.REDO.STORE.DSB.DEAL.IDS,STR.DE.ERR)
        CALL F.READU(FN.REDO.STORE.DSB.DEAL.IDS,Y.ARRNG.ID,R.REDO.STORE.DSB.DEAL.IDS,F.REDO.STORE.DSB.DEAL.IDS,STR.DE.ERR,'');* R22 UTILITY AUTO CONVERSION

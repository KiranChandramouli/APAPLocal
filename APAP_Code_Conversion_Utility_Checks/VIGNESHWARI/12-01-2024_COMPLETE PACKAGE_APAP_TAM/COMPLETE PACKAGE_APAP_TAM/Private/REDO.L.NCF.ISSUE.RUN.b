* @ValidationCode : Mjo2MjE4Njg4MDg6VVRGLTg6MTcwNDk1MzQ2OTMzMDpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 11:41:09
...
*    CALL F.READU(FN.REDO.L.NCF.STOCK,'SYSTEM',R.NCF.STOCK,F.REDO.L.NCF.STOCK,ST.ERR,'')
    ...
    CALL F.READU(FN.REDO.L.NCF.STOCK,IDVAR.1,R.NCF.STOCK,F.REDO.L.NCF.STOCK,ST.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.REDO.L.NCF.UNMAPPED,REDO.NCF.UNMAPPED.ID,R.NCF.UNMAPPED,F.REDO.L.NCF.UNMAPPED,UNMAP.ERR)
        CALL F.READU(FN.REDO.L.NCF.UNMAPPED,REDO.NCF.UNMAPPED.ID,R.NCF.UNMAPPED,F.REDO.L.NCF.UNMAPPED,UNMAP.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL  F.WRITE(FN.REDO.L.NCF.STOCK,'SYSTEM',R.NCF.STOCK)
    IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL  F.WRITE(FN.REDO.L.NCF.STOCK,IDVAR.1,R.NCF.STOCK);* R22 UTILITY AUTO CONVERSION
...
*        CALL JOURNAL.UPDATE(ID.NEW)
        EB.TransactionControl.JournalUpdate(ID.NEW);* R22 UTILITY AUTO CONVERSION
    END
RETURN
*------------
GET.ORIG.NCF:
*------------
    CALL  F.READ(FN.FUNDS.TRANSFER,R.NCF.UNMAPPED<ST.UN.TXN.ID>,R.FUNDS.TRANSFER,F.FUNDS.TRANSFER,FT.ERR)
*    CALL  GET.LOC.REF('FUNDS.TRANSFER','L.NCF.NUMBER',LREF.POS)
    EB.LocalReferences.GetLocRef('FUNDS.TRANSFER','L.NCF.NUMBER',LREF.POS);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : Mjo2NDA5NTExMDk6VVRGLTg6MTcwNDk1NTQ2NjIwOTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 12:14:26
...
$PACKAGE APAP.TAM
SUBROUTINE REDO.MASSIVE.FILE.PROCESS.SELECT
*------------------------------------------------------------
...
*    CALL BATCH.BUILD.LIST('',Y.LIST.OF.ARR)
    EB.Service.BatchBuildList('',Y.LIST.OF.ARR);* R22 UTILITY AUTO CONVERSION
* -----------------------------------------------------------
* PACS00761324 END

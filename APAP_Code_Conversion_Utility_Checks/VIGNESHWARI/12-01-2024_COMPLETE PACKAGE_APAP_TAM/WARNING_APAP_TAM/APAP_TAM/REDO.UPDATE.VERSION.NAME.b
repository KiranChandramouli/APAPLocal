* @ValidationCode : MjozMzAyNDczMTY6VVRGLTg6MTcwNDk3MzM0NDYxNTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 17:12:24
...
* 11.01.2024    Narmadha V            R22               Manual R22 Conversion  F.READ to CACHE.READ
*-----------------------------------------------------------------------------
...
*    CALL F.READ(FN.TELLER.PARAMETER,Y.TEL.PARAM.ID,R.TELLER.PARAMETER,F.TELLER.PARAMETER,TEL.ERR)
    CALL CACHE.READ(FN.TELLER.PARAMETER,Y.TEL.PARAM.ID,R.TELLER.PARAMETER,TEL.ERR) ;*Manual R22 Conversion
...
*    CALL F.READ(FN.REDO.TT.REVE.TODAY,TODAY,R.REDO.TT.REVE.TODAY,F.REDO.TT.REVE.TODAY,RTRT.ERR)
    CALL F.READU(FN.REDO.TT.REVE.TODAY,TODAY,R.REDO.TT.REVE.TODAY,F.REDO.TT.REVE.TODAY,RTRT.ERR,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotMTIxNzQ2MzM1MTpDcDEyNTI6MTcwNDg4OTYzMDI0NTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:57:10
...
*    CALL CACHE.READ(FN.CHARGE.PARAM,"SYSTEM",R.CHARGE.PARAM,CHG.ERR)
    ...
    CALL CACHE.READ(FN.CHARGE.PARAM,IDVAR.1,R.CHARGE.PARAM,CHG.ERR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.PENDING.CHARGE,IN.ACCT.NO,R.PENDING.CHARGE,F.PENDING.CHARGE,PC.ERR)
    CALL F.READU(FN.PENDING.CHARGE,IN.ACCT.NO,R.PENDING.CHARGE,F.PENDING.CHARGE,PC.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL EB.ACCOUNTING("BM.CRCD.MERCH.UPLOAD","SAO",R.ACC.ARR,'')
    AC.API.EbAccounting("BM.CRCD.MERCH.UPLOAD","SAO",R.ACC.ARR,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotMzU3NzA3ODA2OlVURi04OjE3MDQ5Nzk0NDc5NDk6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 18:54:07
...
*    CALL F.READ(FN.REDO.AA.DISBURSE.UPDATE,Y.AA.ID,R.REDO.AA.DISBURSE.UPDATE,F.REDO.AA.DISBURSE.UPDATE,UPD.ERR)
    CALL F.READU(FN.REDO.AA.DISBURSE.UPDATE,Y.AA.ID,R.REDO.AA.DISBURSE.UPDATE,F.REDO.AA.DISBURSE.UPDATE,UPD.ERR,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxOTM2MTU4Nzg6Q3AxMjUyOjE3MDQ4ODY3MTkxNDU6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:08:39
...
*    CALL F.READ(FN.REDO.REPAID.INT, REPAY.ID, R.REPAID.ACC.REC, F.REDO.REPAID.INT, RET.ERR)
    CALL F.READU(FN.REDO.REPAID.INT, REPAY.ID, R.REPAID.ACC.REC, F.REDO.REPAID.INT, RET.ERR,'');* R22 UTILITY AUTO CONVERSION

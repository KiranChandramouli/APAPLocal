* @ValidationCode : MjotMTcxOTI5NDQyOlVURi04OjE3MDQ5NTU5NTM2MDU6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 12:22:33
...
*    CALL F.READ(FN.REDO.L.NCF.ISSUED,VAR.ISSUED.ID,R.NCF.ISSUED,F.REDO.L.NCF.ISSUED,ERR)
    CALL F.READU(FN.REDO.L.NCF.ISSUED,VAR.ISSUED.ID,R.NCF.ISSUED,F.REDO.L.NCF.ISSUED,ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.L.NCF.STATUS,VAR.ISSUED.ID,R.NCF.STATUS,F.REDO.L.NCF.STATUS,ST.ERROR)
    CALL F.READU(FN.REDO.L.NCF.STATUS,VAR.ISSUED.ID,R.NCF.STATUS,F.REDO.L.NCF.STATUS,ST.ERROR,'');* R22 UTILITY AUTO CONVERSION

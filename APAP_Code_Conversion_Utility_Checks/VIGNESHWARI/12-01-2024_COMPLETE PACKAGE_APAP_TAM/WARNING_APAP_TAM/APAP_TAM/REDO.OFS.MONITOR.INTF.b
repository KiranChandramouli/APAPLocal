* @ValidationCode : MjoxMjg1MzY2ODMwOlVURi04OjE3MDQ5NTg5ODQwNTQ6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 13:13:04
...
*    CALL CACHE.READ("F.REDO.MONITOR.PARAMETER",Y.APPLICATION,R.RECORD.PARAM,Y.ERR.PARAM)
    FN.REDO.MONITOR.PARAMETER = "F.REDO.MONITOR.PARAMETER";* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.MONITOR.PARAMETER,Y.APPLICATION,R.RECORD.PARAM,Y.ERR.PARAM);* R22 UTILITY AUTO CONVERSION
...
*CALL REDO.MON.POST.MAP.QUEUE(P.REC.ID, P.MAP.ID, P.FUNCT, P.OPERATOR, P.COMPANY, P.APP, P.OBJ, P.REC.OLD, P.REC.NEW, P.ACC.OLD, P.ACC.NEW, O.ERR)
    APAP.TAM.redoMonPostMapQueue(P.REC.ID, P.MAP.ID, P.FUNCT, P.OPERATOR, P.COMPANY, P.APP, P.OBJ, P.REC.OLD, P.REC.NEW, P.ACC.OLD, P.ACC.NEW, O.ERR) ;*MANUAL R22 CODE CONVERSION

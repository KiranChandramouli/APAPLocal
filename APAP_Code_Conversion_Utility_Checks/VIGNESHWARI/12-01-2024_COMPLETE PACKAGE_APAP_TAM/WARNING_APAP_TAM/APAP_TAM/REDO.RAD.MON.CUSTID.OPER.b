* @ValidationCode : MjotMTEyMzU0MDk3NTpDcDEyNTI6MTcwNDg4NjY2MzAyMTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:07:43
...
*    CALL GET.LOC.REF("CUSTOMER","L.CU.CIDENT", Y.POS.CIDENT)
    EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.CIDENT", Y.POS.CIDENT);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF("CUSTOMER","L.CU.NOUNICO", Y.POS.NOUNICO)
    EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.NOUNICO", Y.POS.NOUNICO);* R22 UTILITY AUTO CONVERSION
    Y.CUST.CODE = COMI

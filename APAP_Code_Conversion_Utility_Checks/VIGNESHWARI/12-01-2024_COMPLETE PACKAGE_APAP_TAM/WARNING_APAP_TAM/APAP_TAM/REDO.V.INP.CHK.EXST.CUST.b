* @ValidationCode : MjoxMDgxNjU2NDIxOkNwMTI1MjoxNzA1MDQ4MjI3NDY5OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 12 Jan 2024 14:00:27
...
*    CALL GET.LOC.REF(LOC.REF.APP,LOC.REF.FIELD,LOC.REF.POS)
    EB.LocalReferences.GetLocRef(LOC.REF.APP,LOC.REF.FIELD,LOC.REF.POS);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.CUSTOMER,CUSTOMER.ID.NEW,R.CUSTOMER,F.CUSTOMER,CUSTOMER.ERR)
    CALL F.READU(FN.CUSTOMER,CUSTOMER.ID.NEW,R.CUSTOMER,F.CUSTOMER,CUSTOMER.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.CUSTOMER,CUSTOMER.ID.OLD,R.CUSTOMER,F.CUSTOMER,CUSTOMER.ERR)
    CALL F.READU(FN.CUSTOMER,CUSTOMER.ID.OLD,R.CUSTOMER,F.CUSTOMER,CUSTOMER.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.CUSTOMER,CUSTOMER.ID.DEL,R.CUSTOMER,F.CUSTOMER,CUSTOMER.ERR)
    CALL F.READU(FN.CUSTOMER,CUSTOMER.ID.DEL,R.CUSTOMER,F.CUSTOMER,CUSTOMER.ERR,'');* R22 UTILITY AUTO CONVERSION
    R.CUSTOMER<EB.CUS.LOCAL.REF,LOC.REF.POS>='NO'
...
*    CALL F.READ(FN.REDO.RESTRICT.CUST.CONCAT,YIDENT.VAL,R.REDO.RESTRICT.CUST.CONCAT,F.REDO.RESTRICT.CUST.CONCAT,ERR.REDO.RESTRICT.CUST.CONCAT)
    CALL F.READU(FN.REDO.RESTRICT.CUST.CONCAT,YIDENT.VAL,R.REDO.RESTRICT.CUST.CONCAT,F.REDO.RESTRICT.CUST.CONCAT,ERR.REDO.RESTRICT.CUST.CONCAT,'');* R22 UTILITY AUTO CONVERSION
RETURN
...
*    CALL F.READ(FN.CUSTOMER.L.CU.CIDENT,Y.DOC.NO,R.CUSTOMER.L.CU.CIDENT,F.CUSTOMER.L.CU.CIDENT,ERR.CUSTOMER.L.CU.CIDENT)
    CALL F.READU(FN.CUSTOMER.L.CU.CIDENT,Y.DOC.NO,R.CUSTOMER.L.CU.CIDENT,F.CUSTOMER.L.CU.CIDENT,ERR.CUSTOMER.L.CU.CIDENT,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.CUSTOMER.L.CU.RNC,Y.DOC.NO,R.CUSTOMER.L.CU.RNC,F.CUSTOMER.L.CU.RNC,ERR.CUSTOMER.L.CU.RNC)
    CALL F.READU(FN.CUSTOMER.L.CU.RNC,Y.DOC.NO,R.CUSTOMER.L.CU.RNC,F.CUSTOMER.L.CU.RNC,ERR.CUSTOMER.L.CU.RNC,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.CUSTOMER.L.CU.PASS.NAT,YCUST.ID,R.CUSTOMER.L.CU.PASS.NAT,F.CUSTOMER.L.CU.PASS.NAT,ERR.CUSTOMER.L.CU.PASS.NAT)
    CALL F.READU(FN.CUSTOMER.L.CU.PASS.NAT,YCUST.ID,R.CUSTOMER.L.CU.PASS.NAT,F.CUSTOMER.L.CU.PASS.NAT,ERR.CUSTOMER.L.CU.PASS.NAT,'');* R22 UTILITY AUTO CONVERSION

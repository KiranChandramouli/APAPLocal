* @ValidationCode : MjoyMzgyOTIxODc6VVRGLTg6MTcwNDk2OTA0OTgyOTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 16:00:49
...
*------------------------------------------------------------------------------------------------
    ...
    Y.ARR.ID = ''
*CALL REDO.CONVERT.ACCOUNT(Y.ARR.ACC.ID,Y.ARR.ID,OUT.ID,ERR.TEXT) ;*R22 MANUAL CODE CONVERSION
    APAP.TAM.redoConvertAccount(Y.ARR.ACC.ID,Y.ARR.ID,OUT.ID,ERR.TEXT) ;*R22 MANUAL CODE CONVERSION

    VAR.AA.ID = OUT.ID
*    CALL F.READ(FN.REDO.NOTIFY.RATE.CHANGE,VAR.AA.ID,R.NOTIFY.DETAIL,F.REDO.NOTIFY.RATE.CHANGE,NOTIFY.ERR)
    CALL F.READU(FN.REDO.NOTIFY.RATE.CHANGE,VAR.AA.ID,R.NOTIFY.DETAIL,F.REDO.NOTIFY.RATE.CHANGE,NOTIFY.ERR,'');* R22 UTILITY AUTO CONVERSION

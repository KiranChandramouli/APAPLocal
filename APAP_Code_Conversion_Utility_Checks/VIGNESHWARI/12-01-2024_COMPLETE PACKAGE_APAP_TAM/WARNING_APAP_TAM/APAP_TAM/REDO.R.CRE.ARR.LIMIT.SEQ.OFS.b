* @ValidationCode : MjoxMzUzODI0MTgyOkNwMTI1MjoxNzA0ODg2MzYxMTc4OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:02:41
...
*------------------------------------------------------------------------------------------------------
    ...
    E = ""
    APAP.TAM.redoRCreArrLimitSeqUpd(P.CUSTOMER.ID, P.LIMIT.REF, P.ACTION, P.LAST.ID, P.LAST.COLL.ID) ;*MANUAL R22 CODE CONVERSION
    Y.RESPONSE = ""

    IF E EQ "" THEN
*        CALL JOURNAL.UPDATE("REDO.R.CRE.ARR.LIMIT.SEQ.OFS")
        EB.TransactionControl.JournalUpdate("REDO.R.CRE.ARR.LIMIT.SEQ.OFS");* R22 UTILITY AUTO CONVERSION
        Y.RESPONSE = "//1"
    END ELSE
        Y.RESPONSE = "//-1," : E
    END

* @ValidationCode : MjoxMDkwNzEwNjgyOlVURi04OjE3MDQ5NjU5MDk4MDc6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 15:08:29
...
*11/01/2024                 Narmadha V        Manual R22 Conversion         CALL Routine Modified
*-----------------------------------------------------------------------------------------------------------------------
...
*    Y.ORIN.COMP = R.AA<AA.ARR.CO.CODE>
    Y.ORIN.COMP = R.AA<AA.Framework.ArrangementSim.ArrCoCode> ;*Manual R22 Conversion
    Y.PAY.AGENCY = R.FT<FT.CO.CODE>
    Y.PAY.DATE = R.FT<FT.CREDIT.VALUE.DATE>
*    Y.PORT.FOLIO = R.AA<AA.ARR.PRODUCT.GROUP>
    Y.PORT.FOLIO = R.AA<AA.Framework.ArrangementSim.ArrProductGroup> ;*Manual R22 Conversion
...
*    CALL AA.GET.ARRANGEMENT.CONDITIONS(Y.ARR.ID,'ACCOUNT','',Y.EF.DATE,'',RET.COND,RET.ER)
    AA.Framework.GetArrangementConditions(Y.ARR.ID,'ACCOUNT','',Y.EF.DATE,'',RET.COND,RET.ER);* R22 UTILITY AUTO CONVERSION
...
*        Y.PROPS = R.AA.ACT.BAL<AA.ACT.BAL.PROPERTY,POS.AAA>
        Y.PROPS = R.AA.ACT.BAL<AA.Framework.ActivityBalances.ActBalProperty,POS.AAA> ;*Manual R22 Conversion

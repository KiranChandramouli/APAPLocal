* @ValidationCode : MjoxODc5MDUwNDA3OkNwMTI1MjoxNjgzODkyNjQ0NTQyOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.CREDIT.LIMIT.MAINTENANCE,IDVAR.1,R.CRD.LIM.MAIN,CRD.ERR);* R22 UTILITY AUTO CONVERSION
...
AA.PaymentSchedule.ScheduleProjector(AA.ID, SIM.REF, "",CYCLE.DATE, TOT.PAYMENT, DUE.DATES, DUE.DEFER.DATES, DUE.TYPES, DUE.METHODS, DUE.TYPE.AMTS, DUE.PROPS, DUE.PROP.AMTS, DUE.OUTS);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxNTk4MjEwMTc3OkNwMTI1MjoxNzA0OTY5NjA3OTM1OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Jan 2024 16:10:07
...
EB.LocalReferences.GetLocRef(LREF.APP,LREF.FIELDS,LREF.POS);* R22 UTILITY AUTO CONVERSION
...
* PACS00085750 - S
    ...
    IF Y.ARR.ID[1,2] EQ 'AA' THEN
        ...
        OUT.ID = ''
        ERR.TEXT = ''
*APAP.TAM.REDO.CONVERT.ACCOUNT(IN.ACC.ID,IN.ARR.ID,OUT.ID,ERR.TEXT)

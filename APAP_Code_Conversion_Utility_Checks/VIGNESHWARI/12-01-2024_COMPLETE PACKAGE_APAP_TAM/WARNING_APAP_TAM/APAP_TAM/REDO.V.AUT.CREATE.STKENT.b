* @ValidationCode : MjotNTM0MDE1MzA1OlVURi04OjE3MDQ5Nzc1MTM4MzE6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 18:21:53
...
*    CALL CACHE.READ(FN.REDO.SER.PARAM,'SYSTEM',R.REDO.SER.PARAM,PROD.ERR)
    ...
    CALL CACHE.READ(FN.REDO.SER.PARAM,IDVAR.1,R.REDO.SER.PARAM,PROD.ERR);* R22 UTILITY AUTO CONVERSION

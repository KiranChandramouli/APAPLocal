* @ValidationCode : Mjo0ODc3MTcwMDg6VVRGLTg6MTcwNDk2NDM1MjA1NDpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 14:42:32
...
*11-01-2024            Narmadha V                 Manual R22 Conversion                    CALL Routine format Modified
*--------------------------------------------------------------------------------------------------------------------------------------
...
*    Y.PRD.GRP = R.AA<AA.ARR.PRODUCT.GROUP>
    Y.PRD.GRP = R.AA<AA.Framework.ArrangementSim.ArrProductGroup> ;*Manual R22 Conversion
*    Y.PRD = R.AA<AA.ARR.PRODUCT>
    Y.PRD = R.AA<AA.Framework.Arrangement.ArrProduct> ;*Manual R22 Conversion
*    Y.CURR = R.AA<AA.ARR.CURRENCY>
    Y.CURR = R.AA<AA.Framework.Arrangement.ArrCurrency> ;*Manual R22 Conversion
*    Y.COMP = R.AA<AA.ARR.CO.CODE>
    Y.COMP = R.AA<AA.Framework.ArrangementSim.ArrCoCode> ;*Manual R22 Conversion
*    Y.AC.ID = R.AA<AA.ARR.LINKED.APPL.ID>
    Y.AC.ID = R.AA<AA.Framework.ArrangementSim.ArrLinkedApplId> ;*Manual R22 Conversion
*    Y.CUS = R.AA<AA.ARR.CUSTOMER>
    Y.CUS = R.AA<AA.Framework.ArrangementSim.ArrCustomer> ;*Manual R22 Conversion

*    CALL AA.GET.ARRANGEMENT.CONDITIONS(Y.AA.ID,'CUSTOMER','','','',RET.COND,RET.ERR)
    AA.Framework.GetArrangementConditions(Y.AA.ID,'CUSTOMER','','','',RET.COND,RET.ERR);* R22 UTILITY AUTO CONVERSION
...
*    CALL AA.GET.ARRANGEMENT.CONDITIONS(Y.AA.ID,'OVERDUE','','','',RET.PR.OV,OV.ERR)
    AA.Framework.GetArrangementConditions(Y.AA.ID,'OVERDUE','','','',RET.PR.OV,OV.ERR);* R22 UTILITY AUTO CONVERSION
...
*        CALL AA.GET.ARRANGEMENT.CONDITIONS(Y.AA.ID,'INTEREST','PRINCIPALINT','','',RET.PR.OV,OV.ERR)
        AA.Framework.GetArrangementConditions(Y.AA.ID,'INTEREST','PRINCIPALINT','','',RET.PR.OV,OV.ERR);* R22 UTILITY AUTO CONVERSION
        RET.PR.OV = RAISE(RET.PR.OV)
...
*    Y.ACTY = R.AA.HIS<AA.AH.ACTIVITY> ; Y.ACTY = CHANGE(Y.ACTY,@SM,@VM) ; Y.ACTY.DUP = Y.ACTY
    Y.ACTY = R.AA.HIS<AA.Framework.ActivityHistoryHist.AhActivity> ; Y.ACTY = CHANGE(Y.ACTY,@SM,@VM) ; Y.ACTY.DUP = Y.ACTY ;*Manual R22 Conversion
*    Y.ACTY.REF = R.AA.HIS<AA.AH.ACTIVITY.REF> ; Y.ACTY.REF = CHANGE(Y.ACTY.REF,@SM,@VM); Y.ACTY.REF.DUP = Y.ACTY.REF
    Y.ACTY.REF = R.AA.HIS<AA.Framework.ActivityHistory.AhActivityRef> ; Y.ACTY.REF = CHANGE(Y.ACTY.REF,@SM,@VM); Y.ACTY.REF.DUP = Y.ACTY.REF ;*Manual R22 Conversion
*    Y.ACT.STS = R.AA.HIS<AA.AH.ACT.STATUS> ; Y.ACT.STS = CHANGE(Y.ACT.STS,@SM,@VM) ; CK = '' ; Y.ACT.STS.DUP = Y.ACT.STS
    Y.ACT.STS = R.AA.HIS<AA.Framework.ActivityHistory.AhActStatus> ; Y.ACT.STS = CHANGE(Y.ACT.STS,@SM,@VM) ; CK = '' ; Y.ACT.STS.DUP = Y.ACT.STS ;*Manual R22 Conversion
*    Y.INT.TYPES = R.AA.HIS<AA.AH.INITIATION> ; Y.INT.TYPES = CHANGE(Y.INT.TYPES,@SM,@VM) ; Y.LAST.REP.DATE = '' ; Y.LAST.REP.AMT = ''
    Y.INT.TYPES = R.AA.HIS<AA.Framework.ActivityHistory.AhInitiation> ; Y.INT.TYPES = CHANGE(Y.INT.TYPES,@SM,@VM) ; Y.LAST.REP.DATE = '' ; Y.LAST.REP.AMT = '' ;*Manual R22 Conversion
...
*                Y.LAST.REP.DATE = R.AAA<AA.ARR.ACT.EFFECTIVE.DATE>
                Y.LAST.REP.DATE = R.AAA<AA.Framework.SimulationCapture.ArrActEffectiveDate> ;*Manual R22 Conversion
*                Y.LAST.REP.AMT = R.AAA<AA.ARR.ACT.ORIG.TXN.AMT>
                Y.LAST.REP.AMT = R.AAA<AA.Framework.RrControl.ArrActOrigTxnAmt> ;*Manual R22 Conversion
                CK = 1
            END ELSE
                DEL Y.ACTY<1,POS.LP>
...
*    CALL AA.GET.ECB.BALANCE.AMOUNT(Y.AC.ID, Y.PR.PN, REQUEST.DATE, BALANCE.AMOUNT,RET.ERROR)
    AA.Framework.GetEcbBalanceAmount(Y.AC.ID, Y.PR.PN, REQUEST.DATE, BALANCE.AMOUNT,RET.ERROR);* R22 UTILITY AUTO CONVERSION
...
*        CALL AA.GET.ECB.BALANCE.AMOUNT(Y.AC.ID, Y.PRO, REQUEST.DATE, BALANCE.AMOUNT,RET.ERROR)
        AA.Framework.GetEcbBalanceAmount(Y.AC.ID, Y.PRO, REQUEST.DATE, BALANCE.AMOUNT,RET.ERROR);* R22 UTILITY AUTO CONVERSION
...
*        CALL AA.GET.ECB.BALANCE.AMOUNT(Y.AC.ID, Y.PR.I, REQUEST.DATE, BALANCE.AMOUNT,RET.ERROR)
        AA.Framework.GetEcbBalanceAmount(Y.AC.ID, Y.PR.I, REQUEST.DATE, BALANCE.AMOUNT,RET.ERROR);* R22 UTILITY AUTO CONVERSION
...
*        CALL AA.GET.ECB.BALANCE.AMOUNT(Y.AC.ID, Y.PR.MORA, REQUEST.DATE, BALANCE.AMOUNT,RET.ERROR)
        AA.Framework.GetEcbBalanceAmount(Y.AC.ID, Y.PR.MORA, REQUEST.DATE, BALANCE.AMOUNT,RET.ERROR);* R22 UTILITY AUTO CONVERSION
...
*                Y.TOT.DIS.AMT += R.AAA<AA.ARR.ACT.TXN.AMOUNT>
                Y.TOT.DIS.AMT += R.AAA<AA.Framework.SimulationCapture.ArrActTxnAmount> ;*Manual R22 Conversion

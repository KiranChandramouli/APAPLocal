* @ValidationCode : MjotMzA3NzEwNDA6Q3AxMjUyOjE3MDQ5NjcyNDM0MDk6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 15:30:43
...
*            CALL F.READ(FN.REDO.NV.TXN.CHAIN,Y.ID,R.REDO.NV.TXN.CHAIN,F.REDO.NV.TXN.CHAIN,CHAIN.ERR)
            CALL F.READU(FN.REDO.NV.TXN.CHAIN,Y.ID,R.REDO.NV.TXN.CHAIN,F.REDO.NV.TXN.CHAIN,CHAIN.ERR,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : Mjo0NjAyODExNjg6Q3AxMjUyOjE3MDQ4ODY2ODgzMDE6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:08:08
...
*13/07/2023	     CONVERSION TOOL                                  AUTO R22 CODE CONVERSION - VM TO @VM,SM TO @SM,FM TO @FM
*13/07/2023	      VIGNESHWARI	    			                 MANUAL R22 CODE CONVERSION - VARIABLE IS NOT FOUND IN INSERT
*-------------------------------------------------------------------------------------------------------------------
...
*    CALL F.READ(FN.REDO.NAB.ACCOUNTING, NAB.ID, R.NAB.ACC.REC, F.REDO.NAB.ACCOUNTING, RET.ERR)
    CALL F.READU(FN.REDO.NAB.ACCOUNTING, NAB.ID, R.NAB.ACC.REC, F.REDO.NAB.ACCOUNTING, RET.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.ACCOUNT, DR.ACCOUNT.NUMBER, DR.ACCOUNT, F.ACCOUNT, RET.ERR)
    CALL F.READU(FN.ACCOUNT, DR.ACCOUNT.NUMBER, DR.ACCOUNT, F.ACCOUNT, RET.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.ACCOUNT, SWAP.ACCOUNT.NUMBER, CR.ACCOUNT, F.ACCOUNT, RET.ERR)
    CALL F.READU(FN.ACCOUNT, SWAP.ACCOUNT.NUMBER, CR.ACCOUNT, F.ACCOUNT, RET.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    LOCATE AA.PRODUCT IN R.AA.INT.CLASS.REC<REDO.INT.CLASS.PRODUCT,1> SETTING PROD.POS THEN  ;*MANUAL R22 CODE CONVERSION- "REDO.INT.CLASS.PRODUCT,REDO.INT.CLASS.DEBIT.CATEGORY & REDO.INT.CLASS.CREDIT.CATEGORY": VARIABLE IS NOT FOUND-START
*
...
*    CALL EB.ACCOUNTING(ACC.PRODUCT,ACC.TYPE,R.STMT.ENTRY,'')  ;* Raise accounting for Consolidated NAB
    AC.API.EbAccounting(ACC.PRODUCT,ACC.TYPE,R.STMT.ENTRY,'')  ;* Raise accounting for Consolidated NAB;* R22 UTILITY AUTO CONVERSION

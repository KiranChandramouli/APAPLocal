* @ValidationCode : MjotODYyNzA3NjcxOlVURi04OjE3MDQ5Njc5NjI0NTk6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Jan 2024 15:42:42
...
$PACKAGE APAP.TAM
SUBROUTINE REDO.TT.TILLTOTILL(V.DR.DENOMINATIO)
*--------------------------------------------------------------------------------
...
* 10.04.2023       Conversion Tool       R22            Auto Conversion     - VM TO @VM, ++ TO += 1, = TO EQ, F TO CACHE, FM TO @FM

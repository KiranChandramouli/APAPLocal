* @ValidationCode : MjotMTMyOTgyMzQ4NzpVVEYtODoxNzA0OTU1NzI2OTk0OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Jan 2024 12:18:46
...
*    CALL F.READ(FN.APAP.PROCESS,'TFS.PROCESS',R.APAP.PROCESS,F.APAP.PROCESS,PROCESS.ERR)
    IDVAR.1 = 'TFS.PROCESS' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.APAP.PROCESS,IDVAR.1,R.APAP.PROCESS,F.APAP.PROCESS,PROCESS.ERR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.LOCKING,'REDO.RETURN.FILE',R.LOCKING,F.LOCKING,LOCK.ERR,'');* R22 UTILITY AUTO CONVERSION
    IDVAR.1 = 'REDO.RETURN.FILE' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READU(FN.LOCKING,IDVAR.1,R.LOCKING,F.LOCKING,LOCK.ERR,'');* R22 UTILITY AUTO CONVERSION;* R22 UTILITY AUTO CONVERSION
...
*    CALL F.WRITE(FN.LOCKING,'REDO.RETURN.FILE',R.LOCKING)
    IDVAR.1 = 'REDO.RETURN.FILE' ;* R22 UTILITY AUTO CONVERSION
    CALL F.WRITE(FN.LOCKING,IDVAR.1,R.LOCKING);* R22 UTILITY AUTO CONVERSION

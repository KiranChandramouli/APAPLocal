* @ValidationCode : MjotNjkwNzk1NDk6Q3AxMjUyOjE3MDQ4ODc3NjIwMzk6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 10 Jan 2024 17:26:02
...
*28-08-2023    CONVERSION TOOL     R22 AUTO CONVERSION	   FM TO @FM,INSERT FILE MODIFIED
    ...
    END ELSE
        ...
        IF Y.CUSTOMER THEN
            ...
            IF F.TOT.AMOUNT GT YWORK.BALANCE THEN
                WERROR.MSG = "EB-Not.enough.BALANCE.in.&.account":@FM:COMM.CUST.ACCT ;*R22 AUTO CONVERSION
            END
        END ELSE
...
*
    ...
    OUT.ERR<2> ="ERROR"
    IF Y.VAR NE '' THEN
        OUT.ERR<3>=Y.VAR ;*R22 AUTO CONVERSION END
    END
*
RETURN
*

* @ValidationCode : Mjo2NTQzMzU2NzQ6VVRGLTg6MTcwNDk3NTkyMzMzMDpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Jan 2024 17:55:23
...
*    CALL EB.ACCOUNTING("CHQ","SAO",MULTI.STMT,'')
    AC.API.EbAccounting("CHQ","SAO",MULTI.STMT,'');* R22 UTILITY AUTO CONVERSION
RETURN
*---------------------------------------------------------------------
RAISE.CATEG.ENTRIES:
*---------------------------------------------------------------------

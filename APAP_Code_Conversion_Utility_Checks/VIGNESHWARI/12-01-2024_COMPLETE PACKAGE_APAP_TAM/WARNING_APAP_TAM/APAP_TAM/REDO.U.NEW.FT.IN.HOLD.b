* @ValidationCode : MjotMTg2NTE4Mzc4MTpVVEYtODoxNzA0OTY4ODMwMTM0OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Jan 2024 15:57:10
...
*    CALL GET.LOC.REF('STANDING.ORDER','L.RETRY.DAYS',STO.RETRY.DAYS.POS)
    EB.LocalReferences.GetLocRef('STANDING.ORDER','L.RETRY.DAYS',STO.RETRY.DAYS.POS);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.RESUBMIT.FT.DET,ARR.ID,R.REDO.RESUBMIT.FT.DET,F.REDO.RESUBMIT.FT.DET,FT.RESUB.ERR)
    CALL F.READU(FN.REDO.RESUBMIT.FT.DET,ARR.ID,R.REDO.RESUBMIT.FT.DET,F.REDO.RESUBMIT.FT.DET,FT.RESUB.ERR,'');* R22 UTILITY AUTO CONVERSION

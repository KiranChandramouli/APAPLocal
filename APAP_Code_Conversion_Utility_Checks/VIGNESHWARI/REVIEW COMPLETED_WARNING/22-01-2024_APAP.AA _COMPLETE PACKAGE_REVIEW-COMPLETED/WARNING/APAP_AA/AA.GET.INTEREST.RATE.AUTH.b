* @ValidationCode : Mjo4NzE4NDI1OTpDcDEyNTI6MTcwNDcxMTkyNTU2Njp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 08 Jan 2024 16:35:25
...
*21/12/2023     VIGNESHWARI     R22 Manual Conversion               CHANGED AA.FRAMEWORK & EB.LocalReferences is changed
*----------------------------------------------------------------------------
...
Y.CUSTOMER.ID = AA.Framework.getC_aalocarractivityrec()<AA.Framework.SimulationCapture.ArrActCustomer>;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
*AA Changes 20161013
...
Y.DISB.AMOUNT=AA.Framework.getC_aalocarractivityrec()<AA.Framework.SimulationCapture.ArrActTxnAmount>;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
R.ALE<AC.LCK.DESCRIPTION>=AA.Framework.getC_aalocarractivityid();*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
Y.ARRANGEMENT.ID= AA.Framework.getC_aalocarrid();*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
ADJUST.FINAL.AMOUNT=''
REQD.END.DATE=''
CHARGE.CALC.INFO = '' ;*Manual R22 conversion - New argument in AA.BUILD.PAYMENT.SCHEDULE.SCHEDULES
...
CALL AA.BUILD.PAYMENT.SCHEDULE.SCHEDULES(SCHEDULE.INFO, REQD.END.DATE, NO.CYCLES, ADJUST.FINAL.AMOUNT, PAYMENT.DATES, PAYMENT.TYPES, PAYMENT.METHODS, PAYMENT.AMOUNTS, PAYMENT.PROPERTIES, PAYMENT.PROPERTIES.AMT, TAX.DETAILS, OUTSTANDING.AMOUNT, FINAL.PRINCIPAL.POS, PAYMENT.PERCENTAGES, PAYMENT.MIN.AMOUNTS, PAYMENT.DEFER.DATES, PAYMENT.BILL.TYPES, CHARGE.CALC.INFO, RET.ERROR)   ;*Manual R22 conversion - CHARGE.CALC.INFO argument added
*TUS END
...
AA.Framework.GetArrangementConditions(Y.ARRANGEMENT.ID, 'PAYMENT.SCHEDULE','','', RET.IDS, R.PAY.SCHED, RET.ERR);* R22 AUTO CONVERSION
...
*APAP.AA.redoCrrGetConditions(c_aalocArrId,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG)  ;*Manual R22 conversion
APAP.AA.redoCrrGetConditions(AA.Framework.getC_aalocarrid(),EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG)  ;*Manual R22 conversion ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED

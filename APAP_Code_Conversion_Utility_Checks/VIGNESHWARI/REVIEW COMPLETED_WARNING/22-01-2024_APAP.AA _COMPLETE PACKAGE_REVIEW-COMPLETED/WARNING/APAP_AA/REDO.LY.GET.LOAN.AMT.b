* @ValidationCode : MjotMTgxOTc2MDY1MzpDcDEyNTI6MTcwNDI2NTk4MzAwODp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 Jan 2024 12:43:03
...
*IF c_aalocActivityStatus EQ 'AUTH' THEN
    IF AA.Framework.getC_aalocactivitystatus() EQ 'AUTH' THEN ;*R22 MANUAL CONVERSION-AA.FRAMEWORK IS CHANGED
GOSUB GET.PROPERTY
*        GOSUB CHECK.MOD
...
*-----------------------------------------------------------------------------------------------------
*ARR.ID = c_aalocArrId
ARR.ID = AA.Framework.getC_aalocarrid();*R22 MANUAL CONVERSION-AA.FRAMEWORK IS CHANGED
PROP.CLASS = 'OVERDUE'
PROPERTY = ''
R.Condition = ''
ERR.MSG = ''
...
TXN.ID = R.AA.ACTIVITY<AA.Framework.ArrangementActivity.ArrActTxnContractId> ;*R22 MANUAL CONVERSION-AA.FRAMEWORK IS CHANGED
GOSUB ASSIGN.LY.PTS
IF PTS.CHG THEN

...
*02-01-2024	     Vigneshwari S			MANUAL R22 CODE CONVERSION 		variable is hardcoded	
*--------------------------------------------------------------------------------------------------------
...
CALL CACHE.READ(FN.REDO.H.ITEM.DETAILS,IDVAR.1,R.REDO.H.ITEM.DETAILS,Y.ITEM.ERR);* R22 AUTO CONVERSION

* @ValidationCode : MjotODczNzM4NjU4OkNwMTI1MjoxNzAzNTkyNzgzOTE3OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 17:43:03
...
* 26-12-2023       VIGNESHWARI S            R22 MANUAL CONVERSTION       call rtn modified
*-----------------------------------------------------------------------------------
...
*************
    ...
    WHILE Y.CNT GT 0 DO
       ...
       * CALL AA.GET.ECB.BALANCE.AMOUNT(Y.LINK.APP.ID, Y.BAL.TYPE, REQUEST.DATE, BALANCE.AMOUNT,RET.ERROR)
        AA.Framework.GetEcbBalanceAmount(Y.LINK.APP.ID, Y.BAL.TYPE, REQUEST.DATE, BALANCE.AMOUNT,RET.ERROR);*R22 MANUAL CODE CONVERSION-CALL RTN MODIFIED
...
AA.Framework.GetPeriodBalances(Y.LINK.APP.ID, BALANCE.TO.CHECK, DATE.OPTIONS, EFFECTIVE.DATE, "", "", BAL.DETAILS, "")  ;*R22 MANUAL CODE CONVERSION-CALL RTN MODIFIED

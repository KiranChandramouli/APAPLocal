* @ValidationCode : Mjo4NjYxMzkwODA6Q3AxMjUyOjE3MDQ3MDI4MzQ3MDc6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 08 Jan 2024 14:03:54
...
* 29/03/2023         Conversion Tool     AUTO R22 CODE CONVERSTION               VM to @VM, SM to @SM
...
GOSUB OPEN.FILES
*IF c_aalocActivityStatus MATCHES 'AUTH':@VM:'UNAUTH' THEN ;*AUTO R22 CODE CONVERSION
IF AA.Framework.getC_aalocactivitystatus() MATCHES 'AUTH':@VM:'UNAUTH' THEN ;*AUTO R22 CODE CONVERSION ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
GOSUB MAIN
END
*IF c_aalocActivityStatus EQ 'AUTH-REV' THEN
IF AA.Framework.getC_aalocactivitystatus() EQ 'AUTH-REV' THEN    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
Y.AA.ID = AA.Framework.getC_aalocarrid()    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
AA.Framework.GetArrangementConditions(Y.AA.ID,Y.PRP.CLS,PROP,EFF.DATE,RET.IDS,RET.COND,RET.ERR);* R22 AUTO CONVERSION
...
*CALL F.READU(FN.REDO.REMOVE.ACTUAL.AMT,c_aalocArrId,R.REDO.REMOVE.ACTUAL.AMT,F.REDO.REMOVE.ACTUAL.AMT,CNCT.ERR,'');* R22 AUTO CONVERSION
CALL F.READU(FN.REDO.REMOVE.ACTUAL.AMT,AA.Framework.getC_aalocarrid(),R.REDO.REMOVE.ACTUAL.AMT,F.REDO.REMOVE.ACTUAL.AMT,CNCT.ERR,'');* R22 AUTO CONVERSION  ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
R.REDO.REMOVE.ACTUAL.AMT<2> = AA.Framework.getC_aalocarractivityid()    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
CALL F.WRITE(FN.REDO.REMOVE.ACTUAL.AMT,AA.Framework.getC_aalocarrid(),R.REDO.REMOVE.ACTUAL.AMT) ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
END
...
CALL F.READU(FN.REDO.REMOVE.ACTUAL.AMT,AA.Framework.getC_aalocarrid(),R.REDO.REMOVE.ACTUAL.AMT,F.REDO.REMOVE.ACTUAL.AMT,CNCT.ERR,'');* R22 AUTO CONVERSION  ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
IF R.REDO.REMOVE.ACTUAL.AMT<2> EQ AA.Framework.getC_aalocarractivityid() THEN   ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED

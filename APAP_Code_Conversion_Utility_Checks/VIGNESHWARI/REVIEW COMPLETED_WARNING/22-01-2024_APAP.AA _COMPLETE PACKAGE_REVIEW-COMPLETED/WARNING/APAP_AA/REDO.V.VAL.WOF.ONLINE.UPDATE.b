* @ValidationCode : MjotMTYyMzQwMjkzMTpDcDEyNTI6MTcwNDcwNTExNjc2MDp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 08 Jan 2024 14:41:56
...
* 08/01/2023         VIGNESHWARI         MANUAL R22 CODE CONVERSION          AA.FRAMEWORK IS ADDED
*-----------------------------------------------------------------
$INSERT I_COMMON
$INSERT I_EQUATE
...
IF AA.Framework.getC_aalocactivitystatus() EQ 'UNAUTH' THEN    
GOSUB OPENFILES
GOSUB PROCESS
END
GOSUB PGM.END
...
CALL F.READU(FN.REDO.ACCT.MRKWOF.HIST,Y.AA.ID,R.REDO.ACCT.MRKWOF.HIST,F.REDO.ACCT.MRKWOF.HIST,WOF.ERR,'');* R22 AUTO CONVERSION
...
R.REDO.ACCT.MRKWOF.HIST<REDO.WH.WOF.CHANGE.DATE> = AA.Framework.getC_aalocactivityeffdate() ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
R.REDO.ACCT.MRKWOF.HIST<REDO.WH.CURRENCY> = AA.Framework.getC_aalocarrangementrec()<AA.Framework.Arrangement.ArrCurrency>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
Y.AC.ID = AA.Framework.getC_aalocarrangementrec()<AA.Framework.ArrangementSim.ArrLinkedApplId>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
*Y.AC.ID = c_aalocArrangementRec<AA.ARR.LINKED.APPL.ID>
R.REDO.ACCT.MRKWOF.HIST<REDO.WH.PRODUCT> = AA.Framework.getC_aalocarrangementrec()<AA.Framework.Arrangement.ArrProduct>  ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
Y.AC.ID = AA.Framework.getC_aalocarrangementrec()<AA.Framework.ArrangementSim.ArrLinkedApplId>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
CALL F.READU(FN.REDO.AA.NAB.HISTORY,Y.AA.ID,R.REDO.AA.NAB.HISTORY,F.REDO.AA.NAB.HISTORY,HIS.NAB.ERR,'');* R22 AUTO CONVERSION
...
R.REDO.AA.NAB.HISTORY<REDO.NAB.HIST.WOF.DATE> = AA.Framework.getC_aalocactivityeffdate()    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
AA.Framework.GetPeriodBalances(Y.AC.ID, BALANCE.TO.CHECK, DATE.OPTIONS, EFFECTIVE.DATE, "", "", BAL.DETAILS, "");* R22 AUTO CONVERSION

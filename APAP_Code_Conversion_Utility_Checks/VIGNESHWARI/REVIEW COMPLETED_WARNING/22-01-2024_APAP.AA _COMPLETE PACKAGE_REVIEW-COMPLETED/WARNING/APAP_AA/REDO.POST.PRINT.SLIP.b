* @ValidationCode : MjoxNDgzODg1MTM5OkNwMTI1MjoxNzA0MzcxMjAwNzU4OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:56:40
...
*04-01-2024	VIGNESHWARI		R22 AUTO CONVERSION	   VARIABLE IS HARDCODED
*-------------------------------------------------------------------------------------
*----------------------------------------------------------------------------------
...
CALL F.READ(FN.REDO.RATE.CHANGE.MESSAGE,IDVAR.1,R.MESSAGE.EMAIL,F.REDO.RATE.CHANGE.MESSAGE,MSG.ERR);* R22 AUTO CONVERSION
*CALL F.READ(FN.REDO.RATE.CHANGE.MESSAGE,'ARCIB',R.MESSAGE.ARCIB,F.REDO.RATE.CHANGE.MESSAGE,MSG.ERR)
IDVAR.1 = 'ARCIB' ;* R22 AUTO CONVERSION
CALL F.READ(FN.REDO.RATE.CHANGE.MESSAGE,IDVAR.1,R.MESSAGE.ARCIB,F.REDO.RATE.CHANGE.MESSAGE,MSG.ERR);* R22 AUTO CONVERSION
...
CALL CACHE.READ(FN.REDO.APAP.PARAM.EMAIL,IDVAR.1,R.EMAIL,MAIL.ERR);* R22 AUTO CONVERSION
...
IDVAR.1 = 'SYSTEM' ;* R22 AUTO CONVERSION
CALL CACHE.READ(FN.REDO.ISSUE.EMAIL,IDVAR.1,R.REDO.ISSUE.EMAIL,MAIL.ERR);* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.NOTIFY.RATE.CHANGE,Y.ARR.ID,R.ARR,F.REDO.NOTIFY.RATE.CHANGE,NOT.ERR,'');* R22 AUTO CONVERSION

* @ValidationCode : MjoxMDkyNTc4ODg3OkNwMTI1MjoxNzA0NzA0MjMzNzYyOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 08 Jan 2024 14:27:13
...
*08-01-2024         VIGNESHWARI             R22 MANUAL CODE CONVERSION  VARIABLE IS HARDCODED
* ----------------------------------------------------------------------------------
$INSERT I_COMMON
$INSERT I_EQUATE
...
CALL CACHE.READ(FN.CREDIT.LIMIT.MAINTENANCE,IDVAR.1,R.CRD.LIM.MAIN,CRD.ERR);* R22 AUTO CONVERSION
...
IDVAR.1 = 'SYSTEM' ;* R22 AUTO CONVERSION
CALL F.WRITE(FN.CREDIT.LIMIT.MAINTENANCE,IDVAR.1,R.CRD.LIM.MAIN);* R22 AUTO CONVERSION
END
RETURN
*-----------------------------------------------------------------
IND.AVAIL.AMT:

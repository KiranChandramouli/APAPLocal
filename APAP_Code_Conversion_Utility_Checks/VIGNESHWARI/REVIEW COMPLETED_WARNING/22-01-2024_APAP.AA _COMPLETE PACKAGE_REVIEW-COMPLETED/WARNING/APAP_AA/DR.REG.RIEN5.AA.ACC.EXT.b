* @ValidationCode : MjotODA1MzEwMjYxOkNwMTI1MjoxNzAzMjQ4MTc1NTQxOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Dec 2023 17:59:35
...
* 22-12-2023         VIGNESHWARI           R22 Manual Code Conversion      CALL RTN MODIFIED,CHANGES AA.FRAMEWORK
...
*        YARR.STATUS = R.AA.ARRANGEMENT<AA.ARR.ARR.STATUS>
  ;*R22 Manual Code Conversion-CHANGES AA.FRAMEWORK-START      
        ...
        YACCOUNT.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId>
        YSTART.DTE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrStartDate>
        YARR.STATUS = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrArrStatus>
...
*        CALL AA.GET.PERIOD.BALANCES(YACCOUNT.ID, BALANCE.TO.CHECK,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE)
        AA.Framework.GetPeriodBalances(YACCOUNT.ID, BALANCE.TO.CHECK,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE);*R22 Manual Code Conversion- CALL RTN MODIFIED
...
*   CALL AA.GET.ARRANGEMENT.CONDITIONS(ARRANGEMENT.ID, idPropertyClass, idProperty, effectiveDate, returnIds, returnConditions, returnError)
    AA.Framework.GetArrangementConditions(ARRANGEMENT.ID, idPropertyClass, idProperty, effectiveDate, returnIds, returnConditions, returnError);*R22 Manual Code Conversion- CALL RTN MODIFIED

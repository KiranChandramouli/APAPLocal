* @ValidationCode : MjoyMDQ4MDM0ODIzOkNwMTI1MjoxNzA0MjY2MjQ4MjA5OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 Jan 2024 12:47:28
...
R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(Y.ARR.ID, AA.ERR) ;* R22 MANUAL CONVERSION-AA.FRAMEWORK IS CHANGED
...
;* R22 MANUAL CONVERSION-AA.FRAMEWORK IS CHANGED-START
LOAN.PORTFOLIO.VAL<-1> = R.AA.ARRANGEMENT< AA.Framework.ArrangementSim.ArrProductGroup>
LOAN.PRODUCT.VAL<-1> = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct>
LOAN.STATUS.VAL<-1> = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrArrStatus>

* @ValidationCode : MjotMTQxNTA0MDMxOTpDcDEyNTI6MTcwNDI2MDk3NDk5MDp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 Jan 2024 11:19:34
...
FN.AA.BILL.DETAILS = "F.AA.BILL.DETAILS";* R22 AUTO CONVERSION
F.AA.BILL.DETAILS = ""
CALL OPF(FN.AA.BILL.DETAILS,F.AA.BILL.DETAILS) ;*R22 MANUAL CONVERSION -OPF IS ADDED
CALL F.READ(FN.AA.BILL.DETAILS, BILL.ID, R.AA.BILLS, F.AA.BILLS, RET.ERR);* R22 AUTO CONVERSION
END
*
IF R.AA.BILLS THEN

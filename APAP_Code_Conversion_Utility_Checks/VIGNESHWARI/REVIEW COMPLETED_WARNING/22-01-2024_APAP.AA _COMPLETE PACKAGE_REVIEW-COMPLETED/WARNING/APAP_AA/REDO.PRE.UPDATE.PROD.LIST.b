* @ValidationCode : MjotMTgxOTY4NTA4MDpDcDEyNTI6MTcwNDQzODA0MTg2NTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jan 2024 12:30:41
...
*05-01-2024	VIGNESHWARI S          R22 AUTO CONVERSION 			CHANGE F.READ TO F.READU
*----------------------------------------------------------------------------------------
$INSERT I_EQUATE
$INSERT I_COMMON
$INSERT I_F.ACCOUNT
...
CALL F.READU(FN.CUST.PRD.LIST,Y.CUSTOMER.ID,R.CUST.PRD.LIST,F.CUST.PRD.LIST,CUS.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.CUST.PRD.LIST,Y.OTHER.PARTY.ID,R.CUST.PRD.LIST,F.CUST.PRD.LIST,CUS.ERR,'');* R22 AUTO CONVERSION

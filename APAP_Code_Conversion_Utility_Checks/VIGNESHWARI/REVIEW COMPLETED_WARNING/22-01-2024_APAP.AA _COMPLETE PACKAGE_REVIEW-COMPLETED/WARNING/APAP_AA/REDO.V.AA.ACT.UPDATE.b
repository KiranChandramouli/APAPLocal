* @ValidationCode : MjotMzYxNzI5MzY0OkNwMTI1MjoxNzA0Njk2OTc3MTk2OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 08 Jan 2024 12:26:17
...
* 01-01-2024 S Vigneshwari R22 Manual Conversion -   CHANGED "FN.AA.ACTIITY.HISTORY" TO "FN.AA.ACTIITY.HISTORY"
*08-01-2024	VIGNESHWARI  R22 AUTO CONVERSION - CHANGE F.READ TO F.READU
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_System
...
*-------
    ...
    *CALL F.READ(FN.AA.ACTIITY.HISTORY, Y.ARR.ID, R.AA.ACTIVITY.HISTORY, F.AA.ACTIVITY.HISTORY, AA.HIS.ERR)
    CALL F.READ(FN.AA.ACTIITY.HISTORY, Y.ARR.ID, R.AA.ACTIVITY.HISTORY, F.AA.ACTIVITY.HISTORY, AA.HIS.ERR) ;*R22 MANUAL CODE CONVERSION-CHANGED "FN.AA.ACTIITY.HISTORY" TO "FN.AA.ACTIITY.HISTORY"

* @ValidationCode : MjoxOTE2OTc1NDAzOkNwMTI1MjoxNzA0MjY0ODg0MTY1OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 Jan 2024 12:24:44
...
Y.AA.REQUEST<AA.Framework.ArrangementActivity.ArrActArrangement> = Y.AA.ID
Y.AA.REQUEST<AA.Framework.SimulationCapture.ArrActEffectiveDate> = TODAY
Y.AA.REQUEST<AA.Framework.RrControl.ArrActActivity> = 'LENDING-UPDATE-COMMITMENT'   ;* 'LENDING-CHANGE.TERM-COMMITMENT'
Y.AA.REQUEST<AA.Framework.RrControl.ArrActProperty,-1> = AA.PROPERTY
...
CALL F.READU(FN.COLLATERAL,Y.ID.COLLATERAL,R.COLLATERAL,F.COLLATERAL,Y.ERR,'');* R22 AUTO CONVERSION
...
;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED -START
* PACS00308600 - E
Y.AA.REQUEST<AA.Framework.RrControl.ArrActFieldName,1,-1>  = Y.FIELD:":":I.COLL.CNT:':1'
Y.AA.REQUEST<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = Y.AA.COL.IDS<1,I.COLL.CNT>
* Collateral amount
Y.AA.REQUEST<AA.Framework.RrControl.ArrActFieldName,1,-1>  = Y.FIELD.COL.AMOUNT:":":I.COLL.CNT:':1'
Y.AA.REQUEST<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = Y.AA.COL.AMT<1,I.COLL.CNT>
* PACS00307565 - S
* AA Balance amount
Y.AA.REQUEST<AA.Framework.RrControl.ArrActFieldName,1,-1>  = Y.FIELD.COL.VALAMT:":":I.COLL.CNT:':1'
Y.AA.REQUEST<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = Y.AA.COL.AVAMT<1,I.COLL.CNT>
* PACS00307565 - E
* description field
Y.AA.REQUEST<AA.Framework.RrControl.ArrActFieldName,1,-1>  = Y.FIELD.COL.DESC:":":I.COLL.CNT:':1'
Y.AA.REQUEST<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = Y.AA.COL.DESC<1,I.COLL.CNT>
;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED -END
...
;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED -START
Y.AA.REQUEST< AA.Framework.RrControl.ArrActFieldName,1,-1>  = Y.FIELD:":":I.COLL.CNT:':1'
Y.AA.REQUEST<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = 'NULL'
* Collateral amount
Y.AA.REQUEST< AA.Framework.RrControl.ArrActFieldName,1,-1>  = Y.FIELD.COL.AMOUNT:":":I.COLL.CNT:':1'
Y.AA.REQUEST<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = 'NULL'
* PACS00307565 - S

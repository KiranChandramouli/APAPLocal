* @ValidationCode : MjotNjQxNjU3MjE5OkNwMTI1MjoxNzA0MjYyMzE0MzA2OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 Jan 2024 11:41:54
...
*02-01-2024          VIGNESHWARI S                    R22 MANUAL CONVERSION             CALL RTN MODIFIED
*-----------------------------------------------------------------------------
...
********
  ...
  *  CALL F.READ(FN.AA.ACTIVITY.HISTORY,Y.ARR.ID,R.AA.ACTIVITY.HISTORY,F.AA.ACTIVITY.HISTORY,ERR.AA.ACTIVITY.HISTORY)
   R.AA.ACTIVITY.HISTORY = AA.Framework.ActivityHistory.Read(Y.ARR.ID, ERR.AA.ACTIVITY.HISTORY)  ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
*    YACT.RECS = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY>
*    YACT.IDR = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY.REF>
    
        YACT.RECS = R.AA.ACTIVITY.HISTORY< AA.Framework.ActivityHistoryHist.AhActivity> ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
    YACT.IDR = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistory.AhActivityRef> ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
  ...
  *  YACT.REF.BAL = R.AA.ACT.BAL<AA.ACT.BAL.ACTIVITY.REF>
   YACT.REF.BAL = R.AA.ACT.BAL<AA.Framework.ActivityBalances.ActBalActivityRef>  ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
    YTMP.CNT = 0
    LOOP
...
***************
    ...
    WHILE BALANCE.NAME:B.POSN
      ...
      *  CALL AA.GET.PERIOD.BALANCES(YACCT.ID, BALANCE.NAME, VALUE.TRADE, Y.DISBURSE.DATE, Y.DISBURSE.DATE, "", BAL.DETS, ERR.PROCESS)
        AA.Framework.GetPeriodBalances(YACCT.ID, BALANCE.NAME, VALUE.TRADE, Y.DISBURSE.DATE, Y.DISBURSE.DATE, "", BAL.DETS, ERR.PROCESS) ;*R22 MANUAL CODE CONVERSION-CALL RTN MODIFIED
...
*        Y.PROPS.AMTS = R.AA.ACT.BAL<AA.ACT.BAL.PROPERTY.AMT,POS.AAA>
    ...
    Y.PROPS = R.AA.ACT.BAL<AA.Framework.ActivityBalances.ActBalProperty,POS.AAA>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
   Y.PROPS.AMTS = R.AA.ACT.BAL<AA.Framework.ActivityBalances.ActBalPropertyAmt,POS.AAA>   ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
*****************
   ...
   * CALL F.READ(FN.AA.ARRANGEMENT,Y.ARR.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,ERR.AA.ARRANGEMENT)
     R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(Y.ARR.ID, ERR.AA.ARRANGEMENT);*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED

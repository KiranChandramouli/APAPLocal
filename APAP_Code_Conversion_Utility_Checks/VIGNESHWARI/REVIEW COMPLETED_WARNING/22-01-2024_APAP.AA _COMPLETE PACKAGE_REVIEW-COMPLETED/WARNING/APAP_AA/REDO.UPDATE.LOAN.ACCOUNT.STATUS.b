* @ValidationCode : MjoxNjUxODE1NTYxOkNwMTI1MjoxNzA0NDQyMjE0ODE5OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:40:14
...
*05-01-2024      VIGNESHWARI S   	R22 AUTO Code Conversion        CHANGED "F.READ" TO "F.READU"
*---------------------------------------------------------------------------------------------------------------------------
*
...
CALL F.READU(FN.REDO.AA.LOAN.UPD.STATUS,Y.ARR.ID,R.REDO.AA.LOAN.UPD.STATUS,F.REDO.AA.LOAN.UPD.STATUS,Y.ER.RES,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.AA.NAB.HISTORY,Y.ARR.ID,R.REDO.AA.NAB.HISTORY,F.REDO.AA.NAB.HISTORY,HIS.ERR,'');* R22 AUTO CONVERSION

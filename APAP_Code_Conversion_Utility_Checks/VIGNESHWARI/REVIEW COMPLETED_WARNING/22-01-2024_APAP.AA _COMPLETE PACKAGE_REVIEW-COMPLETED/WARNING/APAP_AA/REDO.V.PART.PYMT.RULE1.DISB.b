* @ValidationCode : MjoyNTk1Mzk1NzU6Q3AxMjUyOjE3MDQ3MDMwMjE3MDQ6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 08 Jan 2024 14:07:01
...
*08-01-2024         VIGNESHWARI S      R22 MANUAL CODE CONVERSION       AA.FRAMEWORK IS CHANGED
*-----------------------------------------------------------------------------------
$INSERT I_COMMON
$INSERT I_EQUATE
...
AA.Framework.GetPeriodBalances(ACCOUNT.ID, BALANCE.TO.CHECK, DATE.OPTIONS, EFFECTIVE.DATE, "", "", BAL.DETAILS, "");* R22 AUTO CONVERSION

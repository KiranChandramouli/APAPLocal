* @ValidationCode : Mjo2MDI1NDMyNTQ6Q3AxMjUyOjE3MDQ0NDIxNzg2OTI6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:39:38
...
*05-01-2024      VIGNESHWARI S   	R22 AUTO Code Conversion        VARIABLE IS HARDCODED,CHANGED "F.READ" TO "F.READU"
*
*********************************************************************************************************
$INSERT I_COMMON
$INSERT I_EQUATE
...
CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,IDVAR.1,R.REDO.APAP.CLEAR.PARAM,CLR.PAR.ERR);* R22 AUTO CONVERSION
...
APAP.AA.redoAaUpdateOverdueStatus(ARR.ID) ;*R22 MANUAL CONVERSION
END

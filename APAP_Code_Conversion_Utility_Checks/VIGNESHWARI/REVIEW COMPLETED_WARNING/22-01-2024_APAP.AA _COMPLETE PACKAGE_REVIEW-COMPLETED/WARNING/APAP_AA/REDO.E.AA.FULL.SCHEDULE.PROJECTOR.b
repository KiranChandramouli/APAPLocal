...
*03-01-2024	     VIGNESHWARI S			MANUAL R22 CODE CONVERSION		VARIABLE IS HARDCODED	
*------------------------------------------------------------------------
*
$INSERT I_COMMON
$INSERT I_EQUATE
...
CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,IDVAR.1,R.REDO.H.AA.DIS.CHG,F.REDO.H.AA.DIS.CHG);* R22 AUTO CONVERSION

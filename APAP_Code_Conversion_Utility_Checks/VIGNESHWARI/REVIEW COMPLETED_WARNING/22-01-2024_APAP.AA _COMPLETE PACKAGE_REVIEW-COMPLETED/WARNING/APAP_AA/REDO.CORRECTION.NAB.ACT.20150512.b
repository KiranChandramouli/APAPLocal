* @ValidationCode : MjotNDgzODY2Njc3OkNwMTI1MjoxNzA0MjAwMzk2NDgzOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 02 Jan 2024 18:29:56
...
* 02-01-2024      VIGNESHWARI               R22 AUTO Conversion - CALL RTN MODIFIED, CHANGE F.READ TO F.READU
*------------------------------------------------------------------------
$INSERT I_COMMON
$INSERT I_EQUATE
$INSERT I_GTS.COMMON
...
CALL F.READU(FN.REDO.AA.NAB.HISTORY,Y.AA.ID,R.NAB.HISTORY.REC,F.REDO.AA.NAB.HISTORY,HIST.ERR,'');* R22 AUTO CONVERSION

* @ValidationCode : MjotNTc5ODg4NTM0OkNwMTI1MjoxNzAzNzY4NDk2MjQ4OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Dec 2023 18:31:36
...
*28-12-2023       VIGNESHWARI S      R22 MANUAL CONVERSTION -VARIABLE IS HARDCODED
*----------------------------------------------------------------------------------------------------------------------------
*
...
OPEN.FILES:
   ...
   * CALL F.READ(FN.REDO.LOAN.ACCOUNT.STATUS,'Write-off',R.REDO.LOAN.ACCOUNT.STATUS,F.REDO.LOAN.ACCOUNT.STATUS,AC.LOAN.ERR)
    VAL.ID='Write-off'
    CALL F.READ(FN.REDO.LOAN.ACCOUNT.STATUS,VAL.ID,R.REDO.LOAN.ACCOUNT.STATUS,F.REDO.LOAN.ACCOUNT.STATUS,AC.LOAN.ERR) ;*R22 MANUAL CONVERSTION-VARIABLE IS HARDCODED
   ...
   * CALL F.READ(FN.REDO.LOAN.ACCOUNT.STATUS,'JudicialCollection',R.REDO.LOAN.ACCOUNT.STATUS,F.REDO.LOAN.ACCOUNT.STATUS,AC.LOAN.ERR)
   VAL.VAR='JudicialCollection'
   CALL F.READ(FN.REDO.LOAN.ACCOUNT.STATUS,VAL.VAR,R.REDO.LOAN.ACCOUNT.STATUS,F.REDO.LOAN.ACCOUNT.STATUS,AC.LOAN.ERR) ;*R22 MANUAL CONVERSTION-VARIABLE IS HARDCODED

* @ValidationCode : MjoxODc4NTQxMDg3OkNwMTI1MjoxNzAzNTczNTI3OTU3OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 12:22:07
...
* 26-12-2023     VIGNESHWARI S     R22 MANUAL CONVERSTION   VARIABLE IS HARDCODED, call rtn modified
* ------------------------------------------------------------------
...
PROCESS:
   * CALL CACHE.READ(FN.REDO.L.NCF.STOCK,'SYSTEM',R.NCF.STOCK,ST.ERR)
    VAR.VAL='SYSTEM'    ;*R22 MANUAL CONVERSTION-VARIABLE IS HARDECODED
    CALL CACHE.READ(FN.REDO.L.NCF.STOCK,VAR.VAL,R.NCF.STOCK,ST.ERR)
...
*-------------
    ...
    END
    *CALL JOURNAL.UPDATE('')
    EB.TransactionControl.JournalUpdate('');*R22 MANUAL CONVERSTION -CALL RTN MODIFIED
RETURN
END

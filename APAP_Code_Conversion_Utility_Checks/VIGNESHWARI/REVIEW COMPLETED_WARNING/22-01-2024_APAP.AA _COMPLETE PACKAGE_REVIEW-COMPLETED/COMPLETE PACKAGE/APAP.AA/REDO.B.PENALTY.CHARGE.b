* @ValidationCode : MjoxODEyOTkxMjYwOkNwMTI1MjoxNzAzNzYzMTQ4NDMyOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Dec 2023 17:02:28
...
*28-12-2023       VIGNESHWARI S      R22 MANUAL CONVERSTION - CHANGED F.READ TO F.READU
*------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
 ...
 *   CALL F.READ(FN.REDO.CONCAT.PENALTY.CHARGE,ARR.ID,R.REDO.CONCAT.PENALTY.CHARGE,F.REDO.CONCAT.PENALTY.CHARGE,CNCT.ERR)
  CALL F.READU(FN.REDO.CONCAT.PENALTY.CHARGE,ARR.ID,R.REDO.CONCAT.PENALTY.CHARGE,F.REDO.CONCAT.PENALTY.CHARGE,CNCT.ERR,"");*R22 MANUAL CONVERSTION - CHANGE F.READ TO F.READU

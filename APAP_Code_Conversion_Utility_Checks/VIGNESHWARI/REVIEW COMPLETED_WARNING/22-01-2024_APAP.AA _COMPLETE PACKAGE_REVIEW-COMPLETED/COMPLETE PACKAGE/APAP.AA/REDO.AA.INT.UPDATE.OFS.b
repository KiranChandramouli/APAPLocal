* @ValidationCode : MjotMTgwNTcxODgxMjpDcDEyNTI6MTcwMzU3MjA3Nzc0MDp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Dec 2023 11:57:57
...
* 26-12-2023          VIGNESHWARI S         R22 MANUAL CONVERSTION -CHANGE F.READ TO F.READU
*
*----------------------------------------------------------------------------
...
*---------------------------------------------------------------------------------
   ...
   * CALL F.READ(FN.REDO.AA.OFS.FAIL,TODAY,R.OFS.FAIL,F.REDO.AA.OFS.FAIL,OFS.FAIL.ERR)
   CALL F.READU(FN.REDO.AA.OFS.FAIL,TODAY,R.OFS.FAIL,F.REDO.AA.OFS.FAIL,OFS.FAIL.ERR,"");*R22 MANUAL CONVERSTION -CHANGE F.READ TO F.READU

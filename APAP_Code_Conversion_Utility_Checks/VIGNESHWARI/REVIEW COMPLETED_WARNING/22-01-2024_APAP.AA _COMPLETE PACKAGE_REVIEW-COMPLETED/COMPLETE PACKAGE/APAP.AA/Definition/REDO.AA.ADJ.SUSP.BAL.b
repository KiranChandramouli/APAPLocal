* @ValidationCode : Mjo2MTE1Mzg5MDE6Q3AxMjUyOjE3MDMyNTE5NjE4MjA6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Dec 2023 19:02:41
        ...
        IF Y.TRANSACTION.TYPE EQ 'ACUN' AND ARR.ID THEN
            ...
            IF Y.REPAY.REF[1,2] EQ 'FT' THEN
                *CALL F.READ(FN.REDO.AA.REVERSE.REPAY,ARR.ID,R.REDO.AA.REVERSE.REPAY,F.REDO.AA.REVERSE.REPAY,REVERSE.ERR)
                 CALL F.READU(FN.REDO.AA.REVERSE.REPAY,ARR.ID,R.REDO.AA.REVERSE.REPAY,F.REDO.AA.REVERSE.REPAY,REVERSE.ERR,"") ;*R22 MANUAL CODE CONVERSION-F.READ TO F.READU

* @ValidationCode : MjoxOTY2Mzc4MDkwOkNwMTI1MjoxNzA0MjY0OTc1NTczOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 Jan 2024 12:26:15
...
*03-01-2024	VIGNESHWARI S	     MANUAL R22 CODE CONVERSION		Call rtn modified	
*   ==================================================================
...
AA.Framework.GetPeriodBalances(IN.ACCT.ID,BALANCE.ID,REQUEST.TYPE,ST.DATE,END.DATE,SYSTEM.DATE,BAL.DETAILS,YERR.BAL);* R22 AUTO CONVERSION

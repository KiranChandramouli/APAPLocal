* @ValidationCode : Mjo2NDIzNjc3MzY6Q3AxMjUyOjE3MDM3NjMzNzEzNDk6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 28 Dec 2023 17:06:11
 ...
 *   CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,'SYSTEM',R.REDO.H.AA.DIS.CHG,CHG.ERR)
 VAL.VAR = 'SYSTEM'
   CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,VAL.VAR,R.REDO.H.AA.DIS.CHG,CHG.ERR) ;*R22 MANUAL CONVERSTION - VARIABLE IS HARDCODED

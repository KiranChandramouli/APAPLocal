* @ValidationCode : MjotMzQ2OTI0ODg0OkNwMTI1MjoxNzAzMjAxMzc5NTM1OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Dec 2023 04:59:39
...
*21-12-2023              VIGNESHWARI                MANUAL R22 CODE CONVERSION              OPF IS CALL
*------------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*-----------------------------------------
    ...
    CALL OPF(FN.REDO.APAP.PROPERTY.PARAM,F.REDO.APAP.PROPERTY.PARAM)    ;*MANUAL R22 CODE CONVERSION -OPF IS CALL

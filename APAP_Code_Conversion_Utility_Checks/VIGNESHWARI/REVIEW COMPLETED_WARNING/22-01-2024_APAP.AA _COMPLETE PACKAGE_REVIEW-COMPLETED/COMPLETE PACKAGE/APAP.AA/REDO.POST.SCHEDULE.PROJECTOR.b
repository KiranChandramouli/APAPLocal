* @ValidationCode : MjoxMzE1MTI3NTg0OkNwMTI1MjoxNzA0MzczMzAwMzc2OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 18:31:40
...
*04-01-2024	VIGNESHWARI		R22 AUTO CONVERSION	   		CHANGE F.READ TO F.READU
*---------------------------------------------------------------------------------------------
...
CALL F.READU(FN.REDO.B.PENDING.SCH.PROJECTOR.LIST,Y.UNIQUE.KEY,R.RECORD.LIST,F.REDO.B.PENDING.SCH.PROJECTOR.LIST,PROJ.ERR,'');* R22 AUTO CONVERSION

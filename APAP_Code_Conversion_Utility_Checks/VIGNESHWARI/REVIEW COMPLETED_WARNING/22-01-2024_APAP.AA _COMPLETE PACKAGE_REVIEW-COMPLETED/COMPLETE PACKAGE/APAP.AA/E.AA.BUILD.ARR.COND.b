* @ValidationCode : MjoxMDc1NTMyOTg0OkNwMTI1MjoxNzAzMjQ4NzEzMzQ5OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Dec 2023 18:08:33
...
*19/12/2023         Arun               R22 Manual Conversion             Added OPF and Changed F.READ
*22-12-2023         VIGNESHWARI                         R22 MANUAL CODE CONVERSION    FN VARIABLE IS HARDCODED,OPF IS CALL
*
...
****************************
    ...
    BEGIN CASE
        CASE ENQ$SIM.REF AND INDEX(FILE.VERSION,"SIM",1)
            ...
            SIM.REF = ENQ$SIM.REF
            FN.AA.SIM="F.AA.SIMULATION.RUNNER"  ;*R22 MANUAL CODE CONVERSION-FN VARIABLE IS HARDCODED
            F.AA.SIM=""
            CALL OPF(FN.AA.SIM,F.AA.SIM)    ;*R22 MANUAL CODE CONVERSION-OPF IS CALL
            CALL F.READ(FN.AA.SIM, SIM.REF, R.SIM, F.AA.SIM, RET.ERR)   
...
*
    ...
    BEGIN CASE
        ...
        CASE 1
*MANUAL R22 CODE CONVERSION_Start
...
*MANUAL R22 CODE CONVERSION_End
    END CASE

* @ValidationCode : Mjo1MzE2MTA0NjE6Q3AxMjUyOjE3MDQyNjI1MjczMjM6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 Jan 2024 11:45:27
...
CALL F.READU(FN.COLLATERAL,PAY.COLL.ID<1,Y.VAR>,R.COLLATERAL,F.COLLATERAL,ERR.CO,'');* R22 AUTO CONVERSION
...
CALL OPF(FN.REDO.FC.CL.BALANCE,F.REDO.FC.CL.BALANCE) ;*R22 MANUAL CODE CONVERSION-OPF IS ADDED
R.COLLATERAL = ""
FN.COLLATERAL = "F.COLLATERAL"
F.COLLATERAL = ""
CALL OPF(FN.COLLATERAL,F.COLLATERAL) ;*R22 MANUAL CODE CONVERSION-OPF IS ADDED

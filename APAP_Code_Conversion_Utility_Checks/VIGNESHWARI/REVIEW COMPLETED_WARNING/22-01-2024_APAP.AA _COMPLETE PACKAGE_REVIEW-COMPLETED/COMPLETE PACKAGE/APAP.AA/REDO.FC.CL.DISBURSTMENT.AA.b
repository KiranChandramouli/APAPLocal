...
*02-01-2024	     Vigneshwari		       MANUAL R22 CODE CONVERSTION	   change f.read to f.readu, Changed <= to LE
...
CALL F.READU(FN.REDO.FC.CL.BALANCE,DES.AA.ID,R.REDO.FC.CL.BALANCE,F.REDO.FC.CL.BALANCE,ERR.MSJ,'');* R22 AUTO CONVERSION
...
IF DES.AMOUNT.BALANCE LE DES.AMOUNT.OG THEN ; *AUTO R22 CODE CONVERSION LE to LE;* R22 AUTO CONVERSION

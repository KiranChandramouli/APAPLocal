* @ValidationCode : MjotMTU1MTUyNTY5NTpDcDEyNTI6MTcwNDQzNzc4MzEzNTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jan 2024 12:26:23
...
*05-01-2024	vigneshwari		R22 AUTO CONVERSION			CHANGED F.READ TO F.READU
*-------------------------------------------------------------------------------------------
$INSERT I_COMMON
$INSERT I_EQUATE
...
CALL F.READU(FN.AA.BILL.DETAILS,Y.BILL.ID,R.BILL.DETAILS,F.AA.BILL.DETAILS,BILL.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.AA.BILL.DETAILS,BILL,R.BILL,F.AA.BILL.DETAILS,BILL.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.CONCAT.PENALTY.CHARGE,ARR.ID,R.REDO.CONCAT.PENALTY.CHARGE,F.REDO.CONCAT.PENALTY.CHARGE,CNCT.PEN.ERR,'');* R22 AUTO CONVERSION

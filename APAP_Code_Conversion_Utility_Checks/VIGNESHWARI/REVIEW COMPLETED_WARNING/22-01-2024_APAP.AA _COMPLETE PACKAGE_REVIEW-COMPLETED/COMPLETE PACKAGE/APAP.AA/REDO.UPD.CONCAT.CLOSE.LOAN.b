* @ValidationCode : MjotMTU0MTMxNzg4OkNwMTI1MjoxNzA0NDQxMTQ3MDQyOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:22:27
...
*05-01-2024	VIGNESHWARI		R22 AUTO CODE CONVERSION    VARIABLE IS HARDCODED
*------------------------------------------------------------------------
$INSERT I_COMMON
$INSERT I_EQUATE
...
CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,IDVAR.1,R.REDO.APAP.CLEAR.PARAM,PARA.ERR);* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.CONCAT.AA.CLOSURE.DAYS,Y.EFF.DATE,R.REDO.CONCAT.AA.CLOSURE.DAYS,F.REDO.CONCAT.AA.CLOSURE.DAYS,CNCT.ERR,'');* R22 AUTO CONVERSION

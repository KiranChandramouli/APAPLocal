* @ValidationCode : MjotMTU4MDE3NTA0NjpDcDEyNTI6MTcwNDcwMzk0MzM3OTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 08 Jan 2024 14:22:23
...
*08-01-2024         VIGNESHWARI             R22 MANUAL CODE CONVERSION  CHANGED "FN.AA.ARRANGMENT" TO "FN.AA.ARRANGEMENT" , CHANGED F.READ TO F.READU
*------------------------------------------------------------------------------------------------------------------
*
$INSERT I_COMMON
$INSERT I_EQUATE
...
CALL F.READU(FN.REDO.H.POLICY.NUMBER,VAR.INS.POL.TYPE,R.REDO.H.POLICY.NUMBER,F.REDO.H.POLICY.NUMBER,Y.REDO.POL.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READ(FN.AA.ARRANGEMENT,ARR.ID,R.AA.ARRANGMENT,F.AA.ARRANGMENT,E.AA.ARRANGMENT)            ;*R22 MANUAL CODE CONVERSION- CHANGED "FN.AA.ARRANGMENT" TO "FN.AA.ARRANGEMENT"

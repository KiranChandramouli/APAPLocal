* @ValidationCode : MjotOTgwNjc0MjMwOkNwMTI1MjoxNzAzNzYyNzUwNDAzOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Dec 2023 16:55:50
...
OPENFILES:
  ...
  *  CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,'SYSTEM',R.REDO.H.AA.DIS.CHG,PROP.PARAM.ERR)
  VAL.VAR = 'SYSTEM'
  CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,VAL.VAR,R.REDO.H.AA.DIS.CHG,PROP.PARAM.ERR) ;*R22 MANUAL CONVERSTION - VARIABLE IS HARDCODED

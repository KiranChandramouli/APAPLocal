* @ValidationCode : MjoxNTU2NDYyMzgyOkNwMTI1MjoxNzAzNzY3ODg3ODYwOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Dec 2023 18:21:27
...
*28-12-2023       VIGNESHWARI S      R22 MANUAL CONVERSTION -CALL RTN MODIFIED, AA.FRAMEWORK IS CHANGED
*--------------------------------------------------------------------------------------------------------
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
 *   $INSERT I_AA.LOCAL.COMMON
  *  $INSERT I_F.AA.ARRANGEMENT.ACTIVITY
   ...
   * VAR.STATUS = c_aalocActivityStatus
    VAR.STATUS = AA.Framework.getC_aalocactivitystatus();*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
*-------------------------------------------------------------------------------
   ...
   *     CALL AA.GET.PERIOD.BALANCES (Y.ACC.ID, Y.BAL, REQUEST.TYPE, START.DATE, END.DATE, SYSTEM.DATE, BAL.DETAILS, ERR.MSG)
    AA.Framework.GetPeriodBalances(Y.ACC.ID, Y.BAL, REQUEST.TYPE, START.DATE, END.DATE, SYSTEM.DATE, BAL.DETAILS, ERR.MSG)    ;*R22 MANUAL CODE CONVERSION-CALL RTN MODIFIED

* @ValidationCode : MjoyMDM0MTA2MzM6Q3AxMjUyOjE3MDQ0Mzk0NTkzMzM6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jan 2024 12:54:19
...
*05-01-2024     VIGNESHWARI             Manual R22 Code Conversion -  VARIABLE IS HARDCODED,AA.FRAMEWORK & EB.LocalReferences IS MODIFIED
*-------------------------------------------------------------------------------------------
...
CALL F.READ(FN.COLLATERAL,Y.COLL.ID,R.COLLATERAL,F.COLLATERAL,IDVAR.1);* R22 AUTO CONVERSION
...
EB.LocalReferences.GetLocRef ('COLLATERAL',Y.FIELD.NAME,Y.FIELD.NO);* R22 AUTO CONVERSION
...
IDVAR.1 = "" ;* R22 AUTO CONVERSION
CALL F.READ(FN.REDO.FC.ENQPARMS,Y.AA.COLL.TYPE,R.REDO.FC.ENQPARMS,F.REDO.FC.ENQPARMS,IDVAR.1);* R22 AUTO CONVERSION

* @ValidationCode : MjotMTQ2NzkzOTA4MzpDcDEyNTI6MTcwNDcwNDAwMDUxNDp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 08 Jan 2024 14:23:20
...
*----------------------------------------------------------------------------------------------------------------------------------------------
* Modification History :
*08-01-2024         VIGNESHWARI             R22 MANUAL CODE CONVERSION  $USING EB.LocalReferences IS INSERTED
*-----------------------------------------------------------------------------
*
* DATE WHO REFERENCE DESCRIPTION
...
EB.LocalReferences.GetLocRef("AA.PRD.DES.INTEREST","L.AA.INT.RT.AR",INTARR.POS);* R22 AUTO CONVERSION

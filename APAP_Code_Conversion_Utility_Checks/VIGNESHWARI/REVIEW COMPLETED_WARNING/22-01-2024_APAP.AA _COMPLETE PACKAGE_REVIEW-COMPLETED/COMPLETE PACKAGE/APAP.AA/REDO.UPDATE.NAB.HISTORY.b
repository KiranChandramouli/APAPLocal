* @ValidationCode : MjotMjA3OTE0NTE0OkNwMTI1MjoxNzA0NDU2NjExNDg3OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 17:40:11
...
** 05-01-2024                   Skanda                              R22 Manual Conversion                   CALL method format changed,AA.FRAMEWORK IS MODIFIED 
*05-01-2024      		VIGNESHWARI S   		   R22 AUTO Code Conversion        AA.FRAMEWORK COMMOMN FILE IS ADDED
*------------------------------------------------------------------------------------------------------------------------------
*
...
IF (AA.Framework.getC_aalocactivitystatus() EQ 'AUTH' OR AA.Framework.getC_aalocactivitystatus() EQ 'AUTH-REV') THEN ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
...
IF Y.NEW.STATUS EQ 'NAB' AND Y.OLD.STATUS NE 'NAB' AND AA.Framework.getC_aalocactivitystatus() EQ 'AUTH' THEN ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
...
IF Y.NEW.STATUS EQ 'NAB' AND Y.OLD.STATUS EQ 'NAB' AND  AA.Framework.getC_aalocactivitystatus() EQ 'AUTH-REV' THEN ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
*CALL F.READ(FN.REDO.AA.NAB.HISTORY,ARR.ID,R.AA.NAB.HIST,F.REDO.AA.NAB.HISTORY,HIST.ERR)
CALL F.READU(FN.REDO.AA.NAB.HISTORY,ARR.ID,R.AA.NAB.HIST,F.REDO.AA.NAB.HISTORY,HIST.ERR,'');* R22 AUTO CONVERSION
...
ARR.CURRENCY = AA.Framework.getC_aaloclinkedaccount()
...
Y.CURR.ACT.REC = AA.Framework.getC_aalocarractivityrec()    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
Y.LOCAL.REF = AA.Framework.getC_aalocarractivityrec()<AA.Framework.RrControl.ArrActFieldName>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
...
Y.LL.S = AA.Framework.getC_aalocarractivityrec()<AA.Framework.SimulationCapture.ArrActFieldValue>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
...
Y.ACCT.MAS = AA.Framework.getC_aalocmasteractivity()<1,2>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
...
IF  AA.Framework.getC_aalocactivitystatus() EQ 'AUTH' OR  AA.Framework.getC_aalocactivitystatus() EQ 'UNAUTH' THEN    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
R.NAB.HISTORY.REC = ''
...
Y.MASTER.ACT = AA.Framework.getC_aalocarractivityrec()<AA.Framework.RrControl.ArrActMasterAaa>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
...
Y.MAST.EFF.DATE = R.AAA.NAU<AA.Framework.SimulationCapture.ArrActEffectiveDate>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
...
Y.ACT.IDS = R.AAA.NAU<AA.Framework.RrControl.ArrActActivity>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
...
CALL F.READU(FN.REDO.NAB.BK.REV.REP,ARR.ID,R.REDO.NAB.BK.REV,F.REDO.NAB.BK.REV.REP,REV.ERR,'');* R22 AUTO CONVERSION
GOSUB SUB.LOOP
END
...
ACCOUNT.ID = AA.Framework.getC_aaloclinkedaccount()    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
*START.DATE = c_aalocActivityEffDate ; END.DATE = '' ; SYSTEM.DATE = ''
START.DATE = AA.Framework.getC_aalocactivityeffdate() ; END.DATE = '' ; SYSTEM.DATE = ''  ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED
REQUEST.TYPE    = ''
REQUEST.TYPE<4>  = 'ECB'
BAL.DETAILS = ''
...
;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED-start
FINDSTR 'LENDING-MAKEDUE-REPAYMENT.SCHEDULE' IN R.AA.SCH.ACT<AA.Framework.ScheduledActivity.SchActivityName,1> SETTING POS.NEX THEN
Y.NEX.BL.DATE = R.AA.SCH.ACT<AA.Framework.ScheduledActivity.SchNextDate,POS.NEX>
;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED-end
END ELSE
...
PROPERTY = ''
*EFF.DATE = c_aalocActivityEffDate
EFF.DATE = AA.Framework.getC_aalocactivityeffdate()    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS MODIFIED-start
ERR.MSG = ''
R.PAY.SCH.COND = ''

...
* 02-JAN-2024     VIGNESHWARI                R22 Manual Conversion 		F.READ TO F.READU
*------------------------------------------------------------------------
$INSERT I_COMMON
$INSERT I_EQUATE
...
CALL F.READU(FN.REDO.CONCAT.PENALTY.CHARGE,ARR.ID,R.REDO.CONCAT.PENALTY.CHARGE,F.REDO.CONCAT.PENALTY.CHARGE,PEN.CHR.ERR,'');* R22 AUTO CONVERSION

...
*02-01-2024		VIGNESHWARI			R22 AUTO CONVERSION			OPF IS CALL
*------------------------------------------------------------------------------
$INSERT I_COMMON
$INSERT I_EQUATE
...
FN.LIMIT.PARAMETER = "F.LIMIT.PARAMETER";* R22 AUTO CONVERSION
CALL CACHE.READ(FN.LIMIT.PARAMETER,"SYSTEM",YR.SYSTEM,ER);* R22 AUTO CONVERSION
IF ER THEN

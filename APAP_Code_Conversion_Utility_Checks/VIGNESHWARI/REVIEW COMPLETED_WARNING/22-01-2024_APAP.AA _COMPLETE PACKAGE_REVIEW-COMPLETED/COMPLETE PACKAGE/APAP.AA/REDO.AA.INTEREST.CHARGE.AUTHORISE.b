* @ValidationCode : MjoxNDU5OTUxODg5OkNwMTI1MjoxNzAzNTgyMjYwNzUyOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 14:47:40
...
* 26-12-2023          VIGNESHWARI S         R22 MANUAL CONVERSTION              VARIABLE IS HARDCODED,CHANGE F.READ TO F.READU
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.ACCOUNT
...
PROCESS:
    ...
    *CALL CACHE.READ(FN.REDO.L.NCF.STOCK,'SYSTEM',R.REDO.L.NCF.STOCK,ERR)
    VAR.ID='SYSTEM';*R22 MANUAL CONVERSTION -VARIABLE IS HARDCODED
    CALL CACHE.READ(FN.REDO.L.NCF.STOCK,VAR.ID,R.REDO.L.NCF.STOCK,ERR)
...
CALL F.READU(FN.REDO.NCF.ISSUED,Y.NCF.ID,R.REDO.NCF.ISSUED,F.REDO.NCF.ISSUED,ERR,"");*R22 MANUAL CONVERSTION -CHANGE F.READ TO F.READU
    CALL F.READU(FN.REDO.NCF.UNMAPPED,Y.NCF.ID,R.REDO.NCF.UNMAPPED,F.REDO.NCF.UNMAPPED,ERR,"");*R22 MANUAL CONVERSTION -CHANGE F.READ TO F.READU

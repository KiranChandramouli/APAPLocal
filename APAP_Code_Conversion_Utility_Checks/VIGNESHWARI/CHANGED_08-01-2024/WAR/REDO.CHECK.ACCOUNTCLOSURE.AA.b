* @ValidationCode : MjotMTY4MjU0NzIyMjpDcDEyNTI6MTcwMzc2NTE1Mzk5MTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 28 Dec 2023 17:35:53
...
*This part has to update the reason values to account record
  ...
  *  CALL F.READ(FN.ACCOUNT,Y.ID,R.ACCOUNT,F.ACCOUNT,ACC.ERR)
  CALL F.READU(FN.ACCOUNT,Y.ID,R.ACCOUNT,F.ACCOUNT,ACC.ERR,"")  ;*R22 MANUAL CONVERSTION - CHANGED F.READ TO F.READU
    IF R.ACCOUNT THEN

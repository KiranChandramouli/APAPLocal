* @ValidationCode : MjotNjMzMTEzMDgxOkNwMTI1MjoxNzA0NDM4NTQwMjcxOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 12:39:00
...
*05-01-2024     VIGNESHWARI S           MANUAL R22 CODE CONVERSION              OPF IS CALL
*-----------------------------------------------------------------------------------
...
*=========
    ...
    F.CUSTOMER=""
    CALL OPF(FN.CUSTOMER,FN.CUSTOMER) ;*R22 MANUAL CODE CONVERSION-OPF IS CALL
    Y.CUS.ID = AA.ID

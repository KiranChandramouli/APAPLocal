* @ValidationCode : Mjo0NTg4ODQzOTE6Q3AxMjUyOjE3MDQzNjg4MjkzNTI6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:17:09
...
IF AA.Framework.getC_aaloccurractivity() EQ 'LENDING-ADJUST.SUSP.BALANCE-MANT.SALD.CUOTA' AND AA.Framework.getC_aalocactivitystatus() EQ 'AUTH' THEN  ;*R22 MANUAL CONVERSION-AA.FRAMEWORK IS CHANGED
GOSUB INIT
GOSUB PROCESS
END
...
ACCOUNT.ID = AA.Framework.getLinkedAccount() ;*R22 MANUAL CONVERSION-AA.FRAMEWORK IS CHANGED
...
R.FT<FT.CREDIT.ACCT.NO> = AA.Framework.getLinkedAccount() ;*R22 MANUAL CONVERSION-AA.FRAMEWORK IS CHANGED

* @ValidationCode : Mjo2MDIwNjA2NTpDcDEyNTI6MTcwNDcwNTIxODMyNzp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 08 Jan 2024 14:43:38
...
* 08/01/2023         VIGNESHWARI         MANUAL R22 CODE CONVERSION   CALL RTN MODIFIED
*-------------------------------------------------------------------------------------
$INSERT I_COMMON
$INSERT I_EQUATE
...
CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,IDVAR.1,R.REDO.H.AA.DIS.CHG,CHG.ERR);* R22 AUTO CONVERSION
...
EB.Display.RefreshField(CR.FIELD,FILD.EN) ;*R22 MANUAL CODE CONVERSION-CALL RTN MODIFIED

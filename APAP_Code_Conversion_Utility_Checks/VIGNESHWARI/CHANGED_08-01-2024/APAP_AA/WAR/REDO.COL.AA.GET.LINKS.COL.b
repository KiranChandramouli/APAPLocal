* @ValidationCode : MjoxMDkzMjE2OTY2OkNwMTI1MjoxNzAzODM0MDA0OTQzOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 29 Dec 2023 12:43:24
...
*====================
    ...
    *CALL AA.GET.ARRANGEMENT.CONDITIONS(ARR.INFO,PROPERTY.CLASS,AA.PROPERTY,Y.EFFEC.DATE,returnIds,returnConditions,returnError)
    AA.Framework.GetArrangementConditions(ARR.INFO,PROPERTY.CLASS,AA.PROPERTY,Y.EFFEC.DATE,returnIds,returnConditions,returnError);*R22 MANUAL CODE CONVERSION-CALL RTN MODIFIED

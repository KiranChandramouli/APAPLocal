* @ValidationCode : MjotMTg4NzY4ODEzODpDcDEyNTI6MTcwMjg3NDg0OTcxMDp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 18 Dec 2023 10:17:29
...
*17-12-2023          VIGNESHWARI                       MANUAL R22 CODE CONVERSION           CHANGE "<Y.RECORD >" TO "<Y.RECORD>"
*
*=======================================================================
*
    $INSERT I_COMMON
...
*   HEADER
    IF Y.NUM.HEADER.TAGS.BEGIN NE 0 THEN
        ...
        Y.RECORD        = 1
        O.R.TXT.MSG<Y.RECORD>  = C.HEAD : Y.TXT.MSG : @FM   ;* MANUAL R22 CODE CONVERSION-CHANGE "<Y.RECORD >" TO "<Y.RECORD>"
    END

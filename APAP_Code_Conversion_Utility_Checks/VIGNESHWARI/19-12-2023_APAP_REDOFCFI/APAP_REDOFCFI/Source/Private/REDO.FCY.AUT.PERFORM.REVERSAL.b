* @ValidationCode : MjotMTY0NDQ0Mzg0NjpDcDEyNTI6MTcwMjY0NjQyMTMwNzp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 Dec 2023 18:50:21
...
*15-12-2023         VIGNESHWARI            R22 Manual Conversion -  VARIABLE IS ASSIGN
*----------------------------------------------------------------------------
*------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*Get the Count of Transaction Field
    ...
    ID.VAR='SYSTEM'
    CALL CACHE.READ(FN.REDO.APAP.PARAM,ID.VAR,R.REDO.APAP.PARAM,PARAM.ERR);* R22 Manual Conversion -  VARIABLE IS ASSIGN
    
    CALL CACHE.READ(FN.REDO.CLEAR.PARM,ID.VAR,R.REDO.CLEAR.PARAM,CLEAR.ERR);* R22 Manual Conversion -  VARIABLE IS ASSIGN

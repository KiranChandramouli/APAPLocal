* @ValidationCode : MjoxNDQxNDUyMjMxOkNwMTI1MjoxNzAyODgxMzY2NDUzOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 18 Dec 2023 12:06:06
...
*17-12-2023          VIGNESHWARI                     MANUAL R22 CODE CONVERSION             CHANGE F.READ TO F.CACHE.READ
*=======================================================================
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
 ...
 *       CALL F.READ(FN.REDO.INTERFACE.PARAM, FI.INTERFACE, FI.REDO.INTERFACE.PARAM, FV.REDO.INTERFACE.PARAM, Y.ERR)
 CALL F.CACHE.READ(FN.REDO.INTERFACE.PARAM, FI.INTERFACE, FI.REDO.INTERFACE.PARAM, FV.REDO.INTERFACE.PARAM, Y.ERR);*MANUAL R22 CODE CONVERSION-CHANGE F.READ TO F.CACHE.READ
        IF Y.ERR THEN
            PROCESS.GOAHEAD = 0
...
*
    ...
    END
*
    APAP.REDOFCFI.redoFiRecordControl(WERROR.MSG) ;*MANUAL R22 CODE CONVERSION
*
RETURN
*
* ======================
...
*
    ...
    APAP.REDOCHNLS.redoInterfaceRecAct(FI.INT.ACT.ID,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,ID.DESC,REC.CON,EX.USER,EX.PC) ;*MANUAL R22 CODE CONVERSION
*
RETURN
*
* =================
...
*                CALL F.READ(FN.REDO.INTERFACE.PARAM, PARAM.ID, R.REDO.INTERFACE.PARAM, FV.REDO.INTERFACE.PARAM, Y.ERR)
 CALL F.CACHE.READ(FN.REDO.INTERFACE.PARAM, PARAM.ID, R.REDO.INTERFACE.PARAM, FV.REDO.INTERFACE.PARAM, Y.ERR)     ;*MANUAL R22 CODE CONVERSION-CHANGE F.READ TO F.CACHE.READ          
                IF Y.ERR THEN
                    PROCESS.GOAHEAD = 0
...
*Locate ID.INTERFACE.LIST
            ...
            CASE LOOP.CNT EQ 4
                ...
                WHILE Y.SETPOS : PARAM.ID AND PROCESS.GOAHEAD DO
                    ...
                    APAP.REDOFCFI.redoFiGetDirList(PARAM.ID,W.ERROR) ;* MANUAL R22 CONVERSION
                    IF W.ERROR THEN
                        PROCESS.GOAHEAD = 0
                    END
                REPEAT

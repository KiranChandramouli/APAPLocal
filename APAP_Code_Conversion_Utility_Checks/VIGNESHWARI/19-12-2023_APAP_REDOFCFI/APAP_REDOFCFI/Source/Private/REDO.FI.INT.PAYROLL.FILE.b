* @ValidationCode : MjozOTA1ODIzNTE6Q3AxMjUyOjE3MDI4ODIxOTI0NTQ6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 18 Dec 2023 12:19:52
...
*17-12-2023          VIGNESHWARI                     MANUAL R22 CODE CONVERSION             VARIABLE IS ASSIGN,OPF IS CALL
*=====================================================================================================
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
ID.VAR.PARAM='SYSTEM'
    CALL CACHE.READ(FN.REDO.APAP.PARAM.EMAIL,ID.VAR.PARAM,R.EMAIL,MAIL.ERR)
    ...
    R.REDO.ISSUE.MAIL = ''
    Y.ISSUE.EMAIL.ERR = ''
    CALL OPF(FN.REDO.ISSUE.MAIL,F.REDO.ISSUE.MAIL);*   MANUAL R22 CODE CONVERSION -OPF IS CALL
    ID.VAR.MAIL='SYSTEM'
 CALL F.READ(FN.REDO.ISSUE.MAIL,ID.VAR.MAIL,R.REDO.ISSUE.MAIL,F.REDO.ISSUE.MAIL,Y.ISSUE.EMAIL.ERR) ;*Tus Start;*   MANUAL R22 CODE CONVERSION- VARIABLE IS ASSIGN

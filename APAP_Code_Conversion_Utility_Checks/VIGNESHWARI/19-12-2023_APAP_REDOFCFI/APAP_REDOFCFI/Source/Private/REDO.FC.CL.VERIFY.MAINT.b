* @ValidationCode : MjoxMzQzNzUyMzk1OkNwMTI1MjoxNzAyNTYxOTg2Mjc0OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 14 Dec 2023 19:23:06
...
*14-12-2023         VIGNESHWARI                       MANUAL R22 CODE CONVERSION        Call method format changed  
*-----------------------------------------------------------------------------
...
* =========
    ...
    F.COLLATERAL.RIGHT = ''
    R.COLLATERAL.RIGHT = ''
    CALL OPF(FN.COLLATERAL.RIGHT,F.COLLATERAL.RIGHT)    ;* MANUAL R22 CODE CONVERSION-OPF CALL
...
*    CALL GET.LOC.REF('COLLATERAL','L.COL.VAL.AVA',Y.AVAIL.VAL.FIELD.NO);* MANUAL R22 CODE CONVERSION- Call method format changed
EB.LocalReferences.GetLocRef('COLLATERAL','L.COL.VAL.AVA',Y.AVAIL.VAL.FIELD.NO);* MANUAL R22 CODE CONVERSION- Call method format changed

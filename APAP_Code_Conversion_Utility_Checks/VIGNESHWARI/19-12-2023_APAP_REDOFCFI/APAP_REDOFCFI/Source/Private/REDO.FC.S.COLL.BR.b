* @ValidationCode : MjotNTUxOTg1ODg4OkNwMTI1MjoxNzAyNjI1MjAyODkxOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 Dec 2023 12:56:42
...
*PORCENTAJE.MAXIMO.PRESTAR:
    ...
    CALL OPF(FN.REDO.MAXIMO.PRESTAR.COLLATERAL,F.REDO.MAXIMO.PRESTAR.COLLATERAL)    ;*MANUAL R22 CODE CONVERSION- OPF IS ADDED
...
*    CALL F.READ(FN.REDO.MAXIMO.PRESTAR.COLLATERAL, Y.REDO.COLLATERAL.REA.ID<1,Y.I>, R.REDO.MAXIMO.PRESTAR.COLLATERAL, F.REDO.MAXIMO.PRESTAR.COLLATERAL, Y.ERR.REDO.MAXIMO.PRESTAR.COLLATERAL)
  CALL F.CACHE.READ(FN.REDO.MAXIMO.PRESTAR.COLLATERAL, Y.REDO.COLLATERAL.REA.ID<1,Y.I>, R.REDO.MAXIMO.PRESTAR.COLLATERAL, F.REDO.MAXIMO.PRESTAR.COLLATERAL, Y.ERR.REDO.MAXIMO.PRESTAR.COLLATERAL)   ;*MANUAL R22 CODE CONVERSION-CHANGE F.READ TO F.CACHE.READ

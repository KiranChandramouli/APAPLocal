* @ValidationCode : MjotMTQ4NTAyNDMwODpDcDEyNTI6MTcwMzI1MTQ4MTI1Njp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Dec 2023 18:54:41
...
*22-12-2023         VIGNESHWARI                         R22 MANUAL CODE CONVERSION    CALL RTN MODIFIED, CHANGED AA.FRAMEWORK
*-----------------------------------------------------------------------------------
...
* PACS00307565 - E
       ...
       * CALL AA.GET.ARRANGEMENT.CONDITIONS(idArrangementComp, idPropertyClass, idProperty, effectiveDate, returnIds, returnConditions, returnError)
       AA.Framework.GetArrangementConditions(Idarrangementcomp, Idpropertyclass, Idproperty, Effectivedate, Returnids, Returnconditions, Returnerror) ;*R22 MANUAL CODE CONVERSION-CALL RTN MODIFIED
...
* PACS00307565 - E
    ...
    LOCATE ID.NEW IN Y.AA.COLL.IDS<1,1> SETTING POS.CL THEN
        ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK-START
...
*        AAA.REQ<AA.ARR.ACT.FIELD.VALUE,1,-1> = Y.DESC.GAR[1,60]
        AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL:':POS.CL:':1'
        AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = ID.NEW

        AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL.VAL:':POS.CL:':1'
        AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = R.NEW(COLL.EXECUTION.VALUE)

        AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL.DESC:':POS.CL:':1'
        AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = Y.DESC.GAR[1,60]
         ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK-END
* PACS00307565 - S
...
*            AAA.REQ<AA.ARR.ACT.FIELD.VALUE,1,-1> = Y.AA.BAL
            AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.AV.COL.BAL:':POS.CL:':1'    ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK
            AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = Y.AA.BAL     ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK
        END
* PACS00307565 - E
END ELSE
 ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK-START
...
*        AAA.REQ<AA.ARR.ACT.FIELD.VALUE,1,-1> = Y.DESC.GAR[1,60]
        ...
        AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL:':Y.CL.CNT+1:':1'
        AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = ID.NEW

        AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL.VAL:':Y.CL.CNT+1:':1'
        AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = R.NEW(COLL.EXECUTION.VALUE)

        AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL.DESC:':Y.CL.CNT+1:':1'
        AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = Y.DESC.GAR[1,60]
         ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK-END
* PACS00307565 - S
        IF Y.AA.DUP.ID NE Y.OLD.AA.ID THEN  ;* Any of the Loans was changed or replaced
...
*            AAA.REQ<AA.ARR.ACT.FIELD.VALUE,1,-1> = Y.AA.BAL
            AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.AV.COL.BAL:':Y.CL.CNT+1:':1'    ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK
            AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = Y.AA.BAL     ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK
        END
* PACS00307565 - E
    END
...
*    AAA.REQ<AA.ARR.ACT.PROPERTY,1> = 'COMMITMENT'
    ...
    AAA.REQ<AA.Framework.RrControl.ArrActActivity> = 'LENDING-UPDATE-COMMITMENT'
    AAA.REQ<AA.Framework.SimulationCapture.ArrActEffectiveDate> = TODAY
    AAA.REQ<AA.Framework.ArrangementActivity.ArrActArrangement> = Y.AA.SD
    AAA.REQ<AA.Framework.RrControl.ArrActProperty,1> = 'COMMITMENT'
 ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK-END
...
*            AAA.REQ<AA.ARR.ACT.FIELD.VALUE,1,-1> = '|-|'
            AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL:':POS.OL.COD:':1'   ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK
            AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = '|-|'    ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK
...
*            AAA.REQ<AA.ARR.ACT.FIELD.VALUE,1,-1> = 'NULL'
      ...
      ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK-START   
            ...
            AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL:':POS.OL.COD:':1'
            AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = 'NULL'

            AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL.VAL:':POS.OL.COD:':1'
            AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = 'NULL'

            AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL.DESC:':POS.OL.COD:':1'
            AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = 'NULL'
* PACS00307565 - S
            AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.AV.COL.BAL:':POS.OL.COD:':1'
            AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = 'NULL'
             ;* R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK-END
* PACS00307565 - E
        END

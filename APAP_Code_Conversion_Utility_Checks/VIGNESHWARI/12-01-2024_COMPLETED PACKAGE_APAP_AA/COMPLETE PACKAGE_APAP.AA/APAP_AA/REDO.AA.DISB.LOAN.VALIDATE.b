* @ValidationCode : MjotOTQ4NTYzMjYyOkNwMTI1MjoxNzAzMjU1MTk0MzM3OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Dec 2023 19:56:34
...
*22-12-2023         VIGNESHWARI           R22 MANUAL CODE CONVERSION-VARIABLE IS HARDE CODED,OPF IS CALL
*-----------------------------------------------------------------------------
    $INSERT I_EQUATE
    $INSERT I_COMMON
...
CALL OPF(FN.REDO.BRANCH.INT.ACCT.PARAM,F.REDO.BRANCH.INT.ACCT.PARAM) ;*R22 MANUAL CODE CONVERSION- OPF IS CALL
...
ID.VAR='SYSTEM';*R22 MANUAL CODE CONVERSION-VARIABLE IS ASSIGN
    CALL CACHE.READ(FN.REDO.BRANCH.INT.ACCT.PARAM,ID.VAR,R.REDO.BRANCH.INT.ACCT.PARAM,INT.ERR)
* Tus End

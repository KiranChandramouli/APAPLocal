* @ValidationCode : MjotMTIxOTg2MzM4NzpDcDEyNTI6MTcwMzY2OTI2MzM3MDp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Dec 2023 14:57:43
...
* 29-MAR-2023      Conversion Tool    R22 Auto conversion     F.READ to CACHE.READ
* 29-MAR-2023      Harishvikram C     Manual R22 conversion   Modified AA$CURR.ACTIVITY to c_aalocCurrActivity
* 27-12-2023       VIGNESHWARI S            R22 MANUAL CONVERSTION       call rtn modified,AA.FRAMEWORK IS CHANGED
*---------------------------------------------------------------------------------------------------------
 ...
 *   Y.PRODUCT.ID = c_aalocArrProductId  ;* Product ID
   Y.PRODUCT.ID = AA.Framework.getC_aalocarrproductid() ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK CHANGED
    CALL CACHE.READ(FN.AA.PRODUCT, Y.PRODUCT.ID, R.PRODUCT, PROD.ERR) ;*R22 Auto conversion
...
*    IF AA$CURR.ACTIVITY EQ Y.PAYOFF.ACTIVITY THEN
;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK CHANGED-START
     *   IF c_aalocCurrActivity EQ Y.PAYOFF.ACTIVITY THEN ;*R22 Manual conversion
      *      IF c_aalocActivityStatus EQ 'AUTH' THEN
            ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK CHANGED-END    
                 IF AA.Framework.getC_aaloccurractivity() EQ Y.PAYOFF.ACTIVITY THEN ;*R22 Manual conversion
...
PROCES.LIMITS:
    ...
    *Y.AA.ID = c_aalocArrId ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK CHANGED
...
AA.Framework.GetArrangementConditions(idArrangementComp, idPropertyClass, idProperty, effectiveDate, returnIds, returnConditions, returnError) ;*R22 MANUAL CONVERSTION-call rtn modified
...
*AA Changes 20161013
   ...
   * Y.CUS = R.AA.ARR<AA.ARR.CUSTOMER> ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK CHANGED
    Y.CUS = R.AA.ARR<AA.Framework.ArrangementSim.ArrCustomer>
*AA Changes 20161013
...
FORM.OFS.LIM:
   ...
   * Y.EF.DATE = c_aalocActivityEffDate
    Y.EF.DATE = AA.Framework.getC_aalocactivityeffdate() ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK CHANGED

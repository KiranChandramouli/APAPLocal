* @ValidationCode : MjotMTY1NDc1Mjg0NTpDcDEyNTI6MTcwMzc1ODU1NDI2MDp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 28 Dec 2023 15:45:54
...
**------------------
    ...
    RET.ERR          = ''
    returnConditions = ''
    *CALL AA.GET.ARRANGEMENT.CONDITIONS(ARRANGEMENT.ID,PROP.CLASS,PROP.NAME,'','',returnConditions,RET.ERR);*R22 MANUAL CONVERSTION - call rtn modified
...
*    CALL AA.GET.ARRANGEMENT.CONDITIONS(ARRANGEMENT.ID,PROP.CLASS,PROP.NAME,'','',returnConditions,RET.ERR)
 AA.Framework.GetArrangementConditions(ARRANGEMENT.ID,PROP.CLASS,PROP.NAME,'','',returnConditions,RET.ERR);*R22 MANUAL CONVERSTION - call rtn modified

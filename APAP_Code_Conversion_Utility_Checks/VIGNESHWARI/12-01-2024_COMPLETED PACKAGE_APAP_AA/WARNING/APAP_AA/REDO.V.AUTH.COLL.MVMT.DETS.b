* @ValidationCode : MjoxOTM0MjQ5ODQ0OkNwMTI1MjoxNzA0NzAxNTI3OTYyOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 08 Jan 2024 13:42:07
...
*08-01-2024         vigneshwari                     R22 MANUAL CODE CONVERSION      AA.FRAMEWORK IS CHANGED
*********************************************************************************************************
$INSERT I_COMMON
$INSERT I_EQUATE
...
ARR.AMT.ID      = AA.Framework.getC_aalocarrid()        ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
EFF.AMT.DATE    = TODAY
...
Y.COLLATERAL.ID = AA.Framework.getC_aalocarrid():'.':Y.AMT.COLL.ID    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(SEL.AA.ID, AA.ARRANGEMENT.ERR) ;*R22 MANUAL CODE CONVERSION-F.READ IS MODIFIED
*Y.LINK.APP = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL>
*Y.LINK.APP.ID = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID>
Y.LINK.APP = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedAppl>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
Y.LINK.APP.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId>    ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
...
AA.Framework.GetPeriodBalances(Y.LINK.APP.ID, BALANCE.TO.CHECK, DATE.OPTIONS, EFFECTIVE.DATE, "", "", BAL.DETAILS, "");* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.MVMT.LIST,ID.NEW,R.REDO.MVMT.LIST,F.REDO.MVMT.LIST,COL.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.MVMT.COLLATERAL,Y.COLLATERAL.ID,R.REDO.MVMT.COLLATERAL,F.REDO.MVMT.COLLATERAL,COLL.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.MVMT.LIST,Y.AMT.COLL.ID,R.REDO.MVMT.LIST,F.REDO.MVMT.LIST,REDO.MVMT.ERR,'');* R22 AUTO CONVERSION
IF R.REDO.MVMT.LIST THEN
*LOCATE c_aalocArrId IN R.REDO.MVMT.LIST SETTING ARR.POS ELSE
*R.REDO.MVMT.LIST<-1> = c_aalocArrId

LOCATE AA.Framework.getC_aalocarrid() IN R.REDO.MVMT.LIST SETTING ARR.POS ELSE  ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
R.REDO.MVMT.LIST<-1> = AA.Framework.getC_aalocarrid()   ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED
END
END ELSE
*R.REDO.MVMT.LIST<-1> = c_aalocArrId
R.REDO.MVMT.LIST<-1> = AA.Framework.getC_aalocarrid()   ;*R22 MANUAL CODE CONVERSION-AA.FRAMEWORK IS CHANGED

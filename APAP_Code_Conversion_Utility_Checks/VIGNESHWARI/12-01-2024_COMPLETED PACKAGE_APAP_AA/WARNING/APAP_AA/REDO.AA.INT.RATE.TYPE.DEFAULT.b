* @ValidationCode : MjotMTk3MTMyNzkyMDpDcDEyNTI6MTcwMzU3MjAzMDg0NTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Dec 2023 11:57:10
...
INITIALISE:
    ...
    *CALL GET.LOC.REF("AA.PRD.DES.INTEREST","L.AA.REV.RT.TY",REVRATE.POS)
    EB.LocalReferences.GetLocRef("AA.PRD.DES.INTEREST","L.AA.REV.RT.TY",REVRATE.POS);*R22 MANUAL CONVERSTION -CALL RTN MODIFIED

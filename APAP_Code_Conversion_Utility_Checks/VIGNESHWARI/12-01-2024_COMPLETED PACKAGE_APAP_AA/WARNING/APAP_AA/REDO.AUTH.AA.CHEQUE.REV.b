* @ValidationCode : MjotNzY5Nzk3NTMzOkNwMTI1MjoxNzAzNjcwMDkwOTM1OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Dec 2023 15:11:30
...
* 27-12-2023       VIGNESHWARI S            R22 MANUAL CONVERSTION       call rtn modified,variable is hardcoded,changed f.read to f.readu
*-----------------------------------------------------------------------------------
...
*    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,'SYSTEM',R.REDO.APAP.CLEAR.PARAM,PARA.ERR)
    VAR.VAL='SYSTEM' ;*R22 MANUAL CODE CONVERSION-variable is hardcoded
    
    CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,VAR.VAL,R.REDO.H.AA.DIS.CHG,CHG.ERR)
    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,VAR.VAL,R.REDO.APAP.CLEAR.PARAM,PARA.ERR)
 ...
 *   CALL F.READ(FN.REDO.LOAN.CHQ.RETURN,Y.LOAN.NO,R.REDO.LOAN.CHQ.RETURN,F.REDO.LOAN.CHQ.RETURN,CHQ.RET.ERR)
  CALL F.READU(FN.REDO.LOAN.CHQ.RETURN,Y.LOAN.NO,R.REDO.LOAN.CHQ.RETURN,F.REDO.LOAN.CHQ.RETURN,CHQ.RET.ERR,"")  ;*R22 MANUAL CODE CONVERSION-changed f.read to f.readu
...
AC.API.EbAccounting("FT","SAO",MULTI.STMT,'') ;*R22 MANUAL CODE CONVERSION--call rtn modified

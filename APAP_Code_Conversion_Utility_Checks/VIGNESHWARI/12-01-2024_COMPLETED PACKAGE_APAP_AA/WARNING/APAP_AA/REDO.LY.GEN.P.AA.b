* @ValidationCode : MjotMTQ5NjYxNjM4MzpDcDEyNTI6MTcwNDI2NTQzNTQ3NTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 Jan 2024 12:33:55
...
CALL OPF(FN.REDO.LY.CUST.NOTRAVREC,F.REDO.LY.CUST.NOTRAVREC);*R22 MANUAL CODE COMVERSION-OPF IS ADDED
...
F.REDO.LY.TEMPAA = ''
CALL OPF(FN.REDO.LY.TEMPAA,F.REDO.LY.TEMPAA) ;*R22 MANUAL CODE COMVERSION-OPF IS ADDED
...
CALL CACHE.READ(FN.REDO.LY.AIR.FILEGEN,IDVAR.1,R.AIR,AIR.ERR);* R22 AUTO CONVERSION
...
IDVAR.1 = 'SYSTEM' ;* R22 AUTO CONVERSION
CALL CACHE.READ(FN.REDO.LY.PROGAERO,IDVAR.1,R.PROGAERO,PROGAERO.ERR) ; * Tus End;* R22 AUTO CONVERSION
IF R.PROGAERO THEN
...
CALL F.READU(FN.REDO.LY.POINTS,Y.PTS.ID,R.REC.POINTS,F.REDO.LY.POINTS,PTS.ERR.R,'');* R22 AUTO CONVERSION

* @ValidationCode : MjoxODcwODE0NTU2OkNwMTI1MjoxNzAzMjUwMjQxNjA2OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Dec 2023 18:34:01
...
GET.AA.IDSS:
    ...
    WHILE Y.CNT.AA GT 0 DO
      ...
      AA.Framework.GetArrangementConditions(Idarrangementcomp, Idpropertyclass, Idproperty, Effectivedate, Returnids, Returnconditions, Returnerror) ;*R22 MANUAL CODE CONVERSION-CALL RTN IS MODIFIED
     ...
     *   AAA.REQ<AA.ARR.ACT.FIELD.NAME,1,-1> = 'L.AA.COL:':POS.CL:':1'
      *  AAA.REQ<AA.ARR.ACT.FIELD.VALUE,1,-1> = ID.NEW
       ...
       * AAA.REQ<AA.ARR.ACT.FIELD.VALUE,1,-1> = R.NEW(COLL.NOMINAL.VALUE)
        ...
        AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = ID.NEW
        AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL.VAL:':POS.CL:':1'
        AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = R.NEW(COLL.NOMINAL.VALUE)
;*R22 MANUAL CODE CONVERSION-END
 ...
 ;*R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK-START           
             AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.AV.COL.BAL:':POS.CL:':1'
            AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = Y.AA.BAL
...
*        AAA.REQ<AA.ARR.ACT.FIELD.VALUE,1,-1> = R.NEW(COLL.NOMINAL.VALUE)
        ...
        AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = 'L.AA.COL.VAL:':Y.CL.CNT+1:':1'
        AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = R.NEW(COLL.NOMINAL.VALUE)
...
*            AAA.REQ<AA.ARR.ACT.FIELD.VALUE,1,-1> = 'NULL'
            ...
            AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.COL.VAL:':POS.OL.COD:':1'  ;*R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK
            AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = 'NULL'  ;*R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK
* PACS00307565 - S
*            AAA.REQ<AA.ARR.ACT.FIELD.NAME,1,-1> = 'L.AA.AV.COL.BAL:':POS.OL.COD:':1'
*            AAA.REQ<AA.ARR.ACT.FIELD.VALUE,1,-1> = 'NULL'
            
                        AAA.REQ<AA.Framework.RrControl.ArrActFieldName,1,-1> = 'L.AA.AV.COL.BAL:':POS.OL.COD:':1'   ;*R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK
            AAA.REQ<AA.Framework.SimulationCapture.ArrActFieldValue,1,-1> = 'NULL'  ;*R22 MANUAL CODE CONVERSION-CHANGED AA.FRAMEWORK
* PACS00307565 - E
        END

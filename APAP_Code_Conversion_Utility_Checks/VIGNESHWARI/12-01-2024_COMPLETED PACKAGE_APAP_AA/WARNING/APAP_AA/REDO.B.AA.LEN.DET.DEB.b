* @ValidationCode : MjotMjAyMjkwMzQ1OTpDcDEyNTI6MTcwMzY4MDcyNzUzODp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Dec 2023 18:08:47
...
*    STAR.DATE.VAL = R.AA.ARRANGEMENT<AA.ARR.START.DATE>
    ...
    PRODUCT.ID = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct>
 ...
 *   Y.LINKED.APPL    = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL>
 ...
 Y.LINKED.APPL    = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedAppl> ;*R22 MANUAL CODE CONVERSION - AA.FRAMEWORK IS CHANGED
    Y.LINKED.APPL.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId> ;*R22 MANUAL CODE CONVERSION - AA.FRAMEWORK IS CHANGED
 ...
 *   CALL AA.GET.PERIOD.BALANCES(Y.NROPRESTAMO, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE)
  AA.Framework.GetPeriodBalances(Y.NROPRESTAMO, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE) ;*R22 MANUAL CODE CONVERSION- CALL RTN MODIFIED

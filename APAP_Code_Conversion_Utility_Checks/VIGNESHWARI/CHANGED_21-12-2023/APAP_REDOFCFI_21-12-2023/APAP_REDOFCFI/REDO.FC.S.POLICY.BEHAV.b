* @ValidationCode : MjotMjA3MTU5Mzc3NDpDcDEyNTI6MTcwMzE1MDcyOTY3ODp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 14:55:29
...
*            CALL F.READ(FN.INS.COMB, ID.INS.COMB, R.INS.COMB, F.INS.COMB, Y.APP.ERR)
 CALL F.CACHE.READ(FN.INS.COMB, ID.INS.COMB, R.INS.COMB, Y.APP.ERR)
            IF Y.APP.ERR THEN

* @ValidationCode : MjotMTQyMTAxOTQ2ODpDcDEyNTI6MTcwMzE1NzQyOTg5Mjp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 16:47:09
...
*  CALL F.READ(FN.REDO.ISSUE.MAIL,'SYSTEM',R.REDO.ISSUE.MAIL,F.REDO.ISSUE.MAIL,Y.ISSUE.EMAIL.ERR) ;*Tus Start
    CALL CACHE.READ(FN.REDO.ISSUE.MAIL,'SYSTEM',R.REDO.ISSUE.MAIL,Y.ISSUE.EMAIL.ERR) ; * Tus End;* MANUAL R22 CODE CONVERSION -CHANGE F.READ TO CACHE.READ
 ...
 *               CALL F.READ(FN.REDO.INTERFACE.PARAM,Y.COMP.ID,R.REDO.INTERFACE.PARAM.COMP,F.REDO.INTERFACE.PARAM,Y.COMP.ERR)
  CALL CACHE.READ(FN.REDO.INTERFACE.PARAM,Y.COMP.ID,R.REDO.INTERFACE.PARAM.COMP,Y.COMP.ERR);* MANUAL R22 CODE CONVERSION -CHANGE F.READ TO CACHE.READ

* @ValidationCode : MjotMTkzNjYzOTY4NDpDcDEyNTI6MTcwMzE1Nzg4NzE2MTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 16:54:47
...
*15-12-2023         VIGNESHWARI                     MANUAL R22 CODE CONVERSION            OPF IS ADDED,CHANGE F.READ TO CACHE.READ
*=============================================================================
 ...
 *   CALL F.READ(FN.PARMS,R.NEW(REDO.FC.SEC.CLASSIFY.DE)<1,Y.I> ,R.PARMS,F.PARMS,Y.PARMS.ERR.MSG)
     CALL CACHE.READ(FN.PARMS,R.NEW(REDO.FC.SEC.CLASSIFY.DE)<1,Y.I> ,R.PARMS,Y.PARMS.ERR.MSG);*MANUAL R22 CODE CONVERSION-CHANGE F.READ TO CACHE.READ

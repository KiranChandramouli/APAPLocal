* @ValidationCode : Mjo2NTUzMzc0NTM6Q3AxMjUyOjE3MDMxNTczMTIyMTg6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 21 Dec 2023 16:45:12
...
*17-12-2023          VIGNESHWARI                     MANUAL R22 CODE CONVERSION             CHANGE F.READ TO CACHE.READ
*=======================================================================
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
 ...
 *       CALL F.READ(FN.REDO.INTERFACE.PARAM, FI.INTERFACE, FI.REDO.INTERFACE.PARAM, FV.REDO.INTERFACE.PARAM, Y.ERR)
 CALL CACHE.READ(FN.REDO.INTERFACE.PARAM, FI.INTERFACE, FI.REDO.INTERFACE.PARAM, Y.ERR);*MANUAL R22 CODE CONVERSION-CHANGE F.READ TO CACHE.READ
        IF Y.ERR THEN
            PROCESS.GOAHEAD = 0
...
*                CALL F.READ(FN.REDO.INTERFACE.PARAM, PARAM.ID, R.REDO.INTERFACE.PARAM, FV.REDO.INTERFACE.PARAM, Y.ERR)
 CALL CACHE.READ(FN.REDO.INTERFACE.PARAM, PARAM.ID, R.REDO.INTERFACE.PARAM, Y.ERR)     ;*MANUAL R22 CODE CONVERSION-CHANGE F.READ TO CACHE.READ          
                IF Y.ERR THEN
                    PROCESS.GOAHEAD = 0

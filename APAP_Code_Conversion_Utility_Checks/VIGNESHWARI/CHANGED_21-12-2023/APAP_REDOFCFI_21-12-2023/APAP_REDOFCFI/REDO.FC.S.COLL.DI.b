* @ValidationCode : MjotMTU2MDY0NDYxNDpDcDEyNTI6MTcwMzE1Nzg2MjQ1Nzp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 16:54:22
...
* 15-12-2023        VIGNESHWARI            R22 Manual Conversion - CHANGE F.READ TO CACHE.READ
*------------------------------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_GTS.COMMON
...
*    CALL F.READ(FN.COLL.CODE.PARAMS, Y.COLL.CLASS<1,Y.I>, R.COLL.CODE.PARAMS, F.COLL.CODE.PARAMS, Y.ERR)
 CALL F.CACHE.READ(FN.COLL.CODE.PARAMS, Y.COLL.CLASS<1,Y.I>, R.COLL.CODE.PARAMS, Y.ERR)

* @ValidationCode : MjotMTMxNDM0ODkyMzpDcDEyNTI6MTcwMzE1NzkyNDE4ODp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 16:55:24
...
*    CALL F.READ(FN.REDO.MAXIMO.PRESTAR.COLLATERAL, Y.REDO.COLLATERAL.REA.ID<1,Y.I>, R.REDO.MAXIMO.PRESTAR.COLLATERAL, F.REDO.MAXIMO.PRESTAR.COLLATERAL, Y.ERR.REDO.MAXIMO.PRESTAR.COLLATERAL)
  CALL CACHE.READ(FN.REDO.MAXIMO.PRESTAR.COLLATERAL, Y.REDO.COLLATERAL.REA.ID<1,Y.I>, R.REDO.MAXIMO.PRESTAR.COLLATERAL, Y.ERR.REDO.MAXIMO.PRESTAR.COLLATERAL)   ;*MANUAL R22 CODE CONVERSION-CHANGE F.READ TO CACHE.READ

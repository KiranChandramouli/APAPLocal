* @ValidationCode : MjotNzUwODI2ODczOkNwMTI1MjoxNzAzMTQ5NTc5NzI0OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 14:36:19
...
CALL CACHE.READ(FN.REDO.CCRG.RISK.LIMIT.PARAM,ID.NAME.LIM,R.REDO.CCRG.RISK.LIMIT.PARAM,Y.ERR)  ;*R22 Manual Conversion-Change read to cache.read 
    IF Y.ERR THEN

* @ValidationCode : MjotNzM4ODkyMDE3OkNwMTI1MjoxNzAzMTQ5NTI5MDQyOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 14:35:29
...
CALL CACHE.READ(FN.REDO.CCRG.RISK.LIMIT.PARAM,Y.LIMIT.ID,R.REDO.CCRG.RISK.LIMIT.PARAM,Y.ERR);*MANUAL R22 CODE CONVERSION -Change "read" to "CACHE.READ"
 ...
 *       CALL F.READ(FN.REDO.CCRG.RISK.LIMIT.PARAM,Y.RL.SEC,R.RL.SEC,F.REDO.CCRG.RISK.LIMIT.PARM,Y.ERR)
 CALL CACHE.READ(FN.REDO.CCRG.RISK.LIMIT.PARAM,Y.RL.SEC,R.RL.SEC,Y.ERR) ;*MANUAL R22 CODE CONVERSION -Change "read" to "CACHE.READ"
 *       CALL F.READ(FN.REDO.CCRG.RISK.LIMIT.PARAM,Y.RL.UNSEC,R.RL.UNSEC,F.REDO.CCRG.RISK.LIMIT.PARM,Y.ERR)
  CALL CACHE.READ(FN.REDO.CCRG.RISK.LIMIT.PARAM,Y.RL.UNSEC,R.RL.UNSEC,Y.ERR)    ;*MANUAL R22 CODE CONVERSION -Change "read" to "CACHE.READ"

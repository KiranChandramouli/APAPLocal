* @ValidationCode : MjozNTc4MjQ1MzpDcDEyNTI6MTcwMzE1NzU3NzUxMjp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 16:49:37
...
*15-12-2023          VIGNESHWARI                     MANUAL R22 CODE CONVERSION            OPF IS ADDED,F.READ TO CACHE.READ
*-----------------------------------------------------------------------------------
...
CALL CACHE.READ(FN.REDO.FC.COLL.CODE.PARAMS,Y.COLL.CODE,R.REDO.FC.COLL.CODE.PARAMS,YERR);*MANUAL R22 CODE CONVERSION F.READ TO CACHE.READ

* @ValidationCode : MjoxMTQ0NTY3OTcyOkNwMTI1MjoxNzAzMTU1ODM5NzA3OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 16:20:39
...
*17-12-2023          VIGNESHWARI                       MANUAL R22 CODE CONVERSION            VARIABLE IS ASSIGN, CHANGE F.READ TO CACHE.READ
*-----------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
CALL CACHE.READ(FN.REDO.INTERFACE.PARAM,Y.FACE.ID,R.REDO.INTERFACE.PARAM,INT.ERR);*MANUAL R22 CODE CONVERSION -CHANGE F.READ TO CACHE.READ

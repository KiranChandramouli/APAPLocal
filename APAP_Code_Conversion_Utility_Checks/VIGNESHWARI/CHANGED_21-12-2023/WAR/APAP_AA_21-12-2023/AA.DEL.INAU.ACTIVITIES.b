* @ValidationCode : MjotMTQ0ODQwNzgxNjpDcDEyNTI6MTcwMzIwMDE4NTEyOTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Dec 2023 04:39:45
...
* Select the BASE.DATE eq NULL reocrds from AA.ARR.PAYMENT.SCHEDULE
    ...
    WHILE Y.ID:YID.POS
        ...
        *CALL F.READ(FN.ARR.PS, Y.ID, Y.ARR.REC, F.ARR.PS, ERR)
        CALL F.READU(FN.ARR.PS, Y.ID, Y.ARR.REC, F.ARR.PS, ERR, "") ;*R22 MANUVAL CONVERSION-CHANGED F.READ TO F.READU
...
* Select the BASE.DATE eq NULL reocrds from AA.ARR.PAYMENT.SCHEDULE$NAU
    ...
    CALL F.READU(FN.ARR.PS$NAU, Y.ID, Y.ARR.REC, F.ARR.PS$NAU, ERR, "") ;*R22 MANUVAL CONVERSION-CHANGED F.READ TO F.READU

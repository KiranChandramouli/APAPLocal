* @ValidationCode : MjotMjA3MjExMzg4ODpDcDEyNTI6MTY4Mzg3ODA5NTM3ODpJVFNTOi0xOi0xOjMyNzoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 May 2023 13:24:55
...
* 19/12/2023         Arun               R22 Manual Conversion             Changed to AA.ProductFramework.PropertyGetBalanceName
*-------------------------------------------------------------------------------------
...
*CALL AA.PROPERTY.GET.BALANCE.NAME(ARR.ID,PROPERTY, LIFECYLE.STATUS, "", CHARGEOFF.TYPE, BALANCE.TYPE)
    AA.ProductFramework.PropertyGetBalanceName(ARR.ID,PROPERTY, LIFECYLE.STATUS, "", CHARGEOFF.TYPE, BALANCE.TYPE)
* TUS END
    ACCT.EVENT.ARRAY=''

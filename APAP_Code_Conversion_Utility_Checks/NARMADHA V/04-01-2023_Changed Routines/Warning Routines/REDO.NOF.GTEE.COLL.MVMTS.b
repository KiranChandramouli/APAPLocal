* @ValidationCode : MjotODEzOTIyMzIwOlVURi04OjE3MDQzNjc2NTA3ODE6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:57:30
...
* 04-01-2024       Narmadha V       Manual R22 Conversion      CALL OPF Added
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
* PACS00313081 - 2015APR29 - Sandra's email - S
    ...
    F.ALTERNATE.ACCOUNT = ''
    CALL OPF(FN.ALTERNATE.ACCOUNT,F.ALTERNATE.ACCOUNT) ;*Manual R22 Conversion
* PACS00313081 - 2015APR29 - Sandra's email - E
    Y.AAPL = 'COLLATERAL'

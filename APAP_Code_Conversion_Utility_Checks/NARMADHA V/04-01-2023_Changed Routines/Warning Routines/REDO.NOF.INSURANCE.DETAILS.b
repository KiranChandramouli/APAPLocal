* @ValidationCode : MjotNTg1NDM5ODkxOlVURi04OjE3MDQzNjE1MzIwNjM6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jan 2024 15:15:32
...
*    CALL F.READ(FN.AA.ARRANGEMENT,Y.ARR.ID,R.AA.ARR,F.AA.ARRANGEMENT,AA.ARR.ERR)
    R.AA.ARR = AA.Framework.Arrangement.Read(Y.ARR.ID, AA.ARR.ERR)
*    Y.PRODUCT = R.AA.ARR<AA.ARR.PRODUCT>
    Y.PRODUCT = R.AA.ARR<AA.Framework.Arrangement.ArrProduct>
*    Y.CURRENCY = R.AA.ARR<AA.ARR.CURRENCY>
    Y.CURRENCY = R.AA.ARR<AA.Framework.Arrangement.ArrCurrency>
...
*             SEL.LIST.BILL = R.AA.ACCOUNT.DETAILS<AA.AD.BILL.ID>
                SEL.LIST.BILL = R.AA.ACCOUNT.DETAILS<AA.PaymentSchedule.AccountDetailsHist.AdBillId>
...
*-----------------------------------------------------------------------------
    ...
    WHILE Y.BILL.ID:BILL.POS
        R.BILL.DETAILS = AA.PaymentSchedule.BillDetails.Read(Y.BILL.ID, BIL.A.ERR)
...
*      Y.PROPERTIES = R.BILL.DETAILS<AA.BD.PROPERTY>
        Y.PROPERTIES = R.BILL.DETAILS<AA.PaymentSchedule.BillDetailsHist.BdProperty>
...
* Y.OS.PROP.AMT = Y.OS.PROP.AMT + R.BILL.DETAILS<AA.BD.OS.PROP.AMOUNT,POS.PR>
            Y.OS.PROP.AMT = Y.OS.PROP.AMT + R.BILL.DETAILS<AA.PaymentSchedule.BillDetails.BdOsPropAmount,POS.PR>
        END
...
*    CALL F.READ(FN.AA.ARRANGEMENT.DATED.XREF,Y.ARR.ID,R.AA.ARRANGEMENT.DA.XR,F.AA.ARRANGEMENT.DATED.XREF,ERR.DTA.XREF)
    R.AA.ARRANGEMENT.DA.XR = AA.Framework.ArrangementDatedXref.Read(Y.ARR.ID, ERR.DTA.XREF)

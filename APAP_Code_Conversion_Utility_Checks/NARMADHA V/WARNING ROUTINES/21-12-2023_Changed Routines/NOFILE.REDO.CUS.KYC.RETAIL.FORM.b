* @ValidationCode : MjotMTUwNzgxMzk1ODpVVEYtODoxNzAzMTU2MzAzMDA2OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 16:28:23
...
* 06-APRIL-2023      Harsha                R22 Manual Conversion - Call method formate modified.
*------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*CALL F.READ(FN.APP,APP.ID,R.APP,F.APP,AP.ER)
        CALL CACHE.READ(FN.APP,APP.ID,R.APP,AP.ER) ;*Manual R22 Conversion - F.READ to CACHE.READ

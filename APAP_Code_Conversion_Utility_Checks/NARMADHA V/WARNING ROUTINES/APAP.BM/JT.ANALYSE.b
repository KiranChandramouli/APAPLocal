* @ValidationCode : MjoyMzc2MDQ3MzY6VVRGLTg6MTcwMjQ2ODcyMTc5OTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 13 Dec 2023 17:28:41
...
*13-12-2023       Narmadha V                  Manual R22 Conversion      Intialise FN variable,Change hardcoded value to FN variable
*----------------------------------------------------------------------------------------

    FN.SPF = "F.SPF" ;* Manual R22 Conversion - Intialise FN variable - START
    F.SPF  = ""
    FN.DATES = "F.DATES"
    F.DATES = ""
    FN.BATCH = "F.BATCH"
    F.BATCH =""
    FN.JOB.TIMES = "F.JOB.TIMES"
    F.JOB.TIMES = "" ;*Manual R22 Conversion - Intialise FN variable - END
* OPEN 'F.SPF' TO F.SPF ELSE CRT 'Unable to open F.SPF file' ; STOP ;
    OPEN FN.SPF TO F.SPF ELSE CRT 'Unable to open F.SPF file' ; STOP ;*Manual R22 Conversion- Change hardcoded value to FN variable
* OPEN 'F.DATES' TO F3 ELSE CRT 'Unable to open F.DATES file' ; STOP
    OPEN FN.DATES TO F3 ELSE CRT 'Unable to open F.DATES file' ; STOP ;*Manual R22 Conversion - Change hardcoded value to FN variable
* OPEN 'F.BATCH' TO F2 ELSE CRT 'Unable to open F.BATCH file' ; STOP
    OPEN FN.BATCH TO F2 ELSE CRT 'Unable to open F.BATCH file' ; STOP ;*Manual R22 Conversion - Change hardcoded value to FN variable
* OPEN 'F.JOB.TIMES' TO F1 ELSE CRT 'Unable to open F.JOB.TIMES file' ; STOP
    OPEN FN.JOB.TIMES TO F1 ELSE CRT 'Unable to open F.JOB.TIMES file' ; STOP ;*Manual R22 Conversion - Change hardcoded value to FN variable

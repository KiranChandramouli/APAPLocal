* @ValidationCode : MjotMTY3MDY4MjU0OlVURi04OjE3MDQ0MzgxOTk5MzQ6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jan 2024 12:33:19
...
SUBROUTINE REDO.NOFILE.AI.LIST.APAP.BEN.EDIT(FIN.ARR)
*-----------------------------------------------------------------------------
...
*-----------------------------------------------------------------------------
    ...
    LREF.FIELDS='L.AC.STATUS1':@VM:'L.AC.AV.BAL':@VM:'L.AC.NOTIFY.1':@VM:'L.AC.STATUS2':@FM:'L.BEN.CUST.NAME':@VM:'L.BEN.CEDULA':@VM:'L.BEN.BANK':@VM:':L.BEN.OWN.ACCT':@VM:'L.BEN.PROD.TYPE':@VM:'L.BEN.EMAIL'
...
*CALL CACHE.READ(FN.AI.REDO.ACCT.RESTRICT.PARAMETER,'SYSTEM',R.AI.REDO.ACCT.RESTRICT.PARAMETER,RES.ERR)
    ...
    WHILE BEN.ID:BEN.POS
        ...
        IF R.BENEFICIARY THEN
            ...
            FIN.ARR<-1> = BEN.PART.ID:"*":Y.L.BEN.CUST.NAME:"*":ACCT.ID:"*":Y.BEN.PROD.TYPE:"*":Y.NICKNAME:"*":Y.L.BEN.EMAIL
        END
    REPEAT
RETURN
*-----------------------------------------------------------------------------

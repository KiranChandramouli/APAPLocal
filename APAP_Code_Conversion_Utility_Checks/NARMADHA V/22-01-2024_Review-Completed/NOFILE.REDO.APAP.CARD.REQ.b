* @ValidationCode : MjotNzE4MTgzOTA5OlVURi04OjE3MDU5MDA0MDQyNTA6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Jan 2024 10:43:24
...
* 21-12-2023         Narmadha V            Manual R22 Conversion - CALL routine Format Modified,Add $USING
* ----------------------------------------------------------------------------
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*CALL GET.LOC.REF(Y.LRF.APPL, Y.LRF.FIELDS, FIELD.POS)
    EB.LocalReferences.GetLocRef(Y.LRF.APPL, Y.LRF.FIELDS, FIELD.POS) ;*Manual R22 Conversion - CALL routine Format Modified
*

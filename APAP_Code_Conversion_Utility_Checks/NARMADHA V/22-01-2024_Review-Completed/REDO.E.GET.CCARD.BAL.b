* @ValidationCode : MjotMTcwMTMzMDAzODpVVEYtODoxNzA1OTI0ODI1MzI2OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Jan 2024 17:30:25
...
* 19-01-2024         Narmadha V            Manual R22 Conversion   F.READ to F.READU
*---------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*CALL F.READ(FN.REDO.EB.USER.PRINT.VAR,Y.USR.VAR,HTML.DATA,F.REDO.EB.USER.PRINT.VAR,HTML.DATA.ERR)
    CALL F.READU(FN.REDO.EB.USER.PRINT.VAR,Y.USR.VAR,HTML.DATA,F.REDO.EB.USER.PRINT.VAR,HTML.DATA.ERR,'');* Manual R22 Conversion
    IF HTML.DATA.ERR NE "" THEN
        HTML.DATA = ''
    END

* @ValidationCode : MjoxNTY4MjEzMDM0OlVURi04OjE3MDU5MDYwMDE4MjQ6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Jan 2024 12:16:41
...
*26-12-2023     Narmadha V    Manual R22 Conversion              Call Routine Format Modified
*------------------------------------------------------------------------------
...
* CALL GET.LOC.REF('CUSTOMER','L.CU.TIPO.CL',REF.POS)
    EB.LocalReferences.GetLocRef('CUSTOMER','L.CU.TIPO.CL',REF.POS) ;*Manual R22 Conversion - Call Routine Format Modified
*

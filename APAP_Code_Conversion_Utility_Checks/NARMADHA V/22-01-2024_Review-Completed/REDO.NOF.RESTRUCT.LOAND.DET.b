* @ValidationCode : MjoxODQ0OTg4MDE5OlVURi04OjE3MDU5ODY5NTE5NTQ6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 23 Jan 2024 10:45:51
...
*        PAY.RT<-1> = R.PR<AA.PS.PAYMENT.TYPE>
        PAY.RT<-1> = R.PR<AA.PaymentSchedule.PaymentSchedule.PsPaymentType>;*Manual R22 Conversion
...
*    Y.MIG.LN.OR = RET.COND<AA.PS.LOCAL.REF,Y.POS.MIG.L>
    Y.MIG.LN.OR = RET.COND<AA.PaymentSchedule.PaymentSchedule.PsLocalRef,Y.POS.MIG.L>;*Manual R22 Conversion
...
* Y.CUR.MAT.DATE = R.AA.AC<AA.AD.MATURITY.DATE>
    Y.CUR.MAT.DATE = R.AA.AC<AA.PaymentSchedule.AccountDetails.AdMaturityDate> ;*Manual R22 Conversion
...
*Y.CUR.PAY.TYPE.M = RET.COND<AA.PS.PAYMENT.TYPE>
    Y.CUR.PAY.TYPE.M = RET.COND<AA.PaymentSchedule.PaymentSchedule.PsPaymentType> ;*Manual R22 Conversion
...
*    Y.PORTFOL = R.AA<AA.ARR.PRODUCT.GROUP>
    Y.PORTFOL = R.AA<AA.Framework.ArrangementSim.ArrProductGroup> ;*Manual R22 Conversion

* @ValidationCode : Mjo5MzE5ODUzNDU6VVRGLTg6MTcwNTkxODMyNDg5OTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Jan 2024 15:42:04
...
*    $INSERT I_F.AA.ACTIVITY.BALANCES ;*Manual R22 Conversion
...
*    Y.CO.CODE = R.AA<AA.ARR.CO.CODE>
    Y.CO.CODE = R.AA<AA.Framework.ArrangementSim.ArrCoCode> ;*Manual R22 Conversion
...
*    Y.CUS.ID = R.AA<AA.ARR.CUSTOMER>
    Y.CUS.ID = R.AA<AA.Framework.ArrangementSim.ArrCustomer> ;*Manual R22 Conversion
...
*   Y.OPEN.DATE = R.AA<AA.ARR.PROD.EFF.DATE>
    Y.OPEN.DATE = R.AA<AA.Framework.ArrangementSim.ArrProdEffDate> ;*Manual R22 Conversion
...
*CALL AA.GET.ARRANGEMENT.CONDITIONS(Y.AA.ID,'TERM.AMOUNT','','','',RET.COND,RET.ERR)
    AA.Framework.GetArrangementConditions(Y.AA.ID,'TERM.AMOUNT','','','',RET.COND,RET.ERR);* R22 Utility Changes
...
*CALL AA.GET.ARRANGEMENT.CONDITIONS(Y.AA.ID,'INTEREST','PRINCIPALINT','','',RET.COND,RET.ERR)
        AA.Framework.GetArrangementConditions(Y.AA.ID,'INTEREST','PRINCIPALINT','','',RET.COND,RET.ERR);* R22 Utility Changes
        RET.COND = RAISE(RET.COND)
...
*Y.CHLD.AAA = R.AAA<AA.ARR.ACT.CHILD.ACTIVITY> ;
        Y.CHLD.AAA = R.AAA<AA.Framework.SimulationCapture.ArrActChildActivity> ;*Manual R22 Conversion
        Y.CLD.CNT = DCOUNT(Y.CHLD.AAA,@VM) ; FLG.CHL = ''; Y.CHLD.CHIN = ''
...
*Y.CHLD.AAA<1,-1> = R.AAA<AA.ARR.ACT.CHILD.ACTIVITY>
                    Y.CHLD.AAA<1,-1> = R.AAA<AA.Framework.SimulationCapture.ArrActChildActivity> ;*Manual R22 Conversion
...
*LOCATE Y.AAA.ID IN R.AA.ACT.BAL<AA.ACT.BAL.ACTIVITY.REF,1> SETTING POS.AAA THEN
    LOCATE Y.AAA.ID IN R.AA.ACT.BAL<AA.Framework.ActivityBalances.ActBalActivityRef,1> SETTING POS.AAA THEN ;*Manual R22 Conversion
*Y.PROPS = R.AA.ACT.BAL<AA.ACT.BAL.PROPERTY,POS.AAA>
        Y.PROPS = R.AA.ACT.BAL<AA.Framework.ActivityBalances.ActBalProperty> ;*Manual R22 Conversion
*Y.PROPS.AMTS = R.AA.ACT.BAL<AA.ACT.BAL.PROPERTY.AMT,POS.AAA>
        Y.PROPS.AMTS = R.AA.ACT.BAL<AA.Framework.ActivityBalances.ActBalPropertyAmt> ;*Manual R22 Conversion

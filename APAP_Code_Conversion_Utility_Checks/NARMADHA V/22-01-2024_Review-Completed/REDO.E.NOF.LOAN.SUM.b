* @ValidationCode : MjotOTk3OTU5MjAwOlVURi04OjE3MDU5MTcxNDU4ODY6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Jan 2024 15:22:25
...
*CALL F.READ(FN.AA.ARRANGEMENT,Y.AA.LOAN.NO,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,Y.AA.ARRANGE.ERR)
    R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(Y.AA.LOAN.NO, Y.AA.ARRANGE.ERR) ;*Manual R22 Conversion
    Y.CUST.SECTOR.VAL = ''
    Y.ACCT.CATEG.VAL = ''
    IF NOT(Y.AA.ARRANGE.ERR) THEN
*ARR.STATUS.VAL = R.AA.ARRANGEMENT<AA.ARR.ARR.STATUS>
        ARR.STATUS.VAL = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrArrStatus> ;*Manual R22 Conversion
*  CURRENCY.VAL = R.AA.ARRANGEMENT<AA.ARR.CURRENCY>
        CURRENCY.VAL = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCurrency> ;*Manual R22 Conversion
*CO.CODE.VAL = R.AA.ARRANGEMENT<AA.ARR.CO.CODE>
        CO.CODE.VAL = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCurrency> ;*Manual R22 Conversion
*Y.LINK.APPL.VAL = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID>
        Y.LINK.APPL.VAL = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId> ;*Manual R22 Conversion
...
*CALL AA.GET.PERIOD.BALANCES(Y.LINK.APPL.VAL, BALANCE.TO.CHECK, DATE.OPTIONS,Y.START.DATE ,Y.END.DATE , "", BAL.DETAILS, "")
            AA.Framework.GetPeriodBalances(Y.LINK.APPL.VAL, BALANCE.TO.CHECK, DATE.OPTIONS,Y.START.DATE ,Y.END.DATE , "", BAL.DETAILS, "");* R22 Utility Changes
            IF BAL.DETAILS THEN

* @ValidationCode : MjotMTk5OTY1OTUyMjpVVEYtODoxNzA1OTA0MjUzOTI0OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Jan 2024 11:47:33
...
SUBROUTINE REDO.E.BLD.VAL.ACCOUNT.LCK(ENQ.DATA)
*------------------------------------------------------------------------
...
*-----------------------------------------
    ...
    Y.CUS=''
    Y.ID = "ACCOUNT" ;*Manual R22 Conversion
* CALL F.READ(FN.REDO.RESTRICT.ENQ.DATA,'ACCOUNT',R.REDO.RESTRICT.ENQ.DATA,F.REDO.RESTRICT.ENQ.DATA,ERR)
    CALL F.READ(FN.REDO.RESTRICT.ENQ.DATA, Y.ID,R.REDO.RESTRICT.ENQ.DATA,F.REDO.RESTRICT.ENQ.DATA,ERR) ;*Manual R22 Conversion - ID variable changed instead of Hardcoding
...
GET.DAO.DETAILS:
*---------------------------------------
    ID.VAR = "SYSTEM" ;*Manual R22 Conversion
* CALL CACHE.READ(FN.REDO.EMPLOYEE.SUPER.USER,'SYSTEM',R.SUPER.USER,SUPER.ERR)
    CALL CACHE.READ(FN.REDO.EMPLOYEE.SUPER.USER,ID.VAR,R.SUPER.USER,SUPER.ERR) ;*Manual R22 Conversion - ID Variable Changed Instead Of Hardcoding

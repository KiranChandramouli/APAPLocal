* @ValidationCode : MjotMTA2NjMwODkwNzpVVEYtODoxNzA1OTE3NDk0MDI4OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Jan 2024 15:28:14
...
*CALL CACHE.READ(FN.MULTI.BRANCH.INTERNAL.ACCOUNT,'SYSTEM',R.MULTI.BRANCH,F.MULTI.BRANCH.INTERNAL.ACCOUNT)
                ...
                CALL CACHE.READ(FN.MULTI.BRANCH.INTERNAL.ACCOUNT,IDVAR.1,R.MULTI.BRANCH,F.MULTI.BRANCH.INTERNAL.ACCOUNT);* R22 Utility Changes

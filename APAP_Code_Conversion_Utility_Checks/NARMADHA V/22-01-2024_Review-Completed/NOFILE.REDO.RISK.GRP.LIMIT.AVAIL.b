* @ValidationCode : MjotNjE4MDM0NDM3OlVURi04OjE3MDU5MDE1MTg3MTc6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Jan 2024 11:01:58
...
* 21-12-2023         Narmadha V            Manual R22 Conversion - Change ID variable instead of Hardcoding, ID Variable initailised
*----------------------------------------------------------------------------
* -----------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*    CALL CACHE.READ(FN.CREDIT.LIMIT.MAINTENANCE,'SYSTEM',R.CR.LIM.MAINT,CR.ERR1)
    CALL CACHE.READ(FN.CREDIT.LIMIT.MAINTENANCE, ID.VAR, R.CR.LIM.MAINT, CR.ERR1) ;*Manual R22 Conversion - Change ID variable instead of Hardcoding

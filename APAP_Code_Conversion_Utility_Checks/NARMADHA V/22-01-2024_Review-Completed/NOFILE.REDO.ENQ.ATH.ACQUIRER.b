* @ValidationCode : MjotMjExMzM3ODM3MzpVVEYtODoxNzA1OTAwNTA1MjUyOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Jan 2024 10:45:05
...
*21-12-2023    Narmadha V          Manual R22 Conversion   ID variable changed instead of Hardcoding, ID variable initailised
*------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*CALL CACHE.READ(FN.REDO.APAP.H.PARAMETER,'SYSTEM',R.REDO.APAP.H.PARAMETER,Y.APAP.ERR)
    CALL CACHE.READ(FN.REDO.APAP.H.PARAMETER,Y.ID,R.REDO.APAP.H.PARAMETER,Y.APAP.ERR) ;*Manual R22 Conversion - ID variable changed instead of Hardcoding

    Y.L.CR.CRD=R.REDO.APAP.H.PARAMETER<PARAM.FTTC.ATHL.CR.CRD>
*Y.L.DR.CRD=R.REDO.APAP.H.PARAMETER<PARAM.FTTC.ATHL.DR.CRD> ;*R22 MANUAL CONVERSION
    Y.I.CR.CRD=R.REDO.APAP.H.PARAMETER<PARAM.FTTC.ATHL.CR.CRD>
*Y.I.DR.CRD=R.REDO.APAP.H.PARAMETER<PARAM.FTTC.ATHI.DR.CRD> ;*R22 MANUAL CONVERSION

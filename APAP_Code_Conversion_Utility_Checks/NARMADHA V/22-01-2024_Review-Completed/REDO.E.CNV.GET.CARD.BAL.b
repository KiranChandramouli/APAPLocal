* @ValidationCode : MjotNDkxMjMzNTA1OlVURi04OjE3MDU5MDU5NzM4MjU6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Jan 2024 12:16:13
...
*CALL CACHE.READ(FN.REDO.SUNNEL.PARAMETER,'SYSTEM',R.REDO.SUNNEL.PARAMETER,ERR)
    CALL CACHE.READ(FN.REDO.SUNNEL.PARAMETER,Y.ID,R.REDO.SUNNEL.PARAMETER,ERR) ;*Manual R22 Conversion - ID Variable changed instead of Hardcoding

* @ValidationCode : MjotMjU0NjYxNjAxOlVURi04OjE3MDU5MTc5MzMwMjU6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Jan 2024 15:35:33
...
*CALL CACHE.READ(FN.REDO.H.APAP.PARAMETER,'SYSTEM',R.REDO.H.APAP.PARAMETER,ERR.OVER) ; * Tus End
    ...
    CALL CACHE.READ(FN.REDO.H.APAP.PARAMETER,IDVAR.1,R.REDO.H.APAP.PARAMETER,ERR.OVER) ; * Tus End;* R22 Utility Changes

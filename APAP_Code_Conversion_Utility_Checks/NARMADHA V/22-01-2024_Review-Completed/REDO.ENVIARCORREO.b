* @ValidationCode : MjotMTY3ODA1MDQ4MTpVVEYtODoxNzA1OTE3ODEwNTA4OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Jan 2024 15:33:30
...
* 19-01-2024    Narmadha V       Manual R22 Conversion,R22 Utility Changes - Id Variable Changed instead of hardcoding, Call routine format modified
*------------------------------------------------------------------------


    $INSERT I_COMMON
    $USING EB.Display ;*Manual R22 Conversion
...
*OPEN '','F.EB.EXTERNAL.USER' TO F.EB.EXTERNAL.USER ELSE
    OPEN '',FN.EB.EXT.USER TO F.EB.EXTERNAL.USER ELSE ;* Manual R22 Changes
...
*CALL REBUILD.SCREEN
    EB.Display.RebuildScreen();* R22 Utility Changes

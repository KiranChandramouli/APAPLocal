* @ValidationCode : MjoxODA3MTkyNDUzOlVURi04OjE3MDU5MjQwNjMyNTM6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Jan 2024 17:17:43
...
*CALL CACHE.READ(FN.ACCT.RESTRICT.PARAMETER,'SYSTEM',R.ACCT.RESTRICT.PARAMETER,RESTR.ERR)
    ...
    CALL CACHE.READ(FN.ACCT.RESTRICT.PARAMETER,IDVAR.1,R.ACCT.RESTRICT.PARAMETER,RESTR.ERR);* R22 Utility Changes

* @ValidationCode : MjotNDYwOTAxMTIxOlVURi04OjE3MDU5MjU2MDg2Nzk6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Jan 2024 17:43:28
...
*    CALL F.READ(FN.AA.ARRANGEMENT,Y.AA.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,AA.ARRANGEMENT.ERR)
    R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(Y.AA.ID, AA.ARRANGEMENT.ERR) ;*Manual R22 Conversion
    IF R.AA.ARRANGEMENT THEN
*        Y.LINKED.APPL      = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL>
        Y.LINKED.APPL      = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedAppl> ;*Manual R22 Conversion
*        Y.LINKED.APPL.ID   = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID>
        Y.LINKED.APPL.ID   = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId> ;*Manual R22 Conversion
*        Y.CUST             = R.AA.ARRANGEMENT<AA.ARR.CUSTOMER>
        Y.CUST             = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer> ;*Manual R22 Conversion
*        Y.PRODUCT.TY = R.AA.ARRANGEMENT<AA.ARR.PRODUCT>
        Y.PRODUCT.TY = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct> ;*Manual R22 Conversion
*        Y.AA.START.DATE = R.AA.ARRANGEMENT<AA.ARR.START.DATE>
        Y.AA.START.DATE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrStartDate> ;*Manual R22 Conversion
...
*        CALL F.READ(FN.AA.ARRANGEMENT.ACTIVITY,Y.TRANSACTION.REF,R.AA.ARRANGEMENT.ACTIVITY,F.AA.ARRANGEMENT.ACTIVITY,Y.AA.ARRANGEMENT.ERR)
        R.AA.ARRANGEMENT.ACTIVITY = AA.Framework.ArrangementActivity.Read(Y.TRANSACTION.REF, Y.AA.ARRANGEMENT.ERR) ;*Manual R22 Conversion

        Y.TRANS.ID = ''
        IF R.AA.ARRANGEMENT.ACTIVITY THEN
*            Y.TRANS.ID = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.CONTRACT.ID>
            Y.TRANS.ID = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.ArrangementActivity.ArrActTxnContractId> ;*Manual R22 Conversion
        END ELSE
...
*    CALL F.READ(FN.AA.ARRANGEMENT.ACTIVITY,Y.TRANS.ID,R.AA.ARRANGEMENT.ACTIVITY,F.AA.ARRANGEMENT.ACTIVITY,Y.AA.ARRANGEMENT.ERR)
    R.AA.ARRANGEMENT.ACTIVITY = AA.Framework.ArrangementActivity.Read(Y.TRANS.ID, Y.AA.ARRANGEMENT.ERR) ;*Manual R22 Conversion
    IF R.AA.ARRANGEMENT.ACTIVITY THEN
*        Y.TRANS.ID.1 = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.CONTRACT.ID>
        Y.TRANS.ID.1 = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.ArrangementActivity.ArrActTxnContractId> ;*Manual R22 Conversion
    END ELSE

* @ValidationCode : Mjo3Nzc0ODIyMTY6VVRGLTg6MTcwNTkxNjc2OTExMDpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Jan 2024 15:16:09
...
* 10-01-2024   Narmadha V           Manual R22 Conversion    Call Routine Format Modified
*-----------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_GTS.COMMON
...
*CALL F.READ(FN.REDO.FC.TYPEIDENT,Y.TIPO.DOCUMENTO,R.REDO.FC.TYPEIDENT,F.REDO.FC.TYPEIDENT,"")
    IDVAR.1 = "" ;* Manual R22 Conversion
    CALL F.READ(FN.REDO.FC.TYPEIDENT,Y.TIPO.DOCUMENTO,R.REDO.FC.TYPEIDENT,F.REDO.FC.TYPEIDENT,IDVAR.1);* Manual R22 Conversion
...
*CALL F.READ(FN.REDO.FC.ENQPARMS,Y.ENQPARMS.ID,R.REDO.FC.ENQPARMS,F.REDO.FC.ENQPARMS,"")
        IDVAR.1 = "" ;* Manual R22 Conversion
        CALL F.READ(FN.REDO.FC.ENQPARMS,Y.ENQPARMS.ID,R.REDO.FC.ENQPARMS,F.REDO.FC.ENQPARMS,IDVAR.1);*Manual R22 Conversion
        RETURN
*END
...
*CALL F.READ(FN.REDO.FC.GENERICO,Y.ID.APP,R.REDO.FC.GENERICO,F.REDO.FC.GENERICO,"")
        IDVAR.1 = "" ;*Manual R22 Conversion
        CALL F.READ(FN.REDO.FC.GENERICO,Y.ID.APP,R.REDO.FC.GENERICO,F.REDO.FC.GENERICO,IDVAR.1);* Manual R22 Conversion
...
*CALL F.READ(FN.ACCOUNT,Y.CUENTA,R.ACCOUNT,F.ACCOUNT,"")
        IDVAR.1 = "" ;*Manual R22 Conversion
        CALL F.READ(FN.ACCOUNT,Y.CUENTA,R.ACCOUNT,F.ACCOUNT,IDVAR.1);*Manual R22 Conversion
...
*CALL GET.LOC.REF (Y.APLICACION,Y.FIELD.NAME,Y.FIELD.NO)
        EB.LocalReferences.GetLocRef (Y.APLICACION,Y.FIELD.NAME,Y.FIELD.NO);*Manual R22 Conversion
...
*CALL F.READ(FN.CONCAT,ID.CLIENT.SIGNER,R.CONCAT.TEMP,F.CONCAT,"")
            IDVAR.1 = "" ;*Manual R22 Conversion
            CALL F.READ(FN.CONCAT,ID.CLIENT.SIGNER,R.CONCAT.TEMP,F.CONCAT,IDVAR.1);*Manual R22 Conversion
...
*CALL F.READ(FN.CONCAT,ID.CLIENT.TEMP,R.CONCAT.1,F.CONCAT,"")
            ...
            CALL F.READ(FN.CONCAT,ID.CLIENT.TEMP,R.CONCAT.1,F.CONCAT,IDVAR.1);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.CONCAT,ID.CLIENT.TEMP,R.CONCAT.2,F.CONCAT,"")
        IDVAR.1 = "" ;*Manual R22 Conversion
        CALL F.READ(FN.CONCAT,ID.CLIENT.TEMP,R.CONCAT.2,F.CONCAT,IDVAR.1);*Manual R22 Conversion
...
*CALL F.READ(FN.REDO.FC.ENQMAIN,Y.TIPO.CLIENTE,R.REDO.FC.ENQMAIN,F.REDO.FC.ENQMAIN,"")
    IDVAR.1 = "" ;*Manual R22 Conversion
    CALL F.READ(FN.REDO.FC.ENQMAIN,Y.TIPO.CLIENTE,R.REDO.FC.ENQMAIN,F.REDO.FC.ENQMAIN,IDVAR.1);*Manual R22 Conversion
    IF NOT(R.REDO.FC.ENQMAIN) THEN
        RETURN
    END
...
*CALL F.READ(FN.REDO.FC.GENERICO,Y.NRO.DOCUMENTO,R.REDO.FC.GENERICO,F.REDO.FC.GENERICO,"")
    IDVAR.1 = "" ;* Manual R22 Conversion
    CALL F.READ(FN.REDO.FC.GENERICO,Y.NRO.DOCUMENTO,R.REDO.FC.GENERICO,F.REDO.FC.GENERICO,IDVAR.1);*Manual R22 Conversion
...
*CALL F.READ(FN.CUSTOMER,ID.CLIENT,R.CUSTOMER,F.CUSTOMER,"")
        IDVAR.1 = "" ;* Manual R22 Conversion
        CALL F.READ(FN.CUSTOMER,ID.CLIENT,R.CUSTOMER,F.CUSTOMER,IDVAR.1);*Manual R22 Conversion
    END

* @ValidationCode : Mjo3NTM0MTcyMzQ6VVRGLTg6MTcwNTkwMDg4NDEwNjpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Jan 2024 10:51:24
...
* All selection fields related to REDO.ISSUE.REQUESTS application are processed here
    ...
    IF D.FIELDS NE '' THEN
        ...
        APAP.REDOENQ.redoEFormSelStmt(FILE.NAME, '', '', SEL.REQUESTS.CMD) ;*Manual R22 conversion

* @ValidationCode : Mjo2NjA5MTI0MTk6VVRGLTg6MTcwNTkwMTM4MzU2NTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Jan 2024 10:59:43
...
*CALL CACHE.READ(FN.CREDIT.LIMIT.MAINTENANCE,'SYSTEM',R.CR.LIM.MAINT,CR.ERR1)
        CALL CACHE.READ(FN.CREDIT.LIMIT.MAINTENANCE,Y.ID,R.CR.LIM.MAINT,CR.ERR1) ;*Manual R22 Conversion - Change ID variable instead of Hardcoding

* @ValidationCode : Mjo0NTM5NzI2NTg6VVRGLTg6MTcwNTkxNjU2OTI2OTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Jan 2024 15:12:49
...
* 19.01.2024       Narmadha V       Manual R22 Conversion   Call Routine Format Modified, Change ID variable instead of Hardcoding
*--------------------------------------------------------------------------------------------------------------------------
...
*CALL CACHE.READ(FN.REDO.AML.PARAM,'SYSTEM',R.REDO.AML.PARAM,ERR.RAP)
    IDVAR.1 = 'SYSTEM' ;* Manual R22 Conversion
    CALL CACHE.READ(FN.REDO.AML.PARAM,IDVAR.1,R.REDO.AML.PARAM,ERR.RAP);* Manual R22 Conversion
...
*CALL GET.LOC.REF('CUSTOMER','L.CU.TIPO.CL',LOC.L.CU.TIPO.CL.POS)
    EB.LocalReferences.GetLocRef('CUSTOMER','L.CU.TIPO.CL',LOC.L.CU.TIPO.CL.POS) ;* Manual R22 Conversion
*
RETURN
*----------------------------------------------------------------------------------------------------------------------------

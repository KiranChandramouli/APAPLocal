* @ValidationCode : MjotMTcwMzA1OTY2NzpVVEYtODoxNzA1OTg4MTM1MjAxOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 23 Jan 2024 11:05:35
...
* 08-01-2024         Narmadha V            Manual R22 Coversion    Change F.READ to CACHE.READ,ID Variable used instead of hardcoding
*------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*CALL CACHE.READ(FN.ACCOUNT.PARAMETER,'SYSTEM',R.ACCT.PARAM,ACCT.ERR)
    ...
    CALL CACHE.READ(FN.ACCOUNT.PARAMETER,IDVAR.1,R.ACCT.PARAM,ACCT.ERR);* R22 Utility Changes
...
*CALL F.READ(FN.AZ.ACCOUNT,Y.ACC.NO,R.AZ.ACCOUNT,F.AZ.ACCOUNT,AZ.ERR)
                CALL CACHE.READ(FN.AZ.ACCOUNT,Y.ACC.NO,R.AZ.ACCOUNT,AZ.ERR) ;*Manual R22 Conversion

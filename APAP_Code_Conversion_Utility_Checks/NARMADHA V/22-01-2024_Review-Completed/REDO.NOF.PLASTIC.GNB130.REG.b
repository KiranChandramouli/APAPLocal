* @ValidationCode : MjotMTQ4ODYxOTQzOlVURi04OjE3MDQ2OTU1NDE3NDM6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 08 Jan 2024 12:02:21
...
* 08-01-2024      Narmadha  V       Manual R22 Coversion       CALL OPF changed, F.READ to CACHE.READ,ID Variable used instead of hardcoding
*-------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    ...
    $USING EB.LocalReferences ;*Manual R22 Coversion
...
*CALL F.READ(FN.REDO.H.REPORTS.PARAM,IDVAR.1,R.REDO.H.REPORTS.PARAM,F.REDO.H.REPORTS.PARAM,ERR);* R22 Utility Changes
    CALL CACHE.READ(FN.REDO.H.REPORTS.PARAM,IDVAR.1,R.REDO.H.REPORTS.PARAM,ERR);* Manual R22 Conversion
...
*CALL GET.LOC.REF(LOC.REF.APPL,LOC.REF.FIELDS,LOC.REF.POS)
    EB.LocalReferences.GetLocRef(LOC.REF.APPL,LOC.REF.FIELDS,LOC.REF.POS);* R22 Utility Changes

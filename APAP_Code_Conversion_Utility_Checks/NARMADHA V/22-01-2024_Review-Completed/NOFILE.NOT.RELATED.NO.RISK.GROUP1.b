* @ValidationCode : MjoxOTAyMTA0MDMwOlVURi04OjE3MDU4OTk4OTc0MTU6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Jan 2024 10:34:57
...
* 21-12-2023      Narmadha V        Manual R22 Conversion      Replaced ID variable insted of Hardcoding, Initialised ID Variable
* -----------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*CALL CACHE.READ(FN.CREDIT.LIMIT.MAINTENANCE,'SYSTEM',R.CR.LIM.MAINT,CR.ERR1)
    CALL CACHE.READ(FN.CREDIT.LIMIT.MAINTENANCE,Y.ID,R.CR.LIM.MAINT,CR.ERR1) ;*Manual R22 Conversion - Replaced ID variable insted of Hardcoding

* @ValidationCode : Mjo5ODAxOTA5MTE6VVRGLTg6MTcwNTkwNTUyOTI2NTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Jan 2024 12:08:49
...
*26-12-2023    Narmadha V         Manual R22 Conversion    ID variable changed instead of Hardcoding
*-----------------------------------------------------------------------------
...
*CALL CACHE.READ(FN.REDO.AUT.INP.VERSION.NAME,'SYSTEM',R.REDO.AUT.INP.VERSION.NAME,RAIVN.ERR)
    CALL CACHE.READ(FN.REDO.AUT.INP.VERSION.NAME,Y.ID,R.REDO.AUT.INP.VERSION.NAME,RAIVN.ERR) ;*Manual R22 Conversion - ID variable changed instead of Hardcoding
    Y.INP.VERSION.NAME  = R.REDO.AUT.INP.VERSION.NAME<REDO.PRE.INP.VER.NAME>
    CHANGE @VM TO @FM IN Y.INP.VERSION.NAME ;*R22 AUTO CONVERSION
    Y.AUTH.VERSION.NAME = R.REDO.AUT.INP.VERSION.NAME<REDO.PRE.AUTH.VER.NAME>
    CHANGE @VM TO @FM IN Y.AUTH.VERSION.NAME ;*R22 AUTO CONVERSION
    Y.DELT.VERSION.NAME = R.REDO.AUT.INP.VERSION.NAME<REDO.PRE.DEL.VER.NAME>
    CHANGE @VM TO @FM IN Y.DELT.VERSION.NAME ;*R22 AUTO CONVERSION
 
*CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,'SYSTEM',R.REDO.APAP.CLEAR.PARAM,PARAM.ERR)
    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,Y.ID,R.REDO.APAP.CLEAR.PARAM,PARAM.ERR) ;*Manual R22 Conversion - ID variable changed instead of Hardcoding
...
*------------
*
    WAPPL        = 'USER' : @FM : 'FUNDS.TRANSFER' : @FM : 'TELLER' : @FM : 'T24.FUND.SERVICES' ;*R22 AUTO CONVERSION
    WCAMPO       = 'L.US.IDC.BR' : @VM : 'L.US.IDC.CODE' : @FM : 'L.ACTUAL.VERSIO' : @FM : 'L.ACTUAL.VERSIO' : @VM : 'T24.FS.REF' : @FM : 'L.T24FS.TRA.DAY' ;*R22 AUTO CONVERSION
    YPOS         = ''
...
*----------
*
    Y.DATA.CNT = "" ; Y.DATA.CNT = DCOUNT(Y.DATA.TMP,@FM) ; Y.CNT = 1 ;*R22 AUTO CONVERSION
...
*
    R.USER.ARR = '' ; YERR = ''
    CALL CACHE.READ(FN.USER, Y.APP.USER, R.USER.ARR, YERR) ;*R22 AUTO CONVERSION

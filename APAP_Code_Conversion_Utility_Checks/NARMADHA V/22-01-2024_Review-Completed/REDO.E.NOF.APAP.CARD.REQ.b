* @ValidationCode : MjotNjg4OTMxNjpVVEYtODoxNzA1OTE2NjA1NTI5OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Jan 2024 15:13:25
...
* 19.01.2024       Narmadha V       R22 Utility Changes     Call routine format modified
* ----------------------------------------------------------------------------
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
    ...
    $USING EB.LocalReferences ;*R22 Utility Changes
*
...
*CALL GET.LOC.REF(Y.LRF.APPL, Y.LRF.FIELDS, FIELD.POS)
    EB.LocalReferences.GetLocRef(Y.LRF.APPL, Y.LRF.FIELDS, FIELD.POS);* R22 Utility Changes
*

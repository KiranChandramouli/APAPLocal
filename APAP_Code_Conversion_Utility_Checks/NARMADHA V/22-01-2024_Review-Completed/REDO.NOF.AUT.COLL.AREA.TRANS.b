* @ValidationCode : MjotMTg5MjgzMDY0MjpVVEYtODoxNzA1OTE3OTU0NjM3OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Jan 2024 15:35:54
...
*CALL CACHE.READ(FN.REDO.REPAY.NEXT.VER.PROCESS,'SYSTEM',R.REDO.REPAY.NEX,RE.ERR)
    ...
    CALL CACHE.READ(FN.REDO.REPAY.NEXT.VER.PROCESS,IDVAR.1,R.REDO.REPAY.NEX,RE.ERR);* R22 Utility Changes

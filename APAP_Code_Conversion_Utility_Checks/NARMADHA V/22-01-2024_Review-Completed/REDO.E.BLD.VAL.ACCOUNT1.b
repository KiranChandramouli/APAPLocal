* @ValidationCode : MjozNTQ3MDE2NjpVVEYtODoxNzA1OTA0Mjc3NTA5OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Jan 2024 11:47:57
...
*CALL CACHE.READ(FN.REDO.EMPLOYEE.SUPER.USER,'SYSTEM',R.SUPER.USER,SUPER.ERR)
    CALL CACHE.READ(FN.REDO.EMPLOYEE.SUPER.USER,Y.ID,R.SUPER.USER,SUPER.ERR) ;*Manual R22 Conversion - Id Variable Changed instead of Hardcoding

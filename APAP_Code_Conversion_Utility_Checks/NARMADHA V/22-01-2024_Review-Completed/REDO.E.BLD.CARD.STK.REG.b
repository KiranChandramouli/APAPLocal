* @ValidationCode : MjotNTE0Nzc3MDE5OlVURi04OjE3MDU5MDE2ODg1Mjg6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Jan 2024 11:04:48
...
* 22-12-2023         Narmadha V            Manual R22 Conversion - Changed FN & ID variable instead of Hardcoding, ID Variable initailised
* ----------------------------------------------------------------------------
...
* CALL CACHE.READ('F.REDO.CARD.SERIES.PARAM','SYSTEM',R.REDO.CARD.SERIES.PARAM,PARAM.ERR)
    CALL CACHE.READ(FN.REDO.CARD.SERIES.PARAM, Y.ID,R.REDO.CARD.SERIES.PARAM,PARAM.ERR) ;*Manual R22 Conversion - Changed FN & ID variable instead of Hardcoding

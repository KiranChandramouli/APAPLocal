* @ValidationCode : MjotMTA1OTY3NDM3NTpVVEYtODoxNzA1OTIzNDI2MzU3OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Jan 2024 17:07:06
...
* 19-01-2024         Narmadha V            R22 Utility Changes   Call Routine Format Modified,ID variable used instead of hardcoding
*------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*CALL CACHE.READ(FN.REDO.INTERFACE.C18.PARAM,'SYSTEM',R.REDO.INTERFACE.C18.PARAM,RES.ERR)
    IDVAR.1 = 'SYSTEM' ;* R22 Utility Changes
    CALL CACHE.READ(FN.REDO.INTERFACE.C18.PARAM,IDVAR.1,R.REDO.INTERFACE.C18.PARAM,RES.ERR);* R22 Utility Changes

* @ValidationCode : MjotNjI0NTgwMTYzOlVURi04OjE3MDI1NzU3NzM5MjQ6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 14 Dec 2023 23:12:53
...
* 21 AUG 2023    Narmadha V                    Manual R22 Conversion                 SM to @SM
* 14-12-2023     Narmadha V                    Manual R22 Conversion                 Changes in F variable , Call OPF added
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*        AF = 6
        ...
        BEGIN CASE
            ...
            CASE APPL.TXN.ID NE ''
                APPL.ERR = ''
                F.APPL = ""
                CALL OPF(FN.APPL,F.APPL) ;*Manual R22 Conversion - Call OPF added
* CALL F.READ(FN.APPL, APPL.TXN.ID, R.APPL.TXN, '', APPL.ERR)
                CALL F.READ(FN.APPL, APPL.TXN.ID, R.APPL.TXN, F.APPL, APPL.ERR) ;*Manual R22 Conversion - Changes in F variable.
                IF APPL.ERR THEN

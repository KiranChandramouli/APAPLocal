* @ValidationCode : MjoxNjE1MzkxMzYzOlVURi04OjE3MDI4Nzg5MDExODM6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 18 Dec 2023 11:25:01
...
*CALL CACHE.READ(FN.REDO.COB.NCF.CHARGES,'SYSTEM',R.REDO.COB.NCF.CHARGES,ERR)
    CALL CACHE.READ(FN.REDO.COB.NCF.CHARGES,Y.ID,R.REDO.COB.NCF.CHARGES,ERR) ;*Manual R22 Conversion
...
*   PGM.VERSION='FUNDS.TRANSFER'      ; * PACS00528405
        ...
        IF PAY.TYPE EQ 'STO' THEN
            FT.ID = ID.NEW
*CALL REDO.STO.NCF.UPDATE(VAR.NCF.REQ,VAR.CURRENCY,VAR.CHARGE.AMOUNT,VAR.TAX.AMOUNT)
            APAP.TAM.redoStoNcfUpdate(VAR.NCF.REQ,VAR.CURRENCY,VAR.CHARGE.AMOUNT,VAR.TAX.AMOUNT);*Manual R22 conversion
...
*CALL REDO.NCF.PERF.RTN(Y.CNT,Y.NCF.NO.LIST)
    APAP.TAM.redoNcfPerfRtn(Y.CNT,Y.NCF.NO.LIST);*Manual R22 conversion

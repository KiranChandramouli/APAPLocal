* @ValidationCode : MjotODc5NTMwMTAxOlVURi04OjE3MDQzNDUzOTQ5NDU6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jan 2024 10:46:34
...
*    Y.CO.CODE = R.AA<AA.ARR.CO.CODE>
    Y.CO.CODE = R.AA<AA.Framework.ArrangementSim.ArrCoCode>
...
*    Y.CUS.ID = R.AA<AA.ARR.CUSTOMER>
    Y.CUS.ID = R.AA<AA.Framework.ArrangementSim.ArrCustomer>
*    Y.CUR = R.AA<AA.ARR.CURRENCY>
    Y.CUR = R.AA<AA.Framework.Arrangement.ArrCurrency>
*   Y.OPEN.DATE = R.AA<AA.ARR.PROD.EFF.DATE>
    Y.OPEN.DATE = R.AA<AA.Framework.ArrangementSim.ArrProdEffDate>
...
*Y.CHLD.AAA = R.AAA<AA.ARR.ACT.CHILD.ACTIVITY> ;
        Y.CHLD.AAA = R.AAA<AA.Framework.SimulationCapture.ArrActChildActivity>
...
*Y.CHLD.AAA<1,-1> = R.AAA<AA.ARR.ACT.CHILD.ACTIVITY>
                    Y.CHLD.AAA<1,-1> = R.AAA<AA.Framework.SimulationCapture.ArrActChildActivity>
...
*LOCATE Y.AAA.ID IN R.AA.ACT.BAL<AA.ACT.BAL.ACTIVITY.REF,1> SETTING POS.AAA THEN
    LOCATE Y.AAA.ID IN R.AA.ACT.BAL<AA.Framework.ActivityBalances.ActBalActivityRef,1> SETTING POS.AAA THEN
*Y.PROPS = R.AA.ACT.BAL<AA.ACT.BAL.PROPERTY,POS.AAA>
        Y.PROPS = R.AA.ACT.BAL<AA.Framework.ActivityBalances.ActBalProperty>
*Y.PROPS.AMTS = R.AA.ACT.BAL<AA.ACT.BAL.PROPERTY.AMT,POS.AAA>
        Y.PROPS.AMTS = R.AA.ACT.BAL<AA.Framework.ActivityBalances.ActBalPropertyAmt>

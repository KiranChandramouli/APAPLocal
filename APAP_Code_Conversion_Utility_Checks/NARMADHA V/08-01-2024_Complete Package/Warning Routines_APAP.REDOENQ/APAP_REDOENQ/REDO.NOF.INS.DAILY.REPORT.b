* @ValidationCode : Mjo0OTg1NDYzMzQ6VVRGLTg6MTcwNDM2ODY5NzY1OTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:14:57
...
*    CALL F.READ(FN.AA.ARRANGEMENT,Y.AA.ID,R.ARRANGEMENT,F.AA.ARRANGEMENT,ARR.ERR)
    R.ARRANGEMENT = AA.Framework.Arrangement.Read(Y.AA.ID, ARR.ERR)
*    Y.AGENCY        = R.ARRANGEMENT<AA.ARR.CO.CODE>
    Y.AGENCY        = R.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCoCode>
*    Y.CUST          = R.ARRANGEMENT<AA.ARR.CUSTOMER>
    Y.CUST          = R.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer>
...
*    Y.PRODUCT.TYPE  = R.ARRANGEMENT<AA.ARR.PRODUCT>
    Y.PRODUCT.TYPE  = R.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct>

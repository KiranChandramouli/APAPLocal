* @ValidationCode : Mjo5MTc3NTU4NDk6VVRGLTg6MTcwNDI2NjUyMTU2NTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 Jan 2024 12:52:01
...
*CALL F.READ(FN.AA.ARRANGEMENT,Y.ARR.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,Y.READ.AA.ERR)
    R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(Y.ARR.ID, Y.READ.AA.ERR)
...
*Y.PROD.TYPE      = R.AA.ARRANGEMENT<AA.ARR.PRODUCT>
    Y.PROD.TYPE      = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct>

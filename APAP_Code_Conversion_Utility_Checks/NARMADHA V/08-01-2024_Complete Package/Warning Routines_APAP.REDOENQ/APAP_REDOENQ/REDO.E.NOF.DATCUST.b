* @ValidationCode : Mjo1MjM2MDE5MzQ6Q3AxMjUyOjE3MDI5OTA4OTM3MjQ6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
CALL F.READ(FN.REDO.FC.TYPEIDENT,Y.TIPO.DOCUMENTO,R.REDO.FC.TYPEIDENT,F.REDO.FC.TYPEIDENT,IDVAR.1);* R22 AUTO CONVERSION
...
IDVAR.1 = "" ;* R22 AUTO CONVERSION
CALL F.READ(FN.REDO.FC.ENQPARMS,Y.ENQPARMS.ID,R.REDO.FC.ENQPARMS,F.REDO.FC.ENQPARMS,IDVAR.1);* R22 AUTO CONVERSION
...
IDVAR.1 = "" ;* R22 AUTO CONVERSION
CALL F.READ(FN.REDO.FC.GENERICO,Y.ID.APP,R.REDO.FC.GENERICO,F.REDO.FC.GENERICO,IDVAR.1);* R22 AUTO CONVERSION
...
IDVAR.1 = "" ;* R22 AUTO CONVERSION
CALL F.READ(FN.ACCOUNT,Y.CUENTA,R.ACCOUNT,F.ACCOUNT,IDVAR.1);* R22 AUTO CONVERSION
...
EB.LocalReferences.GetLocRef (Y.APLICACION,Y.FIELD.NAME,Y.FIELD.NO);* R22 AUTO CONVERSION
...
IDVAR.1 = "" ;* R22 AUTO CONVERSION
CALL F.READ(FN.CONCAT,ID.CLIENT.SIGNER,R.CONCAT.TEMP,F.CONCAT,IDVAR.1);* R22 AUTO CONVERSION
...
IDVAR.1 = "" ;* R22 AUTO CONVERSION
CALL F.READ(FN.CONCAT,ID.CLIENT.TEMP,R.CONCAT.2,F.CONCAT,IDVAR.1);* R22 AUTO CONVERSION
...
IDVAR.1 = "" ;* R22 AUTO CONVERSION
CALL F.READ(FN.REDO.FC.ENQMAIN,Y.TIPO.CLIENTE,R.REDO.FC.ENQMAIN,F.REDO.FC.ENQMAIN,IDVAR.1);* R22 AUTO CONVERSION
IF NOT(R.REDO.FC.ENQMAIN) THEN
RETURN
END
...
IDVAR.1 = "" ;* R22 AUTO CONVERSION
CALL F.READ(FN.REDO.FC.GENERICO,Y.NRO.DOCUMENTO,R.REDO.FC.GENERICO,F.REDO.FC.GENERICO,IDVAR.1);* R22 AUTO CONVERSION
...
IDVAR.1 = "" ;* R22 AUTO CONVERSION
CALL F.READ(FN.CUSTOMER,ID.CLIENT,R.CUSTOMER,F.CUSTOMER,IDVAR.1);* R22 AUTO CONVERSION
END

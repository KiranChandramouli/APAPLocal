* @ValidationCode : MjotMjEwMTE5ODQzNjpVVEYtODoxNzA0MjY5MjY4NDYxOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 Jan 2024 13:37:48
...
*    CALL F.READ(FN.AA.ARRANGEMENT,Y.AA.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,AA.ARR.ERR)
    R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(Y.AA.ID, AA.ARR.ERR)
*    X.LOAN.BOOK.TYPE     = R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP>
    X.LOAN.BOOK.TYPE     = R.AA.ARRANGEMENT< AA.Framework.ArrangementSim.ArrProductGroup>
* X.LOAN.PRODUCT.TYPE  = R.AA.ARRANGEMENT<AA.ARR.PRODUCT> ;  X.LOAN.NUMBER        = Y.AA.ID
    X.LOAN.PRODUCT.TYPE  = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct> ;  X.LOAN.NUMBER        = Y.AA.ID
*X.CURRENCY           = R.AA.ARRANGEMENT<AA.ARR.CURRENCY>;  X.LOAN.SOURCE.AGENCY = R.AA.ARRANGEMENT<AA.ARR.CO.CODE>
    X.CURRENCY           = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCurrency>;  X.LOAN.SOURCE.AGENCY = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCoCode>
RETURN
*----------------------------------------------------------------------------------------
GET.ARR.CONDITION:
*----------------------------------------------------------------------------------------
...
*ARR.INFO = ''        ;       Y.EFF.DATE = R.AA.ARRANGEMENT<AA.ARR.PROD.EFF.DATE>
    ARR.INFO = ''        ;       Y.EFF.DATE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProdEffDate>
...
*CALL F.READ(FN.AA.ACTIVITY.HISTORY,Y.AA.ID,R.AA.ACTIVITY.HISTORY,F.AA.ACTIVITY.HISTORY,ACT.HIS.ERR)
    R.AA.ACTIVITY.HISTORY = AA.Framework.ActivityHistory.Read(Y.AA.ID, ACT.HIS.ERR)
...
*Y.ACTIVITY       = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY>
        Y.ACTIVITY       = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistoryHist.AhActivity>
    END
    LOOP
...
*CALL F.READ(FN.AA.ARRANGEMENT.ACTIVITY,Y.ACTIVITY.REF.ID,R.AA.ARRANGEMENT.ACTIVITY,F.AA.ARRANGEMENT.ACTIVITY,ARR.ACTY.ERR)
    R.AA.ARRANGEMENT.ACTIVITY = AA.Framework.ArrangementActivity.Read(Y.ACTIVITY.REF.ID, ARR.ACTY.ERR)
    IF Y.EFFECTIVE.DATE EQ '' THEN
*   Y.EFFECTIVE.DATE     = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.EFFECTIVE.DATE>
        Y.EFFECTIVE.DATE     = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.SimulationCapture.ArrActEffectiveDate>
...
*   Y.EFFECTIVE.DATE<-1> = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.EFFECTIVE.DATE>
        Y.EFFECTIVE.DATE<-1> = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.SimulationCapture.ArrActEffectiveDate>
*    Y.TXN.AMOUNT<-1>     = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.AMOUNT>
        Y.TXN.AMOUNT<-1>     = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.SimulationCapture.ArrActTxnAmount>
    END
RETURN
*----------------------------------------------------------------------------------------
...
*       Y.DISB.AMT += R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.AMOUNT>
        Y.DISB.AMT += R.AA.ARRANGEMENT.ACTIVITY< AA.Framework.SimulationCapture.ArrActTxnAmount>
    END
RETURN
*----------------------------------------------------------------------------------------
...
*   Y.CUS = R.AA.ARRANGEMENT<AA.ARR.CUSTOMER>
    Y.CUS = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer>
...
*    Y.AA.PROPERTY = R.AA.ARRANGEMENT<AA.ARR.PROPERTY>
    Y.AA.PROPERTY = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProperty>
    LOOP
...
*    Y.EFF.DATE = R.AA.ARRANGEMENT<AA.ARR.PROD.EFF.DATE>
    Y.EFF.DATE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProdEffDate>
    ARR.INFO<1> = Y.AA.ID     ;  R.ARRANGEMENT = ''
*CALL AA.GET.ARRANGEMENT.PROPERTIES(ARR.INFO,Y.EFF.DATE,R.ARRANGEMENT,PROP.LIST)
    AA.Framework.GetArrangementProperties(ARR.INFO,Y.EFF.DATE,R.ARRANGEMENT,PROP.LIST);* R22 Utility Changes

* @ValidationCode : MjotNjA2OTIwODY1OlVURi04OjE3MDMyNTAxMDU0Mjg6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Dec 2023 18:31:45
...
* 22-12-2023       Narmadha V       Manual R22 Conversion      Changed ID variable instead of Hardcoding,F.READ to F.READU
* -----------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_TT.COMMON
...
**************************
    Y.ID = "REDO.H.BAT.CHQ.DETAILS" ;*Manual R22 Conversion
*CALL F.READU(FN.LOCKING,'REDO.H.BAT.CHQ.DETAILS',R.LOCKING,F.LOCKING,LOCK.ERR,RETRY)
    CALL F.READU(FN.LOCKING,Y.ID,R.LOCKING,F.LOCKING,LOCK.ERR,RETRY) ;*Manual R22 Conversion - ID variable changed instead of hardcoding
...
*CALL F.WRITE(FN.LOCKING,'REDO.H.BAT.CHQ.DETAILS',R.LOCKING)
    CALL F.WRITE(FN.LOCKING,Y.ID,R.LOCKING) ;*Manual R22 Conversion - ID variable changed instead of hardcoding
...
* CALL F.READ(FN.REDO.H.BAT.CHQ.DETAILS,Y.ID,R.REDO.H.BAT.CHQ.DETAILS,F.REDO.H.BAT.CHQ.DETAILS,Y.ERR)
    CALL F.READU(FN.REDO.H.BAT.CHQ.DETAILS,Y.ID,R.REDO.H.BAT.CHQ.DETAILS,F.REDO.H.BAT.CHQ.DETAILS,Y.ERR,'') ;*Manual R22 Conversion - F.READ to F.READU
...
*CALL F.READ(FN.REDO.H.CLEARING.OUTWARD,Y.CLR.OUTWARD.ID1,R.CLR.OUTWARD.RECORD,F.REDO.H.CLEARING.OUTWARD,CLR.ERR)
        CALL F.READU(FN.REDO.H.CLEARING.OUTWARD,Y.CLR.OUTWARD.ID1,R.CLR.OUTWARD.RECORD,F.REDO.H.CLEARING.OUTWARD,CLR.ERR,'') ;*Manual R22 Conversion - F.READ to F.READU
...
*CALL F.READ(FN.REDO.H.CHECK.CLEARING.SCREEN,Y.CLR.OUTWARD.ID1,R.REDO.H.CHECK.CLEARING.SCREEN,F.REDO.H.CHECK.CLEARING.SCREEN,Y.ERROR)
        CALL F.READU(FN.REDO.H.CHECK.CLEARING.SCREEN,Y.CLR.OUTWARD.ID1,R.REDO.H.CHECK.CLEARING.SCREEN,F.REDO.H.CHECK.CLEARING.SCREEN,Y.ERROR,'') ;*Manual R22 Conversion - F.READ to F.READU

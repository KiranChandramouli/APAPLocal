* @ValidationCode : MjotMTI2MzA4NDAxMTpVVEYtODoxNzA0MzYwOTI3MDA5OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 15:05:27
...
*CALL CACHE.READ(FN.REDO.EXCEP.REC.PARAM,'SYSTEM',R.REDO.EXCEP.REC.PARAM,EXCEP.ERR)
    ...
    CALL CACHE.READ(FN.REDO.EXCEP.REC.PARAM,IDVAR.1,R.REDO.EXCEP.REC.PARAM,EXCEP.ERR);* R22 Utility Changes

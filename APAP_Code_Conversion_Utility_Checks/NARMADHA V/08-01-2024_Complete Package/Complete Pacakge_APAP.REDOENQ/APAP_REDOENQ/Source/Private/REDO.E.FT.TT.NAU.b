* @ValidationCode : MjotMTk2MzY3MDc5MTpVVEYtODoxNzA0MTc3NTAxMTI2OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 02 Jan 2024 12:08:21
...
*02-01-20234   Narmadha V          Manual R22 Conversion   ID variable Changed instead of Hardcoding
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
* Fix for PACS00349444 [CAN BE AMENDED ONLY USING L.ACTUAL.VERSIO #1]
    ...
    Y.APPLICATION = 'FUNDS.TRANSFER':@FM:'TELLER':@FM:'T24.FUND.SERVICES' ;*R22 AUTO CONVERSION
    Y.FIELDS = 'L.ACTUAL.VERSIO':@FM:'L.ACTUAL.VERSIO':@FM:'L.T24FS.TRA.DAY' ;*R22 AUTO CONVERSION
    Y.POS = ''

* @ValidationCode : MjotMTc4Mjk5MjIyMDpVVEYtODoxNzAzNzcwNTY4MzYxOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Dec 2023 19:06:08
...
* 28-12-2023         Narmadha V            Manual R22 Conversion - FN Variable modified
*------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*-----------
    ...
    APAP.REDOENQ.redoEFormSelStmt(FN.CUSTOMER.NAU, '', '', SEL.CUST.CMD)   ;*R22 Manual Conversion - Added APAP.REDOENQ
...
*CALL F.READ(F.CUSTOMER.NAU,Y.VAL,R.CUSTOMER.NAU,F.CUSTOMER.NAU,CUSTOMER.ERR)
                CALL F.READ(FN.CUSTOMER.NAU,Y.VAL,R.CUSTOMER.NAU,F.CUSTOMER.NAU,CUSTOMER.ERR) ;*Manual R22 Conversion - FN Variable modified

...
CALL CACHE.READ(FN.REDO.AML.PARAM,IDVAR.1,R.REDO.AML.PARAM,ERR.RAP);* R22 AUTO CONVERSION
...
EB.LocalReferences.GetLocRef('CUSTOMER','L.CU.TIPO.CL',LOC.L.CU.TIPO.CL.POS);* R22 AUTO CONVERSION
*
RETURN
*----------------------------------------------------------------------------------------------------------------------------

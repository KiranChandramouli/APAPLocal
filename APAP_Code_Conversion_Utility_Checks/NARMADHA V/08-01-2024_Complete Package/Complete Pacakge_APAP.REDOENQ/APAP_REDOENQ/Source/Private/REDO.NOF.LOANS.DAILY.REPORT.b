* @ValidationCode : MjotNTQ4NzEwNzA6VVRGLTg6MTcwNDM3NTAyMjY5MDpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 04 Jan 2024 19:00:22
...
*    CALL F.READ(FN.AA.ARRANGEMENT,Y.AA.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,AA.ARRANGEMENT.ERR)
    R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(Y.AA.ID, AA.ARRANGEMENT.ERR)
...
*        Y.CUST             = R.AA.ARRANGEMENT<AA.ARR.CUSTOMER>
        Y.CUST             = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer>
*        Y.PRODUCT.TY = R.AA.ARRANGEMENT<AA.ARR.PRODUCT>
        Y.PRODUCT.TY = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct>
*        Y.AA.START.DATE = R.AA.ARRANGEMENT<AA.ARR.START.DATE>
        Y.AA.START.DATE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrStartDate>
...
*        CALL F.READ(FN.AA.ARRANGEMENT.ACTIVITY,Y.TRANSACTION.REF,R.AA.ARRANGEMENT.ACTIVITY,F.AA.ARRANGEMENT.ACTIVITY,Y.AA.ARRANGEMENT.ERR)
        R.AA.ARRANGEMENT.ACTIVITY = AA.Framework.ArrangementActivity.Read(Y.TRANSACTION.REF, Y.AA.ARRANGEMENT.ERR)

        Y.TRANS.ID = ''
        IF R.AA.ARRANGEMENT.ACTIVITY THEN
*            Y.TRANS.ID = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.CONTRACT.ID>
            Y.TRANS.ID = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.ArrangementActivity.ArrActTxnContractId>
        END ELSE
...
*    CALL F.READ(FN.AA.ARRANGEMENT.ACTIVITY,Y.TRANS.ID,R.AA.ARRANGEMENT.ACTIVITY,F.AA.ARRANGEMENT.ACTIVITY,Y.AA.ARRANGEMENT.ERR)
    R.AA.ARRANGEMENT.ACTIVITY = AA.Framework.ArrangementActivity.Read(Y.TRANS.ID, Y.AA.ARRANGEMENT.ERR)
    IF R.AA.ARRANGEMENT.ACTIVITY THEN
*        Y.TRANS.ID.1 = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.CONTRACT.ID>
        Y.TRANS.ID.1 = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.ArrangementActivity.ArrActTxnContractId>
    END ELSE

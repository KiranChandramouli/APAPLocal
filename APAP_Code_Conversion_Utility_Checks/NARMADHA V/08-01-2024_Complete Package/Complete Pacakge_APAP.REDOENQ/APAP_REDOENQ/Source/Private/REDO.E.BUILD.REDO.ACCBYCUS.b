* @ValidationCode : MjoxMDMzNzI1NTc5OlVURi04OjE3MDM1MjE3OTc5ODc6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 25 Dec 2023 21:59:57
...
* 26-12-2023       Narmadha V       Manual R22 Conversion     ID Variable changed instead of Harcoding
*---------------------------------------------------------------------------------
...
* CALL CACHE.READ(FN.AI.REDO.ARCIB.PARAMETER,'SYSTEM',R.AI.REDO.ARCIB.PARAMETER,REDO.ARCIB.ERR)
    CALL CACHE.READ(FN.AI.REDO.ARCIB.PARAMETER,Y.ID,R.AI.REDO.ARCIB.PARAMETER,REDO.ARCIB.ERR) ;*Manual R22 Conversion - ID Variable changed instead of Harcoding

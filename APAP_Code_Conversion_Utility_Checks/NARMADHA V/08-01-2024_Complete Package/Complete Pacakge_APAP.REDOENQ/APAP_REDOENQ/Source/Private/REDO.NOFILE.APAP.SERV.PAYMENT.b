* @ValidationCode : MjotMTc4NzgwODI1NzpVVEYtODoxNzA0NDM5NTUxNDUxOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 12:55:51
...
*CALL CACHE.READ(FN.ARCIB.PARAM,'SYSTEM',R.ARC.REC,ARC.ERR)
    ...
    CALL CACHE.READ(FN.ARCIB.PARAM,IDVAR.1,R.ARC.REC,ARC.ERR);* R22 Utility Changes
    IF R.ARC.REC THEN

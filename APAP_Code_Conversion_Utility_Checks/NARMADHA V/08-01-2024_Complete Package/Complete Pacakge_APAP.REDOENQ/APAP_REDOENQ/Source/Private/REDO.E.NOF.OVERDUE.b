* @ValidationCode : MjotMTI2MjY2Nzc1NzpVVEYtODoxNzA0MjY2Mzc2MDk1OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 Jan 2024 12:49:36
...
*Y.GROUP = R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP>
    Y.GROUP = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup>
*Y.PRODUT= R.AA.ARRANGEMENT<AA.ARR.PRODUCT>
    Y.PRODUT= R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct>
*Y.CUR = R.AA.ARRANGEMENT<AA.ARR.CURRENCY>
    Y.CUR = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCurrency>
*Shek -s
* Get account # from aa.arrangement
    jPos = ''
*LOCATE 'ACCOUNT' IN R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL,1> SETTING jPos THEN
    LOCATE 'ACCOUNT' IN R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedAppl,1> SETTING jPos THEN
*Y.ACC.ID = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID,jPos>
        Y.ACC.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId,jPos>
    END
*Shek -e

* @ValidationCode : MjoxODIyMjkyMjAwOlVURi04OjE3MDQzNzUyMTEyMjU6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jan 2024 19:03:31
...
*    Y.AC.ID = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID>
    Y.AC.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId>
...
*    Y.AAA.IDS = R.AA.ACT.HIS<AA.AH.ACTIVITY.REF> ; Y.AAA.IDS = CHANGE(Y.AAA.IDS,@VM,@SM)    ;*R22 Manual Conversion - changed to AA.AH.ACTIVITY.REF
    Y.AAA.IDS = R.AA.ACT.HIS<AA.Framework.ActivityHistory.AhActivityRef>
...
*    Y.AAA.STS = R.AA.ACT.HIS<AA.AH.ACT.STATUS> ; Y.AAA.STS = CHANGE(Y.AAA.STS,@VM,@SM)
    Y.AAA.STS = R.AA.ACT.HIS<AA.Framework.ActivityHistory.AhActStatus>
    Y.AAA.STS = CHANGE(Y.AAA.STS,@VM,@SM)

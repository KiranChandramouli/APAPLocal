* @ValidationCode : MjotMTgyMjU3ODAyMDpVVEYtODoxNzA0MzQ3NTM1NTM1OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 11:22:15
...
*CALL F.READ(FN.AA.ARRANGEMENT,Y.NOT.FHA.AA.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,Y.AA.ARRANGE.ERR)
        R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(Y.NOT.FHA.AA.ID, Y.AA.ARRANGE.ERR)
...
*            Y.SEL.LOAN.READ.PRD.VALUE = R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP>
            Y.SEL.LOAN.READ.PRD.VALUE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup>
            Y.ARRANGEMENT.ID = Y.NOT.FHA.AA.ID
            GOSUB FIND.PROD.GROUP
*            IF R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP> EQ 'HIPOTECARIO' THEN
            IF R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup> EQ 'HIPOTECARIO' THEN
...
*        CALL F.READ(FN.AA.ARRANGEMENT,Y.ARRANGEMENT.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,Y.AA.ARRANGE.ERR)
        R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(Y.ARRANGEMENT.ID, Y.AA.ARRANGE.ERR)
*        Y.PROD.GROUP.VALUE = R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP>
        Y.PROD.GROUP.VALUE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup>
    END ELSE
...
*        Y.AA.REC.ORIGIN.AGENCY =  R.AA.ARRANGEMENT<AA.ARR.CO.CODE>
        Y.AA.REC.ORIGIN.AGENCY =  R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCoCode>
*        Y.AA.REC.START.DATE = R.AA.ARRANGEMENT<AA.ARR.START.DATE>
        Y.AA.REC.START.DATE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrStartDate>
...
*    Y.ARRANGE.CUST = R.AA.ARRANGEMENT<AA.ARR.CUSTOMER>
    Y.ARRANGE.CUST = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer>
...
*    CALL F.READ(FN.AA.ACTIVITY.HISTORY,Y.LOAN.NO,R.AA.ACTVITY.HISTORY,F.AA.ACTIVITY.HISTORY,Y.AA.ACT.HIS.ERR)
    R.AA.ACTVITY.HISTORY = AA.Framework.ActivityHistory.Read(Y.LOAN.NO, Y.AA.ACT.HIS.ERR)
...
*        Y.AA.ACTIVITY.HIS.ACT.ID = R.AA.ACTVITY.HISTORY<AA.AH.ACTIVITY.REF>     ;*R22 Manual Conversion - changed to AA.AH.ACTIVITY.REF
        Y.AA.ACTIVITY.HIS.ACT.ID = R.AA.ACTVITY.HISTORY<AA.Framework.ActivityHistory.AhActivityRef>
    END
...
*        Y.DISBURSED.VALUE = R.AA.ACTVITY.HISTORY<AA.AH.ACTIVITY.AMT,Y.AA.ACTIVITY.HIS.ACT.POS,1>  ;*R22 Manual Conversion - changed from AA.AH.ACT.AMOUNT to AA.AH.ACTIVITY.AMT
        Y.DISBURSED.VALUE = R.AA.ACTVITY.HISTORY<AA.Framework.ActivityHistory.AhActivityAmt,Y.AA.ACTIVITY.HIS.ACT.POS,1>
    END
RETURN
*------------------------------------------------------------------------------------------------------------------
TERM.AMOUNT:
...
*        Y.ACCT.NO =  R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID>
        Y.ACCT.NO =  R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId>
    END

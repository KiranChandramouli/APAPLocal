* @ValidationCode : MjoxMjIxOTk5MDA6VVRGLTg6MTcwNDQ1OTkxOTQ3OTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jan 2024 18:35:19
...
* 05-01-2024       Narmadha V       Manual R22 conversion    Changed Hardcoded value to Variable
*------------------------------------------------------------------------
...
*  CALL F.READ(FN.AA.ACCOUNT.DETAILS,Y.ARR.ID,R.AA.ACC.DET,F.AA.ACCOUNT.DETAILS,ACT.ERR)
    R.AA.ACC.DET = AA.PaymentSchedule.AccountDetails.Read(Y.ARR.ID, ACT.ERR)
*Y.PAY.START.DATE = R.AA.ACC.DET<AA.AD.PAYMENT.START.DATE>
    Y.PAY.START.DATE = R.AA.ACC.DET<AA.PaymentSchedule.AccountDetailsHist.AdPaymentStartDate>

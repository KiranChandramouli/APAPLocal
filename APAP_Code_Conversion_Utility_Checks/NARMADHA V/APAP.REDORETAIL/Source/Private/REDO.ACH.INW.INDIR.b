* @ValidationCode : MjotMTAwNDg1OTQwODpVVEYtODoxNzAyODk3MDEzNDAzOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 18 Dec 2023 16:26:53
...
*Y.OFS.SOURCE.ID = OFS$SOURCE.ID
    Y.OFS.SOURCE.ID = EB.Interface.getOfsSourceId() ;*Manual R22 Conversion
* R.OFS.SOURCE = OFS$SOURCE.REC
    R.OFS.SOURCE = EB.Interface.getOfsSourceRec() ;*Manual R22 Conversion
*IN.QUEUE.PATH = R.OFS.SOURCE<OFS.SRC.IN.QUEUE.DIR>
    IN.QUEUE.PATH = R.OFS.SOURCE<EB.Interface.OfsSource.OfsSrcInQueueDir>
...
* CALL OFS.CALL.BULK.MANAGER(Y1.SOURCE.ID,OFSRECORD,Y.theResponse, Y.txnCommitted)
        CALL EB.Interface.OfsCallBulkManager(Y1.SOURCE.ID,OFSRECORD,Y.theResponse, Y.txnCommitted) ;*Manual R22 Conversion
    
    END
*OFS$SOURCE.ID=Y.OFS.SOURCE.ID
    EB.Interface.setOfsSourceId(Y.OFS.SOURCE.ID) ;*Manual R22 Conversion
*OFS$SOURCE.REC=R.OFS.SOURCE
    EB.Interface.setOfsSourceRec(R.OFS.SOURCE) ;*Manual R22 Conversion

* @ValidationCode : MjoxNzQ2Nzk0OTM3OlVURi04OjE3MDI4OTgwNjcxMzA6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 18 Dec 2023 16:44:27
...
*-----------------------------------------------------------------------------
    ...
    E = ""
*APAP.TAM.REDO.R.COL.GET.MAPPING(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING, Y.MAP.TYPE, Y.MAP.VALUE)
...
*APAP.TAM.REDO.R.COL.PROCESS.TRACE(P.TYPE_PROC, P.STATUS.ERR, Y.CONTADOR, P.TABLE, Y.TYPE.TXN, C.DESC)
...
*APAP.TAM.REDO.R.COL.EXTRACT.ERROR(C.DESC, "REDO.COL.EXTRACT.TXN",P.TABLE)
...
*APAP.REDOVER.REDO.INTERFACE.REC.ACT(C.INT.CODE,C.INT.TYPE,Y.CONTADOR,C.BAT.TOT,C.INFO.OR,C.INFO.DE,C.ID.PROC,C.MON.TP,C.DESC,C.REC.CON,C.EX.USER,C.EX.PC)
    PROCESS.GOAHEAD = 0
RETURN

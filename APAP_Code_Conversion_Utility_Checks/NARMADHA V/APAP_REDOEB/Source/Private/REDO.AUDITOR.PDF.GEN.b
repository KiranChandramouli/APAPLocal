* @ValidationCode : MjoxMDIyMDIxODA2OlVURi04OjE3MDI4ODEyMTM5NjU6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 18 Dec 2023 12:03:33
...
* 18-12-2023      Narmadha V        Manual R22 Conversion    ID variable Added
*----------------------------------------------------------------------
...
*CALL F.READ(FN.DYNAMIC.TEXT,'REDO.LETTER',R.DYNAMIC.TEXT,F.DYNAMIC.TEXT,DYNAMIC.ERR)
        CALL F.READ(FN.DYNAMIC.TEXT,Y.ID,R.DYNAMIC.TEXT,F.DYNAMIC.TEXT,DYNAMIC.ERR) ;*Manual R22 Conversion - ID Variable Added
* Y.NAME.PREFIX=R.DYNAMIC.TEXT<2>
        Y.NAME.PREFIX=R.DYNAMIC.TEXT<REDO.LET.ISS.CU.IDENTITY> ;*Manual R22 Conversion - Variable changed

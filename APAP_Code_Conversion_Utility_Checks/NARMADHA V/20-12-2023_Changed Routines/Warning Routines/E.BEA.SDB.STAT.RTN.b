* @ValidationCode : MjotMTM4Mjk5ODM5NzpVVEYtODoxNzAzMDczMjY5MzUxOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 20 Dec 2023 17:24:29
...
* 20-12-2023      Narmadha V        Manual R22 Conversion      F.READ to CACHE.READ
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
* CALL F.READ(FN.MB.SDB.PARAM,MB.SDB.PARAM.ID,R.MB.SDB.PARAM,F.MB.SDB.PARAM,YERR)
    CALL CACHE.READ(FN.MB.SDB.PARAM,MB.SDB.PARAM.ID,R.MB.SDB.PARAM,F.MB.SDB.PARAM,YERR) ;*Manual R22 Conversion - F.READ to CACHE.READ

* @ValidationCode : MjoxMTQ4NDIzNDg4OlVURi04OjE3MDI4ODIwMjkzMzI6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 18 Dec 2023 12:17:09
...
* 18-12-2023    Narmadha V     Manual R22 Conversion   Replace Hardcoded value with Variable
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.PGM.FILE
...
* OPEN 'DICT',TAP.SEN.FILE TO F.TAP.SEN.FILE.DICT ELSE
                OPEN Y.VAR,TAP.SEN.FILE TO F.TAP.SEN.FILE.DICT ELSE ;*Manual R22 Conversion - Replace Hardcoded value with Variable

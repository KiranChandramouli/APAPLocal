* @ValidationCode : MjotMTE0MzU1NDAyODpVVEYtODoxNzAyNzAwMzYzMDAyOkFkbWluOi0xOi0xOjA6MDp0cnVlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 Dec 2023 09:49:23
...
*CALL REFRESH.FIELD(DEFAULTED.FIELD, DEFAULTED.ENRI)
    EB.Display.RefreshField(DEFAULTED.FIELD, DEFAULTED.ENRI) ;*Manual R22 Conversion - Call Routine Format Modified
...
* CASE AF = SDB.TYP.NO.OF.SDB.BR
        CASE AF EQ SDB.TYP.NO.OF.SDB.BR ;*Manual R22 Conversion = to EQ

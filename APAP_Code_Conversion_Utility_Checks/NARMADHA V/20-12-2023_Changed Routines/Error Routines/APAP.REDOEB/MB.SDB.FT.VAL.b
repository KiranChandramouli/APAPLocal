* @ValidationCode : MjotMTk4NzE0NjM0MjpVVEYtODoxNzAyNjI3MDgzMjc2OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 Dec 2023 13:28:03
...
* 15-12-2023      Narmadha V        Manual R22 Conversion      Call Rouitne Modified,F.READ to CACHE.READ
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*CALL REBUILD.SCREEN
    EB.Display.RebuildScreen() ;*Manual R22 Conversion - Call Rouitne Modified
...
*CALL F.READ(FN.MB.SDB.STATUS,MB.SDB.STATUS.ID,R.MB.SDB.STATUS,F.MB.SDB.STATUS,RERR)
    CALL CACHE.READ(FN.MB.SDB.STATUS,MB.SDB.STATUS.ID,R.MB.SDB.STATUS,RERR) ;*Manual R22 Conversion - F.READ to CACHE.READ
    IF RERR THEN

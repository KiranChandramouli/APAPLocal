* @ValidationCode : MjotODg2OTYwNTE3OkNwMTI1MjoxNzA0NzA2NzU3NjIyOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 08 Jan 2024 15:09:17
...
*=============================
   * CALL F.READ(FN.AA.ARRANGEMENT, Y.AA.ID, R.AA.ARRANGEMENT, F.AA.ARRANGEMENT, Y.ERR)
    R.AA.ARRANGEMENT=AA.Framework.Arrangement.Read(Y.AA.ID, Y.ERR)
   * Y.ACCOUNT.ID = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID>
    Y.ACCOUNT.ID = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrLinkedApplId>
    *VAR.CUS.CRED = R.AA.ARRANGEMENT<AA.ARR.CUSTOMER>
     VAR.CUS.CRED = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCustomer>
   * VAR.PRODUCTO =  R.AA.ARRANGEMENT<AA.ARR.PRODUCT>
    VAR.PRODUCTO =  R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct>
RETURN
*=============================
READ.ACCOUNT:
*=============================

* @ValidationCode : MjotMzIxNTU4NTY3OkNwMTI1MjoxNzAzNzQwNTEzNzIyOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Dec 2023 10:45:13
...
*CALL F.READ(FN.REDO.T.SHA1,SHA1.CODE,R.SHA1.CODE,F.REDO.T.SHA1,SHA1.ERR)
    CALL F.READU(FN.REDO.T.SHA1,SHA1.CODE,R.SHA1.CODE,F.REDO.T.SHA1,SHA1.ERR,'');*R22 MANUAL CODE CONVERSION
    IF SHA1.ERR THEN

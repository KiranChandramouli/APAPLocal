* @ValidationCode : MjotMTU2NzMzNDMzNTpDcDEyNTI6MTcwMzc0NjczNTc0MTphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 28 Dec 2023 12:28:55
...
*14-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     FM TO @FM
...
*STMT.ENTRY.REC<AC.STE.ACCOUNT.NUMBER> = R.REDO.APAP.CLEAR.PARAM<CLEAR.PARAM.INW.RET.ACCT>
    STMT.ENTRY.REC<AC.STE.ACCOUNT.NUMBER> = R.REDO.APAP.CLEAR.PARAM<CLEAR.PARAM.INW.RETURN> ;*R22 MANUAL CONVERSION
...
*STMT.ENTRY.REC<AC.STE.ACCOUNT.NUMBER> = R.REDO.APAP.CLEAR.PARAM<CLEAR.PARAM.INW.REF.ACCT>
    STMT.ENTRY.REC<AC.STE.ACCOUNT.NUMBER> = R.REDO.APAP.CLEAR.PARAM<CLEAR.PARAM.INW.RETURN> ;*R22 MANUAL CONVERSION
...
*Raising Credit PL category account by charge amount
        ...
        CATEG.ENTRY.REC<AC.CAT.TRANSACTION.CODE> = R.REDO.APAP.CLEAR.PARAM<CLEAR.PARAM.TAX.CR.CODE>
...
*******************
    ...
    APPL.ARRY = 'STMT.ENTRY':@FM:'CATEG.ENTRY' ;*R22 AUTO CONVERSION
    FLD.ARRAY = 'L.EB.IMAGE.ID':@FM:'L.EB.IMAGE.ID' ;*R22 AUTO CONVERSION
    FLD.POS = ''

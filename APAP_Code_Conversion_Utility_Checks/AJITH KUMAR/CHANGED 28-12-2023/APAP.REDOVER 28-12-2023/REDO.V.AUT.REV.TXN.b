* @ValidationCode : MjoxMDQ4NDQzMjIyOkNwMTI1MjoxNzAzNzQ2MTUzOTQ5OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Dec 2023 12:19:13
...
*CALL F.READ(FN.REDO.FT.TT.REV,CONCAT.ID,R.REDO.FT.TT.REV,F.REDO.FT.TT.REV,CONCAT.ERR)
    CALL F.READU(FN.REDO.FT.TT.REV,CONCAT.ID,R.REDO.FT.TT.REV,F.REDO.FT.TT.REV,CONCAT.ERR,'');*R22 MANUAL CODE CONVERSION
...
*CALL F.READ(FN.REDO.FT.TT.REV.REC,TODAY,R.REDO.FT.TT.REV.REC,F.REDO.FT.TT.REV.REC,REV.ERR)
    CALL F.READU(FN.REDO.FT.TT.REV.REC,TODAY,R.REDO.FT.TT.REV.REC,F.REDO.FT.TT.REV.REC,REV.ERR,'');*R22 MANUAL CODE CONVERSION

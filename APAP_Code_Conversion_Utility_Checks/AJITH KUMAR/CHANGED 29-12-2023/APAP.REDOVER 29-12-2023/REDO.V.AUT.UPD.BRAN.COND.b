* @ValidationCode : MjotMjUzNzYxOTk4OkNwMTI1MjoxNzAzODI0NDk2MzM5OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 29 Dec 2023 10:04:56
...
* Fix for PACS00325160 [FX Branch and Overall Position update]
    ...
    END ELSE
        ...
        CALL CACHE.READ(FN.REDO.FXSN.TXN.VERSION,ID.VAR,R.REDO.FXSN.TXN.VERSION,REDO.FXSN.TXN.VERSION.ERR)
...
*PACS00149084 - E
    ...
    APAP.REDOVER.redoVCallUsdEqv(Y.USD.AMOUNT,Y.REC.STATUS,CURR.NO) ;* MANUAL R22 CODE CONVERSION

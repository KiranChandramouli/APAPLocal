* @ValidationCode : MjotMTQ5Mjk4Mjk0NDpDcDEyNTI6MTcwMzgyNDE5NTQyMDphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 29 Dec 2023 09:59:55
...
*CALL GET.LOC.REF(LOC.REF.APPLICATION,LOC.REF.FIELDS,LOC.REF.POS)
    EB.LocalReferences.GetLocRef(LOC.REF.APPLICATION,LOC.REF.FIELDS,LOC.REF.POS);*R22 MANUAL CODE CONVERSION
...
* CALL F.READ(FN.REDO.LETTER.ISSUE,Y.LETTER.ISSUE.ID,R.REDO.LETTER.ISSUE,F.REDO.LETTER.ISSUE,LETTER.ERR)
    CALL F.READU(FN.REDO.LETTER.ISSUE,Y.LETTER.ISSUE.ID,R.REDO.LETTER.ISSUE,F.REDO.LETTER.ISSUE,LETTER.ERR,'');*R22 MANUAAL CODE CONVERSION

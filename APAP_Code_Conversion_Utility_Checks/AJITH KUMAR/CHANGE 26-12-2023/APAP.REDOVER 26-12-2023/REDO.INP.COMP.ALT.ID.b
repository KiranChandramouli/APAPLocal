* @ValidationCode : MjotMjExMTcxOTM1MzpDcDEyNTI6MTcwMzU5MTA1MjMxMTphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Dec 2023 17:14:12
...
*  CALL F.READ(FN.REDO.CUST.COMPLAINTS,'SYSTEM',R.REDO.CUST.COM,F.REDO.CUST.COMPLAINTS,CUST.COM.ERR) ;*Tus Start
    ID.VAR = 'SYSTEM' ;*R22 MANAUL CODE CONVERSION
    CALL CACHE.READ(FN.REDO.CUST.COMPLAINTS,ID.VAR,R.REDO.CUST.COM,CUST.COM.ERR) ; * Tus End

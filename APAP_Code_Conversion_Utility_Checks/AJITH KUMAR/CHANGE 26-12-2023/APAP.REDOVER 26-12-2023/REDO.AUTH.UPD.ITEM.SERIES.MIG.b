* @ValidationCode : MjotMTQxMzE0ODcyMzpDcDEyNTI6MTcwMzU2NDg4NzYyMjphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Dec 2023 09:58:07
...
*CALL F.READ(FN.REDO.ITEM.SERIES,VAR.ACCOUNT,R.REDO.ITEM.SERIES,F.REDO.ITEM.SERIES,Y.ERR)
        CALL F.READU(FN.REDO.ITEM.SERIES,VAR.ACCOUNT,R.REDO.ITEM.SERIES,F.REDO.ITEM.SERIES,Y.ERR,'') ;*R22 MANUAL CODE CONVERSION

* @ValidationCode : MjotMTA0MzI3MDEyNTpDcDEyNTI6MTcwNDQ0OTAzNDQ5OTphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jan 2024 15:33:54
...
*    CALL CACHE.READ(FN.ACCOUNT.PARAMETER,'SYSTEM',R.ACCOUNT.PARAMETER,ERR.AP)
    ...
    CALL CACHE.READ(FN.ACCOUNT.PARAMETER,IDVAR.1,R.ACCOUNT.PARAMETER,ERR.AP);* R22 UTILITY AUTO CONVERSION

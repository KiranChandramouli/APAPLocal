* @ValidationCode : MjoyMTA5NjczMjgwOkNwMTI1MjoxNzA0NDQxNjU0MTU4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:30:54
...
*    CALL GET.LOC.REF(LOC.REF.APPL,LOC.REF.FLD,LOC.REF.POS)
    EB.LocalReferences.GetLocRef(LOC.REF.APPL,LOC.REF.FLD,LOC.REF.POS);* R22 UTILITY AUTO CONVERSION
RETURN

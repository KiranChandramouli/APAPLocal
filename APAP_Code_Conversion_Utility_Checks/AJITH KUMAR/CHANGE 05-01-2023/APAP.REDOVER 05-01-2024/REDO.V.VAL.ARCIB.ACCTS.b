* @ValidationCode : Mjo4NzkwNzI5NTA6Q3AxMjUyOjE3MDQ0NDYxMjQyMjU6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jan 2024 14:45:24
...
*    CALL CACHE.READ(FN.ARCIB.PARAM,'SYSTEM',R.ARCIB.PARAM.REC,ARCIB.PARAM.ERR)
    ...
    CALL CACHE.READ(FN.ARCIB.PARAM,IDVAR.1,R.ARCIB.PARAM.REC,ARCIB.PARAM.ERR);* R22 UTILITY AUTO CONVERSION

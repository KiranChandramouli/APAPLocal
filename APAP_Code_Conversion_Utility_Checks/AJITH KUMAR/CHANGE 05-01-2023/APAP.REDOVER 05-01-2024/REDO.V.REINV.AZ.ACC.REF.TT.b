* @ValidationCode : Mjo0NDc5MDg4NzA6Q3AxMjUyOjE3MDQ0NDAyMDgxNDA6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:06:48
...
*    CALL F.READ(FN.REDO.CHEQUE.PROCESS,Y.REDO.CHEQUE.PROCESS.ID,R.REDO.CHEQUE.PROCESS,F.REDO.CHEQUE.PROCESS,Y.ERR)
    CALL F.READU(FN.REDO.CHEQUE.PROCESS,Y.REDO.CHEQUE.PROCESS.ID,R.REDO.CHEQUE.PROCESS,F.REDO.CHEQUE.PROCESS,Y.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.APAP.REINV.CHQ.AMT,Y.INT.LIQ.ACCT,R.REDO.APAP.REINV.CHQ.AMT,F.REDO.APAP.REINV.CHQ.AMT,ACC.ERR)
    CALL F.READU(FN.REDO.APAP.REINV.CHQ.AMT,Y.INT.LIQ.ACCT,R.REDO.APAP.REINV.CHQ.AMT,F.REDO.APAP.REINV.CHQ.AMT,ACC.ERR,'');* R22 UTILITY AUTO CONVERSION

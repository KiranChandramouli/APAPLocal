* @ValidationCode : MjoxMDI2Njk3ODQ0OkNwMTI1MjoxNzA0NDQ4ODg5MjIyOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 15:31:29
...
*    CALL GET.LOC.REF("TELLER","L.TT.BASE.AMT",POS.BASE.AMT)
    EB.LocalReferences.GetLocRef("TELLER","L.TT.BASE.AMT",POS.BASE.AMT);* R22 UTILITY AUTO CONVERSION

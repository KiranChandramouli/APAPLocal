* @ValidationCode : MjotOTMwODI0MDg2OkNwMTI1MjoxNzA0NDQ5MTA1OTQ0OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 15:35:05
...
*    CALL F.READ(FN.REDO.FC.CL.BALANCE,Y.AA.ID,R.REDO.FC.CL.BALANCE,F.REDO.FC.CL.BALANCE,Y.BALANCE.ERR.MSJ)
    CALL F.READU(FN.REDO.FC.CL.BALANCE,Y.AA.ID,R.REDO.FC.CL.BALANCE,F.REDO.FC.CL.BALANCE,Y.BALANCE.ERR.MSJ,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.COLL.RIGHT,Y.ID.AA.PRD,R.COLL.RIGHT,F.COLL.RIGHT,Y.BALANCE.ERR.MSJ)
    CALL F.READU(FN.COLL.RIGHT,Y.ID.AA.PRD,R.COLL.RIGHT,F.COLL.RIGHT,Y.BALANCE.ERR.MSJ,'');* R22 UTILITY AUTO CONVERSION

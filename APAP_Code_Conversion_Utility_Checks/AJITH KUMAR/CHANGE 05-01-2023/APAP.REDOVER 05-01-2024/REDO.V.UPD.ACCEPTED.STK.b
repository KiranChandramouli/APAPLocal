* @ValidationCode : MjoxODgzMDg1ODMzOkNwMTI1MjoxNzA0NDQ1NjgyODgzOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 14:38:02
...
*    CALL CACHE.READ(FN.REDO.CARD.SERIES.PARAM,'SYSTEM',R.REDO.CARD.SERIES.PARAM,ERR.SER)
    ...
    CALL CACHE.READ(FN.REDO.CARD.SERIES.PARAM,IDVAR.1,R.REDO.CARD.SERIES.PARAM,ERR.SER);* R22 UTILITY AUTO CONVERSION

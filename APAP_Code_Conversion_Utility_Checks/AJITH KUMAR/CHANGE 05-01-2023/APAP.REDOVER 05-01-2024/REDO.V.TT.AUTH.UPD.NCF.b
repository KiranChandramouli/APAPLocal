* @ValidationCode : MjoxNzYxNjU4NDQwOkNwMTI1MjoxNzA0NDQ1NjMxNzEzOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 14:37:11
...
*    CALL F.READ(FN.REDO.L.NCF.STATUS,NCF.ISSUE.ID,R.REDO.L.NCF.STATUS,F.REDO.L.NCF.STATUS,STATUS.MSG)
    CALL F.READU(FN.REDO.L.NCF.STATUS,NCF.ISSUE.ID,R.REDO.L.NCF.STATUS,F.REDO.L.NCF.STATUS,STATUS.MSG,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL CACHE.READ(FN.ACCOUNT.CLASS, 'NOSTRO', R.ACCOUNT.CLASS, ACCOUNT.CLASS.ERR) ;*R22 Auto code conversion
    IDVAR.1 = 'NOSTRO' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.ACCOUNT.CLASS, IDVAR.1, R.ACCOUNT.CLASS, ACCOUNT.CLASS.ERR) ;*R22 Auto code conversion;* R22 UTILITY AUTO CONVERSION

* @ValidationCode : Mjo4Mjc1NzM4NjE6Q3AxMjUyOjE3MDQ0Mzk4NDA0ODE6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:00:40
...
*    CALL GET.LOC.REF('SEC.TRADE','L.SC.TRN.YIELD',Y.TRN.POS)
    EB.LocalReferences.GetLocRef('SEC.TRADE','L.SC.TRN.YIELD',Y.TRN.POS);* R22 UTILITY AUTO CONVERSION
    Y.REDEM = 100
    Y.CNTR = 0
    Y.BR.CNTR = 0

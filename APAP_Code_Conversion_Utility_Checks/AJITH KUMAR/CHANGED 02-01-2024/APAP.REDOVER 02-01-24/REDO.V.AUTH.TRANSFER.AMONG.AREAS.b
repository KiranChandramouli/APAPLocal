* @ValidationCode : MjotMTMzNTk1Mjk0NzpDcDEyNTI6MTY4MzAxMDc1NjEwNTpJVFNTOi0xOi0xOjI1MjE6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 02 May 2023 12:29:16
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 2521
...
CALL F.READU(FN.REDO.ITEM.SERIES,Y.S.ID,R.REDO.ITEM.SERIES,F.REDO.ITEM.SERIES,Y.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.H.DEPOSIT.RECEIPTS,SEL.LIST.1,R.REDO.H.DEPOSIT.RECEIPTS,F.REDO.H.DEPOSIT.RECEIPTS,Y.ERR.APP,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.H.BANK.DRAFTS,SEL.LIST.1,R.REDO.H.BANK.DRAFTS,F.REDO.H.BANK.DRAFTS,Y.ERR.APP,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.H.ADMIN.CHEQUES,SEL.LIST.1,R.REDO.H.ADMIN.CHEQUES,F.REDO.H.ADMIN.CHEQUES,Y.ERR.APP,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.H.PASSBOOK.INVENTORY,nSEL.LIST.1,R.REDO.H.PASSBOOK.INVENTORY,F.REDO.H.PASSBOOK.INVENTORY,Y.ERR.APP,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.ITEM.STOCK,Y.FROM.COMAPNY,R.REDO.ITEM.STOCK,F.REDO.ITEM.STOCK,Y.ERR.STOCK,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.ITEM.STOCK,Y.DEST.AREA,R.REDO.ITEM.STK,F.REDO.ITEM.STOCK,Y.ERR.STOCK,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.ITEM.STOCK.BY.DATE,Y.ITEM.STOCK.RPT.ID1,R.REDO.ITEM.STOCK.BY.DATE1,F.REDO.ITEM.STOCK.BY.DATE,Y.ERR.DATE,'');* R22 AUTO CONVERSION
Y.DATE.RPT = R.NEW(RE.ORD.DATE)

...
CALL F.READU(FN.REDO.ADMIN.CHQ.DETAILS,Y.REDO.ADMIN.CHQ.DETAILS.ID,R.REDO.ADMIN.CHQ.DETAILS,F.REDO.ADMIN.CHQ.DETAILS,ERR.READ,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.ADMIN.CHQ.DETAILS,Y.REDO.ADMIN.CHQ.DETAILS.ID,R.REDO.ADMIN.CHQ.DETAILS,F.REDO.ADMIN.CHQ.DETAILS,ERR.ADMIN.CHQ,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.H.ADMIN.CHEQUES,Y.REDO.H.ADMIN.CHQ.ID,R.REDO.H.ADMIN.CHEQUES,F.REDO.H.ADMIN.CHEQUES,REDO.H.ADMIN.CHEQUES.ERR,'');* R22 AUTO CONVERSION

* @ValidationCode : MjotMzM5ODQzNDQzOkNwMTI1MjoxNzA0MTg3MDUwNjE1OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 02 Jan 2024 14:47:30
...
SUBROUTINE REDO.V.AUTH.REINSTATE
*-----------------------------------------------------------------------------
*------------------------------------------------------------------------------------------
* DESCRIPTION : This routine will be executed at the Authorisation level for the Following
* versions of TELLER,REINSTATE.CERTIFIED.CHEQUES. This Routine will be used for cancel or
* reinstate the certified cheques and also to update the status as "REINSTATED"
* in CERTIFIED.CHEQUE.DETAILS and CERTIFIED.CHEQUE.STOCK application
*------------------------------------------------------------------------------------------
*------------------------------------------------------------------------------------------
* * Input / Output
* ---------------------------
...
* PROGRAM NAME : REDO.V.AUTH.REINSTATE
*------------------------------------------------------------------------------------------
...
*CALL F.READ(FN.CERTIFIED.CHEQUE.STOCK,Y.CERT.CHEQ.NO,R.CERT.CHEQ.STO,F.CERTIFIED.CHEQUE.STOCK,STO.ERR)
    ...
    R.CERT.CHEQ.STO<CERT.STO.STATUS> = 'REINSTATED'
    ...
    R.CERT.CHEQ.DET<CERT.DET.STATUS> = 'REINSTATED'

* @ValidationCode : MjoxNDk3ODMyMjIwOkNwMTI1MjoxNjg5OTM2MTExNTAwOklUU1M6LTE6LTE6MTE3NzoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 21 Jul 2023 16:11:51
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1177
...
IDVAR.1 = "1" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PRM, IDVAR.1, R.PRM1, FV.PRM, PRM1.ERR);* R22 UTILITY AUTO CONVERSION
    Y.PA.BALANCE.INICIO = R.PRM1<ST.L.A95.VALOR>
*    CALL F.READ(FN.PRM, "2", R.PRM2, FV.PRM, PRM1.ERR)
IDVAR.1 = "2" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PRM, IDVAR.1, R.PRM2, FV.PRM, PRM1.ERR);* R22 UTILITY AUTO CONVERSION
    Y.PA.BALANCE.PROMEDIO = R.PRM2<ST.L.A95.VALOR>
*    CALL F.READ(FN.PRM, "3", R.PRM3, FV.PRM, PRM1.ERR)
IDVAR.1 = "3" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PRM, IDVAR.1, R.PRM3, FV.PRM, PRM1.ERR);* R22 UTILITY AUTO CONVERSION
...
IDVAR.1 = "4" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PRM, IDVAR.1, R.PRM4, FV.PRM, PRM1.ERR);* R22 UTILITY AUTO CONVERSION
...
EB.LocalReferences.GetLocRef('CUSTOMER','L.CU.TIPO.CL',Y.TCL.POS);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotMjEzNTE1NDg3MzpDcDEyNTI6MTcwNTM4MDA3NzkyNTphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 16 Jan 2024 10:11:17
...
AA.Framework.GetPeriodBalances(Y.ACCT.ID, YCRF.TYPE,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE);* R22 UTILITY AUTO CONVERSION
...
********************
  ...
  *  CALL F.READ(FN.AA.ACTIVITY.HISTORY,Y.AA.ARR.ID,R.AA.ACTIVITY.HISTORY,F.AA.ACTIVITY.HISTORY,ERR.AA.ACTIVITY.HISTORY)
    R.AA.ACTIVITY.HISTORY=AA.Framework.ArrangementActivity.Read(Y.AA.ARR.ID,ERR.AA.ACTIVITY.HISTORY)

* @ValidationCode : MjoxMDA0MzczNjk5OkNwMTI1MjoxNzA1MDUyMTcwOTM4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 12 Jan 2024 15:06:10
...
*------*
  ...
  *  CALL F.READ(FN.AA.ARRANGEMENT,REC.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,AA.ARRANGEMENT.ERR)
    R.AA.ARRANGEMENT=AA.Framework.Arrangement.Read(REC.ID, AA.ARRANGEMENT.ERR)
  ...
  *  STAR.DATE.VAL = R.AA.ARRANGEMENT<AA.ARR.START.DATE>
     YAA.PROD = R.AA.ARRANGEMENT< AA.Framework.Arrangement.ArrProduct>
    ...
    CUS.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer>
...
AA.Framework.GetPeriodBalances(ACCOUNT.ID, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE);* R22 UTILITY AUTO CONVERSION
...
GET.ARR.DETAILS:
*--------------*
    LOCATE 'ACCOUNT' IN R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedAppl,1> SETTING LINK.POS THEN
        ACCOUNT.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId,LINK.POS>
    END
RETURN
*----------------------------------------------------------------------------
PROCESS.INIT1:
...
*CALL REDO.S.REG.CUSTOMER.EXTRACT(CUS.ID,Y.PRODUCT.GROUP,Y.REL.CODE,OUT.ARR)
    APAP.LAPAP.redoSRegCustomerExtract(CUS.ID,Y.PRODUCT.GROUP,Y.REL.CODE,OUT.ARR) ;*R22 MANUAL CODE CONVERSION
...
*    CALL F.READ(FN.REDO.APAP.PROPERTY.PARAM,YAA.PROD.GRP,R.REDO.APAP.PROPERTY.PARAM,F.REDO.APAP.PROPERTY.PARAM,ERR.REDO.APAP.PROPERTY.PARAM)
    CALL CACHE.READ(FN.REDO.APAP.PROPERTY.PARAM,YAA.PROD.GRP,R.REDO.APAP.PROPERTY.PARAM,ERR.REDO.APAP.PROPERTY.PARAM);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotMTU4MjEwODY4NTpDcDEyNTI6MTY4NjY3NDI0NDQ3ODpJVFNTOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 13 Jun 2023 22:07:24
...
*24-04-2023       CONVERSION TOOLS            AUTO R22 CODE CONVERSION  TAM.BP & LAPAP.BP is removed , $INCLUDE to $INSERT, = to EQ
*24-04-2023       AJITHKUMAR                  MANUAL R22 CODE CONVERSION CALL Routine format modified, L.FT.CHANNELS.POS,L.FTTC.CHANNELS.POS added in insert file I_DR.REG.FD01.LASTD.EXTRACT.COMMON
...
*----------------------------------------------------------------------------
    ...
    $INSERT I_F.REDO.ID.CARD.CHECK ;*R22 AUTO CODE CONVERSION
    $INSERT I_DR.REG.FD01.LASTD.EXTRACT.COMMON ;*R22 AUTO CODE CONVRSION
...
***************
    ...
    IF TRANS.LEGAL.ID THEN
        ...
        APAP.LAPAP.lapapGetCusByIdent(R.CUSTOMER, IDENT.NO, IDENT.TYPE, CUS.ID) ;*MANUAL R22 CODE CONVERSION
    ...
    IF LEN(ACCOUNT.NO) EQ 10 AND TRANS.LEGAL.ID EQ '' THEN
        APAP.LAPAP.lapapCusTutorByAccount(ACCOUNT.NO, R.CUSTOMER, CUS.ID) ;*MANUAL R22 CODE CONVERSION
    END
...
**************
    FLD3 = ''
    COMI = CUS.ID
    APAP.LAPAP.drRegn16GetCustType() ;*MANUAL R22 CODE CONVERSION
    FLD3 = COMI
RETURN
...
*********
    OUT.ARR = ''
    APAP.LAPAP.drRegGetCustType(R.CUSTOMER, OUT.ARR) ;*MANUAL R22 CODE CONVERSION
    FLD3 = OUT.ARR<1>
    FLD4 = OUT.ARR<2>
...
EB.LocalReferences.GetLocRef("FUNDS.TRANSFER", "L.PAIS", L.PAIS.POS);* R22 UTILITY AUTO CONVERSION
        CUS.COUNTRY = R.FUNDS.TRANSFER<FT.LOCAL.REF, L.PAIS.POS>

        APAP.LAPAP.lapapGetCusByIdent(R.CUSTOMER, CUS.IDENT, IDENT.TYPE, CUS.ID) ;*MANUAL R22 CODE CONVERSION

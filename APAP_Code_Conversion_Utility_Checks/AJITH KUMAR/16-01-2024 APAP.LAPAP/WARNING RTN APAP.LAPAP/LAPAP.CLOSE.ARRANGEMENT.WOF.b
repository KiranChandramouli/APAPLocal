* @ValidationCode : MjotMTk1NDc0MzcwNjpDcDEyNTI6MTcwNDgwNTI2NzE5Mzphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 09 Jan 2024 18:31:07
...
$PACKAGE APAP.LAPAP
SUBROUTINE LAPAP.CLOSE.ARRANGEMENT.WOF
*=====================================================================
...
*    CALL F.READ(FN.AA, AA.ID, R.ARRANGEMENT, F.AA, AA.ERR)
    CALL F.READU(FN.AA, AA.ID, R.ARRANGEMENT, F.AA, AA.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.AAM, AC.ID, R.AAM, F.AA, AAM.ERR)
        CALL F.READU(FN.AAM, AC.ID, R.AAM, F.AA, AAM.ERR,'');* R22 UTILITY AUTO CONVERSION
        IF AAM.ERR THEN
            R.AAS = ""; AAS.ERR = ""
*            CALL F.READ(FN.AAS, AA.ID, R.AAS, F.AAS, AAS.ERR)
            CALL F.READU(FN.AAS, AA.ID, R.AAS, F.AAS, AAS.ERR,'');* R22 UTILITY AUTO CONVERSION
            IF AAS.ERR THEN
            END ELSE
                DONT.PROCESS  = 1
            END
...
CLOSE.ARR:
    ...
    R.ARRANGEMENT<AA.Framework.ArrangementSim.ArrArrStatus > = "PENDING.CLOSURE"
...
ST.CompanyCreation.LoadCompany(R.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCoCode>);* R22 UTILITY AUTO CONVERSION

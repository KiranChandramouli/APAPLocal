* @ValidationCode : MjoxNDYzNjQ1MDAyOkNwMTI1MjoxNzAyOTg4MzQxMjAxOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*    CALL F.READ(FN.CHK.DIR,AAEXTRACT.FILE.ID,R.FIL,F.CHK.DIR,READ.FIL.ERR)
    CALL F.READU(FN.CHK.DIR,AAEXTRACT.FILE.ID,R.FIL,F.CHK.DIR,READ.FIL.ERR,'');* R22 UTILITY AUTO CONVERSION
    IF R.FIL THEN

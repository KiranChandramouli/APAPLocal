* @ValidationCode : MjoxMzA3OTU4ODc5OkNwMTI1MjoxNzAyOTg4MzQ1NjM0OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*   CALL F.READ(FN.REDO.H.REPORTS.PARAM,REDO.H.REPORTS.PARAM.ID,R.REDO.H.REPORTS.PARAM,F.REDO.H.REPORTS.PARAM,ERR.REDO.H.REPORTS.PARAM)
    CALL CACHE.READ(FN.REDO.H.REPORTS.PARAM,REDO.H.REPORTS.PARAM.ID,R.REDO.H.REPORTS.PARAM,ERR.REDO.H.REPORTS.PARAM) ;*R22 Manual Code Conversion_Utility Check
...
*    CALL F.READ(FN.CHK.DIR,YEXTRACT.FILENAME,R.FIL,F.CHK.DIR,READ.FIL.ERR)
    CALL F.READU(FN.CHK.DIR,YEXTRACT.FILENAME,R.FIL,F.CHK.DIR,READ.FIL.ERR,'');* R22 UTILITY AUTO CONVERSION
    IF R.FIL THEN
...
*********************
    ...
    FOR I.VAR = 1 TO YAC.BAL.CNT
        YAC.MCNT += 1 ;*R22 Auto code conversion
...
************
    ...
    FOR I.VAR = 1 TO YBAL.CNT ;*R22 Auto code conversion
        YMCNT += 1

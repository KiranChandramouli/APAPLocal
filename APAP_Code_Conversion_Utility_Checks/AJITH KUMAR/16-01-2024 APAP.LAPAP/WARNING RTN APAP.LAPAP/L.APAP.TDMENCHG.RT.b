* @ValidationCode : MjoxOTcyMTk0NzgxOkNwMTI1MjoxNjkwMTY3NTM2MjA5OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
EB.LocalReferences.GetLocRef("ACCOUNT","L.AC.STATUS1",AC.POS.1);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF("ACCOUNT","L.AC.STATUS2",AC.POS.2)
EB.LocalReferences.GetLocRef("ACCOUNT","L.AC.STATUS2",AC.POS.2);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxNzU2ODE4NjcxOkNwMTI1MjoxNjg2Njc0OTYyOTk3OklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 13 Jun 2023 22:19:22
...
*CALL REDO.LY.UPDATE.USE(CUS.ID,PRG.ID,ID.NEW,Y.US.QUANTITY,Y.US.QTY.VALUE)
    APAP.TAM.redoLyUpdateUse(CUS.ID,PRG.ID,ID.NEW,Y.US.QUANTITY,Y.US.QTY.VALUE)  ;*R22 MANUAL CODE CONVERSION

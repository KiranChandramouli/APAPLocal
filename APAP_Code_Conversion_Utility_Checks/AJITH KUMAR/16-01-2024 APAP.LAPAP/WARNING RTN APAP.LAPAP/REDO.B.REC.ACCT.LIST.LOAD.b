* @ValidationCode : MjoxMTk5OTM2MTM1OlVURi04OjE2ODQyMjI4Mjc1NDg6SVRTUzotMTotMToyMzA0OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 16 May 2023 13:10:27
* @ValidationInfo : Encoding          : UTF-8
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 2304
...
IDVAR.1 = 'RECONRPT' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.RHRP,IDVAR.1,R.RHRP,F.RHRP,ERR);* R22 UTILITY AUTO CONVERSION

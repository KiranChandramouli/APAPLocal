...
EB.LocalReferences.GetLocRef("TELLER","L.PRESENCIAL",POS.L.PRESENCIAL);* R22 UTILITY AUTO CONVERSION
        GOSUB TELLER.PROCCESS
    END

    IF APPLICATION EQ 'T24.FUND.SERVICES' THEN
*        CALL GET.LOC.REF("T24.FUND.SERVICES","L.PRESENCIAL",POS.L.PRESENCIAL)
EB.LocalReferences.GetLocRef("T24.FUND.SERVICES","L.PRESENCIAL",POS.L.PRESENCIAL);* R22 UTILITY AUTO CONVERSION
...
EB.LocalReferences.GetLocRef("ACCOUNT","L.PRESENCIAL",Y.PRESENCIAL.POS);* R22 UTILITY AUTO CONVERSION

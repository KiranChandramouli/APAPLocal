* @ValidationCode : MjotMjEyMzE3MzEyNjpVVEYtODoxNjg0MjIyODI1OTc1OklUU1M6LTE6LTE6NjY3OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 16 May 2023 13:10:25
...
*    CALL F.READ(FN.CHK.DIR,Y.FILE.NAME,R.FIL,F.CHK.DIR,READ.FIL.ERR)
    CALL F.READU(FN.CHK.DIR,Y.FILE.NAME,R.FIL,F.CHK.DIR,READ.FIL.ERR,'');* R22 UTILITY AUTO CONVERSION
    IF R.FIL THEN

* @ValidationCode : MjotMTY3MzkwNDAzMTpDcDEyNTI6MTcwNDc5NDQ1NzA2NTphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 09 Jan 2024 15:30:57
...
* 13-07-2023     Conversion tool    R22 Auto conversion       FM TO @FM, VM to @VM, SM to @SM, I to I.VAR, BP Removed in INSERTFILE
...
AA.Framework.GetArrangement(AA.ARR.ID,R.ARRANGEMENT,ERR.ARRAGEMENT);* R22 UTILITY AUTO CONVERSION
    *CLIENTE.ID = R.ARRANGEMENT<AA.ARR.CUSTOMER>
      CLIENTE.ID = R.ARRANGEMENT<AA.Framework.Arrangement.ArrCustomer>
  ...
  *  Y.PRODUCT = R.ARRANGEMENT<AA.ARR.PRODUCT>
      Y.PRODUCT = R.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct>
   * Y.LINKED.APPL.ID = R.ARRANGEMENT<AA.ARR.LINKED.APPL.ID,1,1>
    Y.LINKED.APPL.ID = R.ARRANGEMENT<AA.Framework.Arrangement.ArrLinkedApplId,1,1>
  *  Y.STATUS =  R.ARRANGEMENT<AA.ARR.ARR.STATUS>
    Y.STATUS =  R.ARRANGEMENT<AA.Framework.Arrangement.ArrArrStatus>
...
*    CALL DR.REG.GET.CUST.TYPE(R.CUSTOMER,OUT.ARR)
    APAP.LAPAP.drRegGetCustType(R.CUSTOMER,OUT.ARR)          ;*Manual R22 conversion
...
*    CALL REDO.RPT.ACCT.ALT.LOANS(YACCT.GRP,Y.PREV.ACCOUNT)
    APAP.TAM.redoRptAcctAltLoans(YACCT.GRP,Y.PREV.ACCOUNT)              ;*Manual R22 conversion
...
*    CALL REDO.B.CON.LNS.BY.DEBTOR.AA.RECS(AA.ARR.ID,OUT.RECORD)
    APAP.AA.redoBConLnsByDebtorAaRecs(AA.ARR.ID,OUT.RECORD)          ;*Manual R22 conversion
...
*******************
    ...
    *CALL F.READ(FN.AA.ACTIVITY.HISTORY,AA.ARR.ID,R.AA.ACTIVITY.HISTORY,F.AA.ACTIVITY.HISTORY,ERR.AA.ACTIVITY.HISTORY)
    R.AA.ACTIVITY.HISTORY=AA.Framework.ActivityHistoryHist.Read(AA.ARR.ID, ERR.AA.ACTIVITY.HISTORY)
    IF R.AA.ACTIVITY.HISTORY THEN
       * YACT.ID.ARR = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY>
        ...
        *YACT.IS.STAT = R.AA.ACTIVITY.HISTORY<AA.AH.ACT.STATUS>
          YACT.IS.STAT = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistoryHist.AhActStatus>
       * Y.EFFECTIVE.DATE = R.AA.ACTIVITY.HISTORY<AA.AH.EFFECTIVE.DATE>
        Y.EFFECTIVE.DATE = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistoryHist.AhEffectiveDate>
       * Y.ACTIVITY.AMT = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY.AMT>
        Y.ACTIVITY.AMT = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistoryHist.AhActivityAmt>
       * Y.ACTIVITY.REF = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY.REF>
        Y.ACTIVITY.REF = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistoryHist.AhActivityRef>
    ...
    FOR I.VAR = 1 TO Y.CNT
        ...
        *Y.TXN.AMOUNT =  R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.AMOUNT>
        Y.TXN.AMOUNT =  R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.ArrangementActivity.ArrActTxnAmount>
        IF Y.TXN.AMOUNT GE 0 THEN
            *Y.TXNCONTRACTID = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.CONTRACT.ID>
             Y.TXNCONTRACTID = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.ArrangementActivity.ArrActTxnContractId>
           * Y.TXNSYSTEMID = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.SYSTEM.ID>
            Y.TXNSYSTEMID = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.ArrangementActivity.ArrActTxnSystemId>
           * Y.FECHA.EFECTIVIDAD = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.EFFECTIVE.DATE>
             Y.FECHA.EFECTIVIDAD = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.ArrangementActivity.ArrActEffectiveDate>
            CAMPO.VAL8 = FMT(Y.FECHA.EFECTIVIDAD,'L#10')
            BEGIN CASE
...
EB.LocalReferences.GetLocRef ("TELLER", "L.CREDIT.AMOUNT",L.CREDIT.AMOUNT.POS);* R22 UTILITY AUTO CONVERSION

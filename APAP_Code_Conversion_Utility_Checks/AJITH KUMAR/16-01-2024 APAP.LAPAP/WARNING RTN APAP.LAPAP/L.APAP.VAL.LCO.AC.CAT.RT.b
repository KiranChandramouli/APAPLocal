...
IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.CAT.RES, IDVAR.1, R.CAT.RES, CAT.RES.ERROR) ;* AUTO R22 CODE CONVERSION F.READ TO CACHE.READ;* R22 UTILITY AUTO CONVERSION
RETURN
...
*        IF (Y.ACCS.CUSTOMER<1,CONT> EQ Y.ACCOUNT.NUMBER) THEN ;* AUTO R22 CODE CONVERSION = TO EQ
        IF (Y.ACCS.CUSTOMER<1,CONT> EQ Y.ACCOUNT.NUMBER) THEN ;* AUTO R22 CODE CONVERSION EQ TO EQ;* R22 UTILITY AUTO CONVERSION

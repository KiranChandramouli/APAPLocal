* @ValidationCode : MjotMTEyOTg4MDI2NjpVVEYtODoxNjg2Njc0MjU4MzY0OklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
$PACKAGE APAP.LAPAP
SUBROUTINE L.APAP.VUN.MTS.AUTOR.NV
*-----------------------------------------------------------------------------
*MODIFICATION HISTORY:
* DATE                WHO              REFERENCE                    DESCRIPTION

* 12-JUNE-2023    Conversion tool    R22 Auto conversion           BP is removed in Insert File, FM to @FM , VM to @VM,SM to @SM, ++ to +=, F.READ to CACHE
...
*IF PGM.VERSION MATCHES ',REDO.MULTI.AA.ACRP.UPD.TR':VM:',REDO.MULTI.AA.ACRP.UPD' THEN
    ...
    END
*END ELSE
*EXECUTE.ROUTINE = 'REDO.VUN.MTS.AUTOR.NV'
...
*OUT.RECORD = 0
*CALL LAPAP.CALCULO.CARGO(Y.CREDIT.ACCT.NO,Y.CREDIT.AMOUNT,Y.CURR.NO,OUT.RECORD)
    OUT.RECORD = 0
    Y.CHAR.AMOUNT.POS = '';
...
*                CALL F.READ(FN.TELLER.ID,WTT.ID,R.TELLER.ID,F.TELLER.ID,ERR.MSJ)
            ...
            CASE LOOP.CNT EQ 2
                ...
                CALL CACHE.READ(FN.FT.TXN.TYPE.CONDITION, TRANSID, R.FT.TXN.TYPE.CONDITION, ERR.MSJ) ;*R22 Auto conversion

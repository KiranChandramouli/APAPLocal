* @ValidationCode : MjoxODM3NjQ5MDE0OkNwMTI1MjoxNjkwMTY3NTM0NDM2OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
$PACKAGE APAP.LAPAP
SUBROUTINE L.APAP.PROCESS.RABBIT.JSON.REQ.NOVAL(Y.SERVICE.NAME, Y.T24.DATA, Y.PARAM, Y.RABBIT.MQ.OUT)
*-----------------------------------------------------------------------------
*MODIFICATION HISTORY:
*
* DATE              WHO                REFERENCE                 DESCRIPTION
* 13-07-2023     Conversion tool    R22 Auto conversion       BP Removed, INCLUDE to INSERT, = to EQ
...
*        CASE Y.OBJECT.TYPE = 'ROUTINE'
        CASE Y.OBJECT.TYPE EQ 'ROUTINE';* R22 UTILITY AUTO CONVERSION
*FOR OUTPUT
...
*IF PUTENV('OFS_SOURCE=TAABS') THEN NULL
    IF PUTENV('OFS_SOURCE=LAPAP.JSON.NO.VAL') THEN
        NULL
    END
    Y.CMT = ''

    Y.OFS.IN.REQUEST =  EREPLACE(Y.OFS.IN.REQUEST, "TYPE.OF.SCHDLE", "TYPE.OF.SCHDLE:2")
    Y.OFS.IN.REQUEST =  EREPLACE(Y.OFS.IN.REQUEST, "SCH.FIXED.RATE", "SCH.FIXED.RATE:2")
    Y.OFS.IN.REQUEST =  EREPLACE(Y.OFS.IN.REQUEST, "FREQUENCY", "FREQUENCY:2")

...
EB.LocalReferences.GetLocRef("BENEFICIARY","L.BEN.CTA.REG",L.BEN.CTA.REG.POS);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF("REDO.ACH.PARTICIPANTS","L.LBTR.BIC",L.LBTR.BIC.POS)
EB.LocalReferences.GetLocRef("REDO.ACH.PARTICIPANTS","L.LBTR.BIC",L.LBTR.BIC.POS);* R22 UTILITY AUTO CONVERSION

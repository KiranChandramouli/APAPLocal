* @ValidationCode : MjoyMDQxMzc2NzY0OlVURi04OjE2ODk3NDk2NTc0Nzc6SVRTUzotMTotMTo3NTc6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*-----------------------------------------------------------------------------
    ...
    $INSERT I_F.L.APAP.REP.MANUAL ;*R22 Auto Conversion -END
...
*            CALL F.READ(FN.L.APAP.REP.MANUAL,AA.INTEREST.ID,R.REP.MANUAL,F.L.APAP.REP.MANUAL,L.APAP.REP.MANUAL.ERR);
            CALL F.READU(FN.L.APAP.REP.MANUAL,AA.INTEREST.ID,R.REP.MANUAL,F.L.APAP.REP.MANUAL,L.APAP.REP.MANUAL.ERR,'');;* R22 UTILITY AUTO CONVERSION

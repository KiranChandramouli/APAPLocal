* @ValidationCode : MjoxOTc3NTA0MjgzOkNwMTI1MjoxNzAyOTg4MzQ2NzMyOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*13-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     T24.BP,TAM.BP,ATM.BP is Removed,FM to @FM
...
*   CALL OFS.CALL.BULK.MANAGER("DIARY.OFS", FINAL.OFS.2, OFS.RESP, TXN.COMMIT) ;* R22 Manual conversion - End
    EB.Interface.OfsCallBulkManager("DIARY.OFS", FINAL.OFS.2, OFS.RESP, TXN.COMMIT)  ;*R22 Manual Code Conversion_Utility Check
...
EB.TransactionControl.JournalUpdate(ID);* R22 UTILITY AUTO CONVERSION
RETURN

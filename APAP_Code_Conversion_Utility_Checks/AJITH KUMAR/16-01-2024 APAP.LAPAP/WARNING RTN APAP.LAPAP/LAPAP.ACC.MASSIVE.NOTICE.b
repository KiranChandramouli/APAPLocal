...
EB.LocalReferences.GetLocRef("ACCOUNT","L.AC.NOTIFY.1",POS);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF("ACCOUNT","L.AC.NOTIFY.2",PO2)
EB.LocalReferences.GetLocRef("ACCOUNT","L.AC.NOTIFY.2",PO2);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxNTE3MDI1NDgxOlVURi04OjE2ODk3NDk2NTU2Nzk6SVRTUzotMTotMTo2OTA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*        CALL F.READ(FN.REDO.AA.NCF.IDS,Y.USER.ID,R.REDO.AA.NCF.IDS.FROM,F.REDO.AA.NCF.IDS,R.REDO.AA.NCF.IDS.ERR.FROM)
        CALL F.READU(FN.REDO.AA.NCF.IDS,Y.USER.ID,R.REDO.AA.NCF.IDS.FROM,F.REDO.AA.NCF.IDS,R.REDO.AA.NCF.IDS.ERR.FROM,'');* R22 UTILITY AUTO CONVERSION
...
EB.TransactionControl.JournalUpdate('FROM.ID');* R22 UTILITY AUTO CONVERSION
RETURN

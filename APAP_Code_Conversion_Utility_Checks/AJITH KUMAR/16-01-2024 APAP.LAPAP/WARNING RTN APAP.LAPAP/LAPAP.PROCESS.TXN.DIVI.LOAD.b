* @ValidationCode : MjoyOTEyMzk4OkNwMTI1MjoxNjkzMjA3NTE3MTA3OklUU1M6LTE6LTE6ODgzOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 28 Aug 2023 12:55:17
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 883
...
IDVAR.1 = "SYSTEM" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.TIPO.CAMBIO.SDT,IDVAR.1,R.TIPO.CAMBIO,F.TIPO.CAMBIO.SDT,TIPO.CAMBIO.ERR);* R22 UTILITY AUTO CONVERSION

*    CALL F.READ(FN.TIPO.TRANS.SDT,"SYSTEM",R.TIPO.TRANS,F.TIPO.TRANS.SDT,TIPO.TRANS.ERR)
IDVAR.1 = "SYSTEM" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.TIPO.TRANS.SDT,IDVAR.1,R.TIPO.TRANS,F.TIPO.TRANS.SDT,TIPO.TRANS.ERR);* R22 UTILITY AUTO CONVERSION

*    CALL F.READ(FN.MONEDA.SDT,"SYSTEM",R.MONEDA,F.MONEDA.SDT,MONEDA.ERR)
IDVAR.1 = "SYSTEM" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.MONEDA.SDT,IDVAR.1,R.MONEDA,F.MONEDA.SDT,MONEDA.ERR);* R22 UTILITY AUTO CONVERSION

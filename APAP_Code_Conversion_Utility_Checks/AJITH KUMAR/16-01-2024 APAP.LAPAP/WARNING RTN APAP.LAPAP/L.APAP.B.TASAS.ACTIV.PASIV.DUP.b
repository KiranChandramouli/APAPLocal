* @ValidationCode : MjoyNDc1NjIzNTA6Q3AxMjUyOjE3MDI5ODgzNDU5MzM6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
...
*13-07-2023    AJITHKUMAR S        R22 MANUAL CONVERSION   VARAIABLE NAME MODIFIED
...
*    Y.PRODUCT = R.AA.ARRANGEMENT<AA.ARR.PRODUCT>
    ...
    STRT.DATE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer>
...
*   CALL AA.SCHEDULE.PROJECTOR(REC.ID, SIMULATION.REF, NO.RESET, DATE.RANGE, TOT.PAYMENT, DUE.DATES, DUE.DEFER.DATES, DUE.TYPES, DUE.METHODS,DUE.TYPE.AMTS, DUE.PROPS, DUE.PROP.AMTS, DUE.OUTS)
    AA.PaymentSchedule.ScheduleProjector(REC.ID, SIMULATION.REF, NO.RESET, DATE.RANGE, TOT.PAYMENT, DUE.DATES, DUE.DEFER.DATES, DUE.TYPES, DUE.METHODS,DUE.TYPE.AMTS, DUE.PROPS, DUE.PROP.AMTS, DUE.OUTS) ;*R22 Manual Code Conversion_Utility Check
...
*    IF YDATE[1,4] > YDATE1[1,4] THEN
    IF YDATE[1,4] GT YDATE1[1,4] THEN;* R22 UTILITY AUTO CONVERSION
        TMP.YDATE1 = YDATE1
        TMP.YDATE = YDATE
        YDATE1 = TMP.YDATE
        YDATE = TMP.YDATE1

* @ValidationCode : Mjo2MDE2Mzk3NDQ6Q3AxMjUyOjE2ODQyMjI4MDc1NTc6SVRTUzotMTotMTozOTY6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*    CALL F.READ(FN.BEN.LIST,ID,R.BEN.LIST,F.BEN.LIST,ERR)
    CALL F.READU(FN.BEN.LIST,ID,R.BEN.LIST,F.BEN.LIST,ERR,'');* R22 UTILITY AUTO CONVERSION

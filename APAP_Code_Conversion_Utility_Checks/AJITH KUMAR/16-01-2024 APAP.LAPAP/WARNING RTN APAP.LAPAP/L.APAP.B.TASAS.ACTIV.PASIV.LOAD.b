...
*13-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     FM ,SM,VM to @FM,@SM,@VM,INCLUDE to INSERT,TAM.BP is Removed
...
IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.DR.REG.PASIVAS.PARAM,IDVAR.1,R.DR.REG.PASIVAS.PARAM,DR.REG.PASIVAS.PARAM.ERR);* R22 UTILITY AUTO CONVERSION
    ...
    END
    Y.COMP.VAL.ARR = CHANGE(Y.COMP.VAL.ARR,@SM,@VM) ;*R22 Auto code conversion
    ...
    Y.TIPO.DIS.ARR = CHANGE(Y.TIPO.DIS.ARR,@SM,@VM) ;*R22 Auto code conversion
...
EB.LocalReferences.GetLocRef('AA.ARR.OVERDUE','L.LOAN.COND',Y.L.LOAN.COND.POS);* R22 UTILITY AUTO CONVERSION

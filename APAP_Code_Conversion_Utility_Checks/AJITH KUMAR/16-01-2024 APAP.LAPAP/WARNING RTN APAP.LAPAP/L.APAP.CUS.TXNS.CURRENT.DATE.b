...
EB.LocalReferences.GetLocRef("FUNDS.TRANSFER", "L.INP.USER.ID", L.INP.USER.ID.POS);* R22 UTILITY AUTO CONVERSION
...
EB.LocalReferences.GetLocRef("FUNDS.TRANSFER", "L.TT.COMM.AMT", L.TT.COMM.AMT.POS);* R22 UTILITY AUTO CONVERSION

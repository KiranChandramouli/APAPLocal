* @ValidationCode : MjotNzA1NzE4ODYyOkNwMTI1MjoxNzA1MDQzNzcwMTQ5OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 12 Jan 2024 12:46:10
...
EB.LocalReferences.GetLocRef("FUNDS.TRANSFER","L.CHAR.EDIT",Y.EDIT.CHAR.POS);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.ST.L.APAP.GENERACION.CARGO,Y.ACCOUNT.ID,R.L.APAP.GENERACION,F.ST.L.APAP.GENERACION.CARGO,ERROR.GENERACION.CARGO)
    CALL F.READU(FN.ST.L.APAP.GENERACION.CARGO,Y.ACCOUNT.ID,R.L.APAP.GENERACION,F.ST.L.APAP.GENERACION.CARGO,ERROR.GENERACION.CARGO,'');* R22 UTILITY AUTO CONVERSION
...
EB.LocalReferences.GetLocRef("FUNDS.TRANSFER","L.TOTAL.PAY",Y.TOTAL.PAY.POS);* R22 UTILITY AUTO CONVERSION
...
*===============
  ...
  *  CALL F.READ(FN.AA.ARRANGEMENT,Y.AA.ID,R.ARRANGEMENT,F.AA.ARRANGEMENT,ERR.ARRANGEMENT)
    R.ARRANGEMENT=AA.Framework.Arrangement.Read(Y.AA.ID, ERR.ARRANGEMENT)
    Y.START.DATE = R.ARRANGEMENT<AA.Framework.ArrangementSim.ArrOrigContractDate>
...
EB.LocalReferences.GetLocRef ("AA.PRD.DES.PAYMENT.SCHEDULE", "L.AA.PAY.METHD",L.AA.PAY.METHD.POS);* R22 UTILITY AUTO CONVERSION
...
IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ (FN.LAPAP.CARGO.ABONO.EXTRAC,IDVAR.1,R.LAPAP.CARGO.ABONO.EXTRAC,F.LAPAP.CARGO.ABONO.EXTRAC,ERR.PAGO.EXTRA);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxMjg1ODA5Mzg1OkNwMTI1MjoxNjg0MjIyNzc1MDc2OklUU1M6LTE6LTE6NDc3OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 16 May 2023 13:09:35
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 477
...
*    CALL F.READ(FN.DR.REG.FD03.CONCAT,CONCAT.ID,R.DR.REG.FD03.CONCAT,F.DR.REG.FD03.CONCAT,DR.REG.FD03.CONCAT.ERR)
    CALL F.READU(FN.DR.REG.FD03.CONCAT,CONCAT.ID,R.DR.REG.FD03.CONCAT,F.DR.REG.FD03.CONCAT,DR.REG.FD03.CONCAT.ERR,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotMTY2NjAyNDc0NDpDcDEyNTI6MTY5MTc1MTM0MjAyMzpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Aug 2023 16:25:42
...
*    IF TRIM(Y.PARAM, " ", "R") = ""  THEN
    IF TRIM(Y.PARAM, " ", "R") EQ ""  THEN;* R22 UTILITY AUTO CONVERSION
        Y.ERROR<1> = 1
...
*            IF (CONTA = CANT_OBJECT) THEN
            IF (CONTA EQ CANT_OBJECT) THEN;* R22 UTILITY AUTO CONVERSION
...
*    IF Y.ACC.BALANCE < Y.AMOUNT AND Y.VAR.OPER EQ 'DEBIT' THEN
    IF Y.ACC.BALANCE LT Y.AMOUNT AND Y.VAR.OPER EQ 'DEBIT' THEN;* R22 UTILITY AUTO CONVERSION
        Y.CAN.DO.OPERAT = 'false'

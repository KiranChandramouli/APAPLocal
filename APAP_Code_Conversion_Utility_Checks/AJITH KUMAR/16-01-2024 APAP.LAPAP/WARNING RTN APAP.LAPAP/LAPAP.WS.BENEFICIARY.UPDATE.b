* @ValidationCode : MjotMTg3NTYzMzUxNjpVVEYtODoxNzAyOTg4Mzg5ODYzOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
EB.LocalReferences.GetLocRef("BENEFICIARY","L.BEN.EMAIL",POS1);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF("BENEFICIARY","L.BEN.PROD.TYPE",POS2)
EB.LocalReferences.GetLocRef("BENEFICIARY","L.BEN.PROD.TYPE",POS2);* R22 UTILITY AUTO CONVERSION
...
* CALL OFS.CALL.BULK.MANAGER("DM.OFS.SRC.VAL", FINAL.OFS, OFS.RESP, TXN.COMMIT);* R22 Manual conversion - End
    EB.Interface.OfsCallBulkManager("DM.OFS.SRC.VAL", FINAL.OFS, OFS.RESP, TXN.COMMIT) ;*Manual R22 Conversion - Call Routine Format Modified
*    CALL JOURNAL.UPDATE('')

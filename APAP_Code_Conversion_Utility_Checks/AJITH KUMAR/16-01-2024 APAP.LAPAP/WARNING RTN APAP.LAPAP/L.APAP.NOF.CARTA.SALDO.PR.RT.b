* @ValidationCode : MjotNzIwMzI4MzI6Q3AxMjUyOjE3MDQ4MDAzODIzMTI6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 09 Jan 2024 17:09:42
...
*------------------------------------------------------------------------
*DATE                WHO                REFERENCE
* 24-MARCH-2023     Conversion Tool  R22 Auto Conversion - changed T24.BP in insert
* 24-MARCH-2023     Conversion Tool  R22 Auto Conversion - changed F.READ to CACHE.READ
* 07-06-2023        Ghayathri T      R22 Manual Conversion - uncommanded the Y.EB.COM.COMPANY.NAME variable initialised line
*------------------------------------------------------------------------
  ...
  *  $INSERT I_F.AA.ARRANGEMENT
    $INSERT I_F.AA.CUSTOMER;*--> FBNK.AA.ARR.CUSTOMER
    $INSERT I_F.AA.PRODUCT
    $INSERT I_F.EB.CONTRACT.BALANCES
    $INSERT I_F.AA.TERM.AMOUNT;*WHERE OPEN BALANCE IS STORED...
    $INSERT I_F.USER
...
GET.AA.ARR.INFO:
    ...
    IF AA.ARR.ERR NE 'RECORD NOT FOUND' THEN
      *  Y.AA.ARR.CUSTOMER = R.AA.ARR<AA.ARR.CUSTOMER>
         Y.AA.ARR.CUSTOMER = R.AA.ARR<AA.Framework.ArrangementSim.ArrCustomer>
       * Y.AA.ARR.PRODUCT = R.AA.ARR<AA.ARR.PRODUCT>
         Y.AA.ARR.PRODUCT = R.AA.ARR<AA.Framework.Arrangement.ArrProduct>
       * Y.AA.ARR.LINKED.APPL.ID = R.AA.ARR<AA.ARR.LINKED.APPL.ID>     ;*ACCOUNT.NUMBER AT ACCOUNT TABLE
        Y.AA.ARR.LINKED.APPL.ID = R.AA.ARR<AA.Framework.ArrangementSim.ArrLinkedApplId>     ;*ACCOUNT.NUMBER AT ACCOUNT TABLE
        *Y.AA.ARR.START.DATE = R.AA.ARR<AA.ARR.ORIG.CONTRACT.DATE>
        Y.AA.ARR.START.DATE = R.AA.ARR< AA.Framework.ArrangementSim.ArrOrigContractDate>
        IF Y.AA.ARR.START.DATE EQ '' THEN
          *  Y.AA.ARR.START.DATE = R.AA.ARR<AA.ARR.START.DATE>
             Y.AA.ARR.START.DATE = R.AA.ARR<AA.Framework.ArrangementSim.ArrStartDate>
        END
...
AA.Framework.GetArrangementConditions(Y.AA.ARRANGEMENT.ID,PROP.CLASS,PROP.NAME,'','',R.AA0,RET.ERR);* R22 UTILITY AUTO CONVERSION
...
GET.PRODUCT.DESC:
    CALL CACHE.READ(FN.AA.PRD, Y.AA.ARR.PRODUCT, R.AA.PRD, AA.PRD.ERR)
...
*    CALL L.APAP.FECHA.CANC.PR.RT(Y.AA.ARRANGEMENT.ID,OUT.ARR)
    APAP.LAPAP.lApapFechaCancPrRt(Y.AA.ARRANGEMENT.ID,OUT.ARR) ;* R22 Manual Conversion
...
AA.Framework.GetArrangementConditions(Y.AA.ARRANGEMENT.ID,PROP.CLASS,PROP.NAME,'','',R.AA,RET.ERR);* R22 UTILITY AUTO CONVERSION
...
GET.USER.DETAILS:
    Y.USER.ID = OPERATOR
    CALL CACHE.READ(FN.USR, Y.USER.ID, R.USR, USR.ERR)
...
*Y.EB.COM.COMPANY.NAME = R.COMP<EB.COM.COMPANY.NAME>
    Y.EB.COM.COMPANY.NAME = R.COMP<EB.COM.COMPANY.NAME>;* R22 Manual Conversion uncommanded the Y.EB.COM.COMPANY.NAME variable initialised line

...
*13-07-2023    AJITHKUMAR S        R22 MANUAL CONVERSION  CALL ROUTINE FORMAT CAN BE MODIFIED
*----------------------------------------------------------------------------------------
    ...
    BEGIN CASE
        ...
        CASE YDTE NE ''
            ...
            WHILE REPAYMENT.ID:RP.POSN
                ...
                IF REPAYMENT.ID[1,3] NE 'CHG' THEN
                    CONTINUE
                END
...
* CALL REDO.NCF.PERF.RTN(Y.CNT,NCF.NUMBER)
        APAP.TAM.redoNcfPerfRtn(Y.CNT,NCF.NUMBER) ;*R22 MANUAL CODE CONVERSION

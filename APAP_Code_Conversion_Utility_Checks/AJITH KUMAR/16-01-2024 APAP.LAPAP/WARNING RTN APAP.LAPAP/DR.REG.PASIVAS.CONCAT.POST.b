* @ValidationCode : MjotMTYyNzQwMjQ3NjpDcDEyNTI6MTcwMjk4ODM0MjE5MDpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
...
*    CALL F.READ(FN.CHK.DIR,ACEXTRACT.FILE.ID,R.FIL,F.CHK.DIR,READ.FIL.ERR)
    CALL F.READU(FN.CHK.DIR,ACEXTRACT.FILE.ID,R.FIL,F.CHK.DIR,READ.FIL.ERR,'');* R22 UTILITY AUTO CONVERSION
    IF R.FIL THEN
...
*    CALL F.READ(FN.CHK.DIR,AZEXTRACT.FILE.ID,R.FIL,F.CHK.DIR,READ.FIL.ERR)
    CALL F.READU(FN.CHK.DIR,AZEXTRACT.FILE.ID,R.FIL,F.CHK.DIR,READ.FIL.ERR,'');* R22 UTILITY AUTO CONVERSION
    IF R.FIL THEN

* @ValidationCode : MjotMTMwMDAzNzgzNTpDcDEyNTI6MTY4OTc0NDU2ODI2MTpJVFNTOi0xOi0xOjEwNjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Jul 2023 10:59:28
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1060
...
EB.LocalReferences.GetLocRef("FUNDS.TRANSFER","L.MON.CARG",Y.CHAR.AMOUNT.POS);* R22 UTILITY AUTO CONVERSION
    Y.MONTO.CARGO = R.NEW(FT.LOCAL.REF)<1,Y.CHAR.AMOUNT.POS>

    Y.CHAR.ACC.POS = '';
*    CALL GET.LOC.REF("FUNDS.TRANSFER","L.CHAR.ACC",Y.CHAR.ACC.POS)
EB.LocalReferences.GetLocRef("FUNDS.TRANSFER","L.CHAR.ACC",Y.CHAR.ACC.POS);* R22 UTILITY AUTO CONVERSION
...
EB.LocalReferences.GetLocRef("FUNDS.TRANSFER","L.FT.ORIGEN",Y.FT.ORIGEN.POS);* R22 UTILITY AUTO CONVERSION

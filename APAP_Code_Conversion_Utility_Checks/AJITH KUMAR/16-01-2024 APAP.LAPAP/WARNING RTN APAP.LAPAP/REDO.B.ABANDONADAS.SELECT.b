...
EB.Service.ClearFile(FN.DR.REG.ABANDON.WORKFILE, F.DR.REG.ABANDON.WORKFILE);* R22 UTILITY AUTO CONVERSION
...
EB.Service.BatchBuildList("",LIST.ACC);* R22 UTILITY AUTO CONVERSION
RETURN
END

* @ValidationCode : MjoxODEzODI2NTE4OkNwMTI1MjoxNzAyOTg4MzQwOTEyOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*13-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     t24.BP is removed ,VM,SM,FMto @VM,@SM,@FM, I to I.VAR
...
*   $INSERT I_F.AA.ARRANGEMENT;* PACS00309079 ;*R22 Manual Code Conversion_Utility Check
...
*   $INSERT I_F.ACCOUNT
    ...
    $INSERT I_F.COUNTRY
    $INSERT I_F.CURRENCY
    $INSERT I_DR.REG.213IF01.TXN.EXTRACT.COMMON ;*R22 Auto code conversion
    $INSERT I_F.DR.REG.213IF01.PARAM
    $INSERT I_F.DR.REG.213IF01.CONCAT
    $INSERT I_F.REDO.RTE.CUST.CASHTXN ;*R22 Auto code conversion
...
****************
    ...
    TOT.CASH.AMT = ''
**R22 Auto code conversion-Start: Missing variable initialize
    L.2ND.NAME.POS = '';AZ.L.AC.STATUS.POS=''; L.PASSPORT.POS=''; L.1ST.NAME.POS=''
    L.T24FS.TRA.DAY.POS=''; ymend=''; L.TT.BENEFICIAR.POS=''; L.ACT.BEN.POS=''; Y.LAST.WORK.DAY=''; L.OLD.ID.CARD.POS=''; L.PEP.BEN.POS=''; L.FT.ADD.INFO.POS=''; L.PEP.INTERM.POS=''; L.INV.FACILITY.POS='';  L.SEX.POS=''; Y.TFS.SERVICE.VERSIONS=''
    L.TYPE.PEP.INT.POS=''; TT.L.CUSTOMER.CODE.POS=''; L.ACT.INT.POS=''; Y.TFS.LCY.VERSIONS=''; L.2ND.LAST.NAME.POS=''; L.LAST.NAME.POS=''; TT.L.TT.CR.ACCT.NO.POS=''; L.NATIONALITY.POS=''; TT.L.TT.AC.STATUS.POS=''; L.NEW.ID.CARD.POS=''; L.TYPE.PEP.BEN.POS=''
**R22 Auto code conversion-End
...
************
    ...
    CNT.TXN = DCOUNT(R.REDO.RTE.CUST.CASHTXN<RTE.CASH.AMOUNT>,@VM) ;*R22 Auto code conversion
...
*  Change - New RTE 24 hours process.
    ...
    IF R.REDO.RTE.CUST.CASHTXN THEN
        ...
        FOR I.VAR = 1 TO Y.TXN.CNT
            IF R.REDO.RTE.CUST.CASHTXN<RTE.CASH.AMOUNT,I.VAR> NE '' THEN ;*R22 Auto code conversion
                Y.RTE.TXN.CNT += 1
                TOT.CASH.AMT += R.REDO.RTE.CUST.CASHTXN<RTE.CASH.AMOUNT,I.VAR>
*                IF TOT.CASH.AMT GE AMT.LCY THEN
                Y.ID.COMPANY = R.REDO.RTE.CUST.CASHTXN<RTE.BRANCH.CODE,I.VAR>
                Y.RTE.TXN.DATE = R.REDO.RTE.CUST.CASHTXN<RTE.TRANS.DATE,I.VAR> ;*R22 Auto code conversion
                AMT.TXN  = R.REDO.RTE.CUST.CASHTXN<RTE.CASH.AMOUNT,I.VAR>
                Y.TXN.ID = R.REDO.RTE.CUST.CASHTXN<RTE.TXN.ID,I.VAR> ;*R22 Auto code conversion
...
*Requerimiento CN009150
                ...
                TXN.REF = R.REDO.RTE.CUST.CASHTXN<RTE.TXN.ID,I.VAR>
...
**************
    ...
    CHANGE @VM TO @FM IN ACC.CODE.AFFCT.LIST ;*R22 Auto code conversion
...
*       CALL F.READ(FN.AA.ARRANGEMENT,ARR.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,AA.ARRANGEMENT.ERR)
        R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(ARR.ID, AA.ARRANGEMENT.ERR) ;*R22 Manual Code Conversion_Utility Check
        IF NOT(R.AA.ARRANGEMENT) THEN
            RETURN
        END
*       AAR.STATUS.VAL = R.AA.ARRANGEMENT<AA.ARR.ARR.STATUS>
        AAR.STATUS.VAL = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrArrStatus> ;*R22 Manual Code Conversion_Utility Check
        BEGIN CASE
    ...
    END ELSE
        ...
        STAT2.CNT = DCOUNT(AC.STATUS2.VAL,@SM) ;*R22 Auto code conversion

* @ValidationCode : MjotNDc0OTM5ODI5OkNwMTI1MjoxNzAyOTg4MzQ0MzI0OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*13-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION    LAPAP.BP is Removed, IF CONDITION IS MODIFIED ,VM to @VM
...
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
*   $INSERT I_F.AA.ARRANGEMENT.ACTIVITY ;*R22 Manual Code Conversion_Utility Check
...
*   CALL F.READ(FN.AA.ARRANGEMENT,AA.ACT.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,ERR.AA.ARRANGEMENT)
    R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(AA.ACT.ID, ERR.AA.ARRANGEMENT)
*   YPRD.GRP = R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP>
    YPRD.GRP = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup>
    IF YPRD.GRP NE 'LINEAS.DE.CREDITO.TC' THEN
        RETURN
...
*   YAA.PROD = R.AA.ARRANGEMENT<AA.ARR.PRODUCT,1>
    ...
    YAA.CUST = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer,1>
    YAA.EFFDTE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProdEffDate,1>
    YAA.CONT.DTE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrOrigContractDate,1>
    YAA.ACCT.ID= R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId,1>
    YAA.CO.CODE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCoCode>
...
*   CALL AA.GET.PERIOD.BALANCES(YAA.ACCT.ID, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE)
    AA.Framework.GetPeriodBalances(YAA.ACCT.ID, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE) ;*R22 Manual Code Conversion_Utility Check

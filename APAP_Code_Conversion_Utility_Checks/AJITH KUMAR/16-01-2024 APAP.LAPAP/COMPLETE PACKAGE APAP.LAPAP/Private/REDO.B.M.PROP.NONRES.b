* @ValidationCode : MjoxMDU4NDAxMzcwOkNwMTI1MjoxNzA1Mzc5MTAxMzg3OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jan 2024 09:55:01
    ...
    IF NOT(REDO.CUS.ERR) THEN
        ...
        WHILE Y.AA.ARRANGEMENT:Y.POS
            *CALL F.READ(FN.AA.ARRANGEMENT,Y.AA.ARRANGEMENT,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,AA.ERR)
            R.AA.ARRANGEMENT=AA.Framework.Arrangement.Read(Y.AA.ARRANGEMENT, AA.ERR)
             ...
             *   Y.ARR.STATUS = R.AA.ARRANGEMENT<AA.ARR.ARR.STATUS>
                ...
                Y.PRODUCT.LINE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductLine>
                Y.PRODUCT.GROUP = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup>
...
*-------------
*
    Y.AA.CUSTOMER = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer>
...
AA.Framework.GetArrangementConditions(AA.ARRANGEMENT.ID,ID.PROPERTY.CLASS,ID.PROPERTY,EFF.DATE,ID.OUT,OUT.COND,OUT.ERR);* R22 UTILITY AUTO CONVERSION

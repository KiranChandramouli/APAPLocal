* @ValidationCode : MjotMTUxMTkyNjAyNDpVVEYtODoxNjg5NzQ5NjUzOTQxOklUU1M6LTE6LTE6MzczOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
* 13-07-2023    Conversion Tool        R22 Auto Conversion     BP is removed in insert file, REM to DISPLAY.MESSAGE(TEXT, ''),B to B.VAR
* 13-07-2023    Namadha V              R22 Manual Conversion   No Changes
*-----------------------------------------------------------------------------
...
EB.LocalReferences.GetLocRef(FN.CUS,"L.CU.RES.SECTOR",Y.SECTOR.POS);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF(FN.CUS,"L.CU.URB.ENS.RE",Y.URB.POS)
EB.LocalReferences.GetLocRef(FN.CUS,"L.CU.URB.ENS.RE",Y.URB.POS);* R22 UTILITY AUTO CONVERSION
    Y.SECTOR.POS = 11
    Y.URB.POS = 14
    Y.TEL.TYPE.POS = 21
    Y.TEL.AREA.POS = 22
...
*DEBUG
    ...
    Y.STR.TEL.EXT = ''
    Y.STR.TEL.PER = ''
    FOR B.VAR = 1 TO Y.TEL.QNT STEP 1


        Y.STR.TIPO.TEL := Y.TEL.TYPE<1,1,B.VAR>
        Y.STR.TEL.ARA := Y.TEL.AREA<1,1,B.VAR>
        Y.STR.TEL.NO := Y.TEL.NO<1,1,B.VAR>
        Y.STR.TEL.EXT := Y.TEL.EXT<1,1,B.VAR>

        Y.STR.TEL.PER := Y.TEL.PER<1,1,B.VAR>
        IF B.VAR NE Y.TEL.QNT THEN
            Y.STR.TIPO.TEL := @VM
            Y.STR.TEL.ARA := @VM
            Y.STR.TEL.NO := @VM
            Y.STR.TEL.EXT := @VM

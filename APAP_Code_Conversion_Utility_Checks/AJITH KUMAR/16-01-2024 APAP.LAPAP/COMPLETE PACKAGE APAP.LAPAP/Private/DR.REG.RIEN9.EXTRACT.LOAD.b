* @ValidationCode : MjotMjA5NjQ3MDczMzpDcDEyNTI6MTcwMjk4ODM0Mjk0MjpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
...
****************
    ...
    CALL CACHE.READ(FN.REDO.H.PROVISION.PARAMETER,Y.SYS.ID,R.REDO.H.PROVISION.PARAMETER,REDO.H.PROVISION.PARAMETER.ERR) ;*R22 Manual Code Conversion_Utility Check

    DR.REG.RIEN9.PARAM.ERR = ''; R.DR.REG.RIEN9.PARAM = ''
    CALL CACHE.READ(FN.DR.REG.RIEN9.PARAM,Y.SYS.ID,R.DR.REG.RIEN9.PARAM,DR.REG.RIEN9.PARAM.ERR) ;*R22 Manual Code Conversion_Utility Check

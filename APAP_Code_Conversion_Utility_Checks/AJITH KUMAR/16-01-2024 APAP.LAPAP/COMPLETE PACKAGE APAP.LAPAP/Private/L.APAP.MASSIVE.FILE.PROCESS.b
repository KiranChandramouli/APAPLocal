* @ValidationCode : MjoxOTAxMzMzNTA4OkNwMTI1MjoxNzAyOTg4MzU3ODc4OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Dec 2023 17:49:17
...
*   CALL OFS.CALL.BULK.MANAGER(OFS.SRC, OFS.STRING.PRIN, OFS.RESP, TXN.COMMIT)
    EB.Interface.OfsCallBulkManager(OFS.SRC, OFS.STRING.PRIN, OFS.RESP, TXN.COMMIT) ;*R22 Manual Code Conversion_Utility Check
...
*   CALL OFS.CALL.BULK.MANAGER(OFS.SRC, OFS.STRING.PENAL, OFS.RESP, TXN.COMMIT)
    EB.Interface.OfsCallBulkManager(OFS.SRC, OFS.STRING.PENAL, OFS.RESP, TXN.COMMIT) ;*R22 Manual Code Conversion_Utility Check
    CALL OCOMO(" END MESSAGE- ":ARR.ID:" - END RESP - ":OFS.RESP)

* @ValidationCode : MjotMTc1MDc0OTYyNzpDcDEyNTI6MTY5MDE2NzU1NDA0NzpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 24 Jul 2023 08:29:14
...
IDVAR.1 = "SYSTEM" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.NCLIM,IDVAR.1,R.NCLIM,F.NCLIM,NCLIM.ERR);* R22 UTILITY AUTO CONVERSION
...
IDVAR.1 = "USD" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.CURREN,IDVAR.1,R.CURREN,F.CURREN,CURREN.ERR);* R22 UTILITY AUTO CONVERSION
...
*            CALL LAPAP.I.NOCUS.DECLINED.RT
            APAP.LAPAP.lapapINocusDeclinedRt()          ;*Manual R22 conversion

* @ValidationCode : Mjo1Nzc4MDQzNjQ6Q3AxMjUyOjE2OTAxNjc1NTY5MDI6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
*13/07/2023	 CONVERSION TOOL        AUTO R22 CODE CONVERSION	   LAPAP.BP is removed in insertfile
*-----------------------------------------------------------------------------------------------------------------------
...
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.REDO.APAP.CREDIT.CARD.DET ;*AUTO R22 CODE CONVERSION
...
*        CALL F.READ(FN.REDO.APAP.CREDIT.CARD.DET,YCARD.ID,R.REDO.APAP.CREDIT.CARD.DET,F.REDO.APAP.CREDIT.CARD.DET,ERR.REDO.APAP.CREDIT.CARD.DET)
        CALL F.READU(FN.REDO.APAP.CREDIT.CARD.DET,YCARD.ID,R.REDO.APAP.CREDIT.CARD.DET,F.REDO.APAP.CREDIT.CARD.DET,ERR.REDO.APAP.CREDIT.CARD.DET,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxOTcwNTU3NzA1OkNwMTI1MjoxNzAyOTg4MzM4Mjc5OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*    CALL EB.READLIST(CMD,SEL.LIST,'',CNT1,ER)
    FN.BP = "&SAVEDLISTS&" ;*R22 Manual Code Conversion
    F.BP = ''
*   OPEN "&SAVEDLISTS&" TO F.BP ELSE PRINT 'Unable to open SAVEDLIST' ;*R22 Manual Code Conversion
    OPEN FN.BP TO F.BP ELSE PRINT 'Unable to open SAVEDLIST'
    ...
    IF SEL.LIST THEN
        ...
        WHILE ACC.ID:POS
            ...
            READ R.ACCT FROM FV.ACCOUNT, ACC.ID ELSE
                ...
                GOSUB PROGRAM.END;* GOTO to GOSUB - R22 Manual conversion
            END
            GOSUB INIT.VARS
            GOSUB PROCESS
PROGRAM.END:

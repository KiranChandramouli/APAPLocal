* @ValidationCode : MjotNDc5MjAzMzg0OlVURi04OjE2ODk3NDk2NTY1OTQ6SVRTUzotMTotMTo0NTk6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*    CALL F.READ(FN.LAPAP.CONCATE.RN.RT,Y.ARRANGEMENT.ID,R.LAPAP.CONCATE.RN.RT,FV.LAPAP.CONCATE.RN.RT,ERRR.CONCATE)
    CALL F.READU(FN.LAPAP.CONCATE.RN.RT,Y.ARRANGEMENT.ID,R.LAPAP.CONCATE.RN.RT,FV.LAPAP.CONCATE.RN.RT,ERRR.CONCATE,'');* R22 UTILITY AUTO CONVERSION
RETURN

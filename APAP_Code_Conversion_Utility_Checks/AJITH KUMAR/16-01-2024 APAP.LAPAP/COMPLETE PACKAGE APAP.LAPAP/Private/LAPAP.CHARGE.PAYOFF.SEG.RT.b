* @ValidationCode : MjotNDM2NjMyNzA5OkNwMTI1MjoxNzA0ODAxNjgzMjEyOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 09 Jan 2024 17:31:23
...
*------------------------------------------------------------------------
*  DATE             WHO                   REFERENCE
* 20-JULY-2023      Harsha                R22 Auto Conversion  - VM to @VM , FM to @FM ,SM to @SM
* 20-JULY-2023      Harsha                R22 Manual Conversion - BP removed from Inserts and Added Call
  ...
  *  $INSERT  I_F.AA.ARRANGEMENT
   ...
   * $INSERT  I_F.AA.ARRANGEMENT.ACTIVITY
    ...
    $INCLUDE I_F.LAPAP.CARGO.EXTRAC
    $INCLUDE I_F.LAPAP.CARGO.EXT.SECT
...
READ.AA.ARRANGEMENT:
   ...
   * Y.START.DATE =  R.AA.ARRANGEMENT<AA.ARR.START.DATE>
    Y.START.DATE =  R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrStartDate>
    ...
    *Y.CUSTOMER.ID = R.AA.ARRANGEMENT<AA.ARR.CUSTOMER>
    ...
    Y.CUSTOMER.ID = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCustomer>
RETURN
LOAD.APLICATIONS:
...
GET.CAPITAL.PENDIENTE:
    APAP.LAPAP.lApapReturnBanlaceCancelacion(Y.AA.ID,OUT.RECORD)  ;*R22 Manual Conversion - Added Call

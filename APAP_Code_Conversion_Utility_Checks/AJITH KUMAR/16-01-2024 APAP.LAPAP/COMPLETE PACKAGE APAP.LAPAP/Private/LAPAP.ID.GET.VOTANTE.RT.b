...
IDVAR.1 = "2" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PRM, IDVAR.1, R.PRM2, FV.PRM, PRM2.ERR);* R22 UTILITY AUTO CONVERSION
...
IDVAR.1 = "3" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PRM, IDVAR.1, R.PRM3, FV.PRM, PRM3.ERR);* R22 UTILITY AUTO CONVERSION
...
IDVAR.1 = "4" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PRM, IDVAR.1, R.PRM4, FV.PRM, PRM4.ERR);* R22 UTILITY AUTO CONVERSION

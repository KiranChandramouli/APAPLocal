* @ValidationCode : MjotMTQ0MTQ0MzUzOkNwMTI1MjoxNjg0MjIyODA3MTYzOklUU1M6LTE6LTE6OTc4OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,IDVAR.1,R.REDO.APAP.CLEAR.PARAM,PARAM.ERR);* R22 UTILITY AUTO CONVERSION
*    CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,'SYSTEM',R.REDO.H.AA.DIS.CHG,PRE.ERR)
IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,IDVAR.1,R.REDO.H.AA.DIS.CHG,PRE.ERR);* R22 UTILITY AUTO CONVERSION
RETURN
END

* @ValidationCode : Mjo3NDIyNDg3ODU6Q3AxMjUyOjE3MDUwNDMzNzk4ODg6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 Jan 2024 12:39:39
...
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
SUBROUTINE LAPAP.RAISE.ENTRY.IN(ARR.ID)
**==================================================================================================================================
...
* 14-07-2023    Conversion Tool        R22 Auto Conversion     BP is removed in Insert file,= to EQ,ENTRY.SUM + to +=
...
**==================================================================================================================================
    ...
    GOSUB PROCESS
    GOSUB UPDATE.LOG
    APAP.LAPAP.lapapCloseArrangementIn(ARR.NO);*R22 Manual Conversion
RETURN
...
*==============
    ...
    CALL F.READ(FN.TRANSACTION,TXN.CODE,R.TRANS,F.TRANSACTION,RET.ERR)

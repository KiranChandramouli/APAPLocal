* @ValidationCode : Mjo2NDU0ODg2MTQ6Q3AxMjUyOjE3MDI5ODgzNDc5MjQ6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
...
*---------------------------------------------------------------------------------------	-
    ...
    $INSERT I_F.COMPANY
*   $INSERT I_F.AA.ACCOUNT.DETAILS  ;*R22 Manual Code Conversion_Utility Check
    $INSERT I_F.ACCOUNT
...
FN.COMPANY = 'F.COMPANY';* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.COMPANY,Y.CO.CODE, R.COMP ,YERR);* R22 UTILITY AUTO CONVERSION
    IF YERR NE '' THEN
...
IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.H.PROVISION.PARAMETER,IDVAR.1, R.RHPP, YERR);* R22 UTILITY AUTO CONVERSION
*****PACS00523653****
...
*CALL REDO.R.COL.GET.MAPPING(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING.OUT, "", "")
    ...
    APAP.TAM.redoRColGetMapping(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING.OUT, "", "")  ;*R22 Manual Code Conversion

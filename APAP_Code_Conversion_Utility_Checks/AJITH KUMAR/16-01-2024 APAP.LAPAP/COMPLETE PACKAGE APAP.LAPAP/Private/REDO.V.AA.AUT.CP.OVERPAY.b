* @ValidationCode : MjoxMjQ0MjE2NjY3OlVURi04OjE3MDI5ODg0MDY1NTg6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 Dec 2023 17:50:06
...
*    CALL F.READ(FN.REDO.AA.CP.OVERPAYMENT,Y.CNCT.ID,R.REDO.AA.CP.OVERPAYMENT,F.REDO.AA.CP.OVERPAYMENT,ERR.REDO.AA.CP.OVERPAYMENT)
    CALL F.READU(FN.REDO.AA.CP.OVERPAYMENT,Y.CNCT.ID,R.REDO.AA.CP.OVERPAYMENT,F.REDO.AA.CP.OVERPAYMENT,ERR.REDO.AA.CP.OVERPAYMENT,'');* R22 UTILITY AUTO CONVERSION
*-------------------------------------------------------------------------------------------------

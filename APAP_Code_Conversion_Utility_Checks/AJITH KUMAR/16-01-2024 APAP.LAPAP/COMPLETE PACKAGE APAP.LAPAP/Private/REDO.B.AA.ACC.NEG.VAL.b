* @ValidationCode : Mjo3NDI4ODcwNDY6Q3AxMjUyOjE3MDUwNDU1ODY4ODU6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 Jan 2024 13:16:26
...
*13-07-2023       Conversion Tool        R22 Auto Code conversion          INSERT FILE MODIFIED,X TO X.VAR,FM TO @FM,VM TO @VM, SM TO @SM,++ TO +=,<= TO LE
...
*************
  ...
  *  Y.MAIN.STRT.DTE = R.AA.ARR<AA.ARR.START.DATE>
    ...
    Y.MAIN.ARR.STATUS = R.AA.ARR<AA.Framework.ArrangementSim.ArrProductGroup>
   ...
   * Y.LINKED.APPL.ID = R.AA.ARR<AA.ARR.LINKED.APPL.ID>
    ...
    Y.LINKED.APPL.ID = R.AA.ARR<AA.Framework.ArrangementSim.ArrLinkedApplId>
...
PRICNI.MVMT.APPL:
*---------------
    YARR.CNT = 0; X.VAR = 1   ;*R22 AUTO CODE CONVERSION
...
********************
   ...
   * CALL F.READ(FN.AA.ACTIVITY.HISTORY,AA.ID,R.AA.ACTIVITY.HISTORY,F.AA.ACTIVITY.HISTORY,ERR.AA.ACTIVITY.HISTORY)
    R.AA.ACTIVITY.HISTORY=AA.Framework.ActivityHistory.Read(AA.ID, ERR.AA.ACTIVITY.HISTORY)

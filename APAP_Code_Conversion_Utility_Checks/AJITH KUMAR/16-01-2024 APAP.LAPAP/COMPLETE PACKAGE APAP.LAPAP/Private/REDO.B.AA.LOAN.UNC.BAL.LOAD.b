...
*13-07-2023              Samaran T                R22 Manual Code conversion                         No Change
*-------------------------------------------------------------------------------------------------------------------------------------------
...
**********
    ...
    LOCATE "UNC.ACTIVITY" IN Y.FIELD.NME.ARR<1,1> SETTING TXNCE.POS THEN
        ...
        Y.TXNCDE.VAL.ARR = CHANGE(Y.TXNCDE.VAL.ARR,@SM,@VM)  ;*R22 AUTO CODE CONVERSION
    END

*    CALL GET.LOC.REF('COMPANY','L.CO.BOOK',L.CO.BOOK.POS)
EB.LocalReferences.GetLocRef('COMPANY','L.CO.BOOK',L.CO.BOOK.POS);* R22 UTILITY AUTO CONVERSION
RETURN

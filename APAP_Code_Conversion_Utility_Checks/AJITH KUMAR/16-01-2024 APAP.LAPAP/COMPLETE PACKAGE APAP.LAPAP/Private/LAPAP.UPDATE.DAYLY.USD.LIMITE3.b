* @ValidationCode : MjotMzgxOTc5MjQ5OlVURi04OjE2OTAxNjc1NTI5NjU6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
* <Rating>0</Rating>
*-----------------------------------------------------------------------------
SUBROUTINE LAPAP.UPDATE.DAYLY.USD.LIMITE3
*========================================================================
* Technical report:
* =================
* Company Name   : APAP
* Program Name   : APAP.UPDATE.DAYLY.USD.LIMITE3
* Date           : 2019-10-17
* Item ID        :
*========================================================================
* Brief description :
...
* 15-07-2023    Narmadha V             R22 Manual Conversion   BP is removed in insert file,Call routine format modified
*========================================================================
* Content summary :
* =================
* Table name     :
...
*    CALL GET.LOC.REF("TELLER","L.TT.BASE.AMT",POS2)
EB.LocalReferences.GetLocRef("TELLER","L.TT.BASE.AMT",POS2);* R22 UTILITY AUTO CONVERSION
    TELLER.AMOUNT = R.NEW(TT.TE.LOCAL.REF)<1,POS2>

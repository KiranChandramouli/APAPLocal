* @ValidationCode : MjoxNzk2MjQ2NTM3OkNwMTI1MjoxNjg0MjIyODAyNzMxOklUU1M6LTE6LTE6OTQ6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*-----------------------------------------------------------------------------
*-----------------------------------------------------------------------------
SUBROUTINE LAPAP.BUILD.OFS.LOAD(APP,FUNC,ID,RSS)
*========================================================================
* Technical report:
* =================
* Company Name   : APAP
...
* -------------  -----------       ---------------------------
* 2018-06-03     Richard HC         Initial Development
*Modification history
...
* Auto Increment :N/A
* Views/versions :N/A
* EB record      :LAPAP.BUILD.OFS.LOAD
* Routine        :LAPAP.BUILD.OFS.LOAD
*========================================================================
...
*------------------------------------------------------------------------
   ...
   $USING EB.TransactionControl
    ...
    APPL.NAME = APP                     ;* Table
    VERS.NAME = APP:",MB.DM.LOAD"       ;* Version
...
*   CALL OFS.POST.MESSAGE(FINAL.OFS,'',"DM.OFS.SRC.VAL",'')
    ...
    CALL OFS.POST.MESSAGE(FINAL.OFS,'',"DM.OFS.ACC.NOTICE",'')
*    CALL JOURNAL.UPDATE('')

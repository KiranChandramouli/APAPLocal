* @ValidationCode : Mjo2ODI1OTQ5Njg6Q3AxMjUyOjE3MDI5ODgzNDMxOTQ6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
...
*   AC.ID = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID,1>       ;* ACCOUNT is 1st multi-value.
    AC.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId,1>
...
*               CALL AA.GET.PERIOD.BALANCES(AC.ID, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE)
                AA.Framework.GetPeriodBalances(AC.ID, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE) ;*R22 Manual Code Conversion_Utility Check
...
*       CALL AA.GET.PERIOD.BALANCES(AC.ID, BALANCE.TO.CHECK,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE)
        AA.Framework.GetPeriodBalances(AC.ID, BALANCE.TO.CHECK,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE) ;*R22 Manual Code Conversion_Utility Check
        DAT.BALANCES = BAL.DETAILS<4>
...
*   CALL AA.GET.PERIOD.BALANCES(R.REDO.CONCAT.ACC.NAB, YCRF.TYPE,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE)
    AA.Framework.GetPeriodBalances(R.REDO.CONCAT.ACC.NAB, YCRF.TYPE,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE) ;*R22 Manual Code Conversion_Utility Check
    DAT.BALANCES = BAL.DETAILS<4>

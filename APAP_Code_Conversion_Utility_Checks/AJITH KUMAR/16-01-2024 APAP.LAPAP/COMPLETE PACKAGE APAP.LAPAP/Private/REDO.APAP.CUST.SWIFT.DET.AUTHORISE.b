...
*        CALL F.READ(FN.REDO.APAP.CUST.SWIFT.CONCAT,YCUST.ID,R.REDO.APAP.CUST.SWIFT.CONCAT,F.REDO.APAP.CUST.SWIFT.CONCAT,ERR.REDO.APAP.CUST.SWIFT.CONCAT)
        CALL F.READU(FN.REDO.APAP.CUST.SWIFT.CONCAT,YCUST.ID,R.REDO.APAP.CUST.SWIFT.CONCAT,F.REDO.APAP.CUST.SWIFT.CONCAT,ERR.REDO.APAP.CUST.SWIFT.CONCAT,'');* R22 UTILITY AUTO CONVERSION

...
*13-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     FM,SM,VM to @SM,@VM,@FM,TAM.BP is REMOVED.INCLUDE to INSERT
...
IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    ...
    CHANGE @VM TO @FM IN CAT.LIST3 ;*R22 Auto code conversion

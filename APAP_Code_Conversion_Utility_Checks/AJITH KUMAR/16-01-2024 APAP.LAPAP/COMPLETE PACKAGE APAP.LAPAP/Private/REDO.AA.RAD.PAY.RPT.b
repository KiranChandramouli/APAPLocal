* @ValidationCode : MjotNDAzMjU2OTUxOkNwMTI1MjoxNzA1MDQ0MjIwMjAxOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 12 Jan 2024 12:53:40
...
IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.L.NCF.STOCK,IDVAR.1,R.REDO.L.NCF.STOCK,REDO.L.NCF.STOCK.ERR);* R22 UTILITY AUTO CONVERSION
...
EB.LocalReferences.GetLocRef("ACCOUNT","L.OD.STATUS",L.OD.STATUS.POS);* R22 UTILITY AUTO CONVERSION
...
********
    ...
    WHILE AAA.ID:AAA.POSN
        ...
        *CALL F.READ(FN.AA.ARRANGEMENT.ACTIVITY,AAA.ID,R.AA.ARRANGEMENT.ACTIVITY,F.AA.ARRANGEMENT.ACTIVITY,ERR.AAA)
        R.AA.ARRANGEMENT.ACTIVITY=AA.Framework.ArrangementActivity.Read(AAA.ID, ERR.AAA)
       ...
       * ACTIVTTY.VAL = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.ACTIVITY>
        ...
        AA.ARR.ID = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.ArrangementActivity.ArrActArrangement >
        AA.EFF.ID = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.SimulationCapture.ArrActEffectiveDate>
        ACTIVTTY.VAL = R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.RrControl.ArrActActivity >
        ...
        LOCATE AAA.ID IN YACT.REF<1> SETTING AA.POSN THEN
          ...
          *  CALL F.READ(FN.AA.ARRANGEMENT,AA.ARR.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,ERR.AA.ARR)
            R.AA.ARRANGEMENT=AA.Framework.Arrangement.Read(AA.ARR.ID, ERR.AA.ARR)
            ...
            *YPROD.GRP = R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP>
            ...
            YACCOUNT.NO  = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId>
            YPROD = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct>
            YPROD.GRP = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct>
...
AA.Framework.GetPeriodBalances(YACCOUNT.NO, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE);* R22 UTILITY AUTO CONVERSION
RETURN
...
********************
   ...
   * CALL F.READ(FN.AA.ACTIVITY.HISTORY,AA.ARR.ID,R.AA.ACTIVITY.HISTORY,F.AA.ACTIVITY.HISTORY,ERR.AA.ACTIVITY.HISTORY)
    R.AA.ACTIVITY.HISTORY =AA.Framework.ActivityHistory.Read(RecId, Error)

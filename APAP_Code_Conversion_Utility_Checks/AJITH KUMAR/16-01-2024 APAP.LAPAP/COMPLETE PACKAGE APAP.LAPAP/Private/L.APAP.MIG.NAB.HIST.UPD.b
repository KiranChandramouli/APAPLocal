...
*        CALL F.READ(FN.REDO.AA.NAB.HISTORY,YAA.ID,R.NAB.HISTORY.REC,F.REDO.AA.NAB.HISTORY,ERR.REDO.AA.NAB.HISTORY)
        CALL F.READU(FN.REDO.AA.NAB.HISTORY,YAA.ID,R.NAB.HISTORY.REC,F.REDO.AA.NAB.HISTORY,ERR.REDO.AA.NAB.HISTORY,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.AA.NAB.HISTORY,YOLDAA.ID,R.NAB.HISTORY.RECHST,F.REDO.AA.NAB.HISTORY,ERR.REDO.AA.NAB.HISTORY)
    CALL F.READU(FN.REDO.AA.NAB.HISTORY,YOLDAA.ID,R.NAB.HISTORY.RECHST,F.REDO.AA.NAB.HISTORY,ERR.REDO.AA.NAB.HISTORY,'');* R22 UTILITY AUTO CONVERSION
RETURN

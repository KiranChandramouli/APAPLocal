* @ValidationCode : MjotNjE5MjI3MDc1OkNwMTI1MjoxNzAyOTg4MzQwNzQ1OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*   CALL EB.CLEAR.FILE(FN.DR.REG.213IF01.WORKFILE,F.DR.REG.213IF01.WORKFILE) ;*R22 Manual Code Conversion_Utility Check
    EB.Service.ClearFile(FN.DR.REG.213IF01.WORKFILE,F.DR.REG.213IF01.WORKFILE)

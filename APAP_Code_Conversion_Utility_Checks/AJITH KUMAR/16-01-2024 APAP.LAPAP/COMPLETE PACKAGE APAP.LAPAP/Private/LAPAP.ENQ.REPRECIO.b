* @ValidationCode : Mjo5NDg4ODExMjc6Q3AxMjUyOjE3MDUwMzMzNDA4MTU6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 Jan 2024 09:52:20
...
EB.LocalReferences.GetLocRef(LOC.REF.APPLICATION,LOC.REF.FIELDS,LOC.REF.POS.2);* R22 UTILITY AUTO CONVERSION
...
EB.LocalReferences.GetLocRef("ACCOUNT","L.EB.TASA.POOL",ACC.POS.POOL);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF("ACCOUNT","L.STAT.INT.RATE",ACC.POS.TASA)
EB.LocalReferences.GetLocRef("ACCOUNT","L.STAT.INT.RATE",ACC.POS.TASA);* R22 UTILITY AUTO CONVERSION
...
************************
    ...
    IF Y.CATEGORY NE '' THEN
        ...
        IF Y.ARRANGEMENT.ID NE '' THEN
            ...
            Y.TIPO.PRODUCTO = R.AA.ARR< AA.Framework.ArrangementSim.ArrProductGroup>
...
AA.Framework.GetArrangementConditions(Y.PRESTAMO,PROP.CLASS,PROP.NAME,'','',returnConditions,ERR.COND);* R22 UTILITY AUTO CONVERSION

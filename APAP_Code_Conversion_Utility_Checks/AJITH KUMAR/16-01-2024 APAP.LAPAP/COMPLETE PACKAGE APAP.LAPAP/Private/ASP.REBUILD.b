* @ValidationCode : MjoxMzMxMjI2NDY6Q3AxMjUyOjE2ODQyMjI3NzEyNTU6SVRTUzotMTotMTozMDg2OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 16 May 2023 13:09:31
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 3086
...
************
    ...
    FOR I.VAR = APOS TO NEXT.DATE.NO
        ...
        IF SP.DATE GE TODAY THEN
            GOSUB 100         ;* Do not calculate closing bal for the frequency scheduled for printing -- R22 Manual conversion - GOTO to GOSUB
        END ;*R22 AUOD CODE CONVERSION

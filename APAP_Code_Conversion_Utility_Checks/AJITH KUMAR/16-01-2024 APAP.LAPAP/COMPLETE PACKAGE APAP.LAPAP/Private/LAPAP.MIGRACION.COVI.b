* @ValidationCode : MjotMzA1MTI4ODQyOkNwMTI1MjoxNzA1MDMzNzYwODM4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 12 Jan 2024 09:59:20
...
* 13-07-2023    Conversion Tool        R22 Auto Conversion     BP is removed in insert file,FM to @FM,VM to @VM,SM to @SM,Y.COUNT.CUOTAS.SINPAGAR +1 to +=1 ,Y.DIA.DE.PAGO - to -=1,J to J.VAR
...
*Y.FECHA.CREACION.PRESTMO = R.ARRANGEMENT<AA.ARR.START.DATE>
    ...
    Y.FECHA.CREACION.PRESTMO = R.ARRANGEMENT<AA.Framework.ArrangementSim.ArrStartDate >
RETURN
    ...
    WHILE Y.BILL.ID DO
        ...
        LOCATE 'CONSTANTE' IN Y.PAYMENT.TYPE.BII<1,1> SETTING BIII.POSN THEN
            ...
            IF Y.OS.TOTAL.AMOUNT GT 0 THEN
                ...
                Y.COUNT.CUOTAS.SINPAGAR += 1; ;* R22 Auto Conversion

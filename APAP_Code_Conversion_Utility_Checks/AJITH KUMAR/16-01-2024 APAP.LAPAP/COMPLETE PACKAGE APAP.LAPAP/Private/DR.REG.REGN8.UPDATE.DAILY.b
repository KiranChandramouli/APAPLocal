* @ValidationCode : MjotODYyMzg1MDY3OkNwMTI1MjoxNzAyOTg4MzQyNzIzOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*   $INSERT I_TSA.COMMON ;*R22 AUTO CONVERSTION $INSERT T24.BP TO $INSERT
    $INSERT I_F.STMT.ENTRY  ;*R22 AUTO CONVERSTION $INSERT T24.BP TO $INSERT ;*R22 Manual Code Conversion_Utility Check
...
*   CALL EB.CLEAR.FILE(FN.DR.REG.REGN8.CONCAT,F.DR.REG.REGN8.CONCAT)
    EB.Service.ClearFile(FN.DR.REG.REGN8.CONCAT,F.DR.REG.REGN8.CONCAT) ;*R22 Manual Code Conversion_Utility Check

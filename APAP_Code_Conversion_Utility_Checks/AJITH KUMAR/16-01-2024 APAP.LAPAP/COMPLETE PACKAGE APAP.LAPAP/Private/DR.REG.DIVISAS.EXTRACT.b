...
* 09-Jul-2018  Anthony Martínez    CN008837 - Exclude internal transactions made by APAP
*----------------------------------------------------------------------------
*---------------------------------------------------------------------------------------
*MODIFICATION HISTORY:
...
*----------------------------------------------------------------------------------------
    ...
    $INSERT I_F.REDO.APAP.INSTIT.FINANC.PARAM ;*R22 MANUAL CONSEVERSION
*
    GOSUB PROCESS
RETURN
...
*    CALL F.READ(FN.REDO.APAP.INSTIT.FINANC.PARAM,YRNC.VAL,R.REDO.APAP.INSTIT.FINANC.PARAM,F.REDO.APAP.INSTIT.FINANC.PARAM,ERR.REDO.APAP.INSTIT.FINANC.PARAM)
    CALL CACHE.READ(FN.REDO.APAP.INSTIT.FINANC.PARAM,YRNC.VAL,R.REDO.APAP.INSTIT.FINANC.PARAM,ERR.REDO.APAP.INSTIT.FINANC.PARAM);* R22 UTILITY AUTO CONVERSION

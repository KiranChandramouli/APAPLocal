...
EB.LocalReferences.GetLocRef("TELLER", "L.ID.PERS.BENEF",L.ID.PERS.BENEF.POS);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF("TELLER", "L.COUNTRY",L.COUNTRY.POS)
EB.LocalReferences.GetLocRef("TELLER", "L.COUNTRY",L.COUNTRY.POS);* R22 UTILITY AUTO CONVERSION

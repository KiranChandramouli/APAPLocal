...
*    CALL F.READ(FN.PA,PARTICIPANTE,R.PA, F.PA, PA.ERR)
    CALL F.READU(FN.PA,PARTICIPANTE,R.PA, F.PA, PA.ERR,'');* R22 UTILITY AUTO CONVERSION
    IF R.PA NE '' THEN
...
EB.TransactionControl.JournalUpdate(PARTICIPANTE);* R22 UTILITY AUTO CONVERSION

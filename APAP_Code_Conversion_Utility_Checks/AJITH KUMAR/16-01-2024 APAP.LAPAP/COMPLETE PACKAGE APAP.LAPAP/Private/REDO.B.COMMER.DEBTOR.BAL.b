* @ValidationCode : MjotMTU5ODg3MDI5NDpDcDEyNTI6MTcwNTA0ODU4OTA0MDphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 Jan 2024 14:06:29
...
AA.Framework.GetArrangement(AA.ARR.ID,R.ARR.APPL,ARR.ERR);* R22 UTILITY AUTO CONVERSION
  ...
  *  Y.MAIN.PRDT.LNE = R.ARR.APPL<AA.ARR.PRODUCT.LINE>
   ...
   * Y.MAIN.STRT.DTE = R.ARR.APPL<AA.ARR.START.DATE>
      ...
      Y.MAIN.PRDT.LNE = R.ARR.APPL<AA.Framework.ArrangementSim.ArrProductLine>
    Y.MAIN.PROD.GROUP = R.ARR.APPL<AA.Framework.ArrangementSim.ArrProductGroup>
    Y.MAIN.ARR.STATUS = R.ARR.APPL<AA.Framework.ArrangementSim.ArrArrStatus>
    Y.MAIN.ARR.PRCT = R.ARR.APPL<AA.Framework.Arrangement.ArrProduct>
    Y.MAIN.STRT.DTE = R.ARR.APPL<AA.Framework.ArrangementSim.ArrStartDate>
...
*------------
   ...
   * Y.LINKED.APPL.ID = R.ARR.APPL<AA.ARR.LINKED.APPL.ID>
     ...
     Y.CUSTOMER.ID = R.ARR.APPL<AA.Framework.ArrangementSim.ArrCustomer>
    Y.CURRENCY    = R.ARR.APPL<AA.Framework.Arrangement.ArrCurrency >
    Y.LINKED.APPL = R.ARR.APPL<AA.Framework.Arrangement.ArrLinkedAppl >
    Y.LINKED.APPL.ID = R.ARR.APPL<AA.Framework.Arrangement.ArrLinkedApplId>
...
*CALL REDO.S.REG.CUSTOMER.EXTRACT(Y.AA.CUS.ID,Y.PRODUCT.GROUP,Y.REL.CODE,OUT.ARR)
    APAP.LAPAP.redoSRegCustomerExtract(Y.AA.CUS.ID,Y.PRODUCT.GROUP,Y.REL.CODE,OUT.ARR);* R22 Manual conversion
...
AA.Framework.GetPeriodBalances(Y.ACCOUNT, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE);* R22 UTILITY AUTO CONVERSION
...
*CALL RAD.CONDUIT.LINEAR.TRANSLATION(MAP.FMT,Y.MAP.ID,Y.RCL.APPL,Y.RCL.AA.ID,R.CUSTOMER,R.RETURN.MSG,ERR.MSG)
    APAP.LAPAP.redoConduitLinearTranslation(MAP.FMT,Y.MAP.ID,Y.RCL.APPL,Y.RCL.AA.ID,R.CUSTOMER,R.RETURN.MSG,ERR.MSG) ;*R22 MANUAL CONVERSION
...
AA.Framework.ReadActivityHistory(REC.ID, REQD.MODE, EFF.DATE, R.AA.ACTIVITY.HISTORY);* R22 UTILITY AUTO CONVERSION

...
EB.LocalReferences.GetLocRef("CUSTOMER", "L.CU.PASS.NAT",CUS.POS.2);* R22 UTILITY AUTO CONVERSION
    T.CUS.PASS.NAT = R.CUS<EB.CUS.LOCAL.REF,CUS.POS.2>
*    CALL GET.LOC.REF("CUSTOMER", "L.CU.ACTANAC",CUS.POS.3)
EB.LocalReferences.GetLocRef("CUSTOMER", "L.CU.ACTANAC",CUS.POS.3);* R22 UTILITY AUTO CONVERSION
    T.CUS.ACT.NAC = R.CUS<EB.CUS.LOCAL.REF,CUS.POS.3>
*    CALL GET.LOC.REF("CUSTOMER", "L.CU.NOUNICO",CUS.POS.4)
EB.LocalReferences.GetLocRef("CUSTOMER", "L.CU.NOUNICO",CUS.POS.4);* R22 UTILITY AUTO CONVERSION
    T.CUS.NOUNICO = R.CUS<EB.CUS.LOCAL.REF,CUS.POS.4>
*    CALL GET.LOC.REF("CUSTOMER", "L.CU.TIPO.CL",CUS.POS.5)
EB.LocalReferences.GetLocRef("CUSTOMER", "L.CU.TIPO.CL",CUS.POS.5);* R22 UTILITY AUTO CONVERSION

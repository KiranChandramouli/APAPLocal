* @ValidationCode : MjotMTY4NTkyMzc4OTpDcDEyNTI6MTcwNTAzNDAxNDU2Njphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 Jan 2024 10:03:34
...
* 13-07-2023    Conversion Tool        R22 Auto Conversion     BP is removed in insert file,FM to @FM,SM to @SM,VM to @VM,Y.PRINCIPALINTWOF + to +=,Y.TOTAL.AMT + to +=,I to I.VAR
 ...
 *   Y.ARR.STATUS =  R.ARRANGEMENT<AA.ARR.ARR.STATUS>
    Y.ID.CLIENTE = R.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer >
    ...
    Y.LINKED.APPL.ID = R.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId,1,1>
    Y.ARR.STATUS =  R.ARRANGEMENT< AA.Framework.ArrangementSim.ArrArrStatus>
    Y.NROPRESTAMO = Y.LINKED.APPL.ID
    Y.FECHA.ORIGINAL.APE = R.ARRANGEMENT< AA.Framework.ArrangementSim.ArrOrigContractDate>
...
*--PRMORA
    ...
    Y.PRINCIPALINTWOF += Y.PRINCIPALINWOF
...
EB.TransactionControl.JournalUpdate(AA.ARR.ID);* R22 UTILITY AUTO CONVERSION
RETURN

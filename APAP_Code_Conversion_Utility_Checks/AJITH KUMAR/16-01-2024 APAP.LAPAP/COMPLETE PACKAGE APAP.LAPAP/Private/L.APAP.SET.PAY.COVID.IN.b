* @ValidationCode : MjoyOTI5ODA0Njc6Q3AxMjUyOjE2OTAxNjc1MzU1OTY6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
* 13-07-2023     Harishvikram C   Manual R22 conversion       BP Removed, CALL routine format modified, FM TO @FM, VM to @VM, SM to @SM
*-----------------------------------------------------------------------------
    $INSERT  I_COMMON
    $INSERT  I_EQUATE
...
*        CALL L.APAP.MONTO.SOLO.COVID.PR(Y.AAA.ID,Y.MONTO.CUOTA.PR)
        APAP.LAPAP.lApapMontoSoloCovidPr(Y.AAA.ID,Y.MONTO.CUOTA.PR)              ;*Manual R22 conversion
...
EB.TransactionControl.JournalUpdate(Y.AAA.ID);* R22 UTILITY AUTO CONVERSION
**---------------------------------------
...
*    CALL F.READ(FN.L.APAP.PRELACION.COVI19.DET,Y.CONTRACT.ID,R.L.APAP.PRELACION.COVI19.DET,FV.L.APAP.PRELACION.COVI19.DET,ERROR.L.APAP.PRELACION.COVI19.DET)
    CALL F.READU(FN.L.APAP.PRELACION.COVI19.DET,Y.CONTRACT.ID,R.L.APAP.PRELACION.COVI19.DET,FV.L.APAP.PRELACION.COVI19.DET,ERROR.L.APAP.PRELACION.COVI19.DET,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : Mjo4MDM3MjkyNTY6Q3AxMjUyOjE2OTE3NTEzMzUyNjY6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Aug 2023 16:25:35
...
EB.TransactionControl.JournalUpdate(Y.TRANS.ID);* R22 UTILITY AUTO CONVERSION
...
IDVAR.1 = 'BULK.PAYROLL' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PARAMETERS,IDVAR.1,R.PARAMETER,F.PARAMETERS,ERR.PARAMETERS);* R22 UTILITY AUTO CONVERSION
    Y.TRANS.ACCOUNT = ''
    IF(R.PARAMETER) THEN

* @ValidationCode : MjoxNjM1MDk0NDMyOkNwMTI1MjoxNjg0MjIyODE1ODYwOklUU1M6LTE6LTE6NTgyOjE6ZmFsc2U6Ti9BOkRFVl8yMDIxMDguMDotMTotMQ==
...
EB.LocalReferences.GetLocRef("ACCOUNT", "L.AC.STATUS1",ACC.STATUS.POS);* R22 UTILITY AUTO CONVERSION
...
EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.CIDENT",POS.CIDENT);* R22 UTILITY AUTO CONVERSION
        CEDULA = R.CUS<EB.CUS.LOCAL.REF,POS.CIDENT>

*        CALL GET.LOC.REF("CUSTOMER","L.CU.RNC",POS.RNC)
EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.RNC",POS.RNC);* R22 UTILITY AUTO CONVERSION
        RNC.NO = R.CUS<EB.CUS.LOCAL.REF,POS.RNC>

*        CALL GET.LOC.REF("CUSTOMER","L.CU.PASS.NAT",POS.NAT)
EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.PASS.NAT",POS.NAT);* R22 UTILITY AUTO CONVERSION
        PASS.NO = R.CUS<EB.CUS.LOCAL.REF,POS.NAT>

*        CALL GET.LOC.REF("CUSTOMER","L.CU.NOUNICO",POS.NOUNICO)
EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.NOUNICO",POS.NOUNICO);* R22 UTILITY AUTO CONVERSION
        NO.UNIC = R.CUS<EB.CUS.LOCAL.REF,POS.NOUNICO>

*        CALL GET.LOC.REF("CUSTOMER","L.CU.ACTANAC",POS.ACTANAC)
EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.ACTANAC",POS.ACTANAC);* R22 UTILITY AUTO CONVERSION

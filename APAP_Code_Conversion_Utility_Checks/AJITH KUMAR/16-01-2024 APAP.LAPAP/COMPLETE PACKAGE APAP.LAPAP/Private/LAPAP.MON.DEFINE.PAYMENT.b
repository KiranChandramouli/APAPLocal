...
EB.LocalReferences.GetLocRef("AZ.ACCOUNT","L.AZ.METHOD.PAY",POS);* R22 UTILITY AUTO CONVERSION
*        CALL GET.LOC.REF("AZ.ACCOUNT","L.AZ.AMOUNT",POSS)
EB.LocalReferences.GetLocRef("AZ.ACCOUNT","L.AZ.AMOUNT",POSS);* R22 UTILITY AUTO CONVERSION

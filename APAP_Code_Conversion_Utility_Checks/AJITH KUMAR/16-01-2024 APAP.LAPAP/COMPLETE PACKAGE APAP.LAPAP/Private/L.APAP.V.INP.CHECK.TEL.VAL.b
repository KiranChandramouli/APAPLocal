...
EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.TEL.AREA",CUS.POS);* R22 UTILITY AUTO CONVERSION
    CUSAREA = R.NEW(EB.CUS.LOCAL.REF)<1,CUS.POS>

*    CALL GET.LOC.REF("CUSTOMER","L.CU.TEL.NO",CUS.POS1)
EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.TEL.NO",CUS.POS1);* R22 UTILITY AUTO CONVERSION
...
*    CALL REBUILD.SCREEN
EB.Display.RebuildScreen();* R22 UTILITY AUTO CONVERSION
END

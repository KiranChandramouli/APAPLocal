* @ValidationCode : MjotMTMyODg3MTM0NjpDcDEyNTI6MTcwNTA0MjIzNDQxNzphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 12 Jan 2024 12:20:34
...
EB.LocalReferences.GetLocRef(LREF.APP.ACCT,LREF.FIELD.ACCT,LREF.POS);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF(LREF.APP.ACCT,LREF.FIELD.ACCT2,LREF.POS2)
EB.LocalReferences.GetLocRef(LREF.APP.ACCT,LREF.FIELD.ACCT2,LREF.POS2);* R22 UTILITY AUTO CONVERSION
...
IDVAR.1 = "SYSTEM" ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.ACH.PARAM,IDVAR.1,R.REDO.ACH.PARAM,Y.ERR.ACH.PAR);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxMTI3MTQ4NDg2OkNwMTI1MjoxNzAyOTg4MzQxMzgxOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*   ACCOUNT.ID = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID,1>
    ...
    YAA.PROD = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct,1>
    YAA.PROD.GRP = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup>
    YAA.ARR.STAT = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrArrStatus>
    STAR.DATE.VAL = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrStartDate>
    ACCOUNT.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId,1>
...
*   CUS.ID = R.AA.ARRANGEMENT<AA.ARR.CUSTOMER>
    CUS.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer> ;*R22 Manual Code Conversion_Utility Check
...
*   CALL AA.GET.PERIOD.BALANCES(ACCOUNT.ID, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE) ;*R22 Manual Code Conversion_Utility Check
    AA.Framework.GetPeriodBalances(ACCOUNT.ID, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE)
...
*   CALL AA.GET.PERIOD.BALANCES(ACCOUNT.ID, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE)
    AA.Framework.GetPeriodBalances(ACCOUNT.ID, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE) ;*R22 Manual Code Conversion_Utility Check
    DAT.BALANCES = BAL.DETAILS<4>
...
*   CALL AA.GET.PERIOD.BALANCES(Y.ACCT.ID, YCRF.TYPE,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE) ;*R22 Manual Code Conversion_Utility Check
    AA.Framework.GetPeriodBalances(Y.ACCT.ID, YCRF.TYPE,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE)
...
************
    ...
    returnConditions = ''
    returnError = ''
*   CALL AA.GET.ARRANGEMENT.CONDITIONS(ArrangementID, idPropertyClass, idProperty, effectiveDate, returnIds, returnConditions, returnError) ;*R22 Manual Code Conversion_Utility Check
...
*   CALL AA.GET.ARRANGEMENT.CONDITIONS(ARRANGEMENT.ID,PROP.CLASS,PROP.NAME,'','',returnConditions,RET.ERR) ;*R22 Manual Code Conversion_Utility Check
    AA.Framework.GetArrangementConditions(ARRANGEMENT.ID,PROP.CLASS,PROP.NAME,'','',returnConditions,RET.ERR)

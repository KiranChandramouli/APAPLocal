* @ValidationCode : MjoxMzgwNjU2Mjg2OkNwMTI1MjoxNjkwMTY3NTI5Njk5OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*    CALL F.READ(FN.CHK.DIR1,Y.FILE.NAME,R.DIR.INPUT,F.CHK.DIR1, ERROR.DIR.INPUT)
    CALL F.READU(FN.CHK.DIR1,Y.FILE.NAME,R.DIR.INPUT,F.CHK.DIR1, ERROR.DIR.INPUT,'');* R22 UTILITY AUTO CONVERSION
    IF (R.DIR.INPUT) THEN

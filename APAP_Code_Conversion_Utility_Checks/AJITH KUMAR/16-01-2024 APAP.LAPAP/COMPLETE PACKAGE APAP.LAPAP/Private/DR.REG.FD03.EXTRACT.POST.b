* @ValidationCode : Mjo0NTY4NDA1MDg6Q3AxMjUyOjE3MDI5ODgzNDE3NDc6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
...
*   CALL F.WRITE(FN.DR.REG.FD03.PARAM,'SYSTEM',R.DR.REG.FD03.PARAM)
    CALL F.WRITE(FN.DR.REG.FD03.PARAM,Y.SYS.ID,R.DR.REG.FD03.PARAM) ;*R22 Manual Code Conversion_Utility Check
RETURN
*-------------------------------------------------------------------
END

* @ValidationCode : MjotMTE2NTU4NzI4NjpDcDEyNTI6MTY5MDE2NzUyNjE5ODpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
...
*    CALL F.READ(FN.BATCH,SERVICE.ID,R.BATCH,F.BATCH,ERR.BATCH)
    CALL F.READU(FN.BATCH,SERVICE.ID,R.BATCH,F.BATCH,ERR.BATCH,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotMTcyOTA0MDQ5MTpDcDEyNTI6MTY4NDIyMjgxNjcxMzpJVFNTOi0xOi0xOjQ5NToxOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 May 2023 13:10:16
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 495
...
EB.LocalReferences.GetLocRef(LREF.APP,LREF.STATUS1,STATUS1.POS);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF(LREF.APP,LREF.STATUS2,STATUS2.POS)
EB.LocalReferences.GetLocRef(LREF.APP,LREF.STATUS2,STATUS2.POS);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF(LREF.APP,LREF.NOTIFY,NOTIFY.POS)
EB.LocalReferences.GetLocRef(LREF.APP,LREF.NOTIFY,NOTIFY.POS);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : Mjo4MDk1MzY0MTA6VVRGLTg6MTY5MDE2NzU1MTE5MjpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
IDVAR.1 = "1" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PARAM,IDVAR.1,R.PARAM1, FV.PARAM, PA1.ERR);* R22 UTILITY AUTO CONVERSION
*    CALL F.READ(FN.PARAM,"2",R.PARAM2, FV.PARAM, PA2.ERR)
IDVAR.1 = "2" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PARAM,IDVAR.1,R.PARAM2, FV.PARAM, PA2.ERR);* R22 UTILITY AUTO CONVERSION
*    CALL F.READ(FN.PARAM,"3",R.PARAM3, FV.PARAM, PA3.ERR)
IDVAR.1 = "3" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PARAM,IDVAR.1,R.PARAM3, FV.PARAM, PA3.ERR);* R22 UTILITY AUTO CONVERSION
*    CALL F.READ(FN.PARAM,"4",R.PARAM4, FV.PARAM, PA4.ERR)
IDVAR.1 = "4" ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.PARAM,IDVAR.1,R.PARAM4, FV.PARAM, PA4.ERR);* R22 UTILITY AUTO CONVERSION

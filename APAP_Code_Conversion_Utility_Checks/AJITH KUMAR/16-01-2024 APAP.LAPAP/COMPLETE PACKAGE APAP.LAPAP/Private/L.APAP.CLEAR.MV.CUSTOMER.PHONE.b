...
EB.LocalReferences.GetLocRef('CUSTOMER', 'L.CU.TEL.TYPE', Y.L.CU.TEL.TYPE.POS);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF('CUSTOMER', 'L.CU.TEL.AREA', Y.L.CU.TEL.AREA.POS)
EB.LocalReferences.GetLocRef('CUSTOMER', 'L.CU.TEL.AREA', Y.L.CU.TEL.AREA.POS);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF('CUSTOMER', 'L.CU.TEL.NO', Y.L.CU.TEL.NO.POS)
EB.LocalReferences.GetLocRef('CUSTOMER', 'L.CU.TEL.NO', Y.L.CU.TEL.NO.POS);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF('CUSTOMER', 'L.CU.TEL.EXT', Y.L.CU.TEL.EXT.POS)
EB.LocalReferences.GetLocRef('CUSTOMER', 'L.CU.TEL.EXT', Y.L.CU.TEL.EXT.POS);* R22 UTILITY AUTO CONVERSION
*    CALL GET.LOC.REF('CUSTOMER', 'L.CU.TEL.P.CONT', Y.L.CU.TEL.P.CONT.POS)
EB.LocalReferences.GetLocRef('CUSTOMER', 'L.CU.TEL.P.CONT', Y.L.CU.TEL.P.CONT.POS);* R22 UTILITY AUTO CONVERSION

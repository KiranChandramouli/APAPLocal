...
IDVAR.1 = 'DO0010001' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.DAT, IDVAR.1, R.DAT, DAT.ERR) ;*AUTO R22 CODE CONVERSION F.READ TO CACHE.READ;* R22 UTILITY AUTO CONVERSION
    Y.DATE = R.DAT<EB.DAT.TODAY>

*    IF Y.DATE EQ TELLER.FECHA THEN ;*AUTO R22 CODE CONVERSION = TO EQ
    IF Y.DATE EQ TELLER.FECHA THEN ;*AUTO R22 CODE CONVERSION EQ TO EQ;* R22 UTILITY AUTO CONVERSION
...
EB.LocalReferences.GetLocRef("TELLER.ID","L.TT.TILL.LIM",Y.LIM);* R22 UTILITY AUTO CONVERSION
...
EB.LocalReferences.GetLocRef("TELLER.ID","L.TT.CURRENCY",Y.LIM.CURRENCY);* R22 UTILITY AUTO CONVERSION
...
EB.LocalReferences.GetLocRef("TELLER.ID","L.CI.CATEG.CARD",Y.LIM.CATEG);* R22 UTILITY AUTO CONVERSION

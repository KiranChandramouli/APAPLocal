...
EB.TransactionControl.JournalUpdate(Y.EXCL.ID);* R22 UTILITY AUTO CONVERSION
...
EB.TransactionControl.JournalUpdate(Y.CUENTA.REL.ID);* R22 UTILITY AUTO CONVERSION
RETURN
...
EB.TransactionControl.JournalUpdate(Y.PARTICIPA.ID);* R22 UTILITY AUTO CONVERSION
...
EB.TransactionControl.JournalUpdate(Y.BALANCE.ID);* R22 UTILITY AUTO CONVERSION
RETURN

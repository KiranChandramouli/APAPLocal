...
*13-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION    T24.BP,LAPAP.BP is Removed
...
SUBROUTINE L.APAP.COMPRA.PAS.ACT(CUS.ID)
    ...
    $INSERT I_F.CUSTOMER
    $INSERT I_L.APAP.COMPRA.PAS.ACT.COMMON;*R22 MANUAL Code conversion
...
EB.LocalReferences.GetLocRef("CUSTOMER", "L.CU.RNC",L.CU.RNC.POS);* R22 UTILITY AUTO CONVERSION
...
IDVAR.1 = 'DO0010001' ;* R22 UTILITY AUTO CONVERSION
        CALL F.READ(FN.DATES,IDVAR.1,R.FECHAS,FV.DATES,ERR.FECHAS);* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.INSTIT.FINANC.PARAM, Y.L.CU.RNC, R.FINANC.PARAM, FV.INSTIT.FINANC.PARAM, INSTIT.ERROR)
        CALL CACHE.READ(FN.INSTIT.FINANC.PARAM, Y.L.CU.RNC, R.FINANC.PARAM, INSTIT.ERROR);* R22 UTILITY AUTO CONVERSION
...
*            CALL F.READ(FN.INSTIT.FINANC.PARAM,Y.IDCUSTOMER, R.FINANC.PARAM, FV.INSTIT.FINANC.PARAM, INSTIT.ERROR)
            CALL CACHE.READ(FN.INSTIT.FINANC.PARAM,Y.IDCUSTOMER, R.FINANC.PARAM, INSTIT.ERROR);* R22 UTILITY AUTO CONVERSION
            IF (R.FINANC.PARAM) THEN
                Y.CODIGO.INSITUCION  = R.FINANC.PARAM<3>
                Y.NUMERO.INSTITUCION = R.FINANC.PARAM<4>
                Y.CONTRAPARTE = R.FINANC.PARAM<2>
...
***********************
        ...
        Y.FINAL = Y.FINAL : CAMPO.VAL12 : "|" : CHARX(13)

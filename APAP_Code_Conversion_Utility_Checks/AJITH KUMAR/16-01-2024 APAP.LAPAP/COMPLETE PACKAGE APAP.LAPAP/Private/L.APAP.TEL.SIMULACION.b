...
EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.TEL.TYPE",Y.POS);* R22 UTILITY AUTO CONVERSION
    Y.TEL.TYPE = R.CUSTOMER<EB.CUS.LOCAL.REF,Y.POS>
*    CALL GET.LOC.REF("CUSTOMER","L.CU.TEL.AREA",Y.POS)
EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.TEL.AREA",Y.POS);* R22 UTILITY AUTO CONVERSION
    Y.AREA = R.CUSTOMER<EB.CUS.LOCAL.REF,Y.POS>
*    CALL GET.LOC.REF("CUSTOMER","L.CU.TEL.NO",Y.POS)
EB.LocalReferences.GetLocRef("CUSTOMER","L.CU.TEL.NO",Y.POS);* R22 UTILITY AUTO CONVERSION

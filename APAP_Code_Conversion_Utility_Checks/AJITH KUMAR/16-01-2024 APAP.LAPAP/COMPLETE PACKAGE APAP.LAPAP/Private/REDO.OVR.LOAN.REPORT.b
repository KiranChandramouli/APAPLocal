* @ValidationCode : MjotMjEzNzM2NTgwNDpDcDEyNTI6MTcwNTM4MzU0NDAwODphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 16 Jan 2024 11:09:04
...
*21/04/2023         SURESH           MANUAL R22 CODE CONVERSION     Call method format changed
*-----------------------------------------------------------------------------------
...
*    Y.CUS = R.AA<AA.ARR.CUSTOMER>
    ...
    Y.PRD.GRP = R.AA<AA.Framework.ArrangementSim.ArrProductGroup>
    Y.PRD = R.AA<AA.Framework.ArrangementSim.ArrProduct>
    Y.CURR = R.AA<AA.Framework.Arrangement.ArrCurrency>
    Y.COMP = R.AA<AA.Framework.ArrangementSim.ArrCoCode>
    Y.AC.ID = R.AA<AA.Framework.ArrangementSim.ArrLinkedApplId>
    Y.CUS = R.AA<AA.Framework.ArrangementSim.ArrCustomer>
    ...
    WHILE CK EQ '' DO
        LOCATE 'TRANSACTION' IN Y.INT.TYPES<1,1> SETTING POS.LP THEN
            IF Y.ACT.STS<1,POS.LP> EQ 'AUTH' AND Y.ACTY<1,POS.LP> MATCHES 'LENDING-APPLYPAYMENT...' THEN
                ...
                Y.LAST.REP.DATE = R.AAA<AA.Framework.SimulationCapture.ArrActEffectiveDate>
                Y.LAST.REP.AMT = R.AAA<AA.Framework.RrControl.ArrActOrigTxnAmt>
                CK = 1
            END ELSE
                DEL Y.ACTY<1,POS.LP>
...
GET.DISB.AMT:
    ...
    Y.IDS.DETAILS<2> = "YES"
    APAP.TAM.redoGetDisbursementDetails(Y.IDS.DETAILS,R.DISB.DETAILS,Y.COMMITED.AMT,Y.PEND.DISB);*MANUAL R22 CODE CONVERSION

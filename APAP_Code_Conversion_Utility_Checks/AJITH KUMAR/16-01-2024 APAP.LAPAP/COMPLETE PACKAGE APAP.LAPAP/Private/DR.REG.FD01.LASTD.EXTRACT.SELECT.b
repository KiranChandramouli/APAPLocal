* @ValidationCode : MjoyMTI2ODU2MDQxOkNwMTI1MjoxNzAyOTg4MzQxNTkzOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*   CALL EB.CLEAR.FILE(FN.DR.REG.FD01.WORKFILE, F.DR.REG.FD01.WORKFILE)
    EB.Service.ClearFile(FN.DR.REG.FD01.WORKFILE, F.DR.REG.FD01.WORKFILE) ;*R22 Manual Code Conversion_Utility Check

* @ValidationCode : MjotMzc2OTI0MDAyOkNwMTI1MjoxNzAyOTg4MzQzNDMwOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
* 18-05-2023   Ghayathri T          R22 Manual Conversion - Call routine modified, Include $USING APAP.AA,Changed AA.AH.ACTIVITY.ID to AA.AH.ACTIVITY.REF
* 07-06-2023   Ghayathri T          R22 Manual Conversion - L.MIGRATED.LN.POS variable Added in I_DR.REG.RIEN9.EXTRACT.COMMON insert file
* 24-05-2023   Conversion Tool      R22 Auto Conversion - changed $INCLUDE to $INSERT
* 24-05-2023   Conversion Tool      R22 Auto Conversion - Removed T24.BP,LAPAP.BP,REGREP.BP,TAM.BP in INSERT FILE
* 24-05-2023   Conversion Too       R22 Auto Conversion - changed VM to @VM, FM to @FM,SM to @SM and ++ to +=1
...
*   YPRCT.GROUP = R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP,1>
    ...
    CCY.VAL = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCurrency,1>
    CUS.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCustomer,1>
    STAR.DATE.VAL = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrStartDate,1>
    AA.STATUS = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrArrStatus,1>
    YPRCT.GROUP = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup,1>
...
*   Y.LINKED.ID = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID,1>
    Y.LINKED.APPL = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedAppl,1>
    Y.LINKED.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId,1>
*R22 Manual Code Conversion_Utility Check-End
    ...
    APAP.AA.redoBConLnsByDebtorAaRecs(REC.ID,OUT.RECORD);*R22 Manual Conversion
...
*****************
    ...
    APAP.LAPAP.redoLGetDisbursementDetails(REC.ID,R.DISB.DETAILS,Y.COMMITED.AMT,Y.PEND.DISB);*R22 Manual Conversion
...
***************
    ...
    Y.L.MIGRATED.LN = R.AA.PAYMENT.SCHEDULE<AA.PS.LOCAL.REF,L.MIGRATED.LN.POS>;*R22 Manual conversion L.MIGRATED.LN.POS variable Added in I_DR.REG.RIEN9.EXTRACT.COMMON insert file
...
*    CALL DR.REG.GET.CUST.TYPE(YR.CUSTOMER,OUT.ARR)
    APAP.LAPAP.drRegGetCustType(YR.CUSTOMER,OUT.ARR);* R22 Manual Conversion
...
*    CALL DR.REG.RIEN9.EXTRACT.SUB(YREC.VAL.ID,YRTN.VALUE)
    APAP.LAPAP.drRegRien9ExtractSub(YREC.VAL.ID,YRTN.VALUE) ;* Manual Conversion
    CRT REC.ID
    CRT YRTN.VALUE
...
*   FLD47 = FMT(R.AA.ARRANGEMENT<AA.ARR.PRODUCT,CNT.PRD>,'L#30')      ;* Field 47
    CNT.PRD = DCOUNT(R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct>,@VM)
    FLD47 = FMT(R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrProduct,CNT.PRD>,'L#30')
*R22 Manual Code Conversion_Utility Check-End
...
*   CALL AA.GET.ARRANGEMENT.CONDITIONS(REC.ID,'CHARGE','PRMORA',effectiveDate,'',RET.COND,RET.ERR)
    AA.Framework.GetArrangementConditions(REC.ID,'CHARGE','PRMORA',effectiveDate,'',RET.COND,RET.ERR) ;*R22 Manual Code Conversion_Utility Check
...
*   CALL AA.READ.ACTIVITY.HISTORY(REC.ID, REQD.MODE, EFF.DATE, R.AA.ACTIVITY.HISTORY)
    AA.Framework.ReadActivityHistory(REC.ID, REQD.MODE, EFF.DATE, R.AA.ACTIVITY.HISTORY) ;*R22 Manual Code Conversion_Utility Check
...
*       YACT.DTE.ID = R.AA.ACTIVITY.HISTORY<AA.AH.ACT.DATE,CHG.POSN,1>
        YACT.DTE.ID = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistory.AhActDate,CHG.POSN,1> ;*R22 Manual Code Conversion_Utility Check
        TERM.AMT.ID = REC.ID:'-':PROPERTY.VAL:'-':YACT.DTE.ID:'.1'
        GOSUB READ.TERM.AMT

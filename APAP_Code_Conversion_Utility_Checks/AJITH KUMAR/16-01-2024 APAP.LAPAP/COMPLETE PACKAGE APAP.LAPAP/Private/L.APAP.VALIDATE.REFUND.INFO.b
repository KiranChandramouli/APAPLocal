* @ValidationCode : Mjo2ODE1NDg2OTA6Q3AxMjUyOjE3MDI5ODgzNjUxODE6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 Dec 2023 17:49:25
...
*--------------------------------------------------------------------------------------------------
    ...
    $INSERT I_F.ST.LAPAP.AA.LOAN.PARAM
...
*        CALL REDO.B.CON.LNS.BY.DEBTOR.AA.RECS(AA.ARR.ID,Y.OUT.RECORD)
        APAP.AA.redoBConLnsByDebtorAaRecs(AA.ARR.ID,Y.OUT.RECORD)        ;*Manual R22 conversion
        R.AA.CUSTOMER = FIELD(Y.OUT.RECORD, "*", 9)

*       CALL GET.LOC.REF("AA.ARR.CUSTOMER", "L.AA.CAMP.TY", L.AA.CAMP.TY.POS)
        EB.LocalReferences.GetLocRef("AA.ARR.CUSTOMER", "L.AA.CAMP.TY", L.AA.CAMP.TY.POS) ;*R22 Manual Code Conversion_Utility Check

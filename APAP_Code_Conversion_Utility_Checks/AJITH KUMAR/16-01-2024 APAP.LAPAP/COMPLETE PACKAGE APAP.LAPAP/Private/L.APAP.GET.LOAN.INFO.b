* @ValidationCode : MjotMzQwNzM2Mzg1OkNwMTI1MjoxNjg0MjIyNzkxNTk5OklUU1M6LTE6LTE6MTYxNzoxOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 May 2023 13:09:51
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 1617
...
*CALL REDO.GET.TOTAL.OUTSTANDING.SIN.UNC.UND(Y.ARR.ID,Y.PROP.AMT,Y.TOTAL.AMT)
    APAP.TAM.redoGetTotalOutstandingSinUncUnd(Y.ARR.ID,Y.PROP.AMT,Y.TOTAL.AMT) ;*R22 MANAUAL CODE CONVERSION

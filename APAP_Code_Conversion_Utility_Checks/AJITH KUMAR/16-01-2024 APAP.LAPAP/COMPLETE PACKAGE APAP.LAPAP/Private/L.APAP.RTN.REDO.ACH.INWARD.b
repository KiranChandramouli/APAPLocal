...
EB.LocalReferences.GetLocRef("FUNDS.TRANSFER","L.FT.CLIENT.NME",Y.POS);* R22 UTILITY AUTO CONVERSION
        Y.NOMBRE.CL = R.FT<FT.LOCAL.REF,Y.POS>

        Y.POS = ""
*        CALL GET.LOC.REF("FUNDS.TRANSFER","L.FT.CR.CARD.NO",Y.POS)
EB.LocalReferences.GetLocRef("FUNDS.TRANSFER","L.FT.CR.CARD.NO",Y.POS);* R22 UTILITY AUTO CONVERSION

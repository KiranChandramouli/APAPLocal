...
EB.TransactionControl.JournalUpdate(Y.OLD.ALT);* R22 UTILITY AUTO CONVERSION
...
*            CALL F.READ(FN.ACCOUNT.HST, Y.ALTHISID, R.AC1, F.ACCOUNT.HST, AC.ERROR)
            CALL F.READU(FN.ACCOUNT.HST, Y.ALTHISID, R.AC1, F.ACCOUNT.HST, AC.ERROR,'');* R22 UTILITY AUTO CONVERSION
            IF R.AC1 THEN
                Y.ALT.TYPE = R.AC1<AC.ALT.ACCT.TYPE>
                CHANGE @VM TO @FM IN Y.ALT.TYPE
                CHANGE @SM TO @FM IN Y.ALT.TYPE

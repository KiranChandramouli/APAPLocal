...
*    CALL F.READ(FN.CUSTOMER,Y.CUST.ID,R.CUSTOMER,F.CUSTOMER,CUS.ERROR)
    CALL F.READU(FN.CUSTOMER,Y.CUST.ID,R.CUSTOMER,F.CUSTOMER,CUS.ERROR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.CUSTOMER.ACCOUNT,Y.CUST.ID,R.CUSTOMER.ACCOUNT,F.CUSTOMER.ACCOUNT,ERR.CUSTOMER.ACCOUNT)
    CALL F.READU(FN.CUSTOMER.ACCOUNT,Y.CUST.ID,R.CUSTOMER.ACCOUNT,F.CUSTOMER.ACCOUNT,ERR.CUSTOMER.ACCOUNT,'');* R22 UTILITY AUTO CONVERSION
    LOOP
...
EB.TransactionControl.JournalUpdate(Y.CUST.ID);* R22 UTILITY AUTO CONVERSION

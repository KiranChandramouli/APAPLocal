* @ValidationCode : MjoyMDkzMTAwOTM4OkNwMTI1MjoxNzAyOTg4MzQyNzcwOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
* Date                  who                   Reference
* 21-04-2023         CONVERSTION TOOL      R22 AUTO CONVERSTION -$INSERT T24.BP TO $INSERT AND $INCLUDE REGREP.BP TO $INSERT AND FM TO @FM
...
**********
    ...
    CALL CACHE.READ(FN.DR.REG.RIEN6.PARAM,Y.SYS.ID,R.DR.REG.RIEN6.PARAM,DR.REG.RIEN6.PARAM.ERR)

* @ValidationCode : MjotMTU2MDcyNzEwNDpDcDEyNTI6MTcwMjk2NDQyNzM2Njphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 19 Dec 2023 11:10:27
...
* LOCATE Y.PAY.TYPE IN R.RECORD<AA.PS.PAYMENT.TYPE,1> SETTING POS1 THEN
    LOCATE Y.PAY.TYPE IN R.RECORD<AA.PaymentSchedule.PaymentSchedule.PsPaymentType,1> SETTING POS1 THEN
* Y.ACT.AMT = R.RECORD<AA.PS.ACTUAL.AMT,POS1>
        Y.ACT.AMT = R.RECORD<AA.PaymentSchedule.PaymentSchedule.PsActualAmt,POS1>
    END
    IF Y.ACT.AMT ELSE
        RETURN
    END

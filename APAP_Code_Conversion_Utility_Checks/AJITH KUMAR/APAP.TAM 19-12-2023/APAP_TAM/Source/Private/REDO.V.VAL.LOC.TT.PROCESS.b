* @ValidationCode : MjoxNDcwNzU5NTQ6Q3AxMjUyOjE3MDI5NjU5NjQ5MTc6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 Dec 2023 11:36:04
...
* CALL F.READ(FN.AA.ACCOUNT.DETAILS,VAR.AA.ID,R.AA.ACCOUNT.DETAILS ,F.AA.ACCOUNT.DETAILS ,ERR)
    R.AA.ACCOUNT.DETAILS=AA.PaymentSchedule.AccountDetails.Read(VAR.AA.ID,ERR)
...
* Y.BL.TYPE = R.AA.BILL.DETAILS<AA.BD.BILL.TYPE>
        Y.BL.TYPE = R.AA.BILL.DETAILS<AA.PaymentSchedule.BillDetails.BdBillType>
        LOCATE 'PAYMENT' IN Y.BL.TYPE<1,1> SETTING POS.CH THEN
* IF R.AA.BILL.DETAILS<AA.BD.SETTLE.STATUS,1> EQ 'UNPAID' THEN
            IF R.AA.BILL.DETAILS<AA.PaymentSchedule.BillDetails.BdSettleStatus,1> EQ 'UNPAID' THEN
...
* AA.PaymentScheule.ScheduleProjector(ARRANGEMENT.ID, SIMULATION.REF, NO.RESET, DATE.RANGE, TOT.PAYMENT, DUE.DATES, DUE.DEFER.DATES, DUE.TYPES, DUE.METHODS,DUE.TYPE.AMTS,DUE.PROPS, DUE.PROP.AMTS, DUE.OUTS)

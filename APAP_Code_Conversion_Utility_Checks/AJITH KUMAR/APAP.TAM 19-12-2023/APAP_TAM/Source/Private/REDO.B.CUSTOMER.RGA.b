* @ValidationCode : Mjo3NTg3MzUyNjE6Q3AxMjUyOjE2ODQ0OTEwMjkwNzc6SVRTUzotMTotMToxNjE6MTpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
...
*CALL REDO.S.REG.CUSTOMER.EXTRACT(Y.CUSTOMER.ID,Y.PRODUCT.GROUP,Y.REL.CODE,OUT.ARR)  ;*R22 MANUAL CODE CONVERSION
        APAP.LAPAP.redoSRegCustomerExtract(Y.CUSTOMER.ID,Y.PRODUCT.GROUP,Y.REL.CODE,OUT.ARR)  ;*R22 MANUAL CODE CONVERSION

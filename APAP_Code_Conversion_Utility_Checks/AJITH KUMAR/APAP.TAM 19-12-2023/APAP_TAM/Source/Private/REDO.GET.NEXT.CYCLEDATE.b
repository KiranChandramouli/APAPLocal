* @ValidationCode : MjotNzA5ODIxMTM2OkNwMTI1MjoxNzAyOTY1MTQzODczOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Dec 2023 11:22:23
...
*    CALL REDO.UPGRD.GET.CONDITIONS(ARR.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PAYMENT.SCHEDULE,ERR.MSG)
    APAP.AA.redoUpgrdGetConditions(ARR.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.PAYMENT.SCHEDULE,ERR.MSG) ;*R22 Manual Conversion
*TUS END
* PACS00585816 - Start
...
*Y.PAYMENT.TYPE = R.PAYMENT.SCHEDULE<AA.PS.PAYMENT.TYPE,1>
    Y.PAYMENT.TYPE = R.PAYMENT.SCHEDULE<AA.PaymentSchedule.PaymentSchedule.PsPaymentType,1>
* PACS00585816 - End
*    CALL REDO.GET.PROPERTY.NAME(ARR.ID,PROPERTY.CLASS,R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)
    APAP.TAM.redoGetPropertyName(ARR.ID,PROPERTY.CLASS,R.OUT.AA.RECORD,OUT.PROPERTY,OUT.ERR)
...
*CALL F.READ(FN.AA.ACCOUNT.DETAILS,ARR.ID,R.ACC.DET,F.AA.ACCOUNT.DETAILS,ACC.DET.ERR)
    R.ACC.DET=AA.PaymentSchedule.AccountDetails.Read(ARR.ID, ACC.DET.ERR)
    START.DATE = ""
...
* START.DATE = R.ACC.DET<AA.AD.START.DATE>
    START.DATE = R.ACC.DET<AA.PaymentSchedule.AccountDetails.AdPaymentStartDate>
*TUS END
    NO.CYCLES = ''
    TERM.RECALC.DETAILS = ''
    PAYMENT.TYPES = ""
...
*AA.PaymentScheule.BuildPaymentScheduleDates(SCHEDULE.INFO, START.DATE, END.DATE, NO.CYCLES, TERM.RECALC.DETAILS, PAYMENT.DATES, PAYMENT.ACTUAL.DATES, PAYMENT.FIN.DATES, PAYMENT.TYPES, PAYMENT.METHODS, PAYMENT.AMOUNTS, PAYMENT.PROPERTIES, PAYMENT.PERCENTAGES, PAYMENT.MIN.AMOUNT, PAYMENT.DEFER.DATES, PAYMENT.BILL.TYPE, RET.ERROR)
    AA.PaymentSchedule.BuildPaymentScheduleDates(SCHEDULE.INFO, START.DATE, END.DATE, NO.CYCLES, TERM.RECALC.DETAILS, PAYMENT.DATES, PAYMENT.ACTUAL.DATES, PAYMENT.FIN.DATES, PAYMENT.TYPES, PAYMENT.METHODS, PAYMENT.AMOUNTS, PAYMENT.PROPERTIES, PAYMENT.PERCENTAGES, PAYMENT.MIN.AMOUNT, PAYMENT.DEFER.DATES, PAYMENT.BILL.TYPE, RET.ERROR)

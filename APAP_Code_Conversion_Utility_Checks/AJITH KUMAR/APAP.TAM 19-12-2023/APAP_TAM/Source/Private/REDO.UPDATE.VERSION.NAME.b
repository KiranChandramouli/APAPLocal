* @ValidationCode : MjoxNjY5NTI0MDA5OkNwMTI1MjoxNzAyODgyNjIxNTE4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 18 Dec 2023 12:27:01
...
*CALL F.READ(FN.TELLER.PARAMETER,Y.TEL.PARAM.ID,R.TELLER.PARAMETER,F.TELLER.PARAMETER,TEL.ERR)
    CALL CACHE.READ(FN.TELLER.PARAMETER, Y.TEL.PARAM.ID, R.TELLER.PARAMETER, Y.TT.ERROR)

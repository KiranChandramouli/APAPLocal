* @ValidationCode : MjotMTUxMDU0MDQ6Q3AxMjUyOjE3MDMyMjc4NjM2NjU6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Dec 2023 12:21:03
...
*---------------------------------------------------------------------------------
    Y.ERROR.MSG = ''
    ID.VAR = 'SYSTEM'
    CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,ID.VAR,R.REDO.H.AA.DIS.CHG,CHG.PARAM.ERR);*R22 MANUAL CODE CONVERSION

* @ValidationCode : MjoxNzc1OTIxMzg3OkNwMTI1MjoxNzAzMjI4ODk0MDU4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 22 Dec 2023 12:38:14
...
* CALL GET.LOC.REF(LOC.REF.APPLICATION,LOC.REF.FIELDS,LOC.REF.POS)
    EB.LocalReferences.GetLocRef(LOC.REF.APPLICATION,LOC.REF.FIELDS,LOC.REF.POS)
...
* CALL F.READ(FN.CHEQUE.REGISTER,Y.CHQ.REG.ID,R.CHEQUE.REGISTER,F.CHEQUE.REGISTER,CHQ.ERR)
    CALL F.READU(FN.CHEQUE.REGISTER,Y.CHQ.REG.ID,R.CHEQUE.REGISTER,F.CHEQUE.REGISTER,CHQ.ERR,'');*R22 MANUAL CODE CONVERSION
...
*CALL F.READ(FN.REDO.CONCAT.CHEQUE.REGISTER,Y.ID.NEW,R.REDO.CONCAT.CHEQUE.REGISTER,F.REDO.CONCAT.CHEQUE.REGISTER,CONCAT.ERR)
    CALL F.READ(FN.REDO.CONCAT.CHEQUE.REGISTER,Y.ID.NEW,R.REDO.CONCAT.CHEQUE.REGISTER,F.REDO.CONCAT.CHEQUE.REGISTER,CONCAT.ERR,'');*R22 MANUAL CODE CONVERSION
...
* CALL F.READ(FN.REDO.H.CHEQUE.REGISTER,Y.REDO.H.CHEQ.REGISTER,R.REDO.H.CHEQUE.REGISTER,F.REDO.H.CHEQUE.REGISTER,CHEQ.REG.ERR)
        CALL F.READU(FN.REDO.H.CHEQUE.REGISTER,Y.REDO.H.CHEQ.REGISTER,R.REDO.H.CHEQUE.REGISTER,F.REDO.H.CHEQUE.REGISTER,CHEQ.REG.ERR,'')
...
*CALL F.READ(FN.CHEQUE.ISSUE,CHEQ.ISS.ID,R.CHQ.ISS,F.CHEQUE.ISSUE,CHEQ.ERR)
    CALL F.READU(FN.CHEQUE.ISSUE,CHEQ.ISS.ID,R.CHQ.ISS,F.CHEQUE.ISSUE,CHEQ.ERR,'');*R22 MANUAL CODE CONVERSION
...
*CALL F.READ(FN.REDO.H.CHEQUE.REGISTER,Y.REDO.H.CHEQ.REGISTER,R.REDO.H.CHEQUE.REGISTER,F.REDO.H.CHEQUE.REGISTER,ERR.REDO.CHQ.REG)
    CALL F.READU(FN.REDO.H.CHEQUE.REGISTER,Y.REDO.H.CHEQ.REGISTER,R.REDO.H.CHEQUE.REGISTER,F.REDO.H.CHEQUE.REGISTER,ERR.REDO.CHQ.REG,'')
    Y.CHQ.START.NO=R.NEW(REDO.H.SOL.CHQ.NO.START)
...
*CALL F.READ(FN.ACCOUNT,ACC.ID,R.ACCT,F.ACCOUNT,ACC.ERR)
    CALL F.READU(FN.ACCOUNT,ACC.ID,R.ACCT,F.ACCOUNT,ACC.ERR,'')
...
* CALL EB.ACCOUNTING("AC","SAO",R.ACC.ARR,'')
        AC.API.EbAccounting("AC","SAO",R.ACC.ARR,'');*R22 MANUAL CODE CONVERSION
    END

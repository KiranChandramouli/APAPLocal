* @ValidationCode : Mjo4MTU1NjE0NDk6Q3AxMjUyOjE3MDMyMjkwNTg3Njk6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Dec 2023 12:40:58
...
* CALL F.READ(FN.REDO.NCF.ISSUED,REC.ID,R.REDO.NCF.ISSUED,F.REDO.NCF.ISSUED,ERR.ISSUE)
    CALL F.READU(FN.REDO.NCF.ISSUED,REC.ID,R.REDO.NCF.ISSUED,F.REDO.NCF.ISSUED,ERR.ISSUE,'');*R22 MANUAL CODE CONVERSION
*CALL F.READ(FN.REDO.L.NCF.CANCELLED,REC.ID,R.REDO.L.NCF.CANCELLED,F.REDO.L.NCF.CANCELLED,ERR.CANCEL)
    CALL F.READU(FN.REDO.L.NCF.CANCELLED,REC.ID,R.REDO.L.NCF.CANCELLED,F.REDO.L.NCF.CANCELLED,ERR.CANCEL,'');*R22 MANUAL CODE CONVERSION
...
*CALL F.READ(FN.REDO.NCF.STATUS,REC.ID,R.REDO.NCF.STATUS,F.REDO.NCF.STATUS,ERR.STATUS)
    CALL F.READU(FN.REDO.NCF.STATUS,REC.ID,R.REDO.NCF.STATUS,F.REDO.NCF.STATUS,ERR.STATUS,'');*R22 MANUAL CODE CONVERSION
...
*  CALL F.READ(FN.REDO.NCF.ISSUED,REC.ID,R.REDO.NCF.ISSUED,F.REDO.NCF.ISSUED,ERR.ISSUE)
        CALL F.READU(FN.REDO.NCF.ISSUED,REC.ID,R.REDO.NCF.ISSUED,F.REDO.NCF.ISSUED,ERR.ISSUE,'')
*CALL F.READ(FN.REDO.L.NCF.CANCELLED,REC.ID,R.REDO.L.NCF.CANCELLED,F.REDO.L.NCF.CANCELLED,ERR.CANCEL)
        CALL F.READU(FN.REDO.L.NCF.CANCELLED,REC.ID,R.REDO.L.NCF.CANCELLED,F.REDO.L.NCF.CANCELLED,ERR.CANCEL,'');*R22 MANUAL CODE CONVERSION
        R.REDO.L.NCF.CANCELLED<NCF.CAN.TXN.ID>=R.REDO.NCF.ISSUED<ST.IS.TXN.ID>
        R.REDO.L.NCF.CANCELLED<NCF.CAN.TXN.TYPE>=R.REDO.NCF.ISSUED<ST.IS.TXN.TYPE>
...
*
    ...
    ID.VAR = 'NOSTRO'
    CALL CACHE.READ(FN.ACCOUNT.CLASS,ID.VAR, R.ACCOUNT.CLASS, ACCOUNT.CLASS.ERR)  ;*R22 AUTO CODE CONVERSION

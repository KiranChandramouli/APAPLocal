* @ValidationCode : MjotMTAwNDc5NzM5ODpDcDEyNTI6MTcwMzIyMDA3NTAxMzphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Dec 2023 10:11:15
...
* CALL F.READ(FN.REDO.CUST.PRD.LIST,Y.CUS.ID,R.REDO.CUST.PRD.LIST,F.REDO.CUST.PRD.LIST,CUST.PRD.ERR)
    CALL F.READU(FN.REDO.CUST.PRD.LIST,Y.CUS.ID,R.REDO.CUST.PRD.LIST,F.REDO.CUST.PRD.LIST,CUST.PRD.ERR,'')
...
*CALL F.READ(FN.AA.ARRANGEMENT,Y.ARR.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,AA.ARR.ERR)
    CALL F.READU(FN.AA.ARRANGEMENT,Y.ARR.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,AA.ARR.ERR,'') ;*R22 MANUAL CODE CONVERSION

* @ValidationCode : Mjo5NTYxNjI2MjI6Q3AxMjUyOjE3MDMyMzg3NjY1NzM6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Dec 2023 15:22:46
...
* CALL F.READ(FN.REDO.H.BANK.DRAFTS,Y.REDO.H.BDRAFT.CHQ.ID,R.REDO.H.BANK.DRAFTS,F.REDO.H.BANK.DRAFTS,REDO.H.BANK.DRAFTS.ERR)
    CALL F.READU(FN.REDO.H.BANK.DRAFTS,Y.REDO.H.BDRAFT.CHQ.ID,R.REDO.H.BANK.DRAFTS,F.REDO.H.BANK.DRAFTS,REDO.H.BANK.DRAFTS.ERR,'');*R22 MANUALCODE CONVERSION
...
* CALL F.READ(FN.REDO.H.ADMIN.CHEQUES,Y.REDO.H.ADMIN.CHQ.ID,R.REDO.H.ADMIN.CHEQUES,F.REDO.H.ADMIN.CHEQUES,REDO.H.ADMIN.CHEQUES.ERR)
    CALL F.READ(FN.REDO.H.ADMIN.CHEQUES,Y.REDO.H.ADMIN.CHQ.ID,R.REDO.H.ADMIN.CHEQUES,F.REDO.H.ADMIN.CHEQUES,REDO.H.ADMIN.CHEQUES.ERR,'');*R22 MANAUAL CODE CONVERSION

* @ValidationCode : MjoxMDM4NDY0MzE2OkNwMTI1MjoxNzAyNTU4NDk2NDMyOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 14 Dec 2023 18:24:56
...
*------------------------------------------------------------------------------------
    ...
    FN.FT.CHARGE.TYPE='F.FT.CHARGE.TYPE' ;*R22 MANUAL CODE CONVERSION
...
*------------------------------------------------------------------------------------
    ...
    Y.SYS.ID='SYSTEM'
    ENQ.ERROR.COM=''
* CALL REDO.INIT.CARD.VAL
*  CALL REDO.INIT.ACCT.VAL
    APAP.ATM.redoInitCardVal() ;*Manual R22 conversion
    APAP.ATM.redoInitAcctVal();*Manual R22 conversion
...
* CALL EB.ACCOUNTING('ICGC','SAO',MULTI.STMT,ACCOUNTING.TYPE)
    AC.API.EbAccounting('ICGC','SAO',MULTI.STMT,ACCOUNTING.TYPE)
RETURN
*----------------------------------------------------------------------
END

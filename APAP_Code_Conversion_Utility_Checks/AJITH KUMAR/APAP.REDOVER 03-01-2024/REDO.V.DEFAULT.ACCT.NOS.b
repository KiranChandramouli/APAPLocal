* @ValidationCode : MjoyMTIyNzM0NDg6Q3AxMjUyOjE2ODI0MTIzNDU5NTk6SGFyaXNodmlrcmFtQzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
CALL CACHE.READ(FN.REDO.H.PAY.MODE.PARAM,IDVAR.1,R.REDO.H.PAY.MODE.PARAM,F.REDO.H.PAY.MODE.PARAM);* R22 AUTO CONVERSION
...
IDVAR.1 = 'SYSTEM' ;* R22 AUTO CONVERSION
CALL CACHE.READ(FN.REDO.H.INVENTORY.PARAMETER,IDVAR.1,R.INVENTORY.PARAM,INV.PAR.ERR);* R22 AUTO CONVERSION
...
IDVAR.1 = 'SYSTEM' ;* R22 AUTO CONVERSION
CALL CACHE.READ(FN.REDO.ADMIN.CHQ.PARAM,IDVAR.1,R.ADMIN.CHQ.PARAM,ADM.CHQ.ERR);* R22 AUTO CONVERSION

* @ValidationCode : MjoyMTQ3NDQ5MzM0OkNwMTI1MjoxNjg0NDkxMDI2ODYyOklUU1M6LTE6LTE6MzUyOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
*response is in encrypted form, so decrypt it
    ...
    IF NOT(E) THEN
        ...
        *CALL DISPLAY.MESSAGE(TEXT, '')  ;*R22 AUTO CONVERSTION REM TO DISPLAY.MESSAGE(TEXT, '')
        EB.OverrideProcessing.DisplayMessage(TEST, '')
    END
RETURN

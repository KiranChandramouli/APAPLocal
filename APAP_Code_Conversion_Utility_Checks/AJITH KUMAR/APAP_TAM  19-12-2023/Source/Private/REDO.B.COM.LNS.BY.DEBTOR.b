* @ValidationCode : MjoxOTU3NTUyNjg3OkNwMTI1MjoxNzAyOTc5NzAzNTg1OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Dec 2023 15:25:03
...
* 31-MAY-2023     Conversion tool   AUTO R22 CODE CONVERSION      T24.BP REMOVED INSERT FILE, VM TO @VM, FM TO @FM, ++ to +=, -- to -+, I to I.VAR, J to J.VAR
* 31-MAY-2023      Harishvikram C   Manual R22 conversion       AA.AH.ACTIVITY.ID to AA.AH.ACTIVITY.REF, POS.L.AA.COL,L.CU.COM.CLASIF.POS  added in insert file  I_REDO.B.COM.LNS.BY.DEBTOR.COMMON
*--------------------------------------------------------------------------------------------------
...
* $INSERT I_F.AA.ARRANGEMENT.ACTIVITY
    ...
    $INSERT I_F.COUNTRY
    $INSERT I_F.INDUSTRY
    $INSERT I_F.REDO.APAP.PROPERTY.PARAM ;*AUTO R22 CODE CONVERSION - END
    $INSERT I_F.ACCOUNT
    $INSERT I_F.AZ.ACCOUNT
    $INSERT I_F.REDO.AA.MIG.PAY.START.DTE ;*AUTO R22 CODE CONVERSION
    $INSERT I_F.REDO.CAMPAIGN.TYPES       ;*AUTO R22 CODE CONVERSION
...
* CALL AA.GET.ARRANGEMENT(AA.ARR.ID,R.ARR.APPL,ARR.ERR)
    AA.Framework.GetArrangement(AA.ARR.ID,R.ARR.APPL,ARR.ERR)
* Y.MAIN.PROD.GROUP = R.ARR.APPL<AA.ARR.PRODUCT.GROUP>
    Y.MAIN.PROD.GROUP = R.ARR.APPL<AA.Framework.Arrangement.ArrProductGroup>
...
*  YORG.CONT.DTE = R.ARR.APPL<AA.ARR.ORIG.CONTRACT.DATE>
    YORG.CONT.DTE = R.ARR.APPL<AA.Framework.ArrangementSim.ArrOrigContractDate>
*YSTART.DTE = R.ARR.APPL<AA.ARR.START.DATE>
    YSTART.DTE = R.ARR.APPL<AA.Framework.ArrangementSim.ArrStartDate>
*  YCO.CODE = R.ARR.APPL<AA.ARR.CO.CODE>
    YCO.CODE = R.ARR.APPL< AA.Framework.ArrangementSim.ArrCoCode >
...
*Y.CURRENCY    = R.ARR.APPL<AA.ARR.CURRENCY>
    ...
    AA.ID = AA.ARR.ID
    APAP.AA.redoBConLnsByDebtorAaRecs(AA.ID,OUT.RECORD) ;*MANUAL R22 CODE CONVERSION
...
*--------------
    ...
    APAP.REDOSRTN.redoSRepCustomerExtract(Y.CUSTOMER.ID,Y.PRODUCT.GROUP,Y.REL.CODE,OUT.ARR);*MANUAL R22 CODE CONVERSION
...
*--CHANGE FOR REQUERIMENT CN008754
    ...
    IF L.CU.PASS.NAT NE '' THEN
        APAP.LAPAP.lapapGetFmtPassport(L.CU.PASS.NAT, NO.FMT.PASSPORT);* R22 Manual conversion
...
*  Y.LINKED.APPL    = R.ARR.APPL<AA.ARR.LINKED.APPL>
    Y.LINKED.APPL    = R.ARR.APPL<AA.Framework.ArrangementSim.ArrLinkedAppl L>
* Y.LINKED.APPL.ID = R.ARR.APPL<AA.ARR.LINKED.APPL.ID>
    Y.LINKED.APPL.ID = R.ARR.APPL<AA.Framework.ArrangementSim.ArrLinkedApplId>
    ...
    APAP.TAM.redoRptAcctAltLoans(YACCT.GROUP,Y.PREV.ACCOUNT) ;*MANUAL R22 CODE CONVERSION
...
*  Y.MAIN.ARR.PRCT = RY.ARR.APPL<AA.ARR.PRODUCT>
            Y.MAIN.ARR.PRCT = RY.ARR.APPL<AA.Framework.Arrangement.ArrProduct>
            PFM = '';PVM = ''; PSM = ''
            FINDSTR 'COM' IN Y.MAIN.ARR.PRCT SETTING PFM,PVM,PSM THEN
...
*  Y.CO.CODE = R.ARR.APPL<AA.ARR.CO.CODE>
    Y.CO.CODE = R.ARR.APPL<AA.Framework.ArrangementSim.ArrCoCode>
...
*YACT.ID.ARR = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY.REF> ;*R22 Manual Conversion
        YACT.ID.ARR = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistory.AhActivityRef>
    END
...
*----------------------
    ...
    APAP.AA.redoCrrGetConditions(AA.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG) ;*MANUAL R22 CODE CONVERSION
...
*******************
    ...
    DUE.TYPE.AMTS = ''; DUE.PROPS = ''; DUE.PROP.AMTS = ''; TOT.PAY = ''; FLG.VAL1 = 0; FLG.VAL2 = 0; Y.VAR = 0; YRANGE.AMT = 0
...
*CALL F.READ(FN.AA.ACTIVITY.HISTORY,AA.ARR.ID,R.AA.ACTIVITY.HISTORY,F.AA.ACTIVITY.HISTORY,ERR.AA.ACTIVITY.HISTORY)
    R.AA.ACTIVITY.HISTORY=AA.Framework.ActivityHistory.Read(AA.ARR.ID, ERR.AA.ACTIVITY.HISTORY)
    IF R.AA.ACTIVITY.HISTORY THEN
...
*CALL AA.GET.PERIOD.BALANCES(Y.LOAN.CODE, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE)
    AA.Framework.GetPeriodBalances(Y.LOAN.CODE, BAL.TYPE1,REQUEST.TYPE, START.DATE, END.DATE, '',BAL.DETAILS, ERROR.MESSAGE)

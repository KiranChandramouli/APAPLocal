* @ValidationCode : MjotODE5NjkwMTc3OkNwMTI1MjoxNjkwMTc2MDQ3NzYwOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 24 Jul 2023 10:50:47
...
*03-05-2011        Sudharsanan S        PACS00055008                              Update REDO.PRINT.REPRINT.IDS with id as FT/TT/T24FS and value as  ContractId*HoldId
*13/07/2023	   CONVERSION TOOL      AUTO R22 CODE CONVERSION			              SM to @SM
...
*PACS00055008 - S
    ...
    R.REDO.PRINT.REPRINT.IDS = '' ; PRINT.ERR = '' GET.ID.FT = 'FT'
    CALL F.READ(FN.REDO.PRINT.REPRINT.IDS,GET.ID.FT,R.REDO.PRINT.REPRINT.IDS,F.REDO.PRINT.REPRINT.IDS,PRINT.ERR)
    GOSUB UPDATE.CONCAT.TAB
    CALL F.WRITE(FN.REDO.PRINT.REPRINT.IDS,GET.ID.FT,R.REDO.PRINT.REPRINT.IDS)
*PACS00055008 - E
    ID.NEW = Y.ID
...
*PACS00055008 - S
    VAR.HOLD.ID = C$LAST.HOLD.ID
    R.REDO.PRINT.REPRINT.IDS = '' ; PRINT.ERR = '' ; GET.ID.TT = 'TT'
    CALL F.READ(FN.REDO.PRINT.REPRINT.IDS,GET.ID.TT,R.REDO.PRINT.REPRINT.IDS,F.REDO.PRINT.REPRINT.IDS,PRINT.ERR)
    GOSUB UPDATE.CONCAT.TAB
    CALL F.WRITE(FN.REDO.PRINT.REPRINT.IDS,GET.ID.TT,R.REDO.PRINT.REPRINT.IDS)
*PACS00055008 - E
    ID.NEW = Y.ID
...
* CALL APAP.TAM.REDO.CALL.DEP.TFS.RE.ARR
        APAP.TAM.redoCallDepTfsReArr() ;*MANUAL R22 CODE CONVERSION
    END

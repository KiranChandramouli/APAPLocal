* @ValidationCode : MjotNzI0ODY4OTYwOkNwMTI1MjoxNjg0NDkxMDI2NjY2OklUU1M6LTE6LTE6Nzc3MzoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 May 2023 15:40:26
* @ValidationInfo : Encoding          : Cp1252
* @ValidationInfo : User Name         : ITSS
* @ValidationInfo : Nb tests success  : N/A
* @ValidationInfo : Nb tests failure  : N/A
* @ValidationInfo : Rating            : 7773
...
*
    ...
    FOR COMPT.NO = 1 TO NO.OF.COMPONENTS          ;* loop through each component for catalogging component wise
        ...
        IF CATALOG AND CATALOG.LIST THEN
            ...
            EXECUTE 'tCompile ':PROG.FILE: PASSLIST CATALOG.LIST CAPTURING CATALOG.OUTPUT
...
*** <desc>Invoke jBASE compiler and do stds checking</desc>
    ...
    IF COMPILE THEN
        ...
        IF PROG.FILE EQ 'T24.BP' THEN ;* If directory is T24.BP
            COMPILE.COMMAND = "tCompile ":COMPILE.OPTIONS:" ":PROG.FILE:" ":PROG.NAME      ;* compile with inserts from '-I../T24.BP'
        END ELSE ;* other than T24.BP (i.e local directory)
            ...
            READ R.VOC FROM F.VOC,PROG.FILE THEN ;* read VOC of local directory
                ...
                COMPILE.COMMAND = "tCompile ":COMPILE.OPTIONS.LOCAL:" ":COMPILE.OPTIONS:" ":PROG.FILE:" ":PROG.NAME ;* Use inserts from local directory if present otherwise from T24.BP

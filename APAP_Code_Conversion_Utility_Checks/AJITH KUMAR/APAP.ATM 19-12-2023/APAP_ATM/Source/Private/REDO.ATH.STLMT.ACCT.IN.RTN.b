* @ValidationCode : Mjo2NzYxNjc1Mzg6Q3AxMjUyOjE3MDI1NTYzNDcxNjY6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 14 Dec 2023 17:49:07
...
PROCESS:
*----------------------------------------------------------------------
    FN.ACCOUNT = 'F.ACCOUNT' ;*R22 MANUAL CODE CONVERSION
    F.ACCOUNT =''
    CALL OPF (FN.ACCOUNT,A.ACCOUNT)
    R.FUNDS.TRANSFER=''

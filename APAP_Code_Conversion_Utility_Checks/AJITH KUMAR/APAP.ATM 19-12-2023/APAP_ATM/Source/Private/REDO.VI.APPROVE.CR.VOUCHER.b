* @ValidationCode : MjotMTE1Mzk2NDkzNzpDcDEyNTI6MTcwMjU0ODMyMDQ5ODphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 14 Dec 2023 15:35:20
...
$PACKAGE APAP.ATM
SUBROUTINE REDO.VI.APPROVE.CR.VOUCHER
******************************************************************************
...
*FN.REDO.APAP.H.PARAMETER='F.REDO.APAP.H.PARAMETER'
    ...
    ID.VAR = 'SYSTEM'
    CALL CACHE.READ(FN.REDO.APAP.H.PARAMETER,ID.VAR,R.REDO.APAP.H.PARAMETER,PARAMETER.ERROR)
    FN.AC.LOCKED.EVENTS='F.AC.LOCKED.EVENTS'
    F.AC.LOCKED.EVENTS=''
    CALL OPF(FN.AC.LOCKED.EVENTS,F.AC.LOCKED.EVENTS)
RETURN
...
*   END
    ...
    IF R.REDO.STLMT.LINE<VISA.SETTLE.CARD.ACCEPTOR.ID>[15,1] NE 'P' THEN

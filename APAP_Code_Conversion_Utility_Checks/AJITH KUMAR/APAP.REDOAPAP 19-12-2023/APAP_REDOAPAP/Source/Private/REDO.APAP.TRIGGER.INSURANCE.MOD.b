* @ValidationCode : MjotMjE3MDUxMTE6Q3AxMjUyOjE3MDI5Nzc1OTMwODY6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 Dec 2023 14:49:53
...
* CALL F.READ(FN.AA.ACCOUNT.DETAILS, ARR.ID, R.AA.ACCOUNT.DETAILS, F.AA.ACCOUNT.DETAILS, READ.ERR)
    R.AA.ACCOUNT.DETAILS = AA.PaymentSchedule.AccountDetails.Read(ARR.ID, READ.ERR)
...
*Y.TOTPROP = DCOUNT(R.PAY.SCH<AA.PS.PROPERTY><1,II> , @SM)
    Y.TOTPROP = DCOUNT(R.PAY.SCH<AA.PaymentSchedule.PaymentSchedule.PsProperty><1,II> , @SM)
...
* AA.PaymentScheule.ScheduleProjector(ARR.ID, SIM.REF, "",CYCLE.DATE, TOT.PAYMENT, DUE.DATES, DUE.DEFER.DATES, DUE.TYPES, DUE.METHODS, DUE.TYPE.AMTS, DUE.PROPS, DUE.PROP.AMTS, DUE.OUTS)
        AA.PaymentSchedule.ScheduleProjector(ARR.ID, SIM.REF, "",CYCLE.DATE, TOT.PAYMENT, DUE.DATES, DUE.DEFER.DATES, DUE.TYPES, DUE.METHODS, DUE.TYPE.AMTS, DUE.PROPS, DUE.PROP.AMTS, DUE.OUTS)
        Y.STR.PRP = ''
...
*Y.FREQ = Y.COND<AA.PS.PAYMENT.FREQ,Y.CND>
            Y.FREQ = Y.COND<AA.PaymentSchedule.PaymentSchedule.PsPaymentFreq,Y.CND>
...
*Y.SRT.DTE = Y.COND<AA.PS.START.DATE,Y.CND.1>
        Y.SRT.DTE = Y.COND<AA.PaymentSchedule.PaymentSchedule.PsStartDate,Y.CND.1>
        AAA.REQUEST<AA.ARR.ACT.FIELD.NAME,2,-1> = 'START.DATE:':Y.CND+1:':':JJ
...
*ARR.DATE = R.AA.ACCOUNT.DETAILS<AA.AD.BASE.DATE>
    ARR.DATE = R.AA.ACCOUNT.DETAILS<AA.PaymentSchedule.AccountDetails.AdBaseDate>

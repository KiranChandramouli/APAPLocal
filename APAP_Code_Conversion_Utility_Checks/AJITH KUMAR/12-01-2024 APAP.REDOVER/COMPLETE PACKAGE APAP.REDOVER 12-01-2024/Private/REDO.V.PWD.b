* @ValidationCode : Mjo1MTU4MTE4NjA6Q3AxMjUyOjE3MDQ0NDAwODYxMTc6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:04:46
...
*    CALL CACHE.READ(FN.SPF,"SYSTEM",R.SPF,SPF.ERR)
    ...
    CALL CACHE.READ(FN.SPF,IDVAR.1,R.SPF,SPF.ERR);* R22 UTILITY AUTO CONVERSION
    IF R.SPF THEN

...
FN.REDO.APAP.AUTH.TABLE = 'F.REDO.APAP.AUTH.TABLE';* R22 AUTO CONVERSION
*CALL CACHE.READ(FN.REDO.APAP.AUTH.TABLE,'SYSTEM',R.AUTH.TABLE,AUTH.ERR);* R22 AUTO CONVERSION
IDVAR.1 = 'SYSTEM' ;* R22 AUTO CONVERSION
CALL CACHE.READ(FN.REDO.APAP.AUTH.TABLE,IDVAR.1,R.AUTH.TABLE,AUTH.ERR);* R22 AUTO CONVERSION;* R22 AUTO CONVERSION

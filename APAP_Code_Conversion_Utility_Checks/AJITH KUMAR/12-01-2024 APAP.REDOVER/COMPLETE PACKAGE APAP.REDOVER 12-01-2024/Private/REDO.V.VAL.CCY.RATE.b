* @ValidationCode : MjotNTczODU2MDk5OkNwMTI1MjoxNzA0NDQ4MjcxMTg0OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 15:21:11
...
*    CALL GET.LOC.REF("FOREX","L.FX.POOL.RATE",L.FX.POOL.RATE.POS)
    EB.LocalReferences.GetLocRef("FOREX","L.FX.POOL.RATE",L.FX.POOL.RATE.POS);* R22 UTILITY AUTO CONVERSION
...
*This part is used for charge and commision calculation
    IF PGM.VERSION EQ ",REDO.BUY.ACTR" OR PGM.VERSION EQ ",REDO.SELL.ACTR" THEN
        APAP.REDOVER.redoVFtCalcComm()    ;*R22 MANUAL CODE CONVERSION

* @ValidationCode : MjoxODMwMDgzMTkwOkNwMTI1MjoxNzA0Mjc5MzUzNDc2OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 Jan 2024 16:25:53
...
*CALL F.READ(FN.AA.ARRANGEMENT,Y.AA.ARR.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,ARR.ERR)
        R.AA.ARRANGEMENT=AA.Framework.Arrangement.Read(Y.AA.ARR.ID, ARR.ERR)
...
*  IF R.AA.ARRANGEMENT<AA.ARR.ARR.STATUS> EQ "CURRENT" THEN
        IF R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrArrStatus> EQ "CURRENT" THEN
            AF = COLL.EXPIRY.DATE
            ETEXT="EB-UNSECURED"
...
*  IF R.AA.ARRANGEMENT<AA.ARR.ARR.STATUS> EQ "EXPIRED" THEN
        IF R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrArrStatus> EQ "EXPIRED" THEN
...
*CALL F.READ(FN.AA.ACTIVITY.HISTORY,Y.AA.ARR.ID,R.AA.ACTIVITY.HISTORY,F.AA.ACTIVITY.HISTORY,HIST.ERR)
    R.AA.ACTIVITY.HISTORY=AA.Framework.ActivityHistory.Read(Y.AA.ARR.ID, HIST.ERR)
*Y.AA.ACTIVITY.ID = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY>
    Y.AA.ACTIVITY.ID = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistoryHist.AhActivity>
...
*Y.EFFECTIVE.DATE = R.AA.ACTIVITY.HISTORY<AA.AH.EFFECTIVE.DATE,ACT.POS2>
        Y.EFFECTIVE.DATE = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistory.AhEffectiveDate,ACT.POS2>
        Y.DATE =  TODAY
        NOF.DAYS = "W"

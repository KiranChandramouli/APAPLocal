* @ValidationCode : MjotMTM2OTQwMDg2NzpDcDEyNTI6MTcwNDcxNTQ4MzM3NDphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 08 Jan 2024 17:34:43
...
*    CALL AA.GET.PERIOD.BALANCES(Y.ACCOUNT.ID, Y.BAL.TYPE, DATE.OPTIONS, EFFECTIVE.DATE, "", "", BAL.DETAILS, "")
    AA.Framework.GetPeriodBalances(Y.ACCOUNT.ID, Y.BAL.TYPE, DATE.OPTIONS, EFFECTIVE.DATE, "", "", BAL.DETAILS, "");* R22 UTILITY AUTO CONVERSION

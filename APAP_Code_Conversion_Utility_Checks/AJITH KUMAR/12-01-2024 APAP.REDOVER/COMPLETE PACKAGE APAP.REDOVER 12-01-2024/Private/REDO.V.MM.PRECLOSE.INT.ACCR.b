* @ValidationCode : MjotNzY0OTEyOTI3OkNwMTI1MjoxNzA0NDM5OTcwMzkxOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:02:50
...
*        CALL EB.ACCOUNTING("MM","SAO",ACC.ENTRY.ARRAY,'')
        AC.API.EbAccounting("MM","SAO",ACC.ENTRY.ARRAY,'');* R22 UTILITY AUTO CONVERSION
    END

...
CALL F.READU(FN.REDO.MTS.DISBURSE,Y.ID,R.REDO.MTS.DISBURSE,F.REDO.MTS.DISBURSE,Y.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.AZ.ACCOUNT,GET.CREDIT.ACCT,R.AZ.ACCOUNT,F.AZ.ACCOUNT,AZ.ERR,'');* R22 AUTO CONVERSION

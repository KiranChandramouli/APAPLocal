* @ValidationCode : MjoxMzIxNDQ3NTEzOkNwMTI1MjoxNzAzNTg1NTU1MjM1OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 15:42:35
...
*  CALL F.READ(FN.REDO.ADMIN.CHQ.PARAM,'SYSTEM',R.REDO.ADMIN.CHQ.PARAM,F.REDO.ADMIN.CHQ.PARAM,REDO.ADMIN.CHQ.PARAM.ERR) ;*Tus Start
    ...
    CALL CACHE.READ(FN.REDO.ADMIN.CHQ.PARAM,ID.VAR,R.REDO.ADMIN.CHQ.PARAM,REDO.ADMIN.CHQ.PARAM.ERR) ; * Tus End
    ...
    LOCATE Y.ACCOUNT.NO IN Y.ADMIN.ACCTS SETTING ADM.CHQ.POS THEN
        ...
        CALL F.READ(FN.REDO.ADMIN.CHQ.DETAILS,Y.CHEQUE.NO,R.REDO.ADMIN.CHQ.DETAILS,F.REDO.ADMIN.CHQ.DETAILS,REDO.ADMIN.CHQ.DETAILS.ERR);*R22 MANUAL CODE CONVERSION
...
* CALL F.READ(FN.CERTIFIED.CHEQUE.DETAILS,Y.CHEQUE.NO,R.CERTIFIED.CHEQUE.DETAILS,F.CERTIFIED.CHEQUE.DETAILS,CERTIFIED.CHEQUE.DETAILS.ERR)
        CALL F.READU(FN.CERTIFIED.CHEQUE.DETAILS,Y.CHEQUE.NO,R.CERTIFIED.CHEQUE.DETAILS,F.CERTIFIED.CHEQUE.DETAILS,CERTIFIED.CHEQUE.DETAILS.ERR,'');*R22 MANUAL CODE CONVERSION
...
* CALL F.READ(FN.REDO.ADMIN.CHQ.DETAILS,Y.CHEQUE.NO,R.REDO.ADMIN.CHQ.DETAILS,F.REDO.ADMIN.CHQ.DETAILS,REDO.ADMIN.CHQ.DETAILS.ERR)
        CALL F.READU(FN.REDO.ADMIN.CHQ.DETAILS,Y.CHEQUE.NO,R.REDO.ADMIN.CHQ.DETAILS,F.REDO.ADMIN.CHQ.DETAILS,REDO.ADMIN.CHQ.DETAILS.ERR,'');*R22 MNAAUAL CODE COVERSION

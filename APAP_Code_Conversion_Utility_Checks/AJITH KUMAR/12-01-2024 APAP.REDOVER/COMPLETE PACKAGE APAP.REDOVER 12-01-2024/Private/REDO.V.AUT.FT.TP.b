* @ValidationCode : MjoxMjkzODc0Mjg3OkNwMTI1MjoxNzAzNzQwNDI5NjE4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Dec 2023 10:43:49
...
*Date                Who               Reference                  Description
*12-04-2023      conversion tool     R22 Auto code conversion    VM TO @VM,FM TO @FM,F.READ TO CACHE.READ,IF Condition Added
...
*-------------
    ...
    CALL CACHE.READ(FN.REDO.TRANS.CODE.PARAM,ID.VAR,R.REDO.TRANS.CODE.PARAM,REDO.TRANS.CODE.PARAM.ERR)
...
*---------------
    ...
    IF Y.RESPONSE.MSG EQ 'FAIL' OR Y.RESPONSE THEN
        ...
        IF Y.RESPONSE THEN
            ID.VAR1="EB-TP.CON.FAIL.CODE" ;*R22 MANUAL CODE CONVERSION
            CALL CACHE.READ(FN.EB.ERROR,ID.VAR1, R.EB.ERROR, ERR) ;*R22 Auto code conversion

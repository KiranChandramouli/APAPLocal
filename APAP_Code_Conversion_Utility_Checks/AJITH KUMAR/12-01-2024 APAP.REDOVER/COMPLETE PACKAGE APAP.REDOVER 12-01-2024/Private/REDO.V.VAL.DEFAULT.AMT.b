* @ValidationCode : MjotNTQ2MTE3MjI4OkNwMTI1MjoxNzAyOTkxMDkxODczOklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Dec 2023 18:34:51
...
*YFIRST.BILLDTE = R.ACCOUNT.DETAILS<AA.AD.BILL.PAY.DATE,1>
    YFIRST.BILLDTE = R.ACCOUNT.DETAILS<AA.PaymentSchedule.AccountDetails.AdBillPayDate,1>
...
*Y.BILL.ID = R.ACCOUNT.DETAILS<AA.AD.BILL.ID,FLG.VAL,1>
        Y.BILL.ID = R.ACCOUNT.DETAILS<AA.PaymentSchedule.AccountDetails.AdBillId,FLG.VAL,1>
...
*  IF R.ACCOUNT.DETAILS<AA.AD.BILL.TYPE,FLG.VAL,FG.LG> EQ 'PAYMENT' THEN
        IF R.ACCOUNT.DETAILS<AA.PaymentSchedule.AccountDetails.AdBillType,FLG.VAL,FG.LG> EQ 'PAYMENT' THEN
*Y.BILL.ID = R.ACCOUNT.DETAILS<AA.AD.BILL.ID,FLG.VAL,FG.LG>
            Y.BILL.ID = R.ACCOUNT.DETAILS<AA.PaymentSchedule.AccountDetails.AdBillType,FLG.VAL,FG.LG>
* CALL F.READ(FN.AA.BILL.DETAILS,Y.BILL.ID,R.AA.BILL.DETAILS,F.AA.BILL.DETAILS,BILL.ERR)
            R.AA.BILL.DETAILS = AA.PaymentSchedule.BillDetails.Read(Y.BILL.ID, BILL.ERR)
* Y.SETTLE.STATUS = R.AA.BILL.DETAILS<AA.BD.SETTLE.STATUS,1>
            Y.SETTLE.STATUS = R.AA.BILL.DETAILS<AA.PaymentSchedule.BillDetails.BdSettleStatus,1>
...
* IF R.ACCOUNT.DETAILS<AA.AD.BILL.TYPE,FLG.VAL,FG.LG> EQ 'ACT.CHARGE' THEN
        IF R.ACCOUNT.DETAILS<AA.PaymentSchedule.AccountDetails.AdBillType,FLG.VAL,FG.LG> EQ 'ACT.CHARGE' THEN
*Y.BILL.ID = R.ACCOUNT.DETAILS<AA.AD.BILL.ID,FLG.VAL,FG.LG>
...
* Y.PAY.DATE = R.AA.BILL.DETAILS<AA.BD.PAYMENT.DATE>
            Y.PAY.DATE = R.AA.BILL.DETAILS<AA.PaymentSchedule.BillDetails.BdPaymentType>

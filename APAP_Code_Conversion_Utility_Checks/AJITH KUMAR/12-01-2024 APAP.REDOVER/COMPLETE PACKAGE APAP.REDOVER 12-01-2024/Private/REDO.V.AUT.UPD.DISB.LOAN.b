* @ValidationCode : MjotMTcwMjIwOTA1NDpDcDEyNTI6MTcwMzgyNTA0NDEyMTphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 29 Dec 2023 10:14:04
...
*29-12-2023      AJITH KUMAR         R22 MANUAL CODWE CONVERSION
*-----------------------------------------------------------------------------
    $INSERT I_EQUATE
    $INSERT I_COMMON
    $INSERT I_F.TELLER
...
*CALL F.READ(FN.REDO.AA.DISB.LOAN,Y.DISB.ID,R.REDO.AA.DISB.LOAN,F.REDO.AA.DISB.LOAN,DISB.LN.ERR)
    CALL F.READU(FN.REDO.AA.DISB.LOAN,Y.DISB.ID,R.REDO.AA.DISB.LOAN,F.REDO.AA.DISB.LOAN,DISB.LN.ERR,'');*R22 MANUAL CODE CONVERSION

* @ValidationCode : MjoxNDA3OTExOTAyOkNwMTI1MjoxNzAzODI1NzUzMDc3OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 29 Dec 2023 10:25:53
...
*CALL F.READ(FN.REDO.MANAGER.CHQ.DETAILS,Y.REDO.MANAGER.CHQ.DETAILS.ID,R.REDO.MANAGER.CHQ.DETAILS,F.REDO.MANAGER.CHQ.DETAILS,ERR.READ)
        CALL F.READU(FN.REDO.MANAGER.CHQ.DETAILS,Y.REDO.MANAGER.CHQ.DETAILS.ID,R.REDO.MANAGER.CHQ.DETAILS,F.REDO.MANAGER.CHQ.DETAILS,ERR.READ,'');*R22 MANUAL CODE CONVERSION
...
* CALL F.READ(FN.REDO.MANAGER.CHQ.DETAILS,Y.REDO.MANAGER.CHQ.DETAILS.ID,R.REDO.MANAGER.CHQ.DETAILS,F.REDO.MANAGER.CHQ.DETAILS,ERR.MGR.CHQ)
        CALL F.READU(FN.REDO.MANAGER.CHQ.DETAILS,Y.REDO.MANAGER.CHQ.DETAILS.ID,R.REDO.MANAGER.CHQ.DETAILS,F.REDO.MANAGER.CHQ.DETAILS,ERR.MGR.CHQ,'');*R22 MANUAL CODE CONVERSION
...
*  CALL F.READ(FN.REDO.H.BANK.DRAFTS,Y.REDO.H.BDRAFT.CHQ.ID,R.REDO.H.BANK.DRAFTS,F.REDO.H.BANK.DRAFTS,REDO.H.BANK.DRAFTS.ERR)
    CALL F.READU(FN.REDO.H.BANK.DRAFTS,Y.REDO.H.BDRAFT.CHQ.ID,R.REDO.H.BANK.DRAFTS,F.REDO.H.BANK.DRAFTS,REDO.H.BANK.DRAFTS.ERR,'');*R22 MANUAL CODE CONVERSION

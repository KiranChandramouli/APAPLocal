* @ValidationCode : Mjo1MzYwOTU3MDU6Q3AxMjUyOjE3MDQ0NDAwMDA4NjA6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:03:20
...
*    CALL CACHE.READ(FN.REDO.H.INVENTORY.PARAMETER,'SYSTEM',R.INV.PARAM,PARM.ERR)
    ...
    CALL CACHE.READ(FN.REDO.H.INVENTORY.PARAMETER,IDVAR.1,R.INV.PARAM,PARM.ERR);* R22 UTILITY AUTO CONVERSION

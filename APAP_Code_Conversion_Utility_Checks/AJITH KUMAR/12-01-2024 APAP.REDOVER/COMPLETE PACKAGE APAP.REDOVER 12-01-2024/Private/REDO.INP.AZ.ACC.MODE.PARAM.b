* @ValidationCode : MjotMTUxODY3NzY3MjpDcDEyNTI6MTcwMzU3MjgwMjExNzphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Dec 2023 12:10:02
...
*----------------------------------------------------------------------
    ...
    IF Y.PAY.MODE THEN
        ...
        CALL CACHE.READ(FN.PAY.MODE.PARAM,ID.VAR,R.PAY.MODE.PARAM,ERR.MPAR)
...
*CALL F.READ(FN.ACCOUNT,ID.NEW,R.ACC,F.ACCOUNT,ACC.ERR)
            CALL F.READU(FN.ACCOUNT,ID.NEW,R.ACC,F.ACCOUNT,ACC.ERR,'');*R22 MANUAL CODE CONVERSION

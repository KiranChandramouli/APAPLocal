* @ValidationCode : Mjo2NDEzMDQ3Njk6Q3AxMjUyOjE3MDQyNzg0MjY4Mjk6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 Jan 2024 16:10:26
...
*CALL BATCH.BUILD.LIST('',SEL.LIST1)
            EB.Service.BatchBuildList('',SEL.LIST1);* R22 AUTO CONVERSION
...
*CALL BATCH.BUILD.LIST('',SEL.LIST2)
            EB.Service.BatchBuildList('',SEL.LIST2);* R22 AUTO CONVERSION
...
*CALL BATCH.BUILD.LIST('',SEL.LIST3)
            EB.Service.BatchBuildList('',SEL.LIST3);* R22 AUTO CONVERSION
...
*CALL BATCH.BUILD.LIST('',SEL.LIST4)
            EB.Service.BatchBuildList('',SEL.LIST4);* R22 AUTO CONVERSION

* @ValidationCode : MjoxMTEzNjg3MDUyOkNwMTI1MjoxNjgyNDEyMzY1NDc3OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDoxOmZhbHNlOk4vQTpERVZfMjAyMTA4LjA6LTE6LTE=
...
SUBROUTINE REDO.V.VAL.TAX.MGROVR
***********************************************************************
* COMPANY NAME: ASOCIACION POPULAR DE AHORROS Y PRESTAMOS
* DEVELOPED BY: SHANKAR RAJU
* PROGRAM NAME: REDO.V.VAL.TAX.MGROVR
...
*Modification History
*DATE                       WHO                         REFERENCE                                   DESCRIPTION
*17-04-2023            Conversion Tool             R22 Auto Code conversion                   VM TO @VM,F.READ TO CACHE.READ,++ TO +=1

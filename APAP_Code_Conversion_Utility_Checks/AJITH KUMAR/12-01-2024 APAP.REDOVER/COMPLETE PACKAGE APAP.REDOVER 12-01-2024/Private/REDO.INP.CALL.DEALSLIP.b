* @ValidationCode : MjoxMzYyNDc2ODAwOkNwMTI1MjoxNzAzNTc3MDA4MzEwOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 13:20:08
...
*CALL F.READ(FN.REDO.AA.DISBURSE.METHOD,Y.ARRNG.ID,R.REDO.AA.DISBURSE.METHOD,F.REDO.AA.DISBURSE.METHOD,AA.ERR)
    CALL F.READU(FN.REDO.AA.DISBURSE.METHOD,Y.ARRNG.ID,R.REDO.AA.DISBURSE.METHOD,F.REDO.AA.DISBURSE.METHOD,AA.ERR,'');*R22 MANUAL CODE CONVERSION
...
*CALL F.READ(FN.REDO.STORE.DSB.DEAL.IDS,Y.ARRNG.ID,R.REDO.STORE.DSB.DEAL.IDS,F.REDO.STORE.DSB.DEAL.IDS,STR.DE.ERR)
        CALL F.READU(FN.REDO.STORE.DSB.DEAL.IDS,Y.ARRNG.ID,R.REDO.STORE.DSB.DEAL.IDS,F.REDO.STORE.DSB.DEAL.IDS,STR.DE.ERR,'');*R22 MANUAL CODE CONVERSION

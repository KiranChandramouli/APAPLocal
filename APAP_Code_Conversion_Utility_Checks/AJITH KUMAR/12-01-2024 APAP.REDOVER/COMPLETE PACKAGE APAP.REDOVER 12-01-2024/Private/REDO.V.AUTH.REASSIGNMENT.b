* @ValidationCode : MjotMTUxMjE4MDMzMzpDcDEyNTI6MTY4MjQxMjMzOTg0MzpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MTpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
...
CALL F.READU(FN.REDO.ITEM.STOCK,Y.ITEM.STOCK.ID,R.REDO.ITEM.STOCK,F.REDO.ITEM.STOCK,E.RR.ITEM,'');* R22 AUTO CONVERSION
*CALL F.READ(FN.REDO.ITEM.STOCK.BY.DATE,Y.ITEM.STOCK.ID1,R.REDO.ITEM.STOCK.BY.DATE,F.REDO.ITEM.STOCK.BY.DATE,Y.ER.DAT)
CALL F.READU(FN.REDO.ITEM.STOCK.BY.DATE,Y.ITEM.STOCK.ID1,R.REDO.ITEM.STOCK.BY.DATE,F.REDO.ITEM.STOCK.BY.DATE,Y.ER.DAT,'');* R22 AUTO CONVERSION
RETURN
*-----------------------------------------------------------------------------
PROCESS:
*-----------------------------------------------------------------------------
...
CALL F.READU(FN.REDO.ITEM.SERIES,Y.ITEM.STOCK.ID1,R.REDO.ITEM.SERIES,F.REDO.ITEM.SERIES,Y.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.ITEM.SERIES,Y.ITEM.STOCK.ID1,R.REDO.ITEM.SER,F.REDO.ITEM.SERIES,Y.ERR,'');* R22 AUTO CONVERSION
*CALL F.READ(FN.REDO.H.PASSBOOK.INVENTORY,SEL.LIST,R.PASS.INV,F.REDO.H.PASSBOOK.INVENTORY,PASS.ERR)
CALL F.READU(FN.REDO.H.PASSBOOK.INVENTORY,SEL.LIST,R.PASS.INV,F.REDO.H.PASSBOOK.INVENTORY,PASS.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.ACCOUNT,Y.ACCT.NO,R.ACC,F.ACCOUNT,ACC.ERR,'');* R22 AUTO CONVERSION
TOTAL.DIGIT=''
...
CALL F.READU(FN.REDO.ITEM.SERIES,Y.ACCT.NO,R.REDO.ITEM.SERIES,F.REDO.ITEM.SERIES,Y.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.H.PASSBOOK.INVENTORY, Y.OLD.INV.ID, R.OLD.INV.REC, F.REDO.H.PASSBOOK.INVENTORY, Y.READ.ERR ,'');* R22 AUTO CONVERSION

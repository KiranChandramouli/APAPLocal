* @ValidationCode : Mjo4OTUzODQzMzU6Q3AxMjUyOjE3MDM4MjQ5MTE3OTY6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 29 Dec 2023 10:11:51
...
*CALL F.READ(FN.REDO.CLAIM.OPEN,Y.FILE.ID,R.FILE.REC,F.REDO.CLAIM.OPEN,FILE.ERR)
    CALL F.READU(FN.REDO.CLAIM.OPEN,Y.FILE.ID,R.FILE.REC,F.REDO.CLAIM.OPEN,FILE.ERR,'');*R22 MANUAL CODEE CONVERSION

* @ValidationCode : MjotOTgyMDEwNzU6Q3AxMjUyOjE3MDM2NzI1NTg4NDE6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Dec 2023 15:52:38
...
* CALL F.READ(FN.CUS.BEN.LIST,CUS.BEN.LIST.ID,R.CUS.BEN.LIST,F.CUS.BEN.LIST,CUS.BEN.LIST.ER)
    CALL F.READU(FN.CUS.BEN.LIST,CUS.BEN.LIST.ID,R.CUS.BEN.LIST,F.CUS.BEN.LIST,CUS.BEN.LIST.ER,'');*R22 MANUAL CODE CONVERSION
...
* CALL F.READ(FN.CUS.BEN.LIST,CUS.BEN.LIST.ID,R.CUS.BEN.LIST,F.CUS.BEN.LIST,CUS.BEN.LIST.ER)
    CALL F.READU(FN.CUS.BEN.LIST,CUS.BEN.LIST.ID,R.CUS.BEN.LIST,F.CUS.BEN.LIST,CUS.BEN.LIST.ER,'');*R22 MANUAL CODE COONVERSION
    IF NOT(CUS.BEN.LIST.ER) THEN
        OTHER.BEN.FLAG=1
    END

...
CALL F.READU(FN.ACCOUNT,VAR.ID,R.ACCOUNT,F.ACCOUNT,ACC.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.ACCOUNT,GET.NOM.ACCT,R.ACCOUNT,F.ACCOUNT,ACCOUNT.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.ACCOUNT,ID.NEW,R.ACCOUNT,F.ACCOUNT,ACCOUNT.ERR,'');* R22 AUTO CONVERSION

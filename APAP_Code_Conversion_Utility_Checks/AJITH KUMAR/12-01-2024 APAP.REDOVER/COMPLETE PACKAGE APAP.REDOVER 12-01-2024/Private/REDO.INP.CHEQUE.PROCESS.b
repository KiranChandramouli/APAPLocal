* @ValidationCode : MjotMTczOTQ4Njk5NjpDcDEyNTI6MTcwMzU5MDY0NTIwNDphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Dec 2023 17:07:25
...
*--------------------------------------------------------------------------------
    ...
    CALL CACHE.READ(FN.REDO.H.PAY.VERSION,ID.VAR,R.REDO.H.PAY.VERSION,Y.ERR.PAR)
...
*  CALL F.READ(FN.REDO.APAP.REINV.CHQ.AMT,Y.INT.LIQ.ACC,R.REDO.APAP.REINV.CHQ.AMT,F.REDO.APAP.REINV.CHQ.AMT,ACC.ERR)
    CALL F.READU(FN.REDO.APAP.REINV.CHQ.AMT,Y.INT.LIQ.ACC,R.REDO.APAP.REINV.CHQ.AMT,F.REDO.APAP.REINV.CHQ.AMT,ACC.ERR,'');*R22 MANUAL CODE CONVERSION

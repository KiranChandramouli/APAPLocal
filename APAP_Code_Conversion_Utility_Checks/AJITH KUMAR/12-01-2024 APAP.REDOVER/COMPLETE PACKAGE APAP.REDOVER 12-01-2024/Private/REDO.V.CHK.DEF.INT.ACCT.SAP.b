...
CALL CACHE.READ(FN.APAP.CATEG.PARAM,IDVAR.1,R.APAP.CATEG.PARAM,ERR.CATEG);* R22 AUTO CONVERSION
...
IDVAR.1 = "SYSTEM" ;* R22 AUTO CONVERSION
CALL CACHE.READ(FN.REDO.APAP.WS.PARAM,IDVAR.1,R.REDO.APAP.WS.PARAM,REA.ERR);* R22 AUTO CONVERSION
*PACS00035999 -E

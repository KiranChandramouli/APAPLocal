* @ValidationCode : MjoxMDc5OTc2MTc5OkNwMTI1MjoxNjgyNDEyMzYwMjQ4OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
AA.Framework.GetPeriodBalances(ACCOUNT.ID, BALANCE.TO.CHECK, DATE.OPTIONS, EFFECTIVE.DATE, "", "", BAL.DETAILS, "");* R22 UTILITY AUTO CONVERSION
...
AA.Framework.GetArrangementConditions(Y.AA.ID,'TERM.AMOUNT','','',PROP.COND,RET.COND,RET.ERR);* R22 UTILITY AUTO CONVERSION
...
IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,IDVAR.1,R.REDO.H.AA.DIS.CHG,DIS.CHG.ERR);* R22 UTILITY AUTO CONVERSION

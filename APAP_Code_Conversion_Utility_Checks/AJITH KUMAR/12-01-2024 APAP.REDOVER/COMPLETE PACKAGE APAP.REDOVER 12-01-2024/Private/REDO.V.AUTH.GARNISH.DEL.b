...
CALL F.READU(FN.REDO.GAR.LOCK.ALE,Y.CUSTOMER,R.REDO.GAR.LOCK.ALE,F.REDO.GAR.LOCK.ALE,ERR,'');* R22 AUTO CONVERSION
...
CALL CACHE.READ(FN.REDO.GAR.SUSP.ACCT,IDVAR.1,R.REDO.GAR.SUSP.ACCT,PARA.ERR);* R22 AUTO CONVERSION
...
*-------------------
*CALL F.READ(FN.ACCOUNT,Y.LCK.ACT,R.ACCOUNT,F.ACCOUNT,ERR.ACCOUNT)
CALL F.READU(FN.ACCOUNT,Y.LCK.ACT,R.ACCOUNT,F.ACCOUNT,ERR.ACCOUNT,'');* R22 AUTO CONVERSION
Y.STATUS2 = R.ACCOUNT<AC.LOCAL.REF><1,REF.POS>
...
CALL F.READU(FN.APAP.H.GARNISHMENT.REVERSE,Y.GAR.REV.ID,R.GAR.REV,F.APAP.H.GARNISHMENT.REVERSE,REV.ERR,'');* R22 AUTO CONVERSION

* @ValidationCode : MjoxNzA3NDMwMzc4OkNwMTI1MjoxNzAzNTY1NzU2MTUxOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 10:12:36
...
*CALL F.READ(FN.REDO.MANAGER.CHQ.DETAILS,VAR.CHQ.NO,R.CHQ.DETAILS,F.REDO.MANAGER.CHQ.DETAILS,CHQ.ERR)
        CALL F.READU(FN.REDO.MANAGER.CHQ.DETAILS,VAR.CHQ.NO,R.CHQ.DETAILS,F.REDO.MANAGER.CHQ.DETAILS,CHQ.ERR,'');*R22 MANUAL CODE CONVERSION
...
* CALL F.READ(FN.REDO.ADMIN.CHQ.DETAILS,VAR.CHQ.NO,R.CHQ.DETAILS,F.REDO.ADMIN.CHQ.DETAILS,CHQ.ERR)
        CALL F.READU(FN.REDO.ADMIN.CHQ.DETAILS,VAR.CHQ.NO,R.CHQ.DETAILS,F.REDO.ADMIN.CHQ.DETAILS,CHQ.ERR,'');*R22 MANUAL CODE CONVERSION
        IF R.CHQ.DETAILS THEN

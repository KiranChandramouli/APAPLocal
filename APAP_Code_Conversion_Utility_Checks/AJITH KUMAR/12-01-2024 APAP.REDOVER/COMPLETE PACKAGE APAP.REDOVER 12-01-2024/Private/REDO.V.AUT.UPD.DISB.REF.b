* @ValidationCode : MjoyMDI5Mzg1NzkzOkNwMTI1MjoxNzAzODI1MTY5NDEwOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 29 Dec 2023 10:16:09
...
*29-12-2023     AJIT KUMAR           R22 MANUAL CODE CONVERSION
*-----------------------------------------------------------------------------
    $INSERT I_EQUATE
    $INSERT I_COMMON
    $INSERT I_F.TELLER
...
*  CALL F.READ(FN.REDO.AA.DISBURSE.UPDATE,Y.DISB.UPD.ID,R.REDO.AA.DISBURSE.UPDATE,F.REDO.AA.DISBURSE.UPDATE,UPD.ERR)
    CALL F.READU(FN.REDO.AA.DISBURSE.UPDATE,Y.DISB.UPD.ID,R.REDO.AA.DISBURSE.UPDATE,F.REDO.AA.DISBURSE.UPDATE,UPD.ERR,'');*R22 MANUAL CODE CONVERSION

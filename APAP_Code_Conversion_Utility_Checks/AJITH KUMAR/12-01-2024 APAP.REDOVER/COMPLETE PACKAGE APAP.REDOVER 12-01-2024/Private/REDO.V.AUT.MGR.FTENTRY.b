* @ValidationCode : MjotMTM4NTA5MTcyMDpDcDEyNTI6MTcwMzc0MjI4MjU0Nzphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 28 Dec 2023 11:14:42
...
SUBROUTINE  REDO.V.AUT.MGR.FTENTRY
*-------------------------------------------------------------------------
*DESCRIPTION:
*~~~~~~~~~~~~
...
*   $INSERT I_F.FT.COMMISSION.TYPE   ;*R22 AUTO CODE CONVERSION
...
*~~~~~~~
    ...
    CALL CACHE.READ(FN.REDO.MANAGER.CHQ.PARAM,ID.VAR,R.REDO.MANAGER.CHQ.PARAM,ERR.PAR)
...
*Raising CATEG ENTRY
    ...
    IF (V$FUNCTION EQ 'A' OR V$FUNCTION EQ 'I') AND VAR.REC.STAT NE 'RNAU' THEN
        ...
        END
    END ELSE
        IF (V$FUNCTION EQ 'R' OR VAR.REC.STAT EQ 'RNAU') OR (PGM.VERSION EQ ',REINSTATE' OR PGM.VERSION EQ ',REVERSE.CHQ') THEN
            IF Y.DEBIT.CURRENCY EQ LCCY THEN

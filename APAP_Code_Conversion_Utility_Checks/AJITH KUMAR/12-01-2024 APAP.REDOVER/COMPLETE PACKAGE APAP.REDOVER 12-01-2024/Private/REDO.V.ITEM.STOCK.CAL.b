* @ValidationCode : MjoxNjI2NzUxNTM2OkNwMTI1MjoxNzA0NDM5OTM4MzEzOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:02:18
...
*            CALL F.READ(FN.REDO.H.DEPOSIT.RECEIPTS, Y.DEP.REC.ID, R.DEPOSIT.RECEIPTS, F.REDO.H.DEPOSIT.RECEIPTS, Y.READ.ERR)
            CALL F.READU(FN.REDO.H.DEPOSIT.RECEIPTS, Y.DEP.REC.ID, R.DEPOSIT.RECEIPTS, F.REDO.H.DEPOSIT.RECEIPTS, Y.READ.ERR,'');* R22 UTILITY AUTO CONVERSION

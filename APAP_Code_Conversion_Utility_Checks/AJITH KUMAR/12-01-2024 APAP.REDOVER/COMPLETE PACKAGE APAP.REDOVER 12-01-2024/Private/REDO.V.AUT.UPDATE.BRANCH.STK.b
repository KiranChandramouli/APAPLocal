...
Y.TOT.CARD.SERIES = DCOUNT(R.NEW(STO.ENT.STOCK.SERIES),@VM) ;*R22 AUTO CONVERSION
...
*CALL F.READ(FN.BRANCH.REQ.STOCK,Y.STOCK.SERIES,R.BRANCH.REQ.STOCK,F.BRANCH.REQ.STOCK,Y.ERR)
CALL F.READU(FN.BRANCH.REQ.STOCK,Y.STOCK.SERIES,R.BRANCH.REQ.STOCK,F.BRANCH.REQ.STOCK,Y.ERR,'');* R22 AUTO CONVERSION
*R.BRANCH.REQ.STOCK<BRAN.STK.LOAD.DATE> = R.NEW(STO.ENT.IN.OUT.DATE)
R.BRANCH.REQ.STOCK<BRAN.STK.TXN.DATE> = R.NEW(STO.ENT.IN.OUT.DATE) ;*R22 MANUAL CONVERSION
...
R.BRANCH.REQ.STOCK<BRAN.STK.QTY.REQUEST>=Y.STK.QTY + R.BRANCH.REQ.STOCK<BRAN.STK.QTY.REQUEST>

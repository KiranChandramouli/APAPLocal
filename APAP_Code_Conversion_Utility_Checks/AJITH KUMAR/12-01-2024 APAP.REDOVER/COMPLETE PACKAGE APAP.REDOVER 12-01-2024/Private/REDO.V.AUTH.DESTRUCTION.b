...
DEPOSIT.RECEIPTS:
*-------------------------------
*R22 MANUAL CONVERSION START : STATUS.CHG and STATUS.DATE fields are not missing in REDO.H.DEPOSIT.RECEIPTS
...
CALL F.READU(APPL.NAME,Y.BATCH,R.REC,APPL.PATH,Y.ERR,'');* R22 AUTO CONVERSION
Y.DEL.VAL =  R.REDO.ITEM.SERIES<POS.SER>
R.REDO.ITEM.SERIES<POS.SER>    = ''
END
*R22 MANUAL CONVERSION START: POS.VAL changed to POS.SER
...
CALL F.READU(FN.REDO.L.SERIES.CHANGE.DETS, Y.SERIES.DETAILS.ID, R.SERIES.DETS, F.REDO.L.SERIES.CHANGE.DETS, Y.READ.ERR,'');* R22 AUTO CONVERSION

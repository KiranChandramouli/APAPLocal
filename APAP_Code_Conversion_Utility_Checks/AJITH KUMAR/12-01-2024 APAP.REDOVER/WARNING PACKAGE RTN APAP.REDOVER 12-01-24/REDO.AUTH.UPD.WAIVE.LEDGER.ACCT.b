* @ValidationCode : MjotMTMyOTc1NDEyOkNwMTI1MjoxNzAzNTY2MzM3NDc2OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 10:22:17
...
* CALL F.READ(FN.REDO.WAIVE.LEDGER.ACCT,Y.TRANS.ID,R.REDO.WAIVE.LEDGER.ACCT,F.REDO.WAIVE.LEDGER.ACCT,LED.ERR)
    CALL F.READU(FN.REDO.WAIVE.LEDGER.ACCT,Y.TRANS.ID,R.REDO.WAIVE.LEDGER.ACCT,F.REDO.WAIVE.LEDGER.ACCT,LED.ERR,'');*R22 MANUAL CODE CONVERSION
...
*----------------------
*CALL F.READ(FN.REDO.WAIVE.LEDGER.ACCT,Y.TRANS.ID,R.REDO.WAIVE.LEDGER.ACCT,F.REDO.WAIVE.LEDGER.ACCT,LED.ERR)
    CALL F.READ(FN.REDO.WAIVE.LEDGER.ACCT,Y.TRANS.ID,R.REDO.WAIVE.LEDGER.ACCT,F.REDO.WAIVE.LEDGER.ACCT,LED.ERR,'');*R22 MANUAL CODE CONVERISON

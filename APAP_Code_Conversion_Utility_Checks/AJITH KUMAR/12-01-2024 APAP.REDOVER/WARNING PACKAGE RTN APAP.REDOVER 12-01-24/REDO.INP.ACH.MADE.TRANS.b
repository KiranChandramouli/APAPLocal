* @ValidationCode : MjotNjQyOTczNDc0OkNwMTI1MjoxNzAzNTY4NjI0NDgyOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 11:00:24
...
*CALL F.READ(FN.REDO.ACH.TRANSFER.DETAILS,Y.ID,R.REDO.ADM.CHQ,F.REDO.ACH.TRANSFER.DETAILS,ERR.AD)
        CALL F.READU(FN.REDO.ACH.TRANSFER.DETAILS,Y.ID,R.REDO.ADM.CHQ,F.REDO.ACH.TRANSFER.DETAILS,ERR.AD,'');*R22 MANUAL CODE CONVERSION

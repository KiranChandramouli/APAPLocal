* @ValidationCode : Mjo1NjMyNTE5NTM6Q3AxMjUyOjE2ODI0MTIzNjQ0OTI6SGFyaXNodmlrcmFtQzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
*        IF LEN(VAR.SUBCA) > 0 THEN
        IF LEN(VAR.SUBCA) GT 0 THEN;* R22 UTILITY AUTO CONVERSION

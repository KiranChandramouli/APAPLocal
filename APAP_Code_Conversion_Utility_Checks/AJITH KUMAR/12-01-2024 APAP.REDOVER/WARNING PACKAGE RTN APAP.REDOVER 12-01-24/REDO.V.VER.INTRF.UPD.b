* @ValidationCode : Mjo4NzExODQyNTk6Q3AxMjUyOjE2ODI0MTIzNjYzNDk6SGFyaXNodmlrcmFtQzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
*        CALL F.READ(FN.REDO.INTRF.REP.LINE,Y.ID.OLD.REP.LINE,R.REDO.INTRF.REP.LINE,F.REDO.INTRF.REP.LINE,ERR)
        CALL F.READU(FN.REDO.INTRF.REP.LINE,Y.ID.OLD.REP.LINE,R.REDO.INTRF.REP.LINE,F.REDO.INTRF.REP.LINE,ERR,'');* R22 UTILITY AUTO CONVERSION

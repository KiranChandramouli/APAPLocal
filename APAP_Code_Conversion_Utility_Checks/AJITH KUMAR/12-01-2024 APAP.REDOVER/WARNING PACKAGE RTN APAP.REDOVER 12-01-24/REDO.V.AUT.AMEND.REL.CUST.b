* @ValidationCode : Mjo1NzYwODgzMTM6Q3AxMjUyOjE3MDM2NzMwNjU1NDY6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Dec 2023 16:01:05
...
* CALL F.READ(FN.REDO.EMPLOYEE.ACCOUNTS,ID.NEW,R.REDO.EMPLOYEE.ACCOUNTS,F.REDO.EMPLOYEE.ACCOUNTS,ERR.REDO.EMPLOYEE.ACCOUNTS)
        CALL F.READU(FN.REDO.EMPLOYEE.ACCOUNTS,ID.NEW,R.REDO.EMPLOYEE.ACCOUNTS,F.REDO.EMPLOYEE.ACCOUNTS,ERR.REDO.EMPLOYEE.ACCOUNTS,'');*R22 MANUAL CODE CONVERSION
...
*CALL F.READ(FN.REDO.EMPLOYEE.ACCOUNTS,Y.CUS.ID,R.REDO.EMPLOYEE.ACCOUNTS,F.REDO.EMPLOYEE.ACCOUNTS,ERR.REDO.EMPLOYEE.ACCOUNTS)
        CALL F.READU(FN.REDO.EMPLOYEE.ACCOUNTS,Y.CUS.ID,R.REDO.EMPLOYEE.ACCOUNTS,F.REDO.EMPLOYEE.ACCOUNTS,ERR.REDO.EMPLOYEE.ACCOUNTS,'');*R22 MANUAL CODE CONVERSION
...
* CALL F.READ(FN.REDO.EMPLOYEE.ACCOUNTS,Y.OLD.ID,R.RELATION.EMP,F.REDO.EMPLOYEE.ACCOUNTS,EMP.ERR)
            CALL F.READU(FN.REDO.EMPLOYEE.ACCOUNTS,Y.OLD.ID,R.RELATION.EMP,F.REDO.EMPLOYEE.ACCOUNTS,EMP.ERR,'');*R22 MANUAL CODE COONVERSION
...
*CALL F.READ(FN.REDO.EMPLOYEE.ACCOUNTS,Y.NEW.ID,R.RELATION.EMP,F.REDO.EMPLOYEE.ACCOUNTS,EMP.ERR)
            CALL F.READU(FN.REDO.EMPLOYEE.ACCOUNTS,Y.NEW.ID,R.RELATION.EMP,F.REDO.EMPLOYEE.ACCOUNTS,EMP.ERR,'')
            IF R.RELATION.EMP THEN

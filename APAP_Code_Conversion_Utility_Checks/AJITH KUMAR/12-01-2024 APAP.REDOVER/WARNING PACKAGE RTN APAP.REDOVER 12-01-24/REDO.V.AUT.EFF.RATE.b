* @ValidationCode : Mjo5MDM3MzQ0NDg6Q3AxMjUyOjE3MDM3MzgyNzA3NTU6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 28 Dec 2023 10:07:50
...
*CALL F.READ(FN.REDO.APAP.L.CONTRACT.BALANCES,APAP.CONTRACT.BALANCES.ID,R.APAP.CONTRACT.BALANCES,F.REDO.APAP.L.CONTRACT.BALANCES,APAP.CONTRACT.BALANCES.ERR)
    CALL F.READU(FN.REDO.APAP.L.CONTRACT.BALANCES,APAP.CONTRACT.BALANCES.ID,R.APAP.CONTRACT.BALANCES,F.REDO.APAP.L.CONTRACT.BALANCES,APAP.CONTRACT.BALANCES.ERR,'');*R22 MANAUAL CODE CONVERSION
****
...
* CALL F.READ(FN.REDO.APAP.L.SC.DISC.AMORT,DISC.AMORT.ID,R.DISC.AMORT,F.REDO.APAP.L.SC.DISC.AMORT,DISC.AMORT.ERR)
    CALL F.READU(FN.REDO.APAP.L.SC.DISC.AMORT,DISC.AMORT.ID,R.DISC.AMORT,F.REDO.APAP.L.SC.DISC.AMORT,DISC.AMORT.ERR,'');*R22 MANUAL CODE CONVERSION
...
*CALL EB.ACCOUNTING("SC","SAO",ACC.ENTRY.ARRAY,'')
        AC.API.EbAccounting("SC","SAO",ACC.ENTRY.ARRAY,'');*R22 MANAUL CODE CONVERSION

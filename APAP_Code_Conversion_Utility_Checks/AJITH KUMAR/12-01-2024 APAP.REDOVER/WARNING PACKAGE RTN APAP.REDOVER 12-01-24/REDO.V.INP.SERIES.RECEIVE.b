* @ValidationCode : MjotNDY1MzQyNTIxOkNwMTI1MjoxNzA0MzY4NjQwNjQxOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:14:00
...
*CALL F.READ(FN.REDO.H.BANK.DRAFTS,SEL.LIST.2,R.REDO.H.BANK.DRAFTS,F.REDO.H.BANK.DRAFTS,Y.ERR.APP)
        CALL F.READU(FN.REDO.H.BANK.DRAFTS,SEL.LIST.2,R.REDO.H.BANK.DRAFTS,F.REDO.H.BANK.DRAFTS,Y.ERR.APP,'');* R22 AUTO CONVERSION
        IF Y.REJ.VAL EQ 'YES' THEN
...
*CALL F.READ(FN.REDO.H.DEPOSIT.RECEIPTS,SEL.LIST.2,R.REDO.H.DEPOSIT.RECEIPTS,F.REDO.H.DEPOSIT.RECEIPTS,Y.ERR.APP)
        CALL F.READU(FN.REDO.H.DEPOSIT.RECEIPTS,SEL.LIST.2,R.REDO.H.DEPOSIT.RECEIPTS,F.REDO.H.DEPOSIT.RECEIPTS,Y.ERR.APP,'');* R22 AUTO CONVERSION
        IF Y.REJ.VAL EQ 'YES' THEN
...
*CALL F.READ(FN.REDO.H.ADMIN.CHEQUES,SEL.LIST.2,R.REDO.H.ADMIN.CHEQUES,F.REDO.H.ADMIN.CHEQUES,Y.ERR.APP)
        CALL F.READU(FN.REDO.H.ADMIN.CHEQUES,SEL.LIST.2,R.REDO.H.ADMIN.CHEQUES,F.REDO.H.ADMIN.CHEQUES,Y.ERR.APP,'');* R22 AUTO CONVERSION
        IF Y.REJ.VAL EQ 'YES' THEN
...
*CALL F.READ(FN.REDO.H.PASSBOOK.INVENTORY,SEL.LIST.2,R.REDO.H.PASSBOOK.INVENTORY,F.REDO.H.PASSBOOK.INVENTORY,Y.ERR.APP)
        CALL F.READU(FN.REDO.H.PASSBOOK.INVENTORY,SEL.LIST.2,R.REDO.H.PASSBOOK.INVENTORY,F.REDO.H.PASSBOOK.INVENTORY,Y.ERR.APP,'');* R22 AUTO CONVERSION
        IF Y.REJ.VAL EQ 'YES' THEN

* @ValidationCode : MjoxMjY0MDQwMzU2OkNwMTI1MjoxNjgyNDEyMzM4MTA0OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
CALL F.READU(FN.REDO.EMPLOYEE.ACCOUNTS,Y.CUSTOMER.ID,R.REDO.EMPLOYEE.ACCOUNTS,F.REDO.EMPLOYEE.ACCOUNTS,EMP.ACC.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.EMPLOYEE.ACCOUNTS,Y.JOIN.ID,R.REDO.EMPLOYEE.ACCOUNTS,F.REDO.EMPLOYEE.ACCOUNTS,EMP.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.EMPLOYEE.ACCOUNTS,Y.OLD.ID,R.REDO.EMPLOYEE.ACCOUNTS,F.REDO.EMPLOYEE.ACCOUNTS,EMP.ERR,'');* R22 AUTO CONVERSION

* @ValidationCode : MjoxNzgxNzEwMTg0OkNwMTI1MjoxNzAzNzQ0ODUxNjczOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Dec 2023 11:57:31
...
*  CALL F.READ(FN.AI.REDO.ARCIB.PARAMETER,'SYSTEM',R.AI.REDO.ARCIB.PARAMETER,F.AI.REDO.ARCIB.PARAMETER,AI.REDO.ARCIB.PARAMETER.ERR) ;*Tus Start
    ...
    CALL CACHE.READ(FN.AI.REDO.ARCIB.PARAMETER,ID.VAR,R.AI.REDO.ARCIB.PARAMETER,AI.REDO.ARCIB.PARAMETER.ERR) ; * Tus End
...
*  CALL F.READ(FN.EB.FILE.UPLOAD.PARAM,'SYSTEM',R.EB.FILE.UPLOAD.PARAM,F.EB.FILE.UPLOAD.PARAM,Y.EB.FILE.UPLOAD.PARMA.ERR) ;*Tus Start
    CALL CACHE.READ(FN.EB.FILE.UPLOAD.PARAM,ID.VAR,R.EB.FILE.UPLOAD.PARAM,Y.EB.FILE.UPLOAD.PARMA.ERR) ; * Tus End

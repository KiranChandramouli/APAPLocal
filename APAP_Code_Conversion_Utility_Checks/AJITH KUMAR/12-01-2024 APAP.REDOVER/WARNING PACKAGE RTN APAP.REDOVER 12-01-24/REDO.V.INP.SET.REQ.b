* @ValidationCode : MjoxNDcwNjU4NTczOkNwMTI1MjoxNzA0MzcwMTg0NTYxOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:39:44
...
*CALL F.READ(FN.CUST.REQUESTS,Y.VAR.ID,R.REQUESTS,F.CUST.REQUESTS,ERR)
    CALL F.READU(FN.CUST.REQUESTS,Y.VAR.ID,R.REQUESTS,F.CUST.REQUESTS,ERR,'');* R22 AUTO CONVERSION
    Y.VAR.CUS.NO=1
    IF R.REQUESTS THEN
...
*CALL F.READ(FN.REDO.CRM.DOC.REQ,ID.NEW,R.REDO.CRM.DOC.REQ,F.REDO.CRM.DOC.REQ,DOC.REQ.ERR)
    CALL F.READU(FN.REDO.CRM.DOC.REQ,ID.NEW,R.REDO.CRM.DOC.REQ,F.REDO.CRM.DOC.REQ,DOC.REQ.ERR,'');* R22 AUTO CONVERSION
...
*CALL F.READ(FN.REDO.CRM.DOC.DATE,TODAY,R.REDO.CRM.DOC.DATE,F.REDO.CRM.DOC.DATE,DOC.DATE.ERR)
        CALL F.READU(FN.REDO.CRM.DOC.DATE,TODAY,R.REDO.CRM.DOC.DATE,F.REDO.CRM.DOC.DATE,DOC.DATE.ERR,'');* R22 AUTO CONVERSION
...
*CALL F.READ(FN.REDO.CRM.DOC.DATE,Y.DATE,R.REDO.CRM.DOC.DATE,F.REDO.CRM.DOC.DATE,DOC.DATE.ERR)
    CALL F.READU(FN.REDO.CRM.DOC.DATE,Y.DATE,R.REDO.CRM.DOC.DATE,F.REDO.CRM.DOC.DATE,DOC.DATE.ERR,'');* R22 AUTO CONVERSION

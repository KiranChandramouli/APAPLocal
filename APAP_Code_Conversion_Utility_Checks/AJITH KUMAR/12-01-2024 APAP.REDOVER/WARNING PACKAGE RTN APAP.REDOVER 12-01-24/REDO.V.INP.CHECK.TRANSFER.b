* @ValidationCode : MjotMTgwMTQ4OTQ3OkNwMTI1MjoxNzA0MzYzODkxNjkxOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 15:54:51
...
*CALL CACHE.READ(FN.REDO.TT.GROUP.PARAM,'SYSTEM',R.REDO.TT.GROUP.PARAM,GRO.ERR)
    ...
    CALL CACHE.READ(FN.REDO.TT.GROUP.PARAM,IDVAR.1,R.REDO.TT.GROUP.PARAM,GRO.ERR);* R22 AUTO CONVERSION

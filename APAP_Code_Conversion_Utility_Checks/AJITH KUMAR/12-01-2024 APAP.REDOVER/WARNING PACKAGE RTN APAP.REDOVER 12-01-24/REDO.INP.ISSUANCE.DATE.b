* @ValidationCode : MjotNjkzODE1NTkzOkNwMTI1MjoxNzAzNjUxMjE2ODc0OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Dec 2023 09:56:56
...
CONFIRMED.CHECK:
*------------------------------------------------------------------------
    ID.VAR = 'CONFIRMED' ;*R22 MANUAL CODE CONVERSION
    CALL F.READ(FN.REDO.CHQ.VALID,ID.VAR,R.CHQ.VAL,F.REDO.CHQ.VALID,ERR.REDO)
...
NONCONFIRMED.CHECK:
*------------------------------------------------------------------------
    ID.VAR1 = 'NONCONFIRMED' ;*R22 MANUAL CODE CONVERISON
    CALL F.READ(FN.REDO.CHQ.VALID,ID.VAR1,R.CHQ.VAL,F.REDO.CHQ.VALID,ERR.REDO)

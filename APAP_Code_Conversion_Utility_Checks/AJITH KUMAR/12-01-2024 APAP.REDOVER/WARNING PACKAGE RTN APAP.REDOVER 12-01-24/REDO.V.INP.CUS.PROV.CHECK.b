* @ValidationCode : MjoxMDkxMjgwNDkxOkNwMTI1MjoxNzA0MzY0MTgyMDY0OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 15:59:42
...
*CALL CACHE.READ(FN.REDO.H.PROVISION.PARAMETER,'SYSTEM',R.REDO.H.PROVISION.PARAMETER,Y.ERR)
        ...
        CALL CACHE.READ(FN.REDO.H.PROVISION.PARAMETER,IDVAR.1,R.REDO.H.PROVISION.PARAMETER,Y.ERR);* R22 AUTO CONVERSION

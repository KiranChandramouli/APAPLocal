* @ValidationCode : MjotODM3MDIxNTIxOkNwMTI1MjoxNzAzNzQyMjAwNDg4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Dec 2023 11:13:20
...
*CALL EB.ACCOUNTING("BM.CRCD.MERCH.UPLOAD","SAO",MULTI.STMT,'')
    AC.API.EbAccounting("BM.CRCD.MERCH.UPLOAD","SAO",MULTI.STMT,'') ;*R22 MANUAL CODE CONVERSION
RETURN

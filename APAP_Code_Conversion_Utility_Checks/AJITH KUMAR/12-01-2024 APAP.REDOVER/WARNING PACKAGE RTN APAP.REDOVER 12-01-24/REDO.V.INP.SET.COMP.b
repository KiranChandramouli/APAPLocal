* @ValidationCode : Mjo5ODY3NDU2MTI6Q3AxMjUyOjE3MDQzNjg3NTY4MDI6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:15:56
...
*CALL F.READ(FN.CUST.COMPLAINTS,Y.VAR.ID,R.COMPLAINTS,F.CUST.COMPLAINTS,ERR)
    CALL F.READU(FN.CUST.COMPLAINTS,Y.VAR.ID,R.COMPLAINTS,F.CUST.COMPLAINTS,ERR,'');* R22 AUTO CONVERSION
    Y.VAR.CUS.NO=1

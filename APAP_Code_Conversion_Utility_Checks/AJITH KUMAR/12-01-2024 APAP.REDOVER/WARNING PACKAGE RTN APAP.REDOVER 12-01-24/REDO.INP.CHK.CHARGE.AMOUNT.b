* @ValidationCode : MjotNDIyNjA2NDk2OkNwMTI1MjoxNzAzNTkwODI2MDMzOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 17:10:26
...
* CALL GET.LOC.REF(LOC.REF.APPL,LOC.REF.FIELDS,LOC.REF.POS)
    EB.LocalReferences.GetLocRef(LOC.REF.APPL,LOC.REF.FIELDS,LOC.REF.POS) ;*R22 MANUAL CODE CONVERSION

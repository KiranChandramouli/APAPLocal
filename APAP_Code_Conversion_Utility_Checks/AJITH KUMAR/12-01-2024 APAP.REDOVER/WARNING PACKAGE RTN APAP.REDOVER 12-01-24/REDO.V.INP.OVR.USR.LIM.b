* @ValidationCode : Mjo2MDEyODYzMzk6Q3AxMjUyOjE3MDQzNjU3OTg2NTg6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:26:38
...
*CALL F.READ(FN.REDO.APAP.USER.LIMITS,Y.OPERATOR,R.USR.LIM,F.REDO.APAP.USER.LIMITS,USR.POS)
    CALL F.READU(FN.REDO.APAP.USER.LIMITS,Y.OPERATOR,R.USR.LIM,F.REDO.APAP.USER.LIMITS,USR.POS,'');* R22 AUTO CONVERSION
    IF R.USR.LIM THEN

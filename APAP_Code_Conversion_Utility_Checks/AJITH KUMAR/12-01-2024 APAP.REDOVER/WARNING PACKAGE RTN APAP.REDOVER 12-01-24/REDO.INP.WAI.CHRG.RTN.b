* @ValidationCode : MjoxMzE5NDIxNjQ0OkNwMTI1MjoxNzAzNjUzOTM5NTc5OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Dec 2023 10:42:19
...
*PACS00023910 - S
    IF PGM.VERSION[2,3] EQ 'CHQ' THEN     ;* PACS00023918
        ...
        CALL CACHE.READ(FN.REDO.ADMIN.CHQ.PARAM,ID.VAR,R.REDO.ADMIN.CHQ.PARAM,ERR.PAR)
        Y.ALL.AC.NOS = R.REDO.ADMIN.CHQ.PARAM<ADMIN.CHQ.PARAM.ACCOUNT>
        Y.ALL.TAX.KEY = R.REDO.ADMIN.CHQ.PARAM<ADMIN.CHQ.PARAM.TAX.KEY>
    END
    ELSE
        ID.VAR1 = 'SYSTEM' ;*R22 MANUAL CODE CONVERSION
        CALL CACHE.READ(FN.REDO.MANAGER.CHQ.PARAM,ID.VAR1,R.REDO.MANAGER.CHQ.PARAM,ERR.PAR)

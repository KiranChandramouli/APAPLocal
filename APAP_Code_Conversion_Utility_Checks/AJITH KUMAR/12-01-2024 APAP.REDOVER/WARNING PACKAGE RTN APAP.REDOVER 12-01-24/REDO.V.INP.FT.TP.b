* @ValidationCode : MjotMTAyMDA2Njk5ODpDcDEyNTI6MTcwNDM2NDIwODAyOTphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:00:08
...
*CALL CACHE.READ(FN.REDO.TRANS.CODE.PARAM,"SYSTEM",R.REDO.TRANS.CODE.PARAM,REDO.TRANS.CODE.PARAM.ERR)
    ...
    CALL CACHE.READ(FN.REDO.TRANS.CODE.PARAM,IDVAR.1,R.REDO.TRANS.CODE.PARAM,REDO.TRANS.CODE.PARAM.ERR);* R22 AUTO CONVERSION
...
*        APAP.REDOVER.REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,DESC,REC.CON,EX.USER,EX.PC)  ;*R22 MANUAL CODE CONVERSION

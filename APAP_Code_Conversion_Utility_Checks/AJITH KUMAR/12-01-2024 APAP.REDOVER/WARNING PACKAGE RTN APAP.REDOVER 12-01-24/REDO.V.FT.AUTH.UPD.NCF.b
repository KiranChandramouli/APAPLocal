* @ValidationCode : MjotMjIxOTQyMzk6Q3AxMjUyOjE3MDQyODIzMDM3NTY6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 Jan 2024 17:15:03
...
*Initialisation
    ...
    LRF.FIELD='L.NCF.REQUIRED':@VM:'TRANSACTION.REF':@VM:'L.NCF.NUMBER':@VM:'L.FT.TAX.TYPE':@VM:'L.NCF.TAX.NUM':@VM:'WAIVE.TAX':@VM:'L.TT.COMM.CODE':@VM:'L.TT.WV.COMM':@VM:'L.TT.COMM.AMT':@VM:'L.TT.TAX.CODE':@VM:'L.TT.WV.TAX':@VM:'L.TT.TAX.AMT' ;*R22 MANUAL CONVERSION
    LRF.POS=''
RETURN
***********
OPEN.FILES:
...
* Sum up the amount which is not waived in comm/ tax instead of summing all the waive comm/ tax amount.
    ...
    CHANGE @SM TO @FM IN LOC.WAIVE.COMM ;*R22 MANUAL CONVERSION START
    CHANGE @SM TO @FM IN LOC.WAIVE.TAX
    LOC.WAIVE.COMM.CNT = DCOUNT(LOC.WAIVE.COMM,@FM)
    LOC.WAIVE.TAX.CNT  = DCOUNT(LOC.WAIVE.TAX,@FM) ;*R22 MANUAL CONVERSION END
...
*Generating NCF number and Updating STOCK table
    ...
    VAR.PREV.DR.RANGE=VAR.PREV.DR.RANGE<1,DCOUNT(VAR.PREV.DR.RANGE,@VM)> ;*R22 MANUAL CONVERSION
...
* End of Fix
    ...
    IF VAR.QTY.AVAIL.CR GT 0 THEN
        ...
        VAR.PREV.CR.RANGE=VAR.PREV.CR.RANGE<1,DCOUNT(VAR.PREV.CR.RANGE,@VM)> ;*R22 MANUAL CONVERSION
...
*CALL CACHE.READ(FN.INTERFACE.CONFIG.PRT,"email",R.INT.CONFIG,EMAILL.ERR)
    IDVAR.1 = "email" ;* R22 AUTO CONVERSION
    CALL CACHE.READ(FN.INTERFACE.CONFIG.PRT,IDVAR.1,R.INT.CONFIG,EMAILL.ERR);* R22 AUTO CONVERSION
    IF R.INT.CONFIG THEN
        Y.FOLDER.TYPE = R.INT.CONFIG<INTRF.MSG.INT.FLD.NAME>
        Y.FOLDER.NAME = R.INT.CONFIG<INTRF.MSG.INT.FLD.VAL>
        CHANGE @VM TO @FM IN Y.FOLDER.TYPE ;*R22 MANUAL CONVERSION
        CHANGE @VM TO @FM IN Y.FOLDER.NAME ;*R22 MANUAL CONVERSION
...
*CALL F.READ(FN.REDO.NCF.ISSUED,NCF.ISSUE.ID,R.REDO.NCF.ISSUED,F.REDO.NCF.ISSUED,ISSUE.MSG)
    CALL F.READU(FN.REDO.NCF.ISSUED,NCF.ISSUE.ID,R.REDO.NCF.ISSUED,F.REDO.NCF.ISSUED,ISSUE.MSG,'');* R22 AUTO CONVERSION
    ...
    NCF.CNT = DCOUNT(R.REDO.NCF.ISSUED<ST.IS.NCF>,@VM) ;*R22 MANUAL CONVERSION
...
*CALL F.READ(FN.REDO.L.NCF.STATUS,NCF.ISSUE.ID,R.REDO.L.NCF.STATUS,F.REDO.L.NCF.STATUS,STATUS.MSG)
    CALL F.READU(FN.REDO.L.NCF.STATUS,NCF.ISSUE.ID,R.REDO.L.NCF.STATUS,F.REDO.L.NCF.STATUS,STATUS.MSG,'');* R22 AUTO CONVERSION
    ...
    NCF.ST.CNT = DCOUNT(R.REDO.L.NCF.STATUS<NCF.ST.NCF>,@VM) ;*R22 MANUAL CONVERSION
...
*CALL F.READ(FN.REDO.L.NCF.UNMAPPED,NCF.ISSUE.ID,R.REDO.L.NCF.UNMAPPED,F.REDO.L.NCF.UNMAPPED,UNMAP.ERR)
    CALL F.READU(FN.REDO.L.NCF.UNMAPPED,NCF.ISSUE.ID,R.REDO.L.NCF.UNMAPPED,F.REDO.L.NCF.UNMAPPED,UNMAP.ERR,'');* R22 AUTO CONVERSION

* @ValidationCode : MjotODU3NDUyMDkyOkNwMTI1MjoxNzAzNjUxOTY2MTI4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Dec 2023 10:09:26
...
*  CALL F.READ(FN.REDO.CUST.REQUESTS,'SYSTEM',R.REDO.CUST.REQ,F.REDO.CUST.REQUESTS,CUST.REQ.ERR) ;*Tus Start
    ...
    CALL CACHE.READ(FN.REDO.CUST.REQUESTS,ID.VAR,R.REDO.CUST.REQ,CUST.REQ.ERR) ; * Tus End ;*R22 MANUAL CODE CONVERSION

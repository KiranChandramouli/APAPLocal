* @ValidationCode : Mjo4Nzk0ODE0OTc6Q3AxMjUyOjE2ODI0MTIzNDAxNTc6SGFyaXNodmlrcmFtQzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
SUBROUTINE REDO.V.AUTH.REV.TAX.AMT
*-----------------------------------------------------------------------------
*------------------------------------------------------------------------------------------
...
* PROGRAM NAME : REDO.V.AUTH.REV.TAX.AMT
*------------------------------------------------------------------------------------------
...
*Modification history
*Date                Who               Reference                  Description
*13-04-2023      conversion tool     R22 Auto code conversion    VM TO @VM,F.READ TO CACHE.TREAD
...
Y.CERT.CHEQUE.NO =R.NEW(TT.TE.LOCAL.REF)<1,POS.CERT.CHEQUE.NO>
Y.CERT.CHEQ.NO=Y.CERT.CHEQUE.NO[1,1]
...
CALL F.READ(FN.ACCOUNT,Y.CREDIT.ACCOUNT.NO,R.ACCT,F.ACCOUNT,ACC.ERR)
...
R.STMT.ARR = ''
R.STMT.ARR<AC.STE.ACCOUNT.NUMBER> = Y.CREDIT.ACCOUNT.NO
...
GOSUB RAISE.DR.ENTRIES
*    V = TT.TE.AUDIT.DATE.TIME

*CALL EB.ACCOUNTING("TT","SAO",MULTI.STMT,'')
AC.API.EbAccounting("TT","SAO",MULTI.STMT,'');* R22 AUTO CONVERSION
RETURN
*---------------------------------------------------------------------
RAISE.DR.ENTRIES:
*---------------------------------------------------------------------
...
*------------------------------------------------------------------------
*Raise the accounting entries
Y.ACCOUNT.NO = Y.CREDIT.ACCOUNT.NO
R.ACCT=''
...
R.STMT.ENT<AC.STE.ACCOUNT.OFFICER> = Y.ACCT.OFFICER
R.STMT.ENT<AC.STE.CUSTOMER.ID> = Y.CUST
R.STMT.ENT<AC.STE.DEPARTMENT.CODE> = R.USER<EB.USE.DEPARTMENT.CODE>

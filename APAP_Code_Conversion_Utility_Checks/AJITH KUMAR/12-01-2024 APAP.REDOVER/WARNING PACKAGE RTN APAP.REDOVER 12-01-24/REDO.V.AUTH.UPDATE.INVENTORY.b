* @ValidationCode : MjotMTg3NzIzMTkwODpDcDEyNTI6MTY4MjQxMjM0MDc2OTpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
CALL F.READU(FN.REDO.ITEM.SERIES,Y.ACCOUNT.ID,R.REDO.ITEM.SERIES,F.REDO.ITEM.SERIES,Y.ERR,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.H.PASSBOOK.INVENTORY,Y.PASS.ID,R.PASS.INV,F.REDO.H.PASSBOOK.INVENTORY,Y.ERR.INV,'');* R22 AUTO CONVERSION
AUTHORISER = C$T24.SESSION.NO:'_':OPERATOR ;*R22 Auto code conversion
...
CALL F.READU(FN.REDO.ITEM.SERIES,Y.ACCOUNT.ID,R.REDO.ACCT.ITEM,F.REDO.ITEM.SERIES,Y.ACC.ERR.,'');* R22 AUTO CONVERSION
...
CALL F.READU(FN.REDO.H.PASSBOOK.INVENTORY,Y.PASS.ID1,R.PASS.INV,F.REDO.H.PASSBOOK.INVENTORY,INV.ERR,'');* R22 AUTO CONVERSION

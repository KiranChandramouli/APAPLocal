* @ValidationCode : MjoyMDk1NzIwNjYwOkNwMTI1MjoxNzA0MzY1MDU0MDc4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:14:14
...
*CALL CACHE.READ(FN.AI.REDO.ARCIB.PARAM,'SYSTEM',R.AI.REDO.ARCIB.PARAM,Y.ERR.PAR)
    ...
    CALL CACHE.READ(FN.AI.REDO.ARCIB.PARAM,IDVAR.1,R.AI.REDO.ARCIB.PARAM,Y.ERR.PAR);* R22 AUTO CONVERSION

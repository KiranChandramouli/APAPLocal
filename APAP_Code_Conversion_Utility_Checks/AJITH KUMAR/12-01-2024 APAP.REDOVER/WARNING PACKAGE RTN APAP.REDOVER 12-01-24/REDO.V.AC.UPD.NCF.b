* @ValidationCode : MjoyMDAzNzI4NjY4OkNwMTI1MjoxNzAzNjU3Nzg3MTIxOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Dec 2023 11:46:27
...
*----------------
    ...
    ID.VAR="email"
    CALL CACHE.READ(FN.INTERFACE.CONFIG.PRT,ID.VAR,R.INT.CONFIG,EMAILL.ERR);*R22 MANUAL CODE CONVERSION
...
* CALL F.READ(FN.REDO.NCF.ISSUED,NCF.ISSUE.ID,R.REDO.NCF.ISSUED,F.REDO.NCF.ISSUED,ISSUE.MSG)
    CALL F.READU(FN.REDO.NCF.ISSUED,NCF.ISSUE.ID,R.REDO.NCF.ISSUED,F.REDO.NCF.ISSUED,ISSUE.MSG,'');*R22 MANUAL CODE CONVERSION
...
* CALL F.READ(FN.REDO.L.NCF.STATUS,NCF.ISSUE.ID,R.REDO.L.NCF.STATUS,F.REDO.L.NCF.STATUS,STATUS.MSG)
    CALL F.READU(FN.REDO.L.NCF.STATUS,NCF.ISSUE.ID,R.REDO.L.NCF.STATUS,F.REDO.L.NCF.STATUS,STATUS.MSG,'');*R22 MANUAL CODE CONVERSION
...
*CALL F.READ(FN.REDO.L.NCF.UNMAPPED,NCF.ISSUE.ID,R.REDO.L.NCF.UNMAPPED,F.REDO.L.NCF.UNMAPPED,UNMAP.ERR)
    CALL F.READU(FN.REDO.L.NCF.UNMAPPED,NCF.ISSUE.ID,R.REDO.L.NCF.UNMAPPED,F.REDO.L.NCF.UNMAPPED,UNMAP.ERR,'');*R22 MANUAL CODE CONVERSION

* @ValidationCode : MjotMTYxNjI1ODI5ODpDcDEyNTI6MTcwMzY1MTU3NDAyMzphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Dec 2023 10:02:54
...
*14-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     VM TO @VM,SM TO @SM
...
*Y.CHQ.STATUS = R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.CHEQUE.STATUS,FLG>
        Y.CHQ.STATUS = R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.STATUS,FLG> ;*R22 MANUAL CONVERSION
...
* R.REDO.LOAN.FT.TT.TXN<LN.FT.TT.CHEQUE.STATUS> = 'PROCESSED'
    ...
    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,ID.VAR,R.REDO.APAP.CLEAR.PARAM,CLEAR.ERR)
...
*R22 MANUAL CONVERSION
        APAP.TAM.redoUpdFulChqRev(CK.ID)
        RETURN
    END
...
* PACS00146454 -S
    ...
    CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,ID.VAR1,R.REDO.H.AA.DIS.CHG,CHG.ERR)
...
*R22 MANUAL CONVERSION
    APAP.AA.redoUpdateChqReturnB10(Y.ARR.ID,CK.ID)

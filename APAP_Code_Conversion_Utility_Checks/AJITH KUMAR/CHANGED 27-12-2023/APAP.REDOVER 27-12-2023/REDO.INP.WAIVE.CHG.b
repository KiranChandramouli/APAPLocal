* @ValidationCode : MjoxOTI5MDQ1MjU5OkNwMTI1MjoxNzAzNjU0MDYxNDEzOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Dec 2023 10:44:21
...
*----------------------------------------------------------------------------
    ...
    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,ID.VAR,R.REDO.APAP.CLEAR.PARAM,PARAM.ERR)

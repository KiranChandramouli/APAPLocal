* @ValidationCode : MjotMzU1NjczOTQyOkNwMTI1MjoxNzAzNjU5NDc5NDc3OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Dec 2023 12:14:39
...
* CALL GET.LOC.REF(Y.APPL.1,Y.FIELD.1,Y.POS.1)
    EB.LocalReferences.GetLocRef(Y.APPL.1,Y.FIELD.1,Y.POS.1);*R22 MANUAL CODE CONVERSION

    Y.APPL.2 = 'TELLER'
    Y.FIELD.2 = 'L.TT.AZ.ACC.REF'
    Y.POS.2 = ''
* CALL GET.LOC.REF(Y.APPL.2,Y.FIELD.2,Y.POS.2)
    EB.LocalReferences.GetLocRef(Y.APPL.2,Y.FIELD.2,Y.POS.2);*R22 MANUAL CODE CONVERSION
...
*CALL F.READ(FN.ACCOUNT.CLOSURE,Y.ACCT,R.ACCOUNT.CLOSURE,F.ACCOUNT.CLOSURE,ACCOUNT.CLOSURE.ERR)
    CALL F.READU(FN.ACCOUNT.CLOSURE,Y.ACCT,R.ACCOUNT.CLOSURE,F.ACCOUNT.CLOSURE,ACCOUNT.CLOSURE.ERR,'');*R22 MANUAL CODE CONVERSION

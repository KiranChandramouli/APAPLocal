* @ValidationCode : MjoxNTQxMTUxMzA0OkNwMTI1MjoxNzAzMTM2MTI2NzI3OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 10:52:06
...
* CALL F.READ(FN.REDO.ADMIN.CHEQUE.DETAILS,Y.MAIN.ID,R.MAIN.TEMP.REC,F.REDO.ADMIN.CHEQUE.DETAILS,MA.TEM.ER)
            CALL F.READU(FN.REDO.ADMIN.CHEQUE.DETAILS,Y.MAIN.ID,R.MAIN.TEMP.REC,F.REDO.ADMIN.CHEQUE.DETAILS,MA.TEM.ER,'')

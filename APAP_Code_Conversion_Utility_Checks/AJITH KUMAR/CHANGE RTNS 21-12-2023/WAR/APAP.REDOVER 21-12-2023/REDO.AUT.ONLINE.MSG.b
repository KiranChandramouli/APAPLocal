* @ValidationCode : MjotMTgyODg0MDA1MTpDcDEyNTI6MTcwMzEzNjIzMDAyOTphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 10:53:50
...
*13-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     FM TO @FM,VM TO @VM,++ TO +=1,= TO EQ
...
*Opening Files
    ...
    LREF.APP = 'T24.FUND.SERVICES':@FM:'TELLER':@FM:'ACCOUNT' ;*R22 AUTO CONVERSION
    LREF.FIELDS = 'L.TT.NO.OF.CHQ':@VM:'L.FT.ADD.INFO':@FM:'L.TT.NO.OF.CHQ':@FM:'L.AC.TRAN.AVAIL' ;*R22 AUTO CONVERSION
    LOCAL.REF.POS = ''
...
*Writing the Values to a Concat File
        ...
        ID.VAR2 = 'REDO.RETRUN.FILE'
*CALL F.READ(FN.VAR.LOCKING,ID.VAR2,R.LOCKING,F.VAR.LOCKING,LOCK.ERR)
        CALL F.READU(FN.VAR.LOCKING,ID.VAR2,R.LOCKING,F.VAR.LOCKING,LOCK.ERR,'')
        ...
        ELSE
            ...
            END
        END
        CALL F.WRITE(FN.VAR.LOCKING,ID.VAR2,R.LOCKING)

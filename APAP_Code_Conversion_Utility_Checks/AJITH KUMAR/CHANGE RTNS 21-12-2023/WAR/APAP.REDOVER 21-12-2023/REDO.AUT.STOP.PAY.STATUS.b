* @ValidationCode : MjoyMDY0MzEwMjkyOkNwMTI1MjoxNzAzMTQwMjU0NjYwOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 12:00:54
...
*CALL F.READ(FN.PAYMENT.STOP.HIS,Y.ACC.ID.HIS,R.PAYMENT.STOP.HIS,F.PAYMENT.STOP.HIS,Y.ERR.HIS)
        CALL F.READU(FN.PAYMENT.STOP.HIS,Y.ACC.ID.HIS,R.PAYMENT.STOP.HIS,F.PAYMENT.STOP.HIS,Y.ERR.HIS,'');*R22 MANUAL CODE CONVERSION
...
*CALL F.READ(FN.PAYMENT.STOP,Y.AC.OGM.ID,R.PAYMENT.STOP,F.PAYMENT.STOP,Y.ERR)
        CALL F.READU(FN.PAYMENT.STOP,Y.AC.OGM.ID,R.PAYMENT.STOP,F.PAYMENT.STOP,Y.ERR,'')
        IF Y.ERR ELSE

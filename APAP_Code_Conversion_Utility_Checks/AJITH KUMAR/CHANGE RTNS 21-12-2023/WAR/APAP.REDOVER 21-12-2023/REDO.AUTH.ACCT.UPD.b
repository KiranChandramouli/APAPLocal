* @ValidationCode : MjotMzQxNjU0NTI1OkNwMTI1MjoxNzAzMTU1MzExNDQ1OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 16:11:51
...
*CALL F.READ(FN.ACCOUNT,Y.ACC.ID,R.ACCOUNT,F.ACCOUNT,ACC.ERR)
    CALL F.READU(FN.ACCOUNT,Y.ACC.ID,R.ACCOUNT,F.ACCOUNT,ACC.ERR,'') ;*R22 MANUAAL CODE CONVERSION
    IF R.ACCOUNT THEN
*PACS00303905 - S

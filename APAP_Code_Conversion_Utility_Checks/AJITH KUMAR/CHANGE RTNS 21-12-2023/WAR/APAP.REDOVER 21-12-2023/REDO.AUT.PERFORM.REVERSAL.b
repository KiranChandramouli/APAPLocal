* @ValidationCode : MjoxODY5MTc2NDAyOkNwMTI1MjoxNzAzMTM2MjU5MjQ4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 10:54:19
...
* 05-04-2023        MUTHUKUMAR M                  MANUAL R22 CODE CONVERSION        CALL routine format modified
...
*CALL F.READ(FN.ACCOUNT,ACCT.ID,R.ACCOUNT.CL,F.ACCOUNT,ACCT.ERR)
    CALL F.READU(FN.ACCOUNT,ACCT.ID,R.ACCOUNT.CL,F.ACCOUNT,ACCT.ERR,'')
...
*CALL F.READ(FN.REDO.INTRANSIT.CHQ,ACCT.ID,R.REDO.INTRANSIT.CHQ,F.REDO.INTRANSIT.CHQ,CHQ.ERR)
    CALL F.READU(FN.REDO.INTRANSIT.CHQ,ACCT.ID,R.REDO.INTRANSIT.CHQ,F.REDO.INTRANSIT.CHQ,CHQ.ERR,'')

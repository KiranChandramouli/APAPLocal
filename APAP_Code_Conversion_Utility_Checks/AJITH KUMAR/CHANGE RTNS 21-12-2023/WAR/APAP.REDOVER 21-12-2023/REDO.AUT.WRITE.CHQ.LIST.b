* @ValidationCode : MjotMTc1NzA2MjY2ODpDcDEyNTI6MTcwMzE1MDMxMjk0MDphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 14:48:32
...
*----------
    ...
    ID.VAR = 'SYSTEM'
    CALL CACHE.READ(FN.REDO.MANAGER.CHQ.PARAM,ID.VAR ,R.REDO.MANAGER.CHQ.PARAM, ADMIN.CHQ.ERR)
    CALL CACHE.READ(FN.REDO.ADMIN.CHQ.PARAM,ID.VAR,R.REDO.ADMIN.CHQ.PARAM,MGR.CHQ.ERR)
...
*
    ...
    PROCESS.GOAHEAD          = ""
*
    CALL CACHE.READ(FN.REDO.CHQ.PRNT.VERSIONS,ID.VAR,R.REDO.CHQ.PRNT.VERSIONS,ERR.PR.VRSN)
...
*
    ...
    ERR.MSG      = ''
    IN.AMT = Y.DEBIT.AMT
    APAP.TAM.redoConvertNumToWords(IN.AMT, OUT.AMT, LINE.LENGTH, NO.OF.LINES, ERR.MSG) ;*MANUAL R22 CODE CONVERSION

* @ValidationCode : Mjo0ODIzNDgwODM6Q3AxMjUyOjE3MDMxMzYwODEwNjg6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 21 Dec 2023 10:51:21
...
*CALL F.READ(FN.REDO.TEMP.VERSION.IDS,Y.TEMP.ID,R.REC.TEMP,F.REDO.TEMP.VERSION.IDS,ERR.TEMP)
    CALL F.READU(FN.REDO.TEMP.VERSION.IDS,Y.TEMP.ID,R.REC.TEMP,F.REDO.TEMP.VERSION.IDS,ERR.TEMP,'')
    IF R.REC.TEMP THEN

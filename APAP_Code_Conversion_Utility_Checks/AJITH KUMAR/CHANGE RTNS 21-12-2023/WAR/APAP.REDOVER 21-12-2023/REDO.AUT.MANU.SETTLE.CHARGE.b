* @ValidationCode : MjoxNjE1MDQ4Mjg1OkNwMTI1MjoxNzAzMTM2MTgxNzAzOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 10:53:01
...
*  CALL AA.GET.ARRANGEMENT.CONDITIONS(Y.ARR.ID,'TERM.AMOUNT','','',RET.VALS,RET.COND,RET.ERR)
    AA.Framework.GetArrangementConditions(Y.ARR.ID,'TERM.AMOUNT','','',RET.VALS,RET.COND,RET.ERR)

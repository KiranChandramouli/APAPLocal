* @ValidationCode : MjotNDA2ODEzNTU2OkNwMTI1MjoxNzAzMTYyMDU0NTg5OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 18:04:14
...
* CALL F.READ(FN.REDO.FI.LB.BPROC,ID.FILE,R.REDO.FI.LB.BPROC,F.REDO.FI.LB.BPROC,FILE.ERR)
    CALL F.READ(FN.REDO.FI.LB.BPROC,ID.FILE,R.REDO.FI.LB.BPROC,F.REDO.FI.LB.BPROC,FILE.ERR,'');*R22 MANUAL CODE CONVERSION

* @ValidationCode : MjoxMjE4ODUwNDE5OkNwMTI1MjoxNzAzMTQwNzA0MTc4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 12:08:24
...
********
    ...
    CALL CACHE.READ(FN.REDO.APAP.PARAM,ID.VAR,R.REDO.APAP.PARAM,PARAM.ERR)
    Y.EXP.DATE = ''

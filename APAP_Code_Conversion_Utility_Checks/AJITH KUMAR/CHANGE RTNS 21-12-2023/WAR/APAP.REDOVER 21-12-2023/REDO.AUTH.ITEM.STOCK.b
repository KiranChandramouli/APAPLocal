* @ValidationCode : MjotMTk5MTI5MzcwOkNwMTI1MjoxNzAzMTYyNzc1NzIzOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 18:16:15
...
* CALL F.READ(FN.REDO.ITEM.STOCK,Y.ID,R.REDO.ITEM.STOCK,F.REDO.ITEM.STOCK,STOCK.ERR)
    CALL F.READ(FN.REDO.ITEM.STOCK,Y.ID,R.REDO.ITEM.STOCK,F.REDO.ITEM.STOCK,STOCK.ERR,'');*R22 MANUAL CODE CONVERSION

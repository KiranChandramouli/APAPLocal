* @ValidationCode : MjoyMDM0NzQ0OTU4OkNwMTI1MjoxNzAzMTQxOTcwNzEwOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 12:29:30
...
*CALL F.READ(FN.LCO,LATAM.CARD.ID,R.LCO,F.LCO,LCO.ERR)
        CALL F.READU(FN.LCO,LATAM.CARD.ID,R.LCO,F.LCO,LCO.ERR,'')

* @ValidationCode : MjoxMjgxMzc5ODpDcDEyNTI6MTcwMjkwMjgxODYwNDphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 18 Dec 2023 18:03:38
...
*YFIRST.BILLDTE = R.AA.ACCOUNT.DETAILS<AA.AD.BILL.PAY.DATE,1>
    YFIRST.BILLDTE = R.AA.ACCOUNT.DETAILS<AA.PaymentSchedule.AccountDetails.AdBillPayDate,1>
...
* Y.LAST.PART.AMT = SUM(R.AA.BILL.DETAILS<AA.BD.OS.PROP.AMOUNT>)* (Y.PARTIAL/100)
                Y.LAST.PART.AMT = SUM(R.AA.BILL.DETAILS<AA.PaymentSchedule.BillDetails.BdPosPropAmount>)* (Y.PARTIAL/100)
...
*CALL F.READ(FN.AA.ACCOUNT.DETAILS,VAR.AA.ID,R.AA.ACCOUNT.DETAILS,F.AA.ACCOUNT.DETAILS,AA.AC.ERR)
    R.AA.BILL.DETAILS = AA.PaymentSchedule.BillDetails.Read(VAR.AA.ID, AA.AC.ERR)

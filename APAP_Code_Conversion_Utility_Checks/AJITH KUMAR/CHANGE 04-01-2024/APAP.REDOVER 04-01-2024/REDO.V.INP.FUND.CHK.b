* @ValidationCode : MjotMTczMjA0NDcwNzpDcDEyNTI6MTcwNDM2NTE2ODU2Njphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:16:08
...
*CALL F.READ(FN.REDO.MTS.DISBURSE,Y.MTS.ID,R.REDO.MTS.DISBURSE,F.REDO.MTS.DISBURSE,DISB.ERR)
            CALL F.READU(FN.REDO.MTS.DISBURSE,Y.MTS.ID,R.REDO.MTS.DISBURSE,F.REDO.MTS.DISBURSE,DISB.ERR,'');* R22 AUTO CONVERSION
...
*CALL F.READ(FN.REDO.MTS.DISBURSE,VAR.MTS.ID,R.REDO.MTS.DISBURSE,F.REDO.MTS.DISBURSE,DISB.ERR)
        CALL F.READU(FN.REDO.MTS.DISBURSE,VAR.MTS.ID,R.REDO.MTS.DISBURSE,F.REDO.MTS.DISBURSE,DISB.ERR,'');* R22 AUTO CONVERSION

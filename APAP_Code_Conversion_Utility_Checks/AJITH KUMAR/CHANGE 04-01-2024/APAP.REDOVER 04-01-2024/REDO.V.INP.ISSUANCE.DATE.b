* @ValidationCode : MjoxMTc1NTQyOTIzOkNwMTI1MjoxNzA0MzY1MjA3NzQ3OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:16:47
...
*CALL F.READ(FN.REDO.CHQ.VALID,'CONFIRMED',R.CHQ.VAL,F.REDO.CHQ.VALID,ERR.REDO)
            IDVAR.1 = 'CONFIRMED' ;* R22 AUTO CONVERSION
            CALL F.READ(FN.REDO.CHQ.VALID,IDVAR.1,R.CHQ.VAL,F.REDO.CHQ.VALID,ERR.REDO);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.REDO.CHQ.VALID,'NONCONFIRMED',R.CHQ.VAL,F.REDO.CHQ.VALID,ERR.REDO)
                IDVAR.1 = 'NONCONFIRMED' ;* R22 AUTO CONVERSION
                CALL F.READ(FN.REDO.CHQ.VALID,IDVAR.1,R.CHQ.VAL,F.REDO.CHQ.VALID,ERR.REDO);* R22 AUTO CONVERSION

* @ValidationCode : MjotODU1NDgzOTMxOkNwMTI1MjoxNzA0MzY4NzE0NTc4OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:15:14
...
*CALL F.READ(FN.CUST.CLAIMS,Y.VAR.ID,R.CLAIMS,F.CUST.CLAIMS,ERR)
    CALL F.READU(FN.CUST.CLAIMS,Y.VAR.ID,R.CLAIMS,F.CUST.CLAIMS,ERR,'');* R22 AUTO CONVERSION
    Y.VAR.CUS.NO=1
    IF R.CLAIMS THEN

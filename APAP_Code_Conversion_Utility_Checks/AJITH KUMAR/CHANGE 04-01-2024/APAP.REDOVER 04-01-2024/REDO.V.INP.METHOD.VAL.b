* @ValidationCode : MjotNzMzNDg2OTg1OkNwMTI1MjoxNzA0MzY1MzM0NzcxOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:18:54
...
*CALL CACHE.READ(FN.MULTI.BRANCH.INTERNAL.ACCOUNT,'SYSTEM',R.MULTI.BRANCH,MULTI.ERR)
        ...
        CALL CACHE.READ(FN.MULTI.BRANCH.INTERNAL.ACCOUNT,IDVAR.1,R.MULTI.BRANCH,MULTI.ERR);* R22 AUTO CONVERSION

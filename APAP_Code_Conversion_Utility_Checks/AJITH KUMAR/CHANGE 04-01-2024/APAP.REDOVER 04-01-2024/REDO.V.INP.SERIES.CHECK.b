* @ValidationCode : Mjo5Mjk4OTg2NTM6Q3AxMjUyOjE3MDQzNjg2MTY0MDk6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:13:36
...
*CALL CACHE.READ(FN.REDO.H.INVENTORY.PARAMETER,'SYSTEM',R.REDO.H.INVENTORY.PARAMETER,Y.ERR.INV)
    ...
    CALL CACHE.READ(FN.REDO.H.INVENTORY.PARAMETER,IDVAR.1,R.REDO.H.INVENTORY.PARAMETER,Y.ERR.INV);* R22 AUTO CONVERSION

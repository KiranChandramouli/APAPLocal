* @ValidationCode : MjotMzc3ODUyMzc4OkNwMTI1MjoxNjg0MTI5MTc3ODU0OklUU1M6LTE6LTE6MTM5OjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 May 2023 11:09:37
...
SUBROUTINE REDO.S.FC.VI.EXPOSICION.T.GRUPO.R(AA.ID,VI.ARR)

*
* Subroutine Type : ROUTINE
* Attached to     : ROUTINE REDO.FC.ENQPARMS
* Attached as     : ROUTINE
* Primary Purpose : Get the sum of customer operations and members of the group BY risk group
*
* Incoming:
* ---------
*
...
*14-12-2023      Victoria S          R22 Manual code conversion   Add call routine prefix
...
*CALL OFS.CALL.BULK.MANAGER("AC.EXPECTED.RECS",Y.MESSAGE.ACC, OFS.RESP, TXN.COMMIT) ;* R22 Manual conversion - End
    EB.Interface.OfsCallBulkManager("AC.EXPECTED.RECS",Y.MESSAGE.ACC, OFS.RESP, TXN.COMMIT) ;*R22 Manual conversion -call routine modified
...
*=========
    ...
    FOR Y.I = 1 TO Y.COUNT.DATA
        ...
        Y.TYPE.LIMIT=FIELD(DATA.ENQ,@VM,Y.I)
        Y.TYPE.LIMIT=FIELD(Y.TYPE.LIMIT,"*","1")

        VI.ARR := Y.TYPE.LIMIT:" ":Y.TOT.TOM:"_"

* @ValidationCode : MjoxOTMxNTk4MTM3OkNwMTI1MjoxNjgyNDE1MTM3MTMwOklUU1M6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
*14-12-2023      Victoria S          R22 Manual code conversion   OPF ADDED
...
*---------------------------------------------------------------------------------------------
    ...
    FN.ACCOUNT.HIS="ACCOUNT$HIS" ;*R22 MANUAL CONVERSION START
    F.ACCOUNT.HIS=""
    CALL OPF(FN.ACCOUNT.HIS,F.ACCOUNT.HIS)
    FN.ACCT.ACTIVITY="ACCT.ACTIVITY"
    F.ACCT.ACTIVITY=""
    CALL OPF(FN.ACCT.ACTIVITY,F.ACCT.ACTIVITY)
    FN.CUSTOMER="CUSTOMER"
    F.CUSTOMER=""
    CALL OPF(FN.CUSTOMER,F.CUSTOMER) ;*R22 MANUAL CONVERSION END
    CHK.VAL = 0
    BEGIN CASE
        CASE EVENT EQ 1

* @ValidationCode : MjotMTQ1MzIwMjU3MjpDcDEyNTI6MTY4NDEyNTg5OTI3MTpJVFNTOi0xOi0xOjEzODoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 May 2023 10:14:59
...
SUBROUTINE REDO.S.FC.VI.DISPONIB.VINC(AA.ID,VI.ARR)

*
* Subroutine Type : ROUTINE
* Attached to     : ROUTINE REDO.FC.ENQPARMS
* Attached as     : ROUTINE
* Primary Purpose : Get the limit value minus of the value taken by group linked
*
* Incoming:
* ---------
*
...
*14-12-2023      Victoria S          R22 Manual code conversion   CALL method format modified

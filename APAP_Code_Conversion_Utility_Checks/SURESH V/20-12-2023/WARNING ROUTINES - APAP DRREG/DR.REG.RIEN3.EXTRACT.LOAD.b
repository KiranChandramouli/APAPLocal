* @ValidationCode : MjotMTI0OTY4NDE1MTpDcDEyNTI6MTcwMjUzMjA5NjEzNTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 14 Dec 2023 11:04:56
...
*  CALL F.READ(FN.DR.REG.RIEN3.PARAM,'SYSTEM',R.DR.REG.RIEN3.PARAM,F.DR.REG.RIEN3.PARAM,DR.REG.RIEN3.PARAM.ERR) ;*Tus Start
    ...
    CALL CACHE.READ(FN.DR.REG.RIEN3.PARAM,IDVAR,R.DR.REG.RIEN3.PARAM,DR.REG.RIEN3.PARAM.ERR) ; * Tus End   ;*R22 Manual Conversion

* @ValidationCode : MjotOTg4MDcxMjU4OkNwMTI1MjoxNzA0NzkxNTI4NTAwOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 09 Jan 2024 14:42:08
...
*18/01/2024         Suresh                 R22 UTILITY AUTO CONVERSION   CALL routine Modified, Change F.READ to CACHE.READ
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $USING EB.Service
...
*    CALL EB.CLEAR.FILE(Y.FILE.NAME,F.REDO.CCRG.RL.REL.CUS)
    EB.Service.ClearFile(Y.FILE.NAME,F.REDO.CCRG.RL.REL.CUS);* R22 UTILITY AUTO CONVERSION
*
RETURN
*
* ===================
...
*        CALL F.READ(FN.REDO.CCRG.RISK.LIMIT.PARAM,Y.RL.ID,R.REDO.CCRG.RISK.LIMIT.PARAM,F.REDO.CCRG.RISK.LIMIT.PARAM,Y.ERR)
        CALL CACHE.READ(FN.REDO.CCRG.RISK.LIMIT.PARAM,Y.RL.ID,R.REDO.CCRG.RISK.LIMIT.PARAM,Y.ERR);* R22 UTILITY AUTO CONVERSION
...
*
    ...
    APAP.REDOBATCH.redoCcrgBTraceError(R.SOURCE.INFO, Y.MSG.ERR, @FALSE, Y.CUSTOMER.ID, @TRUE) ;*R22 MANUAL CONVERSTION ADDING PACKAGE TO CALL ROUTINE

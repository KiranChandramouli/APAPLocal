* @ValidationCode : MjotMTkwMDQ3MTExNTpDcDEyNTI6MTcwMzY3MzEwMDcwNDozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Dec 2023 16:01:40
...
*26/12/2023         Suresh                R22 Manual Conversion  - Change F.READ to F.READU, IDVAR Variable Changed
*------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_F.USER
    $INSERT I_EQUATE
...
*    CALL F.READ(FN.REDO.ACH.PROCESS,Y.ID.TEMP,R.REDO.ACH.PROCESS,F.REDO.ACH.PROCESS,ACH.ERR)
    CALL F.READU(FN.REDO.ACH.PROCESS,Y.ID.TEMP,R.REDO.ACH.PROCESS,F.REDO.ACH.PROCESS,ACH.ERR,"") ;*R22 Manual Conversion
...
*   CALL F.READ(FN.REDO.ACH.PROCESS.DET,FETCH.ID,R.REDO.ACH.PROCESS.DET,F.REDO.ACH.PROCESS.DET,Y.ERR.ACH.PROCESS)
    CALL F.READU(FN.REDO.ACH.PROCESS.DET,FETCH.ID,R.REDO.ACH.PROCESS.DET,F.REDO.ACH.PROCESS.DET,Y.ERR.ACH.PROCESS,"") ;*R22 Manual Conversion

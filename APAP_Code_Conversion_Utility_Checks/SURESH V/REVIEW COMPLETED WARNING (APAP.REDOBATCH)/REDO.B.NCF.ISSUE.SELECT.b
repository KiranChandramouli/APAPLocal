* @ValidationCode : MjotMjA3MTk2NTI0MDpDcDEyNTI6MTcwNDM2ODU0OTU0OTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:12:29
...
*CALL BATCH.BUILD.LIST('',VAR.TXN.ACCT.LIST)
    EB.Service.BatchBuildList('',VAR.TXN.ACCT.LIST) ;* R22 AUTO CONVERSION
RETURN
END

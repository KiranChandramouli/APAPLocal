* @ValidationCode : Mjo1ODM2NzAyMjI6Q3AxMjUyOjE3MDQ3MTM5NjMyMjc6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 08 Jan 2024 17:09:23
...
*    CALL F.READ(FN.REDO.ACCT.MRKWOF.HIST,ARR.ID,R.REDO.ACCT.MRKWOF.HIST,F.REDO.ACCT.MRKWOF.HIST,WOF.ERR)
    CALL F.READU(FN.REDO.ACCT.MRKWOF.HIST,ARR.ID,R.REDO.ACCT.MRKWOF.HIST,F.REDO.ACCT.MRKWOF.HIST,WOF.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.AA.ARRANGEMENT,ARR.ID,R.AA.ARR,F.AA.ARRANGEMENT,AA.ERR)
    R.AA.ARR =AA.Framework.Arrangement.Read(ARR.ID, AA.ERR) ;*R22 Manual Conversion
...
*    CALL AA.GET.PERIOD.BALANCES(Y.AC.ID, BAL.TYPES, REQUEST.TYPE, START.DATE, END.DATE, SYSTEM.DATE, BAL.DETAILS, ERROR.MESSAGE)
    AA.Framework.GetPeriodBalances(Y.AC.ID, BAL.TYPES, REQUEST.TYPE, START.DATE, END.DATE, SYSTEM.DATE, BAL.DETAILS, ERROR.MESSAGE);* R22 UTILITY AUTO CONVERSION
...
*        CALL AA.GET.PERIOD.BALANCES(Y.AC.ID, BALANCE.TO.CHECK, DATE.OPTIONS, EFFECTIVE.DATE, "", "", BAL.DETAILS, "")
        AA.Framework.GetPeriodBalances(Y.AC.ID, BALANCE.TO.CHECK, DATE.OPTIONS, EFFECTIVE.DATE, "", "", BAL.DETAILS, "");* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxMTk1OTc5NDk0OkNwMTI1MjoxNzA0MjY4NDQ0NDM4OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 Jan 2024 13:24:04
...
*    CALL CACHE.READ(FN.REDO.LY.MASTERPRGDR,'SYSTEM',R.REDO.LY.MASTERPRGDR,MAS.ERR) ; * Tus End
    ...
    CALL CACHE.READ(FN.REDO.LY.MASTERPRGDR,IDVAR,R.REDO.LY.MASTERPRGDR,MAS.ERR) ; * Tus End ;*R22 Manual Conversion

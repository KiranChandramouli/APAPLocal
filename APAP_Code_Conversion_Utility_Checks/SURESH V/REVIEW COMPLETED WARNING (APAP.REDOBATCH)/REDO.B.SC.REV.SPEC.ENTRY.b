* @ValidationCode : MjotMTY3MDQyNTg5ODpDcDEyNTI6MTcwNDQzOTM4ODc3MTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jan 2024 12:53:08
...
*    CALL EB.ACCOUNTING("SC","SAO",Y.COMMON.ARRAY,'')
    AC.API.EbAccounting("SC","SAO",Y.COMMON.ARRAY,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.REDO.APAP.L.CONTRACT.BALANCES,Y.SEC.TRADE.ID,R.REDO.APAP.L.CONTRACT.BALANCES,F.REDO.APAP.L.CONTRACT.BALANCES,E.REDO.APAP.L.CONTRACT.BALANCES)
    CALL F.READU(FN.REDO.APAP.L.CONTRACT.BALANCES,Y.SEC.TRADE.ID,R.REDO.APAP.L.CONTRACT.BALANCES,F.REDO.APAP.L.CONTRACT.BALANCES,E.REDO.APAP.L.CONTRACT.BALANCES,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxMjI0OTkzNTYxOkNwMTI1MjoxNzA0MzcwNzcyMjI4OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:49:32
...
*18/12/2023        Suresh           R22 AUTO Conversion  -CALL routine modified, Change F.READ to F.READU
*-----------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*CALL F.READ(FN.REDO.NEW.WORK.INT.CAP.OS,Y.ID,R.REDO.NEW.WORK.INT.CAP.OS,F.REDO.NEW.WORK.INT.CAP.OS,CAP.OS.ERR)
    CALL F.READU(FN.REDO.NEW.WORK.INT.CAP.OS,Y.ID,R.REDO.NEW.WORK.INT.CAP.OS,F.REDO.NEW.WORK.INT.CAP.OS,CAP.OS.ERR,'');* R22 AUTO CONVERSION
...
*CALL F.READ(FN.REDO.CONCAT.ACC.WOF,Y.LOAN.ACC,R.REDO.CONCAT.ACC.WOF,F.REDO.CONCAT.ACC.WOF,CON.ERR)
    CALL F.READU(FN.REDO.CONCAT.ACC.WOF,Y.LOAN.ACC,R.REDO.CONCAT.ACC.WOF,F.REDO.CONCAT.ACC.WOF,CON.ERR,'');* R22 AUTO CONVERSION

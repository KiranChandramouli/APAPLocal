* @ValidationCode : MjotMTAwNDI2NDQwMzpDcDEyNTI6MTcwNDI3NjkxMTcxMTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 Jan 2024 15:45:11
...
*CALL F.READ(FN.REDO.AA.REPAY,VAR.ARRANGE.ID,R.REDO.AA.REPAY,F.REDO.AA.REPAY,REP.ERR)
    CALL F.READU(FN.REDO.AA.REPAY,VAR.ARRANGE.ID,R.REDO.AA.REPAY,F.REDO.AA.REPAY,REP.ERR,'');* R22 AUTO CONVERSION
...
*CALL F.RELEASE(FN.REDO.L.NCF.STOCK,'SYSTEM',F.REDO.L.NCF.STOCK)
        ...
        CALL F.RELEASE(FN.REDO.L.NCF.STOCK,IDVAR,F.REDO.L.NCF.STOCK) ;*R22 Manual Conversion
...
*    CALL F.READU(FN.REDO.L.NCF.STOCK,'SYSTEM',R.NCF.STOCK,F.REDO.L.NCF.STOCK,ST.ERR,'')
    IDVAR='SYSTEM' ;*R22 Manual Conversion
    CALL F.READU(FN.REDO.L.NCF.STOCK,IDVAR,R.NCF.STOCK,F.REDO.L.NCF.STOCK,ST.ERR,'') ;*R22 Manual Conversion

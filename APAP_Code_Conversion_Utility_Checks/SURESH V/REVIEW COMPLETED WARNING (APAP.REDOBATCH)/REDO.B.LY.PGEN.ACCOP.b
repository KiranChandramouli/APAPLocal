* @ValidationCode : MjoxMzk5NTU3NDYxOkNwMTI1MjoxNzA0MjU5MDc0MjUxOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 Jan 2024 10:47:54
...
*18/01/2024         Suresh                R22 AUTO Conversion  CALL routine Modified, IDVAR Variable Changed
*----------------------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.CUSTOMER
...
*CALL F.READ(FN.REDO.LY.POINTS,CUS.ID,R.REDO.LY.POINTS,F.REDO.LY.POINTS,RLP.ERR)
    CALL F.READU(FN.REDO.LY.POINTS,CUS.ID,R.REDO.LY.POINTS,F.REDO.LY.POINTS,RLP.ERR,'');* R22 AUTO CONVERSION
    GOSUB ASSIGN.AUDIT
...
*CALL CACHE.READ(FN.REDO.LY.MASTERPRGDR,'SYSTEM',R.REDO.LY.MASTERPRGDR,MAS.ERR) ; * Tus End
    ...
    CALL CACHE.READ(FN.REDO.LY.MASTERPRGDR,IDVAR.1,R.REDO.LY.MASTERPRGDR,MAS.ERR) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.READ(FN.REDO.LY.POINTS.TOT,TOT.POINTS.ID,R.REDO.LY.POINTS.TOT,F.REDO.LY.POINTS.TOT,TOT.ERR)
    CALL F.READU(FN.REDO.LY.POINTS.TOT,TOT.POINTS.ID,R.REDO.LY.POINTS.TOT,F.REDO.LY.POINTS.TOT,TOT.ERR,'');* R22 AUTO CONVERSION
    GOSUB UPD.PROCESS
...
*    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,'VAR.T.GEN',VAR.T.GEN,F.TEMP.LY.PGEN.ACCOP,VAR.T.GEN.ERR,RETRY.VAR)
    IDVAR='VAR.T.GEN' ;*R22 Manual Conversion
    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,IDVAR,VAR.T.GEN,F.TEMP.LY.PGEN.ACCOP,VAR.T.GEN.ERR,RETRY.VAR) ;*R22 Manual Conversion
...
*    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,'VAR.T.GEN.VALUE',VAR.T.GEN.VALUE,F.TEMP.LY.PGEN.ACCOP,VAR.T.GEN.VALUE.ERR,RETRY.VAR)
    IDVAR='VAR.T.GEN.VALUE' ;*R22 Manual Conversion
    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,IDVAR,VAR.T.GEN.VALUE,F.TEMP.LY.PGEN.ACCOP,VAR.T.GEN.VALUE.ERR,RETRY.VAR) ;*R22 Manual Conversion
...
*    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,'VAR.T.AVAIL',VAR.T.AVAIL,F.TEMP.LY.PGEN.ACCOP,VAR.T.AVAIL.ERR,RETRY.VAR)
    IDVAR='VAR.T.AVAIL' ;*R22 Manual Conversion
    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,IDVAR,VAR.T.AVAIL,F.TEMP.LY.PGEN.ACCOP,VAR.T.AVAIL.ERR,RETRY.VAR) ;*R22 Manual Conversion
...
*    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,'VAR.T.AVAIL.VALUE',VAR.T.AVAIL.VALUE,F.TEMP.LY.PGEN.ACCOP,VAR.T.AVAIL.VALUE.ERR,RETRY.VAR)
    IDVAR='VAR.T.AVAIL.VALUE' ;*R22 Manual Conversion
*    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,'VAR.T.AVAIL.VALUE',VAR.T.AVAIL.VALUE,F.TEMP.LY.PGEN.ACCOP,VAR.T.AVAIL.VALUE.ERR,RETRY.VAR) ;*R22 Manual Conversion
IDVAR.1 = 'VAR.T.AVAIL.VALUE' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,VAR.T.AVAIL.VALUE,F.TEMP.LY.PGEN.ACCOP,VAR.T.AVAIL.VALUE.ERR,RETRY.VAR) ;*R22 Manual Conversion;* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,'VAR.T.NAVAIL',VAR.T.NAVAIL,F.TEMP.LY.PGEN.ACCOP,VAR.T.NAVAIL.ERR,RETRY.VAR)
    IDVAR='VAR.T.NAVAIL' ;*R22 Manual Conversion
    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,IDVAR,VAR.T.NAVAIL,F.TEMP.LY.PGEN.ACCOP,VAR.T.NAVAIL.ERR,RETRY.VAR) ;*R22 Manual Conversion
...
*    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,'VAR.T.NAVAIL.VALUE',VAR.T.NAVAIL.VALUE,F.TEMP.LY.PGEN.ACCOP,VAR.T.NAVAIL.VALUE.ERR,RETRY.VAR)
    IDVAR='VAR.T.NAVAIL.VALUE' ;*R22 Manual Conversion
    CALL F.READU(FN.TEMP.LY.PGEN.ACCOP,IDVAR,VAR.T.NAVAIL.VALUE,F.TEMP.LY.PGEN.ACCOP,VAR.T.NAVAIL.VALUE.ERR,RETRY.VAR) ;*R22 Manual Conversion

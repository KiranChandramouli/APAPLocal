* @ValidationCode : MjotNTA3NTc2NTYxOkNwMTI1MjoxNzA0NDQxNjM2OTIwOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:30:36
...
*        CALL F.READ(FN.REDO.UPD.ACC.LIST,Y.ID,R.REDO.UPD.ACC.LIST,F.REDO.UPD.ACC.LIST,Y.ERR.R)
        CALL F.READU(FN.REDO.UPD.ACC.LIST,Y.ID,R.REDO.UPD.ACC.LIST,F.REDO.UPD.ACC.LIST,Y.ERR.R,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.DATES,'DO0010001',R.DATE,F.DATES,DAT.ERR)
        ...
        CALL F.READ(FN.DATES,IDVAR.1,R.DATE,F.DATES,DAT.ERR);* R22 UTILITY AUTO CONVERSION

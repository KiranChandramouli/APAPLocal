* @ValidationCode : MjotMzAwODY2ODQzOkNwMTI1MjoxNzA0MTk1MDQ2MjA5OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 02 Jan 2024 17:00:46
...
*    $INSERT I_F.AA.SCHEDULED.ACTIVITY ;*R22 Manual Conversion - Start
    $USING AC.API
    $USING AA.Framework
...
*CALL F.READ(FN.REDO.AA.NAB.HISTORY,ARR.ID,R.REDO.AA.NAB.HISTORY,F.REDO.AA.NAB.HISTORY,NAB.ERR)
    CALL F.READU(FN.REDO.AA.NAB.HISTORY,ARR.ID,R.REDO.AA.NAB.HISTORY,F.REDO.AA.NAB.HISTORY,NAB.ERR,'');* R22 AUTO CONVERSION
...
*CALL F.READ(FN.AA.ARRANGEMENT,ARR.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,ARR.ERR)
    R.AA.ARRANGEMENT= AA.Framework.Arrangement.Read(ARR.ID,ARR.ERR) ;*R22 Manual Conversion
*    ARR.ACCOUNT.ID = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID>
    ARR.ACCOUNT.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId> AA.Framework.ArrangementSim.ArrLinkedApplId ;*R22 Manual Conversion
...
*    FINDSTR 'LENDING-MAKEDUE-REPAYMENT.SCHEDULE' IN R.AA.SCH.ACT<AA.SCH.ACTIVITY.NAME,1> SETTING POS.NEX THEN
    FINDSTR 'LENDING-MAKEDUE-REPAYMENT.SCHEDULE' IN R.AA.SCH.ACT<AA.Framework.ScheduledActivity.SchActivityName,1> SETTING POS.NEX THEN ;*R22 Manual Conversion
*        Y.NEX.BL.DATE = R.AA.SCH.ACT<AA.SCH.NEXT.DATE,POS.NEX>
        Y.NEX.BL.DATE = R.AA.SCH.ACT<AA.Framework.ScheduledActivity.SchNextDate,POS.NEX> ;*R22 Manual Conversion
    END ELSE
...
*    Y.LOAN.ACC = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID>
    Y.LOAN.ACC = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId> ;*R22 Manual Conversion
...
*CALL F.READ(FN.REDO.CONCAT.ACC.NAB,Y.LOAN.ACC,R.REDO.CONCAT.ACC.NAB,F.REDO.CONCAT.ACC.NAB,CNCT.ERR)
    CALL F.READU(FN.REDO.CONCAT.ACC.NAB,Y.LOAN.ACC,R.REDO.CONCAT.ACC.NAB,F.REDO.CONCAT.ACC.NAB,CNCT.ERR,'');* R22 AUTO CONVERSION
...
*CALL EB.ACCOUNTING(ACC.PRODUCT,ACC.TYPE,R.STMT.ENTRY,'')  ;* Raise accounting for Consolidated
    AC.API.EbAccounting(ACC.PRODUCT,ACC.TYPE,R.STMT.ENTRY,'')  ;* Raise accounting for Consolidated;* R22 AUTO CONVERSION

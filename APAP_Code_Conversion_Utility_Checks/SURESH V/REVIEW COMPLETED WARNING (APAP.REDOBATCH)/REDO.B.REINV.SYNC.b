...
*    CALL F.READ(FN.AZACCOUNT,Y.AZ.ACCOUNT.ID,R.AZACCOUNT,F.AZACCOUNT,AZ.ACC.ERR)
    CALL F.READU(FN.AZACCOUNT,Y.AZ.ACCOUNT.ID,R.AZACCOUNT,F.AZACCOUNT,AZ.ACC.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.ACCOUNT,Y.AZ.ACCOUNT.ID,R.AZ.BASE.ACC,F.ACCOUNT,ACC.ERR)
    CALL F.READU(FN.ACCOUNT,Y.AZ.ACCOUNT.ID,R.AZ.BASE.ACC,F.ACCOUNT,ACC.ERR,'');* R22 UTILITY AUTO CONVERSION
*    CALL F.READ(FN.ACCOUNT,Y.INT.LIQ.ACC,R.INT.LIQ.ACC,F.ACCOUNT,ACC.ERR)
    CALL F.READU(FN.ACCOUNT,Y.INT.LIQ.ACC,R.INT.LIQ.ACC,F.ACCOUNT,ACC.ERR,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotMTMxMjcxMDc0NzpDcDEyNTI6MTcwNDQzMTk3NDkxMjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jan 2024 10:49:34
...
*    CALL F.READ(FN.REDO.WORK.INT.CAP.AMT.RP,GR.ID,R.REDO.WORK.INT.CAP.AMT.RP,F.REDO.WORK.INT.CAP.AMT.RP,WOR.ERR)
    CALL F.READU(FN.REDO.WORK.INT.CAP.AMT.RP,GR.ID,R.REDO.WORK.INT.CAP.AMT.RP,F.REDO.WORK.INT.CAP.AMT.RP,WOR.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.ACCOUNT,DR.ACCOUNT.NUMBER,R.ACCOUNT,F.ACCOUNT,ACC.ERR)
    CALL F.READU(FN.ACCOUNT,DR.ACCOUNT.NUMBER,R.ACCOUNT,F.ACCOUNT,ACC.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.AA.ARRANGEMENT,Y.AR.ID,R.AA.ARR,F.AA.ARRANGEMENT,AA.ERR)
        R.AA.ARR = AA.Framework.Arrangement.Read(Y.AR.ID, AA.ERR) ;*R22 Manual Conversion
        R.REDO.GET.REPAID.DATE = ''
*        CALL F.READ(FN.REDO.GET.REPAID.DATE,Y.AR.ID,R.REDO.GET.REPAID.DATE,F.REDO.GET.REPAID.DATE,DTE.ERR)
        CALL F.READU(FN.REDO.GET.REPAID.DATE,Y.AR.ID,R.REDO.GET.REPAID.DATE,F.REDO.GET.REPAID.DATE,DTE.ERR,'');* R22 UTILITY AUTO CONVERSION
*        Y.AC.ID = R.AA.ARR<AA.ARR.LINKED.APPL.ID>
        Y.AC.ID = R.AA.ARR<AA.Framework.ArrangementSim.ArrLinkedApplId> ;*R22 Manual Conversion
        GOSUB CAL.PL.AMT
...
*        CALL F.READ(FN.REDO.ACCT.MRKWOF.HIST,Y.AR.ID,R.REDO.ACCT.MRKWOF.HIST,F.REDO.ACCT.MRKWOF.HIST,MRKWOF.ERR)
        CALL F.READU(FN.REDO.ACCT.MRKWOF.HIST,Y.AR.ID,R.REDO.ACCT.MRKWOF.HIST,F.REDO.ACCT.MRKWOF.HIST,MRKWOF.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.REDO.WORK.PAID.PL,Y.AR.ID,R.REDO.WORK.PAID.PL,F.REDO.WORK.PAID.PL,PL.ERR)
        CALL F.READU(FN.REDO.WORK.PAID.PL,Y.AR.ID,R.REDO.WORK.PAID.PL,F.REDO.WORK.PAID.PL,PL.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.REDO.ACCT.MRKWOF.HIST,Y.AR.ID,R.REDO.ACCT.MRKWOF.HIST,F.REDO.ACCT.MRKWOF.HIST,WOF.ERR)
        CALL F.READU(FN.REDO.ACCT.MRKWOF.HIST,Y.AR.ID,R.REDO.ACCT.MRKWOF.HIST,F.REDO.ACCT.MRKWOF.HIST,WOF.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL EB.ACCOUNTING(ACC.PRODUCT,ACC.TYPE,R.STMT.ENTRY,'')
    AC.API.EbAccounting(ACC.PRODUCT,ACC.TYPE,R.STMT.ENTRY,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxNzU0MjUxOTI0OkNwMTI1MjoxNzA0MTc2ODk2ODQzOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 02 Jan 2024 11:58:16
...
*-----------------------------------------------------------------------------------------------
    ...
    EFF.DATE = ''
    Y.RES.FALG.UPD = ''
    APAP.AA.redoCrrGetConditions(Y.ARRANGEMENT.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG);*Manual R22 conversion
...
* BILL.FLAG = 1
    ...
    END ELSE
*        CALL F.READ(FN.REDO.AA.LOAN.UPD.STATUS,ARR.ID,R.REDO.AA.LOAN.UPD.STATUS,F.REDO.AA.LOAN.UPD.STATUS,Y.ER.AR)
        CALL F.READU(FN.REDO.AA.LOAN.UPD.STATUS,ARR.ID,R.REDO.AA.LOAN.UPD.STATUS,F.REDO.AA.LOAN.UPD.STATUS,Y.ER.AR,"") ;*R22 Manual Conversion
...
*APAP.AA.REDO.GET.PROPERTY.NAME(Y.ARRANGEMENT.ID,IN.PROPERTY.CLASS,R.OUT.AA.RECORD,OD.PROPERTY,OUT.ERR);*Manual R22 conversion
    APAP.TAM.redoGetPropertyName(Y.ARRANGEMENT.ID,IN.PROPERTY.CLASS,R.OUT.AA.RECORD,OD.PROPERTY,OUT.ERR);*Manual R22 conversion(inAaId, inPropertyClass, rOutAaRecord, outProperty, outErr)
RETURN
END

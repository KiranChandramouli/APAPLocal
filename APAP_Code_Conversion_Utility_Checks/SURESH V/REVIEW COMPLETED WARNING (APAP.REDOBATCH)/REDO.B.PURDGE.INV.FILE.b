* @ValidationCode : MjotMTEyMzU1MjE3NzpDcDEyNTI6MTcwNDQyOTcwNTk3OTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jan 2024 10:11:45
...
*        CALL F.READ(FN.REDO.ITEM.SERIES,Y.ID,R.REDO.ITEM.SERIES,F.REDO.ITEM.SERIES,Y.ER)
        CALL F.READU(FN.REDO.ITEM.SERIES,Y.ID,R.REDO.ITEM.SERIES,F.REDO.ITEM.SERIES,Y.ER,'');* R22 UTILITY AUTO CONVERSION

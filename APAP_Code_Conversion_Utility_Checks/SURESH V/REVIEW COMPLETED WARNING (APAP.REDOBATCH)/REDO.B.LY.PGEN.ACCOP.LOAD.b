* @ValidationCode : MjotMTM0MDcxOTU0MDpDcDEyNTI6MTcwNDM2NDYzODgwMzozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:07:18
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'MOD',PRG.MOD.LST,F.TEMP.LY.PGEN.ACCOP,PRG.MOD.LST.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.MOD.LST,F.TEMP.LY.PGEN.ACCOP,PRG.MOD.LST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'NOPRG',PRG.PER.MOD,F.TEMP.LY.PGEN.ACCOP,PRG.PER.MOD.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.PER.MOD,F.TEMP.LY.PGEN.ACCOP,PRG.PER.MOD.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'PRG',PRG.LST,F.TEMP.LY.PGEN.ACCOP,PRG.LST.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.LST,F.TEMP.LY.PGEN.ACCOP,PRG.LST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'ST.DATE',PRG.ST.DATE.LST,F.TEMP.LY.PGEN.ACCOP,PRG.ST.DATE.LST.ERR)
    IDVAR.1 ='ST.DATE';*R22 Manual Conversion
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.ST.DATE.LST,F.TEMP.LY.PGEN.ACCOP,PRG.ST.DATE.LST.ERR) ;*R22 Manual Conversion
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'END.DATE',PRG.END.DATE.LST,F.TEMP.LY.PGEN.ACCOP,PRG.END.DATE.LST.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.END.DATE.LST,F.TEMP.LY.PGEN.ACCOP,PRG.END.DATE.LST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'DAYS.EXP',PRG.DAYS.EXP.LST,F.TEMP.LY.PGEN.ACCOP,PRG.DAYS.EXP.LST.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.DAYS.EXP.LST,F.TEMP.LY.PGEN.ACCOP,PRG.DAYS.EXP.LST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'EXP.DATE',PRG.EXP.DATE.LST,F.TEMP.LY.PGEN.ACCOP,PRG.EXP.DATE.LST.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.EXP.DATE.LST,F.TEMP.LY.PGEN.ACCOP,PRG.EXP.DATE.LST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'CUS.GROUP',PRG.CUS.GRP.LST,F.TEMP.LY.PGEN.ACCOP,PRG.CUS.GRP.LST.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.CUS.GRP.LST,F.TEMP.LY.PGEN.ACCOP,PRG.CUS.GRP.LST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'POINT.VALUE',PRG.POINT.VALUE.LST,F.TEMP.LY.PGEN.ACCOP,PRG.POINT.VALUE.LST.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.POINT.VALUE.LST,F.TEMP.LY.PGEN.ACCOP,PRG.POINT.VALUE.LST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'AVAIL.IF.DELAY',PRG.AVAIL.IF.DELAY.LST,F.TEMP.LY.PGEN.ACCOP,PRG.AVAIL.IF.DELAY.LST.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.AVAIL.IF.DELAY.LST,F.TEMP.LY.PGEN.ACCOP,PRG.AVAIL.IF.DELAY.LST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'POINT.USE',PRG.POINT.USE.LST,F.TEMP.LY.PGEN.ACCOP,PRG.POINT.USE.LST.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.POINT.USE.LST,F.TEMP.LY.PGEN.ACCOP,PRG.POINT.USE.LST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'COND.TYPE.EXINC',PRG.COND.TYPE.EXINC,F.TEMP.LY.PGEN.ACCOP,PRG.COND.TYPE.EXINC.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.COND.TYPE.EXINC,F.TEMP.LY.PGEN.ACCOP,PRG.COND.TYPE.EXINC.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'APP.EXC.COND',PRG.APP.EXC.COND,F.TEMP.LY.PGEN.ACCOP,PRG.APP.EXC.COND.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.APP.EXC.COND,F.TEMP.LY.PGEN.ACCOP,PRG.APP.EXC.COND.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'EXC.EST.ACCT',PRG.EXC.EST.ACCT,F.TEMP.LY.PGEN.ACCOP,PRG.EXC.EST.ACCT.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.EXC.EST.ACCT,F.TEMP.LY.PGEN.ACCOP,PRG.EXC.EST.ACCT.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'APP.INC.COND',PRG.APP.INC.COND,F.TEMP.LY.PGEN.ACCOP,PRG.APP.INC.COND.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.APP.INC.COND,F.TEMP.LY.PGEN.ACCOP,PRG.APP.INC.COND.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'INC.EST.ACCT',PRG.INC.EST.ACCT,F.TEMP.LY.PGEN.ACCOP,PRG.INC.EST.ACCT.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.INC.EST.ACCT,F.TEMP.LY.PGEN.ACCOP,PRG.INC.EST.ACCT.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'PTS.IN.MOD',PRG.PTS.IN.MOD,F.TEMP.LY.PGEN.ACCOP,PRG.PTS.IN.MOD.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.PTS.IN.MOD,F.TEMP.LY.PGEN.ACCOP,PRG.PTS.IN.MOD.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'ANTIG.IN.MOD',PRG.ANTIG.IN.MOD,F.TEMP.LY.PGEN.ACCOP,PRG.ANTIG.IN.MOD.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.ANTIG.IN.MOD,F.TEMP.LY.PGEN.ACCOP,PRG.ANTIG.IN.MOD.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'PROD',PRG.PROD.LST,F.TEMP.LY.PGEN.ACCOP,PRG.PROD.LST.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.PROD.LST,F.TEMP.LY.PGEN.ACCOP,PRG.PROD.LST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'CCY.IN.MOD',PRG.CCY.IN.MOD,F.TEMP.LY.PGEN.ACCOP,PRG.CCY.IN.MOD.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.CCY.IN.MOD,F.TEMP.LY.PGEN.ACCOP,PRG.CCY.IN.MOD.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,'AIR',PRG.AIR.LST,F.TEMP.LY.PGEN.ACCOP,PRG.AIR.LST.ERR)
    ...
    CALL F.READ(FN.TEMP.LY.PGEN.ACCOP,IDVAR.1,PRG.AIR.LST,F.TEMP.LY.PGEN.ACCOP,PRG.AIR.LST.ERR);* R22 AUTO CONVERSION

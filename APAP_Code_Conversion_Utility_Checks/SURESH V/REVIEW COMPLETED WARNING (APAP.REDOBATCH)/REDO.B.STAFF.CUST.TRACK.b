* @ValidationCode : MjoxMTc0MTk0NDA1OkNwMTI1MjoxNzA0NDQwNDUxMTgxOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:10:51
...
*    CALL F.READ(FN.REDO.EMPLOYEE.ACCOUNTS,Y.CUSTOMER.ID,R.REDO.EMPLOYEE.ACCOUNTS,F.REDO.EMPLOYEE.ACCOUNTS,ERR.REDO.EMPLOYEE.ACCOUNTS)
    CALL F.READU(FN.REDO.EMPLOYEE.ACCOUNTS,Y.CUSTOMER.ID,R.REDO.EMPLOYEE.ACCOUNTS,F.REDO.EMPLOYEE.ACCOUNTS,ERR.REDO.EMPLOYEE.ACCOUNTS,'');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotMTQzNTA0ODIwOTpDcDEyNTI6MTcwNDcwNzE5Nzg2NzozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 08 Jan 2024 15:16:37
...
*        CALL F.READ(FN.REDO.WORK.PARTIAL.AMT,Y.AA.ID,R.REDO.WORK.PARTIAL.AMT,F.REDO.WORK.PARTIAL.AMT,WOR.RK.ERR)
        CALL F.READU(FN.REDO.WORK.PARTIAL.AMT,Y.AA.ID,R.REDO.WORK.PARTIAL.AMT,F.REDO.WORK.PARTIAL.AMT,WOR.RK.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.REDO.WORK.INT.CAP.AMT.RP,Y.TEMP.ID,R.REDO.WORK.INT.CAP.AMT.RP,F.REDO.WORK.INT.CAP.AMT.RP,WORK.ERR)
        CALL F.READU(FN.REDO.WORK.INT.CAP.AMT.RP,Y.TEMP.ID,R.REDO.WORK.INT.CAP.AMT.RP,F.REDO.WORK.INT.CAP.AMT.RP,WORK.ERR,'');* R22 UTILITY AUTO CONVERSION

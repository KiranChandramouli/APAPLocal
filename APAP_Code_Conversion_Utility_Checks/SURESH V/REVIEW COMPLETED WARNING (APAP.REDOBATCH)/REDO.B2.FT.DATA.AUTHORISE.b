* @ValidationCode : Mjo4NzI0Njc4MzE6Q3AxMjUyOjE3MDQ3MTQzMTE0MjM6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 08 Jan 2024 17:15:11
...
*18/01/2024         Suresh          R22 UTILITY AUTO CONVERSION   Change F.READ to F.READU, IDVAR Variable Changed
*-----------------------------------------------------------------------------
...
*    CALL F.READ(FN.PARAM,Y.POLICY.TYPE,R.PARAM,F.PARAM,YERR)
    CALL F.READU(FN.PARAM,Y.POLICY.TYPE,R.PARAM,F.PARAM,YERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL CACHE.READ(FN.PARAM,'SYSTEM',R.PARAM,YERR) ; * Tus End
    ...
    CALL CACHE.READ(FN.PARAM,IDVAR.1,R.PARAM,YERR) ; * Tus End;* R22 UTILITY AUTO CONVERSION
    R.PARAM<PAY.PAR.FECHA.CORTE> = Y.NEWCLOSDATE
*    CALL F.WRITE(FN.PARAM,'SYSTEM',R.PARAM)
    IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL F.WRITE(FN.PARAM,IDVAR.1,R.PARAM);* R22 UTILITY AUTO CONVERSION
RETURN
***</region>

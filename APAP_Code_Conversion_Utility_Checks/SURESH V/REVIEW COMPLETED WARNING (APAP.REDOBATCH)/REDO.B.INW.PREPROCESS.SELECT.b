* @ValidationCode : MjotMjM0MTI1ODcwOkNwMTI1MjoxNzAzODQ0MDEwNTI0OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 29 Dec 2023 15:30:10
...
*
*18/01/2024         Suresh                 R22 Manual Conversion  CALL routine Modified
*------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.ACCOUNT
...
*        CALL BATCH.BUILD.LIST('', R.APERTA.LIST)
        EB.Service.BatchBuildList('', R.APERTA.LIST) ;*R22 Manual Conversion
    END
    ELSE
        INT.CODE ='APA002'
        INT.TYPE ='BATCH'

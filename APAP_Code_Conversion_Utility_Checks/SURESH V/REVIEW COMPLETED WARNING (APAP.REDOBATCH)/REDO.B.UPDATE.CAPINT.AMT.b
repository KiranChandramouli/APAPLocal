* @ValidationCode : MjotMTkyNzY5NDcwMzpDcDEyNTI6MTcwNDcwNjgxOTQ3NDozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 08 Jan 2024 15:10:19
...
*    CALL F.READ(FN.REDO.ACCT.MRKWOF.PARAMETER,ID.COMPANY,R.REDO.ACCT.MRKWOF,F.REDO.ACCT.MRKWOF.PARAMETER,PAR.ERR)
    CALL CACHE.READ(FN.REDO.ACCT.MRKWOF.PARAMETER,ID.COMPANY,R.REDO.ACCT.MRKWOF,PAR.ERR) ;*R22 Manual Conversion
...
*        CALL F.READ(FN.REDO.WORK.INT.CAP.AMT,Y.TEMP.ID,R.REDO.WORK.INT.CAP.AMT,F.REDO.WORK.INT.CAP.AMT,WORK.ERR)
        CALL F.READU(FN.REDO.WORK.INT.CAP.AMT,Y.TEMP.ID,R.REDO.WORK.INT.CAP.AMT,F.REDO.WORK.INT.CAP.AMT,WORK.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.ACCOUNT,DR.ACCOUNT.NUMBER,R.ACCOUNT,F.ACCOUNT,AC.ERR)
    CALL F.READU(FN.ACCOUNT,DR.ACCOUNT.NUMBER,R.ACCOUNT,F.ACCOUNT,AC.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READ(FN.ACCOUNT,CR.ACCOUNT.NUMBER,R.ACCOUNT,F.ACCOUNT,AC.ERR)
    CALL F.READU(FN.ACCOUNT,CR.ACCOUNT.NUMBER,R.ACCOUNT,F.ACCOUNT,AC.ERR,'');* R22 UTILITY AUTO CONVERSION

    IF NOT(R.ACCOUNT) THEN
        CALL INT.ACC.OPEN(CR.ACCOUNT.NUMBER,RET.CODE)
        R.ACCOUNT = ''
*        CALL F.READ(FN.ACCOUNT,CR.ACCOUNT.NUMBER,R.ACCOUNT,F.ACCOUNT,ACC.ERR)
        CALL F.READU(FN.ACCOUNT,CR.ACCOUNT.NUMBER,R.ACCOUNT,F.ACCOUNT,ACC.ERR,'');* R22 UTILITY AUTO CONVERSION
        R.ACCOUNT<AC.LOCAL.REF,L.LOAN.STATUS.POS> = '3'

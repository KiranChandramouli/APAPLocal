* @ValidationCode : MjotMTY0NjUwODk1MjpDcDEyNTI6MTcwMzY3ODc4MDk2NDozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Dec 2023 17:36:20
...
*
*18/01/2024         Suresh                R22 Manual Conversion   IDVAR Variable Changed, Change F.READ to F.READU
*------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.ACCOUNT
    ...
    IDVAR='INW.PROCESS' ;*R22 Manual Conversion
...
*    CALL F.READ(FN.REDO.APAP.CLEARING.INWARD,REDO.APAP.CLEARING.INWARD.ID,R.REDO.APAP.CLEARING.INWARD,F.REDO.APAP.CLEARING.INWARD,REDO.CLEAR.ERR)
    CALL F.READU(FN.REDO.APAP.CLEARING.INWARD,REDO.APAP.CLEARING.INWARD.ID,R.REDO.APAP.CLEARING.INWARD,F.REDO.APAP.CLEARING.INWARD,REDO.CLEAR.ERR,"") ;*R22 Manual Conversion

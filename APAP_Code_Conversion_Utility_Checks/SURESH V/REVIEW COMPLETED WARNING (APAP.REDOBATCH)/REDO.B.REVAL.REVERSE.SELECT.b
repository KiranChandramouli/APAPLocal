* @ValidationCode : MjoxODM1OTcyNjIwOkNwMTI1MjoxNzA0NDM4NzAwMDgwOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 12:41:40
...
*    CALL BATCH.BUILD.LIST(LIST.PARAM,'')
    EB.Service.BatchBuildList(LIST.PARAM,'');* R22 UTILITY AUTO CONVERSION
* Mod1 E
...
*    CALL BATCH.BUILD.LIST('','MERGE.RECORDS')
    EB.Service.BatchBuildList('','MERGE.RECORDS');* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotMjA4NzMyMDI5ODpDcDEyNTI6MTcwNDI3ODE0ODU0MjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 03 Jan 2024 16:05:48
...
*CALL F.READ(FN.REDO.L.NCF.UNMAPPED,VAR.NCF.UNMAP.ID,R.NCF.UNMAPPED,F.REDO.L.NCF.UNMAPPED,UNMAP.ERR)
        CALL F.READU(FN.REDO.L.NCF.UNMAPPED,VAR.NCF.UNMAP.ID,R.NCF.UNMAPPED,F.REDO.L.NCF.UNMAPPED,UNMAP.ERR,'');* R22 AUTO CONVERSION
...
*CALL F.READ(FN.STMT.ENTRY,VAR.STMT.ID,R.STMT.ENTRY,F.STMT.ENTRY,ERR)
        CALL F.READU(FN.STMT.ENTRY,VAR.STMT.ID,R.STMT.ENTRY,F.STMT.ENTRY,ERR,'');* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.REDO.L.NCF.STOCK,'SYSTEM',R.NCF.STOCK)
        ...
        CALL F.WRITE(FN.REDO.L.NCF.STOCK,IDVAR.1,R.NCF.STOCK);* R22 AUTO CONVERSION
...
*CALL F.READU(FN.REDO.L.NCF.STOCK,'SYSTEM',R.NCF.STOCK,F.REDO.L.NCF.STOCK,ST.ERR,RETRY) ;*Tus Start
    ...
    CALL F.READU(FN.REDO.L.NCF.STOCK,'SYSTEM',R.NCF.STOCK,F.REDO.L.NCF.STOCK,ST.ERR,RETRY) ;*R22 Manual Conversion

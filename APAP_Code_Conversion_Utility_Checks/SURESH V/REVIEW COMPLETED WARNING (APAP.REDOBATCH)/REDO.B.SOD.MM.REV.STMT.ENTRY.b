* @ValidationCode : MjotNjI2NzkzNzE5OkNwMTI1MjoxNzA0NDQwMTIzMDAxOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 13:05:23
...
*    CALL F.READ(FN.REDO.APAP.L.CONTRACT.BALANCES,REDO.APAP.L.CONTRACT.BALANCES.ID,R.REDO.APAP.L.CONTRACT.BALANCES,F.REDO.APAP.L.CONTRACT.BALANCES,REDO.APAP.L.CONTRACT.BALANCES.ERR)
    CALL F.READU(FN.REDO.APAP.L.CONTRACT.BALANCES,REDO.APAP.L.CONTRACT.BALANCES.ID,R.REDO.APAP.L.CONTRACT.BALANCES,F.REDO.APAP.L.CONTRACT.BALANCES,REDO.APAP.L.CONTRACT.BALANCES.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL EB.ACCOUNTING('MM','SAO',FINAL.ENTRY.REC,'')
        AC.API.EbAccounting('MM','SAO',FINAL.ENTRY.REC,'');* R22 UTILITY AUTO CONVERSION
    END

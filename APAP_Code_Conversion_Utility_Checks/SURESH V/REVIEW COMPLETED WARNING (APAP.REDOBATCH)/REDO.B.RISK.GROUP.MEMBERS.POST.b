* @ValidationCode : Mjo5OTU2NzE4NjA6Q3AxMjUyOjE3MDQ0Mzg5MDE2NDM6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Jan 2024 12:45:01
...
* Date                   who                   Reference
* 13-04-2023         CONVERSTION TOOL     R22 AUTO CONVERSTION - FM TO @FM AND VM TO @VM AND ++ TO += 1 AND ! TO *
...
*        CALL F.READ(TEMP.PATH,REC.ID,R.TEMP.PATH,TEMP.PTR,ERR.MSG)
        CALL F.READU(TEMP.PATH,REC.ID,R.TEMP.PATH,TEMP.PTR,ERR.MSG,'');* R22 UTILITY AUTO CONVERSION
        IF ERR.MSG NE '' THEN
*20140318(E)
            INT.CODE = "REP001"
            INT.TYPE = "ONLINE"
...
*    CALL F.READ(FN.REDO.GR.REP.CUST,Y.RGRC.ID,R.REDO.GR.REP.CUST,F.REDO.GR.REP.CUST,Y.REP.ERR)
    CALL F.READU(FN.REDO.GR.REP.CUST,Y.RGRC.ID,R.REDO.GR.REP.CUST,F.REDO.GR.REP.CUST,Y.REP.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.REDO.GR.REP.CUST,Y.REP.LIST<Y.REP.CNT>,R.REDO.GR.REP.CUST,F.REDO.GR.REP.CUST,Y.REP.ERR)
        CALL F.READU(FN.REDO.GR.REP.CUST,Y.REP.LIST<Y.REP.CNT>,R.REDO.GR.REP.CUST,F.REDO.GR.REP.CUST,Y.REP.ERR,'');* R22 UTILITY AUTO CONVERSION

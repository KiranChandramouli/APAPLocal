* @ValidationCode : MjoxMjAwMTQyMTAwOkNwMTI1MjoxNzA0MzY0OTc4OTYwOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:12:58
...
*18/01/2024         Suresh               R22 UTILITY AUTO CONVERSION  IDVAR Variable Changed,Change F.READ to F.READU
*----------------------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,'VAR.T.GEN',VAR.T.GEN,F.TEMP.LY.PGEN.BIRTH,VAR.T.GEN.ERR,RETRY.VAR)
    IDVAR.1 = 'VAR.T.GEN' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,IDVAR.1,VAR.T.GEN,F.TEMP.LY.PGEN.BIRTH,VAR.T.GEN.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,'VAR.T.GEN.VALUE',VAR.T.GEN.VALUE,F.TEMP.LY.PGEN.BIRTH,VAR.T.GEN.VALUE.ERR,RETRY.VAR)
    IDVAR.1 = 'VAR.T.GEN.VALUE' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,IDVAR.1,VAR.T.GEN.VALUE,F.TEMP.LY.PGEN.BIRTH,VAR.T.GEN.VALUE.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,'VAR.T.AVAIL',VAR.T.AVAIL,F.TEMP.LY.PGEN.BIRTH,VAR.T.AVAIL.ERR,RETRY.VAR)
    IDVAR.1 = 'VAR.T.AVAIL' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,IDVAR.1,VAR.T.AVAIL,F.TEMP.LY.PGEN.BIRTH,VAR.T.AVAIL.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,'VAR.T.AVAIL.VALUE',VAR.T.AVAIL.VALUE,F.TEMP.LY.PGEN.BIRTH,VAR.T.AVAIL.VALUE.ERR,RETRY.VAR)
    ...
    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,IDVAR.1,VAR.T.AVAIL.VALUE,F.TEMP.LY.PGEN.BIRTH,VAR.T.AVAIL.VALUE.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,'VAR.T.NAVAIL',VAR.T.NAVAIL,F.TEMP.LY.PGEN.BIRTH,VAR.T.NAVAIL.ERR,RETRY.VAR)
    IDVAR.1 = 'VAR.T.NAVAIL' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,IDVAR.1,VAR.T.NAVAIL,F.TEMP.LY.PGEN.BIRTH,VAR.T.NAVAIL.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,'VAR.T.NAVAIL.VALUE',VAR.T.NAVAIL.VALUE,F.TEMP.LY.PGEN.BIRTH,VAR.T.NAVAIL.VALUE.ERR,RETRY.VAR)
    IDVAR.1 = 'VAR.T.NAVAIL.VALUE' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READU(FN.TEMP.LY.PGEN.BIRTH,IDVAR.1,VAR.T.NAVAIL.VALUE,F.TEMP.LY.PGEN.BIRTH,VAR.T.NAVAIL.VALUE.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION

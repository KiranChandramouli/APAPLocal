* @ValidationCode : MjotNzg1NjcyNTc6Q3AxMjUyOjE3MDQyODMwNTUyMDE6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 03 Jan 2024 17:27:35
...
*CALL F.READ(FN.OFS.CHANGE.RATE.QUEUE,MSG.ID,R.OFS.CHANGE.RATE.QUEUE,F.OFS.CHANGE.RATE.QUEUE,QUEUE.ERR)
    CALL F.READU(FN.OFS.CHANGE.RATE.QUEUE,MSG.ID,R.OFS.CHANGE.RATE.QUEUE,F.OFS.CHANGE.RATE.QUEUE,QUEUE.ERR,'');* R22 AUTO CONVERSION
...
*            CALL AA.GET.ARRANGEMENT.CONDITIONS(Y.AA.ARRANGEMENT,'PAYMENT.SCHEDULE',Y.SCHED.PROPERTY, '',returnID,returnConditions,RET.ERR)
            AA.Framework.GetArrangementConditions(Y.AA.ARRANGEMENT,'PAYMENT.SCHEDULE',Y.SCHED.PROPERTY, '',returnID,returnConditions,RET.ERR) ;*R22 Manual Conversion

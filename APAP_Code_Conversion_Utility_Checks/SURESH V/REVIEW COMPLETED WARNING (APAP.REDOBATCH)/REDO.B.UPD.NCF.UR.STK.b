* @ValidationCode : MjotOTI3MjY1MzkyOkNwMTI1MjoxNzA0NDQ3MTI3NzQ3OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jan 2024 15:02:07
...
*    CALL F.READ(FN.REDO.AA.NCF.IDS,Y.USER.ID,R.NCF.IDS,F.REDO.AA.NCF.IDS,NCF.ERR)
    CALL F.READU(FN.REDO.AA.NCF.IDS,Y.USER.ID,R.NCF.IDS,F.REDO.AA.NCF.IDS,NCF.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*    CALL CACHE.READ(FN.INTERFACE.CONFIG.PRT,"email",R.INT.CONFIG,EMAILL.ERR)
    IDVAR.1 = "email" ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.INTERFACE.CONFIG.PRT,IDVAR.1,R.INT.CONFIG,EMAILL.ERR);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjoxMjIyMDU4NjEyOkNwMTI1MjoxNzA0MzY1MTA4NTYxOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:15:08
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'MOD',PRG.MOD.LST) ;*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.MOD.LST) ;*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'NOPRG',PRG.PER.MOD ) ;*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.PER.MOD ) ;*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'PRG',PRG.LST) ;* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.LST) ;* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'ST.DATE',PRG.ST.DATE.LST) ;* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.ST.DATE.LST) ;* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'END.DATE',PRG.END.DATE.LST); *Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.END.DATE.LST); *Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'DAYS.EXP',PRG.DAYS.EXP.LST);*n Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.DAYS.EXP.LST);*n Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'EXP.DATE',PRG.EXP.DATE.LST);* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.EXP.DATE.LST);* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'CUS.GROUP',PRG.CUS.GRP.LST); * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.CUS.GRP.LST); * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'POINT.VALUE',PRG.POINT.VALUE.LST); *Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.POINT.VALUE.LST); *Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'AVAIL.IF.DELAY',PRG.AVAIL.IF.DELAY.LST);*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.AVAIL.IF.DELAY.LST);*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'POINT.USE',PRG.POINT.USE.LST);*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.POINT.USE.LST);*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'AIR',PRG.AIR.LST);*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.AIR.LST);*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'PTS.IN.MOD',PRG.PTS.IN.MOD);*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.PTS.IN.MOD);*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'MIN.GEN.IN.MOD',PRG.MINGEN.IN.MOD) ;*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.MINGEN.IN.MOD) ;*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'MAX.GEN.IN.MOD',PRG.MAXGEN.IN.MOD) ;*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.MAXGEN.IN.MOD) ;*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'FORM.GEN.IN.MOD',PRG.FORM.GEN.IN.MOD) ;*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.FORM.GEN.IN.MOD) ;*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,'GEN.AMT.IN.MOD',PRG.GEN.AMT.IN.MOD) ;*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.PGEN.TBM,IDVAR.1,PRG.GEN.AMT.IN.MOD) ;*Tus End;* R22 AUTO CONVERSION

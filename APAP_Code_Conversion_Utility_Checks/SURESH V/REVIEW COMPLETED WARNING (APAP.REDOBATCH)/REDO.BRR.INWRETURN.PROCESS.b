* @ValidationCode : MjotNDg5NzcwNzM5OkNwMTI1MjoxNzA0NzgyMjQ3MTg2OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 09 Jan 2024 12:07:27
...
*    CALL F.READ(FN.REDO.CLEARING.PROCESS,'B143.PROCESS',R.REDO.CLEARING.PROCESS,F.REDO.CLEARING.PROCESS.ID,PARAM.ERR)
    IDVAR.1 = 'B143.PROCESS' ;* R22 UTILITY AUTO CONVERSION
    CALL F.READ(FN.REDO.CLEARING.PROCESS,IDVAR.1,R.REDO.CLEARING.PROCESS,F.REDO.CLEARING.PROCESS.ID,PARAM.ERR);* R22 UTILITY AUTO CONVERSION

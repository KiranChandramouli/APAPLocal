* @ValidationCode : MjotNzE4MTE4NDQ0OkNwMTI1MjoxNzA0MzY0MzU0MjA4OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:02:34
...
*-------------------------------------------------------------------------------------------------
    ...
    $INSERT I_F.ACCOUNT
    $USING AC.API ;* R22 AUTO CONVERSION
...
*CALL EB.ACCOUNTING("AC","SAO",MULTI.STMT,'')
        AC.API.EbAccounting("AC","SAO",MULTI.STMT,'');* R22 AUTO CONVERSION
    END

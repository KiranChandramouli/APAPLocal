* @ValidationCode : MjoxNTEzMjU5NDY6Q3AxMjUyOjE3MDQ3Nzg1OTA3OTE6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 09 Jan 2024 11:06:30
...
*    CALL CACHE.READ(FN.REDO.EMPLOYEE.SUPER.USER,'SYSTEM',R.SUPER.USER,SUPER.ERR)
    ...
    CALL CACHE.READ(FN.REDO.EMPLOYEE.SUPER.USER,IDVAR.1,R.SUPER.USER,SUPER.ERR);* R22 UTILITY AUTO CONVERSION

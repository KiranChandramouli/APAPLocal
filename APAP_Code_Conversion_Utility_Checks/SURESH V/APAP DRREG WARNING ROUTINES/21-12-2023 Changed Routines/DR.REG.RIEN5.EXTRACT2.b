* @ValidationCode : MjotMTU1NjkwNjg5OkNwMTI1MjoxNzAyNjI0Mzg5NzgwOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 Dec 2023 12:43:09
...
$PACKAGE APAP.DRREG
SUBROUTINE DR.REG.RIEN5.EXTRACT2
*----------------------------------------------------------------------------
* Company Name   : APAP
* Developed By   : gangadhar@temenos.com
* Program Name   : DR.REG.RIEN5.EXTRACT2
* Date           : 27-May-2013
*----------------------------------------------------------------------------
* Description:
*------------
...
** 26/02/2015  Ashokkumar.V.P            PACS00309203 - Just for compilatio0
*----------------------------------------------------------------------------
...
*14/12/2023       Suresh                    R22 Manual Conversion        Change Hardcoding the value to IDVAR
...
*---------*
    ...
    FN.DR.REG.RIEN5.OUT2 = 'F.DR.REG.RIEN5.OUT2'
    F.DR.REG.RIEN5.OUT2 = ''
    CALL OPF(FN.DR.REG.RIEN5.OUT2,F.DR.REG.RIEN5.OUT2)
    ...
    CALL CACHE.READ(FN.DR.REG.RIEN5.PARAM,IDVAR,R.DR.REG.RIEN5.PARAM,DR.REG.RIEN5.PARAM.ERR) ;*R22 Manual Conversion
    FN.CHK.DIR = R.DR.REG.RIEN5.PARAM<RIEN5.PARAM.OUT.PATH>
    F.CHK.DIR = ''
    CALL OPF(FN.CHK.DIR,F.CHK.DIR)
*
    Y.DATE = R.DATES(EB.DAT.LAST.WORKING.DAY)
    EXTRACT.FILE.ID = R.DR.REG.RIEN5.PARAM<RIEN5.PARAM.FILE.NAME>:'_':R.DR.REG.RIEN5.PARAM<RIEN5.PARAM.REP.NAME,2>:'_':Y.DATE:'.csv'
*
    R.FILE.DATA = ''
...
*    WRITESEQ REP.HEADER TO FV.EXTRACT.FILE ELSE NULL
    REP.NAME = R.DR.REG.RIEN5.PARAM<RIEN5.PARAM.REP.NAME,2>
...
*
    ...
    ID.CNT1 = ''
    ERR.SEL1 = ''
    SEL.CMD1 = "SELECT ":FN.DR.REG.RIEN5.OUT2:" BY @ID"
...
*------*
*
    CALL F.READ(FN.DR.REG.RIEN5.OUT2,REC.ID,R.DR.REG.RIEN5.OUT2,F.DR.REG.RIEN5.OUT2,DR.REG.RIEN5.OUT2.ERR)
    IF R.DR.REG.RIEN5.OUT2 THEN
        RANGE1 = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.RANGE.0.15>
        RANGE2 = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.RANGE.16.30>
        RANGE3 = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.RANGE.31.60>
        RANGE4 = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.RANGE.61.90>
        RANGE5 = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.RANGE.91.180>
        RANGE6 = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.RANGE.181.360>
        RANGE7 = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.RANGE.361.720>
        RANGE8 = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.RANGE.721.1080>
        RANGE9 = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.RANGE.1081.1440>
        RANGE10 = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.RANGE.1441.1800>
        RANGE11 = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.RANGE.1881>
        INDET = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.INDETERMINATE>          ;* PACS00309203 - Indeterminado field
        TOTAL = R.DR.REG.RIEN5.OUT2<DR.RIEN5.OUT2.TOTAL>
        IF TOTAL EQ 0 THEN  ;*R22 AUTO CODE CPNVERSION - START
            RETURN ;* PACS00309203 S/E
        END   ;*R22 AUTO CODE CPNVERSION - END

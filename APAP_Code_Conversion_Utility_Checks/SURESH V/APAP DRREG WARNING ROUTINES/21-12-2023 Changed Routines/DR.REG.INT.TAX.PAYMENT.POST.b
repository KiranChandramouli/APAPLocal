* @ValidationCode : MjotMTUwNTU2NDcwMzpDcDEyNTI6MTcwMjYzNjMwNTY0NjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 Dec 2023 16:01:45
...
*
    ...
    CALL CACHE.READ(FN.DR.REG.INT.TAX.PAY.PARAM,IDVAR,R.DR.REG.INT.TAX.PAY.PARAM,DR.REG.INT.TAX.PAY.PARAM.ERR) ;*R22 Manual Conversion
...
*
    ...
    IDVAR='SYSTEM' ;*R22 Manual Conversion
    CALL F.WRITE(FN.DR.REG.INT.TAX.PAY.PARAM,IDVAR,R.DR.REG.INT.TAX.PAY.PARAM) ;*R22 Manual Conversion
*
RETURN
*-------------------------------------------------------------------
END

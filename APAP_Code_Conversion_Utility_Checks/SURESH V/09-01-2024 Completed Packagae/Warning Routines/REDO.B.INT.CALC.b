* @ValidationCode : MjotNTcwMzM2MjI6Q3AxMjUyOjE3MDM2NzQxODU1MjY6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Dec 2023 16:19:45
...
*    CALL F.READ(FN.REDO.INTEREST.REVERSE,REVERSE.ID,R.REDO.INTEREST.REVERSE,F.REDO.INTEREST.REVERSE,REVERSE.ERR)
    CALL F.READU(FN.REDO.INTEREST.REVERSE,REVERSE.ID,R.REDO.INTEREST.REVERSE,F.REDO.INTEREST.REVERSE,REVERSE.ERR,"") ;*R22 Manual Conversion

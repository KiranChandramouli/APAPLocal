* @ValidationCode : MjoxMjI4MzkxMzY3OkNwMTI1MjoxNzA0MzcwNzkzODUyOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:49:53
...
*CALL CACHE.READ(FN.REDO.AA.INT.CLASSIFICATION,'SYSTEM',R.REDO.AA.INT.CLASSIFICATION,INT.ERR)
    ...
    CALL CACHE.READ(FN.REDO.AA.INT.CLASSIFICATION,IDVAR.1,R.REDO.AA.INT.CLASSIFICATION,INT.ERR);* R22 AUTO CONVERSION

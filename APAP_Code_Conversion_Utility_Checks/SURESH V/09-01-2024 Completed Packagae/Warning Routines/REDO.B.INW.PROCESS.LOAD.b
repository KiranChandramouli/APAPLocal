* @ValidationCode : MjoxMzUwMjcxMTc2OkNwMTI1MjoxNzAzODQ2NTYxMDU0OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 29 Dec 2023 16:12:41
...
*  CALL CACHE.READ(FN.REDO.ADMIN.CHQ.PARAM,'SYSTEM',R.REDO.ADMIN.CHQ.PARAM,ADM.CHQ.ERR)
    CALL CACHE.READ(FN.REDO.ADMIN.CHQ.PARAM,IDVAR,R.REDO.ADMIN.CHQ.PARAM,ADM.CHQ.ERR) ;*R22 Manual Conversion
    ...
    IDVAR='SYSTEM' ;*R22 Manual Conversion
*     CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,'SYSTEM',R.REDO.APAP.CLEAR.PARAM,CLEAR.ERR)
    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,IDVAR,R.REDO.APAP.CLEAR.PARAM,CLEAR.ERR) ;*R22 Manual Conversion

* @ValidationCode : MjotNzYyNTkwNDc1OkNwMTI1MjoxNzAzNTk0MDkyMjU5OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 18:04:52
...
*    CALL F.READ(FN.REDO.RESUBMIT.FT.DET,ARR.ID,R.REDO.RESUBMIT.FT.DET,F.REDO.RESUBMIT.FT.DET,FT.RESUB.ERR)
    CALL F.READU(FN.REDO.RESUBMIT.FT.DET,ARR.ID,R.REDO.RESUBMIT.FT.DET,F.REDO.RESUBMIT.FT.DET,FT.RESUB.ERR,"") ;*R22 Manual Conversion
...
*     CALL F.READ(FN.REDO.STO.PENDING.RESUBMISSION,RESUB.FT.ID,R.REDO.STO.PENDING.RESUBMISSION,F.REDO.STO.PENDING.RESUBMISSION,STO.RESUB.ERR)
        CALL F.READU(FN.REDO.STO.PENDING.RESUBMISSION,RESUB.FT.ID,R.REDO.STO.PENDING.RESUBMISSION,F.REDO.STO.PENDING.RESUBMISSION,STO.RESUB.ERR,"") ;*R22 Manual Conversion

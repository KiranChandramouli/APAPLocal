* @ValidationCode : MjotMTA2ODExMjc5NDpDcDEyNTI6MTcwMzE0NDczMTU3MzozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 13:15:31
...
*20/12/2023          Suresh                R22 Manual Conversion   F.READ Variable Changed
* ----------------------------------------------------------------------------
...
*    CALL F.READ(FN.REDO.H.CLEARING.OUTWARD,Y.CLR.OUTWARD.ID1,R.CHQ.REC,F.REDO.H.CLEARING.OUTWARD,CHEQ.ERR)
    CALL F.READU(FN.REDO.H.CLEARING.OUTWARD,Y.CLR.OUTWARD.ID1,R.CHQ.REC,F.REDO.H.CLEARING.OUTWARD,CHEQ.ERR,"") ;*R22 Manual Conversion
...
* CALL F.READ(FN.LOCKING,ID.LOCK,R.LOCKING,FV.LOCKING,LOCK.ERR)
    CALL F.READU(FN.LOCKING,ID.LOCK,R.LOCKING,FV.LOCKING,LOCK.ERR,"") ;*R22 Manual Conversion
    Y.RESET = '0000000000'

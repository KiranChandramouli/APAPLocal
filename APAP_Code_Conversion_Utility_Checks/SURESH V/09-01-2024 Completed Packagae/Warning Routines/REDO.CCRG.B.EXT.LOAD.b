* @ValidationCode : MjotNzc1MzQ1OTM2OkNwMTI1MjoxNzA0NzkyOTQ5MTQwOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 09 Jan 2024 15:05:49
...
*    CALL CACHE.READ('F.REDO.CCRG.PARAMETERS','SYSTEM',R.RCP,YERR)
    FN.REDO.CCRG.PARAMETERS = 'F.REDO.CCRG.PARAMETERS';* R22 UTILITY AUTO CONVERSION
*    CALL CACHE.READ(FN.REDO.CCRG.PARAMETERS,'SYSTEM',R.RCP,YERR);* R22 UTILITY AUTO CONVERSION
    IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.CCRG.PARAMETERS,IDVAR.1,R.RCP,YERR);* R22 UTILITY AUTO CONVERSION;* R22 UTILITY AUTO CONVERSION
    IF R.RCP EQ '' THEN
        Y.ERROR    = K.REC.NOT.FOUND
        Y.ERROR<2> = 'SYSTEM' : @VM : 'F.REDO.CCRG.PARAMETERS'
        APAP.REDOBATCH.redoCcrgBTraceError('REDO.CCRG.B.EXT.LOAD', Y.ERROR, @FALSE, "", @FALSE)
*APAP.REDOBATCH.REDO.CCRG.B.TRACE.ERROR('REDO.CCRG.B.EXT.LOAD', Y.ERROR, @FALSE, "", @FALSE) ;*R22 MANUAL CONVERSTION ADD PACKAGE
    END

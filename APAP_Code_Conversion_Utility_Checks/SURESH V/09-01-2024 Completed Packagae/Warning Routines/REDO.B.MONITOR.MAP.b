* @ValidationCode : Mjo3MzQ2MDYyNDA6Q3AxMjUyOjE3MDQzNjc5NTUyMzA6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:02:35
...
*CALL F.READ(FN.REDO.MON.MAP.QUEUE, MSG.ID, R.MSG, F.REDO.MON.MAP.QUEUE, ERR)
    CALL F.READU(FN.REDO.MON.MAP.QUEUE, MSG.ID, R.MSG, F.REDO.MON.MAP.QUEUE, ERR,'');* R22 AUTO CONVERSION
*
    IF ERR THEN

* @ValidationCode : MjotMjAwNzUxMTQ3ODpDcDEyNTI6MTcwMzIzNDA2OTEwMDozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Dec 2023 14:04:29
...
*    CALL CACHE.READ(FN.REDO.MAPPING.TABLE,'INW.PROCESS',R.REDO.MAPPING.TABLE,RMT.ERR)
    CALL CACHE.READ(FN.REDO.MAPPING.TABLE,IDVAR,R.REDO.MAPPING.TABLE,RMT.ERR) ;*R22 Manual Conversion
    RAC.ERR = ''
    IDVAR="SYSTEM" ;*R22 Manual Conversion
*    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,"SYSTEM",R.REDO.APAP.CLEAR.PARAM,RAC.ERR)
    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,IDVAR,R.REDO.APAP.CLEAR.PARAM,RAC.ERR) ;*R22 Manual Conversion
    IDVAR="SYSTEM" ;*R22 Manual Conversion
*   CALL CACHE.READ(FN.COLLECT.PARAM,"SYSTEM",R.COLLECT.PARAM,CP.ERR)
    CALL CACHE.READ(FN.COLLECT.PARAM,IDVAR,R.COLLECT.PARAM,CP.ERR) ;*R22 Manual Conversion
* PACS00188869 - S
...
*    CALL CACHE.READ(FN.REDO.H.ROUTING.HEADER,"SYSTEM",R.REDO.H.ROUTING.HEADER,ROUTE.ERR)
    CALL CACHE.READ(FN.REDO.H.ROUTING.HEADER,IDVAR,R.REDO.H.ROUTING.HEADER,ROUTE.ERR) ;*R22 Manual Conversion

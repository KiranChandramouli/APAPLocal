* @ValidationCode : MjotMTQyOTcwMTAyMjpDcDEyNTI6MTcwNDM2NDQyNTIxOTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:03:45
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY1',PROGRAM.EXCCONDTYPE.ESP.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.EXCCONDTYPE.ESP.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY2',PROGRAM.APPEXC.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.APPEXC.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY3',PROGRAM.EXCCONDTYPE.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.EXCCONDTYPE.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY4',PROGRAM.INCCONDTYPE.ESP.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.INCCONDTYPE.ESP.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY5',PROGRAM.APPINC.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.APPINC.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY6',PROGRAM.INCCONDTYPE.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.INCCONDTYPE.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY7',MODALITY.CCY.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.CCY.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY8',MODALITY.ID.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.ID.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY9',MODALITY.APP.TXN.LIST) ;* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.APP.TXN.LIST) ;* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY10',MODALITY.TXN.CODE.LIST) ;* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.TXN.CODE.LIST) ;* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY11',MODALITY.FORM.GEN.LIST) ;* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.FORM.GEN.LIST) ;* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY12',MODALITY.CHANNEL.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.CHANNEL.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY13',MODALITY.MINDISAMT.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.MINDISAMT.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY14',MODALITY.GEN.AMT.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.GEN.AMT.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY15',MODALITY.PROD.TYPE.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.PROD.TYPE.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY16',MODALITY.PROD.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.PROD.LIST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,'VARLY17',MODALITY.GEN.FACT.LIST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.GEN.FACT.LIST) ; * Tus End;* R22 AUTO CONVERSION

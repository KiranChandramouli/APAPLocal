* @ValidationCode : Mjo4MDU2MjkxNTQ6Q3AxMjUyOjE3MDM1NzgxNTQ4NTA6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Dec 2023 13:39:14
...
*13-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     FM TO @VM,FM TO @FM,SM TO @SM,++ TO +=1,TNO TO C$T24.SESSION.NO
...
* CALL F.READ(FN.REDO.APAP.H.DEAL.SLIP.QUEUE,Y.DS.QUEUE.ID,R.REDO.APAP.H.DEAL.SLIP.QUEUE,F.REDO.APAP.H.DEAL.SLIP.QUEUE,Y.DS.QUEUE.ERR)
    CALL F.READU(FN.REDO.APAP.H.DEAL.SLIP.QUEUE,Y.DS.QUEUE.ID,R.REDO.APAP.H.DEAL.SLIP.QUEUE,F.REDO.APAP.H.DEAL.SLIP.QUEUE,Y.DS.QUEUE.ERR,"") ;*R22 Manual Conversion
...
* CHANGE SM TO VM IN Y.REPRINT
    ...
    Y.COUNT = 1
    Y.DEAL.COUNT = DCOUNT(Y.DEAL.SLIP.ID,@VM) ;*R22 AUTO CONVERSION
    LOOP
...
***************
    ...
    Y.ALL.REPRINT = DCOUNT(Y.REPRINT,@SM) ;*R22 AUTO CONVERSION

    CHANGE @SM TO @FM IN Y.REPRINT ;*R22 AUTO CONVERSION
    ...
    R.REDO.APAP.H.DEAL.SLIP.QUEUE<REDO.DS.QUEUE.INPUTTER> = C$T24.SESSION.NO:"_":OPERATOR ;*R22 AUTO CONVERSION
    R.REDO.APAP.H.DEAL.SLIP.QUEUE<REDO.DS.QUEUE.DATE.TIME> = SYS.TIME.NOW
    R.REDO.APAP.H.DEAL.SLIP.QUEUE<REDO.DS.QUEUE.AUTHORISER> = C$T24.SESSION.NO:"_":OPERATOR ;*R22 AUTO CONVERSION

* @ValidationCode : MjotMTA1ODU5NjQzMDpDcDEyNTI6MTcwNDQzNjgyNTU2NzozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jan 2024 12:10:25
...
*            CALL LOAD.COMPANY(JL.COMPANY.CODE); * MOVES TO COMAPNY I IN ORDER TO CALL EB.ACCOUNTING
            ST.CompanyCreation.LoadCompany(JL.COMPANY.CODE); * MOVES TO COMAPNY I IN ORDER TO CALL EB.ACCOUNTING;* R22 UTILITY AUTO CONVERSION
*            CALL EB.ACCOUNTING("CATEG.ENTRY","SAO",JL.MVMNT,"")
            AC.API.EbAccounting("CATEG.ENTRY","SAO",JL.MVMNT,"");* R22 UTILITY AUTO CONVERSION
*            CALL LOAD.COMPANY(ORIG.COMPANY); * MOVES TO ORIGINAL COMPANY
            ST.CompanyCreation.LoadCompany(ORIG.COMPANY); * MOVES TO ORIGINAL COMPANY;* R22 UTILITY AUTO CONVERSION
        END
    NEXT JL.COUNTI
*    CALL LOAD.COMPANY(ORIG.COMPANY); * MOVES TO ORIGINAL COMPANY
    ST.CompanyCreation.LoadCompany(ORIG.COMPANY); * MOVES TO ORIGINAL COMPANY;* R22 UTILITY AUTO CONVERSION

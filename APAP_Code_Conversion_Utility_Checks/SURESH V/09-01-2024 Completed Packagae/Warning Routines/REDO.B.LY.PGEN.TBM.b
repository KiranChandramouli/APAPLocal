* @ValidationCode : Mjo5OTQ2NDQ3OTE6Q3AxMjUyOjE3MDQzNjM0ODY1OTg6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jan 2024 15:48:06
...
*    CALL F.READU(FN.TEMP.LY.PGEN.TBM,'VAR.T.GEN',VAR.T.GEN,F.TEMP.LY.PGEN.TBM,VAR.T.GEN.ERR,RETRY.VAR)
    ...
    CALL F.READU(FN.TEMP.LY.PGEN.TBM,IDVAR.1,VAR.T.GEN,F.TEMP.LY.PGEN.TBM,VAR.T.GEN.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.TEMP.LY.PGEN.TBM,'VAR.T.GEN.VALUE',VAR.T.GEN.VALUE,F.TEMP.LY.PGEN.TBM,VAR.T.GEN.VALUE.ERR,RETRY.VAR)
    ...
    CALL F.READU(FN.TEMP.LY.PGEN.TBM,IDVAR.1,VAR.T.GEN.VALUE,F.TEMP.LY.PGEN.TBM,VAR.T.GEN.VALUE.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.TEMP.LY.PGEN.TBM,'VAR.T.AVAIL',VAR.T.AVAIL,F.TEMP.LY.PGEN.TBM,VAR.T.AVAIL.ERR,RETRY.VAR)
    ...
    CALL F.READU(FN.TEMP.LY.PGEN.TBM,IDVAR.1,VAR.T.AVAIL,F.TEMP.LY.PGEN.TBM,VAR.T.AVAIL.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.TEMP.LY.PGEN.TBM,'VAR.T.AVAIL.VALUE',VAR.T.AVAIL.VALUE,F.TEMP.LY.PGEN.TBM,VAR.T.AVAIL.VALUE.ERR,RETRY.VAR)
    ...
    CALL F.READU(FN.TEMP.LY.PGEN.TBM,IDVAR.1,VAR.T.AVAIL.VALUE,F.TEMP.LY.PGEN.TBM,VAR.T.AVAIL.VALUE.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.TEMP.LY.PGEN.TBM,'VAR.T.NAVAIL',VAR.T.NAVAIL,F.TEMP.LY.PGEN.TBM,VAR.T.NAVAIL.ERR,RETRY.VAR)
    ...
    CALL F.READU(FN.TEMP.LY.PGEN.TBM,IDVAR.1,VAR.T.NAVAIL,F.TEMP.LY.PGEN.TBM,VAR.T.NAVAIL.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION
...
*    CALL F.READU(FN.TEMP.LY.PGEN.TBM,'VAR.T.NAVAIL.VALUE',VAR.T.NAVAIL.VALUE,F.TEMP.LY.PGEN.TBM,VAR.T.NAVAIL.VALUE.ERR,RETRY.VAR)
    ...
    CALL F.READU(FN.TEMP.LY.PGEN.TBM,IDVAR.1,VAR.T.NAVAIL.VALUE,F.TEMP.LY.PGEN.TBM,VAR.T.NAVAIL.VALUE.ERR,RETRY.VAR);* R22 UTILITY AUTO CONVERSION

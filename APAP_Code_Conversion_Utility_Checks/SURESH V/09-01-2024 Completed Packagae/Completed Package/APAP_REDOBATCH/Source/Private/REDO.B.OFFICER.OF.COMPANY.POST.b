* @ValidationCode : MjotMzUzNzA1ODM1OkNwMTI1MjoxNzA0MzcxMTY4OTgxOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:56:08
...
*CALL F.READ(TEMP.PATH,REC.ID,R.TEMP.PATH,TEMP.PTR,ERR.MSG)
        CALL F.READU(TEMP.PATH,REC.ID,R.TEMP.PATH,TEMP.PTR,ERR.MSG,'');* R22 AUTO CONVERSION
        IF ERR.MSG NE '' THEN
*20140319 (E)
            INT.CODE = "REP001"
            INT.TYPE = "ONLINE"

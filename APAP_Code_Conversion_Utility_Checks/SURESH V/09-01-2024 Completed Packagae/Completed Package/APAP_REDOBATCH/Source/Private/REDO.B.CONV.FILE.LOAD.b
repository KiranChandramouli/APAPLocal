* @ValidationCode : MjotODkwNjcxMzUwOkNwMTI1MjoxNzAzNTY4MjM2NzQzOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 10:53:56
...
*    CALL CACHE.READ(FN.EB.FILE.UPLOAD.PARAM,'SYSTEM',R.EB.FILE.UPLOAD.PARAM,Y.EB.FILE.UPLOAD.PARMA.ERR)
    CALL CACHE.READ(FN.EB.FILE.UPLOAD.PARAM,IDVAR,R.EB.FILE.UPLOAD.PARAM,Y.EB.FILE.UPLOAD.PARMA.ERR) ;*R22 Manual Conversion
...
*    CALL CACHE.READ(FN.AI.REDO.ARCIB.PARAMETER,'SYSTEM',R.AI.REDO.ARCIB.PARAMETER,AI.REDO.ARCIB.PARAMETER.ERR)
    CALL CACHE.READ(FN.AI.REDO.ARCIB.PARAMETER,IDVAR,R.AI.REDO.ARCIB.PARAMETER,AI.REDO.ARCIB.PARAMETER.ERR) ;*R22 Manual Conversion
...
*    CALL CACHE.READ(FN.FILE.UP.TYPE, 'UPLOAD', R.UP.TYPE, UP.TYPE.ERR);*R22 Auto conversion
    CALL CACHE.READ(FN.FILE.UP.TYPE, IDVAR, R.UP.TYPE, UP.TYPE.ERR) ;*R22 Manual Conversion
...
*-------------------------------------------------------------------------------------
    ...
    EX.USER = OPERATOR ;
    EX.PC = ''
    APAP.REDOCHNLS.redoInterfaceRecAct(FI.ARC.ACT.ID,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,ID.DESC,REC.CON,EX.USER,EX.PC);*Manual R22 conversion
* APAP.REDOCHNLS.REDO.INTERFACE.REC.ACT(FI.ARC.ACT.ID,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,ID.DESC,REC.CON,EX.USER,EX.PC);*Manual R22 conversion
RETURN
*-------------------------------------------------------------------------------------

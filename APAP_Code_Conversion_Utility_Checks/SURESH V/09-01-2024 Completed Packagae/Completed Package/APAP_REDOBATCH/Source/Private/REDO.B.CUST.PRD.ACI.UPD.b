* @ValidationCode : MjoxODkxNjU2Nzc5OkNwMTI1MjoxNzAzNTcyMTYwNDc2OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 11:59:20
...
*26/12/2023         Suresh                R22 Manual Conversion    Change F.READ to F.READU, = TO EQ
...
*       IF BASIC.INT.CTR = 500 THEN
        IF BASIC.INT.CTR EQ 500 THEN ;*R22 Manual Conversion
            BASIC.INT.CTR = 1
        END

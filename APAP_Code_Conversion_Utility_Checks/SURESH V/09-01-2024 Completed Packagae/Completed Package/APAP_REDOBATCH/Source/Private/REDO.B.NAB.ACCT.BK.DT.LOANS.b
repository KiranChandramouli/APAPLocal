* @ValidationCode : MjotMTE0NzgzODg4MTpDcDEyNTI6MTcwNDE5NTY2NjA4OTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 02 Jan 2024 17:11:06
...
*    $INSERT I_F.AA.SCHEDULED.ACTIVITY ;*R22 Manual Conversion
    $USING AC.API
    $USING AA.Framework
...
*    ARR.ACCOUNT.ID = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID>
    ARR.ACCOUNT.ID = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId> ;*R22 Manual Conversion
...
*    CALL F.READ(FN.AA.SCH.ACT,ARR.ID,R.AA.SCH.ACT,F.AA.SCH.ACT,SCH.ERR)
    R.AA.SCH.ACT=AA.Framework.Arrangement.Read(ARR.ID, SCH.ERR) ;*R22 Manual Conversion
...
*   CALL F.READ(FN.ACCOUNT,Y.LOAN.ACC,R.ACCOUNT,F.ACCOUNT,ACC.ERR)
    R.ACCOUNT=AA.Framework.Arrangement.Read(Y.LOAN.ACC, ACC.ERR) ;*R22 Manual Conversion

* @ValidationCode : MjotMTUzMTA5NDI3OTpDcDEyNTI6MTcwMzU3NzY0MDIwODozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Dec 2023 13:30:40
...
*26/12/2023         Suresh                R22 Manual Conversion  CALL routine modified, Change F.READ to F.READU
*-------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_GTS.COMMON
...
*  CALL F.READ(FN.REDO.W.DIRECT.DEBIT,Y.REJ.ID,R.REDO.W.DIRECT.DEBIT.REJ,F.REDO.W.DIRECT.DEBIT,Y.ER.RJ)
            CALL F.READU(FN.REDO.W.DIRECT.DEBIT,Y.REJ.ID,R.REDO.W.DIRECT.DEBIT.REJ,F.REDO.W.DIRECT.DEBIT,Y.ER.RJ,"") ;*R22 Manual Conversion
...
*   CALL F.READ(FN.FTTC,'ACPY',R.FTTC,F.FTTC,Y.ERR)
    CALL F.READ(FN.FTTC,'ACPY',R.FTTC,F.FTTC,Y.ERR) ;*R22 Manual Conversion

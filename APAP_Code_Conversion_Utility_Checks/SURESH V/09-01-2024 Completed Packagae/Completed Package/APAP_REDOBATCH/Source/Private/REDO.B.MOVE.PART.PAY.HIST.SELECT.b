* @ValidationCode : MjoxMzQ3MjIzOTY6Q3AxMjUyOjE3MDQxOTc5MjE5MjQ6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 02 Jan 2024 17:48:41
...
*CALL BATCH.BUILD.LIST('',SEL.FT.LIST)
    EB.Service.BatchBuildList('',SEL.FT.LIST);* R22 AUTO CONVERSION
RETURN
...
*CALL BATCH.BUILD.LIST('',SEL.TT.LIST)
    EB.Service.BatchBuildList('',SEL.TT.LIST);* R22 AUTO CONVERSION
RETURN
END

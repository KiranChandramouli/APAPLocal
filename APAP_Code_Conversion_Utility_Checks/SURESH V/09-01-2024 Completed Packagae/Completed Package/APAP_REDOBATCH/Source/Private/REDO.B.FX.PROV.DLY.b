* @ValidationCode : MjotMTg4MTk5MDI5NjpDcDEyNTI6MTcwMzY1Mzk4NDEwNjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Dec 2023 10:43:04
...
*    AA.Framework.Arrangement.Read(Y.AA.ID, Y.AA.ERR)
    R.AA.ARRANGEMENT=AA.Framework.Arrangement.Read(Y.AA.ID, Y.AA.ERR);*R22 Manual Conversion
...
*       Y.ACCT.NO  = R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID>
        Y.ACCT.NO  = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId> ;*R22 Manual Conversion
    END
...
*    CALL AA.GET.PERIOD.BALANCES(Y.ACCT.NO, BALANCE.TO.CHECK, DATE.OPTIONS, EFFECTIVE.DATE, "", "", BAL.DETAILS, "")
    AA.Framework.GetPeriodBalances(Y.ACCT.NO, BALANCE.TO.CHECK, DATE.OPTIONS, EFFECTIVE.DATE, "", "", BAL.DETAILS, "") ;*R22 Manual Conversion

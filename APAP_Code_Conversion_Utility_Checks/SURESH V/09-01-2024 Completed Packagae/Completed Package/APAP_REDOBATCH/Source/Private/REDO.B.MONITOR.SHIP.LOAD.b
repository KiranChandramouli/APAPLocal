* @ValidationCode : MjotMTE4MjY1NDE1MDpDcDEyNTI6MTcwNDM2ODAwNjMxODozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:03:26
...
*CALL CACHE.READ(FN.REDO.MON.CONNECTION,'SYSTEM',R.CONNECTION,YERR.CONN)
    ...
    CALL CACHE.READ(FN.REDO.MON.CONNECTION,IDVAR.1,R.CONNECTION,YERR.CONN);* R22 AUTO CONVERSION

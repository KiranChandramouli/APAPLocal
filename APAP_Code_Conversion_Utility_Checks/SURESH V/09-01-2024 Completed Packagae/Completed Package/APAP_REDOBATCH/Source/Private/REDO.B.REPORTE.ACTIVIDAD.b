* @ValidationCode : MjotMTM1NzIxOTM3MDpDcDEyNTI6MTcwNDQzNjEwMzI4OTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jan 2024 11:58:23
...
*    CALL F.READ(FN.AA.ARRANGEMENT,AA.ARR.ID,R.AA.ARR,F.AA.ARRANGEMENT,AA.ARR.ERR)
    R.AA.ARR =  AA.Framework.Arrangement.Read(AA.ARR.ID, AA.ARR.ERR) ;*R22 Manual Conversion
*    Y.LINKED.APPL = R.AA.ARR<AA.ARR.LINKED.APPL>
    Y.LINKED.APPL = R.AA.ARR<AA.Framework.ArrangementSim.ArrLinkedAppl> ;*R22 Manual Conversion
*    STAR.DATE.VAL = R.AA.ARR<AA.ARR.START.DATE>
    STAR.DATE.VAL = R.AA.ARR<AA.Framework.ArrangementSim.ArrStartDate> ;*R22 Manual Conversion
*    YAA.ARR.STAT = R.AA.ARR<AA.ARR.ARR.STATUS>
    YAA.ARR.STAT = R.AA.ARR<AA.Framework.ArrangementSim.ArrArrStatus> ;*R22 Manual Conversion
...
*        Y.ACCT.NO = R.AA.ARR<AA.ARR.LINKED.APPL.ID,Y.LINKED.POS>
        Y.ACCT.NO = R.AA.ARR<AA.Framework.ArrangementSim.ArrLinkedApplId,Y.LINKED.POS> ;*R22 Manual Conversion
    END
...
*        CALL AA.GET.PERIOD.BALANCES(Y.ACCT.NO,Y.PRIN.ID,REQUEST.TYPE,START.DATE,SYSTEM.DATE,'',BAL.DETAILS,ERR.MSG)
        AA.Framework.GetPeriodBalances(Y.ACCT.NO,Y.PRIN.ID,REQUEST.TYPE,START.DATE,SYSTEM.DATE,'',BAL.DETAILS,ERR.MSG);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotMTc5ODU5Njk1MzpDcDEyNTI6MTcwNDM2NDM5OTA1NTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:03:19
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY1',PROGRAM.EXCCONDTYPE.ESP.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.EXCCONDTYPE.ESP.LIST.ERR)
    IDVAR.1 = 'VARLY1' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.EXCCONDTYPE.ESP.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.EXCCONDTYPE.ESP.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY2',PROGRAM.APPEXC.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.APPEXC.LIST.ERR)
    IDVAR.1 = 'VARLY2' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.APPEXC.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.APPEXC.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY3',PROGRAM.EXCCONDTYPE.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.EXCCONDTYPE.LIST.ERR)
    IDVAR.1 = 'VARLY3' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.EXCCONDTYPE.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.EXCCONDTYPE.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY4',PROGRAM.INCCONDTYPE.ESP.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.INCCONDTYPE.ESP.LIST.ERR)
    IDVAR.1 = 'VARLY4' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.INCCONDTYPE.ESP.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.INCCONDTYPE.ESP.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY5',PROGRAM.APPINC.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.APPINC.LIST.ERR)
    IDVAR.1 = 'VARLY5' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.APPINC.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.APPINC.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY6',PROGRAM.INCCONDTYPE.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.INCCONDTYPE.LIST.ERR)
    IDVAR.1 = 'VARLY6' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,PROGRAM.INCCONDTYPE.LIST,F.TEMP.LY.GET.TXN.M,PROGRAM.INCCONDTYPE.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY7',MODALITY.CCY.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.CCY.LIST.ERR)
    IDVAR.1 = 'VARLY7' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.CCY.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.CCY.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY8',MODALITY.ID.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.ID.LIST.ERR)
    IDVAR.1 = 'VARLY8' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.ID.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.ID.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY9',MODALITY.APP.TXN.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.APP.TXN.LIST.ERR)
    IDVAR.1 = 'VARLY9' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.APP.TXN.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.APP.TXN.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY10',MODALITY.TXN.CODE.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.TXN.CODE.LIST.ERR)
    IDVAR.1 = 'VARLY10' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.TXN.CODE.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.TXN.CODE.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY11',MODALITY.FORM.GEN.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.FORM.GEN.LIST.ERR)
    IDVAR.1 = 'VARLY11' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.FORM.GEN.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.FORM.GEN.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY12',MODALITY.CHANNEL.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.CHANNEL.LIST.ERR)
    IDVAR.1 = 'VARLY12' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.CHANNEL.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.CHANNEL.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY13',MODALITY.MINDISAMT.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.MINDISAMT.LIST.ERR)
    IDVAR.1 = 'VARLY13' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.MINDISAMT.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.MINDISAMT.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY14',MODALITY.GEN.AMT.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.GEN.AMT.LIST.ERR)
    IDVAR.1 = 'VARLY14' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.GEN.AMT.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.GEN.AMT.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY15',MODALITY.PROD.TYPE.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.PROD.TYPE.LIST.ERR)
    IDVAR.1 = 'VARLY15' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.PROD.TYPE.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.PROD.TYPE.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY16',MODALITY.PROD.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.PROD.LIST.ERR)
    IDVAR.1 = 'VARLY16' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.PROD.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.PROD.LIST.ERR);* R22 AUTO CONVERSION
...
*CALL F.READ(FN.TEMP.LY.GET.TXN.M,'VARLY17',MODALITY.GEN.FACT.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.GEN.FACT.LIST.ERR)
    IDVAR.1 = 'VARLY17' ;* R22 AUTO CONVERSION
    CALL F.READ(FN.TEMP.LY.GET.TXN.M,IDVAR.1,MODALITY.GEN.FACT.LIST,F.TEMP.LY.GET.TXN.M,MODALITY.GEN.FACT.LIST.ERR);* R22 AUTO CONVERSION

* @ValidationCode : MjotMTM0MjU5MTQ1MjpDcDEyNTI6MTcwNDQ1OTQzMDY5NzozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Jan 2024 18:27:10
...
*    CALL CACHE.READ(FN.REDO.APAP.H.PRODUCT.DEFINE,'SYSTEM',R.REDO.APAP.H.PRODUCT.DEFINE,REDO.APAP.H.PRODUCT.DEFINE.ERR)
    ...
    CALL CACHE.READ(FN.REDO.APAP.H.PRODUCT.DEFINE,IDVAR.1,R.REDO.APAP.H.PRODUCT.DEFINE,REDO.APAP.H.PRODUCT.DEFINE.ERR);* R22 UTILITY AUTO CONVERSION

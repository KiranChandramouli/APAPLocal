* @ValidationCode : MjotMjA1NDUyMTI5ODpDcDEyNTI6MTcwNDM2NTE3Mjk0NjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 04 Jan 2024 16:16:12
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'MOD',PRG.MOD.LST);*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.MOD.LST);*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'NOPRG',PRG.PER.MOD);*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.PER.MOD);*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'PRG',PRG.LST);*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.LST);*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'ST.DATE',PRG.ST.DATE.LST);* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.ST.DATE.LST);* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'END.DATE',PRG.END.DATE.LST);* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.END.DATE.LST);* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'DAYS.EXP',PRG.DAYS.EXP.LST);* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.DAYS.EXP.LST);* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'EXP.DATE',PRG.EXP.DATE.LST);* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.EXP.DATE.LST);* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'CUS.GROUP',PRG.CUS.GRP.LST);* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.CUS.GRP.LST);* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'POINT.VALUE',PRG.POINT.VALUE.LST) ; * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.POINT.VALUE.LST) ; * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'AVAIL.IF.DELAY',PRG.AVAIL.IF.DELAY.LST); * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.AVAIL.IF.DELAY.LST); * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'POINT.USE',PRG.POINT.USE.LST); * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.POINT.USE.LST); * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'COND.TYPE.EXINC',PRG.COND.TYPE.EXINC); *Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.COND.TYPE.EXINC); *Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'APP.EXC.COND',PRG.APP.EXC.COND); * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.APP.EXC.COND); * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'EXC.EST.ACCT',PRG.EXC.EST.ACCT);* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.EXC.EST.ACCT);* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'APP.INC.COND',PRG.APP.INC.COND); * Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.APP.INC.COND); * Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'INC.EST.ACCT',PRG.INC.EST.ACCT) ;* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.INC.EST.ACCT) ;* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'AIR',PRG.AIR.LST) ;*Tus  End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.AIR.LST) ;*Tus  End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'MOD.TYPE',PRG.MOD.TYP) ;* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.MOD.TYP) ;* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'MOD.EVENT',PRG.MOD.EVE);* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.MOD.EVE);* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'PTS.IN.MOD',PRG.PTS.IN.MOD) ;* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.PTS.IN.MOD) ;* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'PROD',PRG.PROD.LST);* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.PROD.LST);* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'MIN.GEN.IN.MOD',PRG.MINGEN.IN.MOD);* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.MINGEN.IN.MOD);* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'MAX.GEN.IN.MOD',PRG.MAXGEN.IN.MOD) ;* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.MAXGEN.IN.MOD) ;* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'FORM.GEN.IN.MOD',PRG.FORM.GEN.IN.MOD) ;* Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.FORM.GEN.IN.MOD) ;* Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'GEN.AMT.IN.MOD',PRG.GEN.AMT.IN.MOD) ;*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.GEN.AMT.IN.MOD) ;*Tus End;* R22 AUTO CONVERSION
...
*CALL F.WRITE(FN.TEMP.LY.POINT.GEN,'CCY.IN.MOD',PRG.CCY.IN.MOD) ;*Tus End
    ...
    CALL F.WRITE(FN.TEMP.LY.POINT.GEN,IDVAR.1,PRG.CCY.IN.MOD) ;*Tus End;* R22 AUTO CONVERSION

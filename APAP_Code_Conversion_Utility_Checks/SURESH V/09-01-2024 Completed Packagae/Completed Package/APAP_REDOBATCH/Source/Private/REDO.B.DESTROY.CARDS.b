* @ValidationCode : MjotMTM0OTY1ODU6Q3AxMjUyOjE3MDM1ODE3NDA5Njg6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Dec 2023 14:39:00
...
* CALL F.READ(FN.REDO.CARD.HIS,Y.DH.SEL.LIST,R.REDO.CARD.HIS,F.REDO.CARD.HIS,Y.ERR.CARD.GEN)
    CALL F.READU(FN.REDO.CARD.HIS,Y.DH.SEL.LIST,R.REDO.CARD.HIS,F.REDO.CARD.HIS,Y.ERR.CARD.GEN,"") ;*R22 Manual Conversion
...
* CALL F.READ(FN.REDO.STOCK.QTY.COUNT,Y.ID.ST.QTY.COUNT,R.REDO.STOCK.QTY.COUNT,F.REDO.STOCK.QTY.COUNT,ERR)
    CALL F.READU(FN.REDO.STOCK.QTY.COUNT,Y.ID.ST.QTY.COUNT,R.REDO.STOCK.QTY.COUNT,F.REDO.STOCK.QTY.COUNT,ERR,"") ;*R22 Manual Conversion
...
*    CALL F.READ(FN.REDO.CARD.NO.LOCK,CARD.NO.ID,R.REDO.CARD.NO.LOCK,F.REDO.CARD.NO.LOCK,Y.ERR.CARD.LOCK)
    CALL F.READU(FN.REDO.CARD.NO.LOCK,CARD.NO.ID,R.REDO.CARD.NO.LOCK,F.REDO.CARD.NO.LOCK,Y.ERR.CARD.LOCK,"") ;*R22 Manual Conversion

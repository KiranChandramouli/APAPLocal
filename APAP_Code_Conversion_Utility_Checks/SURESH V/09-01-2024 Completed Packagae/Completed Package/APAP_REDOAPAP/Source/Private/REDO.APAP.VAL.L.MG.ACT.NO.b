* @ValidationCode : MjoxOTM2OTI1MjIzOkNwMTI1MjoxNjg0ODM2MDU0NzE3OklUU1M6LTE6LTE6MjY2OjE6ZmFsc2U6Ti9BOlIyMl9BTVIuMDotMTotMQ==
...
***********************
    ...
    IF R.REDO.APAP.MORTGAGES.DETAIL THEN
        ...
        REPEAT
    END
*APAP.REDOAPAP.REDO.APAP.VAL.FHA.DETS
    APAP.REDOAPAP.redoApapValFhaDets()
RETURN
*---------------------------------------------------------------------------------------------------------------------------------
END

* @ValidationCode : MjoxOTA2NjQ4NTYzOkNwMTI1MjoxNzA0NzA4NzEzODk1OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
* @ValidationInfo : Timestamp         : 08 Jan 2024 15:41:53
...
*    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,'SYSTEM',R.REDO.APAP.CLEAR.PARAM,Y.ERR)
    ...
    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,IDVAR.1,R.REDO.APAP.CLEAR.PARAM,Y.ERR);* R22 UTILITY AUTO CONVERSION
...
*    CALL CACHE.READ(FN.REDO.APAP.H.PARAMETER,"SYSTEM",R.REDO.APAP.H.PARAMETER,PARAM.ERR)
    IDVAR.1 = "SYSTEM" ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.APAP.H.PARAMETER,IDVAR.1,R.REDO.APAP.H.PARAMETER,PARAM.ERR);* R22 UTILITY AUTO CONVERSION
...
*    CALL CACHE.READ(FN.REDO.ACCT.STATUS.CODE,"SYSTEM",R.REDO.ACCT.STATUS.CODE,Y.ERR)
    IDVAR.1 = "SYSTEM" ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.ACCT.STATUS.CODE,IDVAR.1,R.REDO.ACCT.STATUS.CODE,Y.ERR);* R22 UTILITY AUTO CONVERSION
    IF Y.ERR EQ '' THEN

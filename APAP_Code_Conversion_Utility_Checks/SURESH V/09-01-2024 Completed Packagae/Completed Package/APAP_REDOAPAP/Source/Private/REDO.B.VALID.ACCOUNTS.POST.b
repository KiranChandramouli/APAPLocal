* @ValidationCode : Mjo5NzI1Mzk1MTM6Q3AxMjUyOjE3MDQ3MDg3OTE1ODA6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 08 Jan 2024 15:43:11
...
*    CALL CACHE.READ(FN.REDO.APAP.H.PARAMETER,'SYSTEM',R.REDO.APAP.H.PARAMETER,PARAM.ERR) ; * Tus End
    ...
    CALL CACHE.READ(FN.REDO.APAP.H.PARAMETER,IDVAR.1,R.REDO.APAP.H.PARAMETER,PARAM.ERR) ; * Tus End;* R22 UTILITY AUTO CONVERSION

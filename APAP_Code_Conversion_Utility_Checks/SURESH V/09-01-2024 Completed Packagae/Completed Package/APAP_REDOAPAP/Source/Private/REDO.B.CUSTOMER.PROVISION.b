* @ValidationCode : MjotMTE3NDM1NDAyNTpDcDEyNTI6MTcwMzU3NTc1Mjg2ODozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Dec 2023 12:59:12
...
*   $INSERT I_F.AA.ACTIVITY.HISTORY ;*R22 Manual Conversion
...
*        CALL F.READ(FN.AA.ARRANGEMENT,Y.AA.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,ARR.ERRR)
        AA.Framework.Arrangement.Read(Y.AA.ID, ARR.ERRR) ;*R22 Manual Conversion
*       Y.CURRENCY = R.AA.ARRANGEMENT<AA.ARR.CURRENCY>
        Y.CURRENCY = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCurrency > ;*R22 Manual Conversion
*       Y.LOAN.AA.TYPE = R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP>
        Y.LOAN.AA.TYPE = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup> ;*R22 Manual Conversion
        GOSUB GROUP.LOANS
...
*   CALL F.READ(FN.REDO.H.CUSTOMER.PROVISIONING,Y.CUS.ID,R.REDO.H.CUSTOMER.PROVISIONING,F.REDO.H.CUSTOMER.PROVISIONING, PROV.ERR)
    CALL F.READU(FN.REDO.H.CUSTOMER.PROVISIONING,Y.CUS.ID,R.REDO.H.CUSTOMER.PROVISIONING,F.REDO.H.CUSTOMER.PROVISIONING, PROV.ERR,"") ;*R22 Manual Conversion
...
*    R.REDO.H.CUSTOMER.PROVISIONING<REDO.CUS.PROV.ARR.LOAN.TYPE,-1>     = R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP>
    R.REDO.H.CUSTOMER.PROVISIONING<REDO.CUS.PROV.ARR.LOAN.TYPE,-1>     = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup> ;*R22 Manual Conversion
*   R.REDO.H.CUSTOMER.PROVISIONING<REDO.CUS.PROV.CURRENCY,-1>          = R.AA.ARRANGEMENT<AA.ARR.CURRENCY>
    R.REDO.H.CUSTOMER.PROVISIONING<REDO.CUS.PROV.CURRENCY,-1>          = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCurrency> ;*R22 Manual Conversion
...
*    IF R.AA.ARRANGEMENT<AA.ARR.CURRENCY> EQ 'DOP' OR R.AA.ARRANGEMENT<AA.ARR.CURRENCY> EQ '' THEN
    IF R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCurrency> EQ 'DOP' OR R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCurrency> EQ '' THEN  ;*R22 Manual Conversion
        RETURN
    END ELSE
*       Y.CURRENCY = R.AA.ARRANGEMENT<AA.ARR.CURRENCY>
        Y.CURRENCY = R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCurrency> ;*R22 Manual Conversion

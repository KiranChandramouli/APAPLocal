* @ValidationCode : MjotMTU4NDA4OTAwMTpDcDEyNTI6MTcwNDE3ODkyMjY3NjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 02 Jan 2024 12:32:02
...
*02/01/2024         Suresh                R22 Manual Conversion  IDVAR Variable Changed
*---------------------------------------------------------------------------------------------
...
*    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,'SYSTEM',R.REDO.APAP.CLEAR.PARAM,PARAM.ERR)
    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,IDVAR,R.REDO.APAP.CLEAR.PARAM,PARAM.ERR) ;*R22 Manual Conversion
    
    IDVAR='SYSTEM'
*   CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,'SYSTEM',R.REDO.H.AA.DIS.CHG,PRE.ERR)
    CALL CACHE.READ(FN.REDO.H.AA.DIS.CHG,IDVAR,R.REDO.H.AA.DIS.CHG,PRE.ERR) ;*R22 Manual Conversion

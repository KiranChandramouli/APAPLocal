* @ValidationCode : MjotMTY1NTIyNDcyMTpDcDEyNTI6MTcwMzY3MjkzMjczNjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Dec 2023 15:58:52
...
*    CALL F.READ(FN.REDO.ACH.PROC.IDS,TODAY,R.REDO.ACH.PROC.IDS,F.REDO.ACH.PROC.IDS,ID.ERR)
    CALL F.READU(FN.REDO.ACH.PROC.IDS,TODAY,R.REDO.ACH.PROC.IDS,F.REDO.ACH.PROC.IDS,ID.ERR,"") ;*R22 Manual Conversion
...
*       CALL F.READ(FN.REDO.ACH.PROCESS,FETCH.ID,R.REDO.ACH.PROCESS,F.REDO.ACH.PROCESS,Y.ERR.ACH.PROC)
        CALL F.READU(FN.REDO.ACH.PROCESS,FETCH.ID,R.REDO.ACH.PROCESS,F.REDO.ACH.PROCESS,Y.ERR.ACH.PROC,"") ;*R22 Manual Conversion

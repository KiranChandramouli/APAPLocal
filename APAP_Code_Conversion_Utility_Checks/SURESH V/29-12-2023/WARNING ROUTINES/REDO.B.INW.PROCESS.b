* @ValidationCode : MjotMTYzMTUyOTMzOkNwMTI1MjoxNzAzODQ2MjE2MzM4OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 29 Dec 2023 16:06:56
...
*       CALL F.READ(FN.REDO.ADMIN.CHQ.DETAILS,VAL.CHEQUE.NUMBER,R.REDO.ADMIN.CHQ.DETAILS,F.REDO.ADMIN.CHQ.DETAILS,CHQ.DET.ERR)
        CALL F.READU(FN.REDO.ADMIN.CHQ.DETAILS,VAL.CHEQUE.NUMBER,R.REDO.ADMIN.CHQ.DETAILS,F.REDO.ADMIN.CHQ.DETAILS,CHQ.DET.ERR,"") ;*R22 Manual Conversion
...
*        CALL F.READ(FN.CERTIFIED.CHEQUE.DETAILS,VAL.CHEQUE.NUMBER,R.CERTIFIED.CHEQUE.DETAILS,F.CERTIFIED.CHEQUE.DETAILS,CERTIFIED.CHEQUE.DETAILS.ERR)
        CALL F.READU(FN.CERTIFIED.CHEQUE.DETAILS,VAL.CHEQUE.NUMBER,R.CERTIFIED.CHEQUE.DETAILS,F.CERTIFIED.CHEQUE.DETAILS,CERTIFIED.CHEQUE.DETAILS.ERR,"") ;*R22 Manual Conversion

* @ValidationCode : Mjo4NzY0OTQzMTpDcDEyNTI6MTcwMzY3NDQwNTI0MzozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Dec 2023 16:23:25
...
*    CALL CACHE.READ(FN.REDO.W.ACCOUNT.UPDATE,'SYSTEM',R.REDO.W.ACCOUNT.UPDATE,Y.ERR)
    CALL CACHE.READ(FN.REDO.W.ACCOUNT.UPDATE,IDVAR,R.REDO.W.ACCOUNT.UPDATE,Y.ERR) ;*R22 Manual Conversion
    IDVAR='SYSTEM' ;*R22 Manual Conversion
*    CALL CACHE.READ(FN.REDO.APAP.PARAM,'SYSTEM',R.REDO.APAP.PARAM,PARAM.ERR)
    CALL CACHE.READ(FN.REDO.APAP.PARAM,IDVAR,R.REDO.APAP.PARAM,PARAM.ERR) ;*R22 Manual Conversion

* @ValidationCode : Mjo5MzQxNzU5OTY6Q3AxMjUyOjE3MDI2NDE3Mzk5MjY6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Dec 2023 17:32:19
...
*14/12/2023       Suresh                      R22 Manual Conversion        Change F.READ to CACHE.READ
*----------------------------------------------------------------------------------------
...
*   CALL F.READ(FN.DR.REGREP.PARAM,REGREP.SYS.ID,R.REGREP.SYSTEM,F.DR.REGREP.PARAM,ERR.REGREP.SYSTEM)
    CALL CACHE.READ(FN.DR.REGREP.PARAM,REGREP.SYS.ID,R.REGREP.SYSTEM,ERR.REGREP.SYSTEM) ;*R22 Manual Conversion

* @ValidationCode : MjoxMjYxMzU5MjU5OkNwMTI1MjoxNzAyNjIzODA1NjU5OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 Dec 2023 12:33:25
...
$PACKAGE APAP.DRREG
SUBROUTINE DR.REG.RIEN5.EXT.OUT3
*----------------------------------------------------------------------------------------------------------------------------------
*
...
***********
    ...
    FN.DR.REG.RIEN5.REP3 = 'F.DR.REG.RIEN5.REP3'
    F.DR.REG.RIEN5.REP3 = ''
...
*
    ...
    SEL.CMD1 = "SELECT ":FN.DR.REG.RIEN5.REP3:" BY RATE"
    ...
    WHILE ID.CTR1 LE ID.CNT1
        ...
        R.DR.REG.RIEN5.REP3 = ''; DR.REG.RIEN5.REP3.ERR = ''; DR.REG.RIEN5.REP3.1 = ''
        CALL F.READ(FN.DR.REG.RIEN5.REP3,AZ.ID,R.DR.REG.RIEN5.REP3,F.DR.REG.RIEN5.REP3,DR.REG.RIEN5.REP3.ERR)
        CALL F.READ(FN.DR.REG.RIEN5.REP3,NEXT.AZ.ID,R.DR.REG.RIEN5.REP3.1,F.DR.REG.RIEN5.REP3,DR.REG.RIEN5.REP3.ERR)
        CURR.RATE = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RATE>
        NEXT.RATE = R.DR.REG.RIEN5.REP3.1<DR.RIEN5.REP3.RATE>
        GOSUB GET.CURR.BAL
...
GET.CURR.BAL:
*-----------*
    CURR.BAL1 = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RANGE.0.15>
    CURR.BAL2 = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RANGE.16.30>
    CURR.BAL3 = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RANGE.31.60>
    CURR.BAL4 = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RANGE.61.90>
    CURR.BAL5 = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RANGE.91.180>
    CURR.BAL6 = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RANGE.181.360>
    CURR.BAL7 = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RANGE.361.720>
    CURR.BAL8 = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RANGE.721.1080>
    CURR.BAL9 = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RANGE.1081.1440>
    CURR.BAL10 = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RANGE.1441.1800>
    CURR.BAL11 = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.RANGE.1881>
    CURR.INDET.BAL = R.DR.REG.RIEN5.REP3<DR.RIEN5.REP3.INDETERMINATE>   ;* PACS00309203 - Indeterminado field
RETURN
*-------------------------------------------------------------------
SUM.BALANCE:
*----------*

* @ValidationCode : MjoxOTQ0NzcwNjA2OkNwMTI1MjoxNzAyNTUxMDQyNDc2OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 14 Dec 2023 16:20:42
...
*
    ...
    APAP.LAPAP.drReg213if02GetCustType(CUSTOMER.TYPE,TIPO.CL.POS);*R22 AUTO CODE CONVERSION
...
****************
    ...
    CALL CACHE.READ(FN.DR.REG.IF02B.EXTRACT,IDVAR,R.DR.REG.IF02B.EXTRACT,DR.REG.IF02B.EXTRACT.ERR) ;*R22 Manual Conversion

* @ValidationCode : Mjo4MDAwNTMzNjY6Q3AxMjUyOjE3MDQzNjc5OTAzMDY6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jan 2024 17:03:10
...
*CALL F.READ(FN.REDO.MON.SEND.QUEUE, MSG.ID, R.MSG, F.REDO.MON.SEND.QUEUE, ERR.READ)
    CALL F.READU(FN.REDO.MON.SEND.QUEUE, MSG.ID, R.MSG, F.REDO.MON.SEND.QUEUE, ERR.READ,'');* R22 AUTO CONVERSION
*
    IF ERR.READ THEN

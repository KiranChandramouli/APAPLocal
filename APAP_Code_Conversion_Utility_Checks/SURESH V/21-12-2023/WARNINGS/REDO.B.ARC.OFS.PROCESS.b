* @ValidationCode : MjoxMjkxOTU4NzE6Q3AxMjUyOjE3MDMxNDkzMzIyODg6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 21 Dec 2023 14:32:12
...
*18/12/2023           Suresh               R22 Manual Conversion  -CALL routine modified, Changed F.READ Variable
*------------------------------------------------------------------------------------------
...
*     CALL F.READ(FN.AI.REDO.OFS.QUEUE,ARC.OFS.ID,OFS.STRING,F.AI.REDO.OFS.QUEUE,OFS.STRING.ERR)
        CALL F.READU(FN.AI.REDO.OFS.QUEUE,ARC.OFS.ID,OFS.STRING,F.AI.REDO.OFS.QUEUE,OFS.STRING.ERR,"") ;*R22 Manual Conversion

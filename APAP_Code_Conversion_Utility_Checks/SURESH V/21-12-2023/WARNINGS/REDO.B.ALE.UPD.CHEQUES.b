* @ValidationCode : MjotMjc1ODQ1NzA4OkNwMTI1MjoxNzAzMTQ5NTc5ODQ3OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIyX1NQNS4wOi0xOi0x
...
*20/12/2023           Suresh              R22 Manual Conversion Changed the F.READ Variable
*------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.ACCOUNT
...
*CALL F.READ(FN.REDO.GAR.LOCK.ALE,Y.AFG.CUST,R.REDO.GAR.LOCK.ALE,F.REDO.GAR.LOCK.ALE,ERR)
    CALL F.READU(FN.REDO.GAR.LOCK.ALE,Y.AFG.CUST,R.REDO.GAR.LOCK.ALE,F.REDO.GAR.LOCK.ALE,ERR,"") ;*R22 Manual Conversion

* @ValidationCode : Mjo1ODA2MDYxODc6Q3AxMjUyOjE3MDI5NjM4NTQ2OTI6MzMzc3U6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 Dec 2023 11:00:54
...
*   CALL OFS.CALL.BULK.MANAGER(OFS.SOURCE.ID,Y.MESSAGE,Y.RESPONSE, Y.TXN.COMMITTED)
    EB.Interface.OfsCallBulkManager(OFS.SOURCE.ID,Y.MESSAGE,Y.RESPONSE, Y.TXN.COMMITTED) ;*R22 Manual Conversion

* @ValidationCode : MjotMTYwNDAwNjE3MDpDcDEyNTI6MTcwMzE1MjU0MjQxOTpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 15:25:42
...
*20-12-2023      HARISHVIKRAM                R22 Manual Conversion      ID.VAR Initialised
*----------------------------------------------------------------------------------------
...
*        CALL CACHE.READ(FN.CENTRAL.BANK,'SYSTEM',R.CENTRAL.BANK,Y.ERR.CENTRAL.BANK)
        CALL CACHE.READ(FN.CENTRAL.BANK,'SYSTEM',R.CENTRAL.BANK,Y.ERR.CENTRAL.BANK)    ;* R22 Manual Conversion

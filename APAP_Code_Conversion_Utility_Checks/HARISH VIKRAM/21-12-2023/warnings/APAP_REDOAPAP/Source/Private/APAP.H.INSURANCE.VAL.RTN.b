* @ValidationCode : MjotMTU0NDM5MzMxOTpDcDEyNTI6MTcwMzE1MTczODc5MDpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 15:12:18
...
*            CALL F.READ(FN.INS.COMB,ID.INS.COMB,R.INS.COMB,F.INS.COMB,INS.COMB.ERR)
            CALL CACHE.READ(FN.INS.COMB,ID.INS.COMB,R.INS.COMB,INS.COMB.ERR)    ;*R22 Manual Conversion

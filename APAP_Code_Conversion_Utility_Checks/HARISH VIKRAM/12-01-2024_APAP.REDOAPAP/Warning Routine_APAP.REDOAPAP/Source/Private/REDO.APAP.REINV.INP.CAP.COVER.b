* @ValidationCode : MjoxNDUwMzk3NzM1OlVURi04OjE3MDUwNDg2MjgzOTQ6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 12 Jan 2024 14:07:08
...
*CALL CACHE.READ('F.AZ.PRODUCT.PARAMETER',APP.ID,R.APP,ARR.ERR)
    FN.AZ.PRODUCT.PARAMETER = 'F.AZ.PRODUCT.PARAMETER';* R22 Utility Changes
    CALL CACHE.READ(FN.AZ.PRODUCT.PARAMETER,APP.ID,R.APP,ARR.ERR);* R22 Utility Changes

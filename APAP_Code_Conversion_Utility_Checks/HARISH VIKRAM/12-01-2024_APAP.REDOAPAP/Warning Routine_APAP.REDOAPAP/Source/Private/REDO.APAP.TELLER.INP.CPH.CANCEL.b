* @ValidationCode : MjotOTQxMDMxOTY1OlVURi04OjE3MDUzODEzNDYzNjQ6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 Jan 2024 10:32:26
...
*CALL F.READ(FN.REDO.APAP.MORTGAGES.DETAIL,Y.MG.DET.ID,R.REDO.APAP.MORTGAGES.DETAIL,F.REDO.APAP.MORTGAGES.DETAIL,Y.REDO.APAP.MORTGAGES.DETAIL.ERR)
    CALL F.READU(FN.REDO.APAP.MORTGAGES.DETAIL,Y.MG.DET.ID,R.REDO.APAP.MORTGAGES.DETAIL,F.REDO.APAP.MORTGAGES.DETAIL,Y.REDO.APAP.MORTGAGES.DETAIL.ERR,'');* R22 Utility Changes
    GOSUB ASSIGN.VALUES
RETURN
*--------------------------------------------------------------------------------
**********

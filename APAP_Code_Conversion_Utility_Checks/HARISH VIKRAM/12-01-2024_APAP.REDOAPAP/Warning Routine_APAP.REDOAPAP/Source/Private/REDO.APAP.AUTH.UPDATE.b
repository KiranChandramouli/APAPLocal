* @ValidationCode : MjotMTI5NTUxMzQwNDpDcDEyNTI6MTcwMzE2MzgwNzgzNDpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 18:33:27
...
*    CALL F.READ(FN.FX.DEAL.ID.LOG, Y.ID, R.REC.FX.DEAL.ID.LOG, F.FX.DEAL.ID.LOG, Y.ERR.FX.DEAL.ID.LOG)
    CALL F.READU(FN.FX.DEAL.ID.LOG, Y.ID, R.REC.FX.DEAL.ID.LOG, F.FX.DEAL.ID.LOG, Y.ERR.FX.DEAL.ID.LOG,"")   ;*R22 Manual Conversion
*

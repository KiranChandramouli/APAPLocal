* @ValidationCode : MjotMTI4MzA3MTMxMDpDcDEyNTI6MTcwMzc2MzkwMjk3OTpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 28 Dec 2023 17:15:02
...
*    CALL F.READ(FN.REDO.APAP.MORTGAGES.DETAIL,Y.MG.DET.ID,R.REDO.APAP.MORTGAGES.DETAIL,F.REDO.APAP.MORTGAGES.DETAIL,Y.REDO.APAP.MORTGAGES.DETAIL.ERR)
    CALL F.READU(FN.REDO.APAP.MORTGAGES.DETAIL,Y.MG.DET.ID,R.REDO.APAP.MORTGAGES.DETAIL,F.REDO.APAP.MORTGAGES.DETAIL,Y.REDO.APAP.MORTGAGES.DETAIL.ERR,'')    ;*R22 Manual Conversion
    GOSUB ASSIGN.VALUES
RETURN
*--------------------------------------------------------------------------------
**********

* @ValidationCode : Mjo4NDQ0OTI4ODc6Q3AxMjUyOjE3MDMxODE0MjQyMDU6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 23:27:04
...
*21-12-2023      HARISHVIKRAM                 R22 Manual conversion     BATCH.BUILD.LIST changed, F.READ to F.READU
...
*    CALL F.READ(FN.REDO.LOCK.EXP.LIST, L.WORK.DATE, R.REDO.EXP.LIST, F.REDO.LOCK.EXP.LIST, Err)
    CALL F.READU(FN.REDO.LOCK.EXP.LIST, L.WORK.DATE, R.REDO.EXP.LIST, F.REDO.LOCK.EXP.LIST, Err,"") ;*R22 Manual Conversion

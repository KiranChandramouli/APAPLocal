* @ValidationCode : MjotMTU1NDY1NzExMTpDcDEyNTI6MTY5ODc1MDY3Mzg3MDpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
RETRIEVE.OVERRIDES:
    ...
    FOR OFLD.CNT = 1 TO NO.OF.OFIELDS
        ...
        BEGIN CASE
            CASE OFS.FLD.NAME EQ 'OVERRIDE'
                OFS.OVERRIDES<1,-1> = OFS.FLD.VAL['=',2,1]
            CASE OFS.FLD.NAME EQ 'CO.CODE'

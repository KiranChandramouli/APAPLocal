...
*26/10/2023         Suresh             R22 Manual Conversion             GLOBUS.BP File Removed,ID.VAR Initialised, USPLATFORM.BP  File Removed, FM TO @FM, VM TO @VM
...
*            CALL EB.READLIST(SEL.TFST,TFS$TFS.TRANSACTIONS,'','','')
            ...
            CALL CACHE.READ(FN.TFST,ID.VAR,TFS$TFS.TRANSACTIONS,'')      ;*;*R22 Manual Conversion
* 20100624 umar - end

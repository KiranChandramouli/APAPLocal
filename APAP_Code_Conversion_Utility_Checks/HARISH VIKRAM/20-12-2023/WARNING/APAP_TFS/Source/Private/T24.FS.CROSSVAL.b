...
*26/10/2023         Suresh             R22 Manual Conversion           GLOBUS.BP File Removed,CALL REBUILD.SCREEN Changed, = to EQ,USPLATFORM.BP  File Removed, CALL routine format modified, VM TO @VM, SM TO @SM
*-----------------------------------------------------------------------
...
*23/03/09 E
    ...
    IF ETEXT THEN CALL STORE.END.ERROR ELSE
    END
...
*    IF NOT(GTSACTIVE) THEN CALL REBUILD.SCREEN
    IF NOT(GTSACTIVE) THEN EB.Display.RebuildScreen()    ;*R22 Manual Conversion

...
*24-08-2023    VICTORIA S          R22 MANUAL CONVERSION   FN VARIABLES INITIALISED
*----------------------------------------------------------------------------------------
SUBROUTINE CORR.REDO.CARD.NO.LOCK
    ...
    FN.RCNL = 'F.REDO.CARD.NO.LOCK'                     ;*R22 MANUAL CONVERSION - START
*    OPEN 'F.REDO.CARD.NO.LOCK' TO F.RCNL ELSE NULL
    OPEN FN.RCNL TO F.RCNL ELSE NULL
    
    FN.RCN = 'F.REDO.CARD.NUMBERS'
*    OPEN 'F.REDO.CARD.NUMBERS' TO F.RCN ELSE NULL
    OPEN FN.RCN TO F.RCN ELSE NULL
    
    FN.LCO = 'F.LATAM.CARD.ORDER'
*    OPEN 'F.LATAM.CARD.ORDER' TO F.LCO ELSE NULL
    OPEN FN.LCO TO F.LCO ELSE NULL
    
    FN.SL = '&SAVEDLISTS&'
*    OPEN '&SAVEDLISTS&' TO F.SL ELSE NULL
    OPEN FN.SL TO F.SL ELSE NULL                        ;*R22 MANUAL CONVERSION - END

* @ValidationCode : MjoxNTQ4NjIxNzY3OkNwMTI1MjoxNjk4NzUwNjczODg4OklUU1MxOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*26/10/2023         Ajithkumar             R22 Manual Conversion      GLOBUS.BP,USPLATFORM.BP FILE  REMOVED,FM TO @FM, VM TO @VM
*-------------------------------------------------------------------------------
...
PROCESS:
    ...
    IF TD.ID.LIST THEN
        ...
        WHILE ID.TD : MORE.IDS DO
            ...
            IF ERR.TD THEN
                E = 'EB-TFS.REC.MISS.FILE' :@FM: ID.TD :@VM: FN.TD ;*R22 Manual Conversion
            END ELSE
                DENOM.CCY = ID.TD[1,3]

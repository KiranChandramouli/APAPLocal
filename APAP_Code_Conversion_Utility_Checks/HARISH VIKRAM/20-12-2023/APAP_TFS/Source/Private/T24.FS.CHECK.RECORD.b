...
*26/10/2023         Suresh             R22 Manual Conversion             GLOBUS.BP File Removed,CALL DISPLAY.MESSAGE,USPLATFORM.BP File Removed, CALL routine format modified, FM TO @FM, VM TO @VM
*-------------------------------------------------------------------------------
    ...
    $INSERT I_F.TELLER.ID ;*R22 Manual Conversion - END
...
*        CALL DISPLAY.MESSAGE('LOADING TRANS CODES',6)
        EB.OverrideProcessing.DisplayMessage('LOADING TRANS CODES',6)     ;*R22 Manual Conversion
        SAVE.COMI = COMI ; SAVE.AF = AF ; SAVE.AV = AV ; SAVE.E = E
...
*        CALL DISPLAY.MESSAGE('',6)
        EB.OverrideProcessing.DisplayMessage('',6)        ;*R22 Manual Conversion
    END

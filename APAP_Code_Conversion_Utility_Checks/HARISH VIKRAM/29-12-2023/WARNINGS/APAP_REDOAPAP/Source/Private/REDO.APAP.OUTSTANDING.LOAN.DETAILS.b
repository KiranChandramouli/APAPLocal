* @ValidationCode : MjotMTkyODgxMTIzOkNwMTI1MjoxNzA0Njk5NDk4MjQ5OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 08 Jan 2024 13:08:18
...
*CALL CACHE.READ(FN.REDO.H.PROVISION.PARAMETER,'SYSTEM',R.REDO.H.PROVISION.PARAMETER,PARAM.ERR)
    ...
    CALL CACHE.READ(FN.REDO.H.PROVISION.PARAMETER,IDVAR.1,R.REDO.H.PROVISION.PARAMETER,PARAM.ERR);* R22 UTILITY AUTO CONVERSION
...
*CALL CACHE.READ(FN.REDO.AA.CHARGE.PARAM,'SYSTEM',R.REDO.AA.CHARGE.PARAM,PARAM.ERR)
    IDVAR.1 = 'SYSTEM' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.REDO.AA.CHARGE.PARAM,IDVAR.1,R.REDO.AA.CHARGE.PARAM,PARAM.ERR);* R22 UTILITY AUTO CONVERSION

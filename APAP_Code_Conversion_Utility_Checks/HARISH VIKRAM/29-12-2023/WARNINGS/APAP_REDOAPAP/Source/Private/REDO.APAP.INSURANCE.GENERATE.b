* @ValidationCode : MjotOTE1MDI0NzEwOkNwMTI1MjoxNzA0Njk2MTUwMjczOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 08 Jan 2024 12:12:30
...
*CALL AA.GET.ARRANGEMENT.CONDITIONS(ARR.ID, PROPERTY.CLASS, AA.PROPERTY, EFF.DATE, RET.IDS, RET.CONDITIONS, RET.ERR)
    AA.Framework.GetArrangementConditions(ARR.ID, PROPERTY.CLASS, AA.PROPERTY, EFF.DATE, RET.IDS, RET.CONDITIONS, RET.ERR);* R22 UTILITY AUTO CONVERSION
...
*CALL AA.GET.ARRANGEMENT.PROPERTIES(ARR.INFO, ARR.DATE, R.ARRANGEMENT, PROP.LIST)
    AA.Framework.GetArrangementProperties(ARR.INFO, ARR.DATE, R.ARRANGEMENT, PROP.LIST);* R22 UTILITY AUTO CONVERSION

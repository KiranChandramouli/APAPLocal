* @ValidationCode : MjozNTMxMjM3ODpDcDEyNTI6MTcwNTM4MzM0NTQyMDozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 16 Jan 2024 11:05:45
...
*        CALL F.READ(FN.ACCOUNT,Y.AC.NO,R.ACCOUNT,F.ACCOUNT,AC.ERR)
        CALL F.READU(FN.ACCOUNT,Y.AC.NO,R.ACCOUNT,F.ACCOUNT,AC.ERR,'');* R22 UTILITY AUTO CONVERSION
        Y.CK = V$FUNCTION

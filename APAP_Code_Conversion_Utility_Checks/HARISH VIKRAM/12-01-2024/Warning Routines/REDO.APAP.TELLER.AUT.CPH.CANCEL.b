* @ValidationCode : MjoxOTA2OTIzMDU4OlVURi04OjE3MDUzODE2Mjc5MTU6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 Jan 2024 10:37:07
...
*CALL F.READ(FN.REDO.APAP.CPH.DETAIL,Y.CPH.DET.ID,R.CPH.DETAIL,F.REDO.APAP.CPH.DETAIL,Y.REDO.APAP.CPH.DETAIL.ERR)
    CALL F.READU(FN.REDO.APAP.CPH.DETAIL,Y.CPH.DET.ID,R.CPH.DETAIL,F.REDO.APAP.CPH.DETAIL,Y.REDO.APAP.CPH.DETAIL.ERR,'');* R22 Utility Changes
RETURN
*--------------------------------------------------------------------------------
*************

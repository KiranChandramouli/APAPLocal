* @ValidationCode : Mjo4NzY5NDEzMDpDcDEyNTI6MTcwNTM4NTU5NDM2MjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 16 Jan 2024 11:43:14
...
*    CALL CACHE.READ(FN.REDO.PREVALANCE.STATUS,'SYSTEM',R.REDO.PREVALANCE.STATUS,F.ERR)
    ...
    CALL CACHE.READ(FN.REDO.PREVALANCE.STATUS,IDVAR.1,R.REDO.PREVALANCE.STATUS,F.ERR);* R22 UTILITY AUTO CONVERSION

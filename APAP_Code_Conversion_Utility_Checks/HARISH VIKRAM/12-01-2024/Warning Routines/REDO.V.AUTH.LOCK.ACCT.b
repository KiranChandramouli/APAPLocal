* @ValidationCode : MjotODg2MzQxOTExOkNwMTI1MjoxNzA1Mzg1NTYxMjk0OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jan 2024 11:42:41
...
*    CALL F.READ(FN.LOCKING,LOCKING.ID,R.LOCKING,F.LOCKING,LOCK.ERR)
    CALL F.READU(FN.LOCKING,LOCKING.ID,R.LOCKING,F.LOCKING,LOCK.ERR,'');* R22 UTILITY AUTO CONVERSION

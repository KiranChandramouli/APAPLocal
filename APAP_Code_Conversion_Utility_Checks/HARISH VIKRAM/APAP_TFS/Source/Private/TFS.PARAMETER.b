* @ValidationCode : MjoyOTE5MDcxMDM6Q3AxMjUyOjE2OTg3NTA2NzQ0OTI6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
* OFS.VERSION
    IF R.NEW(TFS.PAR.OFS.VERSION) THEN
        ...
        NO.OF.MVS = DCOUNT(R.NEW(AF),@VM) ;*R22 MANAUAL CODE CONVERSION

* @ValidationCode : MjotNzI5NTE1NTM6Q3AxMjUyOjE2OTg3NTA2NzI2NDQ6SVRTUzE6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
*    CALL GET.LOC.REF('T24.FUND.SERVICES','COND.LAST.NM',LAST.NM.POS)
    EB.LocalReferences.GetLocRef('T24.FUND.SERVICES','COND.LAST.NM',LAST.NM.POS)
*    CALL GET.LOC.REF('T24.FUND.SERVICES','COND.ID.TYPE',ID.TYPE.POS)
    EB.LocalReferences.GetLocRef('T24.FUND.SERVICES','COND.ID.TYPE',ID.TYPE.POS)

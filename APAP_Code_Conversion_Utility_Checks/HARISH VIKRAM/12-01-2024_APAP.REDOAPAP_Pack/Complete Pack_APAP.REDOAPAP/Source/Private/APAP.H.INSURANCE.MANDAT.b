* @ValidationCode : MjotMTczOTE4ODA5NzpDcDEyNTI6MTcwMzE1MDc4NzEzNDpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 14:56:27
...
*20-12-2023     HARISHVIKRAM                  R22 Manual Conversion      F.READ into CACHE.READ, ID.VAR initialised
*----------------------------------------------------------------------------------------
...
*    CALL F.READ(FN.INS.COMB, ID.COMB, R.COMB, F.INS.COMB, Y.APP.ERR)
    CALL CACHE.READ(FN.INS.COMB, ID.COMB, R.COMB, F.INS.COMB, Y.APP.ERR)    ;*R22 Manual Conversion
    ...
    ID.VAR = "MANAGEMENT.TYPE"
*    CALL F.READ(FN.EVENT.FIELD, "MANAGEMENT.TYPE", R.EVENT.FIELD, F.EVENT.FIELD, Y.APP.ERR)
    CALL F.READ(FN.EVENT.FIELD, ID.VAR, R.EVENT.FIELD, F.EVENT.FIELD, Y.APP.ERR)          ;* R22 Manual Conversion

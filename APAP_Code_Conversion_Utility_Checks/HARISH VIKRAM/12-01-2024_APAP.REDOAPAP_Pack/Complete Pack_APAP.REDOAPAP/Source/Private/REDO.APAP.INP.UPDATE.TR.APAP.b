* @ValidationCode : MjotMTUwMjU2NjY0MzpDcDEyNTI6MTcwNDI1ODgzMzcxNDpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 03 Jan 2024 10:43:53
...
* 29-12-2023      HARISHVIKRAM                 R22 Manual conversion       GET.LOC.REF Changed
*----------------------------------------------------------------------------------------
...
*CALL GET.LOC.REF(Y.LRF.APPL,Y.LRF.FIELDS,FIELD.POS)
    EB.LocalReferences.GetLocRef(Y.LRF.APPL,Y.LRF.FIELDS,FIELD.POS)    ;*R22 Manual Conversion
*

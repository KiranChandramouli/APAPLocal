* @ValidationCode : MjotOTU4ODQ0MDI2OkNwMTI1MjoxNzA1MzgzMzc0OTE3OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jan 2024 11:06:14
...
*        CALL F.READ(FN.REDO.GAR.LOCK.ALE,Y.CUST,R.REDO.GAR.LOCK.ALE,F.REDO.GAR.LOCK.ALE,ERR)
        CALL F.READU(FN.REDO.GAR.LOCK.ALE,Y.CUST,R.REDO.GAR.LOCK.ALE,F.REDO.GAR.LOCK.ALE,ERR,'');* R22 UTILITY AUTO CONVERSION
...
*            CALL F.READ(FN.ACCOUNT,Y.FIT.ACC<Y.FIT.ACC.CNT>,R.ACCOUNT,F.ACCOUNT,ERR)
            CALL F.READU(FN.ACCOUNT,Y.FIT.ACC<Y.FIT.ACC.CNT>,R.ACCOUNT,F.ACCOUNT,ERR,'');* R22 UTILITY AUTO CONVERSION

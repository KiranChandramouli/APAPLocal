* @ValidationCode : Mjo1MjY0MzEzODY6Q3AxMjUyOjE3MDQ2OTk1ODY4NzA6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 08 Jan 2024 13:09:46
...
*CALL GET.LOC.REF("CURRENCY","L.CU.AMLBUY.RT",Y.LR.CCY)
    EB.LocalReferences.GetLocRef("CURRENCY","L.CU.AMLBUY.RT",Y.LR.CCY);* R22 UTILITY AUTO CONVERSION
    L.CU.AMLBUY.RT = Y.LR.CCY

*CALL CACHE.READ(FN.CCY,'USD',R.CCY.REC,Y.CCY.ERR)
    IDVAR.1 = 'USD' ;* R22 UTILITY AUTO CONVERSION
    CALL CACHE.READ(FN.CCY,IDVAR.1,R.CCY.REC,Y.CCY.ERR);* R22 UTILITY AUTO CONVERSION

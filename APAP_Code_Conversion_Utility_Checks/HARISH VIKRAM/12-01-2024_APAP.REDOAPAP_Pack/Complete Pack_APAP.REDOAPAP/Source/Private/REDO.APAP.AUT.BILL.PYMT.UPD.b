* @ValidationCode : MjotMTE0NjI1ODgzNTpDcDEyNTI6MTcwMzE2MDU2MjUyNTpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 17:39:22
...
*    CALL F.READ(FN.REDO.THIRDPRTY.PAYMENT,REDO.THIRDPRTY.PAYMENT.ID,R.REDO.THIRDPRTY.PAYMENT,F.REDO.THIRDPRTY.PAYMENT,REDO.THIRDPRTY.PAYMENT.ER)
    CALL F.READU(FN.REDO.THIRDPRTY.PAYMENT,REDO.THIRDPRTY.PAYMENT.ID,R.REDO.THIRDPRTY.PAYMENT,F.REDO.THIRDPRTY.PAYMENT,REDO.THIRDPRTY.PAYMENT.ER,"")    ;*R22 Manual Conversion
...
* In this para of the code, local reference field positions are obtained
    ...
    FLD.ARRAY = 'L.TT.CMPNY.ID':@VM:'L.TT.CMPNY.NAME':@VM:'L.TT.BILL.TYPE':@VM:'L.TT.BILL.COND':@VM:'L.TT.BILL.NUM':@VM:'L.TFS.TXN.AMT'
    FLD.POS = ''

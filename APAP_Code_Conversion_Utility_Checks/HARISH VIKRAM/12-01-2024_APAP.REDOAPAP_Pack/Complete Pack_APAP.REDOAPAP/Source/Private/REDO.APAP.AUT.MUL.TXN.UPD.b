* @ValidationCode : MjotMjUyODE5NDAzOkNwMTI1MjoxNzAzMTYyODg4MTU2OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 21 Dec 2023 18:18:08
...
*    CALL F.READ(FN.REDO.MULTI.TRANSACTION.DETAIL,REDO.MULTI.TRANSACTION.DETAIL.ID,R.REDO.MULTI.TRANSACTION.DETAIL,F.REDO.MULTI.TRANSACTION.DETAIL,REDO.MULTI.TRANSACTION.DETAIL.ER)
    CALL F.READU(FN.REDO.MULTI.TRANSACTION.DETAIL,REDO.MULTI.TRANSACTION.DETAIL.ID,R.REDO.MULTI.TRANSACTION.DETAIL,F.REDO.MULTI.TRANSACTION.DETAIL,REDO.MULTI.TRANSACTION.DETAIL.ER,"")    ;*R22 Manual Conversion
...
* In this para of the code, local reference field positions are obtained
    ...
    APPL.ARRAY = 'TFS.PARAMETER':@FM:'T24.FUND.SERVICES'
    FLD.ARRAY  = 'L.TFS.BRCH.ACCT':@FM:'L.TFS.ORIG.REF':@VM:'L.TFS.TXN.DATE'
    FLD.POS    = ''

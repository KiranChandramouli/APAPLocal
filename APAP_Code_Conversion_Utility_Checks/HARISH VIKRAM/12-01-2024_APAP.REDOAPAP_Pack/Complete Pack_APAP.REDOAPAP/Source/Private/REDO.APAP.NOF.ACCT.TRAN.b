* @ValidationCode : MjotMTQ5MDEwODE5OTpDcDEyNTI6MTcwNDY5NjA5NTgyNjpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 08 Jan 2024 12:11:35
...
*$INSERT I_F.LOCAL.TABLE                     ;R22 Manual Conversion
...
*CALL GET.LOC.REF("FT.TXN.TYPE.CONDITION","L.FTTC.CHANNELS",FTTC.LR.POSN)
    EB.LocalReferences.GetLocRef("FT.TXN.TYPE.CONDITION","L.FTTC.CHANNELS",FTTC.LR.POSN);* R22 UTILITY AUTO CONVERSION
...
*CALL CACHE.READ(FN.ACCOUNT.PARAMETER,'SYSTEM',R.ACCOUNT.PARAMETER,Y.ACC.PAR.ERR)
    ...
    CALL CACHE.READ(FN.ACCOUNT.PARAMETER,IDVAR.1,R.ACCOUNT.PARAMETER,Y.ACC.PAR.ERR);* R22 UTILITY AUTO CONVERSION - START
*CALL CACHE.READ(FN.LOCAL.TABLE, '578', R.LT.REC, SEL.ERR3)
    IDVAR.1 = '578' ;* R22 UTILITY AUTO CONVERSION
*    CALL CACHE.READ(FN.LOCAL.TABLE, IDVAR.1, R.LT.REC, SEL.ERR3) ;* R22 UTILITY AUTO CONVERSION  - END
    R.LT.REC = EB.LocalReferences.LocalTable.CacheRead(IDVAR.1, SEL.ERR3)     ;*R22 Manual Conversion
...
*Y.CHN.LIST = R.LT.REC<EB.LTA.VETTING.TABLE>
        Y.CHN.LIST = R.LT.REC<EB.LocalReferences.LocalTable.LtaVettingTable>          ;*R22 Manual Conversion

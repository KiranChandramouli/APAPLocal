* @ValidationCode : MjoxNTYyNTk2MjI0OkNwMTI1MjoxNzAzNzU0NjM4OTY0OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 28 Dec 2023 14:40:38
...
* 28-12-2023      HARISHVIKRAM                 R22 Manual conversion        EB.ACCOUNTING Changed
*
*----------------------------------------------------------------------
*
    $INSERT I_COMMON
...
*    CALL EB.ACCOUNTING("AC","SAO",Y.COMMON.ARRAY,'')
    AC.API.EbAccounting("AC","SAO",Y.COMMON.ARRAY,'')         ;*R22 Manual Conversion

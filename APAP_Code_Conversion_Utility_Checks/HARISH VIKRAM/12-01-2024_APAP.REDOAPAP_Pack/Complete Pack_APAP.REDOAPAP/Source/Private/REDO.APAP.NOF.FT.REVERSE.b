* @ValidationCode : MjotMTQ0Nzc1ODQ1NTpDcDEyNTI6MTcwNDY5NjI5ODQ3NTpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 08 Jan 2024 12:14:58
...
*CALL CACHE.READ(FN.REDO.APAP.REVERSAL.FTTC,'SYSTEM',R.REDO.APAP.REVERSAL.FTTC,FTTC.REV.ERR)
    ...
    CALL CACHE.READ(FN.REDO.APAP.REVERSAL.FTTC,IDVAR.1,R.REDO.APAP.REVERSAL.FTTC,FTTC.REV.ERR);* R22 UTILITY AUTO CONVERSION

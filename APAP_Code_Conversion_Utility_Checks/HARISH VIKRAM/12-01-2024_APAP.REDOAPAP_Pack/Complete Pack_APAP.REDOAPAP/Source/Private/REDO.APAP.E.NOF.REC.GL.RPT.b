* @ValidationCode : MjotMTIxMDUxMzA4MzpDcDEyNTI6MTcwMzY3MjgzOTg5NDpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Dec 2023 15:57:19
...
* 27-12-2023        HARISHVIKRAM          R22 Manual Conversion             F.READ to CACHE.READ, ID.VAR Initialised
*********************************************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.COMPANY
...
********
    ...
    ID.VAR = 'RECONRPT'                          ;*R22 Manual Conversion - Start

*    CALL F.READ(FN.RHRP,'RECONRPT',R.RHRP,F.RHRP,ERR)
    CALL CACHE.READ(FN.RHRP,'RECONRPT',R.RHRP,ERR)            ;*R22 Manual Conversion - End

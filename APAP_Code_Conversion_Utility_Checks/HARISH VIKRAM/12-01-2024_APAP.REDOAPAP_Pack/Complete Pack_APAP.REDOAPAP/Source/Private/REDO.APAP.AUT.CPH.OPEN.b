* @ValidationCode : Mjo3ODM1ODYwMDQ6Q3AxMjUyOjE3MDMxNjI3MDA4Njc6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 18:15:00
...
*    CALL F.READ(FN.REDO.APAP.CPH.DETAIL,Y.CPH.DET.ID,R.REDO.APAP.CPH.DETAIL,F.REDO.APAP.CPH.DETAIL,Y.REDO.APAP.CPH.DETAIL.ERR)
    CALL F.READU(FN.REDO.APAP.CPH.DETAIL,Y.CPH.DET.ID,R.REDO.APAP.CPH.DETAIL,F.REDO.APAP.CPH.DETAIL,Y.REDO.APAP.CPH.DETAIL.ERR,"")   ;*R22 Manual Conversion
RETURN
*-------------------------------------------------------------------------

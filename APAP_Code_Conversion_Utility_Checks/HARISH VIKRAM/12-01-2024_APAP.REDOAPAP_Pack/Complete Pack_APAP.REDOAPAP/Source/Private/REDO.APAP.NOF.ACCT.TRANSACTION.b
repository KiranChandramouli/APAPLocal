* @ValidationCode : MjotODM1NTQ5MDc5OkNwMTI1MjoxNzA0Njk2MjYyMzkyOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 08 Jan 2024 12:14:22
...
*CALL CACHE.READ(FN.ACCOUNT.PARAMETER,'SYSTEM',R.ACCOUNT.PARAMETER,Y.ACC.PAR.ERR)
    ...
    CALL CACHE.READ(FN.ACCOUNT.PARAMETER,IDVAR.1,R.ACCOUNT.PARAMETER,Y.ACC.PAR.ERR);* R22 UTILITY AUTO CONVERSION

* @ValidationCode : MjotNzgxMjY4MTYxOlVURi04OjE3MDUzODY3NDMzMTU6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 Jan 2024 12:02:23
...
*   CALL F.READ(FN.AA.ARRANGEMENT.ACTIVITY,Y.AAA.ID,R.AA.ARRANGEMENT.ACTIVITY,F.AA.ARRANGEMENT.ACTIVITY,Y.ERR.AAA)
    R.AA.ARRANGEMENT.ACTIVITY = AA.Framework.ArrangementActivity.Read(Y.AAA.ID, Y.ERR.AAA)
    IF R.AA.ARRANGEMENT.ACTIVITY EQ '' THEN
        Y.AA.ID.FLAG = '1'
    END
*Y.AA.ID=R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.ARRANGEMENT>
    Y.AA.ID=R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.ArrangementActivity.ArrActArrangement>
*Y.EFF.DATE=R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.EFFECTIVE.DATE>
    Y.EFF.DATE=R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.SimulationCapture.ArrActEffectiveDate>
*Y.ACT.CLASS=R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.ACTIVITY.CLASS>
    Y.ACT.CLASS=R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.SimulationCapture.ArrActActivityClass>
    IF Y.TOT.CANCEL.AMT EQ '' THEN
*Y.TOT.CANCEL.AMT=R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.AMOUNT>
        Y.TOT.CANCEL.AMT=R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.SimulationCapture.ArrActTxnAmount>
    END ELSE
*Y.TOT.CANCEL.AMT = Y.TOT.CANCEL.AMT + R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.AMOUNT>
        Y.TOT.CANCEL.AMT = Y.TOT.CANCEL.AMT + R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.SimulationCapture.ArrActTxnAmount>
    END
RETURN
*-----------------------------------------------------------------------------
PROCESS:
...
*       CALL F.READ(FN.AA.ARRANGEMENT,Y.AA.ID,R.AA.ARRANGEMENT,F.AA.ARRANGEMENT,Y.ERR.AA)
        R.AA.ARRANGEMENT = AA.Framework.Arrangement.Read(Y.AA.ID, Y.ERR.AA)
*       Y.ACC.ID=R.AA.ARRANGEMENT<AA.ARR.LINKED.APPL.ID>
        Y.ACC.ID=R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrLinkedApplId>
        IF Y.ACC.ID NE '' THEN
...
*   Y.TXN.SYS.ID=R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.SYSTEM.ID>
    Y.TXN.SYS.ID=R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.SimulationCapture.ArrActTxnSystemId>
*   Y.TXN.CONT.ID =R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.CONTRACT.ID>
    Y.TXN.CONT.ID =R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.ArrangementActivity.ArrActTxnContractId>
...
*        Y.CO.CODE=R.AA.ARRANGEMENT<AA.ARR.CO.CODE>
        Y.CO.CODE=R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCoCode>
...
*        Y.LOAN.PORTFOLIO = R.AA.ARRANGEMENT<AA.ARR.PRODUCT.GROUP>
        Y.LOAN.PORTFOLIO = R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProductGroup>
...
*    Y.AGENCY=R.AA.ARRANGEMENT<AA.ARR.CO.CODE>
    Y.AGENCY=R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrCoCode>
*    Y.CURRECNY=R.AA.ARRANGEMENT<AA.ARR.CURRENCY>
    Y.CURRECNY=R.AA.ARRANGEMENT<AA.Framework.Arrangement.ArrCurrency>
*   Y.OPENING.DATE=R.AA.ARRANGEMENT<AA.ARR.PROD.EFF.DATE>
    Y.OPENING.DATE=R.AA.ARRANGEMENT<AA.Framework.ArrangementSim.ArrProdEffDate>
...
*    CALL F.READ(FN.AA.ACTIVITY.HISTORY,Y.AA.ID,R.AA.ACTIVITY.HISTORY,F.AA.ACTIVITY.HISTORY,Y.ERR.ACT.HIS)
    R.AA.ACTIVITY.HISTORY = AA.Framework.ActivityHistory.Read(Y.AA.ID, Y.ERR.ACT.HIS)
*    TOTAL.AAH = DCOUNT(R.AA.ACTIVITY.HISTORY<AA.AH.EFFECTIVE.DATE>,@VM)
    TOTAL.AAH = DCOUNT(R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistoryHist.AhEffectiveDate>,@VM)
    Y.POS.AAH = 1
    LOOP
    WHILE Y.POS.AAH LE TOTAL.AAH
*        Y.ALL.ACTIVITY = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY,Y.POS.AAH>
        Y.ALL.ACTIVITY = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistoryHist.AhActivity,Y.POS.AAH>
...
*                Y.ARR.ACT.ID = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY.REF,Y.POS.AAH,POS.ACT>
                Y.ARR.ACT.ID = R.AA.ACTIVITY.HISTORY<AA.Framework.ActivityHistory.AhActivityRef,Y.POS.AAH,POS.ACT>
*            CALL F.READ(FN.AA.ARRANGEMENT.ACTIVITY,Y.ARR.ACT.ID,R.AA.ARRANGEMENT.ACTIVITY,F.AA.ARRANGEMENT.ACTIVITY,ERR.AAA)
                R.AA.ARRANGEMENT.ACTIVITY = AA.Framework.ArrangementActivity.Read(Y.ARR.ACT.ID, ERR.AAA)
*             Y.DISB.AMOUNT+= R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.TXN.AMOUNT>
                Y.DISB.AMOUNT+= R.AA.ARRANGEMENT.ACTIVITY<AA.Framework.SimulationCapture.ArrActTxnAmount>
                Y.POS.ST = POS.ACT + 1
            END ELSE

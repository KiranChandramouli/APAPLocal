* @ValidationCode : MjotMzI0NzE2NzA4OkNwMTI1MjoxNzAzNTg4MDc2MjY0OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Dec 2023 16:24:36
...
*---------------------------------------------------------------------------------------
*DATE               WHO                       REFERENCE                 DESCRIPTION
*12-04-2023       CONVERSION TOOLS            AUTO R22 CODE CONVERSION   FM to@FM , VM to @VM, F.READ into CACHE.READ
*12-04-2023       AJITHKUMAR                  MANUAL R22 CODE CONVERSION NO CHANGE
*23-12-2023      HARISHVIKRAM                 R22 Manual conversion      ID.VAR Initialised
*----------------------------------------------------------------------------------------
*---------------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
********
    ...
    ID.VAR = 'SYSTEM'                                                                                       ;*R22 Manual Conversion - Start
*    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,'SYSTEM',R.REDO.APAP.CLEAR.PARAM,REDO.APAP.CLEAR.PARAM.ERR)
    CALL CACHE.READ(FN.REDO.APAP.CLEAR.PARAM,ID.VAR,R.REDO.APAP.CLEAR.PARAM,REDO.APAP.CLEAR.PARAM.ERR)      ;*R22 Manual Conversion - End
...
VALIDATE.CHARGE.TYPE:
    ...
    IF GET.FT.REF.CHG THEN
        CALL CACHE.READ(FN.FT.COMMISSION.TYPE, GET.FT.REF.CHG, R.FT.TXN.TYPE.CONDITION, FT.ERR) ;*R22 AUTO CODE CONVERSION

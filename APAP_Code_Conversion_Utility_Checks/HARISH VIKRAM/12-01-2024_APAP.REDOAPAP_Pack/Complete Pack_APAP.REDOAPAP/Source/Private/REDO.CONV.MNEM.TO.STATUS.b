* @ValidationCode : MjotMTk3Mjg5NjkxODpDcDEyNTI6MTcwNTM4MzE2Njg4OTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 16 Jan 2024 11:02:46
...
*        CALL CACHE.READ(FN.DATES, 'DO0010001', R.DATE, DAT.ERR) ;*R22 AUTO CODE CONVERSION
        ...
        CALL CACHE.READ(FN.DATES, IDVAR.1, R.DATE, DAT.ERR) ;*R22 AUTO CODE CONVERSION;* R22 UTILITY AUTO CONVERSION

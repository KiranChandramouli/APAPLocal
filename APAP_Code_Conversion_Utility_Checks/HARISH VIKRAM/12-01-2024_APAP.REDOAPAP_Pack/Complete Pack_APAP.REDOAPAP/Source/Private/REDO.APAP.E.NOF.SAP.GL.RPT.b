* @ValidationCode : MjotMjA2NzI4MzIxNDpDcDEyNTI6MTcwMzY3MzY0MTE1MDpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Dec 2023 16:10:41
...
* 27-12-2023        HARISHVIKRAM          R22 Manual Conversion             F.READ to CACHE.READ
*----------------------------------------------------------------------------------------
...
*    CALL F.READ(FN.REDO.INTERFACE.PARAM, Y.PARAM.ID, R.REDO.INTERFACE.PARAM, F.REDO.INTERFACE.PARAM, Y.ERR)
    CALL CACHE.READ(FN.REDO.INTERFACE.PARAM, Y.PARAM.ID, R.REDO.INTERFACE.PARAM, Y.ERR)          ;*R22 Manual Conversion

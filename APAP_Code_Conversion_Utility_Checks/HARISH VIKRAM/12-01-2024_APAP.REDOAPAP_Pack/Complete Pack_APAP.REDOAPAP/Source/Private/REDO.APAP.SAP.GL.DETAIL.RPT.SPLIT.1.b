* @ValidationCode : MjotMTU0Nzk0Mzg3ODpVVEYtODoxNzA1MDY0ODgxNDQ4OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 12 Jan 2024 18:38:01
...
* 12-01-2024         Harish Vikaram C     Manual R22 Conversion   CALL OPF Added
*--------------------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*--------------
    BEGIN CASE
        ...
        CASE Y.ENTRY.INDICATOR EQ 'STMT.ENTRY'        ;* If indicator is STMT.ENTRY
            ...
            END
            R.STMT.ENTRY = ''
            CALL OPF(FN.STMT.ENTRY,F.STMT.ENTRY) ;*Manual R22 Conversion
...
* 20170926 /E
        ...
        CASE Y.ENTRY.INDICATOR EQ 'CATEG.ENTRY'       ;* If indicator is CATEG.ENTRY
            ...
            END
            R.CATEG.ENTRY = ''
            CALL OPF(FN.CATEG.ENTRY,F.CATEG.ENTRY) ;*Manual R22 Conversion
...
* 20170926 /E
        ...
        CASE Y.ENTRY.INDICATOR EQ 'SPEC.ENTRY'        ;* If indicator is SPEC.ENTRY
            ...
            CALL OPF(FN.RE.CONSOL.SPEC.ENTRY,F.RE.CONSOL.SPEC.ENTRY) ;*Manual R22 Conversion
...
***********************
    ...
    LOOP
        ...
        CALL OPF(FN.STMT.ENTRY.DETAIL.XREF,F.STMT.ENTRY.DETAIL.XREF) ;*Manual R22 Conversion
...
*IF STMT.ENTRY.DETAIL.XREF.ERR AND X.VAR EQ 1 THEN  ;*R22 AUTO CONVERSTION X TO X.VAR AND = TO EQ
    IF STMT.ENTRY.DETAIL.XREF.ERR AND X.VAR EQ 1 THEN  ;*R22 AUTO CONVERSTION X TO X.VAR AND EQ TO EQ;* R22 Utility Changes
        CALL F.READ(FN.STMT.ENTRY,Y.STMT.ENTRY.ID,R.STMT.ENTRY,F.STMT.ENTRY,STMT.ENTRY.ERR)
        R.STMT.ENTRY.DETAIL = R.STMT.ENTRY
        GOSUB PROCESS.STMT.DETAILS
    END
...
**************************
    ...
    CALL OPF(FN.RE.SPEC.ENTRY.XREF,F.RE.SPEC.ENTRY.XREF) ;*Manual R22 Conversion
...
************
    R.TRANSACTION = ''
    TRANSACTION.ERR = ''
    CALL OPF(FN.TRANSACTION,F.TRANSACTION) ;*Manual R22 Conversion

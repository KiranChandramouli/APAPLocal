* @ValidationCode : MjoxNDUwOTU3MjUyOkNwMTI1MjoxNzAzMTgzMDIxNTIxOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 21 Dec 2023 23:53:41
...
*21-12-2023      HARISHVIKRAM                 R22 Manual conversion        F.READ to F.READU, EB.ACCOUNTING changed
*----------------------------------------------------------------------------------------
...
*    CALL F.READ(FN.REDO.APAP.L.CONTRACT.BALANCES,REDO.APAP.L.CONTRACT.BALANCES.ID,R.REDO.APAP.L.CONTRACT.BALANCES,F.REDO.APAP.L.CONTRACT.BALANCES,REDO.APAP.L.CONTRACT.BALANCES.ERR)
    CALL F.READU(FN.REDO.APAP.L.CONTRACT.BALANCES,REDO.APAP.L.CONTRACT.BALANCES.ID,R.REDO.APAP.L.CONTRACT.BALANCES,F.REDO.APAP.L.CONTRACT.BALANCES,REDO.APAP.L.CONTRACT.BALANCES.ERR,"")      ;*R22 Manual Conversion
...
*        CALL EB.ACCOUNTING('MM','SAO',FINAL.ENTRY.REC,'')
        AC.API.EbAccounting('MM','SAO',FINAL.ENTRY.REC,'')       ;* R22 Manual Conversion
    END

* @ValidationCode : MjotODg2Njk0NDEzOkNwMTI1MjoxNzAzMTUwNDQ1MDAwOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 21 Dec 2023 14:50:45
...
*20-12-2023     HARISHVIKRAM                  R22 Manual Conversion     F.READ into CACHE.READ
*----------------------------------------------------------------------------------------
...
*            CALL F.READ(FN.INS.COMB, ID.INS.COMB, R.INS.COMB, F.INS.COMB, Y.APP.ERR)
            CALL CACHE.READ(FN.INS.COMB, ID.INS.COMB, R.INS.COMB, F.INS.COMB, Y.APP.ERR)   ;* R22 Manual Conversion

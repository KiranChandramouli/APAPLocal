* @ValidationCode : MjoxMTY4MDI3ODIyOkNwMTI1MjoxNzAzNzY3OTQzMjcwOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 28 Dec 2023 18:22:23
...
*    CALL F.READ(FN.REDO.CUS.SEC.FOL.NO.DET,REDO.CUS.SEC.FOL.NO.DET.ID,R.REDO.CUS.SEC.FOL.NO.DET,F.REDO.CUS.SEC.FOL.NO.DET,REDO.CUS.SEC.FOL.NO.DET.ER)
    CALL F.READU(FN.REDO.CUS.SEC.FOL.NO.DET,REDO.CUS.SEC.FOL.NO.DET.ID,R.REDO.CUS.SEC.FOL.NO.DET,F.REDO.CUS.SEC.FOL.NO.DET,REDO.CUS.SEC.FOL.NO.DET.ER,'')        ;*R22 Manual Conversion

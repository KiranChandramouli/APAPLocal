...
IF R.CUSTOMER<EB.CUS.LOCAL.REF,Y.L.CU.TIPO.CL.POS> EQ "PERSONA FISICA" OR R.CUSTOMER<EB.CUS.LOCAL.REF,Y.L.CU.TIPO.CL.POS> EQ "CLIENTE MENOR" THEN  ;*R22 AUTO CONVERSTION EQ TO EQ;* R22 UTILITY AUTO CONVERSION
...
IF R.CUSTOMER<EB.CUS.LOCAL.REF,Y.L.CU.TIPO.CL.POS> EQ "PERSONA JURIDICA" THEN   ;*R22 AUTO CONVERSTION EQ TO EQ;* R22 UTILITY AUTO CONVERSION

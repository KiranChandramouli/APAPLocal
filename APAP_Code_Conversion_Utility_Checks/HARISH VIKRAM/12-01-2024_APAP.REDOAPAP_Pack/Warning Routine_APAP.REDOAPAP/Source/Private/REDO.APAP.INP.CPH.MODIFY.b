* @ValidationCode : MjotOTg2NjU4NDg6Q3AxMjUyOjE3MDM3NjYxNzUzMTk6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 28 Dec 2023 17:52:55
...
* 28-12-2023      HARISHVIKRAM                 R22 Manual conversion       F.READ to F.READU, GET.LOC.REF modified
*----------------------------------------------------------------------
...
*    CALL F.READ(FN.REDO.APAP.MORTGAGES.DETAIL,MG.DET.ID,R.REDO.APAP.MORTGAGES.DETAIL,F.REDO.APAP.MORTGAGES.DETAIL,MRTG.ERR)
    CALL F.READU(FN.REDO.APAP.MORTGAGES.DETAIL,MG.DET.ID,R.REDO.APAP.MORTGAGES.DETAIL,F.REDO.APAP.MORTGAGES.DETAIL,MRTG.ERR,'')    ;*R22 Manual Conversion
RETURN
*----------------------------------------------------------------------
CLEAR.DELINKED.MGS:
*----------------------------------------------------------------------

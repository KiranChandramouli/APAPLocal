* @ValidationCode : MjotMTQ0NDYwMDkwMDpDcDEyNTI6MTcwMzE2MDk1MTQ4ODpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 17:45:51
...
*
*13/07/2023      Conversion tool            R22 Auto Conversion            T.NO TO C$T24.SESSION.NO, FM TO @FM
*13/07/2023      Suresh                     R22 Manual Conversion          No Change
...
UPDATE.AUDIT.FIELDS:
********************
    R.REDO.H.CLEARING.OUTWARD<REDO.CLR.OUT.INPUTTER>   = C$T24.SESSION.NO:'_':OPERATOR ;*R22 Manual Conversion
    ...
    R.REDO.H.CLEARING.OUTWARD<REDO.CLR.OUT.AUTHORISER> = C$T24.SESSION.NO:'_':OPERATOR ;*R22 Manual Conversion
...
*    CALL F.READ(FN.REDO.H.CLEARING.OUTWARD,REDO.H.CLEARING.OUTWARD.ID,R.REDO.H.CLEARING.OUTWARD,F.REDO.H.CLEARING.OUTWARD,REDO.H.CLEARING.OUTWARD.ER)
    CALL F.READU(FN.REDO.H.CLEARING.OUTWARD,REDO.H.CLEARING.OUTWARD.ID,R.REDO.H.CLEARING.OUTWARD,F.REDO.H.CLEARING.OUTWARD,REDO.H.CLEARING.OUTWARD.ER,"")   ;*R22 Manual Conversion

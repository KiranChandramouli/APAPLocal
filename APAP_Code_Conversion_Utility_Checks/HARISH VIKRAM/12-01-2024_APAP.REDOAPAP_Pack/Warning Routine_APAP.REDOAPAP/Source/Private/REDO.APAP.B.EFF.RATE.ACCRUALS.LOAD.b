* @ValidationCode : MjotOTMyNDkxNjU6Q3AxMjUyOjE3MDMyMjI3ODg3MDQ6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Dec 2023 10:56:28
...
*21-12-2023      HARISHVIKRAM                 R22 Manual conversion        ID.VAR Initialised
*----------------------------------------------------------------------------------------
...
*    CALL CACHE.READ(FN.REDO.APAP.H.PRODUCT.DEFINE,'SYSTEM',R.REDO.APAP.H.PRODUCT.DEFINE,REDO.APAP.H.PRODUCT.DEFINE.ERR)   ;* 29-Jan-2012 - E
    ...
    CALL CACHE.READ(FN.REDO.APAP.H.PRODUCT.DEFINE,ID.VAR,R.REDO.APAP.H.PRODUCT.DEFINE,REDO.APAP.H.PRODUCT.DEFINE.ERR)   ;* 29-Jan-2012 - E   ;R22 Manual Conversion

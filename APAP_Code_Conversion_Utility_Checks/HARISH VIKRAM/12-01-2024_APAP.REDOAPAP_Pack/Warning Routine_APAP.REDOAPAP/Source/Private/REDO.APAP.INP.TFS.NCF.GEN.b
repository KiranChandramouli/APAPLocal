* @ValidationCode : MjotNTMxMjYzNDA2OkNwMTI1MjoxNzAzNzY5NzQwNDYzOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 28 Dec 2023 18:52:20
...
*
*13/07/2023      Conversion tool            R22 Auto Conversion             FM TO @FM, VM TO @VM
*13/07/2023      Suresh                     R22 Manual Conversion           Nochange
* 28-12-2023      HARISHVIKRAM                 R22 Manual conversion       F.READ to F.READU
*********************************************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
CHECK.TFS.TXN.CODE:
*******************
    Y.TFS.CODES  = 'ADMCHQGOVWITTAX' :@FM: 'ADMCHQGOVWOTAX'  :@FM: 'ADMCHQOTHERS'
...
*    CALL F.READ(FN.REDO.NCF.ISSUED,REDO.NCF.ISSUED.ID,R.REDO.NCF.ISSUED,F.REDO.NCF.ISSUED,REDO.NCF.ISSUED.ER)
    CALL F.READU(FN.REDO.NCF.ISSUED,REDO.NCF.ISSUED.ID,R.REDO.NCF.ISSUED,F.REDO.NCF.ISSUED,REDO.NCF.ISSUED.ER,'')     ;*R22 Manual Conversion
...
*    CALL F.READ(FN.REDO.L.NCF.UNMAPPED,REDO.L.NCF.UNMAPPED.ID,R.REDO.L.NCF.UNMAPPED,F.REDO.L.NCF.UNMAPPED,REDO.L.NCF.UNMAPPED.ER)
    CALL F.READU(FN.REDO.L.NCF.UNMAPPED,REDO.L.NCF.UNMAPPED.ID,R.REDO.L.NCF.UNMAPPED,F.REDO.L.NCF.UNMAPPED,REDO.L.NCF.UNMAPPED.ER,'')      ;*R22 Manual Conversion
...
*    CALL F.READ(FN.REDO.L.NCF.STATUS,REDO.L.NCF.STATUS.ID,R.REDO.L.NCF.STATUS,F.REDO.L.NCF.STATUS,REDO.L.NCF.STATUS.ER)
    CALL F.READU(FN.REDO.L.NCF.STATUS,REDO.L.NCF.STATUS.ID,R.REDO.L.NCF.STATUS,F.REDO.L.NCF.STATUS,REDO.L.NCF.STATUS.ER,'')    ;*R22 Manual Conversion
...
* In this para of the code, local reference field positions are obtained
    ...
    FLD.ARRAY  = 'L.NCF.REQUIRED':@VM:'L.NCF.NUMBER'
    FLD.POS    = ''

* @ValidationCode : MjoyMDU3NTM1OTI5OkNwMTI1MjoxNzAzNzY2NDUwMzc2OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 28 Dec 2023 17:57:30
...
*    CALL F.READ(FN.REDO.APAP.MORTGAGES.DETAIL,Y.MSG.DET.ID,R.REDO.APAP.MORTGAGES.DETAIL,F.REDO.APAP.MORTGAGES.DETAIL,MRTG.ERR)
    CALL F.READU(FN.REDO.APAP.MORTGAGES.DETAIL,Y.MSG.DET.ID,R.REDO.APAP.MORTGAGES.DETAIL,F.REDO.APAP.MORTGAGES.DETAIL,MRTG.ERR,'')                ;*R22 Manual Conversion

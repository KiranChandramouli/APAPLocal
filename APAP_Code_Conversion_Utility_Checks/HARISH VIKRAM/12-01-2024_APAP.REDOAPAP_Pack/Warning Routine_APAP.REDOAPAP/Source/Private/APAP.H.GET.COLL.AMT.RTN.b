* @ValidationCode : MjotMTM5MjUwNjcxMzpDcDEyNTI6MTcwMzE0OTg4NjQyOTpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 21 Dec 2023 14:41:26
...
* 20-12-2023         HARISHVIKRAM         R22 Manual Conversion   AA.Framework related variables and AA.GET.ARRANGEMENT.CONDITIONS changed
* Development for :
...
*    Y.PRODUCTO = R.AA.ARR<AA.ARR.PRODUCT>
    Y.PRODUCTO = R.AA.ARR<AA.Framework.Arrangement.ArrProduct>    ;* R22 Manual Conversion
...
*    IF R.AA.ARR<AA.ARR.CURRENCY> NE R.NEW(INS.DET.CURRENCY) THEN
    IF R.AA.ARR<AA.Framework.Arrangement.ArrCurrency> NE R.NEW(INS.DET.CURRENCY) THEN    ;*R22 Manual Conversion
...
*    Y.ID.CURR = R.AA.ARR<AA.ARR.CURRENCY>
    Y.ID.CURR = R.AA.ARR<AA.Framework.Arrangement.ArrCurrency>    ;*R22 Manual Conversion
...
*    CALL AA.GET.ARRANGEMENT.PROPERTIES(ARR.INFO, Y.ARR.DATE, R.ARRANGEMENT, PROP.LIST)
    AA.Framework.GetArrangementProperties(ARR.INFO, Y.ARR.DATE, R.ARRANGEMENT, PROP.LIST)  ;* R22 Manual Conversion
...
*    CALL AA.GET.ARRANGEMENT.CONDITIONS(ARR.INFO,PROPERTY.CLASS,AA.PROPERTY,Y.EFFEC.DATE,returnIds,returnConditions,returnError)
    AA.Framework.GetArrangementConditions(ARR.INFO,PROPERTY.CLASS,AA.PROPERTY,Y.EFFEC.DATE,returnIds,returnConditions,returnError)    ;*R22 Manual Conversion

* @ValidationCode : MjotMTc0MTcyMzcwODpVVEYtODoxNzA1Mzg1ODMyNDUxOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jan 2024 11:47:12
...
*-----------------------------------------------------------------------------
    ...
    CALL OPF(FN.REDO.APAP.PROPERTY.PARAM, F.REDO.APAP.PROPERTY.PARAM)                ;*R22 Manual Conversion - end

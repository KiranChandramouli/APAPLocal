* @ValidationCode : Mjo1MDY3NzQ2Njk6Q3AxMjUyOjE3MDUzODMzMTE4ODc6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 Jan 2024 11:05:11
...
*        CALL F.READ(FN.AZ.ACCOUNT,AZ.ACCOUNT.ID,R.AZ.ACCOUNT,F.AZ.ACCOUNT,AZ.ACC.ERR)
        CALL F.READU(FN.AZ.ACCOUNT,AZ.ACCOUNT.ID,R.AZ.ACCOUNT,F.AZ.ACCOUNT,AZ.ACC.ERR,'');* R22 UTILITY AUTO CONVERSION
...
*        CALL F.READ(FN.AZ.ACCOUNT,Y.ACCOUNT.ID,R.AZ.ACCOUNT,F.AZ.ACCOUNT,ACC.ERR)
        CALL F.READU(FN.AZ.ACCOUNT,Y.ACCOUNT.ID,R.AZ.ACCOUNT,F.AZ.ACCOUNT,ACC.ERR,'');* R22 UTILITY AUTO CONVERSION
        IF R.AZ.ACCOUNT THEN

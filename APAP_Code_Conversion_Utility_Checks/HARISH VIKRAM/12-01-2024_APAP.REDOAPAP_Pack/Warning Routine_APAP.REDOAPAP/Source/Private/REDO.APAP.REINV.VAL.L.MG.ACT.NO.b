* @ValidationCode : MjotMTcwOTc4ODE5MTpVVEYtODoxNzA1MDU0MjkzMDU3OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 12 Jan 2024 15:41:33
...
*CALL CACHE.READ(FN.REDO.APAP.CPH.PARAMETER,'SYSTEM',R.REDO.APAP.CPH.PARAMETER,REDO.APAP.CPH.PARAMETER.ERR)
    ...
    CALL CACHE.READ(FN.REDO.APAP.CPH.PARAMETER,IDVAR.1,R.REDO.APAP.CPH.PARAMETER,REDO.APAP.CPH.PARAMETER.ERR);* R22 Utility Changes

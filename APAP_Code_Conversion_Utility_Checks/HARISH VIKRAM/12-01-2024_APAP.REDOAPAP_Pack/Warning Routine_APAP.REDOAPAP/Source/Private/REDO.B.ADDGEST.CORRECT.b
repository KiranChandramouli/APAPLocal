* @ValidationCode : MjotNjY5MDk5NDcyOkNwMTI1MjoxNzA1MzgyNTIwMjYxOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jan 2024 10:52:00
...
*        CALL OFS.CALL.BULK.MANAGER(OFS.ID,OFS.DATA,RESP,COMM)
        EB.Interface.OfsCallBulkManager(OFS.ID,OFS.DATA,RESP,COMM);* R22 UTILITY AUTO CONVERSION

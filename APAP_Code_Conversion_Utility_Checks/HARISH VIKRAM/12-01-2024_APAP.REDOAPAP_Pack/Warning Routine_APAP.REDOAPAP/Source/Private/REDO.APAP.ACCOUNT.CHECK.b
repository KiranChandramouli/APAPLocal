* @ValidationCode : Mjo3ODYzNDY4NTU6Q3AxMjUyOjE3MDMxNTgzMTM4MDk6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 17:01:53
...
*    CALL CACHE.READ(FN.REDO.H.PAY.VERSION,'SYSTEM',R.REDO.H.PAY.VERSION,Y.ERR.PAR)
    ID.VAR = 'SYSTEM'
    CALL CACHE.READ(FN.REDO.H.PAY.VERSION,ID.VAR,R.REDO.H.PAY.VERSION,Y.ERR.PAR)    ;*R22 Manual Conversion

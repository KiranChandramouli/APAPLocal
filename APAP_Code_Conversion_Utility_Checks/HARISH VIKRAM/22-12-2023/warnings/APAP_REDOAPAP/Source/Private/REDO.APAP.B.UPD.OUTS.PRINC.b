* @ValidationCode : MjotNjU4NzgxOTkwOkNwMTI1MjoxNzAzMjMzNDMwNDA1OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 22 Dec 2023 13:53:50
...
*    CALL F.READ(FN.REDO.APAP.MORTGAGES.DETAIL,REDO.APAP.MORTGAGES.DETAILS.ID,R.REDO.APAP.MORTGAGES.DETAIL,F.REDO.APAP.MORTGAGES.DETAIL,MRTG.ERR)
    CALL F.READU(FN.REDO.APAP.MORTGAGES.DETAIL,REDO.APAP.MORTGAGES.DETAILS.ID,R.REDO.APAP.MORTGAGES.DETAIL,F.REDO.APAP.MORTGAGES.DETAIL,MRTG.ERR,"")   ;*R22 Manual Conversion
...
*CALL F.READ(FN.REDO.APAP.CPH.DETAIL,Y.DEP.ID,R.REDO.APAP.CPH.DETAIL,F.REDO.APAP.CPH.DETAIL,CPH.ERR)
    CALL F.READU(FN.REDO.APAP.CPH.DETAIL,Y.DEP.ID,R.REDO.APAP.CPH.DETAIL,F.REDO.APAP.CPH.DETAIL,CPH.ERR,"")    ;*R22 Manual Conversion
RETURN

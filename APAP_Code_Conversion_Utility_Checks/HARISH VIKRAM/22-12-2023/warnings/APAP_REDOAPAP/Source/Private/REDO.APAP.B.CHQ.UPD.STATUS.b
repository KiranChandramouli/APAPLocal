* @ValidationCode : Mjo5MjEzNDcyODE6Q3AxMjUyOjE3MDMxODE3ODExNjE6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 21 Dec 2023 23:33:01
...
*  CALL F.READ(FN.REDO.APAP.LOAN.CHEQUE.DETAILS,REDO.APAP.LOAN.CHEQUE.DETAILS.ID,R.REDO.APAP.LOAN.CHEQUE.DETAILS,F.REDO.APAP.LOAN.CHEQUE.DETAILS,REDO.APAP.LOAN.CHEQUE.DETAILS.ER)
    CALL F.READU(FN.REDO.APAP.LOAN.CHEQUE.DETAILS,REDO.APAP.LOAN.CHEQUE.DETAILS.ID,R.REDO.APAP.LOAN.CHEQUE.DETAILS,F.REDO.APAP.LOAN.CHEQUE.DETAILS,REDO.APAP.LOAN.CHEQUE.DETAILS.ER,"")     ;*R22 Manual Conversion
...
*    CALL F.READ(FN.REDO.LOAN.CHQ.RETURN,ARR.ID,R.REDO.LOAN.CHQ.RETURN,F.REDO.LOAN.CHQ.RETURN,Y.LCR.ERR)
    CALL F.READU(FN.REDO.LOAN.CHQ.RETURN,ARR.ID,R.REDO.LOAN.CHQ.RETURN,F.REDO.LOAN.CHQ.RETURN,Y.LCR.ERR,"")      ;*R22 Manual Conversion

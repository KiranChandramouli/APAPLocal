* @ValidationCode : Mjo3NDI3OTExMjM6Q3AxMjUyOjE3MDMyMjQ1OTczNjE6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 22 Dec 2023 11:26:37
...
*22-12-2023      HARISHVIKRAM                 R22 Manual conversion        F.READ to F.READU
*----------------------------------------------------------------------------------------
...
*    CALL F.READ(FN.REDO.H.CUST.WRITE.PROV,REDO.H.CUSTOMER.PROVISION.ID,R.REDO.H.CUST.WRITE.PROV,F.REDO.H.CUST.WRITE.PROV,WRITE.ERR)
    CALL F.READU(FN.REDO.H.CUST.WRITE.PROV,REDO.H.CUSTOMER.PROVISION.ID,R.REDO.H.CUST.WRITE.PROV,F.REDO.H.CUST.WRITE.PROV,WRITE.ERR,"")    ;*R22 Manual Conversion
    GOSUB READ.CUSTOMER
...
*    CALL F.READ(FN.REDO.H.CUSTOMER.PROVISION,REDO.H.CUSTOMER.PROVISION.ID,R.REDO.H.CUSTOMER.PROVISION,F.REDO.H.CUSTOMER.PROVISION,REDO.H.CUSTOMER.PROVISION.ER)
    CALL F.READU(FN.REDO.H.CUSTOMER.PROVISION,REDO.H.CUSTOMER.PROVISION.ID,R.REDO.H.CUSTOMER.PROVISION,F.REDO.H.CUSTOMER.PROVISION,REDO.H.CUSTOMER.PROVISION.ER,"")     ;*R22 Manual Conversion
RETURN
*--------------------------------------------------------------------------------------------------------
**************
READ.CUSTOMER:

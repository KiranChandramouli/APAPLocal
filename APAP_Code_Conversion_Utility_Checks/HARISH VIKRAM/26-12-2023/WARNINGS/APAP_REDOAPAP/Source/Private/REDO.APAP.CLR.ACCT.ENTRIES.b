* @ValidationCode : MjozOTk0NjY0MzQ6Q3AxMjUyOjE3MDM1OTE2NjMxOTY6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Dec 2023 17:24:23
...
SUBROUTINE REDO.APAP.CLR.ACCT.ENTRIES
...
*26-12-2023      HARISHVIKRAM                 R22 Manual conversion        EB.ACCOUNTING Changed, ID.VAR Initialised
*------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
READ.PARAM.LCY:
*****************
*IF PGM.VERSION EQ ",LCY.COLLECT" OR PGM.VERSION EQ ",SERVICE.CREATE" THEN
...
READ.PARAM.FCY:
***************
*IF PGM.VERSION EQ ",FCY.COLLECT" OR PGM.VERSION EQ ",SERVICE.CREATE" THEN
...
*****************
    ...
    WHILE VAR.COUNT LE TFS.LIST.COUNT
        IF R.NEW(TFS.CURRENCY)<1,VAR.COUNT> EQ LCCY THEN
            GOSUB READ.PARAM.LCY
        END ELSE
            GOSUB READ.PARAM.FCY
        END
        ...
        LOCATE TXN.ID IN ARR.LIST SETTING ARR.POS THEN
            ...
            IF R.NEW(TFS.REVERSAL.MARK)<1,1> EQ 'R' OR R.NEW(TFS.R.UL.STATUS)<1,1> EQ 'RNAU' THEN
                GOSUB ACCT.REV.ENTRIES1
                GOSUB ACCT.REV.ENTRIES2
            END ELSE
                GOSUB ACCT.ENTRIES1
                GOSUB ACCT.ENTRIES2
            END
...
*Common Call for raising Entries
    ...
    R.STMT.ARR<AC.STE.VALUE.DATE> = R.NEW(TFS.DR.VALUE.DATE)<1, VAR.COUNT>

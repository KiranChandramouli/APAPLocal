* @ValidationCode : MjotNjEwMTg2NTQ0OkNwMTI1MjoxNzAzNTkyNTQ4MTE3OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Dec 2023 17:39:08
...
*26-12-2023      HARISHVIKRAM                 R22 Manual conversion        INSTEAD of Wrong variable F.PAYMENT.STOP.TYPE1 renamed  F.PAYMENT.STOP.TYPE
*----------------------------------------------------------------------------------------
...
*        CALL F.READ(FN.PAYMENT.STOP.TYPE,Y.ID.REASON,R.PAYMENT.STOP.TYPE,F.PAYMENT.STOP.TYPE1,Y.ACC.ERR)
        CALL F.READ(FN.PAYMENT.STOP.TYPE,Y.ID.REASON,R.PAYMENT.STOP.TYPE,F.PAYMENT.STOP.TYPE,Y.ACC.ERR)       ;*R22 Manual Conversion

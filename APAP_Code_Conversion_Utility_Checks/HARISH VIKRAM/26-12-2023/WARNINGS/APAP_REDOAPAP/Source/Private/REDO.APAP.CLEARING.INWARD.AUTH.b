* @ValidationCode : MjotMTIzMzE4NzUzMTpDcDEyNTI6MTcwMzU5MTQ3MjU2NzpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Dec 2023 17:21:12
...
*26-12-2023      HARISHVIKRAM                 R22 Manual conversion        EB.ACCOUNTING Changed, ID.VAR Initialised, F.READ to F.READU
*----------------------------------------------------------------------------------------
*----------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*        CALL EB.ACCOUNTING("AC",Y.TYPE,FINAL.ENTRY.REC,'')
        AC.API.EbAccounting("AC",Y.TYPE,FINAL.ENTRY.REC,'')           ;*R22 Manual Conversion
    END
...
*    CALL F.READ(FN.REDO.PENDING.CHARGE,Y.ACCOUNT.NO,R.REDO.PENDING.CHARGE,F.REDO.PENDING.CHARGE,PEND.CHRG)
    CALL F.READU(FN.REDO.PENDING.CHARGE,Y.ACCOUNT.NO,R.REDO.PENDING.CHARGE,F.REDO.PENDING.CHARGE,PEND.CHRG,"")   ;*R22 Manual Conversion

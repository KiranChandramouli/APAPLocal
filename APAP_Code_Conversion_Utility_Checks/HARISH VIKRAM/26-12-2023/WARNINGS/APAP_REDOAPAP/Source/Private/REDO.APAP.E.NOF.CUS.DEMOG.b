* @ValidationCode : MjotMzY0MDYxMTUyOkNwMTI1MjoxNzAzNTk0MzcyODY0OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Dec 2023 18:09:32
...
*26-12-2023      HARISHVIKRAM                 R22 Manual conversion        Changed the variable miss match in F.READ, ID.VAR Initialised
*----------------------------------------------------------------------------------------
...
GET.SS.LOCAL.REF:
*****************
    LRT.ERR = ''; R.LOCAL.REF.T = ''; ID.VAR = "ACCOUNT"
*    CALL CACHE.READ(FN.LOCAL.REF.T, "ACCOUNT", R.LOCAL.REF.T, LRT.ERR)
    CALL CACHE.READ(FN.LOCAL.REF.T, ID.VAR, R.LOCAL.REF.T, LRT.ERR)       ;*R22 Manual Conversion
RETURN
...
*    CALL F.READ(FN.EB.LOOKUP,LOOK.ID,R.LOOKUP,F.LOOKUP,ERR.LOOKUP)
    CALL F.READ(FN.EB.LOOKUP,LOOK.ID,R.LOOKUP,F.EB.LOOKUP,ERR.LOOKUP)     ;*R22 Manual Conversion

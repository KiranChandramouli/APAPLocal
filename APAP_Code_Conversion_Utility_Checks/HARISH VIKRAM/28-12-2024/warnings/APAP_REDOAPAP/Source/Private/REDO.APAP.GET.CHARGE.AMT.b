* @ValidationCode : Mjo3ODYzMDA4OTI6Q3AxMjUyOjE3MDM3NTc2MzIwNDA6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 28 Dec 2023 15:30:32
...
*-----------------------------------------------------------------------------
    ...
    FN.REDO.APAP.PROPERTY.PARAM = 'F.REDO.APAP.PROPERTY.PARAM'                 ;*R22 Manual Conversion - start
    F.REDO.APAP.PROPERTY.PARAM = ''
    OPF(FN.REDO.APAP.PROPERTY.PARAM, F.REDO.APAP.PROPERTY.PARAM)                ;*R22 Manual Conversion - end
...
*    CALL CACHE.READ('F.REDO.APAP.PROPERTY.PARAM',Y.PROD.ID,R.REDO.APAP.PROPERTY.PARAM,PARA.ERR)
    CALL CACHE.READ(FN.REDO.APAP.PROPERTY.PARAM,Y.PROD.ID,R.REDO.APAP.PROPERTY.PARAM,PARA.ERR)    ;*R22 Manual Conversion

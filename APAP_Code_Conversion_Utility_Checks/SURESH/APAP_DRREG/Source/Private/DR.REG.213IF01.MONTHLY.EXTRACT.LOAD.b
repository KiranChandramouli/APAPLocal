* @ValidationCode : MjoxMTUzNDAyNTE0OkNwMTI1MjoxNzAyNTQ5MzczMDUwOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 14 Dec 2023 15:52:53
...
*  CALL F.READ(FN.DR.REG.213IF01.PARAM, "SYSTEM", R.DR.REG.213IF01.PARAM, F.DR.REG.213IF01.PARAM, DR.REG.213IF01.PARAM.ERR)        ;*/ TUS START/END
    ...
    CALL CACHE.READ(FN.DR.REG.213IF01.PARAM, IDVAR, R.DR.REG.213IF01.PARAM, DR.REG.213IF01.PARAM.ERR) ;*R22 Manual Conversion

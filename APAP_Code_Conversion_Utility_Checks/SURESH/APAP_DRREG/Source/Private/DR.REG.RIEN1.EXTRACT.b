* @ValidationCode : Mjo0MjgzNzM5ODU6Q3AxMjUyOjE3MDI2NDI0NTMwMTc6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Dec 2023 17:44:13
...
*13/12/2023         Suresh                    R22 Manual Conversion      Change Hardcoding the value to IDVAR, Change F Variable
*----------------------------------------------------------------------------------------
...
*  CALL F.READ(FN.DR.REG.RIEN1.PARAM,'SYSTEM',R.DR.REG.RIEN1.PARAM,F.DR.REG.RIEN1.PARAM,DR.REG.RIEN1.PARAM.ERR) ;*Tus Start
    ...
    CALL CACHE.READ(FN.DR.REG.RIEN1.PARAM,IDVAR,R.DR.REG.RIEN1.PARAM,DR.REG.RIEN1.PARAM.ERR) ; *Tus End ;*R22 Manual Conversion
...
*        CALL F.READ(FN.DR.REG.RIEN1.CONCAT, REC.ID, R.REC, FV.DR.REG.RIEN1.CONCAT, RD.ERR)
        CALL F.READ(FN.DR.REG.RIEN1.CONCAT, REC.ID, R.REC, F.DR.REG.RIEN1.CONCAT, RD.ERR) ;*R22 Manual Conversion
        GOSUB CALC.STDEV
...
*CURRENCY = REC.ID
*APAP.REDOENQ.redoNofEnqFxBlotPosn(Y.ARR) ;*R22 MANUAL CODE CONVERSION
    APAP.REDOENQ.redoNofEnqFxBlotPosn(Y.ARR)

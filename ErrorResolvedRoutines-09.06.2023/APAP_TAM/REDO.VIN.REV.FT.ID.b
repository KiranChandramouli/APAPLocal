* @ValidationCode : MjotMTgxMDMzNDMyNjpDcDEyNTI6MTY4NjMxMzI0MjY4MDpJVFNTMTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMl9TUDUuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 09 Jun 2023 17:50:42
...
* 09.06.2023    Santosh         R22 Manual Conversion     Added package, commented not available field TT.MESSAGE
*-------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*            R.NEW(TT.MESSAGE) = Y.TT.ID     ;* R22 Manual Conversion - Field not present in R15 itself
            CALL F.WRITE(FN.REDO.TEMP.VERSION.IDS,Y.ID,R.REC.TEMP)
        END ELSE
            Y.TXN.ID = R.REC.TEMP.VERSION<REDO.TEM.TXN.ID>
            Y.CNT = DCOUNT(Y.TXN.ID,@VM)

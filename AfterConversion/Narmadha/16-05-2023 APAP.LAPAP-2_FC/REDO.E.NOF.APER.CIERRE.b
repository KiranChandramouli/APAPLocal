* @ValidationCode : MjoxOTM2NDY4NjA2OlVURi04OjE2ODQyMTIxODMyODQ6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 May 2023 10:13:03
...
*21/04/2023      CONVERSION TOOL     AUTO R22 CODE CONVERSION           FM TO @FM, VM TO @VM, SM TO @SM,++ TO +=, F.READ TO CACHE.READ, = TO EQ,INCLUDE TO INSERT, BP Removed
...
*----------
    ...
    WHILE Y.AZ.ID:Y.AZ.ID.POS
        ...
        END
        FLG += 1 ;*AUTO R22 CODE CONVERSION
...
*        Y.AGN.EXEC = Y.AGENCIA:'-':Y.DEPT.CODE
        ...
        USER.ERR = ''; R.USER = ''
        CALL CACHE.READ(FN.USER, Y.AUTHORISER, R.USER, USER.ERR) ;*AUTO R22 CODE CONVERSION
        IF NOT(R.USER) THEN
...
*-----------------
    ...
    CALL CACHE.READ(FN.CATEGORY, Y.INV.CATEG, R.CATEG, CATEG.ERR) ;*AUTO R22 CODE CONVERSION
...
*
    ...
    WHILE Y.HOLDER.ID:Y.HOLDER.POS
        ...
        END
        IF R.HOLDER<EB.CUS.LOCAL.REF,Y.CL.TYPE.POS> EQ "PERSONA JURIDICA" THEN ;*AUTO R22 CODE CONVERSION
...
*
    ...
    IF R.AZ.ACCOUNT<AZ.RECORD.STATUS> EQ 'MAT' THEN
        ...
        END
        CALL APAP.TAM.redoGetAzcancelAmtMode(R.AZ.ACCOUNT,Y.AZ.ID,CANCEL.AMT,CANCEL.MODE) ;*MANUAL R22 CODE CONVERSION

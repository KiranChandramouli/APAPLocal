* @ValidationCode : MjoxNjgyNjcwMDc6VVRGLTg6MTY4NDE0NTc1NzYxNTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 May 2023 15:45:57
...
GET.DISB.AMT:
    ...
    Y.IDS.DETAILS<2> = "YES"
    CALL APAP.TAM.RedoGetDisbursementDetails(Y.IDS.DETAILS,R.DISB.DETAILS,Y.COMMITED.AMT,Y.PEND.DISB);*MANUAL R22 CODE CONVERSION

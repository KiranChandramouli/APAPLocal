* @ValidationCode : MjotMTQ2OTg5NzA2OTpVVEYtODoxNjg0MTU2ODQ4OTkwOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 May 2023 18:50:48
...
*--------------
    ...
    ERR.MSG = ''
    EFF.DATE = ''
    CALL APAP.REDOFCFI.redoCrrGetConditions(Y.ARRANGEMENT.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG)     ;*R22 MANUAL CODE CONVERSION

* @ValidationCode : MjotMTIyMTMwNzE5MjpVVEYtODoxNjg0MTU3NzQyMjg1OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 May 2023 19:05:42
...
* Estos pagos no se registran en linea, solo por archivo monetario
    ...
    IF TXN.RESULT<1> EQ 'OFFLINE' OR TXN.RESULT<1> EQ 'ERROR' THEN
        ...
        CALL APAP.REDOCHNLS.redoSNotifyInterfaceAct('VPL003', 'ONLINE', '04', 'Email PAGO SE APLICARA OFFLINE - ID: ':ID.NEW , ' ' : TIMEDATE() : ' - LOG EN Jboss : server.log', '', '', '', '', '', OPERATOR, '')    ;*R22 MANUAL CODE CONVERSION

* @ValidationCode : MjoxOTE1OTk5MTE2OlVURi04OjE2ODQyMTM1MDcwMTc6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 16 May 2023 10:35:07
...
*-------------------------------------------------------------------------
    ...
    $INSERT I_F.ACCOUNT
    $INSERT I_F.AC.CHARGE.REQUEST ;*AUTO R22 CODE CONVERSION END
    $USING APAP.TAM
    $USING APAP.ATM
...
*R22 MANUAL CONVERSION
        CALL APAP.TAM.redoTxnAuthCode(CARD.NUMM,RET.VAL);*R22 MANUAL CONVERSION
...
*R22 MANUAL CONVERSION
        CALL APAP.ATM.vFtUpdEnqAtmKeyId()
        RETURN
    END

* @ValidationCode : MjoxNTE0NTU3NTk3OlVURi04OjE2ODU1MzE5NjYwNzY6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 May 2023 16:49:26
...
*----------------------------------------------------------------------------------------
    ...
    EFF.DATE = ''
    LS.LC.FLAG.WR = ''
    APAP.TAM.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG);*R22 Manual Conversion

* @ValidationCode : MjotMTAzMjk5OTU4NDpVVEYtODoxNjg1NTMyMDY3MDI2OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 16:51:07
...
*--------------------------------------------------------------------------------------------------------
    ...
    APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.AA.ARR.ACCOUNT,ERR.MSG)
...
*--------------------------------------------------------------------------------------------------------
    ...
    APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG)

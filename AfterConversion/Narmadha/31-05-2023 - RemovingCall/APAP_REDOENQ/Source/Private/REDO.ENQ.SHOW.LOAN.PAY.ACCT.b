* @ValidationCode : MjotMTg1ODc5NDg3MTpVVEYtODoxNjg1NTMyMTg5NDc3OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 16:53:09
...
*    L.APP.PCNT.POS=L.APP.POS<1,2>
    ...
    WHILE Y.VAR2 LE Y.OTHER.CNT
        ...
        R.CONDITION = ''
        ERR.MSG = ''
        APAP.TAM.redoCrrGetConditions(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG)
*--------------------PACS00459919---------------------------------------------------------

* @ValidationCode : Mjo4MjczNDcxNDY6VVRGLTg6MTY4NTUzMTkyNjkzMjpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 16:48:46
...
*---------------------------------------------------------------------------------
    ...
    R.CONDITION.ACCOUNT = ""
    APAP.TAM.redoCrrGetConditions(Y.AA.ID,"","ACCOUNT","",R.CONDITION.ACCOUNT,"") ;*R22 Manual conversion
    Y.ALT.ID = R.CONDITION.ACCOUNT<AA.AC.ALT.ID>
    R.CONDITION.CUSTOMER = ""
    APAP.TAM.redoCrrGetConditions(Y.AA.ID,"","CUSTOMER","",R.CONDITION.CUSTOMER,"") ;*R22 Manual conversion

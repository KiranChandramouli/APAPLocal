* @ValidationCode : MjotMTk2OTk0NzUxMjpVVEYtODoxNjg1NTMyNDUwMDc3OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 16:57:30
...
*-------------------------------------
    ...
    R.ACC.CONDITION = ''
    ERR.MSG         = ''
    APAP.TAM.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.ACC.CONDITION,ERR.MSG);* R22 Manual conversion - CALL method format changed

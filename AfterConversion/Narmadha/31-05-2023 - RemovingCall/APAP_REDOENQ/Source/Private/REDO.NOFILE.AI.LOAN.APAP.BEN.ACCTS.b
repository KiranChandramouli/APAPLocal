* @ValidationCode : MjotMzIwNzUxODc0OlVURi04OjE2ODU1MzI3NDU2NTk6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 May 2023 17:02:25
...
*****************
    ...
    WHILE BEN.ID:BEN.POS
        ...
        APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG);*Manual R22 conversion

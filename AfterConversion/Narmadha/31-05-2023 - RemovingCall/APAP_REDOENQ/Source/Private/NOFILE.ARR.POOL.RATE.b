* @ValidationCode : MjotNzMzMzU3MTY0OlVURi04OjE2ODU1MjkzMTA5MTY6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 May 2023 16:05:10
...
*
    ...
    Y.INT.RATE.NEW  = ''
    Y.POOL.RATE = ''
    APAP.TAM.redoCrrGetConditions(Y.ARRG.ID,EFF.DATE,PROPERTY.CLASS,PROPERTY,R.INT.ARR.COND,ERR.MSG) ;*R22 Manual Conversion - Call routine modified

* @ValidationCode : MjotMTg0NDUwNTQzODpVVEYtODoxNjg2ODIxMzc3ODkyOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 Jun 2023 14:59:37
...
*************************************************************************
    ...
    END
    EXECUTE "HUSH ON"
    EXECUTE 'SELECT ':FULL.FNAME:' WITH @ID LIKE "...USD" OR WITH @ID LIKE "...GBP" OR WITH @ID LIKE "...DEM" OR WITH @ID LIKE "...FFR" OR WITH @ID LIKE "...NLG" OR WITH @ID LIKE "...ITL" OR WITH @ID LIKE "...ATS" OR WITH @ID LIKE "...XEU" OR WITH @ID LIKE "...DKK" OR WITH @ID LIKE "...SEK" OR WITH @ID LIKE "...HKD" OR WITH @ID LIKE "...SGD" OR WITH @ID LIKE "...MYR" OR WITH @ID LIKE "...THB" OR WITH @ID LIKE "...ESP" OR WITH @ID LIKE "...CAD" OR WITH @ID LIKE "...JPY" OR WITH @ID LIKE "...AUD" OR WITH @ID LIKE "...NZD" OR WITH @ID LIKE "...KWD" OR WITH @ID LIKE "...XSO" OR WITH @ID LIKE "...XGO"':YSEL.A
    EXECUTE "HUSH OFF"

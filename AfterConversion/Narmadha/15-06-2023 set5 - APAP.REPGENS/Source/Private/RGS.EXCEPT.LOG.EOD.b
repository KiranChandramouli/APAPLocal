* @ValidationCode : MjoxMzA3NjE4NDIwOlVURi04OjE2ODY4MjMzNDA5OTk6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:32:20
...
SUBROUTINE RGS.EXCEPT.LOG.EOD
REM "RGS.EXCEPT.LOG.EOD",230614-4
*************************************************************************
...
*************************************************************************
    ...
    DIM YR.REC(8)
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.EXCEPT.LOG.EOD"
    YOLDFILE = 1
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.EXCEPT.LOG.EOD")
    END
*
    YCOM = ID.COMPANY
*

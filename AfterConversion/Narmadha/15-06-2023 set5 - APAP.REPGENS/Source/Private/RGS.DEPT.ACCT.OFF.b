* @ValidationCode : MjotMTk3NTc4NjU1MTpVVEYtODoxNjg2ODIxOTk2NTE2OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:09:56
...
SUBROUTINE RGS.DEPT.ACCT.OFF
REM "RGS.DEPT.ACCT.OFF",230614-4
*************************************************************************
...
*************************************************************************
    ...
    DIM YR.REC(3)
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.DEPT.ACCT.OFF"
    YOLDFILE = 1
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.DEPT.ACCT.OFF")
    END
*
    YCOM = ID.COMPANY
*
...
*
*************************************************************************
    YFILE = "DEPT.ACCT.OFFICER"
    FULL.FNAME = "F.DEPT.ACCT.OFFICER"; YF.DEPT.ACCT.OFFICER = ""
    ...
    CALL OPF (FULL.FNAME, YF.DEPT.ACCT.OFFICER)
    CLEARSELECT
    ...
    WHILE ID.NEW:YDELIM
        MATREAD R.NEW FROM YF.DEPT.ACCT.OFFICER, ID.NEW ELSE ID.NEW = "" ; MAT R.NEW = ""
        IF T.PWD THEN

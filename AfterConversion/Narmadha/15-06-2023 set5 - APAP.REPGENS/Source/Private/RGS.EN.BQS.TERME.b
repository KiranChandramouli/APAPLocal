* @ValidationCode : Mjo5NDMzMTMyNTA6VVRGLTg6MTY4NjgyMjg2Mzg2OTpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 15 Jun 2023 15:24:23
...
SUBROUTINE RGS.EN.BQS.TERME
REM "RGS.EN.BQS.TERME",230614-4
*************************************************************************
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.EN.BQS.TERME")
    END
*************************************************************************
...
*************************************************************************
    ...
    END
    EXECUTE "HUSH ON"
    EXECUTE 'SELECT ':FULL.FNAME:' WITH ':fldName:' >= "500000" AND ':fldName:' <= "699999" AND ':fldName2:' = "21001"':YSEL.A
    EXECUTE "HUSH OFF"

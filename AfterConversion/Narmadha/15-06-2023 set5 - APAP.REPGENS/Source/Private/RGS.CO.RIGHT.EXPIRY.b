* @ValidationCode : MjoxNjkxOTE5NTkwOlVURi04OjE2ODY4MTYzNTIzNTY6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 13:35:52
...
SUBROUTINE RGS.CO.RIGHT.EXPIRY
REM "RGS.CO.RIGHT.EXPIRY",230614-4
*************************************************************************
...
*************************************************************************
    ...
    OPEN "", "VOC" TO YF.VOC ELSE
        ...
        CALL FATAL.ERROR ("RGS.CO.RIGHT.EXPIRY")
    END
*************************************************************************

* @ValidationCode : MjoxMTY5MzM1MzY3OlVURi04OjE2ODU1MzAzNjM4NjI6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 May 2023 16:22:43
...
*-----------------------------------------------------------------------------
    ...
    WHILE ACC.ID:ACCT.POS
        ...
        APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG) ;*R22 Auto conversion

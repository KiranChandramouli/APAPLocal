* @ValidationCode : MjotMTA3NTEyNDc0NDpVVEYtODoxNjg1NTMzMzI1OTcyOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 17:12:05
...
* Get the loan total commitment value
    ...
    R.CONDITION = ''
    ERR.MSG = ''
    APAP.TAM.redoCrrGetConditions(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG) ;*Manual R22 conversion
...
* Gets the role of the customer in that arrangement
    ...
    ERR.MSG = ''
    APAP.TAM.redoCrrGetConditions(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.CUSTOMER,ERR.MSG) ;*Manual R22 conversion

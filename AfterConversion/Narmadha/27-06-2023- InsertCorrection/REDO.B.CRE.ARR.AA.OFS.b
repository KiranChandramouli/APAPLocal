* @ValidationCode : MjotMTQwNTE2Nzk3NTpVVEYtODoxNjg3ODY0ODczMTU2OkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Jun 2023 16:51:13
...
* R.REDO.CREATE.ARRANGEMENT<REDO.CR.REC.STATUS> = Y.STATUS
    R.REDO.CREATE.ARRANGEMENT<REDO.FC.RECORD.STATUS> = Y.STATUS ;* Manual R22 Conversion,REDO.CR.REC.STATUS changed to REDO.FC.RECORD.STATUS according to I_F.REDO.CREATE.ARRANGEMENT insert file

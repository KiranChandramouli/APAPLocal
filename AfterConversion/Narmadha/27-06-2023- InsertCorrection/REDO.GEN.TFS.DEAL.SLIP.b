* @ValidationCode : MjotMjc4NTgyNzkzOlVURi04OjE2ODc4NTAxOTQyMjI6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Jun 2023 12:46:34
...
* 27-06-2023    Narmadha V    Manual R22 conversion     comment the insert file,FM to @FM ,VM to @VM
*--------------------------------------------------
    ...
    $INSERT I_F.CURRENCY
    $INSERT I_TT.COMMON
*$INSERT I_T24.FS.COMMON ;Manual R22 conversion
...
*Y.NAME.2         = R.CUSTOMER<EB.CUS.NAME.2>
    APAP.REDORETAIL.redoCustIdentityRef(Y.CUS.ID,Y.ALT.ID,Y.CUS.NAME) ;* Manual R22 Conversion

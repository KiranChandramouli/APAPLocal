* @ValidationCode : Mjo0Nzg5NTAwMzU6VVRGLTg6MTY4Nzg2NTEwNjgwNjpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 27 Jun 2023 16:55:06
...
*27-06-2023 Narmadha V Manual R22 Conversion -commented the variable DYN.TO.OFS,Call routine format modified
*=======================================================================
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
* ================
    ...
    IF R.PARAMS<12> EQ 'NOMINA' AND NOT(WERROR.MSG) THEN
        ...
        CALL APAP.REDOENQ.redoNominaAcctStatusCheck(IN.ACCT.ID,IN.ACCT.TYPE,OUT.ACCT.STATUS) ;* Manual R22 Conversion

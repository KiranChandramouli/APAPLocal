* @ValidationCode : MjoxODEwNjc0OTM3OlVURi04OjE2ODk1NzM3MDIyNDY6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 17 Jul 2023 11:31:42
...
* 14-07-2023    Conversion Tool        R22 Auto Conversion    INCLUDE to INSERT,BP is removed in insert file,>= to GE,= to EQ
...
*DEBUG
    ...
    WHILE AA.ARR.ID.YYYYMMDD:PRESTAMOS
        ...
        ELSE
            ...
            IF Y.PROJECTION.DATE GE Y.PJ.YYYYMMDD THEN
                Y.DATA<-1> = AA.ARR.ID.YYYYMMDD
            END ELSE
                CONTINUE
            END

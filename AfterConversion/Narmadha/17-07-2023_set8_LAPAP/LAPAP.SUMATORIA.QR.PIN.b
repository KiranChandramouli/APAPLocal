* @ValidationCode : MjoxNjU1NDAxOTA6VVRGLTg6MTY4OTU2OTYzMDYzNDpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 17 Jul 2023 10:23:50
...
*-----------------------------------------------------------------------------
    ...
    $INSERT I_GTS.COMMON
    $INSERT I_F.DATES
    $INSERT I_F.ST.LAPAP.TRANSACTION.QR.PIN ;*R22 Auto Conversion -END

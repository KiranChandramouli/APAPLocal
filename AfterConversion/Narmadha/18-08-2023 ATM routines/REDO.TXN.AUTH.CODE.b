* @ValidationCode : MjotMTc0Nzg3NjA3MzpVVEYtODoxNjkyMzQ0NTY2MDEzOkFkbWluOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 18 Aug 2023 13:12:46
...
*18-08-2023  Narmadha V     Manual R22 Conversion  BP is removed in insert file
*----------------------------------------------------------------------


    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_AT.ISO.COMMON ;* Manual R22 Conversion
    GOSUB PROCESS
RETURN

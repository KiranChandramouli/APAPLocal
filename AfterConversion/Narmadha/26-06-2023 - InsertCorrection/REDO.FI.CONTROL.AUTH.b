* @ValidationCode : Mjo0NTg0MTQ1MTg6VVRGLTg6MTY4Nzc4NDc3MTAyMDpBZG1pbjotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Jun 2023 18:36:11
...
*    Date          : 2010/Oct/22
*26-06-2023  Narmadha V   Manual R22 conversion -  Call routine format modified,Added I_REDO.FI.VARIABLES.COMMON insert file for variable FI.INTERFACE
*=======================================================================
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
    ...
    $INSERT I_REDO.FI.VARIABLES.COMMON ; * Manual R22 Conversion
    $USING  APAP.TAM
*
...
* TODO: ACTUALIZAR EL ARCHIVO I_F.REDO.FI.CONTROL
    ...
    IF F.CONFIRM EQ "SI" THEN
        ...
        IF FI.INTERFACE EQ 'NOMINA' THEN ;*Insert file added for FI.INTERFACE variable
            APAP.TAM.redoFiDebitProces(R.PARAMS, OUT.RESP, OUT.ERR) ;* Manual R22 Conversion
        END

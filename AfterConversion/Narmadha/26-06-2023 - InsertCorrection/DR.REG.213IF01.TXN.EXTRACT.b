* @ValidationCode : MjoxODQ1NTAwOTc1OlVURi04OjE2ODc3NzYwMzczMjE6QWRtaW46LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Jun 2023 16:10:37
...
* 26-06-2023      Narmadha V         Manual R22 Conversion  - Call routine format modified
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*-------------------*
    ...
    YACC.ID = ACC.ID
    APAP.LAPAP.drRegGetCustType(R.CUSTOMER,YACC.ID,CUSTOMER.TYPE,CUSTOMER.CODE) ;* Manual R22 Conversion
    GOSUB GET.NAMES

* @ValidationCode : MjoxMDc1MjAzMDI6Q3AxMjUyOjE2ODkyMjgxODA2NzM6SVRTUzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 13 Jul 2023 11:33:00
...
*------------------------------------------------------------------------
*  DATE             WHO                   REFERENCE                  
* 13-JULY-2023      Harsha                R22 Auto Conversion  - = to EQ , + to +=
...
***----------------------------------------------------------------------------
        ...
        BEGIN CASE
            CASE Y.AT.REV.CURRENCY.CODE EQ 214
            ...
            CASE Y.AT.REV.CURRENCY.CODE EQ 840
                Y.CERITOS.INT    = Y.AT.REV.TXN.AMOUNT
...
*PRINT "4 IF"
    ...
    CALL OfsGlobusManager("DIARY.OFS", FINAL.OFS)    	;*R22 Manual Conversion - Added call OfsGlobusManager
    CALL JOURNAL.UPDATE('')
*PRINT "OFS: " : FINAL.OFS

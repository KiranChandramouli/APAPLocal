* @ValidationCode : Mjo2NTA2MjI0Mzc6Q3AxMjUyOjE2ODQ0OTEwMzA5ODQ6SVRTUzotMTotMToxNTE6MTpmYWxzZTpOL0E6REVWXzIwMjEwOC4wOi0xOi0x
...
*CALL REDO.GET.MARGIN.ID(Y.ARR.CAMP.TYPE,Y.ARR.AFF.COMP,R.ARRAY,Y.MARGIN) ;*R22 MANUAL CODE CONVERSION
    APAP.TAM.redoGetMarginId(Y.ARR.CAMP.TYPE,Y.ARR.AFF.COMP,R.ARRAY,Y.MARGIN) ;*R22 MANUAL CODE CONVERSION
    IF Y.MARGIN THEN
...
*CALL REDO.CRR.GET.CONDITIONS(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.CUST,ERR.MSG)  ;*R22 MANUAL CODE CONVERSION
    APAP.AA.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.CUST,ERR.MSG) ;*R22 MANUAL CODE CONVERSION

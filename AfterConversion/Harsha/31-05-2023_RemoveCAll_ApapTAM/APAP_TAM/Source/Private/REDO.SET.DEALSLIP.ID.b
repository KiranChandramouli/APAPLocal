* @ValidationCode : MjoyNTQ2NDcwOTY6Q3AxMjUyOjE2ODQ4NDIxMzA5NzE6SVRTUzotMTotMTotNDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
* Fix for PACS00305984 [CASHIER DEAL SLIP PRINT OPTION]
    ...
    Y.FLD = "L.INITIAL.ID"
    Y.FLD.POS = ''
    CALL MULTI.GET.LOC.REF(Y.APPL,Y.FLD,Y.FLD.POS) ;*MANUAL R22 CODE CONVERSION

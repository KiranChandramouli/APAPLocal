...
*   $INSERT I_BATCH.FILES
    ...
    $INSERT I_F.REDO.CUSTOMER.ARRANGEMENT ;*R22 AUTO CODE CONVERSION.END
*
    GOSUB INIT
    GOSUB FIND.LOC.REF
    GOSUB PROCESS
...
FIND.LOC.REF:
*-----------
    Y.APP = "CUSTOMER":@FM:"INDUSTRY":@FM:"AA.PRD.DES.OVERDUE":@FM:'ACCOUNT' ;*R22 AUTO CODE CONVERSION
    Y.FIELDS = "L.CU.TIPO.CL":@VM:"L.CU.CIDENT":@VM:"L.CU.RNC":@VM:"L.CU.DEBTOR":@VM:"L.TIP.CLI":@VM:"L.CU.PASS.NAT":@VM:"L.APAP.INDUSTRY":@VM:"L.CU.COM.CLASIF":@FM:"L.AA.CATEG":@FM:"L.LOAN.STATUS.1":@FM:"L.OD.STATUS" ;*R22 AUTO CODE CONVERSION
    Y.FIELD.POS = ""

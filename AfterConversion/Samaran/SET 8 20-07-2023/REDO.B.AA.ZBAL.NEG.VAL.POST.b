...
*13-07-2023       Conversion Tool        R22 Auto Code conversion          No Changes
...
***************
    ...
    EXTRACT.FILE.ID = Y.OUT.FILE.NAME:TODAY:'.':Y.TIME:'.txt'         ;* Parameterise
    GOSUB READ.FILE
    R.FILE.DATA = "ID Prestamo*ID Cuenta*Estado No*Estatus Manual*Condición Préstamo*Cliente Préstamo*Vlor Cuota*Pendiente Pago*Impuesto*Fecha Cuota*No. Cuenta Debito*Cliente Cta Debito*Saldo Disp. Cta Debito"
    SEL.CMD = ''; ID.LIST = ""; ID.CNT = ''; ERR.SEL = ''

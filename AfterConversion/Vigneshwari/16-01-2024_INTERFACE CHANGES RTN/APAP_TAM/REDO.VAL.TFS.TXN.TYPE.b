* @ValidationCode : MjotMzAzMDQwMTY0OkNwMTI1MjoxNzA1Mzk2NDkxNjk0OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 16 Jan 2024 14:44:51
...
*13/07/2023	        CONVERSION TOOL                       AUTO R22 CODE CONVERSION-"USPLATFORM.BP" IS REMOVED IN INSERT FILE,VM TO @VM,++ TO +=1
*13/07/2023	        VIGNESHWARI	                               MANUAL R22 CODE CONVERSION- CALL method format hanged
*16-01-2024	        VIGNESHWARI       			ADDED COMMENT FOR INTERFACE CHANGES - SQA-11706 - By Santiago
*********************************************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.COMPANY
    ...
    $INSERT I_F.TELLER
    $INSERT I_F.ACCOUNT
    $INSERT I_F.T24.FUND.SERVICES;*AUTO R22 CODE CONVERSION
    $INSERT I_F.TFS.PARAMETER;*AUTO R22 CODE CONVERSION
*--------------------------------------------------------------------------------------------------------
**********
*MAIN.PARA:	;*Fix SQA-11706 - By Santiago-COMMENTED
**********
...
**********
    ...
    IF AF EQ TFS.CREATE.NET.ENTRY THEN
        APAP.TAM.redoTfsWaiveChargeNo();* R22 Manual conversion - CALL method format changed
    END
...
*    Y.GET.WASH.CATEG = R.TFS.PARAM<TFS.PAR.NET.ENTRY.WASHTHRU>		;*Fix SQA-11706 - By Santiago-COMMENETED
    Y.GET.WASH.CATEG = R.TFS.PARAM<TFS.PAR.CONSOL.WASHTHRU> ;*MANUAL R22 CODE CONVERSION- "TFS.PAR.NET.ENTRY.WASHTHRU" TO "TFS.PAR.CONSOL.WASHTHRU"	;*Fix SQA-11706 - By Santiago-UNCOMMENTED

* @ValidationCode : Mjo5Nzc2ODQ0MzI6Q3AxMjUyOjE3MDU1NzcyMDY0ODE6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 18 Jan 2024 16:56:46
...
*18-01-2024	      VIGNESHWARI       ADDED COMMENT FOR INTERFACE CHANGES- SQA-12394 – By Santiago
*-------------------------------------------------------------------------------------
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*    MAP.FMT = 'MAP'  ;*SJ
    MAP.FMT  = 'O'
    ID.RCON.L = Y.MAPPING.ID
    APP = 'F.':Y.APPLICATION	;*Fix SQA-12394 – By Santiago-changed "'F.':FIELD(Y.MAPPING.ID,'/',1)" to "'F.':Y.APPLICATION"
    ID.APP = Y.RECORD.ID
    
    R.RETURN.MSG = ''
    ERR.MAPPING = ''
    
    Y.FN.APP = 'F.':Y.APPLICATION	;*Fix SQA-12394 – By Santiago - changed "'F.':FIELD(Y.MAPPING.ID,'/',1)" to "'F.':Y.APPLICATION"
    Y.F.APP  = ''

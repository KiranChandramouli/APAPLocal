* @ValidationCode : Mjo4Mzc2NDY2OTA6Q3AxMjUyOjE3MDIyMTc4NzAzNjg6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 10 Dec 2023 19:47:50
...
* SJ start
    ...
    OFS.FUNCTION = 'I'
    OFS.PROCESS = 'PROCESS'
*    OFS.VERSION = "LIMIT,APAP"
    OFS.VERSION = "LIMIT,"
    Y.GTSMODE = ''
    NO.OF.AUTH = '0'
    TRANSACTION.ID = Y.LIMIT.ID
    R.RECORD = R.LIMIT.INPUT
    Y.OFS.MSG.REQ=''

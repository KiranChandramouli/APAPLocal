* @ValidationCode : MjoyMDM5OTk4NzIzOkNwMTI1MjoxNjg1NTI4MjA1MTgxOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 15:46:45
...
** R22 Manual conversion
        APAP.REDOCHNLS.redoInterfaceRecAct(Y.INT.CODE, Y.INT.TYPE, '', '', Y.INT.INFO, Y.INT.INFO, Y.NRO.DOCUMENTO, Y.INT.MONT, Y.INT.DESC, Y.INT.DATA, Y.INT.USER, Y.INT.EXPC);* R22 Manual conversion
        RETURN
    END
    CALL OPF(FN.AA.ARRANGEMENT , F.AA.ARRANGEMENT )

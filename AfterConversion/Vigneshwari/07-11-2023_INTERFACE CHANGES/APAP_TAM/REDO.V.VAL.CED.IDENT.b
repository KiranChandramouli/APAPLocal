* @ValidationCode : MjoxMDEwMDA0OTg2OkNwMTI1MjoxNjk5MzQ5NzU4NTQ5OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 07 Nov 2023 15:05:58
...
*APAP.REDOCHNLS.REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP,DESC,REC.CON,EX.USER,EX.PC) ;*R22 MANUAL CODE CONVERSION
...
*R22 MANUAL CONVERSION
*APAP.REDOSRTN.REDO.S.CALC.CHECK.DIGIT(Y.L.CU.CIDENT) ;*R22 MANUAL CODE CONVERSION
    APAP.REDOSRTN.redoSCalcCheckDigit(Y.L.CU.CIDENT) ;*R22 MANUAL CODE CONVERSION

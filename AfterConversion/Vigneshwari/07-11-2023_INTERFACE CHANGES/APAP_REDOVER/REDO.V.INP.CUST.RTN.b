* @ValidationCode : MjotOTM4NDQ1MzkyOkNwMTI1MjoxNjk5MzUwOTY2MDMzOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 07 Nov 2023 15:26:06
...
*            Cedule = "padrone$":Y.L.CU.CIDENT       SJ
            Cedule = Y.L.CU.CIDENT                  ;*SJ	;*Interface Change by Santiago
            INT.CODE = 'CIDENT'
            GOSUB CHK.PADRONE
...
*            Cedule = "rnc$":Y.L.CU.RNC             SJ
            Cedule = Y.L.CU.RNC                     ;*SJ	;*Interface Change by Santiago
            INT.CODE = 'RNC'
            GOSUB CHK.PADRONE
...
*PACS00157018 - E
    ...
    DESC = VAR.NAME<3>
    IF Ret THEN
        GOSUB PADRONE.CHECK.OLD ;*Interface Change by Santiago-changed "GOSUB PADRONE.CHECK" to "GOSUB PADRONE.CHECK.OLD"
    END
RETURN
*--------------------------------------------------------------------------------------------------------------------

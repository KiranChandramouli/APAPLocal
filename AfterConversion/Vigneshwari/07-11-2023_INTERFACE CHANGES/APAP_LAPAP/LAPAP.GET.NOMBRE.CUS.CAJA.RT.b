* @ValidationCode : MjotMTA1MDM0MzA4MTpDcDEyNTI6MTY5OTMzOTQxMTk4Nzp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 07 Nov 2023 12:13:31
...
******************************
METHOD_GET_NO_CLIENTE.OLD:	;*Interface Change by Santiago-CHANGE METHOD_GET_NO_CLIENTE TO METHOD_GET_NO_CLIENTE.OLD
******************************
...
*   STATUS.CODE      = Y.RESPONSE<7>
    ...
    END ELSE
        ...
        IF Y.RESPONSE<7> EQ "SUCCESS" THEN
            ...
            END ELSE
*RNC
                Y.NOMBRE.COMPLETO = Y.RESPONSE<3>
            END
        END
    END

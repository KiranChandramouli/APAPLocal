* @ValidationCode : Mjo3MzE4NTY1OTQ6Q3AxMjUyOjE2ODY4MTM4OTc3NjY6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 12:54:57
...
SUBROUTINE RGS.TRANS.T24INV2
REM "RGS.TRANS.T24INV2",230614-4
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.TRANS.T24INV2")
    END
*
    YCOM = ID.COMPANY
*

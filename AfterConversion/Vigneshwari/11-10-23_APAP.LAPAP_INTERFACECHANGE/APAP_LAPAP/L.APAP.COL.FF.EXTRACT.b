* @ValidationCode : MjoxNzc1Mzg1MTAxOkNwMTI1MjoxNjk3MDAzNzgzMDk5OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Oct 2023 11:26:23
...
*10/10/2023	    VIGNESHWARI       ADDED COMMENT FOR INTERFACE CHANGES      LINES IS ADDED
*---------------------------------------------------------------------------------------	-
...
*****************
    ...
    IF NOT(R.CUSTOMER) THEN  ;*Interface Change by Santiago
        ...
        R.CUSTOMER = R.CUSTOMER.HST  ;*Interface Change by Santiago
    END
    IF R.CUSTOMER THEN
...
*Extrae el tipo de Documento del Customer
*-----------------------------------------------------------------------------------
GET.CUS.ID.TYPE:
*-----------------------------------------------------------------------------------
    BEGIN CASE
...
*EXTRACT INFORMATION ABOUT CUSTOMER
*-----------------------
CUSTOMER.STMT:
*-----------------------
...
*BUCLE PARA LA LECTURA DEL CAMPO LOCAL DEL CLIENTE CORRESPONDIENTE A TELEFONOS  ;*Interface Change by Santiago
*-------------------
GET.CUSTOMER.PHONES:
*-------------------
    IF Y.CLI.TELF.TYPE NE "" THEN
...
*OBTENER TMPCLIENTEDIRECCIONES   18-inicio
*-------------
ADDRESS.STMT:
*-------------
...
*-----------------------------------------------------------------------------------
WRITE.RECORD.NEW:              ;*Interface Change by Santiago-START
*-----------------------------------------------------------------------------------
...
*        Y.QUEUE.ID = DATE():Y.QUEUE.ID
        Y.QUEUE.ID = I.VAR       ;*Interface Change by Santiago

        R.REDO.COL.QUEUE = LIST.INSERTS.STMT(I.VAR)
        Y.FILE.ID='SESSION':R.REDO.COL.QUEUE<1>:Y.QUEUE.ID:AGENT.NUMBER     ;*Interface Change by Santiago

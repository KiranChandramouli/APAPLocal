* @ValidationCode : MjotOTgzNjQzNjg0OkNwMTI1MjoxNjk3MDAzODI1OTY2OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 11 Oct 2023 11:27:05
...
*11/10/2023	    VIGNESHWARI        ADDED COMMENT FOR INTERFACE CHANGES      LINES IS ADDED-Interface Change by Santiago
...
*************
    ...
    Y.LIST=SORT(Y.LIST)   ;*Interface Change by Santiago-START
    Y.REC.CNT=1
    LOOP
    ...
    Y.LIST.CNT=DCOUNT(Y.LIST,@FM)   ;*Interface Change by Santiago-END

* @ValidationCode : MjotMTY4NzI5MzQ1ODpDcDEyNTI6MTY5NjgyODQzMTgxNTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 09 Oct 2023 10:43:51
...
*-------Modification ends--------------------------------
    ...
    ELSE
        LOCK.AMT = BALANCE
    END
    VAR.TOT.LOCK.AMT=VAR.TOT.LOCK.AMT+LOCK.AMT
...
**** CALL ROUTINE TO UPDATE IN DATE TABLE****
    ...
    *CALL REDO.UPD.ACCOUNT.STATUS.DATE(ACC.LOCK.ID,VAR.STATUS)
    APAP.REDOAPAP.redoUpdAccountStatusDate(ACC.LOCK.ID,VAR.STATUS)  ;*MANUAL R22 CODE CONVERSION-call rtn modified.

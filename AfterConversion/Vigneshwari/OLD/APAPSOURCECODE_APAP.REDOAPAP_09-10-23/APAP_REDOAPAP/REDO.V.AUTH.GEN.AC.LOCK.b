* @ValidationCode : MjotMTg1NTEwMjI4NjpDcDEyNTI6MTY5NjgyODM1MDQzNDp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 09 Oct 2023 10:42:30
...
**** CALL ROUTINE TO UPDATE IN DATE TABLE****
        ...
        IF ACC.LOCK.ID THEN
           * CALL REDO.UPD.ACCOUNT.STATUS.DATE(ACC.LOCK.ID,VAR.STATUS)
            APAP.REDOAPAP.redoUpdAccountStatusDate(ACC.LOCK.ID,VAR.STATUS) ;*MANUAL R22 CODE CONVERSION-call rtn is modified
        END
****END****

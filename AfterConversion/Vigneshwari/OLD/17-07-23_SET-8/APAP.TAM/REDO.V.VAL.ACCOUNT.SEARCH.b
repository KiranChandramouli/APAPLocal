* @ValidationCode : MjotMzA3ODI4NzUzOkNwMTI1MjoxNjg5NTkxNjUxMzExOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 17 Jul 2023 16:30:51
...
CHECK.SUNNEL:
    ...
    IF NOT(R.SUNNEL.DETAILS) THEN
        CALL APAP.TAM.redoGetCardType(VAR.CARD.NO,Y.ACCT,Y.CARD.TYPE);* MANUAL R22 CODE CONVERSION

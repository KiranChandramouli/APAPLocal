* @ValidationCode : MjoxMTQ4NDIxNjY4OkNwMTI1MjoxNjg5MzM3NjA3Nzc3OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 14 Jul 2023 17:56:47
...
*13/07/2023	               CONVERSION TOOL      AUTO R22 CODE CONVERSION			 ../T24_BP & TAM.BP is removed in insertfile, FM is changed to @FM, ++ is changed to +=1
*													                                 VM is changed to @VM , SM is changed to @SM,"CONVERT" is changed to "CHANGE"
...
*-----------------------------------------------------------------------------
    ...
    $INSERT I_F.APAP.PARAM.DB.CR.MASK ;*AUTO R22 CODE CONVERSION-END
...
PROCESS:
    ...
    IF R.MASK.PARAM THEN
        ...
        CHANGE @VM TO @FM IN Y.VER.FLD.LST ;*AUTO R22 CODE CONVERSION
...
MASK.CARD.NUM:
    ...
    CHANGE @VM TO @FM IN Y.CARD.NUM.LST ;*AUTO R22 CODE CONVERSION
    CHANGE @SM TO @FM IN Y.CARD.NUM.LST ;*AUTO R22 CODE CONVERSION
            ...
            IF R.MASK.PARAM THEN
                ...
                WHILE Y.INT LE Y.LEN.CARD
                    ...
                    END ELSE
                        ...
                        END
                    END
                    Y.INT += 1 ;*AUTO R22 CODE CONVERSION
                REPEAT
            END

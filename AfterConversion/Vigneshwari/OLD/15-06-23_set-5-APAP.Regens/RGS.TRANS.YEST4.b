* @ValidationCode : Mjo5MTczODcxODg6Q3AxMjUyOjE2ODY4MTQwODQ5MjM6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 15 Jun 2023 12:58:04
...
SUBROUTINE RGS.TRANS.YEST4
REM "RGS.TRANS.YEST4",230614-4
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.TRANS.YEST4")
    END
*
    YCOM = ID.COMPANY
*

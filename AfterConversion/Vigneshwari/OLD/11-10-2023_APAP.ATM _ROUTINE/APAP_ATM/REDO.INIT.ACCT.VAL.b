* @ValidationCode : MjotMTYxODg4NDUxMTpDcDEyNTI6MTY5NzAyMjk0MTYxMjp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Oct 2023 16:45:41
...
*
        ...
        CALL CACHE.READ(FN.REDO.LAC.STATUS.CODE,"SYSTEM",R.REDO.LAC.STATUS.CODE,Y.ERR.STAT)
...
*CALL F.READ(FN.REDO.CR.DB.MAP,"SYSTEM",R.REDO.CR.DB.MAP,F.REDO.CR.DB.MAP,Y.ERR.CR.DB)
            CALL CACHE.READ(FN.REDO.CR.DB.MAP,"SYSTEM",R.REDO.CR.DB.MAP,Y.ERR.CR.DB)

* @ValidationCode : MjotOTU2MzQ5MDI2OkNwMTI1MjoxNjg1NTI4NTYwNjk3OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 15:52:40
...
*CALL REDO.CRR.GET.CONDITIONS(IN.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.OVERDUE,ERR.MSG)
    APAP.TAM.redoCrrGetConditions(IN.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION.OVERDUE,ERR.MSG);* R22 Manual conversion

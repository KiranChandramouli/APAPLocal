* @ValidationCode : MjoxMTk3NDMzNTEzOkNwMTI1MjoxNjkyOTQyNzQwNDM2OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 25 Aug 2023 11:22:20
...
* 25-08-2023          VIGNESHWARI         R22 MANUAL CONVERSTION -PATH IS MODIFIED
...
*
    *MY.CMD = 'COPY FROM ': PROG.FILE : ' TO ' : DIR.TO.CREATE : ' ALL'
    MY.CMD = 'SH -c cp ':PROG.FILE: '/':' ALL':' ':DIR.TO.CREATE:'/':' ALL' ;* R22 MANUAL CONVERSION - PATH IS MODIFIED
    CRT MY.CMD
    EXECUTE MY.CMD CAPTURING THE.OUTPUT
RETURN
*** </region>

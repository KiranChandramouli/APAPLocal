* @ValidationCode : MjotMTcxNjA0MDg1NzpDcDEyNTI6MTY5NTEyODQ2OTI0MTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 19 Sep 2023 18:31:09
...
* -----------------------------------------------------------------------------
    ...
    Y.CREDIT.TXN<-1> = Y.INS.VALUES : @FM : Y.TYPE.TXN  ;*ADDED COMMENT FOR INTERFACE CHANGES-Interface Change by Santiago- @VM changed to @FM
RETURN
...
*JV
    ...
    ;*GOSUB GET.STATIC.MAPPING   ;*AJUSTE ;*ADDED COMMENT FOR INTERFACE CHANGES-Interface Change by Santiago
...
*   CALL REDO.R.COL.GET.MAPPING(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING, Y.MAP.TYPE, Y.MAP.VALUE)
	...
	TEST.MAP = Y.MAP.VALUE ;*ADDED COMMENT FOR INTERFACE CHANGES-Interface Change by Santiago
RETURN

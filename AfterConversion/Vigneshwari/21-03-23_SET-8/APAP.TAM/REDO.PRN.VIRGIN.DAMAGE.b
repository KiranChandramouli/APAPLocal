* @ValidationCode : MjotMjExOTE5MTU3OTpDcDEyNTI6MTY4OTgzNjQ0OTg4NTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 20 Jul 2023 12:30:49
...
*13/07/2023	    CONVERSION TOOL                                 AUTO R22 CODE CONVERSION - VM TO @VM, SM TO @SM
...
*-----------------------------------------------------------------------------
    ...
    WHILE Y.ID : POS1
        ...
        *Y.REQUEST.DATE.LIST = R.REDO.BRANCH.REQ.STOCK<BRAN.STK.REQUEST.DATE>
        Y.REQUEST.DATE.LIST = R.REDO.BRANCH.REQ.STOCK<BRAN.STK.TXN.DATE>  ;*MANUAL R22 CODE CONVERSION- "BRAN.STK.REQUEST.DATE" to "BRAN.STK.TXN.DATE"

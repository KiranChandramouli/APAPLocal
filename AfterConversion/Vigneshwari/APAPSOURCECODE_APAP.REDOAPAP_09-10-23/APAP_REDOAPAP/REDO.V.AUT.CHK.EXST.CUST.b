* @ValidationCode : Mjo1MzI2Mzk5ODQ6Q3AxMjUyOjE2OTY4Mjc5NjU4MTM6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 09 Oct 2023 10:36:05
...
*06/10/2023    VIGNESHWARI      MANUAL R22 CODE CONVERSION       SM to @SM, VM to @VM,FM to @FM, Call routine is modified.
*-----------------------------------------------------------------------------------
    $INSERT I_EQUATE
    $INSERT I_COMMON
    $INSERT I_F.CUSTOMER
...
****LOC TABLE UPDATE***
        ...
        IF Y.ACCOUNT THEN
           * CALL REDO.UPD.ACCOUNT.STATUS.DATE(Y.ACCOUNT,'DECEASED')
            APAP.REDOAPAP.redoUpdAccountStatusDate(Y.ACCOUNT,'DECEASED')    ;*MANUAL R22 CODE CONVERSION-call rtn is modified.
        END
****END****
        TEMP.V = V

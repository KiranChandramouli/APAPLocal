* @ValidationCode : MjoyODkyNjIzNjE6Q3AxMjUyOjE2OTUyMDYyMTM4NDY6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 20 Sep 2023 16:06:53
...
*    SEL.CMD = "SELECT " :CS.PATH: " LIKE " :'CS':PROCESS.DATE: ".temp..."  ;*ADDED COMMENT FOR INTERFACE CHANGES-Interface Change by Santiago
    SEL.CMD = "SELECT " :CS.PATH   ;*ADDED COMMENT FOR INTERFACE CHANGES-Interface Change by Santiago
    ...
    LOOP   ;*ADDED COMMENT FOR INTERFACE CHANGES-START-Interface Change by Santiago
    ...
    WHILE Y.FILE:POS
        ...
        END
    REPEAT  ;*ADDED COMMENT FOR INTERFACE CHANGES-END

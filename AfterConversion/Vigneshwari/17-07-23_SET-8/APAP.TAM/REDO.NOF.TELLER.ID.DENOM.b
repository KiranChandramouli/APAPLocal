* @ValidationCode : MjotMTEwODQxMjMxODpDcDEyNTI6MTY4OTU2OTIzNzM0OTp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 17 Jul 2023 10:17:17
...
*13/07/2023	    CONVERSION TOOL      		              AUTO R22 CODE CONVERSION - ++ TO +=1, FM TO @FM,SM TO @SM,VM TO @VM
...
*---------------
    ...
    CALL CACHE.READ(FN.TELLER.TRANSACTION, Y.TRANSACTION.CODE, R.TELLER.TXN, TRANS.ERR)	;*AUTO R22 CODE CONVERSION
...
*************
    ...
    WHILE INIT LE Y.DENOM.COUNT
        ...
        END
        INIT += 1 	;*AUTO R22 CODE CONVERSION
    REPEAT

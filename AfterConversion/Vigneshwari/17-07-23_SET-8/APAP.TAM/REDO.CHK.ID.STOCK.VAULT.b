* @ValidationCode : MjoxOTg2NzY1NjQzOkNwMTI1MjoxNjg5ODMyMzQzNDY1OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 20 Jul 2023 11:22:23
...
*13/07/2023      CONVERSION TOOL                           AUTO R22 CODE CONVERSION  -F.READ to CACHE.READ,F.COMP to R.COMP, = Y.CNT + 1 to +=1, VM to @VM
*13/07/2023      VIGNESHWARI                               MANUAL R22 CODE CONVERSION -Lines is command
*----------------------------------------------------------------------
...
*  CALL F.READ(FN.REDO.SER.PARAM,'SYSTEM',R.REDO.SER.PARAM,F.REDO.SER.PARAM,SER.ERR) ;*Tus Start
   ...
   *     VAULT.DEPT.CODE = R.REDO.SER.PARAM<REDO.CARD.SERIES.PARAM.VAULT.DEPT.CODE> ;*MANUAL R22 CODE CONVERSION-This line is commanded
    END
    ...
    CALL CACHE.READ(FN.COMP, Y.DEFAULT.BRANCH, R.COMP, Y.COMP.ERR) ;*AUTO R22 CODE CONVERSION
   ...
   *     R.NEW(STO.ENT.TO.REGISTER)<1,Y.CNT> = 'CARD.':FINAL.COMP:'-':VAULT.DEPT.CODE ;*MANUAL R22 CODE CONVERSION-This line is commanded

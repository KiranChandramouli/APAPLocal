* @ValidationCode : MjotMTc1MjMxODI1MDpDcDEyNTI6MTY5ODIzMTE2OTU3MDp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 25 Oct 2023 16:22:49
...
* <Rating>-100</Rating>
*-----------------------------------------------------------------------------
    SUBROUTINE ITSS.REDO.V.AUTH.PYMNT
*-----------------------------------------------------------------------------
...
*           25/10/2023    VIGNESHWARI        MANUAL R23 CODE CONVERSION  Remove TAM.BP from insert file,VM TO @VM
*----------------------------------------------------------------------------------------------------------
* <region name="INSERTS">
    ...
    $INSERT I_F.REDO.VPLUS.MAPPING   ;*MANUAL R23 CODE CONVERSION-Remove TAM.BP from insert file
*    $INSERT TAM.BP I_F.REDO.VISION.PLUS.PARAM
    $INSERT I_F.REDO.VISION.PLUS.TXN ;*MANUAL R23 CODE CONVERSION-Remove TAM.BP from insert file
...
*R.NEW(FT.TRANSACTION.TYPE)
    ...
    IF EXT.USER.ID NE 'EXT.EXTERNAL.USER' THEN
        R.REDO.VISION.PLUS.TXN<VP.TXN.CARDHOLDER.NUM> = R.NEW(Y.LOCAL.REF)<1,CR.ACCT.NO.POS> ;*System.getVariable("CURRENT.CARD.ORG.NO")
    END

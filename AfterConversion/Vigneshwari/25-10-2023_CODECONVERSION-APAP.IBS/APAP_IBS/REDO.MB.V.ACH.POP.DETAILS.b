* @ValidationCode : MjotMTYzNzcyNDk1MDpDcDEyNTI6MTY5ODIzMjcyMzM0Nzp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 25 Oct 2023 16:48:43
...
* <Rating>-40</Rating>
*-----------------------------------------------------------------------------
    SUBROUTINE REDO.MB.V.ACH.POP.DETAILS
...
*-----------------------------------------------------------------------------
    ...
    $INCLUDE I_F.REDO.ACH.PARTICIPANTS
    $INCLUDE I_F.AI.REDO.ARCIB.PARAMETER
...
*---------------*
    ...
    CALL F.READ(FN.BENEFICIARY,BEN.ID,R.BEN,F.BENEFICIARY,BEN.ERR)
    IF NOT(BEN.ERR) THEN
...
*----------------------*
    ...
    IF APPLICATION EQ 'FUNDS.TRANSFER' THEN
        ...
        BEGIN CASE
        CASE PGM.VERSION EQ ',MB.REDO.TRANSFER.OUT'
            Y.TYPE = 'THIRD-TRANSFER'
            GOSUB DEFAULT.CUSTOMER.ACCOUNT
        CASE PGM.VERSION  EQ ',MB.REDO.LOAN.OUT'
            Y.TYPE = 'THIRD-PAYMENT'
            GOSUB DEFAULT.CUSTOMER.ACCOUNT
        CASE PGM.VERSION  EQ ',MB.REDO.CARD.OUT'

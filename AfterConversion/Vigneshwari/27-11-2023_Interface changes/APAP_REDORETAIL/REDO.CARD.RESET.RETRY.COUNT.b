* @ValidationCode : Mjo3OTc2MzE6Q3AxMjUyOjE3MDEwOTAwNTY5OTM6dmlnbmVzaHdhcmk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 27 Nov 2023 18:30:56
...
*-------
    ...
    IF Y.PREV.STATUS NE '75' OR Y.NEW.STATUS NE '94' THEN
        Y.VALUES = ' : ':Y.PREV.STATUS:' - ':Y.PREV.STATUS	;*Fix Embozado � By Santiago-new lines added
        AF=CARD.IS.CARD.STATUS
        ETEXT="EB-RESET.CNT.FAILED":@FM:Y.VALUES	;*Fix Embozado � By Santiago-new lines added
...
*    Y.RESPONSE = CALLJEE(ACTIVATION,INPUT_PARAM)	;*Fix Embozado � By Santiago-commented
	EB.SystemTables.CallJavaApi('REDO.WS.EMBOZADO', INPUT_PARAM, CalljResponse, CalljError)	;*Fix Embozado � By Santiago-new lines added-start
...
*            Y.VALUES = ' Output1: ':CalljResponse	;*Fix Embozado � By Santiago-new lines added and commented
            AF=CARD.IS.CARD.STATUS
            ETEXT="EB-RESET.CNT.FAILED"     ;* :@FM:Y.VALUES	;*Fix Embozado � By Santiago-new lines added and commented
            CALL STORE.END.ERROR
    ...
    END
    ELSE
*        Y.VALUES = ' Output2: ':Y.OUTPUT	;*Fix Embozado � By Santiago-new lines added and commented
        AF=CARD.IS.CARD.STATUS
        ETEXT="EB-RESET.CNT.FAILED"         ;* :@FM:CalljResponse	;*Fix Embozado � By Santiago-new lines added and commented
        CALL STORE.END.ERROR
...
*-----------------
    ...
    INT.CODE='EMB002'
    INT.TYPE='ONLINE'
*APAP.REDOCHNLS.REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP.REJ,DESC,REC.CON,EX.USER,EX.PC)

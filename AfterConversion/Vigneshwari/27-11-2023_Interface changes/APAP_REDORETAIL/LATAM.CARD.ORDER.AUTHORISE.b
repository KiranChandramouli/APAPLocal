* @ValidationCode : MjotOTA3Mjk4OTE2OkNwMTI1MjoxNzAxMDg5ODc0NzQ1OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Nov 2023 18:27:54
...
*   $INSERT I_F.REDO.CARD.REQUEST ;*AUTO R22 CODE CONVERSION
    ...
    $USING EB.SystemTables	;*Fix Embozado � By Santiago- New insert  added
...
*        ERROR.CODE = CALLJEE (ACTIVATION,INPUT_PARAM)	;*Fix Embozado � By Santiago-commented
        ...
        WHILE I LE Y.TOT.VAL
            ...
            I++
        REPEAT
        INPUT_PARAM = Y.LINE.TMP	;*Fix Embozado � By Santiago-End
        
        RESPONSE.CODE = INPUT_PARAM<4>	;*Fix Embozado � By Santiago-Changed "FIELD(INPUT_PARAM,Y.DEM,4)" to "INPUT_PARAM<4>"
...
*APAP.REDOCHNSL.REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP.REJ,DESC,REC.CON,EX.USER,EX.PC)
            ...
            Y.VAL.ERR = ' FAILED: ':RESPONSE.CODE:' ':DESC	;*Fix Embozado � By Santiago-New lines added
            E='EB-UPD.NO.PROC.DISP':@FM:Y.VAL.ERR	;*Fix Embozado � By Santiago-new one added-":@FM:Y.VAL.ERR"
            RETURN
        END
...
*APAP.REDOCHNSL.REDO.INTERFACE.REC.ACT(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP.REJ,DESC,REC.CON,EX.USER,EX.PC)
            APAP.REDOCHNLS.redoInterfaceRecAct(INT.CODE,INT.TYPE,BAT.NO,BAT.TOT,INFO.OR,INFO.DE,ID.PROC,MON.TP.REJ,DESC,REC.CON,EX.USER,EX.PC);*MANUAL R22 CODE CONVERSION
            Y.VAL.ERR = ' ERROR: ':RESPONSE.CODE:' ':DESC	;*Fix Embozado � By Santiago-new line added
            E='EB-UPD.NO.PROC.DISP':@FM:Y.VAL.ERR	;*Fix Embozado � By Santiago-new one added":@FM:Y.VAL.ERR"
        END
    END
*    END
...
*    ERROR.CODE = CALLJEE (ACTIVATION,INPUT_PARAM)	;*Fix Embozado � By Santiago-commented
    ...
    RESPONSE.CODE = INPUT_PARAM<3>	;*Fix Embozado � By Santiago-changed "FIELD(INPUT_PARAM,Y.DEM,3)" to "INPUT_PARAM<3>"
    IF RESPONSE.CODE NE '' THEN

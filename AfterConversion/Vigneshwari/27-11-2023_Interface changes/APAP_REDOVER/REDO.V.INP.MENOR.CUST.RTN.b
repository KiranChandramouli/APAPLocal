* @ValidationCode : MjotNDY5MDg4NDE3OkNwMTI1MjoxNzAxMDkwMzAyMjUyOnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 27 Nov 2023 18:35:02
...
SUBROUTINE REDO.V.INP.MENOR.CUST.RTN
*******************************************************************************************************************
...
*                    & CUSTOMER,REDO.MOD.CL.MINOR.TEST & CUSTOMER,REDO.ACT.MOD.CL.PF.TEST & CUSTOMER,REDO.OPEN.CLIENTE.PF.TEST
*                    & CUSTOMER,REDO.OPEN.CLIENTE.PJ.TEST & CUSTOMER,REDO.ACT.MOD.CL.PJ.TEST & CUSTOMER,REDO.OPEN.PROSP.PF.TEST
...
* 27-OCT-2011        Pradeep S                  PACS00152066           Age validation corrected
...
*12-04-2023              Samaran T                R22 Manual Code conversion                       Call Routine Format M odified
...
*---------------------------------------------------------------------------------------------------------------------------------
    ...
    $INSERT JBC.h
*SJ start	;*Interface Change by Santiago-new lines is added-start
...
PROCESS:
********
* This block checks the basic validations for minor customer
    GOSUB CHK.AGE

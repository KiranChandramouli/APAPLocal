* @ValidationCode : MjotMTYzMjU5NDM0NzpDcDEyNTI6MTY5MjkzOTcwNzY3Mzp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 25 Aug 2023 10:31:47
...
* CALL REDO.FI.MSG.FORMAT(FI.INTERFACE,N.DETAIL,DATO.OUT)
    ...
    IF Y.ERR.MSG NE "" THEN
        ...
        Y.MAIL.MSG<-1> = R.REDO.TEMP.FI.CONTROL<FI.TEMP.MAIL.MSG>  ;*R22 MANUAL CONVERSION Adding Y.MAIL.MSG<-1> = R.REDO.TEMP.FI.CONTROL<FI.TEMP.MAIL.MSG>
    END

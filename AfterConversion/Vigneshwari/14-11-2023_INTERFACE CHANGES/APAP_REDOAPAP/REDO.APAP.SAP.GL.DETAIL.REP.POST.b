* @ValidationCode : Mjo3MTQ5NDEzNjpDcDEyNTI6MTY5OTk2MTk1MzMyNjp2aWduZXNod2FyaTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 14 Nov 2023 17:09:13
...
* 13/10/2023	   VIGNESHWARI       ADDED COMMENT FOR INTERFACE CHANGES      Interface Change by Santiago
...
DEBUG 
    ...
    EXECUTE DAEMON.CMD RETURNING RETURN.VALUE CAPTURING CAPTURE.CAT.VALUE
    EXECUTE DAEMON.REM.CMD RETURNING RETURN.VALUE CAPTURING CAPTURE.REM.VALUE
;*CAMBIO	;*Interface Change by Santiago-commented-start	 	
...
*;cambio por archivo vacio JG	;*Interface Change by Santiago-END
            F.IN.FILE.DIR = ''
			OPEN Y.EXTRACT.OUT.PATH.REV TO F.IN.FILE.DIR ELSE	;*Interface Change by Santiago-line is modified
				CALL OCOMO("CANNOT OPEN ":Y.EXTRACT.OUT.PATH.REV)	;*Interface Change by Santiago-line is modified
			END
*;cambio JG	;*Interface Change by Santiago-start-commented
*	  LOOP
...
*    REPEAT	 
;*CAMBIO JG	;*Interface Change by Santiago-END

       READ REVAL.FILE.DATA FROM F.IN.FILE.DIR,Y.REVAL.ID ELSE	;*Interface Change by Santiago-new lines added-start
        CALL OCOMO("CANNOT READ FROM ":F.EXTRACT.OUT.FILE.PATH)	;*Interface Change by Santiago-END
       END
    ...
    OPENSEQ Y.EXTRACT.OUT.PATH.REV, Y.REVAL.ID TO Y.REVAL.FILE.PATH ELSE
        ...
        END
    END
    Y.REVAL.IND=''	;*Interface Change by Santiago-line is modified

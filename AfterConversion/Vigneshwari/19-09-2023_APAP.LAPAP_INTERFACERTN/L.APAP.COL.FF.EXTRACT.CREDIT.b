* @ValidationCode : MjotMTQ3MjI2MDY2OkNwMTI1MjoxNjk1MTA5MzcwMzY1OnZpZ25lc2h3YXJpOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Sep 2023 13:12:50
...
*19/09/2023	    VIGNESHWARI       AUTO R22 CODE CONVERSION      LINES IS ADDED
*19/09/2023	    CONVERSION TOOL   MANUAL R22 CODE CONVERSION	  NOCHANGE	
*---------------------------------------------------------------------------------------	-
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*-----------------------------------------------------------------------------
	...
	INFO.1 = PR.GESCREDITOSGARANTIAS  ;*AUTO R22 CODE CONVERSION-START
	INFO.2 = PR.GESTIPOGARANTIAS
	INFO.3 = P.GESCREDITOINTEGRACION  ;*AUTO R22 CODE CONVERSION-END
...
* CALL REDO.R.COL.GET.MAPPING(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING, "PRODUCT.GROUP", Y.TMPCREDITOCODIGOPRODUCTO)
    ...
    ;*APAP.TAM.redoRColGetMapping(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING, "PRODUCT.GROUP", ;*Y.TMPCREDITOCODIGOPRODUCTO) ;*AUTO R22 CODE CONVERSION
...
* CALL REDO.R.COL.GET.MAPPING(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING, "TIPO.INV", Y.TMPCREDITOCODIGOTIPOINVERSION)
    ...
    ;*APAP.TAM.redoRColGetMapping(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING, "TIPO.INV", ;*Y.TMPCREDITOCODIGOTIPOINVERSION) ;*AUTO R22 CODE CONVERSION
...
*CALL REDO.COL.GET.TOTAL.OUTSTANDING(AA.ID,Y.PROP.AMT,Y.TMPCREDITOMONTODEUDATOTAL)
 ...
 TEST.F = P.GESCREDITOINTEGRACION ;*AUTO R22 CODE CONVERSION
...
* CALL L.APAP.COL.FF.EXTRACT.TXN(Y.LWD, AA.ID, R.STATIC.MAPPING, Y.ACCOUNT.ID, Y.PRODUCT.GROUP, Y.AGENCY.CODE, Y.CREDIT.TXN)
	...
	TES.T = Y.CREDIT.TXN  ;*AUTO R22 CODE CONVERSION
...
*-----------------------------------------------------------------------------
    ...
    ;*R.STATIC.MAPPING    =  C.STATIC.MAPPING       ;* Static Mapping  ;*AUTO R22 CODE CONVERSION
	
	
*CALL REDO.R.COL.GET.MAPPING(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING.OUT, "", "")
 
    APAP.TAM.redoRColGetMapping(C.ID.STATIC.MAPPING, R.STATIC.MAPPING, 1, R.STATIC.MAPPING.OUT, "", "")  ;*AUTO R22 CODE CONVERSION
 
    
    IF E THEN
        RETURN
    END
    ;*R.STATIC.MAPPING = R.STATIC.MAPPING.OUT  ;*AUTO R22 CODE CONVERSION

...
***********
    ...
    SESSION.FILE.ID = "SFI.":PROCESS.DATE[7,2]:PROCESS.DATE[5,2]:PROCESS.DATE[1,4]:".":AGENT.NUMBER:Y.EXT.FILE.EXTENSION  ;*R22 Auto conversion	;*Interface Change by Santiago
...
********************
    ...
    WHILE Y.COMPANY.MNE.ID:Y.COMPANY.MNE.POS
        CALL CACHE.READ(FN.MNEMONIC.COMPANY, Y.COMPANY.MNE.ID, R.MNEMONIC.COMPANY, ERR) ;*R22 Auto conversion	;*Interface Change by Santiago
        Y.COMPANY.ID = R.MNEMONIC.COMPANY<AC.MCO.COMPANY>
        CALL CACHE.READ(FN.COMPANY, Y.COMPANY.ID, R.COMPANY.REC, ERR.COMP) ;*R22 Auto conversion	;*Interface Change by Santiago
...
************
    ...
    WHILE Y.SPEC.TXN.CODE.ID:Y.SPEC.TXN.CODE.POS
        CALL CACHE.READ(FN.RE.TXN.CODE, Y.SPEC.TXN.CODE.ID, R.RE.TXN.CODE, ERR.COMP) ;*R22 Auto conversion	;*Interface Change by Santiago

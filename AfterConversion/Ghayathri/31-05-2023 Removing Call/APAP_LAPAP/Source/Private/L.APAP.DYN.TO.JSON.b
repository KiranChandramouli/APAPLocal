* @ValidationCode : MjotMTY3Nzk0NzA0NjpDcDEyNTI6MTY4NTUyOTY0MDA3MTpoYWk6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 May 2023 16:10:40
...
*CALL L.APAP.SM.TO.JSON.ARRAY(Y.ITEM.VALUE, Y.JSON.ITEM)  ;*R22 MANAUAL CODE CONVERSION
                APAP.LAPAP.lApapSmToJsonArray(Y.ITEM.VALUE, Y.JSON.ITEM)  ;*R22 MANAUAL CODE CONVERSION
...
*CALL L.APAP.VM.TO.JSON.ARRAY(Y.ITEM.VALUE, Y.JSON.ITEM) ;*R22 MANUAL CODE CONVERSION
                APAP.LAPAP.lApapVmToJsonArray(Y.ITEM.VALUE, Y.JSON.ITEM)  ;*R22 MANUAL CODE CONVERSION
                Y.JSON.ITEM = QUOTE(Y.ITEM.KEY) : ':' : Y.JSON.ITEM
            CASE 1

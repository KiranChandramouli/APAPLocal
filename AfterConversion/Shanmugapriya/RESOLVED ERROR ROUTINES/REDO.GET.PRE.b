* @ValidationCode : Mjo4MzA3ODkzODpDcDEyNTI6MTY4NDM5NTcxODc4OTpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 18 May 2023 13:11:58
...
* 18.05.2023       Conversion Tool       R22            Auto Conversion     - FM TO @FM, VM TO @VM, ++ TO += 1
...
*Shek -e
*Y.PROCESS.DETAIL = R.AA.ARRANGEMENT.ACTIVITY<AA.ARR.ACT.PROCESS.DETAIL>    ** R22 Manual conversion
        Y.PROCESS.DETAIL = ''           ;** R22 Manual conversion
        ...
        WHILE INIT1 LE Y.COUNT.TRANS1
            ...
            IF Y.APP.FUN EQ 'I' THEN
                GOSUB READ.FILES
            END
            INIT1 += 1              ;** R22 Auto conversion - ++ TO += 1
        REPEAT
    END

* @ValidationCode : MjoyMDc3OTQ2NjM1OkNwMTI1MjoxNjg1MDgzNTgxMzcwOklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 May 2023 12:16:21
...
* 18.05.2023    Conversion Tool       R22            Auto Conversion     - FM TO @FM, VM TO @VM
* 18.05.2023    Shanmugapriya M       R22            Manual Conversion   - AA.CUS.PRIMARY.OWNER TO AA.CUS.CUSTOMER
*
* -----------------------------------------------------------------------------------------------------
...
*PRIMARY.OWNER = R.AA.CUST<AA.CUS.PRIMARY.OWNER>
                PRIMARY.OWNER = R.AA.CUST<AA.CUS.CUSTOMER>       ;*R22 MANUAL CONVERSION
                OTHER.PARTY = CUST.ID

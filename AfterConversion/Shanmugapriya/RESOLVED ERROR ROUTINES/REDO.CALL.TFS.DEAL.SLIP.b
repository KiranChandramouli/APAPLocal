* @ValidationCode : MjotNjM4MDIxMzM0OkNwMTI1MjoxNjg0NDcxMTE2MzkwOnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 May 2023 10:08:36
...
*17-5-2023    CONVERSION TOOL     R22 AUTO CONVERSION     NO CHANGE
*17-5-2023    VICTORIA S          R22 MANUAL CONVERSION   VM TO @VM,FM TO @FM, CALL ROUTINE MODIFIED
*----------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.COMPANY
...
GET.LOC.REF:
*-------------------------------------------------------------
    LOC.REF.APPLICATION = "ACCOUNT":@FM:"T24.FUND.SERVICES" ;*R22 MANUAL CONVERSION
    LOC.REF.FIELDS      = 'L.AC.ALPH.AC.NO':@FM:'L.TT.NO.OF.CHQ':@VM:'L.NCF.NUMBER' ;*R22 MANUAL CONVERSION
    LOC.REF.POS         = ''
...
* Here we calculate the total amount, cash & cheque amount
    ...
    Y.CHEQUE.AMT   = 0
    Y.VAR1 = 1
    Y.TRANSACTION.CNT = DCOUNT(Y.TRANSACTION.CODE,@VM) ;*R22 MANUAL CONVERSION
    LOOP

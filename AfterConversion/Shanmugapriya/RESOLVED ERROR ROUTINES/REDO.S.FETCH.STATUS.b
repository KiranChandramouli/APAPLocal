* @ValidationCode : MjoyMTE2MTgwNzU5OkNwMTI1MjoxNjg0NDA0Nzg0OTcyOklUU1M6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 18 May 2023 15:43:04
...
*------------------------------------------------------------------------------------------
    ...
    GOSUB INIT
    GOSUB PRE.CHECK
*    GOSUB ASSIGN                 ** R22 Manual conversion
RETURN
*----
INIT:
*----

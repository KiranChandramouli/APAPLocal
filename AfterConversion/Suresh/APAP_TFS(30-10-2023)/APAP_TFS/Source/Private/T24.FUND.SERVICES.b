* @ValidationCode : Mjo4OTQ2Njc5NTQ6Q3AxMjUyOjE2OTgzMTk5MzY2NzE6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Oct 2023 17:02:16
...
*09 dec 2009 e
                    ...
                    IF TEMP.TEXT<2> THEN TEXT := @FM: TEMP.TEXT<2>
...
*
    ...
    IF TEXT = "NO" OR END.ERROR OR ETEXT OR E THEN          ;* Said No to override
...
SETUP.FLD.ENRI:
    ...
    FOR AV = 1 TO NO.OF.MVS
        NO.OF.SVS = DCOUNT(R.NEW(AF)<1,AV>,@SM)

* @ValidationCode : Mjo2OTE3NzU3OTpDcDEyNTI6MTY5ODMyMjcwNTA1MDozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Oct 2023 17:48:25
...
*
        IF NOT(E) THEN
            ...
            BEGIN CASE
                ...
                CASE V$FUNCTION MATCHES 'R' :@VM: 'D'
...
* For a new record, Load the transaction codes as defined in TFS.PARAMETER
    ...
    IF LOAD.TRANSACTIONS AND TFS$R.TFS.PAR<TFS.PAR.DEF.TFS.TXNS> THEN
        ...
        SAVE.COMI = COMI ; SAVE.AF = AF ; SAVE.AV = AV ; SAVE.E = E
        NO.OF.DEF.TFS.TXNS = DCOUNT(TFS$R.TFS.PAR<TFS.PAR.DEF.TFS.TXNS>,@VM)
        AF = TFS.TRANSACTION

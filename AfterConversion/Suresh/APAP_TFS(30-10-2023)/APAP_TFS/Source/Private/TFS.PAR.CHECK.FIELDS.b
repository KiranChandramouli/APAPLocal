* @ValidationCode : Mjo1NDAzMjE1MDU6Q3AxMjUyOjE2OTgzMDkzNDE1MDY6YWppdGg6LTE6LTE6MDowOnRydWU6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Oct 2023 14:05:41
...
INITIALISE:
    ...
    E = ''
    ETEXT = ''
    ALLOWED.INTERFACES = CHANGE('FT TT DC',' ',@VM,0)
        ...
        CASE AF EQ TFS.PAR.APPLICATION
            IF COMI THEN
                IF NOT(COMI MATCHES ALLOWED.INTERFACES) THEN
                    E = 'EB-TFS.ALLOWED.INTERFACES' :@FM: CHANGE(ALLOWED.INTERFACES,@VM,' ',0)
                END
            END

* @ValidationCode : MjotMTc2NzI5MzUyNzpDcDEyNTI6MTY5ODMyMjc1NzI2MTozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Oct 2023 17:49:17
...
* 07/09/05 - GP /s
    ...
    CHECKFILE(Z) = 'CURRENCY' :@FM: EB.CUR.CCY.NAME :@FM: 'L'
    Z += 1 ; F(Z) = 'CASH.BACK' ; N(Z) = '19..C' ; T(Z)<1> = 'AMT' ; T(Z)<2> = '':@VM:TFS.DEPOSIT.CCY

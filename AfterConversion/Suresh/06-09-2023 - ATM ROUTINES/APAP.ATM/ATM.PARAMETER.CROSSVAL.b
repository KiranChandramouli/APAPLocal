* @ValidationCode : MjotMTgwMzgyMzEzOkNwMTI1MjoxNjkzOTAxNDcwMjA2OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Sep 2023 13:41:10
...
*
    ...
    END CASE
*
*  CALL ATM.PARAMETER.CHECK.FIELDS ;*R22 Manual Conversion
    APAP.ATM.atmParameterCheckFields()
    IF E THEN
        ETEXT = E
        CALL STORE.END.ERROR
    END ELSE

* @ValidationCode : MjotMTkwMTEyMjI5NzpDcDEyNTI6MTY5NzAyOTMxNjAxMzpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
SUBROUTINE REDO.VI.VISA.REP.APPROVE
******************************************************************************
...
*11.04.2023  Conversion Tool       R22         Auto Conversion     - =Y.ACC.AVL.BAL+ TO +=, FM TO @FM, VM TO @VM
...
*END
    ...
    IF  R.AC.LOCKED.EVENTS THEN
        ...
        Y.ACC.AVL.BAL += Y.LOCKED.AMT              ;** R22 Auto conversion - =Y.ACC.AVL.BAL+ TO +=
    END
...
*IF R.DR.ACC<AC.CURRENCY> EQ LCCY AND R.CR.ACC<AC.CURRENCY> EQ LCCY THEN
    ...
    IF R.AC.LOCKED.EVENTS NE '' THEN
        ...
        OFSVERSION  = AC.LOCKED.EVENTS:',':R.REDO.APAP.H.PARAMETER<PARAM.AC.LCK.REV.VERSION,POS> ;*R22 Manual Conversion
        R.AC.LOCKED.EVENTS=''
...
*        CALL REDO.GET.CHRG.AMT(R.CR.ACC<AC.CURRENCY>,FT.CHRG.TYPE,Y.CHARGE.AMT)

* @ValidationCode : Mjo0Njk0NTY4MjpDcDEyNTI6MTY5NzAyOTMxNTc5MzpJVFNTMTotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 11 Oct 2023 18:31:55
...
*----------------------------------------------------------------------
    ...
    OFSFUNCT='R'
    PROCESS  = ''
    OFSVERSION = AC.LOCKED.EVENTS:',':Y.AC.LOCK.VERSION ;*R22 Manual Conversion
    GTSMODE = ''

...
*24/11/2023         Suresh             R22 Manual Conversion             T24.BP, REGREP.BP, LAPAP.BP   File Removed, INCLUDE TO INSERT, FM TO @FM, VM TO @VM, SM TO @SM
*----------------------------------------------------------------------------------------
...
*PACS00309078
    ...
    FN.POS.MVMT.TDY = 'F.POS.M@VMT.TODAY'; F.POS.MVMT.TDY = ''

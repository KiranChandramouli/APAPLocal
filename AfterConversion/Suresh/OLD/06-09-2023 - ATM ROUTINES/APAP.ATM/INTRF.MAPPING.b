* @ValidationCode : MjozNDA3NjMyODg6Q3AxMjUyOjE2OTM4OTcxNDA5NTQ6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 05 Sep 2023 12:29:00
...
*05/09/2023      Suresh                     R22 Manual Conversion           REM TO *, ! TO *, CALL routine format modified
*----------------------------------------------------------------------------------------
...
*    Y.ID.NEW = ID.NEW[1,7] ;*R22 Manual Conversion - START
...
CHECK.FIELDS:
* > CALL XX.CHECK.FIELDS ;*R22 Manual Conversion
...
*
    ...
    TEXT = ''
*
* > CALL XX.CROSSVAL ;*R22 Manual Conversion
*
...
* CALL INTRF.MAPPING.FIELD.DEFINITIONS ;*R22 Manual Conversion'
    APAP.ATM.intrfMappingFieldDefinitions()

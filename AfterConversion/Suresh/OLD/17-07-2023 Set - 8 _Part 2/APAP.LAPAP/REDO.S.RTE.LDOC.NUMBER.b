* @ValidationCode : MjotMTY0Njc0MjQyODpDcDEyNTI6MTY4OTM0MDU1MDUzMDozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 14 Jul 2023 18:45:50
...
SUBROUTINE REDO.S.RTE.LDOC.NUMBER(Y.OUT)
*--------------------------------------------------------------------------------
...
*********
    ...
    BEGIN CASE
        ...
        CASE Y.L.ACQD.CITIZEN NE ''
            Y.OUT = Y.L.ACQD.CITIZEN
        CASE Y.L.NEW.ID.CARD NE ''
            Y.OUT = Y.L.NEW.ID.CARD
        CASE Y.L.OLD.ID.CARD NE ''
            Y.OUT = Y.L.OLD.ID.CARD
        CASE OTHERWISE
            Y.OUT = ''
    END CASE

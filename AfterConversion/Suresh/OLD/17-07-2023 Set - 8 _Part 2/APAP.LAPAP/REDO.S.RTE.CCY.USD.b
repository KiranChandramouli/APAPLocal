* @ValidationCode : MjoxMTIxOTEwMzU2OkNwMTI1MjoxNjg5MzQwNDc4NjMzOjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 14 Jul 2023 18:44:38
...
SUBROUTINE REDO.S.RTE.CCY.USD(Y.OUT)
*--------------------------------------------------------------------------------
...
*13/07/2023      Conversion tool            R22 Auto Conversion            INCLUDE TO INSERT, BP removed in INSERT file, VM TO @VM, ++ TO +=, NE TO EQ
...
*************
    ...
    END CASE
    IF Y.RTE.TXN.CCY EQ 'USD' THEN ;*R22 Auto Conversion
        Y.OUT = 'SI'
    END ELSE
        Y.OUT = ''
    END

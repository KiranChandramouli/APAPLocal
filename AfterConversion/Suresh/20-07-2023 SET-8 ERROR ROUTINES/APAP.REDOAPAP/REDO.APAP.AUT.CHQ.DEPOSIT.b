* @ValidationCode : MjotNjkxMDg0MDE6Q3AxMjUyOjE2ODk3NjU5NTIxMTM6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 19 Jul 2023 16:55:52
...
* In this para of the code, the local template REDO.H.CLEARING.OUTWARD is being updated
    ...
    LOC.L.TT.NO.OF.CHQ.POS = '' ;*R22 Manual Conversion
...
********************
    ...
    Y.CHECK.DATE = DATE()
    EB.USER.DEPARTMENT.CODE = '';*R22 Manual Conversion

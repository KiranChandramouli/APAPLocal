* @ValidationCode : MjotMTA0NjkwNTAwMTpDcDEyNTI6MTY4OTc2NjMzOTYyODozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 19 Jul 2023 17:02:19
...
*13/07/2023      Conversion tool            R22 Auto Conversion            FM TO @FM, VM TO @VM, SM TO @SM
*13/07/2023      Suresh                     R22 Manual Conversion          CALL routine format modified,Variable initialised
*--------------------------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
****************
    ...
    APAP.REDOAPAP.redoApapSapGlDetailRptSplit1(Y.STMT.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST) ;*R22 Manual Conversion
...
*  IF R.RE.CONSOL.SPEC.ENT.KEY<1> GT 0 THEN ;*Tus Start
    RE.CSEK.RE.SPEC.ENT.KEY='' ;*R22 Manual Conversion
...
****************
    ...
    APAP.REDOAPAP.redoApapSapGlDetailRptSplit1(Y.RE.CONSOL.SPEC.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST) ;*R22 Manual Conversion
...
*****************
    ...
    APAP.REDOAPAP.redoApapSapGlDetailRptSplit1(Y.CATEG.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST) ;*R22 Manual Conversion

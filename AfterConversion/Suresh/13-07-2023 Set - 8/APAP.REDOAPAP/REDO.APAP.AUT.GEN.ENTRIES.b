* @ValidationCode : MjotMTc3MjYyNDYwNjpDcDEyNTI6MTY4OTI0MTU4NTMyNDozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 13 Jul 2023 15:16:25
...
*13/07/2023      Conversion tool            R22 Auto Conversion            F.READ TO CACHE.READ, FM TO @FM, VM TO @VM
...
* In this para of the code, file CATEG.INT.ACCT is read
    R.CATEG.INT.ACCT  = ''
    CATEG.INT.ACCT.ER = ''
    CALL CACHE.READ(FN.CATEG.INT.ACCT, CATEG.INT.ACCT.ID, R.CATEG.INT.ACCT, CATEG.INT.ACCT.ER) ;*R22 Auto Conversion
...
* In this para of the code, file FT.COMMISSION.TYPE is read
    ...
    CALL CACHE.READ(FN.FT.COMMISSION.TYPE, FT.COMMISSION.TYPE.ID, R.FT.COMMISSION.TYPE, FT.COMMISSION.TYPE.ER) ;*R22 Auto Conversion

* @ValidationCode : MjotNzQyOTIxMjUxOkNwMTI1MjoxNjg1NTI4MDQzODQ0OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 15:44:03
...
*------------------------------------------------------------------
    ...
    R.CONDITION  = ''
    ERR.MSG      = ''
    APAP.TAM.redoCrrGetConditions(Y.AA.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.CONDITION,ERR.MSG) ;*MANUAL R22 CODE ADDING PACKAGE

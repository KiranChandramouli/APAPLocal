* @ValidationCode : Mjo3NTE2MzI5MjE6Q3AxMjUyOjE2OTY1OTY1MjUzMjQ6MzMzc3U6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 06 Oct 2023 18:18:45
...
*06/10/2023      Suresh                     R22 Manual Conversion           FM TO @FM, VM TO @VM,  CALL routine format modified
*-----------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
********
    ...
    WHILE ACCT.ID:POS DO
        ...
        APAP.REDOAPAP.redoVCheckBalIntEntries(ACCT.ID,BAL.CR.AMT,BAL.DR.AMT,INT.CR.AMT,INT.DR.AMT,Y.BAL.DET,Y.INT.DET)  ;*R22 Manual Conversion
        IF BAL.CR.AMT THEN

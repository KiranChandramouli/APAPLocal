* @ValidationCode : MjotMTkzNDIwNjM3OkNwMTI1MjoxNjg5NzY1NzE2MzI4OjMzM3N1Oi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Jul 2023 16:51:56
...
***************
    ...
    IF R.REDO.LOAN.CHQ.RETURN THEN
        LN.CQ.RET.CHEQUE.RET.DT="";*R22 Manual Conversion
        ...
        WHILE Y.CHQ.RET.DT:Y.POS
            IF Y.CHQ.RET.DT AND Y.CHQ.RET.DT LT SYS.DATE THEN
                ...
                IF Y.DIFF GT Y.CHQ.RETAIN THEN
                    LN.CQ.RET.CHEQUE.STATUS=""               ;*R22 Manual Conversion

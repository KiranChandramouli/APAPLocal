* @ValidationCode : MjotMjA1NzA4MTk1MDpDcDEyNTI6MTY4Nzc2NzAzNjE5OTp2aWN0bzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Jun 2023 13:40:36
...
*26-06-2023    VICTORIA S          R22 MANUAL CONVERSION   FM TO @FM,INSERT FILE MODIFIED
*----------------------------------------------------------------------
...
LOCAL.REF:
*----------------------------------------------------------------------
    LOC.REF.APPLICATION="AZ.ACCOUNT":@FM:"T24.FUND.SERVICES" ;*R22 MANUAL CONVERSION
    LOC.REF.FIELDS='L.AZ.REF.NO':@FM:'L.TT.PROCESS' ;*R22 MANUAL CONVERSION
    LOC.REF.POS=''

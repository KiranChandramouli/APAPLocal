* @ValidationCode : MjotOTA2NzI5MTgzOkNwMTI1MjoxNjg3Nzc2NDMyMjM3OnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Jun 2023 16:17:12
...
*26-06-2023    VICTORIA S          R22 MANUAL CONVERSION   VM TO @VM,FM TO @FM
*-------------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_F.TELLER
...
*$INSERT I_F.T24.FUND.SERVICES ;*R22 MANUAL CONVERSION
    ...
    CHANGE @VM TO @FM IN Y.MANDATE.APPL ;*R22 MANUAL CONVERSION
    CHANGE @VM TO @FM IN Y.MANDATE.RECORD ;*R22 MANUAL CONVERSION
    Y.MANDATE.TOT = DCOUNT(Y.MANDATE.APPL,@FM) ;*R22 MANUAL CONVERSION
    Y.CNT = 1
    LOOP
...
*R22 MANUAL CONVERSION
                    APAP.REDOEB.redoEbCheckMandate(ALLOW.APPROVAL,Y.MAND.GROUP.ID)

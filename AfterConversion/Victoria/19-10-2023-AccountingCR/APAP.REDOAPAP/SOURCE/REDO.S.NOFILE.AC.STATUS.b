* @ValidationCode : MjoyMDA1Mzk4MTMyOkNwMTI1MjoxNjk3NzE4MDA1ODk0OnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 19 Oct 2023 17:50:05
...
*CALL REDO.V.CHECK.BAL.INT.ENTRIES(AC.ID,BAL.CR.AMT,BAL.DR.AMT,INT.CR.AMT,INT.DR.AMT,Y.BAL.DET,Y.INT.DET)
        APAP.REDOAPAP.redoVCheckBalIntEntries(AC.ID,Y.BALANCE,BAL.CR.AMT,BAL.DR.AMT,Y.ACC.INT,INT.CR.AMT,INT.DR.AMT,Y.BAL.DET,Y.INT.DET) ;*R22 MANUAL CONVERSION

* @ValidationCode : MjotNDUyNjExNjMwOkNwMTI1MjoxNjg4NTU4NDYyMzA2OnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 05 Jul 2023 17:31:02
...
*----------------------------------------------------------------------------------------
SUBROUTINE RGP.LC.ACCEPT
REM "RGP.LC.ACCEPT",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "letter Of Credit Accept / Def.Paymt"
    IF YPRINTING THEN
        YTYPE = ""
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "MAT.DATE  LC NUMBER       TYPE   APPLICANT/ISSUING BNK                  CCY         DR AMT     BENEFICIARY"
    YHDR2 = ""
    YHDR3 = ""
    YHDR4 = ""
    ...
    END
    YHDR.GROUP = ""
    YHDR1 = "TODAYS ACCPT/DEF.PAYMENTS"
    YHDR2 = ""
    YHDR3 = ""
    YHDR4 = ""

* @ValidationCode : MjoxNjM3OTI2NDA4OkNwMTI1MjoxNjg1NTM1ODc3MDU3OnZpY3RvOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 17:54:37
...
*CALL APAP.REDOSRTN.REDO.S.NOTIFY.INTERFACE.ACT('VPL002', 'ONLINE', '04', 'EMAIL ERROR ARCHIVO NO MONETARIO [' : WS.DATA<1> : '] - ' : WS.DATA<2>, 'REVISAR EN LOG $JBOSS_HOME\server\default\log\server.log ERROR EN ARCHIVO NO MONETARIO A LAS ' : TIMEDATE(), '', '', '', '', '', OPERATOR, '')
        APAP.REDOSRTN.redoSNotifyInterfaceAct('VPL002', 'ONLINE', '04', 'EMAIL ERROR ARCHIVO NO MONETARIO [' : WS.DATA<1> : '] - ' : WS.DATA<2>, 'REVISAR EN LOG $JBOSS_HOME\server\default\log\server.log ERROR EN ARCHIVO NO MONETARIO A LAS ' : TIMEDATE(), '', '', '', '', '', OPERATOR, '')  ;* MANUAL R22 CODE CONVERSION

* @ValidationCode : MjoyNDcyNDg1NjA6Q3AxMjUyOjE2ODU1MzU4ODI2MzA6dmljdG86LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 31 May 2023 17:54:42
...
*CALL APAP.REDORETAIL.REDO.AZ.PENAL.AMT.CALC('0',Y.PREC.DEP.DAYS,PEN.AMT)
        APAP.REDORETAIL.redoAzPenalAmtCalc('0',Y.PREC.DEP.DAYS,PEN.AMT);*MANUAL R22 CONVERSION
...
*CALL APAP.REDORETAIL.REDO.AZ.PENAL.AMT.CALC(Y.PENAL.PER,Y.PREC.DEP.DAYS,PEN.AMT)
    APAP.REDORETAIL.redoAzPenalAmtCalc(Y.PENAL.PER,Y.PREC.DEP.DAYS,PEN.AMT);*MANUAL R22 CONVERSION
    R.NEW(TT.TE.LOCAL.REF)<1,LOC.L.TT.PENAL.AMT> =PEN.AMT

* @ValidationCode : MjotMTc2OTExMDM3NjpDcDEyNTI6MTY4NTUzNTg4MjY5NDp2aWN0bzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
*CALL APAP.REDORETAIL.REDO.AZ.PENAL.AMT.CALC(Y.PENAL.PERCENT,Y.PREC.DEP.DAYS,PEN.AMT)
    APAP.REDORETAIL.redoAzPenalAmtCalc(Y.PENAL.PERCENT,Y.PREC.DEP.DAYS,PEN.AMT);* MANUAL R22 CODE CONVERSION

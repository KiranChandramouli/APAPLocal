* @ValidationCode : MjotMTgzOTQ2MDkwODpDcDEyNTI6MTY4NTUzNjAxNzkxMzp2aWN0bzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
...
*13-04-2023      Mohanraj R          R22 Manual code conversion   call routine modified
* -----------------------------------------------------------------------------------------
...
*CALL APAP.REDOVER.REDO.V.INP.TT.AC.VAL
    APAP.REDOVER.redoVInpTtAcVal() ;*R22 Manual code conversion
RETURN

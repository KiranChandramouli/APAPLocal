* @ValidationCode : MjotMzc5NzgwNzA4OkNwMTI1MjoxNjg1NTM2MDE3NDcxOnZpY3RvOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*Program   Name    :REDO.V.CAL.CRED.PAYOF
*---------------------------------------------------------------------------------
*
*DESCRIPTION       :
*LINKED WITH       :
...
*10-04-2023          Conversion Tool     R22 Auto Code conversion                FM TO @FM,VM TO @VM,SM TO @SM
...
PROCESS.FT:
    ...
    IF APPLICATION EQ 'FUNDS.TRANSFER' THEN
        ...
        APAP.TAM.redoCrrGetConditions(Y.ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG) ;*R22 Manual Code conversion

* @ValidationCode : MjoyNjc2NzQ5NDg6Q3AxMjUyOjE2ODU1MzYwNDc3ODQ6dmljdG86LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
******LEER CAMPO LOCAL
*Get the values from the local field
...
******LEER CAMPO LOCAL
*Get the values after calculation from the local fields
    Y.VALOR = R.NEW(COLL.LOCAL.REF)<1,WPOSVALOR>

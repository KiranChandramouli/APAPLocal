* @ValidationCode : MjoxMTc1MzIxODI5OkNwMTI1MjoxNjg1NTI4NDEwNTM2OnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 15:50:10
...
*CALL APAP.REDOVER.REDO.V.VAL.DEFAULT.AMT
        APAP.REDOVER.redoVValDefaultAmt()T  ;* R22 Manual Code conversion
    END
** PACS00082427 - E
    ACC.ID =  COMI
    PROP.CLASS = 'OVERDUE'

* @ValidationCode : MjotMTE0MTAyNDk1MzpDcDEyNTI6MTY4NTUzNjAyMzQzNjp2aWN0bzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 17:57:03
...
*
    ...
    R.Condition=''
    ERR.MSG=''
    APAP.TAM.redoCrrGetConditions(Y.ARRANGEMENT.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG) ;* R22 Manual Conversion - CALL method format modified

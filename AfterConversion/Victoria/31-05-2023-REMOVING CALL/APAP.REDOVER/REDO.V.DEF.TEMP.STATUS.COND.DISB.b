* @ValidationCode : MjotMTg2MjA3NDE1MTpDcDEyNTI6MTY4NTUzNjAyMDE4Mjp2aWN0bzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 17:57:00
...
*CALL APAP.REDOVER.REDO.V.VAL.DEFAULT.AMT
        APAP.REDOVER.redoVValDefaultAmt() ;* R22 Manual Conversion - CALL method format modified
    END
** PACS00082427 - E
    ACC.ID =  COMI
    PROP.CLASS = 'OVERDUE'
    ...
    ERR.MSG = ''
    EFF.DATE = ''
    APAP.TAM.redoConvertAccount(ACC.ID,Y.ARR.ID,ARR.ID,ERR.TEXT) ;* R22 Manual Conversion - CALL method format modified
    APAP.TAM.redoCrrGetConditions(ARR.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG) ;* R22 Manual Conversion - CALL method format modified

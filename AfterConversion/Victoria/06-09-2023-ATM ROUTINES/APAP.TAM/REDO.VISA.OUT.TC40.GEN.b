* @ValidationCode : MjotNDIwMDY2NTY3OkNwMTI1MjoxNjkzOTc4MDc0ODkxOnZpY3RvOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 06 Sep 2023 10:57:54
...
*CALL APAP.TAM.VISA.TC40.WRITE(Y.ID.40,R.VISA.TC40) ;*R22 MANUAL CODE CONVERSION
    APAP.TAM.visaTc40Write(Y.ID.40,R.VISA.TC40) ;*R22 MANUAL CODE CONVERSION

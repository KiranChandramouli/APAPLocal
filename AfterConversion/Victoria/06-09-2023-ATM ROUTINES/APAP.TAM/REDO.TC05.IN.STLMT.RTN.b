* @ValidationCode : MjotNjE4NDY5MTcyOkNwMTI1MjoxNjkzOTc4MDY2NzUxOnZpY3RvOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 06 Sep 2023 10:57:46
...
*CALL APAP.TAM.REDO.VERIFY.TRANSACTION ;*MANUAL R22 CODE CONVERSION
        APAP.TAM.redoVerifyTransaction() ;*MANUAL R22 CODE CONVERSION
    END
*CALL APAP.TAM.REDO.STLMT.STATUS.UPDATE ;*MANUAL R22 CODE CONVERSION
    APAP.TAM.redoStlmtStatusUpdate() ;*MANUAL R22 CODE CONVERSION
...
*CALL APAP.TAM.REDO.VISA.OUTGOING.WRITE(Y.ID,R.VISA.OUTGOING) ;*MANUAL R22 CODE CONVERSION
    APAP.TAM.redoVisaOutgoingWrite(Y.ID,R.VISA.OUTGOING) ;*MANUAL R22 CODE CONVERSION
...
*CALL APAP.TAM.REDO.VISA.SETTLE.WRITE(Y.STL.ID,R.REDO.STLMT.LINE) ;*MANUAL R22 CODE CONVERSION
    APAP.TAM.redoVisaSettleWrite(Y.STL.ID,R.REDO.STLMT.LINE) ;*MANUAL R22 CODE CONVERSION

* @ValidationCode : MjoxNDc2OTAwODMxOkNwMTI1MjoxNjkzOTk0NjIwODY0OnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 06 Sep 2023 15:33:40
...
*CALL APAP.TAM.REDO.VISA.OUTGOING.WRITE(Y.ID,R.REDO.VISA.OUTGOING)
    APAP.TAM.redoVisaOutgoingWrite(Y.ID,R.REDO.VISA.OUTGOING);*MANUAL R22 CODE CONVERSION
...
*--------------------------------------------------------------------
    ...
    ID.NEW.LAST=ID.NEWLAST
    Y.ID.40= COMI
*APAP.TAM.VISA.TC40.WRITE(Y.ID.40,R.VISA.TC40)
    APAP.TAM.visaTc40Write(yId, rArray) ;*MANUAL R22 CODE CONVERSION

* @ValidationCode : MjotNDA1NzYwMTc6Q3AxMjUyOjE2OTM5OTI1NTQzOTY6dmljdG86LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 06 Sep 2023 14:59:14
...
*CALL REDO.GET.ISO.RESP(ENQ.ERROR.COM)
        APAP.ATM.redoGetIsoResp(ENQ.ERROR.COM) ;*R22 MANUAL CONVERSION
...
*CALL REDO.ATM.CARD.ACCT(Y.ACCT.NO,RTRN.ACCT.NO)
        APAP.ATM.redoAtmCardAcct(Y.ACCT.NO,RTRN.ACCT.NO) ;*R22 MANUAL CONVERSION
...
*CALL REDO.ENQ.CHG(R.ACCT)   ;* this routine is to raise charge if applicable
            APAP.REDOENQ.redoEnqChg(R.ACCT) ;*R22 MANUAL CONVERSION
        END

* End of Fix

*CALL AT.ISO.FMT.BAL.RTN(R.ACCT,Y.WORK.BAL,Y.AVAIL.BAL,BALANCE.FORMATTED)
        APAP.ATM.atIsoFmtBalRtn(R.ACCT,Y.WORK.BAL,Y.AVAIL.BAL,BALANCE.FORMATTED) ;*R22 MANUAL CONVERSION

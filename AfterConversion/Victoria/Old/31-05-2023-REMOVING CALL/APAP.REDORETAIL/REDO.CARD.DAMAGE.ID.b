* @ValidationCode : MjoxMjYxMjU4NDU4OkNwMTI1MjoxNjg1NTM1ODgzMDk0OnZpY3RvOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*CALL APAP.TAM.REDO.GET.CARD.REQUEST.ID(Y.ID,REQ.ID,Y.CARD.TYPE,ERR)
    APAP.TAM.redoGetCardRequestId(Y.ID,REQ.ID,Y.CARD.TYPE,ERR)    ;*MANUAL R22 CODE CONVERSION
    IF ERR THEN

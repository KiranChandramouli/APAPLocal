* @ValidationCode : MjoxNTMyNzU0MTY0OkNwMTI1MjoxNjg1NTI2MzgxOTY0OnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 15:16:21
...
*-----------------------------------------------------------------------------------
    ...
    Y.CREDIT = ""
    Y.CREDIT.TXN = ""
*CALL APAP.REDORETAIL.REDO.COL.FF.EXTRACT.CREDIT(CUSTOMER.ID, Y.CREDIT, Y.CREDIT.TXN)
    APAP.REDORETAIL.redoColFfExtractCredit(CUSTOMER.ID, Y.CREDIT, Y.CREDIT.TXN);* MANUAL R22 CODE CONVERSION
*    IF E THEN
*        RETURN
*    END

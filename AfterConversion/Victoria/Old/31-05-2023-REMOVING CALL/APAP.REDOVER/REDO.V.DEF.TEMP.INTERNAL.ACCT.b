* @ValidationCode : MjoxMDg0MDExNTMxOkNwMTI1MjoxNjg1NTM2MDIwMTAyOnZpY3RvOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*
    ...
    IF Y.ARR.ID[1,2] EQ 'AA' THEN
        ...
        OUT.ID = ''
        ERR.TEXT = ''
        APAP.TAM.redoConvertAccount(IN.ACC.ID,IN.ARR.ID,OUT.ID,ERR.TEXT) ;* R22 Manual Conversion - CALL method format modified
        Y.ARR.ID = OUT.ID
    END

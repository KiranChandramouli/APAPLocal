* @ValidationCode : MjotMTE1MjU4MjcwNjpDcDEyNTI6MTY4NTUzNTk5NjUwODp2aWN0bzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 17:56:36
...
* For Input update the tables via the online service.
    ...
    IF V$FUNCTION EQ 'R' OR Y.REC.STAT[1,3] EQ 'RNA' THEN
        APAP.REDOVER.redoVFxRefNum();*MANUAL R22 CODE CONVERSION
        APAP.REDOVER.redoVFxCcyPos();*MANUAL R22 CODE CONVERSION
        APAP.REDOVER.redoVAutUpdFxPos();*MANUAL R22 CODE CONVERSION
    ...
    IF V$FUNCTION EQ 'I' OR Y.REC.STAT[1,3] EQ 'INA' THEN
        IF Y.CHANNEL.TYPE NE 'INTERNET' THEN
            APAP.TAM.redoVauFxttDslip() ;*MANUAL R22 CODE CONVERSION
        END
    END

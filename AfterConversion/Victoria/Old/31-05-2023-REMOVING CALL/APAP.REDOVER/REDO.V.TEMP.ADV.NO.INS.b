* @ValidationCode : Mjo0MDA2MDM4ODc6Q3AxMjUyOjE2ODU1MzYwMzQ1ODA6dmljdG86LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
************
    ...
    IF Y.ADV.CNT EQ '' AND (Y.PART.CON EQ 'YES' OR Y.PART.CON EQ 'SI') THEN
        ...
        APAP.TAM.redoCrrGetConditions(VAR.AA.ID,EFF.DATE,PROP.CLASS, PROPERTY,R.CONDITION,ERR.MSG) ;* R22 Manual Conversion - CALL method format modified

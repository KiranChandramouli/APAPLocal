* @ValidationCode : MjotMTA4ODQ5MDE2MjpDcDEyNTI6MTY4NTUzNjAyMjc0OTp2aWN0bzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 17:57:02
...
*-------
    ...
    BUY.RATE = ''
    RATE = ''
    APAP.TAM.redoGetPoolRate(AZ.CUR,Y.DIFF.DAYS,RATE)
    BUY.RATE = RATE<2>
RETURN
END

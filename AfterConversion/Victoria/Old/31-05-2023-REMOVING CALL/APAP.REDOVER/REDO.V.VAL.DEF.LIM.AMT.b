* @ValidationCode : MjotMTYzOTE0NjgzNTpDcDEyNTI6MTY4NTUzNjA0MDM2Mjp2aWN0bzotMTotMTowOjE6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 31 May 2023 17:57:20
...
* To calculate the MIN & MAX amount and period for an arrangement
    ...
    APAP.TAM.redoCrrGetConditions(Y.ARRANGEMENT.ID,EFF.DATE,PROP.CLASS,PROPERTY,R.Condition,ERR.MSG) ;*R22 Manual Code Conversion-Call Method Format Modified

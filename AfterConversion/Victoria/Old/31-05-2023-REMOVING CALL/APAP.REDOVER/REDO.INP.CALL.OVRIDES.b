* @ValidationCode : MjoyMTAxNjUzMTgwOkNwMTI1MjoxNjg1NTM2MDAyMTg4OnZpY3RvOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 31 May 2023 17:56:42
...
*****************
    ...
    IF Y.APP.OVERRIDES THEN
        APAP.REDOAPAP.redoApiIdentifyClass(Y.APP.OVERRIDES,Y.CR.FLAG,Y.TR.FLAG) ;*Manual R22 Code Conversion
    END
    IF Y.CR.FLAG THEN
...
*****************
    ...
    IF Y.APP.OVERRIDES THEN
        APAP.REDOAPAP.redoApiIdentifyClass(Y.APP.OVERRIDES,Y.CR.FLAG,Y.TR.FLAG)  ;*R22 MANUAL CODE CONVETRSION
    END
    IF Y.CR.FLAG THEN

...
SUBROUTINE REDO.S.GET.AZ.ACC.REF(CUSTOMER.NAME)
*---------------------------------------------------------------------------------
...
*14-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     FM TO @FM,++ TO +=1, = TO EQ
...
* LOC.REF.FIELD = 'L.TT.AZ.ACC.REF'
* LOC.REF.APP = 'TELLER'
* LOC.POS = ''
* CALL GET.LOC.REF(LOC.REF.APP,LOC.REF.FIELD,LOC.POS)
* Y.ACCOUNT.ID = R.NEW(TT.TE.LOCAL.REF)<1,LOC.POS>

    APPL.ARRAY = "CUSTOMER":@FM:"TELLER" ;*R22 AUTO CONVERSION
    FIELD.ARRAY = "L.CU.TIPO.CL":@FM:"L.TT.AZ.ACC.REF" ;*R22 AUTO CONVERSION
    FIELD.POS = ''
    CALL MULTI.GET.LOC.REF(APPL.ARRAY,FIELD.ARRAY,FIELD.POS)

    LOC.L.CU.TIPO.CL.POS = FIELD.POS<1,1>
...
CHECK.NAMES:
*    -----------------------------------------------------------------------------
    Y.RELATION.COUNT = DCOUNT(R.ACCOUNT<AC.RELATION.CODE>,@VM) ;*R22 MANUAL CONVERSION -THIS LINE WAS PREVIOUSLY COMMENTED NOW ADDED
    LOOP

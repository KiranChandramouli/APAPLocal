...
********
    ...
    IF VAL.TEXT EQ '' THEN
        VAL.TEXT = 'VALIDATED'
*CALL REDO.V.AVAIL.PROGRAM ;*MANUAL R22 CODE CONVERSION
        CALL APAP.REDOVER.redoVAvailProgram()
*CALL REDO.V.DISDELAY ;*MANUAL R22 CODE CONVERSION
        CALL APAP.REDOVER.redoVDisdelay()

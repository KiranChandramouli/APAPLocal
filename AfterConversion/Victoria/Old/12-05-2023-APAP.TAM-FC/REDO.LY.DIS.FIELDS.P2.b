...
*CALL REDO.LY.DIS.FIELDS.T ;*MANUAL R22 CODE CONVERSION
        CALL APAP.TAM.redoLyDisFieldsT()
*CALL REDO.LY.DIS.FIELDS.P ;*MANUAL R22 CODE CONVERSION
        CALL APAP.TAM.redoLyDisFieldsP()
        VAL.TEXT = ''
    END ELSE
*CALL REDO.V.AVAIL.PROGRAM ;*MANUAL R22 CODE CONVERSION
        CALL APAP.REDOVER.redoVAvailProgram()

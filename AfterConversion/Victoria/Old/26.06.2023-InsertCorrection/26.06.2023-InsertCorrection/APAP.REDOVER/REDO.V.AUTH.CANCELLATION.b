* @ValidationCode : MjotOTIyMDE5Mjk1OkNwMTI1MjoxNjg3Nzc2NzAyMTQ3OnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Jun 2023 16:21:42
...
*26-06-2023    CONVERSION TOOL     R22 AUTO CONVERSION     VM TO @VM,FM TO @FM,TNO TO C$T24.SESSION.NO
...
*CALL REDO.CHECK.APPLICATION(Y.ITEM.CODE,APPL.NAME,APPL.PATH)
    APAP.TAM.redoCheckApplication(Y.ITEM.CODE,APPL.NAME,APPL.PATH) ;*R22 MANUAL CONVERSION

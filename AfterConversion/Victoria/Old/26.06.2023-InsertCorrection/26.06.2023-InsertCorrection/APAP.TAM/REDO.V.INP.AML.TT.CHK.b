* @ValidationCode : MjoxNzYzMjQ0NTMxOkNwMTI1MjoxNjg3NzY3NDA3MDU5OnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Jun 2023 13:46:47
...
*26-06-2023    VICTORIA S          R22 MANUAL CONVERSION   FM TO @FM,VM TO @VM,INSERT FIE MODIFIED
*----------------------------------------------------------------------------------
*
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*
    ...
    CHANGE @VM TO @FM IN Y.TELLER.ID.LIST ;*R22 MANUAL CONVERSION
    Y.ID.CNT      = DCOUNT(Y.TELLER.ID.LIST,@FM) ;*R22 MANUAL CONVERSION
    Y.ID.LOOP.CNT = 1
    Y.LCCY.AMT    = 0
*
    LOOP
...
*Y.TFS.TXN.CODES = R.T24.FUND.SERVICES<TFS.TRANSACTION> ;*R22 MANUAL CONVERSION
        Y.TFS.TXN.COUNT = DCOUNT(Y.TFS.TXN.CODES,@VM) ;*R22 MANUAL CONVERSION
        Y.TFS.COUNT = 1
...
*TOT.TODAY.TXN.AMT += R.T24.FUND.SERVICES<TFS.AMOUNT,Y.TFS.COUNT> ;*R22 MANUAL CONVERSION
...
*
    ...
    CHANGE @VM TO @FM IN VAR.TRAN.CAT ;*R22 MANUAL CONVERSION
...
*
    CHANGE @VM TO @FM IN VAR.OFS.OVERRIDE1 ;*R22 MANUAL CONVERSION
    CHANGE @VM TO @FM IN VAR.OFS.OVERRIDE2 ;*R22 MANUAL CONVERSION
*
...
*
    ...
    LRF.APP   = 'TRANSACTION' : @FM : 'CURRENCY' : @FM : 'TELLER' ;*R22 MANUAL CONVERSION
    LRF.FIELD = 'L.TR.AML.CHECK' : @FM : 'L.CU.AMLBUY.RT' : @FM : 'L.RTE.FORM' : @VM :'L.TT.CLIENT.COD' : @VM : 'L.INITIAL.ID':@VM:'L.ACT.INT':@VM:'L.NATIONALITY': @VM : 'L.PEP.INTERM' : @VM :'L.TYPE.PEP.INT' ;*R22 MANUAL CONVERSION
    LRF.POS   = ''
...
*
    TOT.TODAY.TXN.AMT = ''
    CURR.NO = DCOUNT(R.NEW(TT.TE.OVERRIDE),@VM)      ;* Code Review - 20120820 ;*R22 MANUAL CONVERSION
*

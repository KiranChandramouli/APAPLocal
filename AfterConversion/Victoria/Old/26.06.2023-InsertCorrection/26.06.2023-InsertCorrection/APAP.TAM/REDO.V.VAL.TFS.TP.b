* @ValidationCode : MjotODg2MzM1MDk5OkNwMTI1MjoxNjg3Nzc3Mjg5ODI5OnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Jun 2023 16:31:29
...
*--------*
    ...
    CHANGE @VM TO @FM IN Y.METHOD.LIST ;*R22 MANUAL CONVERSION
    CHANGE @VM TO @FM IN Y.METHOD.NAMES ;*R22 MANUAL CONVERSION
...
HANDLE.PROCESS:
*--------------
    CHANGE Y.DELIMITER TO @FM IN EJB_ARGUMENT ;*R22 MANUAL CONVERSION
    IF EJB_ARGUMENT<1> EQ 'SUCCESS' THEN
*R.NEW(TFS.AMOUNT.LCY)=EJB_ARGUMENT<3> ;*R22 MANUAL CONVERSION
    END
    ELSE
        GOSUB HANDLE.FAIL
    END

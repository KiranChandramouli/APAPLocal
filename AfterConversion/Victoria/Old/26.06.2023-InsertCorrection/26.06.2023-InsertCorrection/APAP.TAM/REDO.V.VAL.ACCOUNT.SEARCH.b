* @ValidationCode : MjotNDM5NTUzNzIwOkNwMTI1MjoxNjg3Nzc3NzEwMzgxOnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Jun 2023 16:38:30
...
*R22 MANUAL CONVERSION
        ...
        LREF.FIELDS='L.TT.CR.CARD.NO':@VM:'L.TT.AC.STATUS' ;*R22 MANUAL CONVERSION
...
*R22 MANUAL CONVERSION
        APAP.REDOVER.redoVWrapSunnel(Y.ARRAY)
        LREF.FIELDS = 'L.FT.CR.CARD.NO':@VM:'L.FT.AC.STATUS' ;*R22 MANUAL CONVERSION
        CALL MULTI.GET.LOC.REF(LREF.APP,LREF.FIELDS,LREF.POS)
        Y.CARD.NO.POS      = LREF.POS<1,1>
        Y.CARD.ACCT.ST.POS = LREF.POS<1,2>
...
*R22 MANUAL CONVERSION
        APAP.TAM.redoGetCardType(VAR.CARD.NO,Y.ACCT,Y.CARD.TYPE)

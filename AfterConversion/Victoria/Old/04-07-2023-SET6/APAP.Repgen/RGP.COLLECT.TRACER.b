* @ValidationCode : MjoxOTE5NTM1OTI3OkNwMTI1MjoxNjg4NDY0OTgzMTgwOnZpY3RvOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 04 Jul 2023 15:33:03
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "COLLECTION TRACE DUE REPORT"
    IF YPRINTING THEN
        YHDR = "RGP.COLLECT.TRACER ":YHDR
        YTYPE = "HEADER":@FM:YHDR ;*R22 MANUAL CONVERSION
        CALL PST ( YTYPE )
    END ELSE
        YTYPE = YHDR
    END
    YHDR1 = "                                               COLLECTIONS TRACER REPORT"
    YHDR2 = ""
    YHDR3 = "  TRACER.DATE COLLECTION.TYPE   COLL NUMBER  CURRENCY   COLLECTION AMT                CUSTOMER/ISSUING SHORT.NAME"
    YHDR4 = "------------------------------------------------------------------------------------------------------------------------------------"

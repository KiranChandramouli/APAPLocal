...
*14-07-2023    CONVERSION TOOL     R22 AUTO CONVERSION     FM TO @FM,VM TO @VM,++ TO +=1,F.READ TO CACHE.READ
...
*********
    ...
    LRF.APP = "CUSTOMER":@FM:"TELLER":@FM:"TELLER.TRANSACTION":@FM:"T24.FUND.SERVICES":@FM:"FT.TXN.TYPE.CONDITION" ;*R22 AUTO CONVERSION  START
    ...
    LRF.FIELD<-1> = "L.TT.CLIENT.COD":@VM:"L.TT.CR.ACCT.NO":@VM:"L.ACTUAL.VERSIO":@VM:"L.COMMENTS":@VM:"L.DEBIT.AMOUNT" ;*R22 AUTO CONVERSION END
...
*************
    ...
    Y.LEN.AMTCCY -= 3 ;*R22 AUTO CONVERSION
    ...
    CALL CACHE.READ(FN.FTTC, Y.FTTC, R.FTTC, FTTC.ERR) ;*R22 AUTO CONVERSION
    IF R.FTTC THEN
...
**********************
    ...
    Y.TRANSACTION.CNT = DCOUNT(Y.TRANSACTION.CODE,@VM) ;*R22 AUTO CONVERSION
    Y.VAR1=1
    LOOP
...
***********************
    R.TT.TXN = ''
    CALL CACHE.READ(FN.TELLER.TRANSACTION, Y.TT.TXN.ID, R.TT.TXN, TT.TXN.ERR) ;*R22 AUTO CONVERSION
    IF R.TT.TXN THEN
...
*****************
    ...
    Y.CNT.CATEG = DCOUNT(Y.CATEG.FROM,@SM) ;*R22 AUTO CONVERSION
    Y.CATEG = 1
    LOOP
...
*This para is used to fetch required customer details
    ...
    END ELSE
        ...
        CALL CACHE.READ(FN.COUNTRY, VAR.NATION, R.COUNTRY, ERR) ;*R22 AUTO CONVERSION
...
*R22 MANUAL CONVERSION
    ...
    CALL CACHE.READ(FN.COUNTRY, VAR.PASS.NAT, R.COUNTRY.ACQ, ERR) ;*R22 AUTO CONVERSION
...
*    VAR.OFF = R.CUSTOMER<EB.CUS.OFF.PHONE>
    ...
    CHANGE @SM TO @FM IN VAR.TEL.TYPE ;*R22 AUTO CONVERSION START
    CHANGE @SM TO @FM IN VAR.TEL.NO
    CHANGE @SM TO @FM IN VAR.TEL.AREA ;*R22 AUTO CONVERSION END

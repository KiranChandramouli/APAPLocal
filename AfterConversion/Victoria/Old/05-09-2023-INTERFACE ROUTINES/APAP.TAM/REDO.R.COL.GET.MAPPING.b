* @ValidationCode : MjotMTY0ODExMDAyNTpDcDEyNTI6MTY5Mzg5NjYzNTY2MTp2aWN0bzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Sep 2023 12:20:35
...
*CALL REDO.CONDUIT.LINEAR.TRANSLATION("O", P.IN.STATIC.MAPPING.ID,  "", "", P.IN.R.STATIC.MAPPING, P.OUT.R.STATIC.MAPPING, Y.ERR) ;*R22 MANUAL CONVERSION
        APAP.LAPAP.redoConduitLinearTranslation("O", P.IN.STATIC.MAPPING.ID,  "", "", P.IN.R.STATIC.MAPPING, P.OUT.R.STATIC.MAPPING, Y.ERR)
        IF Y.ERR THEN

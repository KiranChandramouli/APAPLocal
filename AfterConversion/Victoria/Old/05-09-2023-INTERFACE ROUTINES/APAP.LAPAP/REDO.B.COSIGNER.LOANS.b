* @ValidationCode : MjotMTg5NDkyMDA1MDpDcDEyNTI6MTY5MzkwMDIzODg5NTp2aWN0bzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Sep 2023 13:20:38
...
* 24.04.2023       Conversion Tool       R22            Auto Conversion     - INSERT file folder name removed T24.BP,LAPAP.BP & TAM.BP, FM TO @FM, VM TO @VM, SM TO @SM, ++ TO += 1
...
** R22 Manual conversion
    CALL APAP.TAM.redoRptClseWriteLoans(Y.AA.ARR.ID,R.ARRANGEMENT,ARRAY.VAL)
...
** R22 Manual conversion
    CALL APAP.TAM.redoRptAcctAltLoans(YACCT.GRP,Y.PREV.ACCOUNT)
...
** R22 Manual conversion
    APAP.LAPAP.redoSRegCustomerExtract(Y.CUSTOMER.ID,Y.PRODUCT.GROUP,Y.REL.CODE,OUT.ARR)

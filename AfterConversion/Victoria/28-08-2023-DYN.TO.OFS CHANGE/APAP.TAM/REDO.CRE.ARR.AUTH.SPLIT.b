* @ValidationCode : MjotMTYwNzQ4NzM5OTpDcDEyNTI6MTY5MzIyMDgwODI5NTp2aWN0bzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 28 Aug 2023 16:36:48
...
*Y.OFS.MESSAGE = DYN.TO.OFS(R.LIMIT.INP, "LIMIT", ADDNL.INFO.INP)
        ...
        Y.OFS.STR=''
        CALL OFS.BUILD.RECORD(APP.NAME,OFS.FUNCTION,OFS.PROCESS,OFS.VERSION,Y.GTSMODE,NO.OF.AUTH,TRANSACTION.ID,R.RECORD, Y.OFS.STR) ;*R22 MANUAL CONVERSION END
        IF ETEXT NE '' THEN
            E = ETEXT
            RETURN
        END

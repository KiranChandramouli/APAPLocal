* @ValidationCode : MjoxNDgzNjcxMzU0OkNwMTI1MjoxNjk2ODI2MDE1NjYwOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 09 Oct 2023 10:03:35
...
*--------------------
    ...
    Y.REVAL.IND=''
*    CALL REDO.APAP.SAP.GL.NR.HDR.EXP.LOG(NORMAL.FILE.DATA,Y.REVAL.IND)
    APAP.REDOAPAP.redoApapSapGlNrHdrExpLog(NORMAL.FILE.DATA,Y.REVAL.IND) ;*R22 MANUAL CODE CONVERSION
    LOOP
...
*-------------------
    ...
    END
    Y.REVAL.IND='REVAL'
*CALL REDO.APAP.SAP.GL.NR.HDR.EXP.LOG(REVAL.FILE.DATA,Y.REVAL.IND)
    APAP.REDOAPAP.redoApapSapGlNrHdrExpLog(REVAL.FILE.DATA,Y.REVAL.IND)
    LOOP

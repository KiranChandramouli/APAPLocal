* @ValidationCode : MjotMTU3NTM5Mjk5NTpDcDEyNTI6MTY5NjgyNzgwNjI2NDphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 09 Oct 2023 10:33:26
...
*CALL REDO.B.PREVELENCE.STATUS.UPD(ID,R.ACCOUNT,Y.AC.ST.POS,Y.STATUS.CHG.UPD,R.AZ.ACCOUNT)
            APAP.REDOAPAP.redoBPrevelenceStatusUpd(ID,R.ACCOUNT,Y.AC.ST.POS,Y.STATUS.CHG.UPD,R.AZ.ACCOUNT);*R22 MANUAL CODE CONVERSION
        END ELSE

* @ValidationCode : MjoxNDY4ODA5NjE1OkNwMTI1MjoxNjk2ODI2MzAzMzgwOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 09 Oct 2023 10:08:23
...
* 09-10-2023     AJITH KUMAR .S               R22 MANUAL CODE CONVERSION                 CALL RTN FORMAT MODIEFIED , FM ,VM,SM to @FM, @VM,@SM
...
*APAP.REDOAPAP.redoVCheckBalIntEntries(ACCT.ID,Y.BALANCE,BAL.CR.AMT,BAL.DR.AMT,Y.ACC.INT,INT.CR.AMT,INT.DR.AMT,Y.BAL.DET,Y.INT.DET)
        APAP.REDOAPAP.redoVCheckBalIntEntries(acctId, BAL.CR.AMT, BAL.DR.AMT, INT.CR.AMT, INT.DR.AMT, yBalAccNo, yIntAccNo);*R22 MANUAL CODE CONVERSION

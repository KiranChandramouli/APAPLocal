* @ValidationCode : MjotMTM1MzE1NjgwNjpDcDEyNTI6MTY5NjgyNTkzMTg4ODphaml0aDotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 09 Oct 2023 10:02:11
...
*********************
    ...
    LF.APP = 'COMPANY':@FM:'CUSTOMER':@FM:'RE.STAT.REP.LINE'
    LF.FLD = 'L.CO.EXT.GL.CC':@FM:'L.CU.TIPO.CL':@VM:'L.CU.CIDENT':@VM:'L.CU.RNC':@VM:'L.CU.ACTANAC':@VM:'L.CU.NOUNICO':@FM:'L.BALEM':@VM:'L.BALPG':@VM:'L.BALFA':@VM:'L.ACCEM':@VM:'L.ACCPG':@VM:'L.ACCFA'
    LF.POS = ''
...
***********
    ...
    SESSION.FILE.ID = "SFI.":PROCESS.DATE[7,2]:PROCESS.DATE[5,2]:PROCESS.DATE[1,4]:".":SESSION.NO:Y.EXT.FILE.EXTENSION
...
********************
    ...
    WHILE Y.COMPANY.MNE.ID:Y.COMPANY.MNE.POS
        CALL F.READ(FN.MNEMONIC.COMPANY,Y.COMPANY.MNE.ID,R.MNEMONIC.COMPANY,F.MNEMONIC.COMPANY,ERR)
        Y.COMPANY.ID = R.MNEMONIC.COMPANY<AC.MCO.COMPANY>
        CALL F.READ(FN.COMPANY,Y.COMPANY.ID,R.COMPANY.REC,F.COMPANY,ERR.COMP)
...
************
    ...
    WHILE Y.SPEC.TXN.CODE.ID:Y.SPEC.TXN.CODE.POS
        CALL F.READ(FN.RE.TXN.CODE,Y.SPEC.TXN.CODE.ID,R.RE.TXN.CODE,F.RE.TXN.CODE,ERR.COMP)

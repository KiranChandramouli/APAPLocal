* @ValidationCode : MjoyMTc4OTk1NTg6Q3AxMjUyOjE2OTY4MjcyMTE1OTc6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 09 Oct 2023 10:23:31
...
* 31 JAN 2023 Edwin Charles      ACCOUNTING-CR        TSR479892
* 30 MAY 2023 Edwin Charles      ACCOUNTING-CR        TSR571606
* 20 AUG 2023 Edwin Charles      ACCOUNTING-CR         TSR637100
...
*CALL REDO.APAP.SAP.GL.DETAIL.RPT.SPLIT.1(Y.STMT.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST)
    APAP.REDOAPAP.redoApapSapGlDetailRptSplit1(Y.STMT.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST);*R22 MANUAL CONERSION
...
* CALL REDO.APAP.SAP.GL.DETAIL.RPT.SPLIT.1(Y.CATEG.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST)
    APAP.REDOAPAP.redoApapSapGlDetailRptSplit1(Y.RE.CONSOL.SPEC.ENTRY.ID,Y.ENTRY.INDICATOR,Y.PARAM.DETAILS.LIST,Y.FT.OUT.LIST) ;*r22 Manual Code conversion
    GOSUB WRITE.DATA.TO.SESSION.FILES
...
* APAP.REDOAPAP.redoVCheckBalIntEntries(Y.ACT.ACCOUNT,Y.BALANCE,BAL.CR.AMT,BAL.DR.AMT,Y.ACC.INT,INT.CR.AMT,INT.DR.AMT,Y.BAL.DET,Y.INT.DET)
        APAP.REDOAPAP.redoVCheckBalIntEntries(ACCTID, balCrAmt, balDrAmt, intCrAmt, intDrAmt, yBalAccNo, yIntAccNo)

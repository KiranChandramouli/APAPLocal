* @ValidationCode : Mjo4MDM3MzE1NTU6Q3AxMjUyOjE2OTcwMjcyNDIxNjQ6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 11 Oct 2023 17:57:22
...
* -----------------------------------------------------------------------------
    ...
    Y.CREDIT.TXN<-1> = Y.INS.VALUES : @VM : Y.TYPE.TXN  ;*R22 interface Unit testing changes
RETURN
...
*JV
    ...
    GOSUB GET.STATIC.MAPPING   ;*R22 interface Unit testing changes

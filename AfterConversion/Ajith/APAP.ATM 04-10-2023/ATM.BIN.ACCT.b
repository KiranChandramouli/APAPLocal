* @ValidationCode : MjotMTk1NjQyMjI0MzpDcDEyNTI6MTY5Mzg5OTM4ODg2NjozMzNzdTotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 05 Sep 2023 13:06:28
...
* developed for visa/mastercard development
******************************************************************
...
* Processing after exiting from field input (PF5)
    ...
    IF MESSAGE = 'PREVIEW' THEN
        ...
        IF V$FUNCTION <> 'D' AND V$FUNCTION <> 'R' THEN
            GOSUB CROSS.VALIDATION
            IF NOT(V$ERROR) THEN
* >               GOSUB DELIVERY.PREVIEW   ; * Activate print preview   ;*R22 Manual Conversion
            END
        END
    END
...
CHECK.FIELDS:
* CALL ATM.BIN.ACCT.CHECK.FIELDS
    IF E THEN
        T.SEQU = "IFLD"
        CALL ERR
    END
...
*   CALL ATM.BIN.ACCT.FIELD.DEFINITIONS  ;*R22 Manual Conversion
    APAP.ATM.atmBinAcctFieldDefinitions()

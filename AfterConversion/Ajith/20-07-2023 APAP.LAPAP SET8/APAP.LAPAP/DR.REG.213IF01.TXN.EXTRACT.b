...
****************
    ...
    Y.FCY.FLAG = ''; YJOINT.VAL = ''; L.2ND.NAME.POS = '';AZ.L.AC.STATUS.POS=''; L.PASSPORT.POS=''; L.1ST.NAME.POS='';
    TOT.CASH.AMT = '';L.T24FS.TRA.DAY.POS=''; ymend=''; L.TT.BENEFICIAR.POS=''; L.ACT.BEN.POS=''; Y.LAST.WORK.DAY=''; L.OLD.ID.CARD.POS=''; L.PEP.BEN.POS=''; L.FT.ADD.INFO.POS=''; L.PEP.INTERM.POS=''; L.INV.FACILITY.POS='';  L.SEX.POS=''; Y.TFS.SERVICE.VERSIONS='';

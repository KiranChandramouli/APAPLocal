* @ValidationCode : Mjo1MjUzMjYyMDE6Q3AxMjUyOjE2OTgzMDkwMTkzNTg6YWppdGg6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 26 Oct 2023 14:00:19
...
*-------------------------------------------------------------------------
    ...
    $INCLUDE  I_F.TFS.TRANSACTION ; *R22 Manual code conversion - Start
    $INSERT I_F.TELLER.DENOMINATION
    $INCLUDE  I_T24.FS.COMMON
    $INSERT I_F.CURRENCY.MARKET ; *R22 Manual code conversion - End
...
MODIFY.DENOM.DATA:
    ...
    IF ACTUAL.DENOMINATION THEN
        CONVERT @FM TO @VM IN ACTUAL.DENOMINATION

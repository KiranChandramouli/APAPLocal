* @ValidationCode : MjoxODk0NTk3NTA5OkNwMTI1MjoxNjk4MzA4ODgwNzYwOmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Oct 2023 13:58:00
...
SUBROUTINE TFS.LOAD.TRANSACTION(TFS.TXN,R.TFS.TXN,FUT.ARG.1,FUT.ARG.2,FUT.ARG.3)
*
...
LOAD.TRANSACTION:
    ...
    IF R.TFS.TXN THEN
        ...
        END
    END ELSE
        E = 'EB-TFS.REC.MISS.FILE' :@FM: TFS.TXN :@VM: FN.TFS.TXN
    END

* @ValidationCode : MjotNDg5Mzg3MTQ1OkNwMTI1MjoxNjk4MzEzNTU2NjA2OmFqaXRoOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 26 Oct 2023 15:15:56
...
*CALL TFS.LOAD.TRANSACTION(TFS.TXN,R.TFS.TXN,'','','')
            ...
            END
        END ELSE
            E = 'EB-TFS.TXN.CODE.NOT.SETUP.FOR.TFS' :@FM: INTERFACE.TO :'-': INTERFACE.AS
        END
            ...
            BEGIN CASE
                ...
                CASE LOOP.CNT EQ 4
                    ...
                    IF NOT(R.UL) THEN
                        ...
                        IF NOT(R.UL) THEN
                            E = 'EB-TFS.REC.MISS.FILE' :@FM: ID.UL.HIS :@VM: FN.UL.FILE
                            PROCESS.GOAHEAD = 0
                        END
                    END

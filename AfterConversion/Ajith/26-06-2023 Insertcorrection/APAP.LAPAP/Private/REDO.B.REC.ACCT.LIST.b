...
*26-06-2023       S.AJITHKUMAR               R22 Manual Code Conversion      FMto@FM, T24.BP IS REMOVED,Command this Insert file I_F.T24.FUND.SERVICES,CALL RTN FORMAT CAN BE MODIFIED
*-----------------------------------------------------------------------------
...
*R22 manual conversion
    APAP.TEST.eStmtEnqByConcatFer(Y.ID.LIST)

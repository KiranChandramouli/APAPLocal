* @ValidationCode : Mjo0MzMwNjk1NDpDcDEyNTI6MTY5MTM5MjAzNTk5NDpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 07 Aug 2023 12:37:15
...
*-----------------------------------------------------------------------------
    ...
    $INCLUDE  I_EQUATE
    $INCLUDE  I_F.DATES
    $INCLUDE  I_F.REDO.INTERFACE.PARAM
    $INCLUDE  I_F.REDO.BCR.REPORT.DATA
    $INCLUDE  I_F.REDO.BCR.REPORT.EXEC
    $INCLUDE  I_REDO.B.BCR.REPORT.BUILD.COMMON
    $INCLUDE JBC.h

* @ValidationCode : MjoxODY5NjA5MDA6Q3AxMjUyOjE2ODc3ODQyODE4MDY6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Jun 2023 18:28:01
...
*13-04-2023       AJITHKUMAR                  MANUAL R22 CODE CONVERSION FMto@FM,SMto@SM,VMto@VM, Commented $INSERT I_F.T24.FUND.SERVICES
*----------------------------------------------------------------------------------------
*
*********************************************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
*   $INSERT I_F.T24.FUND.SERVICES   ;*MANUAL R22 CODE CONVERSION

* @ValidationCode : MjoxMDQ1Mzg5MzQ6Q3AxMjUyOjE2ODc3ODMyMjYxMjA6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 26 Jun 2023 18:10:26
...
* 28.04.2023       Shanmugapriya M       R22 Manual Conversion   - FM TO @FM, VM TO @VM, ;*Because of commented 'I_F.T24.FUND.SERVICES' insert file, Comment these variable 'TFS.TRANSACTION', 'TFS.AMOUNT'
*
*----------------------------------------------------------------------------------
...
*        Y.TFS.TXN.CODES = R.T24.FUND.SERVICES<TFS.TRANSACTION>    ;*Because of commented 'I_F.T24.FUND.SERVICES' insert file, Comment this variable 'TFS.TRANSACTION'
...
*                TOT.TODAY.TXN.AMT += R.T24.FUND.SERVICES<TFS.AMOUNT,Y.TFS.COUNT>   ;*Because of commented 'I_F.T24.FUND.SERVICES' insert file, Comment this variable 'TFS.AMOUNT'

* @ValidationCode : MjotNTU3ODgxMzQ1OkNwMTI1MjoxNjg2ODIxNzIyNDczOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
*----------------------------------------------------------------------------------------
SUBROUTINE RGP.PTF.SUMMARIES
REM "RGP.PTF.SUMMARIES",230614-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*
                YCOUNT.TOT2 = 1; YCOUNT.AS.TOT2 = 1
                YFD = YR.TOT2(YAV.TOT)<1>  ;* YM.VALUE1
                YR.TOT2(YAV.TOT)<1> = ""
                IF YFD = "" THEN
                    YFD = STR(" ",18)
                END ELSE
                    YFD = FMT(YFD,"18R":YT.DEC2(YAV.TOT)<1>:",")
                    YT.DEC2(YAV.TOT)<1> = ""
                    IF AMOUNT.FORMAT#"" THEN CONVERT ",." TO AMOUNT.FORMAT IN YFD
                END
                IF LEN(YFD) > 18 THEN YFD = YFD[1,17]:"|"

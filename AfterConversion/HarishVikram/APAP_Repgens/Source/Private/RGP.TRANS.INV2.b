* @ValidationCode : MjoyMDYyNTMyODAwOkNwMTI1MjoxNjg2ODIxNzIyODk2OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDoxOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
...
*----------------------------------------------------------------------------------------
SUBROUTINE RGP.TRANS.INV2
REM "RGP.TRANS.INV2",230614-4
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.TRANS.INV2"
    EXECUTE "HUSH ON"

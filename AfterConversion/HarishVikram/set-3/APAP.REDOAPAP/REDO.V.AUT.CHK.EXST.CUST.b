* @ValidationCode : MjoxNjcwMjc0NTQ4OkNwMTI1MjoxNjg1MDE4ODkyMjk4OnZpY3RvOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 25 May 2023 18:18:12
...
*CALL REDO.UPD.ACCOUNT.STATUS.DATE(Y.ACCOUNT,'DECEASED')
            CALL APAP.REDOAPAP.redoUpdAccountStatusDate(Y.ACCOUNT,'DECEASED') ;*R22 MANUAL CONVERSION
        END
****END****
        TEMP.V = V

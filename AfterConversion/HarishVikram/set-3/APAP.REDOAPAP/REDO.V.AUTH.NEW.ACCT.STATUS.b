* @ValidationCode : MjotMTkxMTMxMjA1NjpDcDEyNTI6MTY4NTAxOTI1OTkwMzp2aWN0bzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 25 May 2023 18:24:19
...
*CALL REDO.UPD.ACCOUNT.STATUS.DATE(ACCOUNT.ID,STATUS.SEQ)          ;*  To update new account active status
    CALL APAP.REDOAPAP.redoUpdAccountStatusDate(ACCOUNT.ID,STATUS.SEQ) ;*R22 MANUAL CONVERSION
RETURN
END

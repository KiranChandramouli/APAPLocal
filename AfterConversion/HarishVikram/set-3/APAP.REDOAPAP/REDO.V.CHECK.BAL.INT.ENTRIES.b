* @ValidationCode : MjotNzg3MTIwOTE6Q3AxMjUyOjE2ODUwMTk4NjI3MTM6dmljdG86LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 25 May 2023 18:34:22
...
*CALL REDO.CONV.MNEM.TO.STATUS(ACCT.ID,Y.STATUS)
    CALL APAP.REDOAPAP.redoConvMnemToStatus(ACCT.ID,Y.STATUS) ;*R22 MANUAL CONVERSION
    BEGIN CASE
        CASE Y.AZ.ACCOUNT
            Y.CATEG = 'DEP'

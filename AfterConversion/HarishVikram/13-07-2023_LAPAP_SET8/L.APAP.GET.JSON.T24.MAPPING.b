* @ValidationCode : Mjo4NTUxNzUyNzM6Q3AxMjUyOjE2ODkyNDM5NzYwNTQ6SGFyaXNodmlrcmFtQzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 13 Jul 2023 15:56:16
...
VALIDATE:
    IF TRIM(Y.MAPPING.NAME, " ", "R") EQ "" THEN
        Y.ERROR<1> = 1
...
*Y.DYN.MAPPING<7>  FILL FROM SSL.SYS.SINGLE.MULT/SSL.USR.SINGLE.MULT
    ...
    IF Y.DYN.MAPPING<2> EQ 'OUT' AND Y.JSON.OBJECT.IN NE '' THEN
*DEBUG
...
*RETURN
    ...
    IF Y.DYN.MAPPING<2> EQ 'OUT' THEN

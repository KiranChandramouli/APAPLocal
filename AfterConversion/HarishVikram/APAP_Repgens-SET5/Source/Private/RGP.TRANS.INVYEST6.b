* @ValidationCode : MjotMTI4OTUzNjMwMDpDcDEyNTI6MTY4NjgyMTcyMzQwNjpIYXJpc2h2aWtyYW1DOi0xOi0xOjA6MTpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
...
*----------------------------------------------------------------------------------------
SUBROUTINE RGP.TRANS.INVYEST6
REM "RGP.TRANS.INVYEST6",230614-4
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    CLEARSELECT
    YFILE = "F":R.COMPANY(EB.COM.MNEMONIC):".RGS.TRANS.INVYEST6"
    EXECUTE "HUSH ON"
...
* T.REMTEXT(23) = "PAGE"
    ...
    GOSUB 1000000
    YHDR = "INVEST. LIST OF YESTERDAYS ENTRIES WITH EXPAND CRF INF"
    IF YPRINTING THEN
        YHDR = "RGP.TRANS.INVYEST6 ":YHDR

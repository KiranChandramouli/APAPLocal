* @ValidationCode : MjoyMDgxNTYyNzQzOkNwMTI1MjoxNjg4NDY3MzIzMTEyOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jul 2023 16:12:03
...
*-----------------------------------------------------------------------------------------------
SUBROUTINE RGS.LCS.BY.BENEF
REM "RGS.LCS.BY.BENEF",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.LCS.BY.BENEF")
    END
*
    YCOM = ID.COMPANY
*
...
*
    ...
    END
    YM.NAME = YM.BENE.NAME
    YM1.NAME = YM.NAME
    YM.BENE.NAME1 = R.NEW(13)<1,1>
    YM.NAME = YM.BENE.NAME1
    YM1.NAME = YM1.NAME : YM.NAME
    YM.NAME = YM1.NAME
    YKEYFD = YM.NAME

* @ValidationCode : MjoxMDk2NzY3NDIxOkNwMTI1MjoxNjg4NDY3Nzk5Mjk0OkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jul 2023 16:19:59
...
*-----------------------------------------------------------------------------------------------
SUBROUTINE RGS.MG.RATE.EX
REM "RGS.MG.RATE.EX",040129-3
*************************************************************************
    $INSERT I_COMMON
    $INSERT I_EQUATE
    $INSERT I_RC.COMMON
...
*************************************************************************
    ...
    OPEN "", YFILE TO F.FILE ELSE
        ...
        CALL FATAL.ERROR ("RGS.MG.RATE.EX")
    END
*
    YCOM = ID.COMPANY
*
...
*
*************************************************************************
    YFILE = "MG.RATE.EXCEPTION"
    FULL.FNAME = "F.MG.RATE.EXCEPTION"; YF.MG.RATE.EXCEPTION = ""
    ...
    CALL OPF (FULL.FNAME, YF.MG.RATE.EXCEPTION)
    CLEARSELECT
    ...
    WHILE ID.NEW:YDELIM
        MATREAD R.NEW FROM YF.MG.RATE.EXCEPTION, ID.NEW ELSE ID.NEW = "" ; MAT R.NEW = ""
        IF T.PWD THEN
...
* Year 2000 compliance
    ...
    YM.MESSAGE = R.NEW(1)
    YR.REC(2) = YM.MESSAGE
    YM.INTEREST.KEY = R.NEW(2)
    YR.REC(3) = YM.INTEREST.KEY
*
    YKEYNO = YKEYNO + 1
    IF YKEYNO > 9999 THEN
        YKEY = YKEY:YKEYNO

* @ValidationCode : MjoxMjU1MDU1NDU1OkNwMTI1MjoxNjg4NDY2MTU0MDEwOkhhcmlzaHZpa3JhbUM6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 04 Jul 2023 15:52:34
...
*************************************************************************
    ...
    CLEARSELECT
    EXECUTE "HUSH ON"
    EXECUTE 'SELECT ':FULL.FNAME:' WITH FLD.':TNO:' LIKE "AC..." OR WITH FLD.':TNO:' LIKE "DP..." AND FLD2.':TNO:' <> ""'
    EXECUTE "HUSH OFF"

* @ValidationCode : MjotMTE4OTQ2NjM3NjpDcDEyNTI6MTY4NjA0OTk5NzgxMzp2aWN0bzotMTotMTowOjA6ZmFsc2U6Ti9BOlIyMV9BTVIuMDotMTotMQ==
* @ValidationInfo : Timestamp         : 06 Jun 2023 16:43:17
...
* 18.05.2023       Conversion Tool       R22            Auto Conversion     - = TO EQ, ++ TO += 1
* 18.05.2023       Shanmugapriya M       R22            NO CHANGE
*
*----------------------------------------------------------------------------------
    $INSERT I_COMMON
    $INSERT I_EQUATE
...
*----------------------------------------------------------------------------------
    ...
    IF R.CUSTOMER<EB.CUS.LOCAL.REF,LOC.L.CU.TIPO.CL.POS> EQ "PERSONA JURIDICA" THEN                ;** R22 Auto conversion - = TO EQ
...
*    Y.RELATION.COUNT = DCOUNT(R.ACCOUNT<AC.RELATION.CODE>,VM)
    Y.RELATION.COUNT = DCOUNT(R.ACCOUNT<AC.RELATION.CODE>,@VM) ;*R22 MANUAL CONVERSION
*    Y.COUNT = 1
...
*           END
            ...
            IF R.CUSTOMER<EB.CUS.LOCAL.REF,LOC.L.CU.TIPO.CL.POS> EQ "PERSONA FISICA" OR R.CUSTOMER<EB.CUS.LOCAL.REF,LOC.L.CU.TIPO.CL.POS> EQ "CLIENTE  MENOR" THEN          ;** R22 Auto conversion - = TO EQ

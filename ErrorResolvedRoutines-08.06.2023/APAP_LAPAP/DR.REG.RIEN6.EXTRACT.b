* @ValidationCode : MjoxODg4Mzc4ODU6Q3AxMjUyOjE2ODYyMjA2MDkzODA6SVRTUzE6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjJfU1A1LjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 08 Jun 2023 16:06:49
...
* 24-05-2023   Conversion T         R22 Auto Conversion - changed VM to @VM, <= to LE, SM to @SM
* 07-06-2023   Ghayathri T          R22 Manual Conversion - R.EB.LOOKUP.APP.LNK,Y.LNK.TYP.NAME,LCOMP.LOCALIDAD.POS and L.CU.LOCAL.POS variables are Added in I_DR.REG.RIEN6.EXTRACT.COMMON file
*----------------------------------------------------------------------------
...
*    FINAL.MSG<-1> = R.COMPANY(EB.COM.NAME.ADDRESS)<1,3>
    ...
    LOC.CODE =  R.CUSTOMER<EB.CUS.LOCAL.REF,L.CU.LOCAL.POS>;*R22 Manual conversion L.CU.LOCAL.POS variable Added in I_DR.REG.RIEN6.EXTRACT.COMMON
    IF NOT(LOC.CODE) THEN
        ...
        LOC.CODE = R.COMP.APP<EB.COM.LOCAL.REF,LCOMP.LOCALIDAD.POS>;*R22 Manual conversion LCOMP.LOCALIDAD.POS variable Added in I_DR.REG.RIEN6.EXTRACT.COMMON
    END
...
*************
    ...
    IF R.CUSTOMER THEN
        ...
        WHILE Y.RL.CNT LE Y.RL.DCNT
            ...
            LOCATE Y.RLN.CODE IN Y.LNK.TYP.NAME<1,1> SETTING Y.LNK.TYP.POS THEN;*R22 Manual conversion Y.LNK.TYP.NAME variable Added in I_DR.REG.RIEN6.EXTRACT.COMMON
                REL.VAL = R.EB.LOOKUP.APP.LNK<EB.LU.DATA.VALUE,Y.LNK.TYP.POS>;*R22 Manual conversion R.EB.LOOKUP.APP.LNK variable Added in I_DR.REG.RIEN6.EXTRACT.COMMON
            END
            IF REL.VAL THEN
                Y.RL.CNT =  Y.RL.DCNT
            END

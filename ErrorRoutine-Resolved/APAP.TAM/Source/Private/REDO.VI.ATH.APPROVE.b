* @ValidationCode : MjotMTc1MTEwMTI1NTpDcDEyNTI6MTY4NDgzNjc4NzkyNDpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 23 May 2023 15:43:07
...
*DATE              WHO                REFERENCE                        DESCRIPTION
*23-05-2023      MOHANRAJ R        AUTO R22 CODE CONVERSION           FM TO @FM,VM TO @VM
*23-05-2023      MOHANRAJ R        MANUAL R22 CODE CONVERSION         Read of CR.ACCT from REDO.APAP.H.PARAMETE
*----------------------------------------------------------------------
...
*----------------------------------------------------------
    ...
    LOCATE TC.CODE IN Y.TC.CODE<1,1> SETTING POS1 THEN
        ...
        CR.ACCT=R.REDO.APAP.H.PARAMETER<PARAM.CR.ACCT,POS1>     ;*R22 Manual Conversion - Read of CR.ACCT from REDO.APAP.H.PARAMETE
    ...
    IF R.AC.LOCKED.EVENTS THEN
        ...
        Y.AVAILABLE.BALANCE += Y.LOCKED.AMT
    END

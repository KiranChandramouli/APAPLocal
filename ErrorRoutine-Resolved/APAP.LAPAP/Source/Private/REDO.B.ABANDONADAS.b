* @ValidationCode : MjotMTA5NDMzMDkzNDpDcDEyNTI6MTY4NTYxOTY0Mjk4NjpJVFNTOi0xOi0xOjA6MDpmYWxzZTpOL0E6UjIxX0FNUi4wOi0xOi0x
* @ValidationInfo : Timestamp         : 01 Jun 2023 17:10:42
...
*23/05/2023      CONVERSION TOOL         AUTO R22 CODE CONVERSION           FM TO @FM, VM TO @VM, SM TO @SM, ++ to +=, = to EQ, I to I.VAR
*23/05/2023      HARISH VIKRAM           MANUAL R22 CODE CONVERSION         CALL routine format modified, L.INV.FACILITY.POS, Y.CINT.VAL.ARR, Y.CCAP.VAL.ARR  added in Insert file  I_REDO.B.ABANDONADAS.COMMON

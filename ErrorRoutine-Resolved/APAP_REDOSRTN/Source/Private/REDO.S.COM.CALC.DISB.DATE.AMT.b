* @ValidationCode : Mjo4OTg3NzQwODA6Q3AxMjUyOjE2ODU0NDg4MTU0MDU6SVRTUzE6LTE6LTE6MDowOmZhbHNlOk4vQTpSMjFfQU1SLjA6LTE6LTE=
* @ValidationInfo : Timestamp         : 30 May 2023 17:43:35
...
*                        VIGNESHWARI                    24/05/2023         MANUAL R22 CODE CONVERSION - AA.AH.ACTIVITY.ID TO AA.AH.ACTIVITY.REF, CHANGED ++ *												    TO += 1
*                        CONVERSION TOOL                24/05/2023         AUTO R22 CODE CONVERSION - VM TO @VM, FM TO @ FM, SM TO @SM,NEW LINES ADDED
*---------------------------------------------------------------------------------------
...
*---------------------
    ...
    END
    YACT.ID.ARR = R.AA.ACTIVITY.HISTORY<AA.AH.ACTIVITY.REF> ;* MANUAL R22 CODE CONVERSION - Changed AA.AH.ACTIVITY.ID TO AA.AH.ACTIVITY.REF
